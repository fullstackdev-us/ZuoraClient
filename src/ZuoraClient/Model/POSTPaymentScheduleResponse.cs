...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTPaymentScheduleResponse")]
    public partial class POSTPaymentScheduleResponse : IEquatable<POSTPaymentScheduleResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTPaymentScheduleResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as POSTPaymentScheduleResponse);
        }

        /// <summary>
        /// Returns true if POSTPaymentScheduleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTPaymentScheduleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTPaymentScheduleResponse input)
        {
            if (input == null)
            {
                return false;
