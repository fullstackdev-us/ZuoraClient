...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderLineItemCommonPostOrder")]
    public partial class OrderLineItemCommonPostOrder : IEquatable<OrderLineItemCommonPostOrder>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderLineItemCommonPostOrder" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OrderLineItemCommonPostOrder);
        }

        /// <summary>
        /// Returns true if OrderLineItemCommonPostOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderLineItemCommonPostOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderLineItemCommonPostOrder input)
        {
            if (input == null)
            {
                return false;
