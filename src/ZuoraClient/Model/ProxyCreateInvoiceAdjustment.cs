...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyCreateInvoiceAdjustment")]
    public partial class ProxyCreateInvoiceAdjustment : IEquatable<ProxyCreateInvoiceAdjustment>, IValidatableObject
    {
        ...
        public ProxyCreateInvoiceAdjustment(string accountId = default(string), string accountingCode = default(string), DateTime adjustmentDate = default(DateTime), string adjustmentNumber = default(string), double amount = default(double), string comments = default(string), string customerName = default(string), string customerNumber = default(string), double impactAmount = default(double), string invoiceId = default(string), string invoiceNumber = default(string), string reasonCode = default(string), string referenceId = default(string), string status = default(string), string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ProxyCreateInvoiceAdjustment and cannot be null");
            }
            this.Type = type;
        ...
        {
            return this.Equals(input as ProxyCreateInvoiceAdjustment);
        }

        /// <summary>
        /// Returns true if ProxyCreateInvoiceAdjustment instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreateInvoiceAdjustment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateInvoiceAdjustment input)
        {
            if (input == null)
            {
                return false;
