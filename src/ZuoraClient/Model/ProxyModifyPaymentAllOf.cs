...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyModifyPayment_allOf")]
    public partial class ProxyModifyPaymentAllOf : IEquatable<ProxyModifyPaymentAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyPaymentAllOf" /> class.
        /// </summary>
        ...
        public ProxyModifyPaymentAllOf(string accountId = default(string), string accountingCode = default(string), double amount = default(double), DateTime effectiveDate = default(DateTime), string paymentMethodId = default(string), string referenceId = default(string), StatusEnum? status = default(StatusEnum?), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), TypeEnum? type = default(TypeEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyModifyPaymentAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyModifyPaymentAllOf);
        }

        /// <summary>
        /// Returns true if ProxyModifyPaymentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyModifyPaymentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyPaymentAllOf input)
        {
            if (input == null)
            {
                return false;
