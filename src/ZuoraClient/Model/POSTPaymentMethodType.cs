...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTPaymentMethodType")]
    public partial class POSTPaymentMethodType : IEquatable<POSTPaymentMethodType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as POSTPaymentMethodType);
        }

        /// <summary>
        /// Returns true if POSTPaymentMethodType instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTPaymentMethodType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTPaymentMethodType input)
        {
            if (input == null)
            {
                return false;
