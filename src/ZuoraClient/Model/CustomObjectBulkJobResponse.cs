...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomObjectBulkJobResponse")]
    public partial class CustomObjectBulkJobResponse : IEquatable<CustomObjectBulkJobResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The namespace of the object. Custom objects belong to the &#x60;default&#x60; namespace. Zuora standard objects belong to the &#x60;com_zuora&#x60; namespace. Bulk job operations on the following Zuora standard objects are supported: * SavedQuery </value>
        ...
        public enum NamespaceEnum
        {
            ...
            /// <summary>
            /// Enum ComZuora for value: com_zuora
            /// </summary>
            [EnumMember(Value = "com_zuora")]
            ComZuora = 2
        ...
        /// </summary>
        /// <value>The operation that the bulk job performs. Only the users that have the \&quot;Delete Custom Objects\&quot; permission can submit a &#x60;delete&#x60; bulk job request. Only the users that have the \&quot;Edit Custom Objects\&quot; permission can submit a &#x60;create&#x60; or &#x60;update&#x60; bulk job request. See [Platform Permissions](https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/h_Platform_Roles#Platform_Permissions) for more information. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>The status of the bulk job:  - &#x60;accepted&#x60; - The job has been accepted and is ready to process. - &#x60;pending&#x60; - The job is waiting for your input. You can use [Upload a file for a custom object bulk job](https://www.zuora.com/developer/api-reference/#operation/POST_UploadFileForCustomObjectBulkJob) to upload a file so that the job can start creating records. - &#x60;in_progress&#x60; - The job is processing. - &#x60;completed&#x60; - The job has completed. - &#x60;failed&#x60; - The job was unable to complete. You can use [List all errors for a custom object bulk job](https://www.zuora.com/developer/api-reference/#operation/GET_CustomObjectBulkJobErrors) to list the errors. - &#x60;cancelled&#x60; - The job was cancelled by the server. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomObjectBulkJobResponse" /> class.
        /// </summary>
        /// <param name="createdById">The ID of the user who creates the job..</param>
        /// <param name="createdDate">The time when the bulk job is created..</param>
        /// <param name="id">The custom object bulk job ID..</param>
        /// <param name="updatedById">The ID of the user who updates the job..</param>
        /// <param name="updatedDate">The time when the bulk job is updated..</param>
        /// <param name="error">error.</param>
        /// <param name="_namespace">The namespace of the object. Custom objects belong to the &#x60;default&#x60; namespace. Zuora standard objects belong to the &#x60;com_zuora&#x60; namespace. Bulk job operations on the following Zuora standard objects are supported: * SavedQuery .</param>
        /// <param name="_object">The object to that the bulk operation performs on..</param>
        /// <param name="operation">The operation that the bulk job performs. Only the users that have the \&quot;Delete Custom Objects\&quot; permission can submit a &#x60;delete&#x60; bulk job request. Only the users that have the \&quot;Edit Custom Objects\&quot; permission can submit a &#x60;create&#x60; or &#x60;update&#x60; bulk job request. See [Platform Permissions](https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/h_Platform_Roles#Platform_Permissions) for more information. .</param>
        /// <param name="processingTime">The amount of time elapsed, in milliseconds, from the submission to the completion of the bulk job..</param>
        /// <param name="recordsProcessed">The number of object records processed by the bulk job..</param>
        /// <param name="status">The status of the bulk job:  - &#x60;accepted&#x60; - The job has been accepted and is ready to process. - &#x60;pending&#x60; - The job is waiting for your input. You can use [Upload a file for a custom object bulk job](https://www.zuora.com/developer/api-reference/#operation/POST_UploadFileForCustomObjectBulkJob) to upload a file so that the job can start creating records. - &#x60;in_progress&#x60; - The job is processing. - &#x60;completed&#x60; - The job has completed. - &#x60;failed&#x60; - The job was unable to complete. You can use [List all errors for a custom object bulk job](https://www.zuora.com/developer/api-reference/#operation/GET_CustomObjectBulkJobErrors) to list the errors. - &#x60;cancelled&#x60; - The job was cancelled by the server. .</param>
        public CustomObjectBulkJobResponse(Guid createdById = default(Guid), DateTime createdDate = default(DateTime), Guid id = default(Guid), Guid updatedById = default(Guid), DateTime updatedDate = default(DateTime), CustomObjectBulkJobResponseError error = default(CustomObjectBulkJobResponseError), NamespaceEnum? _namespace = default(NamespaceEnum?), string _object = default(string), OperationEnum? operation = default(OperationEnum?), int processingTime = default(int), int recordsProcessed = default(int), StatusEnum? status = default(StatusEnum?))
        {
        ...
        /// </summary>
        /// <value>The ID of the user who creates the job.</value>
        ...
        /// </summary>
        /// <value>The time when the bulk job is created.</value>
        ...
        /// </summary>
        /// <value>The custom object bulk job ID.</value>
        ...
        /// </summary>
        /// <value>The ID of the user who updates the job.</value>
        ...
        /// </summary>
        /// <value>The time when the bulk job is updated.</value>
        ...
        public CustomObjectBulkJobResponseError Error { get; set; }

        /// <summary>
        /// The object to that the bulk operation performs on.
        /// </summary>
        /// <value>The object to that the bulk operation performs on.</value>
        ...
        /// </summary>
        /// <value>The amount of time elapsed, in milliseconds, from the submission to the completion of the bulk job.</value>
        ...
        /// </summary>
        /// <value>The number of object records processed by the bulk job.</value>
        [DataMember(Name = "recordsProcessed", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RecordsProcessed: ").Append(RecordsProcessed).Append("\n");
        ...
        {
            return this.Equals(input as CustomObjectBulkJobResponse);
        }

        /// <summary>
        /// Returns true if CustomObjectBulkJobResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomObjectBulkJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomObjectBulkJobResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RecordsProcessed == input.RecordsProcessed ||
                    this.RecordsProcessed.Equals(input.RecordsProcessed)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.RecordsProcessed.GetHashCode();
