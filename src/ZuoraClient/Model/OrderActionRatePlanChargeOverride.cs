...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderActionRatePlanChargeOverride")]
    public partial class OrderActionRatePlanChargeOverride : IEquatable<OrderActionRatePlanChargeOverride>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum ContractEffectiveDate for value: Contract Effective Date
            /// </summary>
            [EnumMember(Value = "Contract Effective Date")]
            ContractEffectiveDate = 1,

            /// <summary>
            /// Enum ServiceActivationDate for value: Service Activation Date
            /// </summary>
            [EnumMember(Value = "Service Activation Date")]
            ServiceActivationDate = 2,

            /// <summary>
            /// Enum CustomerAcceptanceDate for value: Customer Acceptance Date
            /// </summary>
            [EnumMember(Value = "Customer Acceptance Date")]
        ...
        {
            /// <summary>
            /// Enum UponInvoicing for value: Recognize upon invoicing
            /// </summary>
            [EnumMember(Value = "Recognize upon invoicing")]
            UponInvoicing = 1,

            /// <summary>
            /// Enum DailyOverTime for value: Recognize daily over time
            /// </summary>
            [EnumMember(Value = "Recognize daily over time")]
            DailyOverTime = 2
        ...
        public RevenueRecognitionRuleNameEnum? RevenueRecognitionRuleName { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderActionRatePlanChargeOverride" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderActionRatePlanChargeOverride() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderActionRatePlanChargeOverride" /> class.
        /// </summary>
        /// <param name="billing">billing.</param>
        /// <param name="chargeNumber">Charge number of the charge. For example, C-00000307.  If you do not set this field, Zuora will generate the charge number. .</param>
        /// <param name="customFields">Container for custom fields of a Rate Plan Charge object. .</param>
        /// <param name="description">Description of the charge. .</param>
        /// <param name="endDate">endDate.</param>
        /// <param name="pricing">pricing.</param>
        /// <param name="productRatePlanChargeId">Internal identifier of the product rate plan charge that the charge is based on.  (required).</param>
        /// <param name="revRecCode">Revenue Recognition Code .</param>
        /// <param name="revRecTriggerCondition">Specifies the revenue recognition trigger condition.    * &#x60;Contract Effective Date&#x60;   * &#x60;Service Activation Date&#x60;   * &#x60;Customer Acceptance Date&#x60; .</param>
        /// <param name="revenueRecognitionRuleName">Specifies the revenue recognition rule.    * &#x60;Recognize upon invoicing&#x60;   * &#x60;Recognize daily over time&#x60; .</param>
        /// <param name="startDate">startDate.</param>
        /// <param name="uniqueToken">Unique identifier for the charge. This identifier enables you to refer to the charge before the charge has an internal identifier in Zuora.  For instance, suppose that you want to use a single order to add a product to a subscription and later update the same product. When you add the product, you can set a unique identifier for the charge. Then when you update the product, you can use the same unique identifier to specify which charge to modify. .</param>
        public OrderActionRatePlanChargeOverride(ChargeOverrideBilling billing = default(ChargeOverrideBilling), string chargeNumber = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string description = default(string), OrderActionRatePlanEndConditions endDate = default(OrderActionRatePlanEndConditions), OrderActionRatePlanChargeOverridePricing pricing = default(OrderActionRatePlanChargeOverridePricing), string productRatePlanChargeId = default(string), string revRecCode = default(string), RevRecTriggerConditionEnum? revRecTriggerCondition = default(RevRecTriggerConditionEnum?), RevenueRecognitionRuleNameEnum? revenueRecognitionRuleName = default(RevenueRecognitionRuleNameEnum?), OrderActionRatePlanTriggerParams startDate = default(OrderActionRatePlanTriggerParams), string uniqueToken = default(string))
        {
            // to ensure "productRatePlanChargeId" is required (not null)
            if (productRatePlanChargeId == null)
            {
                throw new ArgumentNullException("productRatePlanChargeId is a required property for OrderActionRatePlanChargeOverride and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Container for custom fields of a Rate Plan Charge object. </value>
        ...
        public OrderActionRatePlanEndConditions EndDate { get; set; }

        /// <summary>
        /// Gets or Sets Pricing
        /// </summary>
        [DataMember(Name = "pricing", EmitDefaultValue = false)]
        public OrderActionRatePlanChargeOverridePricing Pricing { get; set; }
        ...
        public OrderActionRatePlanTriggerParams StartDate { get; set; }
        ...
        {
            return this.Equals(input as OrderActionRatePlanChargeOverride);
        }

        /// <summary>
        /// Returns true if OrderActionRatePlanChargeOverride instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderActionRatePlanChargeOverride to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderActionRatePlanChargeOverride input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.UniqueToken == input.UniqueToken ||
                    (this.UniqueToken != null &&
                    this.UniqueToken.Equals(input.UniqueToken))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.UniqueToken.GetHashCode();
                }
                return hashCode;
            }
        }
        ...
        {
            // ChargeNumber (string) maxLength
            if (this.ChargeNumber != null && this.ChargeNumber.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ChargeNumber, length must be less than 50.", new [] { "ChargeNumber" });
            }
            ...
            // UniqueToken (string) maxLength
            if (this.UniqueToken != null && this.UniqueToken.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UniqueToken, length must be less than 50.", new [] { "UniqueToken" });
            }
