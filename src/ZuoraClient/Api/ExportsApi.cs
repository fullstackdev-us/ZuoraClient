...
namespace ZuoraClient.Api
{
    ...
    public interface IExportsApiSync : IApiAccessor
    {
        ...
        ProxyGetExport ObjectGETExport(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0);
        ...
        ApiResponse<ProxyGetExport> ObjectGETExportWithHttpInfo(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="xZuoraWSDLVersion">Set the value to &#x60;80&#x60; if you want to export data about [Debit Taxation Item](https://knowledgecenter.zuora.com/Billing/Reporting/D_Data_Sources_and_Exports/C_Data_Source_Reference/Debit_Taxation_Item_Data_Source) and [Credit Taxation Item](https://knowledgecenter.zuora.com/Billing/Reporting/D_Data_Sources_and_Exports/C_Data_Source_Reference/Credit_Taxation_Item_Data_Source).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProxyCreateOrModifyResponse</returns>
        ProxyCreateOrModifyResponse ObjectPOSTExport(ProxyCreateExport createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0);
        ...
        ApiResponse<ProxyCreateOrModifyResponse> ObjectPOSTExportWithHttpInfo(ProxyCreateExport createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0);
    ...
    public interface IExportsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<ProxyGetExport>> ObjectGETExportWithHttpInfoAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// CRUD: Create an export
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<ProxyCreateOrModifyResponse>> ObjectPOSTExportWithHttpInfoAsync(ProxyCreateExport createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ExportsApi : IExportsApi
    {
        ...
        /// <returns></returns>
        public ExportsApi(ZuoraClient.Client.Configuration configuration)
        {
        ...
        public ExportsApi(ZuoraClient.Client.ISynchronousClient client, ZuoraClient.Client.IAsynchronousClient asyncClient, ZuoraClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// CRUD: Retrieve an export Use this operation to check the status of a data source export and access the exported data.  When you export data from Zuora, each exported file is available for download for 7 days. Data source exports (Export objects) older than 90 days are automatically deleted. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Object id</param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProxyGetExport</returns>
        public ProxyGetExport ObjectGETExport(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<ProxyGetExport> localVarResponse = ObjectGETExportWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProxyGetExport</returns>
        public ZuoraClient.Client.ApiResponse<ProxyGetExport> ObjectGETExportWithHttpInfo(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'id' when calling ExportsApi->ObjectGETExport");
            }
            ...
            localVarRequestOptions.Operation = "ExportsApi.ObjectGETExport";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<ProxyGetExport>("/v1/object/export/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ObjectGETExport", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProxyGetExport</returns>
        public async System.Threading.Tasks.Task<ProxyGetExport> ObjectGETExportAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<ProxyGetExport> localVarResponse = await ObjectGETExportWithHttpInfoAsync(id, authorization, zuoraEntityIds, zuoraTrackId, fields, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProxyGetExport)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<ProxyGetExport>> ObjectGETExportWithHttpInfoAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ProxyGetExport>("/v1/object/export/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// CRUD: Create an export Use this operation to create a data source export. After you have created a data source export, use [CRUD: Retrieve an export](https://www.zuora.com/developer/api-reference/#operation/Object_GETExport) to check the status of the data source export and access the exported data.  ## Limits  Zuora system enforces the following limits on data source exports:  * The maximum processing time per export is 3 hours. If an export is executed for longer than 3 hours, it will be killed automatically. * The maximum number of concurrent exports is 50 per tenant. Exports in &#x60;Pending&#x60; and &#x60;Processing&#x60; status are counted towards the concurrent export limit. Zuora system will reject the subsequent data source export requests once the concurrent export limit is reached.  When you export data from Zuora, each exported file is available for download for 7 days. Data source exports (Export objects) older than 90 days are automatically deleted.  **Note:** This operation supports the [Export ZOQL](https://knowledgecenter.zuora.com/DC_Developers/M_Export_ZOQL) query language. However, this operation does not support some data sources, objects, and fields in Export ZOQL queries. For full compatibility with Export ZOQL, Zuora recommends that you use the [AQuA API](https://knowledgecenter.zuora.com/DC_Developers/T_Aggregate_Query_API) instead of this operation. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="createRequest"></param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProxyCreateOrModifyResponse</returns>
        public ProxyCreateOrModifyResponse ObjectPOSTExport(ProxyCreateExport createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse> localVarResponse = ObjectPOSTExportWithHttpInfo(createRequest, authorization, rejectUnknownFields, zuoraEntityIds, zuoraTrackId, xZuoraWSDLVersion);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProxyCreateOrModifyResponse</returns>
        public ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse> ObjectPOSTExportWithHttpInfo(ProxyCreateExport createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'createRequest' is set
            if (createRequest == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'createRequest' when calling ExportsApi->ObjectPOSTExport");
            }
            ...
            localVarRequestOptions.Operation = "ExportsApi.ObjectPOSTExport";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<ProxyCreateOrModifyResponse>("/v1/object/export", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ObjectPOSTExport", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProxyCreateOrModifyResponse</returns>
        public async System.Threading.Tasks.Task<ProxyCreateOrModifyResponse> ObjectPOSTExportAsync(ProxyCreateExport createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse> localVarResponse = await ObjectPOSTExportWithHttpInfoAsync(createRequest, authorization, rejectUnknownFields, zuoraEntityIds, zuoraTrackId, xZuoraWSDLVersion, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProxyCreateOrModifyResponse)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse>> ObjectPOSTExportWithHttpInfoAsync(ProxyCreateExport createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'createRequest' is set
            if (createRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ProxyCreateOrModifyResponse>("/v1/object/export", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
