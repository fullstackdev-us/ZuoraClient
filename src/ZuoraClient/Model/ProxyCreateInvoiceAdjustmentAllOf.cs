...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyCreateInvoiceAdjustment_allOf")]
    public partial class ProxyCreateInvoiceAdjustmentAllOf : IEquatable<ProxyCreateInvoiceAdjustmentAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateInvoiceAdjustmentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateInvoiceAdjustmentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateInvoiceAdjustmentAllOf" /> class.
        /// </summary>
        ...
        /// <param name="customerName"> The name of the account that owns the associated invoice. **Character limit**: 50 **Values**: inherited from Account.Name .</param>
        /// <param name="customerNumber"> The unique account number of the customer&#39;s account. **Character limit**: 70 **Values**: inherited from Account.AccountNumber .</param>
        ...
        /// <param name="invoiceId"> The ID of the invoice associated with the adjustment. This field is only required if you don&#39;t specify a value for the &#x60;InvoiceNumber&#x60; field. **Character limit**: 32 **Values**: a valid invoice ID .</param>
        /// <param name="invoiceNumber"> The unique identification number for the associated invoice. This field is only required if you don&#39;t specify a value for the &#x60;InvoiceId&#x60; field. **Character limit**: 32 **Values**: a valid invoice number .</param>
        ...
        /// <param name="referenceId"> A code to reference an object external to Zuora. For example, you can use this field to reference a case number in an external system. **Character limit**: 100 **Values**: a string of 100 characters or fewer .</param>
        /// <param name="status"> The status of the invoice adjustment. This field is only required in the Query call, but is automatically generated in other calls. **Character limit**: 9 **Values**: &#x60;Canceled&#x60;, &#x60;Processed&#x60; .</param>
        ...
        public ProxyCreateInvoiceAdjustmentAllOf(string accountId = default(string), string accountingCode = default(string), DateTime adjustmentDate = default(DateTime), string adjustmentNumber = default(string), double amount = default(double), string comments = default(string), string customerName = default(string), string customerNumber = default(string), double impactAmount = default(double), string invoiceId = default(string), string invoiceNumber = default(string), string reasonCode = default(string), string referenceId = default(string), string status = default(string), string type = default(string))
        {
            this.Amount = amount;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ProxyCreateInvoiceAdjustmentAllOf and cannot be null");
            }
            this.Type = type;
        ...
        /// </summary>
        /// <value> The name of the account that owns the associated invoice. **Character limit**: 50 **Values**: inherited from Account.Name </value>
        ...
        /// </summary>
        /// <value> The unique account number of the customer&#39;s account. **Character limit**: 70 **Values**: inherited from Account.AccountNumber </value>
        ...
        /// </summary>
        /// <value> The ID of the invoice associated with the adjustment. This field is only required if you don&#39;t specify a value for the &#x60;InvoiceNumber&#x60; field. **Character limit**: 32 **Values**: a valid invoice ID </value>
        ...
        /// </summary>
        /// <value> The unique identification number for the associated invoice. This field is only required if you don&#39;t specify a value for the &#x60;InvoiceId&#x60; field. **Character limit**: 32 **Values**: a valid invoice number </value>
        ...
        /// </summary>
        /// <value> A code to reference an object external to Zuora. For example, you can use this field to reference a case number in an external system. **Character limit**: 100 **Values**: a string of 100 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The status of the invoice adjustment. This field is only required in the Query call, but is automatically generated in other calls. **Character limit**: 9 **Values**: &#x60;Canceled&#x60;, &#x60;Processed&#x60; </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyCreateInvoiceAdjustmentAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyCreateInvoiceAdjustmentAllOf);
        }

        /// <summary>
        /// Returns true if ProxyCreateInvoiceAdjustmentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreateInvoiceAdjustmentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateInvoiceAdjustmentAllOf input)
        {
            if (input == null)
            {
                return false;
