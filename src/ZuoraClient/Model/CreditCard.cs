...
namespace ZuoraClient.Model
{
    ...
    public partial class CreditCard : IEquatable<CreditCard>, IValidatableObject
    {
        ...
        public enum CardTypeEnum
        {
            ...
            /// <summary>
            /// Enum AppleVisa for value: AppleVisa
            /// </summary>
            [EnumMember(Value = "AppleVisa")]
            AppleVisa = 10,

            /// <summary>
            /// Enum AppleMasterCard for value: AppleMasterCard
            /// </summary>
            [EnumMember(Value = "AppleMasterCard")]
            AppleMasterCard = 11,

            /// <summary>
            /// Enum AppleAmericanExpress for value: AppleAmericanExpress
            /// </summary>
            [EnumMember(Value = "AppleAmericanExpress")]
            AppleAmericanExpress = 12,

            /// <summary>
            /// Enum AppleDiscover for value: AppleDiscover
            /// </summary>
            [EnumMember(Value = "AppleDiscover")]
            AppleDiscover = 13,

            /// <summary>
            /// Enum AppleJCB for value: AppleJCB
            /// </summary>
            [EnumMember(Value = "AppleJCB")]
            AppleJCB = 14,
            ...
            /// <summary>
            /// Enum Nativa for value: Nativa
            /// </summary>
            [EnumMember(Value = "Nativa")]
            Nativa = 18,

            /// <summary>
            /// Enum TarjetaShopping for value: TarjetaShopping
            /// </summary>
            [EnumMember(Value = "TarjetaShopping")]
            TarjetaShopping = 19,

            /// <summary>
            /// Enum Cencosud for value: Cencosud
            /// </summary>
        ...
        /// <param name="cardNumber">Card number. Once set, you cannot update or query the value of this field. The value of this field is only available in masked format. For example, XXXX-XXXX-XXXX-1234 (hyphens must not be used when you set the credit card number). .</param>
        /// <param name="cardType">Type of card. .</param>
        /// <param name="expirationMonth">Expiration date of the card. .</param>
        /// <param name="expirationYear">Expiration year of the card. .</param>
        /// <param name="securityCode">CVV or CVV2 security code of the card. To ensure PCI compliance, Zuora does not store the value of this field. .</param>
        public CreditCard(AccountCreditCardHolder cardHolderInfo = default(AccountCreditCardHolder), string cardNumber = default(string), CardTypeEnum? cardType = default(CardTypeEnum?), int expirationMonth = default(int), int expirationYear = default(int), string securityCode = default(string))
        {
        ...
        public AccountCreditCardHolder CardHolderInfo { get; set; }
        ...
        /// </summary>
        /// <value>Card number. Once set, you cannot update or query the value of this field. The value of this field is only available in masked format. For example, XXXX-XXXX-XXXX-1234 (hyphens must not be used when you set the credit card number). </value>
        ...
        /// </summary>
        /// <value>Expiration date of the card. </value>
        ...
        /// </summary>
        /// <value>CVV or CVV2 security code of the card. To ensure PCI compliance, Zuora does not store the value of this field. </value>
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.ExpirationMonth > (int)12)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExpirationMonth, must be a value less than or equal to 12.", new [] { "ExpirationMonth" });
            }

            // ExpirationMonth (int) minimum
            if (this.ExpirationMonth < (int)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExpirationMonth, must be a value greater than or equal to 1.", new [] { "ExpirationMonth" });
            }

            // ExpirationYear (int) maximum
            if (this.ExpirationYear > (int)2500)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExpirationYear, must be a value less than or equal to 2500.", new [] { "ExpirationYear" });
            }

            // ExpirationYear (int) minimum
            if (this.ExpirationYear < (int)1980)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ExpirationYear, must be a value greater than or equal to 1980.", new [] { "ExpirationYear" });
            }
