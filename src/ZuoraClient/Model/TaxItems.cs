...
namespace ZuoraClient.Model
{
    ...
    /// TaxItems
    /// </summary>
    [DataContract(Name = "taxItems")]
    public partial class TaxItems : IEquatable<TaxItems>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TaxItems" /> class.
        /// </summary>
        ...
        public TaxItems(decimal exemptAmount = default(decimal), string jurisdiction = default(string), string locationCode = default(string), string name = default(string), decimal taxAmount = default(decimal), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), TaxModeEnum taxMode = default(TaxModeEnum), decimal taxRate = default(decimal), string taxRateDescription = default(string), TaxRateTypeEnum taxRateType = default(TaxRateTypeEnum))
        {
            ...
            if (taxCode == null)
            {
                throw new ArgumentNullException("taxCode is a required property for TaxItems and cannot be null");
            }
        ...
        {
            return this.Equals(input as TaxItems);
        }

        /// <summary>
        /// Returns true if TaxItems instances are equal
        /// </summary>
        /// <param name="input">Instance of TaxItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaxItems input)
        {
            if (input == null)
            {
                return false;
