...
namespace ZuoraClient.Model
{
    ...
    /// PostRefundType
    /// </summary>
    [DataContract(Name = "PostRefundType")]
    public partial class PostRefundType : IEquatable<PostRefundType>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>How an external refund was issued to a customer. This field is required for an external refund and must be left empty for an electronic refund. You can issue an external refund on an electronic payment. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostRefundType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostRefundType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostRefundType" /> class.
        /// </summary>
        ...
        /// <param name="methodType">How an external refund was issued to a customer. This field is required for an external refund and must be left empty for an electronic refund. You can issue an external refund on an electronic payment. .</param>
        ...
        /// <param name="refundDate">The date when the refund takes effect, in &#x60;yyyy-mm-dd&#x60; format. The date of the refund cannot be before the payment date. Specify this field only for external refunds. Zuora automatically generates this field for electronic refunds. .</param>
        ...
        /// <param name="totalAmount">The total amount of the refund. The amount cannot exceed the unapplied amount of the associated payment. If the original payment was applied to one or more invoices or debit memos, you have to unapply a full or partial payment from the invoices or debit memos, and then refund the full or partial unapplied payment to your customers.   (required).</param>
        ...
        public PostRefundTypeAllOfFinanceInformation FinanceInformation { get; set; }
        ...
        /// </summary>
        /// <value>The date when the refund takes effect, in &#x60;yyyy-mm-dd&#x60; format. The date of the refund cannot be before the payment date. Specify this field only for external refunds. Zuora automatically generates this field for electronic refunds. </value>
        ...
        /// </summary>
        /// <value>The total amount of the refund. The amount cannot exceed the unapplied amount of the associated payment. If the original payment was applied to one or more invoices or debit memos, you have to unapply a full or partial payment from the invoices or debit memos, and then refund the full or partial unapplied payment to your customers.  </value>
        ...
        {
            return this.Equals(input as PostRefundType);
        }

        /// <summary>
        /// Returns true if PostRefundType instances are equal
        /// </summary>
        /// <param name="input">Instance of PostRefundType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostRefundType input)
        {
            if (input == null)
            {
                return false;
