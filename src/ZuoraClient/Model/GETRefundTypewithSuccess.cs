...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRefundTypewithSuccess")]
    public partial class GETRefundTypewithSuccess : IEquatable<GETRefundTypewithSuccess>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRefundTypewithSuccess" /> class.
        /// </summary>
        /// <param name="accountId">The ID of the account associated with this refund. Zuora associates the refund automatically with the account from the associated payment or credit memo. .</param>
        ...
        /// <param name="creditMemoId">The ID of the credit memo that is refunded. .</param>
        ...
        /// <param name="refundDate">The date when the refund takes effect, in &#x60;yyyy-mm-dd&#x60; format. For example, 2017-03-01. .</param>
        ...
        /// <param name="softDescriptor">A payment gateway-specific field that maps Zuora to other gateways. .</param>
        /// <param name="softDescriptorPhone">A payment gateway-specific field that maps Zuora to other gateways. .</param>
        ...
        /// <param name="updatedById">The ID of the Zuora user who last updated the refund. .</param>
        ...
        /// </summary>
        /// <value>The ID of the account associated with this refund. Zuora associates the refund automatically with the account from the associated payment or credit memo. </value>
        ...
        /// </summary>
        /// <value>The ID of the credit memo that is refunded. </value>
        ...
        /// </summary>
        /// <value>The date when the refund takes effect, in &#x60;yyyy-mm-dd&#x60; format. For example, 2017-03-01. </value>
        ...
        /// </summary>
        /// <value>A payment gateway-specific field that maps Zuora to other gateways. </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who last updated the refund. </value>
        ...
        {
            return this.Equals(input as GETRefundTypewithSuccess);
        }

        /// <summary>
        /// Returns true if GETRefundTypewithSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRefundTypewithSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRefundTypewithSuccess input)
        {
            if (input == null)
            {
                return false;
