...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderLineItemCommonRetrieveOrder")]
    public partial class OrderLineItemCommonRetrieveOrder : IEquatable<OrderLineItemCommonRetrieveOrder>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderLineItemCommonRetrieveOrder" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OrderLineItemCommonRetrieveOrder);
        }

        /// <summary>
        /// Returns true if OrderLineItemCommonRetrieveOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderLineItemCommonRetrieveOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderLineItemCommonRetrieveOrder input)
        {
            if (input == null)
            {
                return false;
