...
namespace ZuoraClient.Model
{
    ...
    /// PUTScAddTypeAllOf
    /// </summary>
    [DataContract(Name = "PUTScAddType_allOf")]
    public partial class PUTScAddTypeAllOf : IEquatable<PUTScAddTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTScAddTypeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PUTScAddTypeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTScAddTypeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="includedUnits">Specifies the number of units in the base set of units for this charge. Must be &gt;&#x3D;&#x60;0&#x60;.  Available for the following charge type for the Overage charge model:  * Usage-based .</param>
        ...
        /// <param name="priceChangeOption">Applies an automatic price change when a termed subscription is renewed. The Zuora Billing Admin setting Enable Automatic Price Change When Subscriptions are Renewed?  must be set to Yes to use this field.  See Define Default Subscription Settings for more information on setting this option.  Values:  * &#x60;NoChange&#x60; (default) * &#x60;SpecificPercentageValue&#x60; * &#x60;UseLatestProductCatalogPricing&#x60;  Available for the following charge types:  * Recurring * Usage-based * Not available for the Fixed-Amount Discount charge model. .</param>
        ...
        /// <param name="productRatePlanChargeId">productRatePlanChargeId (required).</param>
        ...
        /// </summary>
        /// <value>Specifies the number of units in the base set of units for this charge. Must be &gt;&#x3D;&#x60;0&#x60;.  Available for the following charge type for the Overage charge model:  * Usage-based </value>
        ...
        /// </summary>
        /// <value>Applies an automatic price change when a termed subscription is renewed. The Zuora Billing Admin setting Enable Automatic Price Change When Subscriptions are Renewed?  must be set to Yes to use this field.  See Define Default Subscription Settings for more information on setting this option.  Values:  * &#x60;NoChange&#x60; (default) * &#x60;SpecificPercentageValue&#x60; * &#x60;UseLatestProductCatalogPricing&#x60;  Available for the following charge types:  * Recurring * Usage-based * Not available for the Fixed-Amount Discount charge model. </value>
        ...
        {
            return this.Equals(input as PUTScAddTypeAllOf);
        }

        /// <summary>
        /// Returns true if PUTScAddTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTScAddTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTScAddTypeAllOf input)
        {
            if (input == null)
            {
                return false;
