...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETARPaymentTypewithSuccess")]
    public partial class GETARPaymentTypewithSuccess : IEquatable<GETARPaymentTypewithSuccess>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETARPaymentTypewithSuccess" /> class.
        /// </summary>
        ...
        /// <param name="createdById">The ID of the Zuora user who created the payment part. .</param>
        ...
        /// <param name="gatewayOrderId">A merchant-specified natural key value that can be passed to the electronic payment gateway when a payment is created. .</param>
        ...
        /// <param name="id">The unique ID of the payment. For example, 4028905f5a87c0ff015a87eb6b75007f. .</param>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who created the payment part. </value>
        ...
        /// </summary>
        /// <value>A merchant-specified natural key value that can be passed to the electronic payment gateway when a payment is created. </value>
        ...
        /// </summary>
        /// <value>The unique ID of the payment. For example, 4028905f5a87c0ff015a87eb6b75007f. </value>
        ...
        {
            return this.Equals(input as GETARPaymentTypewithSuccess);
        }

        /// <summary>
        /// Returns true if GETARPaymentTypewithSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of GETARPaymentTypewithSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETARPaymentTypewithSuccess input)
        {
            if (input == null)
            {
                return false;
