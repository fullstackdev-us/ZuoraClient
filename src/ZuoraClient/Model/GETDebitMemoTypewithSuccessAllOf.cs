...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETDebitMemoTypewithSuccess_allOf")]
    public partial class GETDebitMemoTypewithSuccessAllOf : IEquatable<GETDebitMemoTypewithSuccessAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETDebitMemoTypewithSuccessAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETDebitMemoTypewithSuccessAllOf);
        }

        /// <summary>
        /// Returns true if GETDebitMemoTypewithSuccessAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETDebitMemoTypewithSuccessAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETDebitMemoTypewithSuccessAllOf input)
        {
            if (input == null)
            {
                return false;
