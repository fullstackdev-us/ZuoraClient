...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyCreateInvoiceItemAdjustment_allOf")]
    public partial class ProxyCreateInvoiceItemAdjustmentAllOf : IEquatable<ProxyCreateInvoiceItemAdjustmentAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateInvoiceItemAdjustmentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateInvoiceItemAdjustmentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateInvoiceItemAdjustmentAllOf" /> class.
        /// </summary>
        ...
        public ProxyCreateInvoiceItemAdjustmentAllOf(string accountingCode = default(string), DateTime adjustmentDate = default(DateTime), string adjustmentNumber = default(string), double amount = default(double), string comment = default(string), string createdById = default(string), string deferredRevenueAccount = default(string), bool excludeItemBillingFromRevenueAccounting = false, string invoiceId = default(string), string invoiceNumber = default(string), string reasonCode = default(string), string recognizedRevenueAccount = default(string), string referenceId = default(string), string sourceId = default(string), string sourceType = default(string), TypeEnum type = default(TypeEnum))
        {
            ...
            if (invoiceId == null)
            {
                throw new ArgumentNullException("invoiceId is a required property for ProxyCreateInvoiceItemAdjustmentAllOf and cannot be null");
            }
            this.InvoiceId = invoiceId;
            // to ensure "invoiceNumber" is required (not null)
            if (invoiceNumber == null)
            {
                throw new ArgumentNullException("invoiceNumber is a required property for ProxyCreateInvoiceItemAdjustmentAllOf and cannot be null");
            }
            this.InvoiceNumber = invoiceNumber;
            // to ensure "sourceId" is required (not null)
            if (sourceId == null)
            {
                throw new ArgumentNullException("sourceId is a required property for ProxyCreateInvoiceItemAdjustmentAllOf and cannot be null");
            }
            this.SourceId = sourceId;
            // to ensure "sourceType" is required (not null)
            if (sourceType == null)
            {
                throw new ArgumentNullException("sourceType is a required property for ProxyCreateInvoiceItemAdjustmentAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyCreateInvoiceItemAdjustmentAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyCreateInvoiceItemAdjustmentAllOf);
        }

        /// <summary>
        /// Returns true if ProxyCreateInvoiceItemAdjustmentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreateInvoiceItemAdjustmentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateInvoiceItemAdjustmentAllOf input)
        {
            if (input == null)
            {
                return false;
