...
namespace ZuoraClient.Model
{
    ...
    /// PutDiscountItemType
    /// </summary>
    [DataContract(Name = "PutDiscountItemType")]
    public partial class PutDiscountItemType : IEquatable<PutDiscountItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutDiscountItemType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutDiscountItemType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutDiscountItemType" /> class.
        /// </summary>
        ...
        /// <param name="chargeName">The name of the charge associated with the discount item. This field is required if the &#x60;productRatePlanChargeId&#x60; field is not specified in the request. .</param>
        ...
        /// <param name="id">The unique ID of the discount item. .</param>
        ...
        public PutDiscountItemType(string accountingCode = default(string), string adjustmentLiabilityAccountingCode = default(string), string adjustmentRevenueAccountingCode = default(string), decimal amount = default(decimal), string bookingReference = default(string), DateTime chargeDate = default(DateTime), string chargeName = default(string), string contractAssetAccountingCode = default(string), string contractLiabilityAccountingCode = default(string), string contractRecognizedRevenueAccountingCode = default(string), string deferredRevenueAccountingCode = default(string), string description = default(string), string id = default(string), string itemType = default(string), string purchaseOrderNumber = default(string), string recognizedRevenueAccountingCode = default(string), string revRecCode = default(string), RevRecTriggerConditionEnum? revRecTriggerCondition = default(RevRecTriggerConditionEnum?), string revenueRecognitionRuleName = default(string), string sku = default(string), string unbilledReceivablesAccountingCode = default(string), decimal unitPrice = default(decimal), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>The name of the charge associated with the discount item. This field is required if the &#x60;productRatePlanChargeId&#x60; field is not specified in the request. </value>
        ...
        /// </summary>
        /// <value>The unique ID of the discount item. </value>
        ...
        {
            return this.Equals(input as PutDiscountItemType);
        }

        /// <summary>
        /// Returns true if PutDiscountItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of PutDiscountItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutDiscountItemType input)
        {
            if (input == null)
            {
                return false;
