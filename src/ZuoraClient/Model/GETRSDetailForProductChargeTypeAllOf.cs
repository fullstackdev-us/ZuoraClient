...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRSDetailForProductChargeType_allOf")]
    public partial class GETRSDetailForProductChargeTypeAllOf : IEquatable<GETRSDetailForProductChargeTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRSDetailForProductChargeTypeAllOf" /> class.
        /// </summary>
        /// <param name="accountId">The ID of a customer account. .</param>
        ...
        /// <param name="createdOn">The date and time when the record was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        ...
        /// <param name="linkedTransactionNumber">The number for the linked invoice item, invoice item adjustment, or debit memo item transaction. This field is used for all rules except for the custom unlimited or manual recognition rule models. If using the custom unlimited or manual recognition rule models, then the field value is null. .</param>
        /// <param name="linkedTransactionType">The type of linked transaction for billing transactions, which can be invoice item, invoice item adjustment, or debit memo item. This field is used for all rules except for the custom unlimited or manual recognition rule models. .</param>
        /// <param name="notes">Additional information about this record. .</param>
        /// <param name="number">The revenue schedule number. The revenue schedule number is always prefixed with \&quot;RS\&quot;, for example, \&quot;RS-00000001\&quot;. .</param>
        /// <param name="productChargeId">The ID of a product rate plan charge. .</param>
        ...
        /// <param name="referenceId">The reference ID is used only in the custom unlimited rule to create a revenue schedule. In this scenario, the revenue schedule is not linked to a credit memo item. .</param>
        /// <param name="revenueItems">Revenue items are listed in ascending order by the accounting period start date. .</param>
        /// <param name="revenueScheduleDate">The effective date of the revenue schedule. For example, the revenue schedule date for bookings-based revenue recognition is typically set to the order date or contract date.  The date cannot be in a closed accounting period. The date must be in &#x60;yyyy-mm-dd&#x60; format. .</param>
        /// <param name="undistributedUnrecognizedRevenue">The revenue in the open-ended accounting period. .</param>
        /// <param name="unrecognizedRevenue">The revenue distributed in all open accounting periods, which includes the open-ended accounting period. .</param>
        /// <param name="updatedOn">The date and time when the revenue automation start date was set, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        public GETRSDetailForProductChargeTypeAllOf(string accountId = default(string), string amount = default(string), DateTime createdOn = default(DateTime), string currency = default(string), string linkedTransactionId = default(string), string linkedTransactionNumber = default(string), string linkedTransactionType = default(string), string notes = default(string), string number = default(string), string productChargeId = default(string), string recognitionRuleName = default(string), string recognizedRevenue = default(string), string referenceId = default(string), List<GETRsRevenueItemType> revenueItems = default(List<GETRsRevenueItemType>), DateTime revenueScheduleDate = default(DateTime), string undistributedUnrecognizedRevenue = default(string), string unrecognizedRevenue = default(string), DateTime updatedOn = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The ID of a customer account. </value>
        ...
        /// </summary>
        /// <value>The date and time when the record was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The linked transaction ID for billing transactions. This field is used for all rules except for the custom unlimited or manual recognition rule models. If using the custom unlimited rule model, then the field value must be null. If the field is not null, then the referenceId field must be null. </value>
        ...
        /// </summary>
        /// <value>The number for the linked invoice item, invoice item adjustment, or debit memo item transaction. This field is used for all rules except for the custom unlimited or manual recognition rule models. If using the custom unlimited or manual recognition rule models, then the field value is null. </value>
        ...
        /// </summary>
        /// <value>The type of linked transaction for billing transactions, which can be invoice item, invoice item adjustment, or debit memo item. This field is used for all rules except for the custom unlimited or manual recognition rule models. </value>
        ...
        /// </summary>
        /// <value>The revenue schedule number. The revenue schedule number is always prefixed with \&quot;RS\&quot;, for example, \&quot;RS-00000001\&quot;. </value>
        ...
        /// </summary>
        /// <value>The ID of a product rate plan charge. </value>
        [DataMember(Name = "productChargeId", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The reference ID is used only in the custom unlimited rule to create a revenue schedule. In this scenario, the revenue schedule is not linked to a credit memo item. </value>
        ...
        /// </summary>
        /// <value>The effective date of the revenue schedule. For example, the revenue schedule date for bookings-based revenue recognition is typically set to the order date or contract date.  The date cannot be in a closed accounting period. The date must be in &#x60;yyyy-mm-dd&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The revenue in the open-ended accounting period. </value>
        ...
        /// </summary>
        /// <value>The revenue distributed in all open accounting periods, which includes the open-ended accounting period. </value>
        ...
        /// </summary>
        /// <value>The date and time when the revenue automation start date was set, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETRSDetailForProductChargeTypeAllOf {\n");
            ...
            sb.Append("  ProductChargeId: ").Append(ProductChargeId).Append("\n");
        ...
        {
            return this.Equals(input as GETRSDetailForProductChargeTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETRSDetailForProductChargeTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRSDetailForProductChargeTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRSDetailForProductChargeTypeAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LinkedTransactionNumber == input.LinkedTransactionNumber ||
                    (this.LinkedTransactionNumber != null &&
                    this.LinkedTransactionNumber.Equals(input.LinkedTransactionNumber))
                ) && 
                (
                    this.LinkedTransactionType == input.LinkedTransactionType ||
                    (this.LinkedTransactionType != null &&
                    this.LinkedTransactionType.Equals(input.LinkedTransactionType))
                ) && 
                (
                ...
                (
                    this.ProductChargeId == input.ProductChargeId ||
                    (this.ProductChargeId != null &&
                    this.ProductChargeId.Equals(input.ProductChargeId))
                ) && 
                (
                    this.RecognitionRuleName == input.RecognitionRuleName ||
                    (this.RecognitionRuleName != null &&
                    this.RecognitionRuleName.Equals(input.RecognitionRuleName))
                ) && 
                (
                    this.RecognizedRevenue == input.RecognizedRevenue ||
                    (this.RecognizedRevenue != null &&
                    this.RecognizedRevenue.Equals(input.RecognizedRevenue))
                ) && 
                (
                ...
                (
                    this.RevenueItems == input.RevenueItems ||
                    this.RevenueItems != null &&
                    input.RevenueItems != null &&
                    this.RevenueItems.SequenceEqual(input.RevenueItems)
                ) && 
                (
                    this.RevenueScheduleDate == input.RevenueScheduleDate ||
                    (this.RevenueScheduleDate != null &&
                    this.RevenueScheduleDate.Equals(input.RevenueScheduleDate))
                ) && 
                (
                    this.UndistributedUnrecognizedRevenue == input.UndistributedUnrecognizedRevenue ||
                    (this.UndistributedUnrecognizedRevenue != null &&
                    this.UndistributedUnrecognizedRevenue.Equals(input.UndistributedUnrecognizedRevenue))
                ) && 
                (
                    this.UnrecognizedRevenue == input.UnrecognizedRevenue ||
                    (this.UnrecognizedRevenue != null &&
                    this.UnrecognizedRevenue.Equals(input.UnrecognizedRevenue))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.LinkedTransactionNumber.GetHashCode();
                }
                if (this.LinkedTransactionType != null)
                {
                    hashCode = (hashCode * 59) + this.LinkedTransactionType.GetHashCode();
                }
                if (this.Notes != null)
                {
                ...
                if (this.ProductChargeId != null)
                {
                    hashCode = (hashCode * 59) + this.ProductChargeId.GetHashCode();
                }
                if (this.RecognitionRuleName != null)
                {
                    hashCode = (hashCode * 59) + this.RecognitionRuleName.GetHashCode();
                }
                if (this.RecognizedRevenue != null)
                {
                    hashCode = (hashCode * 59) + this.RecognizedRevenue.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.RevenueItems.GetHashCode();
                }
                if (this.RevenueScheduleDate != null)
                {
                    hashCode = (hashCode * 59) + this.RevenueScheduleDate.GetHashCode();
                }
                if (this.UndistributedUnrecognizedRevenue != null)
                {
                    hashCode = (hashCode * 59) + this.UndistributedUnrecognizedRevenue.GetHashCode();
                }
                if (this.UnrecognizedRevenue != null)
                {
                    hashCode = (hashCode * 59) + this.UnrecognizedRevenue.GetHashCode();
                }
