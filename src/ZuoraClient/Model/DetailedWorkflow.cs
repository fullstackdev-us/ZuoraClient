...
namespace ZuoraClient.Model
{
    ...
    /// A workflow. 
    /// </summary>
    [DataContract(Name = "DetailedWorkflow")]
    public partial class DetailedWorkflow : IEquatable<DetailedWorkflow>, IValidatableObject
    {
        /// <summary>
        /// The type of the workflow. Currently the only valid value is &#39;Workflow::Setup&#39;. 
        /// </summary>
        /// <value>The type of the workflow. Currently the only valid value is &#39;Workflow::Setup&#39;. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum TypeEnum
        {
            /// <summary>
            /// Enum Setup for value: Workflow::Setup
            /// </summary>
            [EnumMember(Value = "Workflow::Setup")]
            Setup = 1,

            /// <summary>
            /// Enum Instance for value: Workflow::Instance
            /// </summary>
            [EnumMember(Value = "Workflow::Instance")]
            Instance = 2
        ...
        /// </summary>
        /// <param name="callType">The call type of the active workflow version. .</param>
        /// <param name="calloutTrigger">Indicates whether the callout trigger is enabled for the retrieved workflow. .</param>
        /// <param name="createdAt">The date and time when the workflow is created, in the &#x60;YYYY-MM-DD HH:MM:SS&#x60; format. .</param>
        /// <param name="description">The description of the workflow. .</param>
        /// <param name="finishedAt">The date and time when the instance of the workflow version finished at. .</param>
        /// <param name="id">The unique ID of the workflow. .</param>
        /// <param name="interval">The schedule of the workflow, in a CRON expression. Returns null if the schedued trigger is disabled. .</param>
        /// <param name="name">The name of the workflow. .</param>
        /// <param name="ondemandTrigger">Indicates whether the ondemand trigger is enabled for the workflow. .</param>
        /// <param name="originalWorkflowId">The unique ID of the original workflow version. .</param>
        /// <param name="priority">The priority of the active workflow version.  .</param>
        /// <param name="scheduledTrigger">Indicates whether the scheduled trigger is enabled for the workflow. .</param>
        /// <param name="startedAt">The date and time when the instance of the workflow version started at. .</param>
        /// <param name="status">The status of the active workflow version. .</param>
        /// <param name="syncTrigger">Indicates whether the workflow version is enabled for the sync mode. .</param>
        /// <param name="timezone">The timezone that is configured for the scheduler of the workflow. Returns null if the scheduled trigger is disabled. .</param>
        /// <param name="type">The type of the workflow. Currently the only valid value is &#39;Workflow::Setup&#39;. .</param>
        /// <param name="updatedAt">The date and time when the workflow is updated the last time, in the &#x60;YYYY-MM-DD HH:MM:SS&#x60; format. .</param>
        /// <param name="version">The version number of the active workflow version.             .</param>
        public DetailedWorkflow(string callType = default(string), bool calloutTrigger = default(bool), string createdAt = default(string), string description = default(string), string finishedAt = default(string), int id = default(int), string interval = default(string), string name = default(string), bool ondemandTrigger = default(bool), int originalWorkflowId = default(int), string priority = default(string), bool scheduledTrigger = default(bool), string startedAt = default(string), int status = default(int), bool syncTrigger = default(bool), string timezone = default(string), TypeEnum? type = default(TypeEnum?), string updatedAt = default(string), string version = default(string))
        {
        ...
        /// </summary>
        /// <value>The call type of the active workflow version. </value>
        ...
        /// </summary>
        /// <value>Indicates whether the callout trigger is enabled for the retrieved workflow. </value>
        [DataMember(Name = "calloutTrigger", EmitDefaultValue = true)]
        public bool CalloutTrigger { get; set; }

        /// <summary>
        /// The date and time when the workflow is created, in the &#x60;YYYY-MM-DD HH:MM:SS&#x60; format. 
        /// </summary>
        /// <value>The date and time when the workflow is created, in the &#x60;YYYY-MM-DD HH:MM:SS&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The date and time when the instance of the workflow version finished at. </value>
        ...
        /// </summary>
        /// <value>The unique ID of the workflow. </value>
        ...
        /// </summary>
        /// <value>The schedule of the workflow, in a CRON expression. Returns null if the schedued trigger is disabled. </value>
        ...
        /// </summary>
        /// <value>Indicates whether the ondemand trigger is enabled for the workflow. </value>
        [DataMember(Name = "ondemandTrigger", EmitDefaultValue = true)]
        public bool OndemandTrigger { get; set; }

        /// <summary>
        /// The unique ID of the original workflow version. 
        /// </summary>
        /// <value>The unique ID of the original workflow version. </value>
        ...
        /// </summary>
        /// <value>The priority of the active workflow version.  </value>
        ...
        /// </summary>
        /// <value>Indicates whether the scheduled trigger is enabled for the workflow. </value>
        [DataMember(Name = "scheduledTrigger", EmitDefaultValue = true)]
        public bool ScheduledTrigger { get; set; }

        /// <summary>
        /// The date and time when the instance of the workflow version started at. 
        /// </summary>
        /// <value>The date and time when the instance of the workflow version started at. </value>
        ...
        /// </summary>
        /// <value>The status of the active workflow version. </value>
        ...
        /// </summary>
        /// <value>Indicates whether the workflow version is enabled for the sync mode. </value>
        [DataMember(Name = "sync_trigger", EmitDefaultValue = true)]
        public bool SyncTrigger { get; set; }

        /// <summary>
        /// The timezone that is configured for the scheduler of the workflow. Returns null if the scheduled trigger is disabled. 
        /// </summary>
        /// <value>The timezone that is configured for the scheduler of the workflow. Returns null if the scheduled trigger is disabled. </value>
        ...
        /// </summary>
        /// <value>The date and time when the workflow is updated the last time, in the &#x60;YYYY-MM-DD HH:MM:SS&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The version number of the active workflow version.             </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CalloutTrigger: ").Append(CalloutTrigger).Append("\n");
            ...
            sb.Append("  OndemandTrigger: ").Append(OndemandTrigger).Append("\n");
            sb.Append("  OriginalWorkflowId: ").Append(OriginalWorkflowId).Append("\n");
            sb.Append("  Priority: ").Append(Priority).Append("\n");
            sb.Append("  ScheduledTrigger: ").Append(ScheduledTrigger).Append("\n");
            sb.Append("  StartedAt: ").Append(StartedAt).Append("\n");
            sb.Append("  Status: ").Append(Status).Append("\n");
            sb.Append("  SyncTrigger: ").Append(SyncTrigger).Append("\n");
        ...
        {
            return this.Equals(input as DetailedWorkflow);
        }

        /// <summary>
        /// Returns true if DetailedWorkflow instances are equal
        /// </summary>
        /// <param name="input">Instance of DetailedWorkflow to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetailedWorkflow input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CalloutTrigger == input.CalloutTrigger ||
                    this.CalloutTrigger.Equals(input.CalloutTrigger)
                ) && 
                (
                ...
                (
                    this.OndemandTrigger == input.OndemandTrigger ||
                    this.OndemandTrigger.Equals(input.OndemandTrigger)
                ) && 
                (
                ...
                (
                    this.ScheduledTrigger == input.ScheduledTrigger ||
                    this.ScheduledTrigger.Equals(input.ScheduledTrigger)
                ) && 
                (
                ...
                (
                    this.SyncTrigger == input.SyncTrigger ||
                    this.SyncTrigger.Equals(input.SyncTrigger)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CalloutTrigger.GetHashCode();
                ...
                hashCode = (hashCode * 59) + this.OndemandTrigger.GetHashCode();
                hashCode = (hashCode * 59) + this.OriginalWorkflowId.GetHashCode();
                if (this.Priority != null)
                {
                    hashCode = (hashCode * 59) + this.Priority.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.ScheduledTrigger.GetHashCode();
                if (this.StartedAt != null)
                {
                    hashCode = (hashCode * 59) + this.StartedAt.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.Status.GetHashCode();
                hashCode = (hashCode * 59) + this.SyncTrigger.GetHashCode();
