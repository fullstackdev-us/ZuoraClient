...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetInvoiceItem_allOf")]
    public partial class ProxyGetInvoiceItemAllOf : IEquatable<ProxyGetInvoiceItemAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetInvoiceItemAllOf" /> class.
        /// </summary>
        ...
        /// <param name="appliedToInvoiceItemId"> Associates a discount invoice item to a specific invoice item.  **Character limit**: 32  **Values**: inherited from &#x60;InvoiceItem.Id&#x60; for the invoice item that the discount charge is applied to .</param>
        ...
        /// <param name="excludeItemBillingFromRevenueAccounting"> Whether excluding item from revenue accounting. The flag to exclude non-revenue related invoice items, invoice item adjustments, credit memo items, and debit memo items from revenue accounting. **Note**: This field is only available if you have the RevPro Integration feature enabled. And you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;116&#x60; or later. Otherwise, an error occurs. **Character limit**: 8 **Values**: Default value is false, inherited from order line item. .</param>
        ...
        /// <param name="productDescription"> A description of the product associated with this invoice item.  **Character limit**: 500  **Values**: inherited from &#x60;Product.Description&#x60;  **Note**: This value changes if &#x60;Product.Description&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;InvoiceItem&#x60; do not change when &#x60;Product.Description&#x60; is updated. .</param>
        /// <param name="productName"> The name of the product associated with this invoice item.  **Character limit**: 255  **Values**: inherited from &#x60;Product.Name&#x60;  **Note**: This value changes if &#x60;Product.Name&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;InvoiceItem&#x60; do not change when &#x60;Product.Name&#x60; is updated. .</param>
        ...
        /// <param name="sourceItemType"> The type of the source item. **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;118&#x60; or later. Otherwise, an error occurs. **Character limit**: 16 **Values**: one of the following enum values:  -  SubscriptionComponent  -  Rounding  -  ProductRatePlanCharge  -  None  -  OrderLineItem .</param>
        ...
        /// <param name="taxExemptAmount"> The calculated tax amount excluded due to the exemption. **Character limit**: **Values**: calculated from multiple fields in the ProductRatePlanCharge object .</param>
        /// <param name="taxMode"> The tax mode of the invoice item. **Character limit**: 12 **Values**: &#x60;TaxExclusive&#x60;, &#x60;TaxInclusive&#x60; .</param>
        /// <param name="uOM"> Specifies the units to measure usage. **Character limit**: **Values**: inherited from &#x60;ProductRatePlanCharge.UOM&#x60; .</param>
        ...
        public ProxyGetInvoiceItemAllOf(string accountingCode = default(string), string appliedToInvoiceItemId = default(string), double chargeAmount = default(double), DateTime chargeDate = default(DateTime), string chargeName = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), bool excludeItemBillingFromRevenueAccounting = default(bool), string id = default(string), string invoiceId = default(string), double processingType = default(double), string productDescription = default(string), string productName = default(string), double quantity = default(double), string ratePlanChargeId = default(string), DateTime revRecStartDate = default(DateTime), string sKU = default(string), DateTime serviceEndDate = default(DateTime), DateTime serviceStartDate = default(DateTime), string sourceItemType = default(string), string subscriptionId = default(string), double taxAmount = default(double), string taxCode = default(string), double taxExemptAmount = default(double), string taxMode = default(string), string uOM = default(string), double unitPrice = default(double), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value> Associates a discount invoice item to a specific invoice item.  **Character limit**: 32  **Values**: inherited from &#x60;InvoiceItem.Id&#x60; for the invoice item that the discount charge is applied to </value>
        ...
        /// <summary>
        ///  Whether excluding item from revenue accounting. The flag to exclude non-revenue related invoice items, invoice item adjustments, credit memo items, and debit memo items from revenue accounting. **Note**: This field is only available if you have the RevPro Integration feature enabled. And you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;116&#x60; or later. Otherwise, an error occurs. **Character limit**: 8 **Values**: Default value is false, inherited from order line item. 
        /// </summary>
        /// <value> Whether excluding item from revenue accounting. The flag to exclude non-revenue related invoice items, invoice item adjustments, credit memo items, and debit memo items from revenue accounting. **Note**: This field is only available if you have the RevPro Integration feature enabled. And you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;116&#x60; or later. Otherwise, an error occurs. **Character limit**: 8 **Values**: Default value is false, inherited from order line item. </value>
        ...
        /// </summary>
        /// <value> A description of the product associated with this invoice item.  **Character limit**: 500  **Values**: inherited from &#x60;Product.Description&#x60;  **Note**: This value changes if &#x60;Product.Description&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;InvoiceItem&#x60; do not change when &#x60;Product.Description&#x60; is updated. </value>
        ...
        /// </summary>
        /// <value> The name of the product associated with this invoice item.  **Character limit**: 255  **Values**: inherited from &#x60;Product.Name&#x60;  **Note**: This value changes if &#x60;Product.Name&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;InvoiceItem&#x60; do not change when &#x60;Product.Name&#x60; is updated. </value>
        ...
        /// <summary>
        ///  The type of the source item. **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;118&#x60; or later. Otherwise, an error occurs. **Character limit**: 16 **Values**: one of the following enum values:  -  SubscriptionComponent  -  Rounding  -  ProductRatePlanCharge  -  None  -  OrderLineItem 
        /// </summary>
        /// <value> The type of the source item. **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;118&#x60; or later. Otherwise, an error occurs. **Character limit**: 16 **Values**: one of the following enum values:  -  SubscriptionComponent  -  Rounding  -  ProductRatePlanCharge  -  None  -  OrderLineItem </value>
        ...
        /// <summary>
        ///  The calculated tax amount excluded due to the exemption. **Character limit**: **Values**: calculated from multiple fields in the ProductRatePlanCharge object 
        /// </summary>
        /// <value> The calculated tax amount excluded due to the exemption. **Character limit**: **Values**: calculated from multiple fields in the ProductRatePlanCharge object </value>
        ...
        /// </summary>
        /// <value> Specifies the units to measure usage. **Character limit**: **Values**: inherited from &#x60;ProductRatePlanCharge.UOM&#x60; </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetInvoiceItemAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetInvoiceItemAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetInvoiceItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetInvoiceItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetInvoiceItemAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AppliedToInvoiceItemId == input.AppliedToInvoiceItemId ||
                    (this.AppliedToInvoiceItemId != null &&
                    this.AppliedToInvoiceItemId.Equals(input.AppliedToInvoiceItemId))
                ) && 
                (
                ...
                (
                    this.RevRecStartDate == input.RevRecStartDate ||
                    (this.RevRecStartDate != null &&
                    this.RevRecStartDate.Equals(input.RevRecStartDate))
                ) && 
                (
                    this.SKU == input.SKU ||
                    (this.SKU != null &&
                ...
                (
                    this.TaxExemptAmount == input.TaxExemptAmount ||
                    this.TaxExemptAmount.Equals(input.TaxExemptAmount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AppliedToInvoiceItemId.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.RevRecStartDate.GetHashCode();
                }
                if (this.SKU != null)
                {
                ...
                hashCode = (hashCode * 59) + this.TaxExemptAmount.GetHashCode();
