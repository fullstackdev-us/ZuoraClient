...
namespace ZuoraClient.Model
{
    ...
    /// ProxyModifyPayment
    /// </summary>
    [DataContract(Name = "ProxyModifyPayment")]
    public partial class ProxyModifyPayment : IEquatable<ProxyModifyPayment>, IValidatableObject
    {
        /// <summary>
        /// The updated status of the payment. The value depends on the type of payment.  - For Electronic payment, the available value is &#x60;Voided&#x60;. - For External payment, the available value is &#x60;Canceled&#x60;. 
        /// </summary>
        /// <value>The updated status of the payment. The value depends on the type of payment.  - For Electronic payment, the available value is &#x60;Voided&#x60;. - For External payment, the available value is &#x60;Canceled&#x60;. </value>
        ...
        /// </summary>
        /// <value>Whether the refund was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="status">The updated status of the payment. The value depends on the type of payment.  - For Electronic payment, the available value is &#x60;Voided&#x60;. - For External payment, the available value is &#x60;Canceled&#x60;. .</param>
        /// <param name="transferredToAccounting">Whether the refund was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite. .</param>
        ...
        public ProxyModifyPayment(string accountId = default(string), string accountingCode = default(string), double amount = default(double), DateTime effectiveDate = default(DateTime), string paymentMethodId = default(string), string referenceId = default(string), StatusEnum? status = default(StatusEnum?), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), TypeEnum? type = default(TypeEnum?), string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string transactionNS = default(string))
        {
        ...
        {
            return this.Equals(input as ProxyModifyPayment);
        }

        /// <summary>
        /// Returns true if ProxyModifyPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyModifyPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyPayment input)
        {
            if (input == null)
            {
                return false;
