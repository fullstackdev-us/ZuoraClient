...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PutInvoiceItemType_allOf")]
    public partial class PutInvoiceItemTypeAllOf : IEquatable<PutInvoiceItemTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutInvoiceItemTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PutInvoiceItemTypeAllOf);
        }

        /// <summary>
        /// Returns true if PutInvoiceItemTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutInvoiceItemTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutInvoiceItemTypeAllOf input)
        {
            if (input == null)
            {
                return false;
