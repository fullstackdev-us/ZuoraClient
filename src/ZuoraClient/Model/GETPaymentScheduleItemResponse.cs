...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETPaymentScheduleItemResponse")]
    public partial class GETPaymentScheduleItemResponse : IEquatable<GETPaymentScheduleItemResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETPaymentScheduleItemResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETPaymentScheduleItemResponse);
        }

        /// <summary>
        /// Returns true if GETPaymentScheduleItemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GETPaymentScheduleItemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPaymentScheduleItemResponse input)
        {
            if (input == null)
            {
                return false;
