...
{
    /// <summary>
    /// RatePlanChargeDataRatePlanChargeAllOf
    /// </summary>
    [DataContract(Name = "RatePlanChargeDataRatePlanCharge_allOf")]
    public partial class RatePlanChargeDataRatePlanChargeAllOf : IEquatable<RatePlanChargeDataRatePlanChargeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RatePlanChargeDataRatePlanChargeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RatePlanChargeDataRatePlanChargeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RatePlanChargeDataRatePlanChargeAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RatePlanChargeDataRatePlanChargeAllOf {\n");
        ...
        {
            return this.Equals(input as RatePlanChargeDataRatePlanChargeAllOf);
        }

        /// <summary>
        /// Returns true if RatePlanChargeDataRatePlanChargeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of RatePlanChargeDataRatePlanChargeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RatePlanChargeDataRatePlanChargeAllOf input)
        {
            if (input == null)
            {
                return false;
