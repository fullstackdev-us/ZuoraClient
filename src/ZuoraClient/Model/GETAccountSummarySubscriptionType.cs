...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountSummarySubscriptionType")]
    public partial class GETAccountSummarySubscriptionType : IEquatable<GETAccountSummarySubscriptionType>, IValidatableObject
    {
        ...
        public GETAccountSummarySubscriptionType(bool autoRenew = default(bool), string id = default(string), string initialTerm = default(string), List<GETAccountSummarySubscriptionRatePlanType> ratePlans = default(List<GETAccountSummarySubscriptionRatePlanType>), string renewalTerm = default(string), string status = default(string), string subscriptionNumber = default(string), DateTime subscriptionStartDate = default(DateTime), DateTime termEndDate = default(DateTime), DateTime termStartDate = default(DateTime), string termType = default(string), string cpqBundleJsonIdQT = default(string), DateTime opportunityCloseDateQT = default(DateTime), string opportunityNameQT = default(string), string quoteBusinessTypeQT = default(string), string quoteNumberQT = default(string), string quoteTypeQT = default(string), string integrationIdNS = default(string), string integrationStatusNS = default(string), string projectNS = default(string), string salesOrderNS = default(string), string syncDateNS = default(string))
        {
        ...
        {
            return this.Equals(input as GETAccountSummarySubscriptionType);
        }

        /// <summary>
        /// Returns true if GETAccountSummarySubscriptionType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountSummarySubscriptionType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummarySubscriptionType input)
        {
            if (input == null)
            {
                return false;
