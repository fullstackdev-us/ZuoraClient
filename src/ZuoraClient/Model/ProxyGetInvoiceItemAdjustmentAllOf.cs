...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetInvoiceItemAdjustment_allOf")]
    public partial class ProxyGetInvoiceItemAdjustmentAllOf : IEquatable<ProxyGetInvoiceItemAdjustmentAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetInvoiceItemAdjustmentAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetInvoiceItemAdjustmentAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetInvoiceItemAdjustmentAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetInvoiceItemAdjustmentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetInvoiceItemAdjustmentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetInvoiceItemAdjustmentAllOf input)
        {
            if (input == null)
            {
                return false;
