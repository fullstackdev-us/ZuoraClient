...
{
    /// <summary>
    /// ProxyModifyPaymentMethodAllOf
    /// </summary>
    [DataContract(Name = "ProxyModifyPaymentMethod_allOf")]
    public partial class ProxyModifyPaymentMethodAllOf : IEquatable<ProxyModifyPaymentMethodAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyPaymentMethodAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyModifyPaymentMethodAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyModifyPaymentMethodAllOf);
        }

        /// <summary>
        /// Returns true if ProxyModifyPaymentMethodAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyModifyPaymentMethodAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyPaymentMethodAllOf input)
        {
            if (input == null)
            {
                return false;
