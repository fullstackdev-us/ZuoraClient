...
namespace ZuoraClient.Model
{
    ...
    /// ProxyModifyContact
    /// </summary>
    [DataContract(Name = "ProxyModifyContact")]
    public partial class ProxyModifyContact : IEquatable<ProxyModifyContact>, IValidatableObject
    {
        ...
        public ProxyModifyContact(string accountId = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string description = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickName = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string postalCode = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string))
        {
        ...
        {
            return this.Equals(input as ProxyModifyContact);
        }

        /// <summary>
        /// Returns true if ProxyModifyContact instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyModifyContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyContact input)
        {
            if (input == null)
            {
                return false;
