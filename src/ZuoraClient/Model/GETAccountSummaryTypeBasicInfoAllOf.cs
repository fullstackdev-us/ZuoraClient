...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountSummaryTypeBasicInfo_allOf")]
    public partial class GETAccountSummaryTypeBasicInfoAllOf : IEquatable<GETAccountSummaryTypeBasicInfoAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountSummaryTypeBasicInfoAllOf" /> class.
        /// </summary>
        /// <param name="accountNumber">Account number. .</param>
        /// <param name="additionalEmailAddresses">A list of additional email addresses to receive email notifications. .</param>
        ...
        /// <param name="currency">A currency as defined in Billing Settings in the Zuora UI. .</param>
        /// <param name="defaultPaymentMethod">defaultPaymentMethod.</param>
        /// <param name="id">Account ID. .</param>
        /// <param name="invoiceDeliveryPrefsEmail">Whether the customer wants to receive invoices through email.  .</param>
        /// <param name="invoiceDeliveryPrefsPrint">Whether the customer wants to receive printed invoices, such as through postal mail. .</param>
        ...
        public GETAccountSummaryTypeBasicInfoAllOf(string accountNumber = default(string), List<string> additionalEmailAddresses = default(List<string>), decimal balance = default(decimal), string batch = default(string), string billCycleDay = default(string), string currency = default(string), GETAccountSummaryTypeBasicInfoAllOfDefaultPaymentMethod defaultPaymentMethod = default(GETAccountSummaryTypeBasicInfoAllOfDefaultPaymentMethod), string id = default(string), bool invoiceDeliveryPrefsEmail = default(bool), bool invoiceDeliveryPrefsPrint = default(bool), DateTime lastInvoiceDate = default(DateTime), decimal lastPaymentAmount = default(decimal), DateTime lastPaymentDate = default(DateTime), string name = default(string), string status = default(string), string tags = default(string))
        {
        ...
        /// </summary>
        /// <value>A currency as defined in Billing Settings in the Zuora UI. </value>
        ...
        public GETAccountSummaryTypeBasicInfoAllOfDefaultPaymentMethod DefaultPaymentMethod { get; set; }
        ...
        {
            return this.Equals(input as GETAccountSummaryTypeBasicInfoAllOf);
        }

        /// <summary>
        /// Returns true if GETAccountSummaryTypeBasicInfoAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountSummaryTypeBasicInfoAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummaryTypeBasicInfoAllOf input)
        {
            if (input == null)
            {
                return false;
