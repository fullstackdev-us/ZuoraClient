...
{
    /// <summary>
    /// ProxyGetRatePlanChargeAllOf
    /// </summary>
    [DataContract(Name = "ProxyGetRatePlanCharge_allOf")]
    public partial class ProxyGetRatePlanChargeAllOf : IEquatable<ProxyGetRatePlanChargeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetRatePlanChargeAllOf" /> class.
        /// </summary>
        /// <param name="accountingCode">The accounting code for the charge. Accounting codes group transactions that contain similar accounting attributes.  **Character limit**: 100  **Values**: inherited from &#x60;ProductRatePlanCharge.AccountingCode&#x60;  **Note**: This value changes if &#x60;ProductRatePlanCharge.AccountingCode&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;RatePlanCharge&#x60; do not change when &#x60;ProductRatePlanCharge.AccountingCode&#x60; is updated. .</param>
        ...
        /// <param name="excludeItemBookingFromRevenueAccounting">The flag to exclude rate plan charges from revenue accounting.  **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;115&#x60; or later. Otherwise, an error occurs.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.  .</param>
        ...
        /// <param name="priceIncreasePercentage"> Specifies the percentage to increase or decrease the price of renewed subscriptions. **Character limit**: 16 **Values**: a decimal value between -100 and 100 .</param>
        ...
        /// <param name="triggerDate"> The date when the charge becomes effective and billing begins, in &#x60;yyyy-mm-dd&#x60; format. This field is required if the &#x60;TriggerEvent&#x60; field value is &#x60;SpecificDate&#x60;. **Character limit**: 29 .</param>
        ...
        /// <param name="uOM"> Specifies the units to measure usage. **Character limit**: 25 **Values**: inherited from &#x60;ProductRatePlanCharge.UOM&#x60; .</param>
        ...
        public ProxyGetRatePlanChargeAllOf(string accountingCode = default(string), string applyDiscountTo = default(string), int billCycleDay = default(int), string billCycleType = default(string), string billingPeriod = default(string), string billingPeriodAlignment = default(string), string billingTiming = default(string), string chargeModel = default(string), string chargeNumber = default(string), string chargeType = default(string), DateTime chargedThroughDate = default(DateTime), string createdById = default(string), DateTime createdDate = default(DateTime), double dMRC = default(double), double dTCV = default(double), string description = default(string), string discountLevel = default(string), DateTime effectiveEndDate = default(DateTime), DateTime effectiveStartDate = default(DateTime), string endDateCondition = default(string), bool excludeItemBillingFromRevenueAccounting = default(bool), bool excludeItemBookingFromRevenueAccounting = default(bool), string id = default(string), bool isLastSegment = default(bool), string listPriceBase = default(string), double mRR = default(double), string name = default(string), long numberOfPeriods = default(long), string originalId = default(string), string overageCalculationOption = default(string), string overageUnusedUnitsCreditOption = default(string), string priceChangeOption = default(string), double priceIncreasePercentage = default(double), DateTime processedThroughDate = default(DateTime), double quantity = default(double), string ratePlanId = default(string), RatingGroupEnum? ratingGroup = default(RatingGroupEnum?), string revRecCode = default(string), string revRecTriggerCondition = default(string), string revenueRecognitionRuleName = default(string), decimal rolloverBalance = default(decimal), int segment = default(int), long specificBillingPeriod = default(long), DateTime specificEndDate = default(DateTime), double tCV = default(double), DateTime triggerDate = default(DateTime), string triggerEvent = default(string), string uOM = default(string), long upToPeriods = default(long), string upToPeriodsType = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime), long version = default(long), string weeklyBillCycleDay = default(string))
        {
        ...
        /// </summary>
        /// <value>The accounting code for the charge. Accounting codes group transactions that contain similar accounting attributes.  **Character limit**: 100  **Values**: inherited from &#x60;ProductRatePlanCharge.AccountingCode&#x60;  **Note**: This value changes if &#x60;ProductRatePlanCharge.AccountingCode&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;RatePlanCharge&#x60; do not change when &#x60;ProductRatePlanCharge.AccountingCode&#x60; is updated. </value>
        ...
        /// </summary>
        /// <value>The flag to exclude rate plan charge related invoice items, invoice item adjustments, credit memo items, and debit memo items from revenue accounting.  **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;115&#x60; or later. Otherwise, an error occurs.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.  </value>
        ...
        /// <summary>
        /// The flag to exclude rate plan charges from revenue accounting.  **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;115&#x60; or later. Otherwise, an error occurs.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.  
        /// </summary>
        /// <value>The flag to exclude rate plan charges from revenue accounting.  **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;115&#x60; or later. Otherwise, an error occurs.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.  </value>
        ...
        /// </summary>
        /// <value> Specifies the percentage to increase or decrease the price of renewed subscriptions. **Character limit**: 16 **Values**: a decimal value between -100 and 100 </value>
        ...
        /// </summary>
        /// <value> Associates this product rate plan charge with a specific revenue recognition code.  **Character limit**: 70  **Values**: inherited from &#x60;ProductRatePlanCharge.RevRecCode&#x60; or a valid revenue recognition code  **Note**: Unless overridden, this value changes if &#x60;ProductRatePlanCharge.RevRecCode&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;RatePlanCharge&#x60; do not change when &#x60;ProductRatePlanCharge.RevRecCode&#x60; is updated. </value>
        ...
        /// </summary>
        /// <value> Specifies when revenue recognition begins.  **Character limit**: 22  **Values**: inherited from &#x60;ProductRatePlanCharge.RevRecTriggerCondition&#x60; or one of the following:  -  &#x60;ContractEffectiveDate&#x60;  -  &#x60;ServiceActivationDate&#x60;  -  &#x60;CustomerAcceptanceDate&#x60;  Note: Unless overridden, this value changes if &#x60;ProductRatePlanCharge.RevRecTriggerCondition&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;RatePlanCharge&#x60; do not change when &#x60;ProductRatePlanCharge.RevRecTriggerCondition&#x60; is updated. </value>
        ...
        /// </summary>
        /// <value> Specifies the Revenue Recognition Rule that you want the Rate Plan Charge to use. This field can be updated when **Status** is &#x60;Draft&#x60;. By default, the Revenue Recognition Rule is inherited from the Product Rate Plan Charge. For Amend calls, you can use this field only for NewProduct amendments. For Update calls, you can use this field only to update subscriptions in draft status. Note that if you use this field to specify a Revenue Recognition Rule for the Rate Plan Charge, the rule will remain as specified even if you later change the rule used by the corresponding Product Rate Plan Charge.  **Character limit**: n/a  **Values**: inherited from &#x60;ProductRatePlanCharge.RevenueRecognitionRuleName&#x60; or the name of an active Revenue Recognition Rule  **Note**: Unless overridden, this value changes if &#x60;ProductRatePlanCharge.RevenueRecognitionRuleName&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;RatePlanCharge&#x60; do not change when &#x60;ProductRatePlanCharge.RevenueRecognitionRuleName&#x60; is updated. </value>
        ...
        /// </summary>
        /// <value> The date when the charge becomes effective and billing begins, in &#x60;yyyy-mm-dd&#x60; format. This field is required if the &#x60;TriggerEvent&#x60; field value is &#x60;SpecificDate&#x60;. **Character limit**: 29 </value>
        ...
        /// </summary>
        /// <value> Specifies the units to measure usage. **Character limit**: 25 **Values**: inherited from &#x60;ProductRatePlanCharge.UOM&#x60; </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetRatePlanChargeAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetRatePlanChargeAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetRatePlanChargeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetRatePlanChargeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetRatePlanChargeAllOf input)
        {
            if (input == null)
            {
                return false;
