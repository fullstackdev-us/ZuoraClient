...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActionSubscribeInvoiceItem_allOf")]
    public partial class ActionSubscribeInvoiceItemAllOf : IEquatable<ActionSubscribeInvoiceItemAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionSubscribeInvoiceItemAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionSubscribeInvoiceItemAllOf {\n");
        ...
        {
            return this.Equals(input as ActionSubscribeInvoiceItemAllOf);
        }

        /// <summary>
        /// Returns true if ActionSubscribeInvoiceItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionSubscribeInvoiceItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionSubscribeInvoiceItemAllOf input)
        {
            if (input == null)
            {
                return false;
