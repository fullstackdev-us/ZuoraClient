...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreviewOrderChargeOverride")]
    public partial class PreviewOrderChargeOverride : IEquatable<PreviewOrderChargeOverride>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PreviewOrderChargeOverride" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PreviewOrderChargeOverride() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreviewOrderChargeOverride" /> class.
        /// </summary>
        ...
        public PreviewOrderChargeOverride(ChargeOverrideBilling billing = default(ChargeOverrideBilling), string chargeNumber = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string description = default(string), decimal drawdownRate = default(decimal), EndConditions endDate = default(EndConditions), decimal prepaidQuantity = default(decimal), ChargeOverridePricing pricing = default(ChargeOverridePricing), string productRatePlanChargeId = default(string), string revRecCode = default(string), RevRecTriggerConditionEnum? revRecTriggerCondition = default(RevRecTriggerConditionEnum?), RevenueRecognitionRuleNameEnum? revenueRecognitionRuleName = default(RevenueRecognitionRuleNameEnum?), PreviewOrderTriggerParams startDate = default(PreviewOrderTriggerParams), string uniqueToken = default(string), ValidityPeriodTypeEnum? validityPeriodType = default(ValidityPeriodTypeEnum?))
        {
            // to ensure "productRatePlanChargeId" is required (not null)
            if (productRatePlanChargeId == null)
            {
                throw new ArgumentNullException("productRatePlanChargeId is a required property for PreviewOrderChargeOverride and cannot be null");
            }
        ...
        public PreviewOrderTriggerParams StartDate { get; set; }
        ...
        {
            return this.Equals(input as PreviewOrderChargeOverride);
        }

        /// <summary>
        /// Returns true if PreviewOrderChargeOverride instances are equal
        /// </summary>
        /// <param name="input">Instance of PreviewOrderChargeOverride to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreviewOrderChargeOverride input)
        {
            if (input == null)
            {
                return false;
