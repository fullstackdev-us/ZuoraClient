...
namespace ZuoraClient.Api
{
    ...
    /// </summary>
    public interface ICustomEventTriggersApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DELETEEventTrigger(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        ApiResponse<Object> DELETEEventTriggerWithHttpInfo(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>EventTrigger</returns>
        EventTrigger GETEventTrigger(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventTrigger</returns>
        ApiResponse<EventTrigger> GETEventTriggerWithHttpInfo(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        /// <summary>
        /// List event triggers
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        ...
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="baseObject">The Zuora object that trigger condition is defined upon. Should be specified in the pattern: ^[A-Z][\\\\w\\\\-]*$ (optional)</param>
        /// <param name="eventTypeName">The event type name. Should be specified in the pattern: ^[A-Za-z]{1,}[\\w\\-]*$ (optional)</param>
        /// <param name="active">The status of the event trigger. (optional)</param>
        /// <param name="start">The first index of the query result. Default to 0 if absent, and the minimum is 0. (optional, default to 0)</param>
        /// <param name="limit">The maximum number of data records to be returned. Default to 10 if absent. (optional, default to 10)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETEventTriggers200Response</returns>
        GETEventTriggers200Response GETEventTriggers(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string baseObject = default(string), string eventTypeName = default(string), string active = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0);
        ...
        /// <param name="limit">The maximum number of data records to be returned. Default to 10 if absent. (optional, default to 10)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETEventTriggers200Response</returns>
        ApiResponse<GETEventTriggers200Response> GETEventTriggersWithHttpInfo(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string baseObject = default(string), string eventTypeName = default(string), string active = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0);
        /// <summary>
        ...
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken). </param>
        /// <param name="postEventTriggerRequest"></param>
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>EventTrigger</returns>
        EventTrigger POSTEventTrigger(string authorization, PostEventTriggerRequest postEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventTrigger</returns>
        ApiResponse<EventTrigger> POSTEventTriggerWithHttpInfo(string authorization, PostEventTriggerRequest postEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken). </param>
        /// <param name="id"></param>
        /// <param name="putEventTriggerRequest"></param>
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>EventTrigger</returns>
        EventTrigger PUTEventTrigger(string authorization, Guid id, PutEventTriggerRequest putEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventTrigger</returns>
        ApiResponse<EventTrigger> PUTEventTriggerWithHttpInfo(string authorization, Guid id, PutEventTriggerRequest putEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICustomEventTriggersApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DELETEEventTriggerAsync(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DELETEEventTriggerWithHttpInfoAsync(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve an event trigger
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EventTrigger</returns>
        System.Threading.Tasks.Task<EventTrigger> GETEventTriggerAsync(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EventTrigger)</returns>
        System.Threading.Tasks.Task<ApiResponse<EventTrigger>> GETEventTriggerWithHttpInfoAsync(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List event triggers
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETEventTriggers200Response</returns>
        System.Threading.Tasks.Task<GETEventTriggers200Response> GETEventTriggersAsync(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string baseObject = default(string), string eventTypeName = default(string), string active = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETEventTriggers200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<GETEventTriggers200Response>> GETEventTriggersWithHttpInfoAsync(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string baseObject = default(string), string eventTypeName = default(string), string active = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create an event trigger
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EventTrigger</returns>
        System.Threading.Tasks.Task<EventTrigger> POSTEventTriggerAsync(string authorization, PostEventTriggerRequest postEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EventTrigger)</returns>
        System.Threading.Tasks.Task<ApiResponse<EventTrigger>> POSTEventTriggerWithHttpInfoAsync(string authorization, PostEventTriggerRequest postEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update an event trigger
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EventTrigger</returns>
        System.Threading.Tasks.Task<EventTrigger> PUTEventTriggerAsync(string authorization, Guid id, PutEventTriggerRequest putEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EventTrigger)</returns>
        System.Threading.Tasks.Task<ApiResponse<EventTrigger>> PUTEventTriggerWithHttpInfoAsync(string authorization, Guid id, PutEventTriggerRequest putEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICustomEventTriggersApi : ICustomEventTriggersApiSync, ICustomEventTriggersApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CustomEventTriggersApi : ICustomEventTriggersApi
    {
        private ZuoraClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEventTriggersApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CustomEventTriggersApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CustomEventTriggersApi(string basePath)
        {
        ...
        /// <returns></returns>
        public CustomEventTriggersApi(ZuoraClient.Client.Configuration configuration)
        {
        ...
        public CustomEventTriggersApi(ZuoraClient.Client.ISynchronousClient client, ZuoraClient.Client.IAsynchronousClient asyncClient, ZuoraClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DELETEEventTrigger(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            DELETEEventTriggerWithHttpInfo(authorization, id, zuoraEntityIds, zuoraTrackId);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ZuoraClient.Client.ApiResponse<Object> DELETEEventTriggerWithHttpInfo(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'authorization' when calling CustomEventTriggersApi->DELETEEventTrigger");
            }
            ...
            localVarRequestOptions.Operation = "CustomEventTriggersApi.DELETEEventTrigger";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/events/event-triggers/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DELETEEventTrigger", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DELETEEventTriggerAsync(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DELETEEventTriggerWithHttpInfoAsync(authorization, id, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<Object>> DELETEEventTriggerWithHttpInfoAsync(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/events/event-triggers/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>EventTrigger</returns>
        public EventTrigger GETEventTrigger(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<EventTrigger> localVarResponse = GETEventTriggerWithHttpInfo(authorization, id, zuoraEntityIds, zuoraTrackId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventTrigger</returns>
        public ZuoraClient.Client.ApiResponse<EventTrigger> GETEventTriggerWithHttpInfo(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'authorization' when calling CustomEventTriggersApi->GETEventTrigger");
            }
            ...
            localVarRequestOptions.Operation = "CustomEventTriggersApi.GETEventTrigger";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<EventTrigger>("/events/event-triggers/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETEventTrigger", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EventTrigger</returns>
        public async System.Threading.Tasks.Task<EventTrigger> GETEventTriggerAsync(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<EventTrigger> localVarResponse = await GETEventTriggerWithHttpInfoAsync(authorization, id, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EventTrigger)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<EventTrigger>> GETEventTriggerWithHttpInfoAsync(string authorization, Guid id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<EventTrigger>("/events/event-triggers/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETEventTriggers200Response</returns>
        public GETEventTriggers200Response GETEventTriggers(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string baseObject = default(string), string eventTypeName = default(string), string active = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GETEventTriggers200Response> localVarResponse = GETEventTriggersWithHttpInfo(authorization, zuoraEntityIds, zuoraTrackId, baseObject, eventTypeName, active, start, limit);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETEventTriggers200Response</returns>
        public ZuoraClient.Client.ApiResponse<GETEventTriggers200Response> GETEventTriggersWithHttpInfo(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string baseObject = default(string), string eventTypeName = default(string), string active = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'authorization' when calling CustomEventTriggersApi->GETEventTriggers");
            }
            ...
            if (baseObject != null)
            {
                localVarRequestOptions.QueryParameters.Add(ZuoraClient.Client.ClientUtils.ParameterToMultiMap("", "baseObject", baseObject));
            }
            ...
            if (active != null)
            {
                localVarRequestOptions.QueryParameters.Add(ZuoraClient.Client.ClientUtils.ParameterToMultiMap("", "active", active));
            }
            if (start != null)
            {
            ...
            localVarRequestOptions.Operation = "CustomEventTriggersApi.GETEventTriggers";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<GETEventTriggers200Response>("/events/event-triggers", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETEventTriggers", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETEventTriggers200Response</returns>
        public async System.Threading.Tasks.Task<GETEventTriggers200Response> GETEventTriggersAsync(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string baseObject = default(string), string eventTypeName = default(string), string active = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GETEventTriggers200Response> localVarResponse = await GETEventTriggersWithHttpInfoAsync(authorization, zuoraEntityIds, zuoraTrackId, baseObject, eventTypeName, active, start, limit, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETEventTriggers200Response)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GETEventTriggers200Response>> GETEventTriggersWithHttpInfoAsync(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string baseObject = default(string), string eventTypeName = default(string), string active = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GETEventTriggers200Response>("/events/event-triggers", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create an event trigger When you create an event trigger, you must specify the base object and define the trigger condition.  ### Specify the base object Use &#x60;baseObject&#x60; field to specify which object to define a trigger on. You can define an event trigger on any of the following objects:    * Account   * AccountingCode   * AccountingPeriod   * Amendment   * BillingRun   * Contact   * CreditBalanceAdjustment   * CreditMemo   * CreditMemoApplication   * CreditMemoApplicationItem   * CreditMemoItem   * DebitMemo   * DebitMemoItem   * Feature   * Invoice   * InvoiceAdjustment   * InvoiceItem   * InvoiceItemAdjustment   * JournalEntry   * JournalEntryItem   * Order   * OrderAction   * OrderLineItem   * Payment   * PaymentApplication   * PaymentMethod   * PaymentPart   * PaymentSchedule   * PaymentScheduleItem   * PrepaidValidityPeriodSummary   * Product   * ProductFeature   * ProductRatePlan   * ProductRatePlanCharge   * ProductRatePlanChargeTier   * RatePlan   * RatePlanCharge   * RatePlanChargeTier   * Refund   * RefundApplication   * RevenueEvent   * RevenueEventItem   * RevenueSchedule   * RevenueScheduleItem   * Subscription   * SubscriptionProductFeature   * TaxationItem   * Usage  #### Tenant level base objects and tenant level event triggers Zuora identifies the following base objects as the tenant level base objects:    * AccountingCode   * AccountingPeriod   * BillingRun   * Feature   * JournalEntry   * JournalEntryItem   * Product   * ProductFeature   * ProductRatePlan   * ProductRatePlanCharge   * ProductRatePlanChargeTier  Event triggers defined on tenant level base objects are tenant level event triggers. Notifications associated with tenant level events are system notifications.   **Note:** Tenant level event triggers and system notifications are only available in the default profile.          ### Define the trigger condition The &#x60;condition&#x60; field is a [JEXL](http://commons.apache.org/proper/commons-jexl/) expression that specifies when to trigger events. The expression can contain fields from the object that the trigger is defined on.  **Note:** The condition cannot contain fields from [data source](https://knowledgecenter.zuora.com/DC_Developers/M_Export_ZOQL) objects that are joined to the object that the trigger is defined on.  For example, the following condition causes an event to be triggered whenever an invoice is posted with an amount greater than 1000:  &#x60;&#x60;&#x60;changeType &#x3D;&#x3D; &#39;UPDATE&#39; &amp;&amp; Invoice.Status &#x3D;&#x3D; &#39;Posted&#39; &amp;&amp; Invoice.Status_old !&#x3D; &#39;Posted&#39; &amp;&amp; Invoice.Amount &gt; 1000&#x60;&#x60;&#x60;  Where:    * &#x60;changeType&#x60; is a keyword that specifies the type of change that occurred to the Invoice object. For all objects, the supported values of &#x60;changeType&#x60; are &#x60;INSERT&#x60;, &#x60;UPDATE&#x60;,  and &#x60;DELETE&#x60;.   * &#x60;Invoice.Status&#x60; is the value of the Invoice object&#39;s &#x60;Status&#x60; field after the change occurred.   * &#x60;Invoice.Status_old&#x60; is the value of the Invoice object&#39;s &#x60;Status&#x60; field before the change occurred.  In the above example, the value of &#x60;baseObject&#x60; is &#x60;Invoice&#x60;.  ### Limitations   This event trigger has the following limitations:  * The INSERT change type is not supported on RatePlan base objects.  * The INSERT change type is not supported on SubscriptionProductFeature base objects.  * When creating custom events, you cannot match fields of the RatePlanCharge object against constant values for the &#x60;condition&#x60; field. For example, the following condition will cause errors: &#x60;RatePlanCharge.ShippingProcessStatus__c &#x3D;&#x3D; &#39;Shipping Confirmed&#39;&#x60;, where &#x60;Shipping Confirmed&#x60; is a constant value.  * Fields on objects are case-sensitive. For example, &#x60;PaymentMethod.createdbyid&#x60; can result in errors. The correct format is &#x60;PaymentMethod.CreatedById&#x60;.   * A condition cannot contain fields from data source objects that are joined to the base object.  * Do not create duplicate events because they will be either merged or deleted. Zuora considers events that have the same trigger condition as duplicate events, regardless of event type names.   See [Custom Events](https://knowledgecenter.zuora.com/Central_Platform/Notifications/A_Z_Custom_Events) for more information.  
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken). </param>
        /// <param name="postEventTriggerRequest"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>EventTrigger</returns>
        public EventTrigger POSTEventTrigger(string authorization, PostEventTriggerRequest postEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<EventTrigger> localVarResponse = POSTEventTriggerWithHttpInfo(authorization, postEventTriggerRequest, zuoraEntityIds, zuoraTrackId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventTrigger</returns>
        public ZuoraClient.Client.ApiResponse<EventTrigger> POSTEventTriggerWithHttpInfo(string authorization, PostEventTriggerRequest postEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'authorization' when calling CustomEventTriggersApi->POSTEventTrigger");
            }

            // verify the required parameter 'postEventTriggerRequest' is set
            if (postEventTriggerRequest == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'postEventTriggerRequest' when calling CustomEventTriggersApi->POSTEventTrigger");
            }
            ...
            localVarRequestOptions.Data = postEventTriggerRequest;

            localVarRequestOptions.Operation = "CustomEventTriggersApi.POSTEventTrigger";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<EventTrigger>("/events/event-triggers", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("POSTEventTrigger", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EventTrigger</returns>
        public async System.Threading.Tasks.Task<EventTrigger> POSTEventTriggerAsync(string authorization, PostEventTriggerRequest postEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<EventTrigger> localVarResponse = await POSTEventTriggerWithHttpInfoAsync(authorization, postEventTriggerRequest, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EventTrigger)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<EventTrigger>> POSTEventTriggerWithHttpInfoAsync(string authorization, PostEventTriggerRequest postEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<EventTrigger>("/events/event-triggers", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>EventTrigger</returns>
        public EventTrigger PUTEventTrigger(string authorization, Guid id, PutEventTriggerRequest putEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<EventTrigger> localVarResponse = PUTEventTriggerWithHttpInfo(authorization, id, putEventTriggerRequest, zuoraEntityIds, zuoraTrackId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventTrigger</returns>
        public ZuoraClient.Client.ApiResponse<EventTrigger> PUTEventTriggerWithHttpInfo(string authorization, Guid id, PutEventTriggerRequest putEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'authorization' when calling CustomEventTriggersApi->PUTEventTrigger");
            }

            // verify the required parameter 'putEventTriggerRequest' is set
            if (putEventTriggerRequest == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'putEventTriggerRequest' when calling CustomEventTriggersApi->PUTEventTrigger");
            }
            ...
            localVarRequestOptions.Data = putEventTriggerRequest;

            localVarRequestOptions.Operation = "CustomEventTriggersApi.PUTEventTrigger";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Put<EventTrigger>("/events/event-triggers/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PUTEventTrigger", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EventTrigger</returns>
        public async System.Threading.Tasks.Task<EventTrigger> PUTEventTriggerAsync(string authorization, Guid id, PutEventTriggerRequest putEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<EventTrigger> localVarResponse = await PUTEventTriggerWithHttpInfoAsync(authorization, id, putEventTriggerRequest, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EventTrigger)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<EventTrigger>> PUTEventTriggerWithHttpInfoAsync(string authorization, Guid id, PutEventTriggerRequest putEventTriggerRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<EventTrigger>("/events/event-triggers/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
