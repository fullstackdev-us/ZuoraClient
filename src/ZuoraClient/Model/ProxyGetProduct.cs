...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetProduct
    /// </summary>
    [DataContract(Name = "ProxyGetProduct")]
    public partial class ProxyGetProduct : IEquatable<ProxyGetProduct>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Type of item that is created in NetSuite for the product. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        /// </summary>
        /// <param name="allowFeatureChanges"> Controls whether to allow your users to add or remove features while creating or amending a subscription. **Character** **limit**: n/a **Values**: true, false (default) .</param>
        /// <param name="category"> Category of the product. Used by Zuora Quotes Guided Product Selector. **Character** **limit**: 100 **Values**: One of the following:  - Base Products - Add On Services - Miscellaneous Products .</param>
        ...
        /// <param name="createdDate">The date when the &#x60;Product&#x60; object was created. .</param>
        /// <param name="description"> A descriptionof the product. **Character limit**: 500 **Values**: a string of 500 characters or fewer .</param>
        /// <param name="effectiveEndDate">The date when the product expires and can&#39;t be subscribed to anymore, in &#x60;yyyy-mm-dd&#x60; format. .</param>
        /// <param name="effectiveStartDate">The date when the product becomes available and can be subscribed to, in &#x60;yyyy-mm-dd&#x60; format. .</param>
        ...
        /// <param name="updatedDate">The date when the object was last updated. .</param>
        ...
        /// <param name="integrationStatusNS">Status of the product&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        /// <param name="itemTypeNS">Type of item that is created in NetSuite for the product. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        /// <param name="syncDateNS">Date when the product was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        public ProxyGetProduct(bool allowFeatureChanges = default(bool), string category = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), string description = default(string), DateTime effectiveEndDate = default(DateTime), DateTime effectiveStartDate = default(DateTime), string id = default(string), string name = default(string), string sKU = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), ItemTypeNSEnum? itemTypeNS = default(ItemTypeNSEnum?), string syncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value> Controls whether to allow your users to add or remove features while creating or amending a subscription. **Character** **limit**: n/a **Values**: true, false (default) </value>
        [DataMember(Name = "AllowFeatureChanges", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value> Category of the product. Used by Zuora Quotes Guided Product Selector. **Character** **limit**: 100 **Values**: One of the following:  - Base Products - Add On Services - Miscellaneous Products </value>
        ...
        /// </summary>
        /// <value>The date when the &#x60;Product&#x60; object was created. </value>
        ...
        /// </summary>
        /// <value>The date when the product expires and can&#39;t be subscribed to anymore, in &#x60;yyyy-mm-dd&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The date when the product becomes available and can be subscribed to, in &#x60;yyyy-mm-dd&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The date when the object was last updated. </value>
        ...
        /// </summary>
        /// <value>Status of the product&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        /// </summary>
        /// <value>Date when the product was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        {
            return this.Equals(input as ProxyGetProduct);
        }

        /// <summary>
        /// Returns true if ProxyGetProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetProduct input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.AllowFeatureChanges == input.AllowFeatureChanges ||
                    this.AllowFeatureChanges.Equals(input.AllowFeatureChanges)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.AllowFeatureChanges.GetHashCode();
