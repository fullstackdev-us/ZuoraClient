...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetPayment_allOf")]
    public partial class ProxyGetPaymentAllOf : IEquatable<ProxyGetPaymentAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetPaymentAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetPaymentAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetPaymentAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetPaymentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetPaymentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetPaymentAllOf input)
        {
            if (input == null)
            {
                return false;
