...
namespace ZuoraClient.Model
{
    ...
    /// POSTAccountType
    /// </summary>
    [DataContract(Name = "POSTAccountType")]
    public partial class POSTAccountType : IEquatable<POSTAccountType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as POSTAccountType);
        }

        /// <summary>
        /// Returns true if POSTAccountType instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTAccountType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTAccountType input)
        {
            if (input == null)
            {
                return false;
