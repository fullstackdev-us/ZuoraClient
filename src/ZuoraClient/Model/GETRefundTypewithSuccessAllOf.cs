...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRefundTypewithSuccess_allOf")]
    public partial class GETRefundTypewithSuccessAllOf : IEquatable<GETRefundTypewithSuccessAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRefundTypewithSuccessAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETRefundTypewithSuccessAllOf);
        }

        /// <summary>
        /// Returns true if GETRefundTypewithSuccessAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRefundTypewithSuccessAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRefundTypewithSuccessAllOf input)
        {
            if (input == null)
            {
                return false;
