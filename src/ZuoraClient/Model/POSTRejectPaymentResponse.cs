...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTRejectPaymentResponse")]
    public partial class POSTRejectPaymentResponse : IEquatable<POSTRejectPaymentResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTRejectPaymentResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as POSTRejectPaymentResponse);
        }

        /// <summary>
        /// Returns true if POSTRejectPaymentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTRejectPaymentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTRejectPaymentResponse input)
        {
            if (input == null)
            {
                return false;
