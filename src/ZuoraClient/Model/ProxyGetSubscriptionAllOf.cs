...
{
    /// <summary>
    /// ProxyGetSubscriptionAllOf
    /// </summary>
    [DataContract(Name = "ProxyGetSubscription_allOf")]
    public partial class ProxyGetSubscriptionAllOf : IEquatable<ProxyGetSubscriptionAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetSubscriptionAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetSubscriptionAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetSubscriptionAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetSubscriptionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetSubscriptionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetSubscriptionAllOf input)
        {
            if (input == null)
            {
                return false;
