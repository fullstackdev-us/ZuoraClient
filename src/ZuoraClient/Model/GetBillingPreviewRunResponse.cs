...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetBillingPreviewRunResponse")]
    public partial class GetBillingPreviewRunResponse : IEquatable<GetBillingPreviewRunResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBillingPreviewRunResponse" /> class.
        /// </summary>
        /// <param name="assumeRenewal">assumeRenewal.</param>
        /// <param name="batch">The customer batch included in the billing preview run.         **Note**: This field is not available if you set the &#x60;zuora-version&#x60; request header to &#x60;314.0&#x60; or later. .</param>
        /// <param name="batches">The customer batches included in the billing preview run.   **Note**: This field is only available if you set the &#x60;zuora-version&#x60; request header to &#x60;314.0&#x60; or later. .</param>
        /// <param name="chargeTypeToExclude">The charge types excluded from the forecast run. .</param>
        /// <param name="createdById">The ID of the user who created the billing preview run. .</param>
        /// <param name="createdDate">The date and time when the billing preview run was created. .</param>
        /// <param name="endDate">The date and time when the billing preview run completes. .</param>
        /// <param name="errorMessage">The error message generated by a failed billing preview run. .</param>
        /// <param name="includingDraftItems">Whether draft document items are included in the billing preview run. By default, draft document items are not included. .</param>
        /// <param name="includingEvergreenSubscription">Indicates if evergreen subscriptions are included in the billing preview run. .</param>
        /// <param name="resultFileUrl">The URL of the zipped CSV result file generated by the billing preview run. This file contains the preview invoice item data and credit memo item data for the specified customers.  **Note:** The credit memo item data is only available if you have Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. .</param>
        /// <param name="runNumber">The run number of the billing preview run. .</param>
        /// <param name="startDate">The date and time when the billing preview run starts. .</param>
        /// <param name="status">The status of the &gt;billing preview run.  **Possible values:**   * 0: Pending * 1: Processing * 2: Completed * 3: Error * 4: Canceled .</param>
        /// <param name="succeededAccounts">The number of accounts for which preview invoice item data and credit memo item data was successfully generated during the billing preview run.  **Note:** The credit memo item data is only available if you have Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. .</param>
        /// <param name="success">Returns &#x60;true&#x60; if the request was processed successfully..</param>
        /// <param name="targetDate">The target date for the billing preview run.           .</param>
        /// <param name="totalAccounts">The total number of accounts in the billing preview run. .</param>
        /// <param name="updatedById">The ID of the user who last updated the billing preview run. .</param>
        /// <param name="updatedDate">The date and time when the billing preview run was last updated. .</param>
        public GetBillingPreviewRunResponse(string assumeRenewal = default(string), string batch = default(string), string batches = default(string), string chargeTypeToExclude = default(string), string createdById = default(string), string createdDate = default(string), string endDate = default(string), string errorMessage = default(string), bool includingDraftItems = default(bool), bool includingEvergreenSubscription = default(bool), string resultFileUrl = default(string), string runNumber = default(string), string startDate = default(string), string status = default(string), int succeededAccounts = default(int), bool success = default(bool), DateTime targetDate = default(DateTime), int totalAccounts = default(int), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// <summary>
        /// Gets or Sets AssumeRenewal
        /// </summary>
        [DataMember(Name = "assumeRenewal", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The customer batch included in the billing preview run.         **Note**: This field is not available if you set the &#x60;zuora-version&#x60; request header to &#x60;314.0&#x60; or later. </value>
        ...
        /// </summary>
        /// <value>The customer batches included in the billing preview run.   **Note**: This field is only available if you set the &#x60;zuora-version&#x60; request header to &#x60;314.0&#x60; or later. </value>
        ...
        /// </summary>
        /// <value>The charge types excluded from the forecast run. </value>
        [DataMember(Name = "chargeTypeToExclude", EmitDefaultValue = false)]
        public string ChargeTypeToExclude { get; set; }

        /// <summary>
        /// The ID of the user who created the billing preview run. 
        /// </summary>
        /// <value>The ID of the user who created the billing preview run. </value>
        ...
        /// </summary>
        /// <value>The date and time when the billing preview run was created. </value>
        ...
        /// </summary>
        /// <value>The date and time when the billing preview run completes. </value>
        ...
        /// </summary>
        /// <value>The error message generated by a failed billing preview run. </value>
        ...
        /// </summary>
        /// <value>Whether draft document items are included in the billing preview run. By default, draft document items are not included. </value>
        [DataMember(Name = "includingDraftItems", EmitDefaultValue = true)]
        public bool IncludingDraftItems { get; set; }

        /// <summary>
        /// Indicates if evergreen subscriptions are included in the billing preview run. 
        /// </summary>
        /// <value>Indicates if evergreen subscriptions are included in the billing preview run. </value>
        [DataMember(Name = "includingEvergreenSubscription", EmitDefaultValue = true)]
        public bool IncludingEvergreenSubscription { get; set; }
        ...
        /// </summary>
        /// <value>The URL of the zipped CSV result file generated by the billing preview run. This file contains the preview invoice item data and credit memo item data for the specified customers.  **Note:** The credit memo item data is only available if you have Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. </value>
        [DataMember(Name = "resultFileUrl", EmitDefaultValue = false)]
        public string ResultFileUrl { get; set; }

        /// <summary>
        /// The run number of the billing preview run. 
        /// </summary>
        /// <value>The run number of the billing preview run. </value>
        [DataMember(Name = "runNumber", EmitDefaultValue = false)]
        public string RunNumber { get; set; }

        /// <summary>
        /// The date and time when the billing preview run starts. 
        /// </summary>
        /// <value>The date and time when the billing preview run starts. </value>
        ...
        /// </summary>
        /// <value>The status of the &gt;billing preview run.  **Possible values:**   * 0: Pending * 1: Processing * 2: Completed * 3: Error * 4: Canceled </value>
        ...
        /// </summary>
        /// <value>The number of accounts for which preview invoice item data and credit memo item data was successfully generated during the billing preview run.  **Note:** The credit memo item data is only available if you have Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. </value>
        [DataMember(Name = "succeededAccounts", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The target date for the billing preview run.           </value>
        ...
        /// </summary>
        /// <value>The total number of accounts in the billing preview run. </value>
        [DataMember(Name = "totalAccounts", EmitDefaultValue = false)]
        public int TotalAccounts { get; set; }

        /// <summary>
        /// The ID of the user who last updated the billing preview run. 
        /// </summary>
        /// <value>The ID of the user who last updated the billing preview run. </value>
        ...
        /// </summary>
        /// <value>The date and time when the billing preview run was last updated. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ChargeTypeToExclude: ").Append(ChargeTypeToExclude).Append("\n");
            sb.Append("  CreatedById: ").Append(CreatedById).Append("\n");
            sb.Append("  CreatedDate: ").Append(CreatedDate).Append("\n");
            sb.Append("  EndDate: ").Append(EndDate).Append("\n");
            sb.Append("  ErrorMessage: ").Append(ErrorMessage).Append("\n");
            sb.Append("  IncludingDraftItems: ").Append(IncludingDraftItems).Append("\n");
            sb.Append("  IncludingEvergreenSubscription: ").Append(IncludingEvergreenSubscription).Append("\n");
            sb.Append("  ResultFileUrl: ").Append(ResultFileUrl).Append("\n");
            sb.Append("  RunNumber: ").Append(RunNumber).Append("\n");
            sb.Append("  StartDate: ").Append(StartDate).Append("\n");
            sb.Append("  Status: ").Append(Status).Append("\n");
            sb.Append("  SucceededAccounts: ").Append(SucceededAccounts).Append("\n");
        ...
        {
            return this.Equals(input as GetBillingPreviewRunResponse);
        }

        /// <summary>
        /// Returns true if GetBillingPreviewRunResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetBillingPreviewRunResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetBillingPreviewRunResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.AssumeRenewal == input.AssumeRenewal ||
                    (this.AssumeRenewal != null &&
                    this.AssumeRenewal.Equals(input.AssumeRenewal))
                ) && 
                (
                ...
                (
                    this.ChargeTypeToExclude == input.ChargeTypeToExclude ||
                    (this.ChargeTypeToExclude != null &&
                    this.ChargeTypeToExclude.Equals(input.ChargeTypeToExclude))
                ) && 
                (
                ...
                (
                    this.IncludingDraftItems == input.IncludingDraftItems ||
                    this.IncludingDraftItems.Equals(input.IncludingDraftItems)
                ) && 
                (
                    this.IncludingEvergreenSubscription == input.IncludingEvergreenSubscription ||
                    this.IncludingEvergreenSubscription.Equals(input.IncludingEvergreenSubscription)
                ) && 
                (
                    this.ResultFileUrl == input.ResultFileUrl ||
                    (this.ResultFileUrl != null &&
                    this.ResultFileUrl.Equals(input.ResultFileUrl))
                ) && 
                (
                ...
                (
                    this.SucceededAccounts == input.SucceededAccounts ||
                    this.SucceededAccounts.Equals(input.SucceededAccounts)
                ) && 
                (
                ...
                (
                    this.TotalAccounts == input.TotalAccounts ||
                    this.TotalAccounts.Equals(input.TotalAccounts)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AssumeRenewal != null)
                {
                    hashCode = (hashCode * 59) + this.AssumeRenewal.GetHashCode();
                }
                if (this.Batch != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + this.ChargeTypeToExclude.GetHashCode();
                }
                ...
                hashCode = (hashCode * 59) + this.IncludingDraftItems.GetHashCode();
                hashCode = (hashCode * 59) + this.IncludingEvergreenSubscription.GetHashCode();
                if (this.ResultFileUrl != null)
                {
                    hashCode = (hashCode * 59) + this.ResultFileUrl.GetHashCode();
                }
                ...
                hashCode = (hashCode * 59) + this.SucceededAccounts.GetHashCode();
                hashCode = (hashCode * 59) + this.Success.GetHashCode();
                if (this.TargetDate != null)
                {
                    hashCode = (hashCode * 59) + this.TargetDate.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.TotalAccounts.GetHashCode();
