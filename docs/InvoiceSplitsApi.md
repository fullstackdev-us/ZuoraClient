# ZuoraClient.Api.InvoiceSplitsApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**ObjectGETInvoiceSplit**](InvoiceSplitsApi.md#objectgetinvoicesplit) | **GET** /v1/object/invoice-split/{id} | CRUD: Retrieve an invoice split |

<a name="objectgetinvoicesplit"></a>
# **ObjectGETInvoiceSplit**
> ProxyGetInvoiceSplit ObjectGETInvoiceSplit (string id, string authorization = null, string zuoraEntityIds = null, string zuoraTrackId = null, string fields = null)
...
namespace Example
{
    public class ObjectGETInvoiceSplitExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            config.BasePath = "https://rest.zuora.com";
            var apiInstance = new InvoiceSplitsApi(config);
            ...
            {
                // CRUD: Retrieve an invoice split
                ProxyGetInvoiceSplit result = apiInstance.ObjectGETInvoiceSplit(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling InvoiceSplitsApi.ObjectGETInvoiceSplit: " + e.Message);
...
#### Using the ObjectGETInvoiceSplitWithHttpInfo variant
...
{
    // CRUD: Retrieve an invoice split
    ApiResponse<ProxyGetInvoiceSplit> response = apiInstance.ObjectGETInvoiceSplitWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
...
{
    Debug.Print("Exception when calling InvoiceSplitsApi.ObjectGETInvoiceSplitWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
