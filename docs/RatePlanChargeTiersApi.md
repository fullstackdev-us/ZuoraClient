# ZuoraClient.Api.RatePlanChargeTiersApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**ObjectGETRatePlanChargeTier**](RatePlanChargeTiersApi.md#objectgetrateplanchargetier) | **GET** /v1/object/rate-plan-charge-tier/{id} | CRUD: Retrieve a rate plan charge tier |

<a name="objectgetrateplanchargetier"></a>
# **ObjectGETRatePlanChargeTier**
> ProxyGetRatePlanChargeTier ObjectGETRatePlanChargeTier (string id, string authorization = null, string zuoraEntityIds = null, string zuoraTrackId = null, string fields = null)
...
namespace Example
{
    public class ObjectGETRatePlanChargeTierExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            config.BasePath = "https://rest.zuora.com";
            var apiInstance = new RatePlanChargeTiersApi(config);
            ...
            {
                // CRUD: Retrieve a rate plan charge tier
                ProxyGetRatePlanChargeTier result = apiInstance.ObjectGETRatePlanChargeTier(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling RatePlanChargeTiersApi.ObjectGETRatePlanChargeTier: " + e.Message);
...
#### Using the ObjectGETRatePlanChargeTierWithHttpInfo variant
...
{
    // CRUD: Retrieve a rate plan charge tier
    ApiResponse<ProxyGetRatePlanChargeTier> response = apiInstance.ObjectGETRatePlanChargeTierWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
...
{
    Debug.Print("Exception when calling RatePlanChargeTiersApi.ObjectGETRatePlanChargeTierWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
