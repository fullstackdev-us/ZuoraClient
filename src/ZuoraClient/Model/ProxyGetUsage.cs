...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetUsage
    /// </summary>
    [DataContract(Name = "ProxyGetUsage")]
    public partial class ProxyGetUsage : IEquatable<ProxyGetUsage>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyGetUsage);
        }

        /// <summary>
        /// Returns true if ProxyGetUsage instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetUsage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetUsage input)
        {
            if (input == null)
            {
                return false;
