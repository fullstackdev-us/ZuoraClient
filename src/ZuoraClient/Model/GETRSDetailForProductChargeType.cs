...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRSDetailForProductChargeType")]
    public partial class GETRSDetailForProductChargeType : IEquatable<GETRSDetailForProductChargeType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRSDetailForProductChargeType" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETRSDetailForProductChargeType {\n");
        ...
        {
            return this.Equals(input as GETRSDetailForProductChargeType);
        }

        /// <summary>
        /// Returns true if GETRSDetailForProductChargeType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRSDetailForProductChargeType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRSDetailForProductChargeType input)
        {
            if (input == null)
            {
                return false;
