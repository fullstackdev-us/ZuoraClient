...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreatePaymentType_allOf")]
    public partial class CreatePaymentTypeAllOf : IEquatable<CreatePaymentTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePaymentTypeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreatePaymentTypeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePaymentTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreatePaymentTypeAllOf);
        }

        /// <summary>
        /// Returns true if CreatePaymentTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CreatePaymentTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreatePaymentTypeAllOf input)
        {
            if (input == null)
            {
                return false;
