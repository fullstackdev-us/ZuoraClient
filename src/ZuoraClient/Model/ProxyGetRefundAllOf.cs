...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetRefundAllOf
    /// </summary>
    [DataContract(Name = "ProxyGetRefund_allOf")]
    public partial class ProxyGetRefundAllOf : IEquatable<ProxyGetRefundAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetRefundAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetRefundAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetRefundAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetRefundAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetRefundAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetRefundAllOf input)
        {
            if (input == null)
            {
                return false;
