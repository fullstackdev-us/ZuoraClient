...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETSubscriptionTypeWithSuccess")]
    public partial class GETSubscriptionTypeWithSuccess : IEquatable<GETSubscriptionTypeWithSuccess>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETSubscriptionTypeWithSuccess);
        }

        /// <summary>
        /// Returns true if GETSubscriptionTypeWithSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of GETSubscriptionTypeWithSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETSubscriptionTypeWithSuccess input)
        {
            if (input == null)
            {
                return false;
