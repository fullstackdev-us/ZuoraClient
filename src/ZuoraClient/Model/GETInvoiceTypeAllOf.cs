...
namespace ZuoraClient.Model
{
    ...
    /// GETInvoiceTypeAllOf
    /// </summary>
    [DataContract(Name = "GETInvoiceType_allOf")]
    public partial class GETInvoiceTypeAllOf : IEquatable<GETInvoiceTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETInvoiceTypeAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETInvoiceTypeAllOf {\n");
        ...
        {
            return this.Equals(input as GETInvoiceTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETInvoiceTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETInvoiceTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETInvoiceTypeAllOf input)
        {
            if (input == null)
            {
                return false;
