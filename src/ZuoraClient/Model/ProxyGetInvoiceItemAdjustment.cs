...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetInvoiceItemAdjustment")]
    public partial class ProxyGetInvoiceItemAdjustment : IEquatable<ProxyGetInvoiceItemAdjustment>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Indicates the status of the adjustment&#39;s transfer to an external accounting system, such as NetSuite. </value>
        ...
        /// </summary>
        /// <value>Indicates whether the adjustment credits or debits the invoice item amount.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="adjustmentDate"> The date when the invoice item adjustment is applied, in &#x60;yyyy-mm-dd&#x60; format. This date must be the same as the invoice&#39;s date or later. **Character limit**: 29 .</param>
        ...
        /// <param name="customerName"> The name of the account that owns the associated invoice.  **Character limit**: 50  **Values**: inherited from &#x60;Account.Name&#x60;  **Note**: This value changes if &#x60;Account.Name&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;InvoiceItemAdjustment&#x60; do not change when &#x60;Account.Name&#x60; is updated. .</param>
        /// <param name="customerNumber"> The unique account number of the customer&#39;s account.  **Character limit**: 50  **Values**: inherited from &#x60;Account.AccountNumber&#x60;  **Note**: This value changes if &#x60;Account.AccountNumber&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;InvoiceItemAdjustment&#x60; do not change when &#x60;Account.AccountNumber&#x60; is updated. .</param>
        /// <param name="deferredRevenueAccount"> Records the deferred accounting code in the finance system. This field is in Limited Availability. If you want to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/). **Character limit**: 100  **Version notes**: WSDL 63.0+  **Values**: If this field is not passed in, a value from InvoiceItem will be used..</param>
        ...
        /// <param name="invoiceItemName"> The name of the invoice item&#39;s charge. This field is required in the Query call, but is inherited in other calls. **Character limit**: 255 **Values**: inherited from &#x60;InvoiceItem.ChargeName&#x60; .</param>
        ...
        /// <param name="reasonCode"> A code identifying the reason for the transaction. Must be an existing reason code or empty. If you do not specify a value, Zuora uses the default reason code. **Character limit**: 32 **Values**: a valid reason code .</param>
        /// <param name="recognizedRevenueAccount"> Records the recognized accounting code in the finance system. This field is in Limited Availability. If you want to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/). **Character limit**: 100  **Version notes**: WSDL 63.0+  **Values**: If this field is not passed in, a value from InvoiceItem will be used..</param>
        ...
        /// <param name="serviceEndDate"> The end date of the service period associated with the invoice item. Service ends one second before the date in this value.  **Character limit**: 29 .</param>
        /// <param name="serviceStartDate"> The start date of the service period associated with the invoice item. Service ends one second before the date in this value.  **Character limit**: 29 .</param>
        ...
        /// <param name="status"> The status of the invoice item adjustment. This field is required in the Query call, but is automatically generated in other calls. **Character limit**: 9 **Values**: Canceled, Processed .</param>
        /// <param name="transferredToAccounting">Indicates the status of the adjustment&#39;s transfer to an external accounting system, such as NetSuite. .</param>
        /// <param name="type">Indicates whether the adjustment credits or debits the invoice item amount..</param>
        ...
        /// <param name="invoiceItemAdjustmentIntegrationIdNS">ID of the corresponding object in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        /// <param name="invoiceItemAdjustmentIntegrationStatusNS">Status of the invoice item adjustment&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        /// <param name="invoiceItemAdjustmentSyncDateNS">Date when the invoice item adjustment was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        public ProxyGetInvoiceItemAdjustment(string accountId = default(string), string accountingCode = default(string), DateTime adjustmentDate = default(DateTime), string adjustmentNumber = default(string), double amount = default(double), string cancelledById = default(string), DateTime cancelledDate = default(DateTime), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), string customerName = default(string), string customerNumber = default(string), string deferredRevenueAccount = default(string), bool excludeItemBillingFromRevenueAccounting = false, string id = default(string), string invoiceId = default(string), string invoiceItemName = default(string), string invoiceNumber = default(string), string reasonCode = default(string), string recognizedRevenueAccount = default(string), string referenceId = default(string), DateTime serviceEndDate = default(DateTime), DateTime serviceStartDate = default(DateTime), string sourceId = default(string), string sourceType = default(string), string status = default(string), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), TypeEnum? type = default(TypeEnum?), string updatedById = default(string), DateTime updatedDate = default(DateTime), string invoiceItemAdjustmentIntegrationIdNS = default(string), string invoiceItemAdjustmentIntegrationStatusNS = default(string), string invoiceItemAdjustmentSyncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value> The date when the invoice item adjustment is applied, in &#x60;yyyy-mm-dd&#x60; format. This date must be the same as the invoice&#39;s date or later. **Character limit**: 29 </value>
        ...
        /// </summary>
        /// <value> The name of the account that owns the associated invoice.  **Character limit**: 50  **Values**: inherited from &#x60;Account.Name&#x60;  **Note**: This value changes if &#x60;Account.Name&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;InvoiceItemAdjustment&#x60; do not change when &#x60;Account.Name&#x60; is updated. </value>
        ...
        /// </summary>
        /// <value> The unique account number of the customer&#39;s account.  **Character limit**: 50  **Values**: inherited from &#x60;Account.AccountNumber&#x60;  **Note**: This value changes if &#x60;Account.AccountNumber&#x60; is updated. The values of &#x60;UpdatedById&#x60; and &#x60;UpdatedDate&#x60; for the &#x60;InvoiceItemAdjustment&#x60; do not change when &#x60;Account.AccountNumber&#x60; is updated. </value>
        [DataMember(Name = "CustomerNumber", EmitDefaultValue = false)]
        public string CustomerNumber { get; set; }

        /// <summary>
        ///  Records the deferred accounting code in the finance system. This field is in Limited Availability. If you want to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/). **Character limit**: 100  **Version notes**: WSDL 63.0+  **Values**: If this field is not passed in, a value from InvoiceItem will be used.
        /// </summary>
        /// <value> Records the deferred accounting code in the finance system. This field is in Limited Availability. If you want to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/). **Character limit**: 100  **Version notes**: WSDL 63.0+  **Values**: If this field is not passed in, a value from InvoiceItem will be used.</value>
        ...
        /// </summary>
        /// <value>The flag to exclude Order Line Item related invoice items, invoice item adjustments, credit memo items, and debit memo items that are generate for the rate plan charge from revenue accounting.  **Version notes**: WSDL 117.0+  **Values**: boolean value  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled. </value>
        ...
        /// </summary>
        /// <value> The name of the invoice item&#39;s charge. This field is required in the Query call, but is inherited in other calls. **Character limit**: 255 **Values**: inherited from &#x60;InvoiceItem.ChargeName&#x60; </value>
        ...
        /// </summary>
        /// <value> A code identifying the reason for the transaction. Must be an existing reason code or empty. If you do not specify a value, Zuora uses the default reason code. **Character limit**: 32 **Values**: a valid reason code </value>
        ...
        /// </summary>
        /// <value> Records the recognized accounting code in the finance system. This field is in Limited Availability. If you want to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/). **Character limit**: 100  **Version notes**: WSDL 63.0+  **Values**: If this field is not passed in, a value from InvoiceItem will be used.</value>
        ...
        /// </summary>
        /// <value> The end date of the service period associated with the invoice item. Service ends one second before the date in this value.  **Character limit**: 29 </value>
        ...
        /// </summary>
        /// <value> The start date of the service period associated with the invoice item. Service ends one second before the date in this value.  **Character limit**: 29 </value>
        ...
        /// </summary>
        /// <value> The status of the invoice item adjustment. This field is required in the Query call, but is automatically generated in other calls. **Character limit**: 9 **Values**: Canceled, Processed </value>
        ...
        [DataMember(Name = "InvoiceItemAdjustment.IntegrationId__NS", EmitDefaultValue = false)]
        public string InvoiceItemAdjustmentIntegrationIdNS { get; set; }
        ...
        /// </summary>
        /// <value>Status of the invoice item adjustment&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        [DataMember(Name = "InvoiceItemAdjustment.IntegrationStatus__NS", EmitDefaultValue = false)]
        public string InvoiceItemAdjustmentIntegrationStatusNS { get; set; }
        ...
        /// </summary>
        /// <value>Date when the invoice item adjustment was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        [DataMember(Name = "InvoiceItemAdjustment.SyncDate__NS", EmitDefaultValue = false)]
        public string InvoiceItemAdjustmentSyncDateNS { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InvoiceItemAdjustmentIntegrationIdNS: ").Append(InvoiceItemAdjustmentIntegrationIdNS).Append("\n");
            sb.Append("  InvoiceItemAdjustmentIntegrationStatusNS: ").Append(InvoiceItemAdjustmentIntegrationStatusNS).Append("\n");
            sb.Append("  InvoiceItemAdjustmentSyncDateNS: ").Append(InvoiceItemAdjustmentSyncDateNS).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ProxyGetInvoiceItemAdjustment);
        }

        /// <summary>
        /// Returns true if ProxyGetInvoiceItemAdjustment instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetInvoiceItemAdjustment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetInvoiceItemAdjustment input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AdjustmentNumber == input.AdjustmentNumber ||
                    (this.AdjustmentNumber != null &&
                    this.AdjustmentNumber.Equals(input.AdjustmentNumber))
                ) && 
                (
                ...
                (
                    this.InvoiceItemName == input.InvoiceItemName ||
                    (this.InvoiceItemName != null &&
                    this.InvoiceItemName.Equals(input.InvoiceItemName))
                ) && 
                (
                ...
                (
                    this.InvoiceItemAdjustmentIntegrationIdNS == input.InvoiceItemAdjustmentIntegrationIdNS ||
                    (this.InvoiceItemAdjustmentIntegrationIdNS != null &&
                    this.InvoiceItemAdjustmentIntegrationIdNS.Equals(input.InvoiceItemAdjustmentIntegrationIdNS))
                ) && 
                (
                    this.InvoiceItemAdjustmentIntegrationStatusNS == input.InvoiceItemAdjustmentIntegrationStatusNS ||
                    (this.InvoiceItemAdjustmentIntegrationStatusNS != null &&
                    this.InvoiceItemAdjustmentIntegrationStatusNS.Equals(input.InvoiceItemAdjustmentIntegrationStatusNS))
                ) && 
                (
                    this.InvoiceItemAdjustmentSyncDateNS == input.InvoiceItemAdjustmentSyncDateNS ||
                    (this.InvoiceItemAdjustmentSyncDateNS != null &&
                    this.InvoiceItemAdjustmentSyncDateNS.Equals(input.InvoiceItemAdjustmentSyncDateNS))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AdjustmentNumber.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.InvoiceItemName.GetHashCode();
                }
                ...
                if (this.InvoiceItemAdjustmentIntegrationIdNS != null)
                {
                    hashCode = (hashCode * 59) + this.InvoiceItemAdjustmentIntegrationIdNS.GetHashCode();
                }
                if (this.InvoiceItemAdjustmentIntegrationStatusNS != null)
                {
                    hashCode = (hashCode * 59) + this.InvoiceItemAdjustmentIntegrationStatusNS.GetHashCode();
                }
                if (this.InvoiceItemAdjustmentSyncDateNS != null)
                {
                    hashCode = (hashCode * 59) + this.InvoiceItemAdjustmentSyncDateNS.GetHashCode();
                }
                return hashCode;
            }
        }
        ...
        {
            // InvoiceItemAdjustmentIntegrationIdNS (string) maxLength
            if (this.InvoiceItemAdjustmentIntegrationIdNS != null && this.InvoiceItemAdjustmentIntegrationIdNS.Length > 255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InvoiceItemAdjustmentIntegrationIdNS, length must be less than 255.", new [] { "InvoiceItemAdjustmentIntegrationIdNS" });
            }

            // InvoiceItemAdjustmentIntegrationStatusNS (string) maxLength
            if (this.InvoiceItemAdjustmentIntegrationStatusNS != null && this.InvoiceItemAdjustmentIntegrationStatusNS.Length > 255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InvoiceItemAdjustmentIntegrationStatusNS, length must be less than 255.", new [] { "InvoiceItemAdjustmentIntegrationStatusNS" });
            }

            // InvoiceItemAdjustmentSyncDateNS (string) maxLength
            if (this.InvoiceItemAdjustmentSyncDateNS != null && this.InvoiceItemAdjustmentSyncDateNS.Length > 255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InvoiceItemAdjustmentSyncDateNS, length must be less than 255.", new [] { "InvoiceItemAdjustmentSyncDateNS" });
            }
