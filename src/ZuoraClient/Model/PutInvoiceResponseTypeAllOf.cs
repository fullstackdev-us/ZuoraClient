...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PutInvoiceResponseType_allOf")]
    public partial class PutInvoiceResponseTypeAllOf : IEquatable<PutInvoiceResponseTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutInvoiceResponseTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PutInvoiceResponseTypeAllOf);
        }

        /// <summary>
        /// Returns true if PutInvoiceResponseTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutInvoiceResponseTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutInvoiceResponseTypeAllOf input)
        {
            if (input == null)
            {
                return false;
