...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderLineItemRetrieveOrder")]
    public partial class OrderLineItemRetrieveOrder : IEquatable<OrderLineItemRetrieveOrder>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The state of an Order Line Item. See [Order Line Item states, Order states, and state transitions](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AB_Order_Line_Item_States_and_Order_States) for more information. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>The tax mode for the Order Line Item. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderLineItemRetrieveOrder" /> class.
        /// </summary>
        ...
        /// <param name="amount">The calculated gross amount for the Order Line Item. .</param>
        /// <param name="amountWithoutTax">The calculated gross amount for an order line item excluding tax. If the tax mode is tax exclusive, the value of this field equals that of the &#x60;amount&#x60; field.  If the tax mode of an order line item is not set, the system treats it as tax exclusive by default. The value of the &#x60;amountWithoutTax&#x60; field equals that of the &#x60;amount&#x60; field.  If you create an order line item from the product catalog, the tax mode and tax code of the product rate plan charge are used for the order line item by default. You can still overwrite this default set-up by setting the tax mode and tax code of the order line item. .</param>
        /// <param name="id">The sytem generated Id for the Order Line Item. .</param>
        /// <param name="itemNumber">The number for the Order Line Item. .</param>
        ...
        /// <param name="adjustmentLiabilityAccountingCode">The accounting code on the Order Line Item object for customers using [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration). .</param>
        /// <param name="adjustmentRevenueAccountingCode">The accounting code on the Order Line Item object for customers using [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration). .</param>
        /// <param name="amountPerUnit">The actual charged amount per unit for the Order Line Item. .</param>
        /// <param name="billTargetDate">The target date for the Order Line Item to be picked up by bill run for billing. .</param>
        /// <param name="contractAssetAccountingCode">The accounting code on the Order Line Item object for customers using [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration). .</param>
        /// <param name="contractLiabilityAccountingCode">The accounting code on the Order Line Item object for customers using [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration). .</param>
        /// <param name="contractRecognizedRevenueAccountingCode">The accounting code on the Order Line Item object for customers using [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration). .</param>
        /// <param name="customFields">Container for custom fields of an Order Line Item object. .</param>
        /// <param name="deferredRevenueAccountingCode">The deferred revenue accounting code for the Order Line Item. .</param>
        /// <param name="description">The description of the Order Line Item. .</param>
        /// <param name="discount">This field shows the total discount amount that is applied to an order line item after the &#x60;inlineDiscountType&#x60;, &#x60;inlineDiscountPerUnit&#x60; and &#x60;quantity&#x60; fields are set.  The inline discount is applied to the list price of an order line item (see the &#x60;listPrice&#x60; field). .</param>
        /// <param name="excludeItemBillingFromRevenueAccounting">The flag to exclude Order Line Item related invoice items, invoice item adjustments, credit memo items, and debit memo items from revenue accounting.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.  .</param>
        /// <param name="excludeItemBookingFromRevenueAccounting">The flag to exclude Order Line Item from revenue accounting.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.  .</param>
        /// <param name="inlineDiscountPerUnit">This field is used in accordance with the &#x60;inlineDiscountType&#x60; field, in the following manner: * If the &#x60;inlineDiscountType&#x60; field is set as &#x60;Percentage&#x60;, this field specifies the discount percentage for each unit of the order line item. For exmaple, if you specify &#x60;5&#x60; in this field, the discount percentage is 5%. * If the &#x60;inlineDiscountType&#x60; field is set as &#x60;FixedAmount&#x60;, this field specifies the discount amount on each unit of the order line item. For exmaple, if you specify &#x60;10&#x60; in this field, the discount amount on each unit of the order line item is 10.  Once you set the &#x60;inlineDiscountType&#x60;, &#x60;inlineDiscountPerUnit&#x60;, and &#x60;listPricePerUnit&#x60; fields, the system will automatically generate the &#x60;amountPerUnit&#x60; field. You shall not set the &#x60;amountPerUnit&#x60; field by yourself. .</param>
        /// <param name="inlineDiscountType">This field is used to specify the inline discount type, which can be &#x60;Percentage&#x60;, &#x60;FixedAmount&#x60;, or &#x60;None&#x60;. The default value is &#x60;Percentage&#x60;.  This field is used together with the &#x60;inlineDiscountPerUnit&#x60; field to specify inline discounts for order line items. The inline discount is applied to the list price of an order line item.   Once you set the &#x60;inlineDiscountType&#x60;, &#x60;inlineDiscountPerUnit&#x60;, and &#x60;listPricePerUnit&#x60; fields, the system will automatically generate the &#x60;amountPerUnit&#x60; field. You shall not set the &#x60;amountPerUnit&#x60; field by yourself. .</param>
        /// <param name="itemName">The name of the Order Line Item. .</param>
        /// <param name="itemState">The state of an Order Line Item. See [Order Line Item states, Order states, and state transitions](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AB_Order_Line_Item_States_and_Order_States) for more information. .</param>
        /// <param name="itemType">The type of the Order Line Item.  .</param>
        ...
        /// <param name="listPricePerUnit">The list price per unit for the Order Line Item. .</param>
        /// <param name="productCode">The product code for the Order Line Item. .</param>
        /// <param name="productRatePlanChargeId">Id of a Product Rate Plan Charge. Only one-time charges are supported. .</param>
        ...
        /// <param name="recognizedRevenueAccountingCode">The recognized revenue accounting code for the Order Line Item. .</param>
        /// <param name="relatedSubscriptionNumber">Use this field to relate an order line item to a subscription when you create the order line item.  * To relate an order line item to a new subscription which is yet to create in the same \&quot;Create an order\&quot; call, use this field in combination with the &#x60;subscriptions&#x60; &gt; &#x60;subscriptionNumber&#x60; field in the \&quot;Create order\&quot; operation. Specify this field to the same value as that of the &#39;subscriptions&#39; &gt; &#x60;subscriptionNumber&#x60; field when you make the \&quot;Create order\&quot; call. * To relate an order line item to an existing subscription, specify this field to the subscription number of the existing subscription. .</param>
        /// <param name="revenueRecognitionRule">The Revenue Recognition rule for the Order Line Item. .</param>
        /// <param name="soldTo">The ID of a contact that belongs to the billing account of the order line item. Use this field to assign an existing account as the sold-to contact of an order line item. .</param>
        /// <param name="soldToSnapshotId">The snapshot of the ID for an account used as the sold-to contact of an order line item. This field is used to store the original information about the account, in case the information about the account is changed after the creation of the order line item. The &#x60;soldToSnapshotId&#x60; field is exposed while retrieving the order line item details. .</param>
        /// <param name="taxCode">The tax code for the Order Line Item. .</param>
        /// <param name="taxMode">The tax mode for the Order Line Item. .</param>
        /// <param name="transactionEndDate">The date a transaction is completed. The default value of this field is the transaction start date. Also, the value of this field should always equal or be later than the value of the &#x60;transactionStartDate&#x60; field. .</param>
        /// <param name="transactionStartDate">The date a transaction starts. The default value of this field is the order date. .</param>
        /// <param name="unbilledReceivablesAccountingCode">The accounting code on the Order Line Item object for customers using [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration). .</param>
        public OrderLineItemRetrieveOrder(string amendedByOrderOn = default(string), decimal amount = default(decimal), decimal amountWithoutTax = default(decimal), Guid id = default(Guid), string itemNumber = default(string), DateTime originalOrderDate = default(DateTime), string uOM = default(string), string accountingCode = default(string), string adjustmentLiabilityAccountingCode = default(string), string adjustmentRevenueAccountingCode = default(string), decimal amountPerUnit = default(decimal), DateTime billTargetDate = default(DateTime), string contractAssetAccountingCode = default(string), string contractLiabilityAccountingCode = default(string), string contractRecognizedRevenueAccountingCode = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string deferredRevenueAccountingCode = default(string), string description = default(string), decimal discount = default(decimal), bool excludeItemBillingFromRevenueAccounting = default(bool), bool excludeItemBookingFromRevenueAccounting = default(bool), decimal inlineDiscountPerUnit = default(decimal), InlineDiscountTypeEnum? inlineDiscountType = default(InlineDiscountTypeEnum?), string itemName = default(string), ItemStateEnum? itemState = default(ItemStateEnum?), ItemTypeEnum? itemType = default(ItemTypeEnum?), decimal listPrice = default(decimal), decimal listPricePerUnit = default(decimal), string productCode = default(string), DateTime productRatePlanChargeId = default(DateTime), string purchaseOrderNumber = default(string), decimal quantity = default(decimal), string recognizedRevenueAccountingCode = default(string), string relatedSubscriptionNumber = default(string), string revenueRecognitionRule = default(string), string soldTo = default(string), string soldToSnapshotId = default(string), string taxCode = default(string), TaxModeEnum? taxMode = default(TaxModeEnum?), DateTime transactionEndDate = default(DateTime), DateTime transactionStartDate = default(DateTime), string unbilledReceivablesAccountingCode = default(string))
        {
        ...
        /// </summary>
        /// <value>The calculated gross amount for the Order Line Item. </value>
        ...
        /// </summary>
        /// <value>The calculated gross amount for an order line item excluding tax. If the tax mode is tax exclusive, the value of this field equals that of the &#x60;amount&#x60; field.  If the tax mode of an order line item is not set, the system treats it as tax exclusive by default. The value of the &#x60;amountWithoutTax&#x60; field equals that of the &#x60;amount&#x60; field.  If you create an order line item from the product catalog, the tax mode and tax code of the product rate plan charge are used for the order line item by default. You can still overwrite this default set-up by setting the tax mode and tax code of the order line item. </value>
        ...
        /// </summary>
        /// <value>The sytem generated Id for the Order Line Item. </value>
        ...
        /// </summary>
        /// <value>The number for the Order Line Item. </value>
        ...
        /// </summary>
        /// <value>The accounting code on the Order Line Item object for customers using [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration). </value>
        ...
        /// </summary>
        /// <value>The actual charged amount per unit for the Order Line Item. </value>
        ...
        /// </summary>
        /// <value>The deferred revenue accounting code for the Order Line Item. </value>
        ...
        /// </summary>
        /// <value>The description of the Order Line Item. </value>
        ...
        /// </summary>
        /// <value>This field shows the total discount amount that is applied to an order line item after the &#x60;inlineDiscountType&#x60;, &#x60;inlineDiscountPerUnit&#x60; and &#x60;quantity&#x60; fields are set.  The inline discount is applied to the list price of an order line item (see the &#x60;listPrice&#x60; field). </value>
        ...
        /// </summary>
        /// <value>The flag to exclude Order Line Item related invoice items, invoice item adjustments, credit memo items, and debit memo items from revenue accounting.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.  </value>
        ...
        /// </summary>
        /// <value>The flag to exclude Order Line Item from revenue accounting.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.  </value>
        ...
        /// </summary>
        /// <value>This field is used in accordance with the &#x60;inlineDiscountType&#x60; field, in the following manner: * If the &#x60;inlineDiscountType&#x60; field is set as &#x60;Percentage&#x60;, this field specifies the discount percentage for each unit of the order line item. For exmaple, if you specify &#x60;5&#x60; in this field, the discount percentage is 5%. * If the &#x60;inlineDiscountType&#x60; field is set as &#x60;FixedAmount&#x60;, this field specifies the discount amount on each unit of the order line item. For exmaple, if you specify &#x60;10&#x60; in this field, the discount amount on each unit of the order line item is 10.  Once you set the &#x60;inlineDiscountType&#x60;, &#x60;inlineDiscountPerUnit&#x60;, and &#x60;listPricePerUnit&#x60; fields, the system will automatically generate the &#x60;amountPerUnit&#x60; field. You shall not set the &#x60;amountPerUnit&#x60; field by yourself. </value>
        ...
        /// </summary>
        /// <value>Id of a Product Rate Plan Charge. Only one-time charges are supported. </value>
        [DataMember(Name = "productRatePlanChargeId", EmitDefaultValue = false)]
        [JsonConverter(typeof(OpenAPIDateConverter))]
        public DateTime ProductRatePlanChargeId { get; set; }
        ...
        /// </summary>
        /// <value>The recognized revenue accounting code for the Order Line Item. </value>
        ...
        /// </summary>
        /// <value>Use this field to relate an order line item to a subscription when you create the order line item.  * To relate an order line item to a new subscription which is yet to create in the same \&quot;Create an order\&quot; call, use this field in combination with the &#x60;subscriptions&#x60; &gt; &#x60;subscriptionNumber&#x60; field in the \&quot;Create order\&quot; operation. Specify this field to the same value as that of the &#39;subscriptions&#39; &gt; &#x60;subscriptionNumber&#x60; field when you make the \&quot;Create order\&quot; call. * To relate an order line item to an existing subscription, specify this field to the subscription number of the existing subscription. </value>
        ...
        /// </summary>
        /// <value>The snapshot of the ID for an account used as the sold-to contact of an order line item. This field is used to store the original information about the account, in case the information about the account is changed after the creation of the order line item. The &#x60;soldToSnapshotId&#x60; field is exposed while retrieving the order line item details. </value>
        [DataMember(Name = "soldToSnapshotId", EmitDefaultValue = false)]
        public string SoldToSnapshotId { get; set; }
        ...
        /// </summary>
        /// <value>The date a transaction is completed. The default value of this field is the transaction start date. Also, the value of this field should always equal or be later than the value of the &#x60;transactionStartDate&#x60; field. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SoldToSnapshotId: ").Append(SoldToSnapshotId).Append("\n");
        ...
        {
            return this.Equals(input as OrderLineItemRetrieveOrder);
        }

        /// <summary>
        /// Returns true if OrderLineItemRetrieveOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderLineItemRetrieveOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderLineItemRetrieveOrder input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SoldToSnapshotId == input.SoldToSnapshotId ||
                    (this.SoldToSnapshotId != null &&
                    this.SoldToSnapshotId.Equals(input.SoldToSnapshotId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SoldToSnapshotId != null)
                {
                    hashCode = (hashCode * 59) + this.SoldToSnapshotId.GetHashCode();
                }
