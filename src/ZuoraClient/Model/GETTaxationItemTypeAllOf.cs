...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETTaxationItemType_allOf")]
    public partial class GETTaxationItemTypeAllOf : IEquatable<GETTaxationItemTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETTaxationItemTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETTaxationItemTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETTaxationItemTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETTaxationItemTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETTaxationItemTypeAllOf input)
        {
            if (input == null)
            {
                return false;
