...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRevenueEventDetailType")]
    public partial class GETRevenueEventDetailType : IEquatable<GETRevenueEventDetailType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETRevenueEventDetailType);
        }

        /// <summary>
        /// Returns true if GETRevenueEventDetailType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRevenueEventDetailType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRevenueEventDetailType input)
        {
            if (input == null)
            {
                return false;
