...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETJournalEntryDetailType")]
    public partial class GETJournalEntryDetailType : IEquatable<GETJournalEntryDetailType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETJournalEntryDetailType);
        }

        /// <summary>
        /// Returns true if GETJournalEntryDetailType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETJournalEntryDetailType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETJournalEntryDetailType input)
        {
            if (input == null)
            {
                return false;
