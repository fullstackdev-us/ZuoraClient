...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostInvoiceResponse_allOf")]
    public partial class PostInvoiceResponseAllOf : IEquatable<PostInvoiceResponseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInvoiceResponseAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PostInvoiceResponseAllOf);
        }

        /// <summary>
        /// Returns true if PostInvoiceResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostInvoiceResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostInvoiceResponseAllOf input)
        {
            if (input == null)
            {
                return false;
