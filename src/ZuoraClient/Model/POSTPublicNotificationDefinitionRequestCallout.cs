...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTPublicNotificationDefinitionRequest_callout")]
    public partial class POSTPublicNotificationDefinitionRequestCallout : IEquatable<POSTPublicNotificationDefinitionRequestCallout>, IValidatableObject
    {
        /// <summary>
        /// The HTTP method of the callout.
        /// </summary>
        /// <value>The HTTP method of the callout.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTPublicNotificationDefinitionRequestCallout" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTPublicNotificationDefinitionRequestCallout() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTPublicNotificationDefinitionRequestCallout" /> class.
        /// </summary>
        /// <param name="active">The status of the callout. The default is &#x60;true&#x60;. (default to true).</param>
        /// <param name="calloutAuth">calloutAuth.</param>
        /// <param name="calloutBaseurl">The callout URL. It must start with &#39;https://&#39; (required).</param>
        /// <param name="calloutParams">A key-value map of merge fields of this callout. .</param>
        /// <param name="calloutRetry">Specified whether to retry the callout when the callout fails. The default value is &#x60;true&#x60;. (default to true).</param>
        /// <param name="description">Description for the callout..</param>
        /// <param name="eventTypeName">The name of the event type. (required).</param>
        /// <param name="httpMethod">The HTTP method of the callout. (required).</param>
        /// <param name="name">The name of the created callout. (required).</param>
        /// <param name="requiredAuth">Specifies whether the callout requires auth. (required).</param>
        public POSTPublicNotificationDefinitionRequestCallout(bool active = true, CalloutAuth calloutAuth = default(CalloutAuth), string calloutBaseurl = default(string), Dictionary<string, string> calloutParams = default(Dictionary<string, string>), bool calloutRetry = true, string description = default(string), string eventTypeName = default(string), HttpMethodEnum httpMethod = default(HttpMethodEnum), string name = default(string), bool requiredAuth = default(bool))
        {
            // to ensure "calloutBaseurl" is required (not null)
            if (calloutBaseurl == null)
            {
                throw new ArgumentNullException("calloutBaseurl is a required property for POSTPublicNotificationDefinitionRequestCallout and cannot be null");
            }
            this.CalloutBaseurl = calloutBaseurl;
            // to ensure "eventTypeName" is required (not null)
            if (eventTypeName == null)
            {
                throw new ArgumentNullException("eventTypeName is a required property for POSTPublicNotificationDefinitionRequestCallout and cannot be null");
            }
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for POSTPublicNotificationDefinitionRequestCallout and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>The status of the callout. The default is &#x60;true&#x60;.</value>
        [DataMember(Name = "active", EmitDefaultValue = true)]
        public bool Active { get; set; }

        /// <summary>
        /// Gets or Sets CalloutAuth
        /// </summary>
        [DataMember(Name = "calloutAuth", EmitDefaultValue = false)]
        public CalloutAuth CalloutAuth { get; set; }

        /// <summary>
        /// The callout URL. It must start with &#39;https://&#39;
        /// </summary>
        /// <value>The callout URL. It must start with &#39;https://&#39;</value>
        [DataMember(Name = "calloutBaseurl", IsRequired = true, EmitDefaultValue = false)]
        public string CalloutBaseurl { get; set; }

        /// <summary>
        /// A key-value map of merge fields of this callout. 
        /// </summary>
        /// <value>A key-value map of merge fields of this callout. </value>
        [DataMember(Name = "calloutParams", EmitDefaultValue = false)]
        public Dictionary<string, string> CalloutParams { get; set; }

        /// <summary>
        /// Specified whether to retry the callout when the callout fails. The default value is &#x60;true&#x60;.
        /// </summary>
        /// <value>Specified whether to retry the callout when the callout fails. The default value is &#x60;true&#x60;.</value>
        [DataMember(Name = "calloutRetry", EmitDefaultValue = true)]
        public bool CalloutRetry { get; set; }

        /// <summary>
        /// Description for the callout.
        /// </summary>
        /// <value>Description for the callout.</value>
        ...
        [DataMember(Name = "eventTypeName", IsRequired = true, EmitDefaultValue = false)]
        public string EventTypeName { get; set; }

        /// <summary>
        /// The name of the created callout.
        /// </summary>
        /// <value>The name of the created callout.</value>
        ...
        /// </summary>
        /// <value>Specifies whether the callout requires auth.</value>
        [DataMember(Name = "requiredAuth", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class POSTPublicNotificationDefinitionRequestCallout {\n");
            sb.Append("  Active: ").Append(Active).Append("\n");
            sb.Append("  CalloutAuth: ").Append(CalloutAuth).Append("\n");
            sb.Append("  CalloutBaseurl: ").Append(CalloutBaseurl).Append("\n");
            sb.Append("  CalloutParams: ").Append(CalloutParams).Append("\n");
            sb.Append("  CalloutRetry: ").Append(CalloutRetry).Append("\n");
            sb.Append("  Description: ").Append(Description).Append("\n");
            sb.Append("  EventTypeName: ").Append(EventTypeName).Append("\n");
            sb.Append("  HttpMethod: ").Append(HttpMethod).Append("\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  RequiredAuth: ").Append(RequiredAuth).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as POSTPublicNotificationDefinitionRequestCallout);
        }

        /// <summary>
        /// Returns true if POSTPublicNotificationDefinitionRequestCallout instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTPublicNotificationDefinitionRequestCallout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTPublicNotificationDefinitionRequestCallout input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CalloutAuth == input.CalloutAuth ||
                    (this.CalloutAuth != null &&
                    this.CalloutAuth.Equals(input.CalloutAuth))
                ) && 
                (
                    this.CalloutBaseurl == input.CalloutBaseurl ||
                    (this.CalloutBaseurl != null &&
                    this.CalloutBaseurl.Equals(input.CalloutBaseurl))
                ) && 
                (
                    this.CalloutParams == input.CalloutParams ||
                    this.CalloutParams != null &&
                    input.CalloutParams != null &&
                    this.CalloutParams.SequenceEqual(input.CalloutParams)
                ) && 
                (
                    this.CalloutRetry == input.CalloutRetry ||
                    this.CalloutRetry.Equals(input.CalloutRetry)
                ) && 
                (
                ...
                (
                    this.RequiredAuth == input.RequiredAuth ||
                    this.RequiredAuth.Equals(input.RequiredAuth)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CalloutAuth != null)
                {
                    hashCode = (hashCode * 59) + this.CalloutAuth.GetHashCode();
                }
                if (this.CalloutBaseurl != null)
                {
                    hashCode = (hashCode * 59) + this.CalloutBaseurl.GetHashCode();
                }
                if (this.CalloutParams != null)
                {
                    hashCode = (hashCode * 59) + this.CalloutParams.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.CalloutRetry.GetHashCode();
                ...
                hashCode = (hashCode * 59) + this.RequiredAuth.GetHashCode();
                return hashCode;
            }
        }
        ...
        {
            // CalloutBaseurl (string) minLength
            if (this.CalloutBaseurl != null && this.CalloutBaseurl.Length < 10)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CalloutBaseurl, length must be greater than 10.", new [] { "CalloutBaseurl" });
            }
