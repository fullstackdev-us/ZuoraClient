...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PutCreditMemoTaxItemType_allOf")]
    public partial class PutCreditMemoTaxItemTypeAllOf : IEquatable<PutCreditMemoTaxItemTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutCreditMemoTaxItemTypeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutCreditMemoTaxItemTypeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutCreditMemoTaxItemTypeAllOf" /> class.
        /// </summary>
        /// <param name="amount">The amount of the taxation item in the credit memo item. .</param>
        /// <param name="financeInformation">financeInformation.</param>
        /// <param name="id">The ID of the taxation item in the credit memo item.  (required).</param>
        ...
        /// <param name="taxName">The name of taxation. .</param>
        ...
        /// <param name="taxRateType">The type of the tax rate applied to the credit memo. .</param>
        public PutCreditMemoTaxItemTypeAllOf(double amount = default(double), PutCreditMemoTaxItemTypeAllOfFinanceInformation financeInformation = default(PutCreditMemoTaxItemTypeAllOfFinanceInformation), string id = default(string), string jurisdiction = default(string), string locationCode = default(string), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), double taxExemptAmount = default(double), string taxName = default(string), double taxRate = default(double), string taxRateDescription = default(string), TaxRateTypeEnum? taxRateType = default(TaxRateTypeEnum?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PutCreditMemoTaxItemTypeAllOf and cannot be null");
            }
            this.Id = id;
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>The amount of the taxation item in the credit memo item. </value>
        ...
        public PutCreditMemoTaxItemTypeAllOfFinanceInformation FinanceInformation { get; set; }

        /// <summary>
        /// The ID of the taxation item in the credit memo item. 
        /// </summary>
        /// <value>The ID of the taxation item in the credit memo item. </value>
        ...
        {
            return this.Equals(input as PutCreditMemoTaxItemTypeAllOf);
        }

        /// <summary>
        /// Returns true if PutCreditMemoTaxItemTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutCreditMemoTaxItemTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutCreditMemoTaxItemTypeAllOf input)
        {
            if (input == null)
            {
                return false;
