...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyModifyContact_allOf")]
    public partial class ProxyModifyContactAllOf : IEquatable<ProxyModifyContactAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyContactAllOf" /> class.
        /// </summary>
        ...
        public ProxyModifyContactAllOf(string accountId = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string description = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickName = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string postalCode = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyModifyContactAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyModifyContactAllOf);
        }

        /// <summary>
        /// Returns true if ProxyModifyContactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyModifyContactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyContactAllOf input)
        {
            if (input == null)
            {
                return false;
