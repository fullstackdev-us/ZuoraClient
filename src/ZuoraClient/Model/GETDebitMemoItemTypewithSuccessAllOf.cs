...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETDebitMemoItemTypewithSuccess_allOf")]
    public partial class GETDebitMemoItemTypewithSuccessAllOf : IEquatable<GETDebitMemoItemTypewithSuccessAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The tax mode of the debit memo item, indicating whether the amount of the debit memo item includes tax. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETDebitMemoItemTypewithSuccessAllOf" /> class.
        /// </summary>
        /// <param name="amount">The amount of the debit memo item. For tax-inclusive debit memo items, the amount indicates the debit memo item amount including tax. For tax-exclusive debit memo items, the amount indicates the debit memo item amount excluding tax. .</param>
        /// <param name="amountWithoutTax">The debit memo item amount excluding tax. .</param>
        /// <param name="appliedToItemId">The parent debit memo item that this debit memo items is applied to if this item is discount. .</param>
        /// <param name="balance">The balance of the debit memo item. .</param>
        /// <param name="beAppliedAmount">The applied amount of the debit memo item. .</param>
        /// <param name="comment">Comments about the debit memo item.  **Note**: This field is not available if you set the &#x60;zuora-version&#x60; request header to &#x60;257.0&#x60; or later. .</param>
        /// <param name="createdById">The ID of the Zuora user who created the debit memo item. .</param>
        /// <param name="createdDate">The date and time when the debit memo item was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10. .</param>
        /// <param name="description">The description of the debit memo item.  **Note**: This field is only available if you set the &#x60;zuora-version&#x60; request header to &#x60;257.0&#x60; or later. .</param>
        ...
        /// <param name="id">The ID of the debit memo item. .</param>
        /// <param name="processingType">The kind of the charge for the debit memo item. Its possible values are &#x60;Charge&#x60; and &#x60;Discount&#x60;.  .</param>
        /// <param name="quantity">The number of units for the debit memo item. .</param>
        /// <param name="serviceEndDate">The end date of the service period associated with this debit memo item. Service ends one second before the date specified in this field. .</param>
        /// <param name="serviceStartDate">The start date of the service period associated with this debit memo item. If the associated charge is a one-time fee, this date is the date of that charge. .</param>
        /// <param name="sku">The SKU for the product associated with the debit memo item. .</param>
        /// <param name="skuName">The name of the SKU. .</param>
        /// <param name="sourceItemId">The ID of the source item. .</param>
        /// <param name="sourceItemType">The type of the source item. .</param>
        /// <param name="subscriptionId">The ID of the subscription associated with the debit memo item. .</param>
        /// <param name="taxItems">Container for the taxation items of the debit memo item.   **Note**: This field is not available if you set the &#x60;zuora-version&#x60; request header to &#x60;239.0&#x60; or later. .</param>
        /// <param name="taxMode">The tax mode of the debit memo item, indicating whether the amount of the debit memo item includes tax. .</param>
        /// <param name="taxationItems">taxationItems.</param>
        /// <param name="unitOfMeasure">The units to measure usage. .</param>
        /// <param name="unitPrice">The per-unit price of the debit memo item. .</param>
        /// <param name="updatedById">The ID of the Zuora user who last updated the debit memo item. .</param>
        /// <param name="updatedDate">The date and time when the debit memo item was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. .</param>
        public GETDebitMemoItemTypewithSuccessAllOf(double amount = default(double), double amountWithoutTax = default(double), string appliedToItemId = default(string), double balance = default(double), double beAppliedAmount = default(double), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), string description = default(string), bool excludeItemBillingFromRevenueAccounting = default(bool), GETDebitMemoItemTypeAllOfFinanceInformation financeInformation = default(GETDebitMemoItemTypeAllOfFinanceInformation), string id = default(string), string processingType = default(string), double quantity = default(double), DateTime serviceEndDate = default(DateTime), DateTime serviceStartDate = default(DateTime), string sku = default(string), string skuName = default(string), string sourceItemId = default(string), SourceItemTypeEnum? sourceItemType = default(SourceItemTypeEnum?), string subscriptionId = default(string), List<GETDMTaxItemType> taxItems = default(List<GETDMTaxItemType>), TaxModeEnum? taxMode = default(TaxModeEnum?), GETDebitMemoItemTypewithSuccessAllOfTaxationItems taxationItems = default(GETDebitMemoItemTypewithSuccessAllOfTaxationItems), string unitOfMeasure = default(string), double unitPrice = default(double), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>The amount of the debit memo item. For tax-inclusive debit memo items, the amount indicates the debit memo item amount including tax. For tax-exclusive debit memo items, the amount indicates the debit memo item amount excluding tax. </value>
        ...
        /// </summary>
        /// <value>The debit memo item amount excluding tax. </value>
        ...
        /// </summary>
        /// <value>The parent debit memo item that this debit memo items is applied to if this item is discount. </value>
        ...
        /// </summary>
        /// <value>The balance of the debit memo item. </value>
        ...
        /// </summary>
        /// <value>The applied amount of the debit memo item. </value>
        ...
        /// </summary>
        /// <value>Comments about the debit memo item.  **Note**: This field is not available if you set the &#x60;zuora-version&#x60; request header to &#x60;257.0&#x60; or later. </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who created the debit memo item. </value>
        ...
        /// </summary>
        /// <value>The date and time when the debit memo item was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10. </value>
        ...
        /// </summary>
        /// <value>The description of the debit memo item.  **Note**: This field is only available if you set the &#x60;zuora-version&#x60; request header to &#x60;257.0&#x60; or later. </value>
        ...
        public GETDebitMemoItemTypeAllOfFinanceInformation FinanceInformation { get; set; }

        /// <summary>
        /// The ID of the debit memo item. 
        /// </summary>
        /// <value>The ID of the debit memo item. </value>
        ...
        /// </summary>
        /// <value>The kind of the charge for the debit memo item. Its possible values are &#x60;Charge&#x60; and &#x60;Discount&#x60;.  </value>
        ...
        /// </summary>
        /// <value>The number of units for the debit memo item. </value>
        ...
        /// </summary>
        /// <value>The end date of the service period associated with this debit memo item. Service ends one second before the date specified in this field. </value>
        ...
        /// </summary>
        /// <value>The start date of the service period associated with this debit memo item. If the associated charge is a one-time fee, this date is the date of that charge. </value>
        ...
        /// </summary>
        /// <value>The SKU for the product associated with the debit memo item. </value>
        ...
        /// </summary>
        /// <value>The ID of the source item. </value>
        ...
        /// </summary>
        /// <value>The ID of the subscription associated with the debit memo item. </value>
        ...
        /// </summary>
        /// <value>Container for the taxation items of the debit memo item.   **Note**: This field is not available if you set the &#x60;zuora-version&#x60; request header to &#x60;239.0&#x60; or later. </value>
        [DataMember(Name = "taxItems", EmitDefaultValue = false)]
        public List<GETDMTaxItemType> TaxItems { get; set; }

        /// <summary>
        /// Gets or Sets TaxationItems
        /// </summary>
        [DataMember(Name = "taxationItems", EmitDefaultValue = false)]
        public GETDebitMemoItemTypewithSuccessAllOfTaxationItems TaxationItems { get; set; }
        ...
        /// </summary>
        /// <value>The per-unit price of the debit memo item. </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who last updated the debit memo item. </value>
        ...
        /// </summary>
        /// <value>The date and time when the debit memo item was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. </value>
        ...
        {
            return this.Equals(input as GETDebitMemoItemTypewithSuccessAllOf);
        }

        /// <summary>
        /// Returns true if GETDebitMemoItemTypewithSuccessAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETDebitMemoItemTypewithSuccessAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETDebitMemoItemTypewithSuccessAllOf input)
        {
            if (input == null)
            {
                return false;
