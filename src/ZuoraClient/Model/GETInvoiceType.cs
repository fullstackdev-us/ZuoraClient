...
namespace ZuoraClient.Model
{
    ...
    /// GETInvoiceType
    /// </summary>
    [DataContract(Name = "GETInvoiceType")]
    public partial class GETInvoiceType : IEquatable<GETInvoiceType>, IValidatableObject
    {
        ...
        /// <param name="creditBalanceAdjustmentAmount">creditBalanceAdjustmentAmount.</param>
        /// <param name="dueDate">Payment due date as _yyyy-mm-dd_. .</param>
        /// <param name="id">Invoice ID. .</param>
        /// <param name="invoiceDate">Invoice date as _yyyy-mm-dd_ .</param>
        /// <param name="invoiceFiles">URL to retrieve information about all files of a specific invoice if any file exists; otherwise absent. For example, &#x60;https://rest.zuora.com/v1/invoices/2c92c095511f5b4401512682dcfd7987/files&#x60;. If you want to view the invoice file details, call [Get invoice files](https://www.zuora.com/developer/api-reference/#operation/GET_InvoiceFiles) with the returned URL.  If your tenant was created before Zuora Release 228 (R228), July 2018, the value of this field is an array of invoice file details. For more information about the array, see the response body of [Get invoice files](https://www.zuora.com/developer/api-reference/#operation/GET_InvoiceFiles).   Zuora recommends that you use the latest behavior to retrieve invoice information. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/) asking for invoice item and file references to be enabled in the REST API. .</param>
        /// <param name="invoiceItems">URL to retrieve information about all items of a specific invoice. For example, &#x60;https://rest.zuora.com/v1/invoices/2c92c095511f5b4401512682dcfd7987/items&#x60;. If you want to view the invoice item details, call [Get invoice items](https://www.zuora.com/developer/api-reference/#operation/GET_InvoiceItems) with the returned URL.  If your tenant was created before Zuora Release 228 (R228), July 2018, the value of this field is an array of invoice item details. For more information about the array, see the response body of [Get invoice items](https://www.zuora.com/developer/api-reference/#operation/GET_InvoiceItems).   Zuora recommends that you use the latest behavior to retrieve invoice information. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/) asking for invoice item and file references to be enabled in the REST API.  .</param>
        ...
        /// <param name="reversed">Whether the invoice is reversed. .</param>
        ...
        public GETInvoiceType(string accountId = default(string), string accountName = default(string), string accountNumber = default(string), decimal amount = default(decimal), decimal balance = default(decimal), string body = default(string), string createdBy = default(string), decimal creditBalanceAdjustmentAmount = default(decimal), DateTime dueDate = default(DateTime), string id = default(string), DateTime invoiceDate = default(DateTime), string invoiceFiles = default(string), string invoiceItems = default(string), string invoiceNumber = default(string), DateTime invoiceTargetDate = default(DateTime), bool reversed = default(bool), string status = default(string), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets CreditBalanceAdjustmentAmount
        /// </summary>
        ...
        /// </summary>
        /// <value>URL to retrieve information about all files of a specific invoice if any file exists; otherwise absent. For example, &#x60;https://rest.zuora.com/v1/invoices/2c92c095511f5b4401512682dcfd7987/files&#x60;. If you want to view the invoice file details, call [Get invoice files](https://www.zuora.com/developer/api-reference/#operation/GET_InvoiceFiles) with the returned URL.  If your tenant was created before Zuora Release 228 (R228), July 2018, the value of this field is an array of invoice file details. For more information about the array, see the response body of [Get invoice files](https://www.zuora.com/developer/api-reference/#operation/GET_InvoiceFiles).   Zuora recommends that you use the latest behavior to retrieve invoice information. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/) asking for invoice item and file references to be enabled in the REST API. </value>
        ...
        /// </summary>
        /// <value>URL to retrieve information about all items of a specific invoice. For example, &#x60;https://rest.zuora.com/v1/invoices/2c92c095511f5b4401512682dcfd7987/items&#x60;. If you want to view the invoice item details, call [Get invoice items](https://www.zuora.com/developer/api-reference/#operation/GET_InvoiceItems) with the returned URL.  If your tenant was created before Zuora Release 228 (R228), July 2018, the value of this field is an array of invoice item details. For more information about the array, see the response body of [Get invoice items](https://www.zuora.com/developer/api-reference/#operation/GET_InvoiceItems).   Zuora recommends that you use the latest behavior to retrieve invoice information. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/) asking for invoice item and file references to be enabled in the REST API.  </value>
        ...
        /// </summary>
        /// <value>Whether the invoice is reversed. </value>
        ...
        {
            return this.Equals(input as GETInvoiceType);
        }

        /// <summary>
        /// Returns true if GETInvoiceType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETInvoiceType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETInvoiceType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.InvoiceFiles == input.InvoiceFiles ||
                    (this.InvoiceFiles != null &&
                    this.InvoiceFiles.Equals(input.InvoiceFiles))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.InvoiceFiles.GetHashCode();
                }
