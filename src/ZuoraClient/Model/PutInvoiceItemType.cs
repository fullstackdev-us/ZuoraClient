...
namespace ZuoraClient.Model
{
    ...
    /// PutInvoiceItemType
    /// </summary>
    [DataContract(Name = "PutInvoiceItemType")]
    public partial class PutInvoiceItemType : IEquatable<PutInvoiceItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The tax mode of the invoice item, indicating whether the amount of the invoice item includes tax.  **Note:**  - This field is only available if you have Taxation enabled. - If the values of both &#x60;taxCode&#x60; and &#x60;taxMode&#x60; fields are changed to &#x60;null&#x60; when updating a standalone invoice, the corresponding &#x60;invoiceItems&#x60; &gt; &#x60;taxItems&#x60; field and its nested fields specified in the creation request will be removed. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutInvoiceItemType" /> class.
        /// </summary>
        ...
        /// <param name="amount">The amount of the invoice item.   - For tax-inclusive invoice items, the amount indicates the invoice item amount including tax.  - For tax-exclusive invoice items, the amount indicates the invoice item amount excluding tax. .</param>
        ...
        /// <param name="excludeItemBillingFromRevenueAccounting">The flag to exclude the invoice item from revenue accounting.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.   (default to false).</param>
        /// <param name="id">The unique ID of the invoice item. .</param>
        /// <param name="itemType">The type of the invoice item. .</param>
        /// <param name="purchaseOrderNumber">The purchase order number associated the invoice item. .</param>
        /// <param name="quantity">The number of units for the invoice item. .</param>
        ...
        /// <param name="serviceStartDate">The service start date of the invoice item. .</param>
        ...
        /// <param name="taxCode">The tax code identifies which tax rules and tax rates to apply to the invoice item.  **Note:**  - This field is only available if you have Taxation enabled. - If the values of both &#x60;taxCode&#x60; and &#x60;taxMode&#x60; fields are changed to &#x60;null&#x60; when updating a standalone invoice, the corresponding &#x60;invoiceItems&#x60; &gt; &#x60;taxItems&#x60; field and its nested fields specified in the creation request will be removed. .</param>
        /// <param name="taxMode">The tax mode of the invoice item, indicating whether the amount of the invoice item includes tax.  **Note:**  - This field is only available if you have Taxation enabled. - If the values of both &#x60;taxCode&#x60; and &#x60;taxMode&#x60; fields are changed to &#x60;null&#x60; when updating a standalone invoice, the corresponding &#x60;invoiceItems&#x60; &gt; &#x60;taxItems&#x60; field and its nested fields specified in the creation request will be removed. .</param>
        ...
        public PutInvoiceItemType(string accountingCode = default(string), string adjustmentLiabilityAccountingCode = default(string), string adjustmentRevenueAccountingCode = default(string), decimal amount = default(decimal), DateTime chargeDate = default(DateTime), string chargeName = default(string), string contractAssetAccountingCode = default(string), string contractLiabilityAccountingCode = default(string), string contractRecognizedRevenueAccountingCode = default(string), string deferredRevenueAccountingCode = default(string), string description = default(string), List<PutDiscountItemType> discountItems = default(List<PutDiscountItemType>), bool excludeItemBillingFromRevenueAccounting = false, string id = default(string), string itemType = default(string), string purchaseOrderNumber = default(string), decimal quantity = default(decimal), string recognizedRevenueAccountingCode = default(string), string revRecCode = default(string), RevRecTriggerConditionEnum? revRecTriggerCondition = default(RevRecTriggerConditionEnum?), string revenueRecognitionRuleName = default(string), DateTime serviceEndDate = default(DateTime), DateTime serviceStartDate = default(DateTime), string sku = default(string), string taxCode = default(string), TaxModeEnum? taxMode = default(TaxModeEnum?), string unbilledReceivablesAccountingCode = default(string), decimal unitPrice = default(decimal), string uom = default(string), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
        ...
        public List<PutDiscountItemType> DiscountItems { get; set; }
        ...
        /// </summary>
        /// <value>The unique ID of the invoice item. </value>
        ...
        /// </summary>
        /// <value>The purchase order number associated the invoice item. </value>
        ...
        /// </summary>
        /// <value>The tax code identifies which tax rules and tax rates to apply to the invoice item.  **Note:**  - This field is only available if you have Taxation enabled. - If the values of both &#x60;taxCode&#x60; and &#x60;taxMode&#x60; fields are changed to &#x60;null&#x60; when updating a standalone invoice, the corresponding &#x60;invoiceItems&#x60; &gt; &#x60;taxItems&#x60; field and its nested fields specified in the creation request will be removed. </value>
        ...
        {
            return this.Equals(input as PutInvoiceItemType);
        }

        /// <summary>
        /// Returns true if PutInvoiceItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of PutInvoiceItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutInvoiceItemType input)
        {
            if (input == null)
            {
                return false;
