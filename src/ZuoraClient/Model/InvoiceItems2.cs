...
namespace ZuoraClient.Model
{
    ...
    /// InvoiceItems2
    /// </summary>
    [DataContract(Name = "invoiceItems_2")]
    public partial class InvoiceItems2 : IEquatable<InvoiceItems2>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceItems2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvoiceItems2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceItems2" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InvoiceItems2);
        }

        /// <summary>
        /// Returns true if InvoiceItems2 instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceItems2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceItems2 input)
        {
            if (input == null)
            {
                return false;
