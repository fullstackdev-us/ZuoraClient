...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostDiscountItemType")]
    public partial class PostDiscountItemType : IEquatable<PostDiscountItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostDiscountItemType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostDiscountItemType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostDiscountItemType" /> class.
        /// </summary>
        /// <param name="accountingCode">The accounting code associated with the discount item. .</param>
        /// <param name="accountsReceivableAccountingCode">The accounting code for accounts receivable. .</param>
        ...
        /// <param name="amount">The amount of the discount item. - Should be a negative number. For example, &#x60;-10&#x60;. - Always a fixed amount no matter whether the discount charge associated with the discount item uses the [fixed-amount model or percentage model](https://knowledgecenter.zuora.com/Billing/Subscriptions/Product_Catalog/B_Charge_Models/B_Discount_Charge_Models#Fixed_amount_model_and_percentage_model). - For tax-exclusive discount items, this amount indicates the discount item amount excluding tax. - For tax-inclusive discount items, this amount indicates the discount item amount including tax.  (required).</param>
        /// <param name="bookingReference">The booking reference of the discount item. .</param>
        /// <param name="chargeDate">The date when the discount item is charged, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        /// <param name="chargeName">The name of the charge associated with the discount item. This field is required if the &#x60;productRatePlanChargeId&#x60; field is not specified in the request body. .</param>
        ...
        /// <param name="revenueRecognitionRuleName">The name of the revenue recognition rule governing the revenue schedule. **Note:** This field is only available if you have Zuora Finance enabled. .</param>
        /// <param name="sku">The SKU of the invoice item. The SKU of the discount item must be different from the SKU of any existing product. .</param>
        /// <param name="taxItems">Container for taxation items. The maximum number of taxation items is 5. .</param>
        ...
        /// <param name="unitPrice">The per-unit price of the discount item. If the discount charge associated with the discount item uses the percentage model, the unit price will display as a percentage amount in PDF. For example: if unit price is 5.00, it will display as 5.00% in PDF. .</param>
        ...
        public PostDiscountItemType(string accountingCode = default(string), string accountsReceivableAccountingCode = default(string), string adjustmentLiabilityAccountingCode = default(string), string adjustmentRevenueAccountingCode = default(string), decimal amount = default(decimal), string bookingReference = default(string), DateTime chargeDate = default(DateTime), string chargeName = default(string), string contractAssetAccountingCode = default(string), string contractLiabilityAccountingCode = default(string), string contractRecognizedRevenueAccountingCode = default(string), string deferredRevenueAccountingCode = default(string), string description = default(string), string itemType = default(string), string productRatePlanChargeId = default(string), string purchaseOrderNumber = default(string), string recognizedRevenueAccountingCode = default(string), string revRecCode = default(string), RevRecTriggerConditionEnum? revRecTriggerCondition = default(RevRecTriggerConditionEnum?), string revenueRecognitionRuleName = default(string), string sku = default(string), List<PostTaxationItemType> taxItems = default(List<PostTaxationItemType>), string unbilledReceivablesAccountingCode = default(string), decimal unitPrice = default(decimal), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>The accounting code associated with the discount item. </value>
        ...
        /// </summary>
        /// <value>The accounting code for accounts receivable. </value>
        [DataMember(Name = "accountsReceivableAccountingCode", EmitDefaultValue = false)]
        public string AccountsReceivableAccountingCode { get; set; }
        ...
        /// </summary>
        /// <value>The amount of the discount item. - Should be a negative number. For example, &#x60;-10&#x60;. - Always a fixed amount no matter whether the discount charge associated with the discount item uses the [fixed-amount model or percentage model](https://knowledgecenter.zuora.com/Billing/Subscriptions/Product_Catalog/B_Charge_Models/B_Discount_Charge_Models#Fixed_amount_model_and_percentage_model). - For tax-exclusive discount items, this amount indicates the discount item amount excluding tax. - For tax-inclusive discount items, this amount indicates the discount item amount including tax. </value>
        ...
        /// </summary>
        /// <value>The booking reference of the discount item. </value>
        ...
        /// </summary>
        /// <value>The date when the discount item is charged, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The name of the charge associated with the discount item. This field is required if the &#x60;productRatePlanChargeId&#x60; field is not specified in the request body. </value>
        ...
        /// </summary>
        /// <value>The accounting code for the deferred revenue, such as Monthly Recurring Liability. **Note:** This field is only available if you have Zuora Finance enabled. </value>
        ...
        /// </summary>
        /// <value>The description of the discount item. </value>
        ...
        /// </summary>
        /// <value>The type of the discount item. </value>
        ...
        /// </summary>
        /// <value>The ID of the product rate plan charge that the discount item is created from.  If you specify a value for the &#x60;productRatePlanChargeId&#x60; field in the request, Zuora directly copies the values of the following fields from the corresponding product rate plan charge, regardless of the values specified in the request body: - &#x60;chargeName&#x60; - &#x60;sku&#x60;  If you specify a value for the &#x60;productRatePlanChargeId&#x60; field in the request, Zuora directly copies the values of the following fields from the corresponding discount charge that [uses discount specific accounting codes, rule and segment to manage revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Product_Catalog/B_Charge_Models/Manage_Discount_Charges#Use_discount_specific_accounting_codes.2C_rule_and_segment_to_manage_revenue), regardless of the values specified in the request body: - &#x60;accountingCode&#x60; - &#x60;deferredRevenueAccountingCode&#x60; - &#x60;recognizedRevenueAccountingCode&#x60;  If you specify a value for the &#x60;productRatePlanChargeId&#x60; field in the request, Zuora directly copies the values of the following fields from the corresponding invoice item charge if the discount charge DOES NOT [use discount specific accounting codes, rule and segment to manage revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Product_Catalog/B_Charge_Models/Manage_Discount_Charges#Use_discount_specific_accounting_codes.2C_rule_and_segment_to_manage_revenue), regardless of the values specified in the request body: - &#x60;accountingCode&#x60; - &#x60;deferredRevenueAccountingCode&#x60; - &#x60;recognizedRevenueAccountingCode&#x60; </value>
        ...
        /// </summary>
        /// <value>The purchase order number associated with the discount item. </value>
        ...
        /// </summary>
        /// <value>The accounting code for the recognized revenue, such as Monthly Recurring Charges or Overage Charges. **Note:** This field is only available if you have Zuora Finance enabled. </value>
        ...
        /// </summary>
        /// <value>The name of the revenue recognition rule governing the revenue schedule. **Note:** This field is only available if you have Zuora Finance enabled. </value>
        ...
        /// </summary>
        /// <value>The SKU of the invoice item. The SKU of the discount item must be different from the SKU of any existing product. </value>
        ...
        /// </summary>
        /// <value>Container for taxation items. The maximum number of taxation items is 5. </value>
        [DataMember(Name = "taxItems", EmitDefaultValue = false)]
        public List<PostTaxationItemType> TaxItems { get; set; }
        ...
        /// </summary>
        /// <value>The per-unit price of the discount item. If the discount charge associated with the discount item uses the percentage model, the unit price will display as a percentage amount in PDF. For example: if unit price is 5.00, it will display as 5.00% in PDF. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AccountsReceivableAccountingCode: ").Append(AccountsReceivableAccountingCode).Append("\n");
        ...
        {
            return this.Equals(input as PostDiscountItemType);
        }

        /// <summary>
        /// Returns true if PostDiscountItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of PostDiscountItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostDiscountItemType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AccountsReceivableAccountingCode == input.AccountsReceivableAccountingCode ||
                    (this.AccountsReceivableAccountingCode != null &&
                    this.AccountsReceivableAccountingCode.Equals(input.AccountsReceivableAccountingCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AccountsReceivableAccountingCode != null)
                {
                    hashCode = (hashCode * 59) + this.AccountsReceivableAccountingCode.GetHashCode();
                }
