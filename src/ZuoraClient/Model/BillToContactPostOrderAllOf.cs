...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BillToContactPostOrder_allOf")]
    public partial class BillToContactPostOrderAllOf : IEquatable<BillToContactPostOrderAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BillToContactPostOrderAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BillToContactPostOrderAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BillToContactPostOrderAllOf" /> class.
        /// </summary>
        ...
        /// <param name="country">Country; must be a valid country name or abbreviation. If using Zuora Tax, you must specify a country in the bill-to contact to calculate tax. .</param>
        ...
        public BillToContactPostOrderAllOf(string address1 = default(string), string address2 = default(string), string city = default(string), string contactDescription = default(string), string country = default(string), string county = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickname = default(string), string otherPhone = default(string), OtherPhoneTypeEnum? otherPhoneType = default(OtherPhoneTypeEnum?), string personalEmail = default(string), string postalCode = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for BillToContactPostOrderAllOf and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for BillToContactPostOrderAllOf and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Country; must be a valid country name or abbreviation. If using Zuora Tax, you must specify a country in the bill-to contact to calculate tax. </value>
        ...
        {
            return this.Equals(input as BillToContactPostOrderAllOf);
        }

        /// <summary>
        /// Returns true if BillToContactPostOrderAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of BillToContactPostOrderAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillToContactPostOrderAllOf input)
        {
            if (input == null)
            {
                return false;
