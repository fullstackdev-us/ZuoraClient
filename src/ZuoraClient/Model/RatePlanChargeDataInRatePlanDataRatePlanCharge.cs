...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RatePlanChargeDataInRatePlanData_RatePlanCharge")]
    public partial class RatePlanChargeDataInRatePlanDataRatePlanCharge : IEquatable<RatePlanChargeDataInRatePlanDataRatePlanCharge>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RatePlanChargeDataInRatePlanDataRatePlanCharge" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RatePlanChargeDataInRatePlanDataRatePlanCharge() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RatePlanChargeDataInRatePlanDataRatePlanCharge" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RatePlanChargeDataInRatePlanDataRatePlanCharge {\n");
        ...
        {
            return this.Equals(input as RatePlanChargeDataInRatePlanDataRatePlanCharge);
        }

        /// <summary>
        /// Returns true if RatePlanChargeDataInRatePlanDataRatePlanCharge instances are equal
        /// </summary>
        /// <param name="input">Instance of RatePlanChargeDataInRatePlanDataRatePlanCharge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RatePlanChargeDataInRatePlanDataRatePlanCharge input)
        {
            if (input == null)
            {
                return false;
