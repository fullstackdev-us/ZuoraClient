...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetPaymentMethodSnapshot")]
    public partial class ProxyGetPaymentMethodSnapshot : IEquatable<ProxyGetPaymentMethodSnapshot>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The type of bank account associated with the ACH payment.</value>
        ...
        public AchAccountTypeEnum? AchAccountType { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>Specifies the type of direct debit transfer. The value of this field is dependent on the country of the user.  Possible Values:    * &#x60;AutomatischIncasso&#x60; (NL)  * &#x60;LastschriftDE&#x60; (Germany)  * &#x60;LastschriftAT&#x60; (Austria)  * &#x60;DemandeDePrelevement&#x60; (FR)  * &#x60;DirectDebitUK&#x60; (UK)  * &#x60;Domicil&#x60; (Belgium)  * &#x60;LastschriftCH&#x60; (CH)  * &#x60;RID&#x60; (Italy)  * &#x60;OrdenDeDomiciliacion&#x60; (Spain) * &#x60;Autogiro&#x60; (Sweden) * &#x60;Betalingsservice&#x60; (Denmark) </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum BankTransferTypeEnum
        {
            /// <summary>
            /// Enum AutomatischIncasso for value: AutomatischIncasso
            /// </summary>
            [EnumMember(Value = "AutomatischIncasso")]
            AutomatischIncasso = 1,

            /// <summary>
            /// Enum LastschriftDE for value: LastschriftDE
            /// </summary>
            [EnumMember(Value = "LastschriftDE")]
            LastschriftDE = 2,

            /// <summary>
            /// Enum LastschriftAT for value: LastschriftAT
            /// </summary>
            [EnumMember(Value = "LastschriftAT")]
            LastschriftAT = 3,

            /// <summary>
            /// Enum DemandeDePrelevement for value: DemandeDePrelevement
            /// </summary>
            [EnumMember(Value = "DemandeDePrelevement")]
            DemandeDePrelevement = 4,

            /// <summary>
            /// Enum DirectDebitUK for value: DirectDebitUK
            /// </summary>
            [EnumMember(Value = "DirectDebitUK")]
            DirectDebitUK = 5,

            /// <summary>
            /// Enum Domicil for value: Domicil
            /// </summary>
            [EnumMember(Value = "Domicil")]
            Domicil = 6,

            /// <summary>
            /// Enum LastschriftCH for value: LastschriftCH
            /// </summary>
            [EnumMember(Value = "LastschriftCH")]
            LastschriftCH = 7,

            /// <summary>
            /// Enum RID for value: RID
            /// </summary>
            [EnumMember(Value = "RID")]
            RID = 8,

            /// <summary>
            /// Enum OrdenDeDomiciliacion for value: OrdenDeDomiciliacion
            /// </summary>
            [EnumMember(Value = "OrdenDeDomiciliacion")]
            OrdenDeDomiciliacion = 9,

            /// <summary>
            /// Enum Autogiro for value: Autogiro
            /// </summary>
            [EnumMember(Value = "Autogiro")]
            Autogiro = 10,

            /// <summary>
            /// Enum Betalingsservice for value: Betalingsservice
            /// </summary>
        ...
        /// </summary>
        /// <value>The type of credit card or debit card.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Indicates if the customer has an existing mandate or a new mandate. Only applicable to direct debit payment methods.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Specifies the status of the payment method.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Specifies the PayPal gateway: PayFlow Pro (Express Checkout) or Adaptive Payments.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum PaypalTypeEnum
        {
            /// <summary>
            /// Enum ExpressCheckout for value: ExpressCheckout
            /// </summary>
            [EnumMember(Value = "ExpressCheckout")]
            ExpressCheckout = 1,

            /// <summary>
            /// Enum AdaptivePayments for value: AdaptivePayments
            /// </summary>
            [EnumMember(Value = "AdaptivePayments")]
            AdaptivePayments = 2
        ...
        public PaypalTypeEnum? PaypalType { get; set; }
        /// <summary>
        ...
        public enum TypeEnum
        {
            ...
            CreditCardReferenceTransaction = 7,
            ...
            /// <summary>
            /// Enum WireTransfer for value: WireTransfer
            /// </summary>
            [EnumMember(Value = "WireTransfer")]
            WireTransfer = 11
        ...
        /// </summary>
        /// <param name="accountId">The ID of the customer account associated with this payment method..</param>
        /// <param name="achAbaCode">The nine-digit routing number or ABA number used by banks. Applicable to ACH payment methods..</param>
        /// <param name="achAccountName">The name of the account holder, which can be either a person or a company. Applicable to ACH payment methods..</param>
        /// <param name="achAccountNumberMask">This is a masked displayable version of the ACH account number, used for security purposes. For example: &#x60;XXXXXXXXX54321&#x60;..</param>
        /// <param name="achAccountType">The type of bank account associated with the ACH payment..</param>
        /// <param name="achBankName">The name of the bank where the ACH payment account is held..</param>
        /// <param name="bankBranchCode">The branch code of the bank used for direct debit..</param>
        /// <param name="bankCheckDigit">The check digit in the international bank account number, which confirms the validity of the account. Applicable to direct debit payment methods..</param>
        /// <param name="bankCity">The city of the direct debit bank..</param>
        ...
        /// <param name="bankName">The name of the direct debit bank..</param>
        /// <param name="bankPostalCode">The zip code or postal code of the direct debit bank..</param>
        /// <param name="bankStreetName">The name of the street of the direct debit bank..</param>
        /// <param name="bankStreetNumber">The number of the direct debit bank..</param>
        /// <param name="bankTransferAccountName">The name on the direct debit bank account..</param>
        /// <param name="bankTransferAccountNumberMask">This is a masked displayable version of the bank account number, used for security purposes. For example: &#x60;XXXXXXXXX54321&#x60;..</param>
        /// <param name="bankTransferAccountType">The type of the customer&#39;s bank account. Applicable to direct debit payment methods..</param>
        /// <param name="bankTransferType">Specifies the type of direct debit transfer. The value of this field is dependent on the country of the user.  Possible Values:    * &#x60;AutomatischIncasso&#x60; (NL)  * &#x60;LastschriftDE&#x60; (Germany)  * &#x60;LastschriftAT&#x60; (Austria)  * &#x60;DemandeDePrelevement&#x60; (FR)  * &#x60;DirectDebitUK&#x60; (UK)  * &#x60;Domicil&#x60; (Belgium)  * &#x60;LastschriftCH&#x60; (CH)  * &#x60;RID&#x60; (Italy)  * &#x60;OrdenDeDomiciliacion&#x60; (Spain) * &#x60;Autogiro&#x60; (Sweden) * &#x60;Betalingsservice&#x60; (Denmark) .</param>
        /// <param name="businessIdentificationCode">The business identification code for Swiss direct payment methods that use the Global Collect payment gateway. Only applicable to direct debit payments in Switzerland with Global Collect..</param>
        /// <param name="city">The city of the customer&#39;s address. Applicable to debit payment methods..</param>
        /// <param name="companyName">The name of the company. .</param>
        /// <param name="country">The two-letter country code of the customer&#39;s address. Applicable to direct debit payment methods..</param>
        /// <param name="creditCardAddress1">The first line of the card holder&#39;s address, which is often a street address or business name. Applicable to credit card and direct debit payment methods..</param>
        /// <param name="creditCardAddress2">The second line of the card holder&#39;s address. Applicable to credit card and direct debit payment methods..</param>
        /// <param name="creditCardCity">The city of the card holder&#39;s address. Applicable to credit card and direct debit payment methods..</param>
        /// <param name="creditCardCountry">The country of the card holder&#39;s address..</param>
        /// <param name="creditCardExpirationMonth">The expiration month of the credit card or debit card. Applicable to credit card and direct debit payment methods..</param>
        /// <param name="creditCardExpirationYear">The expiration month of the credit card or debit card. Applicable to credit card and direct debit payment methods..</param>
        /// <param name="creditCardHolderName">The full name of the card holder. Applicable to credit card and direct debit payment methods..</param>
        /// <param name="creditCardMaskNumber">A masked version of the credit or debit card number..</param>
        /// <param name="creditCardPostalCode">The billing address&#39;s zip code..</param>
        /// <param name="creditCardState">The billing address&#39;s state. Applicable if &#x60;CreditCardCountry&#x60; is either Canada or the US..</param>
        /// <param name="creditCardType">The type of credit card or debit card..</param>
        /// <param name="deviceSessionId">The session ID of the user when the &#x60;PaymentMethod&#x60; was created or updated..</param>
        /// <param name="email">An email address for the payment method in addition to the bill to contact email address..</param>
        /// <param name="existingMandate">Indicates if the customer has an existing mandate or a new mandate. Only applicable to direct debit payment methods..</param>
        /// <param name="firstName">The customer&#39;s first name. Only applicable to direct debit payment methods..</param>
        /// <param name="iBAN">The International Bank Account Number. Only applicable to direct debit payment methods..</param>
        /// <param name="iPAddress">The IP address of the user when the payment method was created or updated..</param>
        /// <param name="id">Object identifier..</param>
        /// <param name="identityNumber">The unique identity number of the customer account.  .</param>
        /// <param name="isCompany">Whether the customer account is a company. .</param>
        ...
        /// <param name="lastName">The customer&#39;s last name. Only applicable to direct debit payment methods..</param>
        /// <param name="lastTransactionDateTime">The date of the most recent transaction..</param>
        /// <param name="lastTransactionStatus">The status of the most recent transaction..</param>
        /// <param name="mandateCreationDate">The date when the mandate was created, in &#x60;yyyy-mm-dd&#x60; format. A mandate is a signed authorization for UK and NL customers. Only applicable to direct debit payment methods..</param>
        /// <param name="mandateID">The ID of the mandate. A mandate is a signed authorization for UK and NL customers. Only applicable to direct debit payment methods..</param>
        /// <param name="mandateReceived">Indicates if  the mandate was received. A mandate is a signed authorization for UK and NL customers. Only applicable to direct debit payment methods..</param>
        /// <param name="mandateUpdateDate">The date when the mandate was last updated, in &#x60;yyyy-mm-dd&#x60; format. A mandate is a signed authorization for UK and NL customers. Only applicable to direct debit payment methods..</param>
        ...
        /// <param name="numConsecutiveFailures">The number of consecutive failed payment for the payment method..</param>
        /// <param name="paymentMethodId">Object identifier of the payment method..</param>
        /// <param name="paymentMethodStatus">Specifies the status of the payment method..</param>
        ...
        /// <param name="paypalBaid">The PayPal billing agreement ID, which is a contract between two PayPal accounts..</param>
        /// <param name="paypalEmail">The email address associated with the account holder&#39;s PayPal account or of the PayPal account of the person paying for the service..</param>
        /// <param name="paypalPreapprovalKey">PayPal&#39;s Adaptive Payments API key..</param>
        /// <param name="paypalType">Specifies the PayPal gateway: PayFlow Pro (Express Checkout) or Adaptive Payments..</param>
        /// <param name="phone">The phone number that the account holder registered with the bank. This field is used for credit card validation when passing to a gateway..</param>
        /// <param name="postalCode">The zip code of the customer&#39;s address. Only applicable to direct debit payment methods..</param>
        /// <param name="secondTokenId">A gateway unique identifier that replaces sensitive payment method data. Applicable to CC Reference Transaction payment methods..</param>
        /// <param name="state">The state of the customer&#39;s address. Only applicable to direct debit payment methods..</param>
        /// <param name="streetName">The street name of the customer&#39;s address. Only applicable to direct debit payment methods..</param>
        /// <param name="streetNumber">The street number of the customer&#39;s address. Only applicable to direct debit payment methods..</param>
        /// <param name="tokenId">A gateway unique identifier that replaces sensitive payment method data or represents a gateway&#39;s unique customer profile. Applicable to CC Reference Transaction payment methods..</param>
        ...
        /// <param name="useDefaultRetryRule">Determines whether to use the default retry rules configured in the Zuora Payments settings..</param>
        public ProxyGetPaymentMethodSnapshot(string accountId = default(string), string achAbaCode = default(string), string achAccountName = default(string), string achAccountNumberMask = default(string), AchAccountTypeEnum? achAccountType = default(AchAccountTypeEnum?), string achBankName = default(string), string bankBranchCode = default(string), string bankCheckDigit = default(string), string bankCity = default(string), string bankCode = default(string), string bankIdentificationNumber = default(string), string bankName = default(string), string bankPostalCode = default(string), string bankStreetName = default(string), string bankStreetNumber = default(string), string bankTransferAccountName = default(string), string bankTransferAccountNumberMask = default(string), string bankTransferAccountType = default(string), BankTransferTypeEnum? bankTransferType = default(BankTransferTypeEnum?), string businessIdentificationCode = default(string), string city = default(string), string companyName = default(string), string country = default(string), string creditCardAddress1 = default(string), string creditCardAddress2 = default(string), string creditCardCity = default(string), string creditCardCountry = default(string), int creditCardExpirationMonth = default(int), int creditCardExpirationYear = default(int), string creditCardHolderName = default(string), string creditCardMaskNumber = default(string), string creditCardPostalCode = default(string), string creditCardState = default(string), CreditCardTypeEnum? creditCardType = default(CreditCardTypeEnum?), string deviceSessionId = default(string), string email = default(string), ExistingMandateEnum? existingMandate = default(ExistingMandateEnum?), string firstName = default(string), string iBAN = default(string), string iPAddress = default(string), string id = default(string), string identityNumber = default(string), bool isCompany = default(bool), DateTime lastFailedSaleTransactionDate = default(DateTime), string lastName = default(string), DateTime lastTransactionDateTime = default(DateTime), string lastTransactionStatus = default(string), DateTime mandateCreationDate = default(DateTime), string mandateID = default(string), string mandateReceived = default(string), DateTime mandateUpdateDate = default(DateTime), int maxConsecutivePaymentFailures = default(int), string name = default(string), int numConsecutiveFailures = default(int), string paymentMethodId = default(string), PaymentMethodStatusEnum? paymentMethodStatus = default(PaymentMethodStatusEnum?), int paymentRetryWindow = default(int), string paypalBaid = default(string), string paypalEmail = default(string), string paypalPreapprovalKey = default(string), PaypalTypeEnum? paypalType = default(PaypalTypeEnum?), string phone = default(string), string postalCode = default(string), string secondTokenId = default(string), string state = default(string), string streetName = default(string), string streetNumber = default(string), string tokenId = default(string), int totalNumberOfErrorPayments = default(int), int totalNumberOfProcessedPayments = default(int), TypeEnum? type = default(TypeEnum?), bool useDefaultRetryRule = default(bool))
        {
        ...
        /// </summary>
        /// <value>The ID of the customer account associated with this payment method.</value>
        ...
        /// </summary>
        /// <value>The nine-digit routing number or ABA number used by banks. Applicable to ACH payment methods.</value>
        ...
        /// </summary>
        /// <value>The name of the account holder, which can be either a person or a company. Applicable to ACH payment methods.</value>
        ...
        /// </summary>
        /// <value>This is a masked displayable version of the ACH account number, used for security purposes. For example: &#x60;XXXXXXXXX54321&#x60;.</value>
        ...
        /// </summary>
        /// <value>The name of the bank where the ACH payment account is held.</value>
        ...
        /// </summary>
        /// <value>The check digit in the international bank account number, which confirms the validity of the account. Applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The city of the direct debit bank.</value>
        ...
        /// </summary>
        /// <value>The name of the direct debit bank.</value>
        ...
        /// </summary>
        /// <value>The zip code or postal code of the direct debit bank.</value>
        ...
        /// </summary>
        /// <value>The name of the street of the direct debit bank.</value>
        ...
        /// </summary>
        /// <value>The number of the direct debit bank.</value>
        ...
        /// </summary>
        /// <value>The name on the direct debit bank account.</value>
        ...
        /// </summary>
        /// <value>This is a masked displayable version of the bank account number, used for security purposes. For example: &#x60;XXXXXXXXX54321&#x60;.</value>
        ...
        /// </summary>
        /// <value>The type of the customer&#39;s bank account. Applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The business identification code for Swiss direct payment methods that use the Global Collect payment gateway. Only applicable to direct debit payments in Switzerland with Global Collect.</value>
        ...
        /// </summary>
        /// <value>The city of the customer&#39;s address. Applicable to debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The two-letter country code of the customer&#39;s address. Applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The first line of the card holder&#39;s address, which is often a street address or business name. Applicable to credit card and direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The second line of the card holder&#39;s address. Applicable to credit card and direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The city of the card holder&#39;s address. Applicable to credit card and direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The expiration month of the credit card or debit card. Applicable to credit card and direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The full name of the card holder. Applicable to credit card and direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>A masked version of the credit or debit card number.</value>
        ...
        /// </summary>
        /// <value>The billing address&#39;s zip code.</value>
        ...
        /// </summary>
        /// <value>The billing address&#39;s state. Applicable if &#x60;CreditCardCountry&#x60; is either Canada or the US.</value>
        ...
        /// </summary>
        /// <value>An email address for the payment method in addition to the bill to contact email address.</value>
        ...
        /// </summary>
        /// <value>The customer&#39;s first name. Only applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The International Bank Account Number. Only applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The unique identity number of the customer account.  </value>
        ...
        /// </summary>
        /// <value>Whether the customer account is a company. </value>
        ...
        /// </summary>
        /// <value>The customer&#39;s last name. Only applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The date of the most recent transaction.</value>
        ...
        /// </summary>
        /// <value>The status of the most recent transaction.</value>
        ...
        /// </summary>
        /// <value>The date when the mandate was created, in &#x60;yyyy-mm-dd&#x60; format. A mandate is a signed authorization for UK and NL customers. Only applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The ID of the mandate. A mandate is a signed authorization for UK and NL customers. Only applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>Indicates if  the mandate was received. A mandate is a signed authorization for UK and NL customers. Only applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The date when the mandate was last updated, in &#x60;yyyy-mm-dd&#x60; format. A mandate is a signed authorization for UK and NL customers. Only applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The number of consecutive failed payment for the payment method.</value>
        ...
        /// </summary>
        /// <value>Object identifier of the payment method.</value>
        ...
        /// </summary>
        /// <value>The PayPal billing agreement ID, which is a contract between two PayPal accounts.</value>
        ...
        /// </summary>
        /// <value>The email address associated with the account holder&#39;s PayPal account or of the PayPal account of the person paying for the service.</value>
        ...
        /// </summary>
        /// <value>PayPal&#39;s Adaptive Payments API key.</value>
        ...
        /// </summary>
        /// <value>The phone number that the account holder registered with the bank. This field is used for credit card validation when passing to a gateway.</value>
        ...
        /// </summary>
        /// <value>The zip code of the customer&#39;s address. Only applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>A gateway unique identifier that replaces sensitive payment method data. Applicable to CC Reference Transaction payment methods.</value>
        ...
        /// </summary>
        /// <value>The state of the customer&#39;s address. Only applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The street name of the customer&#39;s address. Only applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>The street number of the customer&#39;s address. Only applicable to direct debit payment methods.</value>
        ...
        /// </summary>
        /// <value>A gateway unique identifier that replaces sensitive payment method data or represents a gateway&#39;s unique customer profile. Applicable to CC Reference Transaction payment methods.</value>
        ...
        /// </summary>
        /// <value>Determines whether to use the default retry rules configured in the Zuora Payments settings.</value>
        ...
        {
            return this.Equals(input as ProxyGetPaymentMethodSnapshot);
        }

        /// <summary>
        /// Returns true if ProxyGetPaymentMethodSnapshot instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetPaymentMethodSnapshot to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetPaymentMethodSnapshot input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AchAccountNumberMask == input.AchAccountNumberMask ||
                    (this.AchAccountNumberMask != null &&
                    this.AchAccountNumberMask.Equals(input.AchAccountNumberMask))
                ) && 
                (
                ...
                (
                    this.BankPostalCode == input.BankPostalCode ||
                    (this.BankPostalCode != null &&
                    this.BankPostalCode.Equals(input.BankPostalCode))
                ) && 
                (
                    this.BankStreetName == input.BankStreetName ||
                    (this.BankStreetName != null &&
                    this.BankStreetName.Equals(input.BankStreetName))
                ) && 
                (
                    this.BankStreetNumber == input.BankStreetNumber ||
                    (this.BankStreetNumber != null &&
                    this.BankStreetNumber.Equals(input.BankStreetNumber))
                ) && 
                (
                ...
                (
                    this.BankTransferAccountType == input.BankTransferAccountType ||
                    (this.BankTransferAccountType != null &&
                    this.BankTransferAccountType.Equals(input.BankTransferAccountType))
                ) && 
                (
                ...
                (
                    this.LastTransactionStatus == input.LastTransactionStatus ||
                    (this.LastTransactionStatus != null &&
                    this.LastTransactionStatus.Equals(input.LastTransactionStatus))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AchAccountNumberMask.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.BankPostalCode.GetHashCode();
                }
                if (this.BankStreetName != null)
                {
                    hashCode = (hashCode * 59) + this.BankStreetName.GetHashCode();
                }
                if (this.BankStreetNumber != null)
                {
                    hashCode = (hashCode * 59) + this.BankStreetNumber.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.BankTransferAccountType.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.LastTransactionStatus.GetHashCode();
                }
