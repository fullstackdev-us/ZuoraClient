...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetProductRatePlan")]
    public partial class ProxyGetProductRatePlan : IEquatable<ProxyGetProductRatePlan>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="activeCurrencies">A list of 3-letter currency codes representing active currencies for the product rate plan.   This field cannot be queried in conjunction with any other fields except &#x60;id&#x60; at the same time.  .</param>
        ...
        /// <param name="productId">The ID of the product that contains the product rate plan. **Character limit**: 32 **Values**: a string of 32 characters or fewer .</param>
        ...
        public ProxyGetProductRatePlan(List<string> activeCurrencies = default(List<string>), string createdById = default(string), DateTime createdDate = default(DateTime), string description = default(string), DateTime effectiveEndDate = default(DateTime), DateTime effectiveStartDate = default(DateTime), decimal grade = default(decimal), string id = default(string), string name = default(string), string productId = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime), BillingPeriodNSEnum? billingPeriodNS = default(BillingPeriodNSEnum?), string classNS = default(string), string departmentNS = default(string), IncludeChildrenNSEnum? includeChildrenNS = default(IncludeChildrenNSEnum?), string integrationIdNS = default(string), string integrationStatusNS = default(string), ItemTypeNSEnum? itemTypeNS = default(ItemTypeNSEnum?), string locationNS = default(string), string multiCurrencyPriceNS = default(string), string priceNS = default(string), string subsidiaryNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value>A list of 3-letter currency codes representing active currencies for the product rate plan.   This field cannot be queried in conjunction with any other fields except &#x60;id&#x60; at the same time.  </value>
        ...
        {
            return this.Equals(input as ProxyGetProductRatePlan);
        }

        /// <summary>
        /// Returns true if ProxyGetProductRatePlan instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetProductRatePlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetProductRatePlan input)
        {
            if (input == null)
            {
                return false;
