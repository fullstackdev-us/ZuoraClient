...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountTypeBillToContact_allOf")]
    public partial class GETAccountTypeBillToContactAllOf : IEquatable<GETAccountTypeBillToContactAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountTypeBillToContactAllOf" /> class.
        /// </summary>
        ...
        /// <param name="id">ID of the person to bill for the account, 32 characters or less..</param>
        ...
        public GETAccountTypeBillToContactAllOf(string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string id = default(string), string lastName = default(string), string mobilePhone = default(string), string nickname = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string), string zipCode = default(string))
        {
        ...
        /// </summary>
        /// <value>ID of the person to bill for the account, 32 characters or less.</value>
        ...
        {
            return this.Equals(input as GETAccountTypeBillToContactAllOf);
        }

        /// <summary>
        /// Returns true if GETAccountTypeBillToContactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountTypeBillToContactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountTypeBillToContactAllOf input)
        {
            if (input == null)
            {
                return false;
