...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTSubscriptionType_allOf")]
    public partial class POSTSubscriptionTypeAllOf : IEquatable<POSTSubscriptionTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSubscriptionTypeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTSubscriptionTypeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSubscriptionTypeAllOf" /> class.
        /// </summary>
        ...
        public POSTSubscriptionTypeAllOf(string accountKey = default(string), List<string> applicationOrder = default(List<string>), bool applyCredit = default(bool), bool applyCreditBalance = default(bool), bool autoRenew = false, bool collect = true, DateTime contractEffectiveDate = default(DateTime), string creditMemoReasonCode = default(string), DateTime customerAcceptanceDate = default(DateTime), DateTime documentDate = default(DateTime), ExternallyManagedByEnum? externallyManagedBy = default(ExternallyManagedByEnum?), string gatewayId = default(string), long initialTerm = default(long), string initialTermPeriodType = default(string), bool invoice = default(bool), bool invoiceCollect = true, string invoiceOwnerAccountKey = default(string), bool invoiceSeparately = default(bool), DateTime invoiceTargetDate = default(DateTime), DateTime lastBookingDate = default(DateTime), string notes = default(string), string paymentMethodId = default(string), string renewalSetting = default(string), long renewalTerm = default(long), string renewalTermPeriodType = default(string), bool runBilling = true, DateTime serviceActivationDate = default(DateTime), List<POSTSrpCreateType> subscribeToRatePlans = default(List<POSTSrpCreateType>), string subscriptionNumber = default(string), DateTime targetDate = default(DateTime), DateTime termStartDate = default(DateTime), string termType = default(string))
        {
            ...
            {
                throw new ArgumentNullException("subscribeToRatePlans is a required property for POSTSubscriptionTypeAllOf and cannot be null");
            }
            this.SubscribeToRatePlans = subscribeToRatePlans;
            // to ensure "termType" is required (not null)
            if (termType == null)
            {
                throw new ArgumentNullException("termType is a required property for POSTSubscriptionTypeAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as POSTSubscriptionTypeAllOf);
        }

        /// <summary>
        /// Returns true if POSTSubscriptionTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTSubscriptionTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSubscriptionTypeAllOf input)
        {
            if (input == null)
            {
                return false;
