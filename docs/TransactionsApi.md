# ZuoraClient.Api.TransactionsApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**GETTransactionInvoice**](TransactionsApi.md#gettransactioninvoice) | **GET** /v1/transactions/invoices/accounts/{account-key} | List all invoices for an account |
| [**GETTransactionPayment**](TransactionsApi.md#gettransactionpayment) | **GET** /v1/transactions/payments/accounts/{account-key} | List all payments for an account |

<a name="gettransactioninvoice"></a>
# **GETTransactionInvoice**
> GETInvoiceFileWrapper GETTransactionInvoice (string accountKey, string authorization = null, string zuoraTrackId = null, string zuoraEntityIds = null, int? page = null, int? pageSize = null)
...
namespace Example
{
    public class GETTransactionInvoiceExample
    {
        public static void Main()
        {
            ...
            {
                // List all invoices for an account
                GETInvoiceFileWrapper result = apiInstance.GETTransactionInvoice(accountKey, authorization, zuoraTrackId, zuoraEntityIds, page, pageSize);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TransactionsApi.GETTransactionInvoice: " + e.Message);
...
#### Using the GETTransactionInvoiceWithHttpInfo variant
...
{
    // List all invoices for an account
    ApiResponse<GETInvoiceFileWrapper> response = apiInstance.GETTransactionInvoiceWithHttpInfo(accountKey, authorization, zuoraTrackId, zuoraEntityIds, page, pageSize);
...
{
    Debug.Print("Exception when calling TransactionsApi.GETTransactionInvoiceWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
> GETPaymentsType GETTransactionPayment (string accountKey, string authorization = null, string zuoraTrackId = null, string zuoraEntityIds = null, int? page = null, int? pageSize = null)
...
namespace Example
{
    public class GETTransactionPaymentExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // List all payments for an account
                GETPaymentsType result = apiInstance.GETTransactionPayment(accountKey, authorization, zuoraTrackId, zuoraEntityIds, page, pageSize);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling TransactionsApi.GETTransactionPayment: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the GETTransactionPaymentWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // List all payments for an account
    ApiResponse<GETPaymentsType> response = apiInstance.GETTransactionPaymentWithHttpInfo(accountKey, authorization, zuoraTrackId, zuoraEntityIds, page, pageSize);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling TransactionsApi.GETTransactionPaymentWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
