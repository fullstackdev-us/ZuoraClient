...
namespace ZuoraClient.Api
{
    ...
    public interface IAttachmentsApiSync : IApiAccessor
    {
        ...
        CommonResponseType DELETEAttachments(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        ...
        ApiResponse<CommonResponseType> DELETEAttachmentsWithHttpInfo(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        /// <summary>
        ...
        GETAttachmentResponseType GETAttachments(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        ...
        ApiResponse<GETAttachmentResponseType> GETAttachmentsWithHttpInfo(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        /// <summary>
        ...
        GETAttachmentsResponseType GETAttachmentsList(string objectType, string objectKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0);
        ...
        ApiResponse<GETAttachmentsResponseType> GETAttachmentsListWithHttpInfo(string objectType, string objectKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="associatedObjectType">The type of the object to add attachements for.  </param>
        /// <param name="associatedObjectKey">For the Subscription type, specify the Subscription Number. An attachment is tied to the Subscription Number and thus viewable with every subscription version.  For Account, Credit Memo, and Debit Memo, specify the corresponding ID or number. For Invoice, specify the corresponding ID. </param>
        /// <param name="file">The file to be attached. Files with the following extensions are supported: .pdf, .csv, .png, .xlsx, .xls, .doc, .docx, .msg, .jpg, .txt, .htm, .html, .eml, .pptx, .gif, .rtf, .xml, .jpeg, .log, .cls  The maximum file size is 4 MB. </param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        ...
        POSTAttachmentResponseType POSTAttachments(string associatedObjectType, string associatedObjectKey, System.IO.Stream file, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string description = default(string), int operationIndex = 0);
        ...
        ApiResponse<POSTAttachmentResponseType> POSTAttachmentsWithHttpInfo(string associatedObjectType, string associatedObjectKey, System.IO.Stream file, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string description = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CommonResponseType</returns>
        CommonResponseType PUTAttachments(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), PUTAttachmentType request = default(PUTAttachmentType), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CommonResponseType</returns>
        ApiResponse<CommonResponseType> PUTAttachmentsWithHttpInfo(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), PUTAttachmentType request = default(PUTAttachmentType), int operationIndex = 0);
    ...
    public interface IAttachmentsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CommonResponseType> DELETEAttachmentsAsync(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CommonResponseType>> DELETEAttachmentsWithHttpInfoAsync(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve an attachment
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GETAttachmentResponseType> GETAttachmentsAsync(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GETAttachmentResponseType>> GETAttachmentsWithHttpInfoAsync(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List attachments by object type and key
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GETAttachmentsResponseType> GETAttachmentsListAsync(string objectType, string objectKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GETAttachmentsResponseType>> GETAttachmentsListWithHttpInfoAsync(string objectType, string objectKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create an attachment
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<POSTAttachmentResponseType> POSTAttachmentsAsync(string associatedObjectType, string associatedObjectKey, System.IO.Stream file, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string description = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<POSTAttachmentResponseType>> POSTAttachmentsWithHttpInfoAsync(string associatedObjectType, string associatedObjectKey, System.IO.Stream file, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string description = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update an attachment
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CommonResponseType</returns>
        System.Threading.Tasks.Task<CommonResponseType> PUTAttachmentsAsync(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), PUTAttachmentType request = default(PUTAttachmentType), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CommonResponseType)</returns>
        System.Threading.Tasks.Task<ApiResponse<CommonResponseType>> PUTAttachmentsWithHttpInfoAsync(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), PUTAttachmentType request = default(PUTAttachmentType), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AttachmentsApi : IAttachmentsApi
    {
        ...
        /// <returns></returns>
        public AttachmentsApi(ZuoraClient.Client.Configuration configuration)
        {
        ...
        public AttachmentsApi(ZuoraClient.Client.ISynchronousClient client, ZuoraClient.Client.IAsynchronousClient asyncClient, ZuoraClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Delete an attachment Use the Delete Attachment REST request to delete an attachment from a Zuora object.  You can only use this operation if you have a Billing role that includes the Manage Attachments permission and the Delete Attachments permission. For more information, see [Billing roles](https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/d_Billing_Roles). To change your Billing role, contact your Zuora platform administrator. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="attachmentId">Id of the attachment to be deleted.</param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CommonResponseType</returns>
        public CommonResponseType DELETEAttachments(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<CommonResponseType> localVarResponse = DELETEAttachmentsWithHttpInfo(attachmentId, authorization, zuoraTrackId, zuoraEntityIds);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CommonResponseType</returns>
        public ZuoraClient.Client.ApiResponse<CommonResponseType> DELETEAttachmentsWithHttpInfo(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'attachmentId' is set
            if (attachmentId == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'attachmentId' when calling AttachmentsApi->DELETEAttachments");
            }
            ...
            localVarRequestOptions.PathParameters.Add("attachment-id", ZuoraClient.Client.ClientUtils.ParameterToString(attachmentId)); // path parameter
            ...
            localVarRequestOptions.Operation = "AttachmentsApi.DELETEAttachments";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Delete<CommonResponseType>("/v1/attachments/{attachment-id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DELETEAttachments", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            ZuoraClient.Client.ApiResponse<CommonResponseType> localVarResponse = await DELETEAttachmentsWithHttpInfoAsync(attachmentId, authorization, zuoraTrackId, zuoraEntityIds, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CommonResponseType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<CommonResponseType>> DELETEAttachmentsWithHttpInfoAsync(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'attachmentId' is set
            if (attachmentId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<CommonResponseType>("/v1/attachments/{attachment-id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve an attachment Use the View Attachment REST request to retrieve information about an attachment document.  You can only use this operation if you have a Billing role that includes the Manage Attachments permission. For more information, see [Billing roles](https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/d_Billing_Roles). To change your Billing role, contact your Zuora platform administrator. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="attachmentId">Id of the attachment you want to view.</param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETAttachmentResponseType</returns>
        public GETAttachmentResponseType GETAttachments(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GETAttachmentResponseType> localVarResponse = GETAttachmentsWithHttpInfo(attachmentId, authorization, zuoraTrackId, zuoraEntityIds);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETAttachmentResponseType</returns>
        public ZuoraClient.Client.ApiResponse<GETAttachmentResponseType> GETAttachmentsWithHttpInfo(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'attachmentId' is set
            if (attachmentId == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'attachmentId' when calling AttachmentsApi->GETAttachments");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GETAttachmentResponseType>("/v1/attachments/{attachment-id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETAttachmentResponseType</returns>
        public async System.Threading.Tasks.Task<GETAttachmentResponseType> GETAttachmentsAsync(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GETAttachmentResponseType> localVarResponse = await GETAttachmentsWithHttpInfoAsync(attachmentId, authorization, zuoraTrackId, zuoraEntityIds, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETAttachmentResponseType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GETAttachmentResponseType>> GETAttachmentsWithHttpInfoAsync(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'attachmentId' is set
            if (attachmentId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GETAttachmentResponseType>("/v1/attachments/{attachment-id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// List attachments by object type and key Use the View Attachment REST request to get a list of attachments on an account, an invoice, a subscription, a credit memo, or a debit memo.  You can only use this operation if you have a Billing role that includes the Manage Attachments permission. For more information, see [Billing roles](https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/d_Billing_Roles). To change your Billing role, contact your Zuora platform administrator.  **Note**: The Credit and Debit Memos feature is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="objectType">The type of the object to list attachements for. </param>
        /// <param name="objectKey">ID of the object to list attachements for.  - If &#x60;object-type&#x60; is &#x60;account&#x60;, specify an account ID or number.  - If &#x60;object-type&#x60; is &#x60;invoice&#x60;, specify an invoice ID.  - If &#x60;object-type&#x60; is &#x60;subscription&#x60;, specify a subscription number.  - If &#x60;object-type&#x60; is &#x60;creditmemo&#x60;, specify a credit memo ID or number.  - If &#x60;object-type&#x60; is &#x60;debitmemo&#x60;, specify a debit memo ID or number. </param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETAttachmentsResponseType</returns>
        public GETAttachmentsResponseType GETAttachmentsList(string objectType, string objectKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GETAttachmentsResponseType> localVarResponse = GETAttachmentsListWithHttpInfo(objectType, objectKey, authorization, zuoraTrackId, zuoraEntityIds, page, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETAttachmentsResponseType</returns>
        public ZuoraClient.Client.ApiResponse<GETAttachmentsResponseType> GETAttachmentsListWithHttpInfo(string objectType, string objectKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'objectType' is set
            if (objectType == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'objectType' when calling AttachmentsApi->GETAttachmentsList");
            }

            // verify the required parameter 'objectKey' is set
            if (objectKey == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'objectKey' when calling AttachmentsApi->GETAttachmentsList");
            }
            ...
            localVarRequestOptions.PathParameters.Add("object-type", ZuoraClient.Client.ClientUtils.ParameterToString(objectType)); // path parameter
            localVarRequestOptions.PathParameters.Add("object-key", ZuoraClient.Client.ClientUtils.ParameterToString(objectKey)); // path parameter
            if (page != null)
            {
            ...
            localVarRequestOptions.Operation = "AttachmentsApi.GETAttachmentsList";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<GETAttachmentsResponseType>("/v1/attachments/{object-type}/{object-key}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETAttachmentsList", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETAttachmentsResponseType</returns>
        public async System.Threading.Tasks.Task<GETAttachmentsResponseType> GETAttachmentsListAsync(string objectType, string objectKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GETAttachmentsResponseType> localVarResponse = await GETAttachmentsListWithHttpInfoAsync(objectType, objectKey, authorization, zuoraTrackId, zuoraEntityIds, page, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETAttachmentsResponseType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GETAttachmentsResponseType>> GETAttachmentsListWithHttpInfoAsync(string objectType, string objectKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'objectType' is set
            if (objectType == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GETAttachmentsResponseType>("/v1/attachments/{object-type}/{object-key}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create an attachment Use the Add Attachment REST request with a multipart/form-data to attach a document file to an Account, a Subscription, an Invoice, a Credit Memo, or a Debit Memo.  You can only use this operation if you have a Billing role that includes the Manage Attachments permission. For more information, see [Billing roles](https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/d_Billing_Roles). To change your Billing role, contact your Zuora platform administrator.  **Note**: The Credit and Debit Memos feature is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="associatedObjectType">The type of the object to add attachements for.  </param>
        /// <param name="associatedObjectKey">For the Subscription type, specify the Subscription Number. An attachment is tied to the Subscription Number and thus viewable with every subscription version.  For Account, Credit Memo, and Debit Memo, specify the corresponding ID or number. For Invoice, specify the corresponding ID. </param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>POSTAttachmentResponseType</returns>
        public POSTAttachmentResponseType POSTAttachments(string associatedObjectType, string associatedObjectKey, System.IO.Stream file, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string description = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<POSTAttachmentResponseType> localVarResponse = POSTAttachmentsWithHttpInfo(associatedObjectType, associatedObjectKey, file, authorization, zuoraTrackId, zuoraEntityIds, description);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of POSTAttachmentResponseType</returns>
        public ZuoraClient.Client.ApiResponse<POSTAttachmentResponseType> POSTAttachmentsWithHttpInfo(string associatedObjectType, string associatedObjectKey, System.IO.Stream file, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string description = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'associatedObjectType' is set
            if (associatedObjectType == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'associatedObjectType' when calling AttachmentsApi->POSTAttachments");
            }

            // verify the required parameter 'associatedObjectKey' is set
            if (associatedObjectKey == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'associatedObjectKey' when calling AttachmentsApi->POSTAttachments");
            }

            // verify the required parameter 'file' is set
            if (file == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'file' when calling AttachmentsApi->POSTAttachments");
            }
            ...
            if (description != null)
            {
                localVarRequestOptions.QueryParameters.Add(ZuoraClient.Client.ClientUtils.ParameterToMultiMap("", "description", description));
            }
            localVarRequestOptions.QueryParameters.Add(ZuoraClient.Client.ClientUtils.ParameterToMultiMap("", "associatedObjectType", associatedObjectType));
            localVarRequestOptions.QueryParameters.Add(ZuoraClient.Client.ClientUtils.ParameterToMultiMap("", "associatedObjectKey", associatedObjectKey));
            if (authorization != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Authorization", ZuoraClient.Client.ClientUtils.ParameterToString(authorization)); // header parameter
            }
            ...
            localVarRequestOptions.Operation = "AttachmentsApi.POSTAttachments";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<POSTAttachmentResponseType>("/v1/attachments", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("POSTAttachments", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of POSTAttachmentResponseType</returns>
        public async System.Threading.Tasks.Task<POSTAttachmentResponseType> POSTAttachmentsAsync(string associatedObjectType, string associatedObjectKey, System.IO.Stream file, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string description = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<POSTAttachmentResponseType> localVarResponse = await POSTAttachmentsWithHttpInfoAsync(associatedObjectType, associatedObjectKey, file, authorization, zuoraTrackId, zuoraEntityIds, description, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (POSTAttachmentResponseType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<POSTAttachmentResponseType>> POSTAttachmentsWithHttpInfoAsync(string associatedObjectType, string associatedObjectKey, System.IO.Stream file, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string description = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'associatedObjectType' is set
            if (associatedObjectType == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<POSTAttachmentResponseType>("/v1/attachments", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update an attachment Use the Edit Attachment REST request to make changes to the descriptive fields of an attachment, such as the description and the file name. You cannot change the actual content of the attached file in Zuora. If you need to change the actual content, you need to delete the attachment and add the updated file as a new attachment.  You can only use this operation if you have a Billing role that includes the Manage Attachments permission. For more information, see [Billing roles](https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/d_Billing_Roles). To change your Billing role, contact your Zuora platform administrator. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="attachmentId">Id of the attachment to be updated.</param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CommonResponseType</returns>
        public CommonResponseType PUTAttachments(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), PUTAttachmentType request = default(PUTAttachmentType), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<CommonResponseType> localVarResponse = PUTAttachmentsWithHttpInfo(attachmentId, authorization, zuoraTrackId, zuoraEntityIds, request);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CommonResponseType</returns>
        public ZuoraClient.Client.ApiResponse<CommonResponseType> PUTAttachmentsWithHttpInfo(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), PUTAttachmentType request = default(PUTAttachmentType), int operationIndex = 0)
        {
            // verify the required parameter 'attachmentId' is set
            if (attachmentId == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'attachmentId' when calling AttachmentsApi->PUTAttachments");
            }
            ...
            localVarRequestOptions.Operation = "AttachmentsApi.PUTAttachments";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Put<CommonResponseType>("/v1/attachments/{attachment-id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PUTAttachments", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<CommonResponseType> PUTAttachmentsAsync(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), PUTAttachmentType request = default(PUTAttachmentType), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<CommonResponseType> localVarResponse = await PUTAttachmentsWithHttpInfoAsync(attachmentId, authorization, zuoraTrackId, zuoraEntityIds, request, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CommonResponseType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<CommonResponseType>> PUTAttachmentsWithHttpInfoAsync(string attachmentId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), PUTAttachmentType request = default(PUTAttachmentType), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'attachmentId' is set
            if (attachmentId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<CommonResponseType>("/v1/attachments/{attachment-id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
