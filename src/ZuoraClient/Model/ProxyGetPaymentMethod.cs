...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetPaymentMethod")]
    public partial class ProxyGetPaymentMethod : IEquatable<ProxyGetPaymentMethod>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="accountId"> The ID of the customer account associated with this payment method. This field is not required for the account ID. .</param>
        ...
        /// <param name="achAccountType"> The type of bank account associated with the ACH payment. Use this field for ACH payment methods. When creating an ACH payment method on Adyen, this field is required by Zuora but it is not required by Adyen. To create the ACH payment method successfully, specify a real value for this field if you can. If it is not possible to get the real value for it, specify any of the allowed values as a dummy value, &#x60;Checking&#x60; preferably. **Character limit**: 16 **Values**:  - &#x60;BusinessChecking&#x60; - &#x60;BusinnessSaving&#x60; - &#x60;Checking&#x60; - &#x60;Saving&#x60; .</param>
        ...
        /// <param name="active"> Specifies whether a payment method is available in Zuora. This field is used to indicate if a payment method is loaded by the system or created by the customer. - &#x60;true&#x60;: System loaded payment method. - &#x60;false&#x60;: Customer created payment method.  The default value is &#x60;false&#x60;. **Character limit**: 5 **Values**: &#x60;true&#x60;, &#x60;false&#x60; .</param>
        /// <param name="bankBranchCode"> The branch code of the bank used for direct debit. **Character limit**: 10 **Values**:  string of 10 characters or fewer .</param>
        ...
        /// <param name="bankTransferAccountName"> The name on the customer&#39;s bank account. Use this field for bank transfer payment methods. **Character limit**: 60 **Values**:  string of 60 characters or fewer .</param>
        /// <param name="bankTransferAccountNumber">The number of the customer&#39;s bank account. Use this field for bank transfer payment methods.  **Character limit**: 30 **Values**: a string of 30 characters or fewer .</param>
        /// <param name="bankTransferAccountNumberMask"> This is a masked displayable version of the bank account number, used for security purposes. For example: &#x60;XXXXXXXXX54321&#x60;. **Character limit**: 32 **Values**: automatically generated .</param>
        ...
        /// <param name="bankTransferType">The type of direct debit transfer. .</param>
        ...
        /// <param name="country"> The two-letter country code of the customer&#39;s address. Use this field for bank transfer payment methods. **Character limit**: 2 **Values**: a valid country code .</param>
        ...
        /// <param name="deviceSessionId"> The session ID of the user when the &#x60;PaymentMethod&#x60; was created or updated. Some gateways use this field for fraud prevention. If this field is passed to Zuora, then Zuora passes this field to supported gateways. Currently only Verifi supports this field. **Character limit**: 255 .</param>
        ...
        /// <param name="existingMandate"> Indicates if the customer has an existing mandate or a new mandate. A mandate is a signed authorization for UK and NL customers. When you are migrating mandates from another system, be sure to set this field correctly. If you indicate that a new mandate is an existing mandate or vice-versa, then transactions fail. This field is used only for the direct debit payment method. **Character limit**: 3 **Values**: &#x60;Yes&#x60; or &#x60;No&#x60; .</param>
        ...
        /// <param name="mandateReceived"> Indicates if  the mandate was received. A mandate is a signed authorization for UK and NL customers. This field is used only for the direct debit payment method. **Character limit**: 3 **Values**: &#x60;Yes&#x60; or &#x60;No &#x60;(case-sensitive) .</param>
        ...
        /// <param name="paypalType"> Specifies the PayPal gateway: PayFlow Pro (Express Checkout) or Adaptive Payments. This field is required when you use PayPal Adaptive Payments or Payflow Pro (Express Checkout) gateways. **Character limit**: 32 **Values**: &#x60;ExpressCheckout&#x60; or &#x60;AdaptivePayments&#x60; .</param>
        ...
        /// <param name="tokenId"> A gateway unique identifier that replaces sensitive payment method data or represents a gateway&#39;s unique customer profile. &#x60;TokenId&#x60; is required for the CC Reference Transaction payment method. **Character limit**: 255 **Values**: a string of 255 characters or fewer .</param>
        ...
        /// </summary>
        /// <value> The ID of the customer account associated with this payment method. This field is not required for the account ID. </value>
        ...
        /// <summary>
        ///  The type of bank account associated with the ACH payment. Use this field for ACH payment methods. When creating an ACH payment method on Adyen, this field is required by Zuora but it is not required by Adyen. To create the ACH payment method successfully, specify a real value for this field if you can. If it is not possible to get the real value for it, specify any of the allowed values as a dummy value, &#x60;Checking&#x60; preferably. **Character limit**: 16 **Values**:  - &#x60;BusinessChecking&#x60; - &#x60;BusinnessSaving&#x60; - &#x60;Checking&#x60; - &#x60;Saving&#x60; 
        /// </summary>
        /// <value> The type of bank account associated with the ACH payment. Use this field for ACH payment methods. When creating an ACH payment method on Adyen, this field is required by Zuora but it is not required by Adyen. To create the ACH payment method successfully, specify a real value for this field if you can. If it is not possible to get the real value for it, specify any of the allowed values as a dummy value, &#x60;Checking&#x60; preferably. **Character limit**: 16 **Values**:  - &#x60;BusinessChecking&#x60; - &#x60;BusinnessSaving&#x60; - &#x60;Checking&#x60; - &#x60;Saving&#x60; </value>
        ...
        /// </summary>
        /// <value> Specifies whether a payment method is available in Zuora. This field is used to indicate if a payment method is loaded by the system or created by the customer. - &#x60;true&#x60;: System loaded payment method. - &#x60;false&#x60;: Customer created payment method.  The default value is &#x60;false&#x60;. **Character limit**: 5 **Values**: &#x60;true&#x60;, &#x60;false&#x60; </value>
        ...
        /// </summary>
        /// <value> The branch code of the bank used for direct debit. **Character limit**: 10 **Values**:  string of 10 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The name on the customer&#39;s bank account. Use this field for bank transfer payment methods. **Character limit**: 60 **Values**:  string of 60 characters or fewer </value>
        [DataMember(Name = "BankTransferAccountName", EmitDefaultValue = false)]
        public string BankTransferAccountName { get; set; }

        /// <summary>
        /// The number of the customer&#39;s bank account. Use this field for bank transfer payment methods.  **Character limit**: 30 **Values**: a string of 30 characters or fewer 
        /// </summary>
        /// <value>The number of the customer&#39;s bank account. Use this field for bank transfer payment methods.  **Character limit**: 30 **Values**: a string of 30 characters or fewer </value>
        ...
        /// </summary>
        /// <value> This is a masked displayable version of the bank account number, used for security purposes. For example: &#x60;XXXXXXXXX54321&#x60;. **Character limit**: 32 **Values**: automatically generated </value>
        ...
        /// </summary>
        /// <value>The type of direct debit transfer. </value>
        ...
        /// </summary>
        /// <value> The two-letter country code of the customer&#39;s address. Use this field for bank transfer payment methods. **Character limit**: 2 **Values**: a valid country code </value>
        ...
        /// </summary>
        /// <value> The user ID of the person who created the &#x60;PaymentMethod&#x60; object when there is a login user in the user session. In Hosted Payment Method and Zuora Checkout pages, this field is set to 3 as there is no login user to initiate a user session. **Character limit**: 32 **Values**: automatically generated </value>
        ...
        /// </summary>
        /// <value> The session ID of the user when the &#x60;PaymentMethod&#x60; was created or updated. Some gateways use this field for fraud prevention. If this field is passed to Zuora, then Zuora passes this field to supported gateways. Currently only Verifi supports this field. **Character limit**: 255 </value>
        ...
        /// </summary>
        /// <value> Indicates if the customer has an existing mandate or a new mandate. A mandate is a signed authorization for UK and NL customers. When you are migrating mandates from another system, be sure to set this field correctly. If you indicate that a new mandate is an existing mandate or vice-versa, then transactions fail. This field is used only for the direct debit payment method. **Character limit**: 3 **Values**: &#x60;Yes&#x60; or &#x60;No&#x60; </value>
        ...
        /// </summary>
        /// <value> Indicates if  the mandate was received. A mandate is a signed authorization for UK and NL customers. This field is used only for the direct debit payment method. **Character limit**: 3 **Values**: &#x60;Yes&#x60; or &#x60;No &#x60;(case-sensitive) </value>
        ...
        /// </summary>
        /// <value> Specifies the PayPal gateway: PayFlow Pro (Express Checkout) or Adaptive Payments. This field is required when you use PayPal Adaptive Payments or Payflow Pro (Express Checkout) gateways. **Character limit**: 32 **Values**: &#x60;ExpressCheckout&#x60; or &#x60;AdaptivePayments&#x60; </value>
        ...
        /// </summary>
        /// <value> A gateway unique identifier that replaces sensitive payment method data or represents a gateway&#39;s unique customer profile. &#x60;TokenId&#x60; is required for the CC Reference Transaction payment method. **Character limit**: 255 **Values**: a string of 255 characters or fewer </value>
        ...
        {
            return this.Equals(input as ProxyGetPaymentMethod);
        }

        /// <summary>
        /// Returns true if ProxyGetPaymentMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetPaymentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetPaymentMethod input)
        {
            if (input == null)
            {
                return false;
