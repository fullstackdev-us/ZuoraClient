...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETPublicEmailTemplateResponse")]
    public partial class GETPublicEmailTemplateResponse : IEquatable<GETPublicEmailTemplateResponse>, IValidatableObject
    {
        /// <summary>
        /// Email cc type.
        /// </summary>
        /// <value>Email cc type.</value>
        ...
        /// The from email type.
        /// </summary>
        /// <value>The from email type.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>The from email type.</value>
        [DataMember(Name = "fromEmailType", EmitDefaultValue = false)]
        public FromEmailTypeEnum? FromEmailType { get; set; }
        /// <summary>
        /// The reply email type.
        /// </summary>
        /// <value>The reply email type.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// Email receive type.
        /// </summary>
        /// <value>Email receive type.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Email receive type.</value>
        [DataMember(Name = "toEmailType", EmitDefaultValue = false)]
        public ToEmailTypeEnum? ToEmailType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="GETPublicEmailTemplateResponse" /> class.
        /// </summary>
        /// <param name="active">The status of the email template..</param>
        /// <param name="bccEmailAddress">Email BCC address..</param>
        /// <param name="ccEmailAddress">Email CC address..</param>
        /// <param name="ccEmailType">Email cc type. (default to CcEmailTypeEnum.SpecificEmails).</param>
        /// <param name="createdBy">The ID of the user who created the email template..</param>
        /// <param name="createdOn">The time when the email template was created. Specified in the UTC timezone in the ISO860 format (YYYY-MM-DDThh:mm:ss.sTZD). E.g. 1997-07-16T19:20:30.45+00:00.</param>
        /// <param name="description">The description of the email template..</param>
        /// <param name="emailBody">The email body. You can add merge fields in the email object using angle brackets.  User can also embed html tags if &#x60;isHtml&#x60; is &#x60;true&#x60;..</param>
        /// <param name="emailSubject">The email subject. You can add merge fields in the email subject using angle brackets..</param>
        /// <param name="encodingType">The endcode type of the email body..</param>
        /// <param name="eventCategory">The event category code for a standard event. See [Standard Event Categories](https://knowledgecenter.zuora.com/Central_Platform/Notifications/A_Standard_Events/Standard_Event_Category_Code_for_Notification_Histories_API) for all event category codes..</param>
        /// <param name="eventTypeName">The name of the custom event or custom scheduled event..</param>
        /// <param name="eventTypeNamespace">The namespace of the &#x60;eventTypeName&#x60; field for custom events and custom scheduled events.  .</param>
        /// <param name="fromEmailAddress">If formEmailType is SpecificEmail, this field is required..</param>
        /// <param name="fromEmailType">The from email type..</param>
        /// <param name="fromName">The name of email sender..</param>
        /// <param name="id">The email template ID..</param>
        /// <param name="isHtml">Indicates whether the style of email body is HTML..</param>
        ...
        /// <param name="replyToEmailType">The reply email type..</param>
        /// <param name="toEmailAddress">If &#x60;toEmailType&#x60; is &#x60;SpecificEmail&#x60;, this field is required..</param>
        /// <param name="toEmailType">Email receive type..</param>
        /// <param name="updatedBy">The ID of the user who updated the email template..</param>
        /// <param name="updatedOn">The time when the email template was updated. Specified in the UTC timezone in the ISO860 format (YYYY-MM-DDThh:mm:ss.sTZD). E.g. 1997-07-16T19:20:30.45+00:00.</param>
        public GETPublicEmailTemplateResponse(bool active = default(bool), string bccEmailAddress = default(string), string ccEmailAddress = default(string), CcEmailTypeEnum? ccEmailType = CcEmailTypeEnum.SpecificEmails, Guid createdBy = default(Guid), DateTime createdOn = default(DateTime), string description = default(string), string emailBody = default(string), string emailSubject = default(string), EncodingTypeEnum? encodingType = default(EncodingTypeEnum?), decimal eventCategory = default(decimal), string eventTypeName = default(string), string eventTypeNamespace = default(string), string fromEmailAddress = default(string), FromEmailTypeEnum? fromEmailType = default(FromEmailTypeEnum?), string fromName = default(string), Guid id = default(Guid), bool isHtml = default(bool), string name = default(string), string replyToEmailAddress = default(string), ReplyToEmailTypeEnum? replyToEmailType = default(ReplyToEmailTypeEnum?), string toEmailAddress = default(string), ToEmailTypeEnum? toEmailType = default(ToEmailTypeEnum?), Guid updatedBy = default(Guid), DateTime updatedOn = default(DateTime))
        {
            this.Active = active;
        ...
        /// </summary>
        /// <value>The status of the email template.</value>
        ...
        /// </summary>
        /// <value>The ID of the user who created the email template.</value>
        ...
        /// </summary>
        /// <value>The time when the email template was created. Specified in the UTC timezone in the ISO860 format (YYYY-MM-DDThh:mm:ss.sTZD). E.g. 1997-07-16T19:20:30.45+00:00</value>
        ...
        /// <summary>
        /// The email body. You can add merge fields in the email object using angle brackets.  User can also embed html tags if &#x60;isHtml&#x60; is &#x60;true&#x60;.
        /// </summary>
        /// <value>The email body. You can add merge fields in the email object using angle brackets.  User can also embed html tags if &#x60;isHtml&#x60; is &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>The email subject. You can add merge fields in the email subject using angle brackets.</value>
        ...
        /// </summary>
        /// <value>The event category code for a standard event. See [Standard Event Categories](https://knowledgecenter.zuora.com/Central_Platform/Notifications/A_Standard_Events/Standard_Event_Category_Code_for_Notification_Histories_API) for all event category codes.</value>
        ...
        /// </summary>
        /// <value>The name of the custom event or custom scheduled event.</value>
        ...
        /// </summary>
        /// <value>The namespace of the &#x60;eventTypeName&#x60; field for custom events and custom scheduled events.  </value>
        ...
        /// </summary>
        /// <value>If formEmailType is SpecificEmail, this field is required.</value>
        ...
        /// </summary>
        /// <value>The name of email sender.</value>
        ...
        /// </summary>
        /// <value>The email template ID.</value>
        ...
        /// </summary>
        /// <value>Indicates whether the style of email body is HTML.</value>
        ...
        /// </summary>
        /// <value>The ID of the user who updated the email template.</value>
        ...
        /// </summary>
        /// <value>The time when the email template was updated. Specified in the UTC timezone in the ISO860 format (YYYY-MM-DDThh:mm:ss.sTZD). E.g. 1997-07-16T19:20:30.45+00:00</value>
        ...
        {
            return this.Equals(input as GETPublicEmailTemplateResponse);
        }

        /// <summary>
        /// Returns true if GETPublicEmailTemplateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GETPublicEmailTemplateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPublicEmailTemplateResponse input)
        {
            if (input == null)
            {
                return false;
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.FromName != null && this.FromName.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FromName, length must be less than 50.", new [] { "FromName" });
            }
