...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETSubscriptionRatePlanChargesType_allOf")]
    public partial class GETSubscriptionRatePlanChargesTypeAllOf : IEquatable<GETSubscriptionRatePlanChargesTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETSubscriptionRatePlanChargesTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETSubscriptionRatePlanChargesTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETSubscriptionRatePlanChargesTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETSubscriptionRatePlanChargesTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETSubscriptionRatePlanChargesTypeAllOf input)
        {
            if (input == null)
            {
                return false;
