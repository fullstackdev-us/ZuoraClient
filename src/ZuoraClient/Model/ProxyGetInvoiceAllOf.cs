...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetInvoice_allOf")]
    public partial class ProxyGetInvoiceAllOf : IEquatable<ProxyGetInvoiceAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetInvoiceAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetInvoiceAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetInvoiceAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetInvoiceAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetInvoiceAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetInvoiceAllOf input)
        {
            if (input == null)
            {
                return false;
