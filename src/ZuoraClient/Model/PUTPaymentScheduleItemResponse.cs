...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PUTPaymentScheduleItemResponse")]
    public partial class PUTPaymentScheduleItemResponse : IEquatable<PUTPaymentScheduleItemResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTPaymentScheduleItemResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PUTPaymentScheduleItemResponse);
        }

        /// <summary>
        /// Returns true if PUTPaymentScheduleItemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTPaymentScheduleItemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTPaymentScheduleItemResponse input)
        {
            if (input == null)
            {
                return false;
