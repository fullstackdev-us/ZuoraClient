...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETARPaymentTypewithSuccess_allOf")]
    public partial class GETARPaymentTypewithSuccessAllOf : IEquatable<GETARPaymentTypewithSuccessAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETARPaymentTypewithSuccessAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETARPaymentTypewithSuccessAllOf);
        }

        /// <summary>
        /// Returns true if GETARPaymentTypewithSuccessAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETARPaymentTypewithSuccessAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETARPaymentTypewithSuccessAllOf input)
        {
            if (input == null)
            {
                return false;
