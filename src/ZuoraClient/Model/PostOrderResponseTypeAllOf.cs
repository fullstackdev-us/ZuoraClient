...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOrderResponseType_allOf")]
    public partial class PostOrderResponseTypeAllOf : IEquatable<PostOrderResponseTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOrderResponseTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PostOrderResponseTypeAllOf);
        }

        /// <summary>
        /// Returns true if PostOrderResponseTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOrderResponseTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOrderResponseTypeAllOf input)
        {
            if (input == null)
            {
                return false;
