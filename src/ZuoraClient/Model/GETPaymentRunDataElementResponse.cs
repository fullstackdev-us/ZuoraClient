...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETPaymentRunDataElementResponse")]
    public partial class GETPaymentRunDataElementResponse : IEquatable<GETPaymentRunDataElementResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The billing document type specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. </value>
        ...
        public enum DocumentTypeEnum
        {
            ...
            /// <summary>
            /// Enum DebitMemo for value: DebitMemo
            /// </summary>
            [EnumMember(Value = "DebitMemo")]
            DebitMemo = 2
        ...
        /// </summary>
        /// <value>Indicates whether the data is processed successfully or not. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETPaymentRunDataElementResponse" /> class.
        /// </summary>
        /// <param name="accountId">The customer account ID specified in the &#x60;data&#x60; field when creating the payment run. .</param>
        /// <param name="accountNumber">The customer account number specified in the &#x60;data&#x60; field when creating the payment run. .</param>
        /// <param name="amount">The amount specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. .</param>
        /// <param name="amountCollected">The amount that is collected. .</param>
        /// <param name="amountToCollect">The amount to be collected. .</param>
        /// <param name="comment">The comment specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. .</param>
        /// <param name="currency">This field is only available if support for standalone payments is enabled.  The currency of the standalone payment. The currency of the standalone payment can be different from the payment currency defined in the customer account settings. .</param>
        /// <param name="documentId">The billing document ID specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. .</param>
        /// <param name="documentNumber">The billing document number specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. .</param>
        /// <param name="documentType">The billing document type specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. .</param>
        /// <param name="errorCode">The error code of the response. .</param>
        /// <param name="errorMessage">The detailed information of the error response. .</param>
        /// <param name="paymentGatewayId">The payment gateway ID specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. .</param>
        /// <param name="paymentMethodId">The payment method ID specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. .</param>
        /// <param name="result">Indicates whether the data is processed successfully or not. .</param>
        /// <param name="standalone">This field is only available if the support for standalone payment is enabled.  The value &#x60;true&#x60; indicates this is a standalone payment that is created and processed in Zuora through Zuora gateway integration but will be settled outside of Zuora. No settlement data will be created. The standalone payment cannot be applied, unapplied, or transferred. .</param>
        /// <param name="transactions">Container for transactions that apply to the current request. Each element contains an array of the settlement/payment applied to the record. .</param>
        public GETPaymentRunDataElementResponse(string accountId = default(string), string accountNumber = default(string), decimal amount = default(decimal), decimal amountCollected = default(decimal), decimal amountToCollect = default(decimal), string comment = default(string), string currency = default(string), string documentId = default(string), string documentNumber = default(string), DocumentTypeEnum? documentType = default(DocumentTypeEnum?), string errorCode = default(string), string errorMessage = default(string), string paymentGatewayId = default(string), string paymentMethodId = default(string), ResultEnum? result = default(ResultEnum?), bool standalone = default(bool), List<GETPaymentRunDataTransactionElementResponse> transactions = default(List<GETPaymentRunDataTransactionElementResponse>))
        {
        ...
        /// </summary>
        /// <value>The customer account ID specified in the &#x60;data&#x60; field when creating the payment run. </value>
        ...
        /// </summary>
        /// <value>The customer account number specified in the &#x60;data&#x60; field when creating the payment run. </value>
        ...
        /// </summary>
        /// <value>The amount specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. </value>
        ...
        /// </summary>
        /// <value>The amount that is collected. </value>
        ...
        [DataMember(Name = "amountToCollect", EmitDefaultValue = false)]
        public decimal AmountToCollect { get; set; }

        /// <summary>
        /// The comment specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. 
        /// </summary>
        /// <value>The comment specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. </value>
        ...
        /// </summary>
        /// <value>This field is only available if support for standalone payments is enabled.  The currency of the standalone payment. The currency of the standalone payment can be different from the payment currency defined in the customer account settings. </value>
        ...
        /// </summary>
        /// <value>The billing document ID specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. </value>
        ...
        /// </summary>
        /// <value>The billing document number specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. </value>
        ...
        /// </summary>
        /// <value>The error code of the response. </value>
        ...
        /// </summary>
        /// <value>The detailed information of the error response. </value>
        ...
        /// </summary>
        /// <value>The payment gateway ID specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. </value>
        ...
        /// </summary>
        /// <value>The payment method ID specified in the &#x60;data&#x60; field when creating the payment run. &#x60;null&#x60; is returned if it was not specified. </value>
        ...
        /// </summary>
        /// <value>Container for transactions that apply to the current request. Each element contains an array of the settlement/payment applied to the record. </value>
        [DataMember(Name = "transactions", EmitDefaultValue = false)]
        public List<GETPaymentRunDataTransactionElementResponse> Transactions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AmountToCollect: ").Append(AmountToCollect).Append("\n");
        ...
        {
            return this.Equals(input as GETPaymentRunDataElementResponse);
        }

        /// <summary>
        /// Returns true if GETPaymentRunDataElementResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GETPaymentRunDataElementResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPaymentRunDataElementResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AmountToCollect == input.AmountToCollect ||
                    this.AmountToCollect.Equals(input.AmountToCollect)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AmountToCollect.GetHashCode();
