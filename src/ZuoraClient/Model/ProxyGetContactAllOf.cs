...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetContact_allOf")]
    public partial class ProxyGetContactAllOf : IEquatable<ProxyGetContactAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetContactAllOf" /> class.
        /// </summary>
        ...
        public ProxyGetContactAllOf(string accountId = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), string description = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string id = default(string), string lastName = default(string), string mobilePhone = default(string), string nickName = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string postalCode = default(string), string state = default(string), string taxRegion = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime), string workEmail = default(string), string workPhone = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetContactAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetContactAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetContactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetContactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetContactAllOf input)
        {
            if (input == null)
            {
                return false;
