# ZuoraClient.Api.RefundTransactionLogsApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**ObjectGETRefundTransactionLog**](RefundTransactionLogsApi.md#objectgetrefundtransactionlog) | **GET** /v1/object/refund-transaction-log/{id} | CRUD: Retrieve a refund transaction log |

<a name="objectgetrefundtransactionlog"></a>
# **ObjectGETRefundTransactionLog**
> ProxyGetRefundTransactionLog ObjectGETRefundTransactionLog (string id, string authorization = null, string zuoraEntityIds = null, string zuoraTrackId = null, string fields = null)
...
namespace Example
{
    public class ObjectGETRefundTransactionLogExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            config.BasePath = "https://rest.zuora.com";
            var apiInstance = new RefundTransactionLogsApi(config);
            ...
            {
                // CRUD: Retrieve a refund transaction log
                ProxyGetRefundTransactionLog result = apiInstance.ObjectGETRefundTransactionLog(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling RefundTransactionLogsApi.ObjectGETRefundTransactionLog: " + e.Message);
...
#### Using the ObjectGETRefundTransactionLogWithHttpInfo variant
...
{
    // CRUD: Retrieve a refund transaction log
    ApiResponse<ProxyGetRefundTransactionLog> response = apiInstance.ObjectGETRefundTransactionLogWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
...
{
    Debug.Print("Exception when calling RefundTransactionLogsApi.ObjectGETRefundTransactionLogWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
