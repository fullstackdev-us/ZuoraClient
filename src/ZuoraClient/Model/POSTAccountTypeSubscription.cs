...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTAccountTypeSubscription")]
    public partial class POSTAccountTypeSubscription : IEquatable<POSTAccountTypeSubscription>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as POSTAccountTypeSubscription);
        }

        /// <summary>
        /// Returns true if POSTAccountTypeSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTAccountTypeSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTAccountTypeSubscription input)
        {
            if (input == null)
            {
                return false;
