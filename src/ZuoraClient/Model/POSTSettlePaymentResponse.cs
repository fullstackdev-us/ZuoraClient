...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTSettlePaymentResponse")]
    public partial class POSTSettlePaymentResponse : IEquatable<POSTSettlePaymentResponse>, IValidatableObject
    {
        /// <summary>
        /// The status of the payment in the gateway; specifically used for reconciliation. 
        /// </summary>
        /// <value>The status of the payment in the gateway; specifically used for reconciliation. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTSettlePaymentResponse" /> class.
        /// </summary>
        ...
        /// <param name="createdDate">The date and time when the chargeback is created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2019-03-01 15:31:10. .</param>
        ...
        /// <param name="gatewayState">The status of the payment in the gateway; specifically used for reconciliation. .</param>
        /// <param name="id">The ID of the payment chargeback. .</param>
        /// <param name="markedForSubmissionOn">The date and time when a charge was marked and waiting for batch submission to the payment process, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        ...
        /// <param name="secondPaymentReferenceId">The transaction ID returned by the payment gateway if there is an additional transaction for the payment.  .</param>
        /// <param name="settledOn">The date and time when the transaction is settled, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        ...
        /// <param name="success">Indicates if the request is processed successfully. .</param>
        ...
        /// <param name="updatedDate">The date and time when the payment was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2019-03-02 15:36:10. .</param>
        public POSTSettlePaymentResponse(string accountId = default(string), double amount = default(double), double appliedAmount = default(double), string authTransactionId = default(string), string bankIdentificationNumber = default(string), DateTime cancelledOn = default(DateTime), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), double creditBalanceAmount = default(double), string currency = default(string), DateTime effectiveDate = default(DateTime), POSTReconcileRefundResponseFinanceInformation financeInformation = default(POSTReconcileRefundResponseFinanceInformation), string gatewayId = default(string), string gatewayOrderId = default(string), string gatewayResponse = default(string), string gatewayResponseCode = default(string), GatewayStateEnum? gatewayState = default(GatewayStateEnum?), string id = default(string), DateTime markedForSubmissionOn = default(DateTime), string number = default(string), string paymentMethodId = default(string), string paymentMethodSnapshotId = default(string), string referenceId = default(string), double refundAmount = default(double), string secondPaymentReferenceId = default(string), DateTime settledOn = default(DateTime), string softDescriptor = default(string), string softDescriptorPhone = default(string), string status = default(string), DateTime submittedOn = default(DateTime), bool success = default(bool), TypeEnum? type = default(TypeEnum?), double unappliedAmount = default(double), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The date and time when the chargeback is created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2019-03-01 15:31:10. </value>
        ...
        public POSTReconcileRefundResponseFinanceInformation FinanceInformation { get; set; }
        ...
        /// </summary>
        /// <value>The ID of the payment chargeback. </value>
        ...
        /// </summary>
        /// <value>The date and time when a charge was marked and waiting for batch submission to the payment process, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The transaction ID returned by the payment gateway if there is an additional transaction for the payment.  </value>
        ...
        /// </summary>
        /// <value>The date and time when the transaction is settled, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>Indicates if the request is processed successfully. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2019-03-02 15:36:10. </value>
        ...
        {
            return this.Equals(input as POSTSettlePaymentResponse);
        }

        /// <summary>
        /// Returns true if POSTSettlePaymentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTSettlePaymentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSettlePaymentResponse input)
        {
            if (input == null)
            {
                return false;
