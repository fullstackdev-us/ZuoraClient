...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PUTDebitMemoWithIdType")]
    public partial class PUTDebitMemoWithIdType : IEquatable<PUTDebitMemoWithIdType>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Whether the debit memo is transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite.  </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTDebitMemoWithIdType" /> class.
        /// </summary>
        /// <param name="id">The ID of the debit memo. .</param>
        ...
        /// <param name="effectiveDate">The date when the debit memo takes effect. .</param>
        /// <param name="items">Container for debit memo items. .</param>
        ...
        /// <param name="transferredToAccounting">Whether the debit memo is transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite.  .</param>
        ...
        public PUTDebitMemoWithIdType(string id = default(string), bool autoPay = default(bool), string comment = default(string), DateTime dueDate = default(DateTime), DateTime effectiveDate = default(DateTime), List<PUTDebitMemoItemType> items = default(List<PUTDebitMemoItemType>), string reasonCode = default(string), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>The ID of the debit memo. </value>
        ...
        /// </summary>
        /// <value>Container for debit memo items. </value>
        [DataMember(Name = "items", EmitDefaultValue = false)]
        public List<PUTDebitMemoItemType> Items { get; set; }
        ...
        {
            return this.Equals(input as PUTDebitMemoWithIdType);
        }

        /// <summary>
        /// Returns true if PUTDebitMemoWithIdType instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTDebitMemoWithIdType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTDebitMemoWithIdType input)
        {
            if (input == null)
            {
                return false;
