...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PutInvoiceResponseType")]
    public partial class PutInvoiceResponseType : IEquatable<PutInvoiceResponseType>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Whether the invoice was transferred to an external accounting system. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutInvoiceResponseType" /> class.
        /// </summary>
        /// <param name="accountId">The ID of the customer account associated with the invoice. .</param>
        /// <param name="amount">The total amount of the invoice. .</param>
        /// <param name="autoPay">Whether invoices are automatically picked up for processing in the corresponding payment run.  .</param>
        /// <param name="balance">The balance of the invoice. .</param>
        /// <param name="cancelledById">The ID of the Zuora user who cancelled the invoice. .</param>
        /// <param name="cancelledOn">The date and time when the invoice was cancelled, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        /// <param name="comment">Comments about the invoice.  .</param>
        /// <param name="createdById">The ID of the Zuora user who created the invoice. .</param>
        /// <param name="createdDate">The date and time when the invoice was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10. .</param>
        /// <param name="creditBalanceAdjustmentAmount">**Note:** This filed is only available if you have the Credit Balance feature enabled and the Invoice Settlement feature disabled. The currency amount of the adjustment applied to the customer&#39;s credit balance. .</param>
        /// <param name="currency">A currency defined in the web-based UI administrative settings. .</param>
        /// <param name="discount">The discount of the invoice. .</param>
        /// <param name="dueDate">The date by which the payment for this invoice is due.  .</param>
        /// <param name="id">The unique ID of the invoice. .</param>
        /// <param name="invoiceDate">The date on which to generate the invoice. .</param>
        /// <param name="number">The unique identification number of the invoice. .</param>
        /// <param name="postedById">The ID of the Zuora user who posted the invoice. .</param>
        /// <param name="postedOn">The date and time when the invoice was posted, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format.  .</param>
        ...
        /// <param name="targetDate">The target date for the invoice, in &#x60;yyyy-mm-dd&#x60; format. For example, 2017-07-20.  .</param>
        ...
        /// <param name="transferredToAccounting">Whether the invoice was transferred to an external accounting system. .</param>
        /// <param name="updatedById">The ID of the Zuora user who last updated the invoice. .</param>
        /// <param name="updatedDate">The date and time when the invoice was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. .</param>
        ...
        /// <param name="integrationStatusNS">Status of the invoice&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        /// <param name="syncDateNS">Date when the invoice was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        public PutInvoiceResponseType(string accountId = default(string), decimal amount = default(decimal), bool autoPay = default(bool), decimal balance = default(decimal), string cancelledById = default(string), DateTime cancelledOn = default(DateTime), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), decimal creditBalanceAdjustmentAmount = default(decimal), string currency = default(string), decimal discount = default(decimal), DateTime dueDate = default(DateTime), string id = default(string), DateTime invoiceDate = default(DateTime), string number = default(string), string postedById = default(string), DateTime postedOn = default(DateTime), StatusEnum? status = default(StatusEnum?), bool success = default(bool), DateTime targetDate = default(DateTime), decimal taxAmount = default(decimal), decimal totalTaxExemptAmount = default(decimal), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value>The ID of the customer account associated with the invoice. </value>
        ...
        /// </summary>
        /// <value>The total amount of the invoice. </value>
        ...
        /// </summary>
        /// <value>Whether invoices are automatically picked up for processing in the corresponding payment run.  </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who cancelled the invoice. </value>
        ...
        /// </summary>
        /// <value>The date and time when the invoice was cancelled, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>Comments about the invoice.  </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who created the invoice. </value>
        ...
        /// </summary>
        /// <value>The date and time when the invoice was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10. </value>
        ...
        /// </summary>
        /// <value>**Note:** This filed is only available if you have the Credit Balance feature enabled and the Invoice Settlement feature disabled. The currency amount of the adjustment applied to the customer&#39;s credit balance. </value>
        ...
        /// </summary>
        /// <value>The discount of the invoice. </value>
        ...
        /// </summary>
        /// <value>The date by which the payment for this invoice is due.  </value>
        ...
        /// </summary>
        /// <value>The date on which to generate the invoice. </value>
        ...
        /// </summary>
        /// <value>The unique identification number of the invoice. </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who posted the invoice. </value>
        ...
        /// </summary>
        /// <value>The date and time when the invoice was posted, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format.  </value>
        ...
        /// </summary>
        /// <value>The target date for the invoice, in &#x60;yyyy-mm-dd&#x60; format. For example, 2017-07-20.  </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who last updated the invoice. </value>
        ...
        /// </summary>
        /// <value>The date and time when the invoice was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. </value>
        ...
        /// </summary>
        /// <value>Status of the invoice&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        /// </summary>
        /// <value>Date when the invoice was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        {
            return this.Equals(input as PutInvoiceResponseType);
        }

        /// <summary>
        /// Returns true if PutInvoiceResponseType instances are equal
        /// </summary>
        /// <param name="input">Instance of PutInvoiceResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutInvoiceResponseType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CreditBalanceAdjustmentAmount == input.CreditBalanceAdjustmentAmount ||
                    this.CreditBalanceAdjustmentAmount.Equals(input.CreditBalanceAdjustmentAmount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CreditBalanceAdjustmentAmount.GetHashCode();
