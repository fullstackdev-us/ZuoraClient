...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETDebitMemoTypewithSuccess")]
    public partial class GETDebitMemoTypewithSuccess : IEquatable<GETDebitMemoTypewithSuccess>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETDebitMemoTypewithSuccess" /> class.
        /// </summary>
        ...
        /// <param name="beAppliedAmount">The applied amount of the debit memo. .</param>
        ...
        /// <param name="updatedDate">The date and time when the debit memo was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:31:10. .</param>
        ...
        public GETDebitMemoTypewithSuccess(string accountId = default(string), double amount = default(double), bool autoPay = default(bool), double balance = default(double), double beAppliedAmount = default(double), string billToContactId = default(string), string cancelledById = default(string), DateTime cancelledOn = default(DateTime), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), DateTime debitMemoDate = default(DateTime), DateTime dueDate = default(DateTime), string id = default(string), string latestPDFFileId = default(string), string number = default(string), string paymentTerm = default(string), string postedById = default(string), DateTime postedOn = default(DateTime), string reasonCode = default(string), string referredCreditMemoId = default(string), string referredInvoiceId = default(string), SourceTypeEnum? sourceType = default(SourceTypeEnum?), StatusEnum? status = default(StatusEnum?), DateTime targetDate = default(DateTime), double taxAmount = default(double), string taxMessage = default(string), TaxStatusEnum? taxStatus = default(TaxStatusEnum?), double totalTaxExemptAmount = default(double), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value>The applied amount of the debit memo. </value>
        ...
        /// </summary>
        /// <value>The date and time when the debit memo was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:31:10. </value>
        ...
        {
            return this.Equals(input as GETDebitMemoTypewithSuccess);
        }

        /// <summary>
        /// Returns true if GETDebitMemoTypewithSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of GETDebitMemoTypewithSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETDebitMemoTypewithSuccess input)
        {
            if (input == null)
            {
                return false;
