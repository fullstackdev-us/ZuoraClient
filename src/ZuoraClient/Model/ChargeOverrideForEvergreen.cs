...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChargeOverrideForEvergreen")]
    public partial class ChargeOverrideForEvergreen : IEquatable<ChargeOverrideForEvergreen>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeOverrideForEvergreen" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChargeOverrideForEvergreen() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeOverrideForEvergreen" /> class.
        /// </summary>
        ...
        public ChargeOverrideForEvergreen(ChargeOverrideBilling billing = default(ChargeOverrideBilling), string chargeNumber = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string description = default(string), EndConditions endDate = default(EndConditions), bool excludeItemBillingFromRevenueAccounting = false, bool excludeItemBookingFromRevenueAccounting = false, ChargeOverridePricing pricing = default(ChargeOverridePricing), string productRateplanChargeId = default(string), string revRecCode = default(string), RevRecTriggerConditionEnum? revRecTriggerCondition = default(RevRecTriggerConditionEnum?), RevenueRecognitionRuleNameEnum? revenueRecognitionRuleName = default(RevenueRecognitionRuleNameEnum?), TriggerParams startDate = default(TriggerParams), string uniqueToken = default(string))
        {
            // to ensure "productRateplanChargeId" is required (not null)
            if (productRateplanChargeId == null)
            {
                throw new ArgumentNullException("productRateplanChargeId is a required property for ChargeOverrideForEvergreen and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChargeOverrideForEvergreen {\n");
        ...
        {
            return this.Equals(input as ChargeOverrideForEvergreen);
        }

        /// <summary>
        /// Returns true if ChargeOverrideForEvergreen instances are equal
        /// </summary>
        /// <param name="input">Instance of ChargeOverrideForEvergreen to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargeOverrideForEvergreen input)
        {
            if (input == null)
            {
                return false;
