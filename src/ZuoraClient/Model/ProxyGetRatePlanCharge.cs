...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetRatePlanCharge")]
    public partial class ProxyGetRatePlanCharge : IEquatable<ProxyGetRatePlanCharge>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyGetRatePlanCharge);
        }

        /// <summary>
        /// Returns true if ProxyGetRatePlanCharge instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetRatePlanCharge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetRatePlanCharge input)
        {
            if (input == null)
            {
                return false;
