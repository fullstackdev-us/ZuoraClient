...
namespace ZuoraClient.Api
{
    ...
    /// </summary>
    public interface IChargeMetricsApiSync : IApiAccessor
    {
        ...
        /// <param name="fromTimestamp">The starting date and time of a time range when changes are made to charge metrics, in &#x60;yyyy-mm-ddThh:mm:ssZ&#x60; format. For example, &#x60;2020-08-18T09:01:11Z&#x60;. The timestamp maps to the &#x60;UpdatedOn&#x60; timestamp of the to-be-exported object. </param>
        /// <param name="toTimestamp">The end date and time of a time range when changes are made to charge metrics, in &#x60;yyyy-mm-ddThh:mm:ssZ&#x60; format. For example, &#x60;2020-08-20T09:01:11Z&#x60;. The timestamp maps to the &#x60;UpdatedOn&#x60; timestamp of the to-be-exported object. </param>
        ...
        /// <param name="accept">Expressed as MIME types that the client is able to understand. Using content negotiation, the server then selects one of the proposals, uses it and informs the client of its choice with the &#x60;Content-Type&#x60; response header. The possible response MIME types are &#x60;application/json-seq&#x60; compatible with http://jsonlines.org/, and &#x60;text/csv&#x60; compatible with RFC 4180. &#x60;application/json-seq&#x60; is the default response MIME type. If the &#x60;Accept&#x60; header is not sepecified, or set *_/_*, the response body is returned in application/json-seq MIME type.  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ChargeMetricsResponse</returns>
        ChargeMetricsResponse GETChargeMetrics(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0);
        ...
        /// <param name="accept">Expressed as MIME types that the client is able to understand. Using content negotiation, the server then selects one of the proposals, uses it and informs the client of its choice with the &#x60;Content-Type&#x60; response header. The possible response MIME types are &#x60;application/json-seq&#x60; compatible with http://jsonlines.org/, and &#x60;text/csv&#x60; compatible with RFC 4180. &#x60;application/json-seq&#x60; is the default response MIME type. If the &#x60;Accept&#x60; header is not sepecified, or set *_/_*, the response body is returned in application/json-seq MIME type.  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ChargeMetricsResponse</returns>
        ApiResponse<ChargeMetricsResponse> GETChargeMetricsWithHttpInfo(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="accept">Expressed as MIME types that the client is able to understand. Using content negotiation, the server then selects one of the proposals, uses it and informs the client of its choice with the &#x60;Content-Type&#x60; response header. The possible response MIME types are &#x60;application/json-seq&#x60; compatible with http://jsonlines.org/, and &#x60;text/csv&#x60; compatible with RFC 4180. &#x60;application/json-seq&#x60; is the default response MIME type. If the &#x60;Accept&#x60; header is not sepecified, or set *_/_*, the response body is returned in application/json-seq MIME type.  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ChargeMetricsDiscountAllocationDetailResponse</returns>
        ChargeMetricsDiscountAllocationDetailResponse GETChargeMetricsDiscountAllocationDetails(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0);
        ...
        /// <param name="accept">Expressed as MIME types that the client is able to understand. Using content negotiation, the server then selects one of the proposals, uses it and informs the client of its choice with the &#x60;Content-Type&#x60; response header. The possible response MIME types are &#x60;application/json-seq&#x60; compatible with http://jsonlines.org/, and &#x60;text/csv&#x60; compatible with RFC 4180. &#x60;application/json-seq&#x60; is the default response MIME type. If the &#x60;Accept&#x60; header is not sepecified, or set *_/_*, the response body is returned in application/json-seq MIME type.  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ChargeMetricsDiscountAllocationDetailResponse</returns>
        ApiResponse<ChargeMetricsDiscountAllocationDetailResponse> GETChargeMetricsDiscountAllocationDetailsWithHttpInfo(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IChargeMetricsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of ChargeMetricsResponse</returns>
        System.Threading.Tasks.Task<ChargeMetricsResponse> GETChargeMetricsAsync(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ChargeMetricsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ChargeMetricsResponse>> GETChargeMetricsWithHttpInfoAsync(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List discount allocation details by time range
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ChargeMetricsDiscountAllocationDetailResponse</returns>
        System.Threading.Tasks.Task<ChargeMetricsDiscountAllocationDetailResponse> GETChargeMetricsDiscountAllocationDetailsAsync(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ChargeMetricsDiscountAllocationDetailResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ChargeMetricsDiscountAllocationDetailResponse>> GETChargeMetricsDiscountAllocationDetailsWithHttpInfoAsync(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IChargeMetricsApi : IChargeMetricsApiSync, IChargeMetricsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ChargeMetricsApi : IChargeMetricsApi
    {
        private ZuoraClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeMetricsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ChargeMetricsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ChargeMetricsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public ChargeMetricsApi(ZuoraClient.Client.Configuration configuration)
        {
        ...
        public ChargeMetricsApi(ZuoraClient.Client.ISynchronousClient client, ZuoraClient.Client.IAsynchronousClient asyncClient, ZuoraClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// List charge metrics by time range Retrieves key charge metrics about rate plan charges that have changes in a specified time range.  The purpose of &#x60;fromTimestamp&#x60; and &#x60;toTimestamp&#x60; is to synchronize charge metrics data incrementally.  
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken). </param>
        /// <param name="fromTimestamp">The starting date and time of a time range when changes are made to charge metrics, in &#x60;yyyy-mm-ddThh:mm:ssZ&#x60; format. For example, &#x60;2020-08-18T09:01:11Z&#x60;. The timestamp maps to the &#x60;UpdatedOn&#x60; timestamp of the to-be-exported object. </param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ChargeMetricsResponse</returns>
        public ChargeMetricsResponse GETChargeMetrics(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<ChargeMetricsResponse> localVarResponse = GETChargeMetricsWithHttpInfo(authorization, fromTimestamp, toTimestamp, zuoraTrackId, zuoraEntityIds, accept);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ChargeMetricsResponse</returns>
        public ZuoraClient.Client.ApiResponse<ChargeMetricsResponse> GETChargeMetricsWithHttpInfo(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'authorization' when calling ChargeMetricsApi->GETChargeMetrics");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(ZuoraClient.Client.ClientUtils.ParameterToMultiMap("", "fromTimestamp", fromTimestamp));
            localVarRequestOptions.QueryParameters.Add(ZuoraClient.Client.ClientUtils.ParameterToMultiMap("", "toTimestamp", toTimestamp));
            ...
            if (accept != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Accept", ZuoraClient.Client.ClientUtils.ParameterToString(accept)); // header parameter
            }

            localVarRequestOptions.Operation = "ChargeMetricsApi.GETChargeMetrics";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<ChargeMetricsResponse>("/charge-metrics/data/charge-metrics", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETChargeMetrics", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ChargeMetricsResponse</returns>
        public async System.Threading.Tasks.Task<ChargeMetricsResponse> GETChargeMetricsAsync(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<ChargeMetricsResponse> localVarResponse = await GETChargeMetricsWithHttpInfoAsync(authorization, fromTimestamp, toTimestamp, zuoraTrackId, zuoraEntityIds, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ChargeMetricsResponse)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<ChargeMetricsResponse>> GETChargeMetricsWithHttpInfoAsync(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ChargeMetricsResponse>("/charge-metrics/data/charge-metrics", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// List discount allocation details by time range Retrieves discount allocation details about rate plan charges that have changes in a specified time range.  The purpose of &#x60;fromTimestamp&#x60; and &#x60;toTimestamp&#x60; is to synchronize discount allocation details incrementally.  
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken). </param>
        /// <param name="fromTimestamp">The starting date and time of a time range when changes are made to charge metrics, in &#x60;yyyy-mm-ddThh:mm:ssZ&#x60; format. For example, &#x60;2020-08-18T09:01:11Z&#x60;. The timestamp maps to the &#x60;UpdatedOn&#x60; timestamp of the to-be-exported object. </param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ChargeMetricsDiscountAllocationDetailResponse</returns>
        public ChargeMetricsDiscountAllocationDetailResponse GETChargeMetricsDiscountAllocationDetails(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<ChargeMetricsDiscountAllocationDetailResponse> localVarResponse = GETChargeMetricsDiscountAllocationDetailsWithHttpInfo(authorization, fromTimestamp, toTimestamp, zuoraTrackId, zuoraEntityIds, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ChargeMetricsDiscountAllocationDetailResponse</returns>
        public ZuoraClient.Client.ApiResponse<ChargeMetricsDiscountAllocationDetailResponse> GETChargeMetricsDiscountAllocationDetailsWithHttpInfo(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'authorization' when calling ChargeMetricsApi->GETChargeMetricsDiscountAllocationDetails");
            }
            ...
            localVarRequestOptions.Operation = "ChargeMetricsApi.GETChargeMetricsDiscountAllocationDetails";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<ChargeMetricsDiscountAllocationDetailResponse>("/charge-metrics/data/charge-metrics-discount-allocation-detail", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETChargeMetricsDiscountAllocationDetails", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ChargeMetricsDiscountAllocationDetailResponse</returns>
        public async System.Threading.Tasks.Task<ChargeMetricsDiscountAllocationDetailResponse> GETChargeMetricsDiscountAllocationDetailsAsync(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<ChargeMetricsDiscountAllocationDetailResponse> localVarResponse = await GETChargeMetricsDiscountAllocationDetailsWithHttpInfoAsync(authorization, fromTimestamp, toTimestamp, zuoraTrackId, zuoraEntityIds, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ChargeMetricsDiscountAllocationDetailResponse)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<ChargeMetricsDiscountAllocationDetailResponse>> GETChargeMetricsDiscountAllocationDetailsWithHttpInfoAsync(string authorization, DateTime fromTimestamp, DateTime toTimestamp, string zuoraTrackId = default(string), string zuoraEntityIds = default(string), string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ChargeMetricsDiscountAllocationDetailResponse>("/charge-metrics/data/charge-metrics-discount-allocation-detail", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
