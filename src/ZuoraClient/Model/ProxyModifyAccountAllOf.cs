...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyModifyAccount_allOf")]
    public partial class ProxyModifyAccountAllOf : IEquatable<ProxyModifyAccountAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Status of the account in the system.  Follow the following rules to update the status of accounts: - Include contact IDs in the &#x60;BillToId&#x60; and &#x60;SoldToId&#x60; fields when you change the &#x60;Status&#x60; field value to &#x60;Active&#x60;. - Before changing the status of an account to &#x60;Canceled&#x60;, cancel all subscriptions associated with this account. You cannot cancel an account that has active subscriptions. - You can update a Draft account to Active, assuming the Bill To/Sold To Contacts are assigned.  - You can update a Canceled account to the Active status at any time. - You cannot update the Active or Cancelled status of an account to &#x60;Draft&#x60;. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifyAccountAllOf" /> class.
        /// </summary>
        /// <param name="accountNumber">Unique account number assigned to the account. You can modify the account number of a customer account only if the account has no subscriptions or draft subscriptions only. Otherwise, the account number cannot be modified. **Character limit**: 50 **Values**: one of the following:  - null to auto-generate - a string of 50 characters or fewer that doesn&#39;t begin with the default account number prefix .</param>
        /// <param name="additionalEmailAddresses">List of additional email addresses to receive email notifications. **Character limit**: 120 **Values**: comma-separated list of email addresses .</param>
        ...
        /// <param name="batch"> Organizes your customer accounts into groups to optimize your billing and payment operations. Required if you use the Subscribe call. **Character limit**: 20 **Values**:any system-defined batch (&#x60;Batch1&#x60; - &#x60;Batch50 &#x60;or by name). .</param>
        ...
        /// <param name="currency">Currency that the customer is billed in.   You can update this field only when an account is in Draft status. After the account is activated, you cannot update this field. .</param>
        ...
        /// <param name="defaultPaymentMethodId">ID of the default payment method for the account. This field is required if the AutoPay field is set to &#x60;true&#x60;. For a specified credit card payment method, it is recommended that [the support for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions) for this payment method is already enabled. **Character limit**: 32 **Values**: a valid ID for an existing payment method .</param>
        ...
        /// <param name="invoiceTemplateId">The ID of the invoice template. Each customer account can use a specific invoice template for invoice generation. **Character limit**: 32 **Values**: a valid template ID configured in Zuora Billing Settings .</param>
        ...
        /// <param name="paymentTerm">Indicates when the customer pays for subscriptions. **Character limit**: 100 **Values**: a valid, active payment term defined in the web-based UI administrative settings .</param>
        ...
        /// <param name="soldToId">ID of the person who bought the subscription associated with the account. **Character limit**: 32 **Values**: a valid contact ID for the account .</param>
        /// <param name="status">Status of the account in the system.  Follow the following rules to update the status of accounts: - Include contact IDs in the &#x60;BillToId&#x60; and &#x60;SoldToId&#x60; fields when you change the &#x60;Status&#x60; field value to &#x60;Active&#x60;. - Before changing the status of an account to &#x60;Canceled&#x60;, cancel all subscriptions associated with this account. You cannot cancel an account that has active subscriptions. - You can update a Draft account to Active, assuming the Bill To/Sold To Contacts are assigned.  - You can update a Canceled account to the Active status at any time. - You cannot update the Active or Cancelled status of an account to &#x60;Draft&#x60;. .</param>
        ...
        /// <param name="taxExemptEffectiveDate">Date when the the customer&#39;s tax exemption starts. **Character limit**: 29 **Version notes**: requires Zuora Tax .</param>
        /// <param name="taxExemptExpirationDate">Date when the customer&#39;s tax exemption certificate expires  **Character limit**: 29 **Version notes**: requires Zuora Tax .</param>
        ...
        /// <param name="taxExemptStatus"> Status of the account&#39;s tax exemption. Required if you use Zuora Tax. **Character limit**: 19 **Values**: one of the following:  - &#x60;Yes&#x60; - &#x60;No&#x60; - &#x60;PendingVerification&#x60; .</param>
        ...
        /// <param name="paymentGateway">Gateway used for processing electronic payments and refunds. **Character limit**: 40 **Values**: one of the following:  - a valid configured gateway name - null to inherit the default value set in Zuora Payment Settings .</param>
        public ProxyModifyAccountAllOf(string accountNumber = default(string), string additionalEmailAddresses = default(string), bool allowInvoiceEdit = default(bool), bool autoPay = default(bool), string batch = default(string), string bcdSettingOption = default(string), int billCycleDay = default(int), string billToId = default(string), string crmId = default(string), string currency = default(string), string customerServiceRepName = default(string), string defaultPaymentMethodId = default(string), bool invoiceDeliveryPrefsEmail = default(bool), bool invoiceDeliveryPrefsPrint = default(bool), string invoiceTemplateId = default(string), string name = default(string), string notes = default(string), string parentId = default(string), string paymentTerm = default(string), string purchaseOrderNumber = default(string), string salesRepName = default(string), string soldToId = default(string), StatusEnum? status = default(StatusEnum?), string taxCompanyCode = default(string), string taxExemptCertificateID = default(string), string taxExemptCertificateType = default(string), string taxExemptDescription = default(string), DateTime taxExemptEffectiveDate = default(DateTime), DateTime taxExemptExpirationDate = default(DateTime), string taxExemptIssuingJurisdiction = default(string), string taxExemptStatus = default(string), string vATId = default(string), string communicationProfileId = default(string), string paymentGateway = default(string))
        {
        ...
        /// </summary>
        /// <value>Unique account number assigned to the account. You can modify the account number of a customer account only if the account has no subscriptions or draft subscriptions only. Otherwise, the account number cannot be modified. **Character limit**: 50 **Values**: one of the following:  - null to auto-generate - a string of 50 characters or fewer that doesn&#39;t begin with the default account number prefix </value>
        ...
        /// </summary>
        /// <value>List of additional email addresses to receive email notifications. **Character limit**: 120 **Values**: comma-separated list of email addresses </value>
        ...
        /// </summary>
        /// <value> Organizes your customer accounts into groups to optimize your billing and payment operations. Required if you use the Subscribe call. **Character limit**: 20 **Values**:any system-defined batch (&#x60;Batch1&#x60; - &#x60;Batch50 &#x60;or by name). </value>
        ...
        /// </summary>
        /// <value>Currency that the customer is billed in.   You can update this field only when an account is in Draft status. After the account is activated, you cannot update this field. </value>
        ...
        /// </summary>
        /// <value>The ID of the invoice template. Each customer account can use a specific invoice template for invoice generation. **Character limit**: 32 **Values**: a valid template ID configured in Zuora Billing Settings </value>
        ...
        /// </summary>
        /// <value>Indicates when the customer pays for subscriptions. **Character limit**: 100 **Values**: a valid, active payment term defined in the web-based UI administrative settings </value>
        ...
        /// </summary>
        /// <value>ID of the person who bought the subscription associated with the account. **Character limit**: 32 **Values**: a valid contact ID for the account </value>
        ...
        /// </summary>
        /// <value>Date when the the customer&#39;s tax exemption starts. **Character limit**: 29 **Version notes**: requires Zuora Tax </value>
        ...
        /// </summary>
        /// <value>Date when the customer&#39;s tax exemption certificate expires  **Character limit**: 29 **Version notes**: requires Zuora Tax </value>
        ...
        /// </summary>
        /// <value> Status of the account&#39;s tax exemption. Required if you use Zuora Tax. **Character limit**: 19 **Values**: one of the following:  - &#x60;Yes&#x60; - &#x60;No&#x60; - &#x60;PendingVerification&#x60; </value>
        ...
        /// </summary>
        /// <value>Gateway used for processing electronic payments and refunds. **Character limit**: 40 **Values**: one of the following:  - a valid configured gateway name - null to inherit the default value set in Zuora Payment Settings </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyModifyAccountAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyModifyAccountAllOf);
        }

        /// <summary>
        /// Returns true if ProxyModifyAccountAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyModifyAccountAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyAccountAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SoldToId == input.SoldToId ||
                    (this.SoldToId != null &&
                    this.SoldToId.Equals(input.SoldToId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SoldToId.GetHashCode();
                }
