...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActionAmendInvoiceItem")]
    public partial class ActionAmendInvoiceItem : IEquatable<ActionAmendInvoiceItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionAmendInvoiceItem" /> class.
        /// </summary>
        ...
        /// <param name="productRatePlanChargeId"> The ID of the rate plan charge that&#39;s associated with this invoice item.   **Character limit**: 32  **Values**: inherited from &#x60;ProductRatePlanCharge.Id&#x60; You cannot query for this field. Only the subscribe preview and the amend preview calls will return the value of this field in the response..</param>
        ...
        /// </summary>
        /// <value> The ID of the rate plan charge that&#39;s associated with this invoice item.   **Character limit**: 32  **Values**: inherited from &#x60;ProductRatePlanCharge.Id&#x60; You cannot query for this field. Only the subscribe preview and the amend preview calls will return the value of this field in the response.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionAmendInvoiceItem {\n");
        ...
        {
            return this.Equals(input as ActionAmendInvoiceItem);
        }

        /// <summary>
        /// Returns true if ActionAmendInvoiceItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionAmendInvoiceItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionAmendInvoiceItem input)
        {
            if (input == null)
            {
                return false;
