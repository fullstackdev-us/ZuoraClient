...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountSummaryTypeSoldToContact")]
    public partial class GETAccountSummaryTypeSoldToContact : IEquatable<GETAccountSummaryTypeSoldToContact>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETAccountSummaryTypeSoldToContact);
        }

        /// <summary>
        /// Returns true if GETAccountSummaryTypeSoldToContact instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountSummaryTypeSoldToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummaryTypeSoldToContact input)
        {
            if (input == null)
            {
                return false;
