...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTPMMandateInfo")]
    public partial class POSTPMMandateInfo : IEquatable<POSTPMMandateInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates whether the mandate is an existing mandate. </value>
        [DataMember(Name = "existingMandateStatus", EmitDefaultValue = false)]
        public ExistingMandateStatusEnum? ExistingMandateStatus { get; set; }
        /// <summary>
        /// Indicates whether the mandate is received from the gateway 
        /// </summary>
        /// <value>Indicates whether the mandate is received from the gateway </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Indicates whether the mandate is received from the gateway </value>
        [DataMember(Name = "mandateReceivedStatus", EmitDefaultValue = false)]
        public MandateReceivedStatusEnum? MandateReceivedStatus { get; set; }
        /// <summary>
        /// Defines MitConsentAgreementSrc
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Gets or Sets MitConsentAgreementSrc
        /// </summary>
        ...
        /// </summary>
        /// <value>Specifies how Zuora activates the stored credential profile. Only applicable if you set the &#x60;status&#x60; field to &#x60;Active&#x60;.  * &#x60;Activate&#x60; (default) - Use this value if you are creating the stored credential profile after receiving the customer&#39;s consent.    Zuora will create the stored credential profile then send a cardholder-initiated transaction (CIT) to the payment gateway to validate the stored credential profile. If the CIT succeeds, the status of the stored credential profile will be &#x60;Active&#x60;. If the CIT does not succeed, Zuora will not create a stored credential profile.      If the payment gateway does not support the stored credential transaction framework, the status of the stored credential profile will be &#x60;Agreed&#x60;.   * &#x60;Persist&#x60; - Use this value if the stored credential profile represents a stored credential profile in an external system. The status of the payment method&#39;s stored credential profile will be &#x60;Active&#x60;. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTPMMandateInfo" /> class.
        /// </summary>
        /// <param name="existingMandateStatus">Indicates whether the mandate is an existing mandate. .</param>
        /// <param name="mandateCreationDate">The date on which the mandate was created. .</param>
        /// <param name="mandateId">The mandate ID. .</param>
        /// <param name="mandateReason">The reason of the mandate from the gateway side. .</param>
        /// <param name="mandateReceivedStatus">Indicates whether the mandate is received from the gateway .</param>
        /// <param name="mandateStatus">The status of the mandate from the gateway side. .</param>
        /// <param name="mandateUpdateDate">The date on which the mandate was updated. .</param>
        /// <param name="mitConsentAgreementRef">Reference for the consent agreement that you have established with the customer.   .</param>
        /// <param name="mitConsentAgreementSrc">mitConsentAgreementSrc.</param>
        /// <param name="mitProfileAction">Specifies how Zuora activates the stored credential profile. Only applicable if you set the &#x60;status&#x60; field to &#x60;Active&#x60;.  * &#x60;Activate&#x60; (default) - Use this value if you are creating the stored credential profile after receiving the customer&#39;s consent.    Zuora will create the stored credential profile then send a cardholder-initiated transaction (CIT) to the payment gateway to validate the stored credential profile. If the CIT succeeds, the status of the stored credential profile will be &#x60;Active&#x60;. If the CIT does not succeed, Zuora will not create a stored credential profile.      If the payment gateway does not support the stored credential transaction framework, the status of the stored credential profile will be &#x60;Agreed&#x60;.   * &#x60;Persist&#x60; - Use this value if the stored credential profile represents a stored credential profile in an external system. The status of the payment method&#39;s stored credential profile will be &#x60;Active&#x60;. .</param>
        /// <param name="mitProfileAgreedOn">The date on which the stored credential profile is agreed. The date format is &#x60;yyyy-mm-dd&#x60;. .</param>
        /// <param name="mitProfileType">Indicates the type of the stored credential profile. .</param>
        /// <param name="mitTransactionId">Specifies the ID of the transaction. Only applicable if you set the &#x60;mitProfileAction&#x60; field to &#x60;Persist&#x60;. .</param>
        public POSTPMMandateInfo(ExistingMandateStatusEnum? existingMandateStatus = default(ExistingMandateStatusEnum?), DateTime mandateCreationDate = default(DateTime), string mandateId = default(string), string mandateReason = default(string), MandateReceivedStatusEnum? mandateReceivedStatus = default(MandateReceivedStatusEnum?), string mandateStatus = default(string), DateTime mandateUpdateDate = default(DateTime), string mitConsentAgreementRef = default(string), MitConsentAgreementSrcEnum? mitConsentAgreementSrc = default(MitConsentAgreementSrcEnum?), MitProfileActionEnum? mitProfileAction = default(MitProfileActionEnum?), DateTime mitProfileAgreedOn = default(DateTime), string mitProfileType = default(string), string mitTransactionId = default(string))
        {
        ...
        /// </summary>
        /// <value>The date on which the mandate was created. </value>
        ...
        /// </summary>
        /// <value>The reason of the mandate from the gateway side. </value>
        [DataMember(Name = "mandateReason", EmitDefaultValue = false)]
        public string MandateReason { get; set; }

        /// <summary>
        /// The status of the mandate from the gateway side. 
        /// </summary>
        /// <value>The status of the mandate from the gateway side. </value>
        [DataMember(Name = "mandateStatus", EmitDefaultValue = false)]
        public string MandateStatus { get; set; }

        /// <summary>
        /// The date on which the mandate was updated. 
        /// </summary>
        /// <value>The date on which the mandate was updated. </value>
        ...
        /// </summary>
        /// <value>Reference for the consent agreement that you have established with the customer.   </value>
        ...
        /// </summary>
        /// <value>The date on which the stored credential profile is agreed. The date format is &#x60;yyyy-mm-dd&#x60;. </value>
        ...
        /// </summary>
        /// <value>Indicates the type of the stored credential profile. </value>
        [DataMember(Name = "mitProfileType", EmitDefaultValue = false)]
        public string MitProfileType { get; set; }

        /// <summary>
        /// Specifies the ID of the transaction. Only applicable if you set the &#x60;mitProfileAction&#x60; field to &#x60;Persist&#x60;. 
        /// </summary>
        /// <value>Specifies the ID of the transaction. Only applicable if you set the &#x60;mitProfileAction&#x60; field to &#x60;Persist&#x60;. </value>
        [DataMember(Name = "mitTransactionId", EmitDefaultValue = false)]
        public string MitTransactionId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ExistingMandateStatus: ").Append(ExistingMandateStatus).Append("\n");
            sb.Append("  MandateCreationDate: ").Append(MandateCreationDate).Append("\n");
            sb.Append("  MandateId: ").Append(MandateId).Append("\n");
            sb.Append("  MandateReason: ").Append(MandateReason).Append("\n");
            sb.Append("  MandateReceivedStatus: ").Append(MandateReceivedStatus).Append("\n");
            sb.Append("  MandateStatus: ").Append(MandateStatus).Append("\n");
            ...
            sb.Append("  MitTransactionId: ").Append(MitTransactionId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as POSTPMMandateInfo);
        }

        /// <summary>
        /// Returns true if POSTPMMandateInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTPMMandateInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTPMMandateInfo input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.ExistingMandateStatus == input.ExistingMandateStatus ||
                    this.ExistingMandateStatus.Equals(input.ExistingMandateStatus)
                ) && 
                (
                ...
                (
                    this.MandateReason == input.MandateReason ||
                    (this.MandateReason != null &&
                    this.MandateReason.Equals(input.MandateReason))
                ) && 
                (
                    this.MandateReceivedStatus == input.MandateReceivedStatus ||
                    this.MandateReceivedStatus.Equals(input.MandateReceivedStatus)
                ) && 
                (
                    this.MandateStatus == input.MandateStatus ||
                    (this.MandateStatus != null &&
                    this.MandateStatus.Equals(input.MandateStatus))
                ) && 
                (
                ...
                (
                    this.MitTransactionId == input.MitTransactionId ||
                    (this.MitTransactionId != null &&
                    this.MitTransactionId.Equals(input.MitTransactionId))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.ExistingMandateStatus.GetHashCode();
                ...
                if (this.MandateReason != null)
                {
                    hashCode = (hashCode * 59) + this.MandateReason.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.MandateReceivedStatus.GetHashCode();
                if (this.MandateStatus != null)
                {
                    hashCode = (hashCode * 59) + this.MandateStatus.GetHashCode();
                }
                ...
                if (this.MitTransactionId != null)
                {
                    hashCode = (hashCode * 59) + this.MitTransactionId.GetHashCode();
                }
                return hashCode;
            }
        }
        ...
        {
            // MitTransactionId (string) maxLength
            if (this.MitTransactionId != null && this.MitTransactionId.Length > 128)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MitTransactionId, length must be less than 128.", new [] { "MitTransactionId" });
            }
