...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvoiceItemPreviewResult")]
    public partial class InvoiceItemPreviewResult : IEquatable<InvoiceItemPreviewResult>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceItemPreviewResult" /> class.
        /// </summary>
        /// <param name="additionalInfo">additionalInfo.</param>
        /// <param name="amountWithoutTax">amountWithoutTax.</param>
        /// <param name="appliedToChargeNumber">Available when the chargeNumber of the charge that discount applies to was specified in the request or when the order is amending an existing subscription..</param>
        /// <param name="chargeDescription">chargeDescription.</param>
        /// <param name="chargeName">chargeName.</param>
        /// <param name="chargeNumber">Available when the chargeNumber was specified in the request or when the order is amending an existing subscription..</param>
        /// <param name="orderLineItemNumber">A sequential number auto-assigned for each of order line items in a order, used as an index, for example, \&quot;1\&quot;..</param>
        ...
        /// <param name="taxationItems">List of taxation items.  **Note**: This field is only available if you set the &#x60;zuora-version&#x60; request header to &#x60;309.0&#x60; or later. .</param>
        public InvoiceItemPreviewResult(InvoiceItemPreviewResultAdditionalInfo additionalInfo = default(InvoiceItemPreviewResultAdditionalInfo), decimal amountWithoutTax = default(decimal), string appliedToChargeNumber = default(string), string chargeDescription = default(string), string chargeName = default(string), string chargeNumber = default(string), string orderLineItemNumber = default(string), ProcessingTypeEnum? processingType = default(ProcessingTypeEnum?), string productName = default(string), string productRatePlanChargeId = default(string), DateTime serviceEndDate = default(DateTime), DateTime serviceStartDate = default(DateTime), string subscriptionNumber = default(string), decimal taxAmount = default(decimal), List<InvoiceItemPreviewResultTaxationItemsInner> taxationItems = default(List<InvoiceItemPreviewResultTaxationItemsInner>))
        {
        ...
        public InvoiceItemPreviewResultAdditionalInfo AdditionalInfo { get; set; }

        /// <summary>
        /// Gets or Sets AmountWithoutTax
        /// </summary>
        ...
        /// </summary>
        /// <value>Available when the chargeNumber of the charge that discount applies to was specified in the request or when the order is amending an existing subscription.</value>
        [DataMember(Name = "appliedToChargeNumber", EmitDefaultValue = false)]
        public string AppliedToChargeNumber { get; set; }

        /// <summary>
        /// Gets or Sets ChargeDescription
        /// </summary>
        ...
        /// </summary>
        /// <value>Available when the chargeNumber was specified in the request or when the order is amending an existing subscription.</value>
        ...
        /// </summary>
        /// <value>A sequential number auto-assigned for each of order line items in a order, used as an index, for example, \&quot;1\&quot;.</value>
        [DataMember(Name = "orderLineItemNumber", EmitDefaultValue = false)]
        ...
        /// <summary>
        /// List of taxation items.  **Note**: This field is only available if you set the &#x60;zuora-version&#x60; request header to &#x60;309.0&#x60; or later. 
        /// </summary>
        /// <value>List of taxation items.  **Note**: This field is only available if you set the &#x60;zuora-version&#x60; request header to &#x60;309.0&#x60; or later. </value>
        [DataMember(Name = "taxationItems", EmitDefaultValue = false)]
        public List<InvoiceItemPreviewResultTaxationItemsInner> TaxationItems { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OrderLineItemNumber: ").Append(OrderLineItemNumber).Append("\n");
        ...
        {
            return this.Equals(input as InvoiceItemPreviewResult);
        }

        /// <summary>
        /// Returns true if InvoiceItemPreviewResult instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceItemPreviewResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceItemPreviewResult input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.OrderLineItemNumber == input.OrderLineItemNumber ||
                    (this.OrderLineItemNumber != null &&
                    this.OrderLineItemNumber.Equals(input.OrderLineItemNumber))
                ) && 
                (
                ...
                (
                    ...
                    input.TaxationItems != null &&
                    this.TaxationItems.SequenceEqual(input.TaxationItems)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OrderLineItemNumber != null)
                {
                    hashCode = (hashCode * 59) + this.OrderLineItemNumber.GetHashCode();
                }
