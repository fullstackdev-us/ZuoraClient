...
namespace ZuoraClient.Model
{
    ...
    /// POSTQuoteDocType
    /// </summary>
    [DataContract(Name = "POSTQuoteDocType")]
    public partial class POSTQuoteDocType : IEquatable<POSTQuoteDocType>, IValidatableObject
    {
        ...
        public POSTQuoteDocType(string apiuser = default(string), string documentType = default(string), string locale = default(string), string password = default(string), string quoteId = default(string), string sandbox = default(string), string serverUrl = default(string), string sessionId = default(string), string templateId = default(string), string token = default(string), string useSFDCLocale = default(string), string username = default(string), string zquotesMajorVersion = default(string), string zquotesMinorVersion = default(string))
        {
            // to ensure "documentType" is required (not null)
            if (documentType == null)
            {
                throw new ArgumentNullException("documentType is a required property for POSTQuoteDocType and cannot be null");
            }
            this.DocumentType = documentType;
            // to ensure "quoteId" is required (not null)
            if (quoteId == null)
            {
                throw new ArgumentNullException("quoteId is a required property for POSTQuoteDocType and cannot be null");
            }
            this.QuoteId = quoteId;
            // to ensure "serverUrl" is required (not null)
            if (serverUrl == null)
            {
                throw new ArgumentNullException("serverUrl is a required property for POSTQuoteDocType and cannot be null");
            }
            this.ServerUrl = serverUrl;
            // to ensure "sessionId" is required (not null)
            if (sessionId == null)
            {
                throw new ArgumentNullException("sessionId is a required property for POSTQuoteDocType and cannot be null");
            }
            this.SessionId = sessionId;
            // to ensure "templateId" is required (not null)
            if (templateId == null)
            {
                throw new ArgumentNullException("templateId is a required property for POSTQuoteDocType and cannot be null");
            }
        ...
        [DataMember(Name = "serverUrl", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as POSTQuoteDocType);
        }

        /// <summary>
        /// Returns true if POSTQuoteDocType instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTQuoteDocType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTQuoteDocType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.UseSFDCLocale == input.UseSFDCLocale ||
                    (this.UseSFDCLocale != null &&
                    this.UseSFDCLocale.Equals(input.UseSFDCLocale))
                ) && 
                (
                ...
                (
                    this.ZquotesMajorVersion == input.ZquotesMajorVersion ||
                    (this.ZquotesMajorVersion != null &&
                    this.ZquotesMajorVersion.Equals(input.ZquotesMajorVersion))
                ) && 
                (
                    this.ZquotesMinorVersion == input.ZquotesMinorVersion ||
                    (this.ZquotesMinorVersion != null &&
                    this.ZquotesMinorVersion.Equals(input.ZquotesMinorVersion))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.UseSFDCLocale.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.ZquotesMajorVersion.GetHashCode();
                }
                if (this.ZquotesMinorVersion != null)
                {
                    hashCode = (hashCode * 59) + this.ZquotesMinorVersion.GetHashCode();
                }
                return hashCode;
            }
        }
