...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChargeOverride_pricing")]
    public partial class ChargeOverridePricing : IEquatable<ChargeOverridePricing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeOverridePricing" /> class.
        /// </summary>
        ...
        public ChargeOverridePricing(ChargeModelDataOverride chargeModelData = default(ChargeModelDataOverride), DiscountPricingOverride discount = default(DiscountPricingOverride), OneTimeFlatFeePricingOverride oneTimeFlatFee = default(OneTimeFlatFeePricingOverride), OneTimePerUnitPricingOverride oneTimePerUnit = default(OneTimePerUnitPricingOverride), OneTimeTieredPricingOverride oneTimeTiered = default(OneTimeTieredPricingOverride), OneTimeVolumePricingOverride oneTimeVolume = default(OneTimeVolumePricingOverride), RecurringFlatFeePricingOverride recurringFlatFee = default(RecurringFlatFeePricingOverride), RecurringPerUnitPricingOverride recurringPerUnit = default(RecurringPerUnitPricingOverride), RecurringTieredPricingOverride recurringTiered = default(RecurringTieredPricingOverride), RecurringVolumePricingOverride recurringVolume = default(RecurringVolumePricingOverride), UsageFlatFeePricingOverride usageFlatFee = default(UsageFlatFeePricingOverride), UsageOveragePricingOverride usageOverage = default(UsageOveragePricingOverride), UsagePerUnitPricingOverride usagePerUnit = default(UsagePerUnitPricingOverride), UsageTieredPricingOverride usageTiered = default(UsageTieredPricingOverride), UsageTieredWithOveragePricingOverride usageTieredWithOverage = default(UsageTieredWithOveragePricingOverride), UsageVolumePricingOverride usageVolume = default(UsageVolumePricingOverride))
        {
        ...
        {
            return this.Equals(input as ChargeOverridePricing);
        }

        /// <summary>
        /// Returns true if ChargeOverridePricing instances are equal
        /// </summary>
        /// <param name="input">Instance of ChargeOverridePricing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargeOverridePricing input)
        {
            if (input == null)
            {
                return false;
