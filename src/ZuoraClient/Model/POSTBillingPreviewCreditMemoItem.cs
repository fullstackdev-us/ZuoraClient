...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTBillingPreviewCreditMemoItem")]
    public partial class POSTBillingPreviewCreditMemoItem : IEquatable<POSTBillingPreviewCreditMemoItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTBillingPreviewCreditMemoItem" /> class.
        /// </summary>
        ...
        /// <param name="chargeDate">The date when the credit memo item is created. .</param>
        /// <param name="chargeNumber">Number of the charge. .</param>
        /// <param name="chargeType">The type of charge.   Possible values are &#x60;OneTime&#x60;, &#x60;Recurring&#x60;, and &#x60;Usage&#x60;. .</param>
        /// <param name="comment">Comment of the credit memo item. .</param>
        /// <param name="id">Credit memo item id. .</param>
        /// <param name="processingType">Identifies the kind of charge.   Possible values: * charge * discount * prepayment * tax .</param>
        /// <param name="quantity">Quantity of this item, in the configured unit of measure for the charge. .</param>
        /// <param name="ratePlanChargeId">Id of the rate plan charge associated with this item. .</param>
        /// <param name="serviceEndDate">End date of the service period for this item, i.e., the last day of the service period, in yyyy-mm-dd format. .</param>
        /// <param name="serviceStartDate">Start date of the service period for this item, in yyyy-mm-dd format. If the charge is a one-time fee, this is the date of that charge. .</param>
        /// <param name="sku">Unique SKU for the product associated with this item. .</param>
        /// <param name="skuName">Name of the unique SKU for the product associated with this item. .</param>
        /// <param name="subscriptionId">ID of the subscription associated with this item. .</param>
        /// <param name="subscriptionNumber">Name of the subscription associated with this item. .</param>
        /// <param name="unitOfMeasure">Unit used to measure consumption. .</param>
        public POSTBillingPreviewCreditMemoItem(double amount = default(double), double amountWithoutTax = default(double), string appliedToItemId = default(string), DateTime chargeDate = default(DateTime), string chargeNumber = default(string), string chargeType = default(string), string comment = default(string), string id = default(string), string processingType = default(string), decimal quantity = default(decimal), string ratePlanChargeId = default(string), DateTime serviceEndDate = default(DateTime), DateTime serviceStartDate = default(DateTime), string sku = default(string), string skuName = default(string), string subscriptionId = default(string), string subscriptionNumber = default(string), string unitOfMeasure = default(string))
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>The date when the credit memo item is created. </value>
        ...
        /// </summary>
        /// <value>Number of the charge. </value>
        ...
        /// </summary>
        /// <value>The type of charge.   Possible values are &#x60;OneTime&#x60;, &#x60;Recurring&#x60;, and &#x60;Usage&#x60;. </value>
        ...
        /// </summary>
        /// <value>Comment of the credit memo item. </value>
        ...
        /// Credit memo item id. 
        /// </summary>
        /// <value>Credit memo item id. </value>
        ...
        /// </summary>
        /// <value>Identifies the kind of charge.   Possible values: * charge * discount * prepayment * tax </value>
        ...
        /// </summary>
        /// <value>Id of the rate plan charge associated with this item. </value>
        ...
        /// </summary>
        /// <value>End date of the service period for this item, i.e., the last day of the service period, in yyyy-mm-dd format. </value>
        ...
        /// </summary>
        /// <value>Start date of the service period for this item, in yyyy-mm-dd format. If the charge is a one-time fee, this is the date of that charge. </value>
        ...
        /// </summary>
        /// <value>Unique SKU for the product associated with this item. </value>
        ...
        /// </summary>
        /// <value>Name of the unique SKU for the product associated with this item. </value>
        ...
        /// </summary>
        /// <value>ID of the subscription associated with this item. </value>
        ...
        /// </summary>
        /// <value>Name of the subscription associated with this item. </value>
        ...
        {
            return this.Equals(input as POSTBillingPreviewCreditMemoItem);
        }

        /// <summary>
        /// Returns true if POSTBillingPreviewCreditMemoItem instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTBillingPreviewCreditMemoItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTBillingPreviewCreditMemoItem input)
        {
            if (input == null)
            {
                return false;
