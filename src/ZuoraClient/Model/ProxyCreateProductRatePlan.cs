...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyCreateProductRatePlan")]
    public partial class ProxyCreateProductRatePlan : IEquatable<ProxyCreateProductRatePlan>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Billing period associated with the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        /// </summary>
        /// <value>Billing period associated with the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        [DataMember(Name = "BillingPeriod__NS", EmitDefaultValue = false)]
        public BillingPeriodNSEnum? BillingPeriodNS { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>Type of item that is created in NetSuite for the product rate plan. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// Initializes a new instance of the <see cref="ProxyCreateProductRatePlan" /> class.
        /// </summary>
        /// <param name="activeCurrencies">A list of 3-letter currency codes representing active currencies for the product rate plan. Use a comma to separate each currency code.  When creating a product rate plan, you can use this field to specify at most four active currencies.  .</param>
        ...
        /// <param name="productId">The ID of the product that contains the product rate plan. **Character limit**: 32 **Values**: a string of 32 characters or fewer  (required).</param>
        /// <param name="billingPeriodNS">Billing period associated with the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        ...
        /// <param name="integrationStatusNS">Status of the product rate plan&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        /// <param name="itemTypeNS">Type of item that is created in NetSuite for the product rate plan. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        ...
        /// <param name="multiCurrencyPriceNS">Multi-currency price associated with the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        /// <param name="priceNS">Price associated with the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        ...
        /// <param name="syncDateNS">Date when the product rate plan was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        public ProxyCreateProductRatePlan(List<string> activeCurrencies = default(List<string>), string description = default(string), DateTime effectiveEndDate = default(DateTime), DateTime effectiveStartDate = default(DateTime), decimal grade = default(decimal), string name = default(string), string productId = default(string), BillingPeriodNSEnum? billingPeriodNS = default(BillingPeriodNSEnum?), string classNS = default(string), string departmentNS = default(string), IncludeChildrenNSEnum? includeChildrenNS = default(IncludeChildrenNSEnum?), string integrationIdNS = default(string), string integrationStatusNS = default(string), ItemTypeNSEnum? itemTypeNS = default(ItemTypeNSEnum?), string locationNS = default(string), string multiCurrencyPriceNS = default(string), string priceNS = default(string), string subsidiaryNS = default(string), string syncDateNS = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ProxyCreateProductRatePlan and cannot be null");
            }
            this.Name = name;
            // to ensure "productId" is required (not null)
            if (productId == null)
            {
                throw new ArgumentNullException("productId is a required property for ProxyCreateProductRatePlan and cannot be null");
            }
        ...
        /// <summary>
        /// A list of 3-letter currency codes representing active currencies for the product rate plan. Use a comma to separate each currency code.  When creating a product rate plan, you can use this field to specify at most four active currencies.  
        /// </summary>
        /// <value>A list of 3-letter currency codes representing active currencies for the product rate plan. Use a comma to separate each currency code.  When creating a product rate plan, you can use this field to specify at most four active currencies.  </value>
        [DataMember(Name = "ActiveCurrencies", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value> The date when the product rate plan expires and can&#39;t be subscribed to, in &#x60;yyyy-mm-dd&#x60; format. **Character limit**: 29 </value>
        ...
        /// </summary>
        /// <value> The date when the product rate plan becomes available and can be subscribed to, in &#x60;yyyy-mm-dd&#x60; format. **Character limit**: 29 </value>
        ...
        /// </summary>
        /// <value>The ID of the product that contains the product rate plan. **Character limit**: 32 **Values**: a string of 32 characters or fewer </value>
        ...
        /// </summary>
        /// <value>Status of the product rate plan&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        /// </summary>
        /// <value>Multi-currency price associated with the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        [DataMember(Name = "MultiCurrencyPrice__NS", EmitDefaultValue = false)]
        public string MultiCurrencyPriceNS { get; set; }
        ...
        /// </summary>
        /// <value>Price associated with the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        [DataMember(Name = "Price__NS", EmitDefaultValue = false)]
        public string PriceNS { get; set; }
        ...
        /// </summary>
        /// <value>Date when the product rate plan was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BillingPeriodNS: ").Append(BillingPeriodNS).Append("\n");
            ...
            sb.Append("  MultiCurrencyPriceNS: ").Append(MultiCurrencyPriceNS).Append("\n");
            sb.Append("  PriceNS: ").Append(PriceNS).Append("\n");
        ...
        {
            return this.Equals(input as ProxyCreateProductRatePlan);
        }

        /// <summary>
        /// Returns true if ProxyCreateProductRatePlan instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreateProductRatePlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateProductRatePlan input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.ActiveCurrencies == input.ActiveCurrencies ||
                    this.ActiveCurrencies != null &&
                    input.ActiveCurrencies != null &&
                    this.ActiveCurrencies.SequenceEqual(input.ActiveCurrencies)
                ) && 
                (
                ...
                (
                    this.BillingPeriodNS == input.BillingPeriodNS ||
                    this.BillingPeriodNS.Equals(input.BillingPeriodNS)
                ) && 
                (
                ...
                (
                    this.MultiCurrencyPriceNS == input.MultiCurrencyPriceNS ||
                    (this.MultiCurrencyPriceNS != null &&
                    this.MultiCurrencyPriceNS.Equals(input.MultiCurrencyPriceNS))
                ) && 
                (
                    this.PriceNS == input.PriceNS ||
                    (this.PriceNS != null &&
                    this.PriceNS.Equals(input.PriceNS))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ActiveCurrencies.GetHashCode();
                }
                ...
                hashCode = (hashCode * 59) + this.BillingPeriodNS.GetHashCode();
                ...
                if (this.MultiCurrencyPriceNS != null)
                {
                    hashCode = (hashCode * 59) + this.MultiCurrencyPriceNS.GetHashCode();
                }
                if (this.PriceNS != null)
                {
                    hashCode = (hashCode * 59) + this.PriceNS.GetHashCode();
                }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            // MultiCurrencyPriceNS (string) maxLength
            if (this.MultiCurrencyPriceNS != null && this.MultiCurrencyPriceNS.Length > 255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MultiCurrencyPriceNS, length must be less than 255.", new [] { "MultiCurrencyPriceNS" });
            }

            // PriceNS (string) maxLength
            if (this.PriceNS != null && this.PriceNS.Length > 255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PriceNS, length must be less than 255.", new [] { "PriceNS" });
            }
