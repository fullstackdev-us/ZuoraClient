...
namespace ZuoraClient.Model
{
    ...
    /// GETDMTaxItemTypeNew
    /// </summary>
    [DataContract(Name = "GETDMTaxItemTypeNew")]
    public partial class GETDMTaxItemTypeNew : IEquatable<GETDMTaxItemTypeNew>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETDMTaxItemTypeNew" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETDMTaxItemTypeNew);
        }

        /// <summary>
        /// Returns true if GETDMTaxItemTypeNew instances are equal
        /// </summary>
        /// <param name="input">Instance of GETDMTaxItemTypeNew to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETDMTaxItemTypeNew input)
        {
            if (input == null)
            {
                return false;
