...
namespace ZuoraClient.Model
{
    ...
    /// ProxyCreateRefund
    /// </summary>
    [DataContract(Name = "ProxyCreateRefund")]
    public partial class ProxyCreateRefund : IEquatable<ProxyCreateRefund>, IValidatableObject
    {
        ...
        /// <param name="paymentMethodId"> The unique ID of the payment method that the customer used to make the payment. This field is only required if you create a non-referenced refund. **Character limit**: 32 **V****alues**: a valid payment method ID .</param>
        ...
        /// <param name="refundDate">The date of the refund, in &#x60;yyyy-mm-dd&#x60; format. The date of the refund cannot be before the payment date. This field is only required if the &#x60;Type&#x60; field is set to &#x60; External&#x60;. Zuora automatically generates this field for electronic refunds.  With the Future Dated Credit Balance Adjustment feature enabled, you can create a non-referenced refund with a refund date.  * For external refunds, you can specify any date. * For electronic refunds, you can only set the date to the date when the API operation is called or one day later. .</param>
        /// <param name="refundInvoicePaymentData">refundInvoicePaymentData.</param>
        ...
        public ProxyCreateRefund(string accountId = default(string), double amount = default(double), string comment = default(string), ProxyCreatePaymentAllOfGatewayOptionData gatewayOptionData = default(ProxyCreatePaymentAllOfGatewayOptionData), string gatewayState = default(string), string methodType = default(string), string paymentId = default(string), string paymentMethodId = default(string), string reasonCode = default(string), DateTime refundDate = default(DateTime), ProxyCreateRefundAllOfRefundInvoicePaymentData refundInvoicePaymentData = default(ProxyCreateRefundAllOfRefundInvoicePaymentData), string softDescriptor = default(string), string softDescriptorPhone = default(string), string sourceType = default(string), string type = default(string), string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string synctoNetSuiteNS = default(string))
        {
            this.Amount = amount;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for ProxyCreateRefund and cannot be null");
            }
            this.Type = type;
        ...
        /// </summary>
        /// <value> The ID of the account associated with this refund. This field is only required if you create a non-referenced refund. Don&#39;t specify a value for any other type of refund; Zuora associates the refund automatically with the account from the associated payment. **Character limit**: 32 **Values**: a valid account ID </value>
        ...
        /// </summary>
        /// <value> Indicates how an external refund was issued to a customer. This field is only required if the &#x60;Type&#x60; field is set to &#x60; External&#x60;. You can issue an external refund on an electronic payment. **Character limit**: 30 **Values**:  - &#x60;ACH&#x60; - &#x60;Cash&#x60; - &#x60;Check&#x60; - &#x60;CreditCard&#x60; - &#x60;Other&#x60; - &#x60;PayPal&#x60; - &#x60;WireTransfer&#x60; - &#x60;DebitCard&#x60; - &#x60;CreditCardReferenceTransaction&#x60; </value>
        ...
        /// </summary>
        /// <value> The unique ID of the payment method that the customer used to make the payment. This field is only required if you create a non-referenced refund. **Character limit**: 32 **V****alues**: a valid payment method ID </value>
        ...
        /// </summary>
        /// <value>The date of the refund, in &#x60;yyyy-mm-dd&#x60; format. The date of the refund cannot be before the payment date. This field is only required if the &#x60;Type&#x60; field is set to &#x60; External&#x60;. Zuora automatically generates this field for electronic refunds.  With the Future Dated Credit Balance Adjustment feature enabled, you can create a non-referenced refund with a refund date.  * For external refunds, you can specify any date. * For electronic refunds, you can only set the date to the date when the API operation is called or one day later. </value>
        [DataMember(Name = "RefundDate", EmitDefaultValue = false)]
        [JsonConverter(typeof(OpenAPIDateConverter))]
        public DateTime RefundDate { get; set; }

        /// <summary>
        /// Gets or Sets RefundInvoicePaymentData
        /// </summary>
        [DataMember(Name = "RefundInvoicePaymentData", EmitDefaultValue = false)]
        public ProxyCreateRefundAllOfRefundInvoicePaymentData RefundInvoicePaymentData { get; set; }
        ...
        /// </summary>
        /// <value> Specifies whether the refund is a refund payment or a credit balance. This field is only required if you create a non-referenced refund. If you creating an non-referenced refund, then set this value to &#x60;CreditBalance&#x60;. **Note**: If you have the Invoice Settlement feature enabled, the value of this field can only be set to &#x60;Payment&#x60;. **Character limit**: 13 **Values**:  - &#x60;Payment&#x60; - &#x60;CreditBalance&#x60; </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RefundInvoicePaymentData: ").Append(RefundInvoicePaymentData).Append("\n");
        ...
        {
            return this.Equals(input as ProxyCreateRefund);
        }

        /// <summary>
        /// Returns true if ProxyCreateRefund instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreateRefund to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateRefund input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RefundInvoicePaymentData == input.RefundInvoicePaymentData ||
                    (this.RefundInvoicePaymentData != null &&
                    this.RefundInvoicePaymentData.Equals(input.RefundInvoicePaymentData))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RefundInvoicePaymentData != null)
                {
                    hashCode = (hashCode * 59) + this.RefundInvoicePaymentData.GetHashCode();
                }
