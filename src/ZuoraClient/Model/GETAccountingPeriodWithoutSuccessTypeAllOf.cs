...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountingPeriodWithoutSuccessType_allOf")]
    public partial class GETAccountingPeriodWithoutSuccessTypeAllOf : IEquatable<GETAccountingPeriodWithoutSuccessTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountingPeriodWithoutSuccessTypeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="fiscalQuarter">fiscalQuarter.</param>
        ...
        public GETAccountingPeriodWithoutSuccessTypeAllOf(string createdBy = default(string), DateTime createdOn = default(DateTime), DateTime endDate = default(DateTime), GETAccountingPeriodTypeAllOfFileIds fileIds = default(GETAccountingPeriodTypeAllOfFileIds), string fiscalYear = default(string), long fiscalQuarter = default(long), string id = default(string), string name = default(string), string notes = default(string), DateTime runTrialBalanceEnd = default(DateTime), string runTrialBalanceErrorMessage = default(string), DateTime runTrialBalanceStart = default(DateTime), string runTrialBalanceStatus = default(string), DateTime startDate = default(DateTime), string status = default(string), string updatedBy = default(string), DateTime updatedOn = default(DateTime))
        {
        ...
        public GETAccountingPeriodTypeAllOfFileIds FileIds { get; set; }
        ...
        {
            return this.Equals(input as GETAccountingPeriodWithoutSuccessTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETAccountingPeriodWithoutSuccessTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountingPeriodWithoutSuccessTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountingPeriodWithoutSuccessTypeAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.FileIds != null &&
                    this.FileIds.Equals(input.FileIds))
                ) && 
                (
                ...
                (
                    this.RunTrialBalanceEnd == input.RunTrialBalanceEnd ||
                    (this.RunTrialBalanceEnd != null &&
                    this.RunTrialBalanceEnd.Equals(input.RunTrialBalanceEnd))
                ) && 
                (
                    this.RunTrialBalanceErrorMessage == input.RunTrialBalanceErrorMessage ||
                    (this.RunTrialBalanceErrorMessage != null &&
                    this.RunTrialBalanceErrorMessage.Equals(input.RunTrialBalanceErrorMessage))
                ) && 
                (
                    this.RunTrialBalanceStart == input.RunTrialBalanceStart ||
                    (this.RunTrialBalanceStart != null &&
                    this.RunTrialBalanceStart.Equals(input.RunTrialBalanceStart))
                ) && 
                (
                    this.RunTrialBalanceStatus == input.RunTrialBalanceStatus ||
                    (this.RunTrialBalanceStatus != null &&
                    this.RunTrialBalanceStatus.Equals(input.RunTrialBalanceStatus))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.RunTrialBalanceEnd.GetHashCode();
                }
                if (this.RunTrialBalanceErrorMessage != null)
                {
                    hashCode = (hashCode * 59) + this.RunTrialBalanceErrorMessage.GetHashCode();
                }
                if (this.RunTrialBalanceStart != null)
                {
                    hashCode = (hashCode * 59) + this.RunTrialBalanceStart.GetHashCode();
                }
                if (this.RunTrialBalanceStatus != null)
                {
                    hashCode = (hashCode * 59) + this.RunTrialBalanceStatus.GetHashCode();
                }
