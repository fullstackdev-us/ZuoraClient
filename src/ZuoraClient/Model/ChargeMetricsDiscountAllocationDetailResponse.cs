...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChargeMetricsDiscountAllocationDetailResponse")]
    public partial class ChargeMetricsDiscountAllocationDetailResponse : IEquatable<ChargeMetricsDiscountAllocationDetailResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeMetricsDiscountAllocationDetailResponse" /> class.
        /// </summary>
        /// <param name="amendmentId">The amendment id that result in the discount allocation detail record. .</param>
        /// <param name="amendmentType">The ID of the corresponding amendment that result in the discount allocation detail record. .</param>
        /// <param name="chargeMetricsId">The ID of the corresponding charge metrics record. .</param>
        /// <param name="chargeNumber">The corresponding charge number of the discount allocation details record. .</param>
        /// <param name="createdOn">The date and time when the discount allocation detail record. .</param>
        /// <param name="currency">The currency of the discount allocation detail record. .</param>
        /// <param name="deleted">Whether the discount allocation detail record is deleted. .</param>
        /// <param name="discountChargeNumber">The number of the corresponding discount charge that leads to the discount allocation detail record. .</param>
        /// <param name="discountMrr">The discount amount for the MRR of the discount allocation detail record.  See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. .</param>
        /// <param name="discountTcv">The discount amount for the TCV of the discount allocation detail record. .</param>
        /// <param name="endDate">The end date of the discount allocation detail record. .</param>
        /// <param name="id">The ID of the discount allocation details record. .</param>
        /// <param name="invoiceOwnerAccountNumber">The account number of the corresponding invoice owner. .</param>
        /// <param name="productId">The corresponding product ID of the discount allocation details record. .</param>
        /// <param name="productRatePlanChargeId">The corresponding product rate plan charge ID of the discount allocation detail record. .</param>
        /// <param name="productRatePlanId">The corresponding product rate plan ID of the discount allocation details record. .</param>
        /// <param name="ratePlanChargeId">The corresponding rate plan charge ID of the discount allocation details record. .</param>
        /// <param name="startDate">The start date of the discount allocation detail record. .</param>
        ...
        /// <param name="updatedOn">The date and time when the discount allocation detail record. .</param>
        public ChargeMetricsDiscountAllocationDetailResponse(string amendmentId = default(string), string amendmentType = default(string), string chargeMetricsId = default(string), string chargeNumber = default(string), DateTime createdOn = default(DateTime), string currency = default(string), bool deleted = default(bool), string discountChargeNumber = default(string), decimal discountMrr = default(decimal), decimal discountTcv = default(decimal), DateTime endDate = default(DateTime), string id = default(string), string invoiceOwnerAccountNumber = default(string), string productId = default(string), string productRatePlanChargeId = default(string), string productRatePlanId = default(string), string ratePlanChargeId = default(string), DateTime startDate = default(DateTime), string subscriptionName = default(string), string subscriptionOwnerAccountNumber = default(string), DateTime updatedOn = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The amendment id that result in the discount allocation detail record. </value>
        ...
        /// </summary>
        /// <value>The ID of the corresponding amendment that result in the discount allocation detail record. </value>
        ...
        /// </summary>
        /// <value>The ID of the corresponding charge metrics record. </value>
        [DataMember(Name = "chargeMetricsId", EmitDefaultValue = false)]
        public string ChargeMetricsId { get; set; }

        /// <summary>
        /// The corresponding charge number of the discount allocation details record. 
        /// </summary>
        /// <value>The corresponding charge number of the discount allocation details record. </value>
        ...
        /// </summary>
        /// <value>The date and time when the discount allocation detail record. </value>
        ...
        /// </summary>
        /// <value>The currency of the discount allocation detail record. </value>
        ...
        /// </summary>
        /// <value>Whether the discount allocation detail record is deleted. </value>
        ...
        /// </summary>
        /// <value>The number of the corresponding discount charge that leads to the discount allocation detail record. </value>
        [DataMember(Name = "discountChargeNumber", EmitDefaultValue = false)]
        public string DiscountChargeNumber { get; set; }

        /// <summary>
        /// The discount amount for the MRR of the discount allocation detail record.  See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. 
        /// </summary>
        /// <value>The discount amount for the MRR of the discount allocation detail record.  See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. </value>
        [DataMember(Name = "discountMrr", EmitDefaultValue = false)]
        public decimal DiscountMrr { get; set; }

        /// <summary>
        /// The discount amount for the TCV of the discount allocation detail record. 
        /// </summary>
        /// <value>The discount amount for the TCV of the discount allocation detail record. </value>
        [DataMember(Name = "discountTcv", EmitDefaultValue = false)]
        public decimal DiscountTcv { get; set; }

        /// <summary>
        /// The end date of the discount allocation detail record. 
        /// </summary>
        /// <value>The end date of the discount allocation detail record. </value>
        ...
        /// </summary>
        /// <value>The ID of the discount allocation details record. </value>
        ...
        /// </summary>
        /// <value>The corresponding product ID of the discount allocation details record. </value>
        ...
        /// </summary>
        /// <value>The corresponding product rate plan charge ID of the discount allocation detail record. </value>
        ...
        /// </summary>
        /// <value>The corresponding product rate plan ID of the discount allocation details record. </value>
        ...
        /// </summary>
        /// <value>The corresponding rate plan charge ID of the discount allocation details record. </value>
        ...
        /// </summary>
        /// <value>The start date of the discount allocation detail record. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChargeMetricsDiscountAllocationDetailResponse {\n");
            sb.Append("  AmendmentId: ").Append(AmendmentId).Append("\n");
            sb.Append("  AmendmentType: ").Append(AmendmentType).Append("\n");
            sb.Append("  ChargeMetricsId: ").Append(ChargeMetricsId).Append("\n");
            sb.Append("  ChargeNumber: ").Append(ChargeNumber).Append("\n");
            sb.Append("  CreatedOn: ").Append(CreatedOn).Append("\n");
            sb.Append("  Currency: ").Append(Currency).Append("\n");
            sb.Append("  Deleted: ").Append(Deleted).Append("\n");
            sb.Append("  DiscountChargeNumber: ").Append(DiscountChargeNumber).Append("\n");
            sb.Append("  DiscountMrr: ").Append(DiscountMrr).Append("\n");
            sb.Append("  DiscountTcv: ").Append(DiscountTcv).Append("\n");
        ...
        {
            return this.Equals(input as ChargeMetricsDiscountAllocationDetailResponse);
        }

        /// <summary>
        /// Returns true if ChargeMetricsDiscountAllocationDetailResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ChargeMetricsDiscountAllocationDetailResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargeMetricsDiscountAllocationDetailResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ChargeMetricsId == input.ChargeMetricsId ||
                    (this.ChargeMetricsId != null &&
                    this.ChargeMetricsId.Equals(input.ChargeMetricsId))
                ) && 
                (
                ...
                (
                    this.DiscountChargeNumber == input.DiscountChargeNumber ||
                    (this.DiscountChargeNumber != null &&
                    this.DiscountChargeNumber.Equals(input.DiscountChargeNumber))
                ) && 
                (
                    this.DiscountMrr == input.DiscountMrr ||
                    this.DiscountMrr.Equals(input.DiscountMrr)
                ) && 
                (
                    this.DiscountTcv == input.DiscountTcv ||
                    this.DiscountTcv.Equals(input.DiscountTcv)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChargeMetricsId != null)
                {
                    hashCode = (hashCode * 59) + this.ChargeMetricsId.GetHashCode();
                }
                ...
                if (this.DiscountChargeNumber != null)
                {
                    hashCode = (hashCode * 59) + this.DiscountChargeNumber.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.DiscountMrr.GetHashCode();
                hashCode = (hashCode * 59) + this.DiscountTcv.GetHashCode();
