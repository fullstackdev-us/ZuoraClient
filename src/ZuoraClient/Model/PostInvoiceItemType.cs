...
namespace ZuoraClient.Model
{
    ...
    /// PostInvoiceItemType
    /// </summary>
    [DataContract(Name = "PostInvoiceItemType")]
    public partial class PostInvoiceItemType : IEquatable<PostInvoiceItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The tax mode of the invoice item, indicating whether the amount of the invoice item includes tax.  **Note**: This field is only available only if you have Taxation enabled. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInvoiceItemType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostInvoiceItemType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInvoiceItemType" /> class.
        /// </summary>
        ...
        /// <param name="amount">The amount of the invoice item.   - For tax-inclusive invoice items, the amount indicates the invoice item amount including tax.  - For tax-exclusive invoice items, the amount indicates the invoice item amount excluding tax.  (required).</param>
        /// <param name="bookingReference">The booking reference of the invoice item. .</param>
        /// <param name="chargeDate">The date when the invoice item is charged, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        /// <param name="chargeName">The name of the charge associated with the invoice item.   This field is required if the &#x60;productRatePlanChargeId&#x60; field is not specified in the request. .</param>
        ...
        /// <param name="discountItems">Container for discount items. The maximum number of discount items is 10. .</param>
        ...
        /// <param name="quantity">The number of units for the invoice item.  (default to &quot;1&quot;).</param>
        ...
        /// <param name="serviceEndDate">The service end date of the invoice item. .</param>
        /// <param name="serviceStartDate">The service start date of the invoice item.  (required).</param>
        /// <param name="sku">The SKU of the invoice item. The SKU of the invoice item must be different from the SKU of any existing product. .</param>
        /// <param name="taxCode">The tax code identifies which tax rules and tax rates to apply to the invoice item.  **Note**: This field is only available only if you have Taxation enabled. .</param>
        /// <param name="taxItems">Container for taxation items. The maximum number of taxation items is 5. .</param>
        /// <param name="taxMode">The tax mode of the invoice item, indicating whether the amount of the invoice item includes tax.  **Note**: This field is only available only if you have Taxation enabled. .</param>
        ...
        public PostInvoiceItemType(string accountingCode = default(string), string adjustmentLiabilityAccountingCode = default(string), string adjustmentRevenueAccountingCode = default(string), decimal amount = default(decimal), string bookingReference = default(string), DateTime chargeDate = default(DateTime), string chargeName = default(string), string contractAssetAccountingCode = default(string), string contractLiabilityAccountingCode = default(string), string contractRecognizedRevenueAccountingCode = default(string), string deferredRevenueAccountingCode = default(string), string description = default(string), List<PostDiscountItemType> discountItems = default(List<PostDiscountItemType>), bool excludeItemBillingFromRevenueAccounting = default(bool), string itemType = default(string), string productRatePlanChargeId = default(string), string purchaseOrderNumber = default(string), decimal quantity = 1, string recognizedRevenueAccountingCode = default(string), string revRecCode = default(string), RevRecTriggerConditionEnum? revRecTriggerCondition = default(RevRecTriggerConditionEnum?), string revenueRecognitionRuleName = default(string), DateTime serviceEndDate = default(DateTime), DateTime serviceStartDate = default(DateTime), string sku = default(string), string taxCode = default(string), List<PostTaxationItemType> taxItems = default(List<PostTaxationItemType>), TaxModeEnum? taxMode = default(TaxModeEnum?), string unbilledReceivablesAccountingCode = default(string), decimal unitPrice = default(decimal), string uom = default(string), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>The amount of the invoice item.   - For tax-inclusive invoice items, the amount indicates the invoice item amount including tax.  - For tax-exclusive invoice items, the amount indicates the invoice item amount excluding tax. </value>
        ...
        /// </summary>
        /// <value>The date when the invoice item is charged, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The name of the charge associated with the invoice item.   This field is required if the &#x60;productRatePlanChargeId&#x60; field is not specified in the request. </value>
        ...
        /// </summary>
        /// <value>Container for discount items. The maximum number of discount items is 10. </value>
        [DataMember(Name = "discountItems", EmitDefaultValue = false)]
        public List<PostDiscountItemType> DiscountItems { get; set; }
        ...
        /// </summary>
        /// <value>The number of units for the invoice item. </value>
        ...
        /// </summary>
        /// <value>The service end date of the invoice item. </value>
        ...
        /// </summary>
        /// <value>The service start date of the invoice item. </value>
        [DataMember(Name = "serviceStartDate", IsRequired = true, EmitDefaultValue = false)]
        [JsonConverter(typeof(OpenAPIDateConverter))]
        ...
        /// </summary>
        /// <value>The SKU of the invoice item. The SKU of the invoice item must be different from the SKU of any existing product. </value>
        ...
        /// </summary>
        /// <value>The tax code identifies which tax rules and tax rates to apply to the invoice item.  **Note**: This field is only available only if you have Taxation enabled. </value>
        ...
        {
            return this.Equals(input as PostInvoiceItemType);
        }

        /// <summary>
        /// Returns true if PostInvoiceItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of PostInvoiceItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostInvoiceItemType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    input.DiscountItems != null &&
                    this.DiscountItems.SequenceEqual(input.DiscountItems)
                ) && 
                (
