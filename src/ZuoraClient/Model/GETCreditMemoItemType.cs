...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETCreditMemoItemType")]
    public partial class GETCreditMemoItemType : IEquatable<GETCreditMemoItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETCreditMemoItemType" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETCreditMemoItemType);
        }

        /// <summary>
        /// Returns true if GETCreditMemoItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETCreditMemoItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETCreditMemoItemType input)
        {
            if (input == null)
            {
                return false;
