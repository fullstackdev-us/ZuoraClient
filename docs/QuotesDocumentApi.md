# ZuoraClient.Api.QuotesDocumentApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**POSTQuotesDocument**](QuotesDocumentApi.md#postquotesdocument) | **POST** /v1/quotes/document | Generate a quote document |

<a name="postquotesdocument"></a>
# **POSTQuotesDocument**
> POSTQuoteDocResponseType POSTQuotesDocument (POSTQuoteDocType request, string authorization = null, string zuoraTrackId = null, string zuoraEntityIds = null)
...
namespace Example
{
    public class POSTQuotesDocumentExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            config.BasePath = "https://rest.zuora.com";
            var apiInstance = new QuotesDocumentApi(config);
            var request = new POSTQuoteDocType(); // POSTQuoteDocType | 
            ...
            {
                // Generate a quote document
                POSTQuoteDocResponseType result = apiInstance.POSTQuotesDocument(request, authorization, zuoraTrackId, zuoraEntityIds);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling QuotesDocumentApi.POSTQuotesDocument: " + e.Message);
...
#### Using the POSTQuotesDocumentWithHttpInfo variant
...
{
    // Generate a quote document
    ApiResponse<POSTQuoteDocResponseType> response = apiInstance.POSTQuotesDocumentWithHttpInfo(request, authorization, zuoraTrackId, zuoraEntityIds);
...
{
    Debug.Print("Exception when calling QuotesDocumentApi.POSTQuotesDocumentWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
