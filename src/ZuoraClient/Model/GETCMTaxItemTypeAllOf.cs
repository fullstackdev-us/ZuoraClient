...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETCMTaxItemType_allOf")]
    public partial class GETCMTaxItemTypeAllOf : IEquatable<GETCMTaxItemTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETCMTaxItemTypeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="taxDate">The date that the tax is applied to the credit memo, in &#x60;yyyy-mm-dd&#x60; format. .</param>
        /// <param name="taxRate">The tax rate applied to the credit memo. .</param>
        ...
        public GETCMTaxItemTypeAllOf(double appliedAmount = default(double), double exemptAmount = default(double), GETCMTaxItemTypeAllOfFinanceInformation financeInformation = default(GETCMTaxItemTypeAllOfFinanceInformation), string id = default(string), string jurisdiction = default(string), string locationCode = default(string), string name = default(string), double refundAmount = default(double), string sourceTaxItemId = default(string), double taxAmount = default(double), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), double taxRate = default(double), string taxRateDescription = default(string), TaxRateTypeEnum? taxRateType = default(TaxRateTypeEnum?), double unappliedAmount = default(double))
        {
        ...
        /// </summary>
        /// <value>The date that the tax is applied to the credit memo, in &#x60;yyyy-mm-dd&#x60; format. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETCMTaxItemTypeAllOf {\n");
        ...
        {
            return this.Equals(input as GETCMTaxItemTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETCMTaxItemTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETCMTaxItemTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETCMTaxItemTypeAllOf input)
        {
            if (input == null)
            {
                return false;
