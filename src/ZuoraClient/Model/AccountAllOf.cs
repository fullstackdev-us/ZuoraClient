...
namespace ZuoraClient.Model
{
    ...
    public partial class AccountAllOf : IEquatable<AccountAllOf>, IValidatableObject
    {
        ...
        /// <param name="sequenceSetId">The ID of the billing document sequence set to assign to the customer account.   The billing documents to generate for this account will adopt the prefix and starting document number configured in the sequence set. .</param>
        ...
        /// <summary>
        /// Gets or Sets CommunicationProfileId
        /// </summary>
        ...
        /// </summary>
        /// <value>The ID of the billing document sequence set to assign to the customer account.   The billing documents to generate for this account will adopt the prefix and starting document number configured in the sequence set. </value>
