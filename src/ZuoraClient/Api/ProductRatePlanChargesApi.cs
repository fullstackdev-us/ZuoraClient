...
namespace ZuoraClient.Api
{
    ...
    /// </summary>
    public interface IProductRatePlanChargesApiSync : IApiAccessor
    {
        ...
        /// <param name="id">The unique ID of the product rate plan charge to be deleted. For example, 2c93808457d787030157e031fcd34e19. </param>
        ...
        ProxyDeleteResponse ObjectDELETEProductRatePlanCharge(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        ApiResponse<ProxyDeleteResponse> ObjectDELETEProductRatePlanChargeWithHttpInfo(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        /// <summary>
        /// CRUD: Retrieve a product rate plan charge
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The unique ID of a product rate plan charge to be retrieved. For example, 2c93808457d787030157e031fcd34e19. </param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        ...
        ProxyGetProductRatePlanCharge ObjectGETProductRatePlanCharge(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0);
        ...
        ApiResponse<ProxyGetProductRatePlanCharge> ObjectGETProductRatePlanChargeWithHttpInfo(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0);
        /// <summary>
        ...
        ApiResponse<ProxyCreateOrModifyResponse> ObjectPOSTProductRatePlanChargeWithHttpInfo(ProxyCreateProductRatePlanCharge createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The unique ID of the product rate plan charge to be updated. For example, 2c93808457d787030157e031fcd34e19. </param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProxyCreateOrModifyResponse</returns>
        ApiResponse<ProxyCreateOrModifyResponse> ObjectPUTProductRatePlanChargeWithHttpInfo(string id, ProxyModifyProductRatePlanCharge modifyRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IProductRatePlanChargesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<ProxyDeleteResponse>> ObjectDELETEProductRatePlanChargeWithHttpInfoAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// CRUD: Retrieve a product rate plan charge
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<ProxyGetProductRatePlanCharge>> ObjectGETProductRatePlanChargeWithHttpInfoAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// CRUD: Create a product rate plan charge
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<ProxyCreateOrModifyResponse>> ObjectPOSTProductRatePlanChargeWithHttpInfoAsync(ProxyCreateProductRatePlanCharge createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// CRUD: Update a product rate plan charge
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProxyCreateOrModifyResponse</returns>
        System.Threading.Tasks.Task<ProxyCreateOrModifyResponse> ObjectPUTProductRatePlanChargeAsync(string id, ProxyModifyProductRatePlanCharge modifyRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProxyCreateOrModifyResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ProxyCreateOrModifyResponse>> ObjectPUTProductRatePlanChargeWithHttpInfoAsync(string id, ProxyModifyProductRatePlanCharge modifyRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IProductRatePlanChargesApi : IProductRatePlanChargesApiSync, IProductRatePlanChargesApiAsync
    {
    ...
    public partial class ProductRatePlanChargesApi : IProductRatePlanChargesApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ProductRatePlanChargesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public ProductRatePlanChargesApi(ZuoraClient.Client.Configuration configuration)
        {
        ...
        public ProductRatePlanChargesApi(ZuoraClient.Client.ISynchronousClient client, ZuoraClient.Client.IAsynchronousClient asyncClient, ZuoraClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// CRUD: Delete a product rate plan charge Deletes a product rate plan charge. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The unique ID of the product rate plan charge to be deleted. For example, 2c93808457d787030157e031fcd34e19. </param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProxyDeleteResponse</returns>
        public ProxyDeleteResponse ObjectDELETEProductRatePlanCharge(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<ProxyDeleteResponse> localVarResponse = ObjectDELETEProductRatePlanChargeWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProxyDeleteResponse</returns>
        public ZuoraClient.Client.ApiResponse<ProxyDeleteResponse> ObjectDELETEProductRatePlanChargeWithHttpInfo(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProductRatePlanChargesApi->ObjectDELETEProductRatePlanCharge");
            }
            ...
            localVarRequestOptions.Operation = "ProductRatePlanChargesApi.ObjectDELETEProductRatePlanCharge";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Delete<ProxyDeleteResponse>("/v1/object/product-rate-plan-charge/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ObjectDELETEProductRatePlanCharge", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProxyDeleteResponse</returns>
        public async System.Threading.Tasks.Task<ProxyDeleteResponse> ObjectDELETEProductRatePlanChargeAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<ProxyDeleteResponse> localVarResponse = await ObjectDELETEProductRatePlanChargeWithHttpInfoAsync(id, authorization, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProxyDeleteResponse)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<ProxyDeleteResponse>> ObjectDELETEProductRatePlanChargeWithHttpInfoAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<ProxyDeleteResponse>("/v1/object/product-rate-plan-charge/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProxyGetProductRatePlanCharge</returns>
        public ProxyGetProductRatePlanCharge ObjectGETProductRatePlanCharge(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<ProxyGetProductRatePlanCharge> localVarResponse = ObjectGETProductRatePlanChargeWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProxyGetProductRatePlanCharge</returns>
        public ZuoraClient.Client.ApiResponse<ProxyGetProductRatePlanCharge> ObjectGETProductRatePlanChargeWithHttpInfo(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProductRatePlanChargesApi->ObjectGETProductRatePlanCharge");
            }
            ...
            localVarRequestOptions.Operation = "ProductRatePlanChargesApi.ObjectGETProductRatePlanCharge";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<ProxyGetProductRatePlanCharge>("/v1/object/product-rate-plan-charge/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ObjectGETProductRatePlanCharge", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProxyGetProductRatePlanCharge</returns>
        public async System.Threading.Tasks.Task<ProxyGetProductRatePlanCharge> ObjectGETProductRatePlanChargeAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<ProxyGetProductRatePlanCharge> localVarResponse = await ObjectGETProductRatePlanChargeWithHttpInfoAsync(id, authorization, zuoraEntityIds, zuoraTrackId, fields, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProxyGetProductRatePlanCharge)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<ProxyGetProductRatePlanCharge>> ObjectGETProductRatePlanChargeWithHttpInfoAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ProxyGetProductRatePlanCharge>("/v1/object/product-rate-plan-charge/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// CRUD: Create a product rate plan charge Creates a product rate plan charge for a specified rate plan charge.   Product rate plan charges can be of three types, one-time fees, recurring fees, and usage fees.  
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="createRequest"></param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProxyCreateOrModifyResponse</returns>
        public ProxyCreateOrModifyResponse ObjectPOSTProductRatePlanCharge(ProxyCreateProductRatePlanCharge createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse> localVarResponse = ObjectPOSTProductRatePlanChargeWithHttpInfo(createRequest, authorization, rejectUnknownFields, zuoraEntityIds, zuoraTrackId, xZuoraWSDLVersion);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProxyCreateOrModifyResponse</returns>
        public ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse> ObjectPOSTProductRatePlanChargeWithHttpInfo(ProxyCreateProductRatePlanCharge createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'createRequest' is set
            if (createRequest == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'createRequest' when calling ProductRatePlanChargesApi->ObjectPOSTProductRatePlanCharge");
            }
            ...
            localVarRequestOptions.Operation = "ProductRatePlanChargesApi.ObjectPOSTProductRatePlanCharge";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<ProxyCreateOrModifyResponse>("/v1/object/product-rate-plan-charge", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ObjectPOSTProductRatePlanCharge", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProxyCreateOrModifyResponse</returns>
        public async System.Threading.Tasks.Task<ProxyCreateOrModifyResponse> ObjectPOSTProductRatePlanChargeAsync(ProxyCreateProductRatePlanCharge createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse> localVarResponse = await ObjectPOSTProductRatePlanChargeWithHttpInfoAsync(createRequest, authorization, rejectUnknownFields, zuoraEntityIds, zuoraTrackId, xZuoraWSDLVersion, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProxyCreateOrModifyResponse)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse>> ObjectPOSTProductRatePlanChargeWithHttpInfoAsync(ProxyCreateProductRatePlanCharge createRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'createRequest' is set
            if (createRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ProxyCreateOrModifyResponse>("/v1/object/product-rate-plan-charge", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// CRUD: Update a product rate plan charge Updates the information about a product rate plan charge. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The unique ID of the product rate plan charge to be updated. For example, 2c93808457d787030157e031fcd34e19. </param>
        /// <param name="modifyRequest"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProxyCreateOrModifyResponse</returns>
        public ProxyCreateOrModifyResponse ObjectPUTProductRatePlanCharge(string id, ProxyModifyProductRatePlanCharge modifyRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse> localVarResponse = ObjectPUTProductRatePlanChargeWithHttpInfo(id, modifyRequest, authorization, rejectUnknownFields, zuoraEntityIds, zuoraTrackId, xZuoraWSDLVersion);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProxyCreateOrModifyResponse</returns>
        public ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse> ObjectPUTProductRatePlanChargeWithHttpInfo(string id, ProxyModifyProductRatePlanCharge modifyRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProductRatePlanChargesApi->ObjectPUTProductRatePlanCharge");
            }

            // verify the required parameter 'modifyRequest' is set
            if (modifyRequest == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'modifyRequest' when calling ProductRatePlanChargesApi->ObjectPUTProductRatePlanCharge");
            }
            ...
            localVarRequestOptions.Operation = "ProductRatePlanChargesApi.ObjectPUTProductRatePlanCharge";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Put<ProxyCreateOrModifyResponse>("/v1/object/product-rate-plan-charge/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ObjectPUTProductRatePlanCharge", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProxyCreateOrModifyResponse</returns>
        public async System.Threading.Tasks.Task<ProxyCreateOrModifyResponse> ObjectPUTProductRatePlanChargeAsync(string id, ProxyModifyProductRatePlanCharge modifyRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse> localVarResponse = await ObjectPUTProductRatePlanChargeWithHttpInfoAsync(id, modifyRequest, authorization, rejectUnknownFields, zuoraEntityIds, zuoraTrackId, xZuoraWSDLVersion, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProxyCreateOrModifyResponse)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<ProxyCreateOrModifyResponse>> ObjectPUTProductRatePlanChargeWithHttpInfoAsync(string id, ProxyModifyProductRatePlanCharge modifyRequest, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string xZuoraWSDLVersion = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<ProxyCreateOrModifyResponse>("/v1/object/product-rate-plan-charge/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
