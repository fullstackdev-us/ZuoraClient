...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTScCreateType_allOf")]
    public partial class POSTScCreateTypeAllOf : IEquatable<POSTScCreateTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTScCreateTypeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTScCreateTypeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTScCreateTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as POSTScCreateTypeAllOf);
        }

        /// <summary>
        /// Returns true if POSTScCreateTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTScCreateTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTScCreateTypeAllOf input)
        {
            if (input == null)
            {
                return false;
