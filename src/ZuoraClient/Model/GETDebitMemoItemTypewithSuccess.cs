...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETDebitMemoItemTypewithSuccess")]
    public partial class GETDebitMemoItemTypewithSuccess : IEquatable<GETDebitMemoItemTypewithSuccess>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETDebitMemoItemTypewithSuccess" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETDebitMemoItemTypewithSuccess);
        }

        /// <summary>
        /// Returns true if GETDebitMemoItemTypewithSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of GETDebitMemoItemTypewithSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETDebitMemoItemTypewithSuccess input)
        {
            if (input == null)
            {
                return false;
