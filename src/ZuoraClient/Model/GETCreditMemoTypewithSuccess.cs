...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETCreditMemoTypewithSuccess")]
    public partial class GETCreditMemoTypewithSuccess : IEquatable<GETCreditMemoTypewithSuccess>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETCreditMemoTypewithSuccess" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETCreditMemoTypewithSuccess);
        }

        /// <summary>
        /// Returns true if GETCreditMemoTypewithSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of GETCreditMemoTypewithSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETCreditMemoTypewithSuccess input)
        {
            if (input == null)
            {
                return false;
