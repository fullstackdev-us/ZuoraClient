...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETDMTaxItemType_allOf")]
    public partial class GETDMTaxItemTypeAllOf : IEquatable<GETDMTaxItemTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// The type of the tax rate. 
        /// </summary>
        /// <value>The type of the tax rate. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETDMTaxItemTypeAllOf" /> class.
        /// </summary>
        /// <param name="appliedAmount">The applied amount of the taxation item. .</param>
        /// <param name="creditAmount">The amount of credit memos applied to the debit memo.  .</param>
        ...
        /// <param name="paymentAmount">The amount of payments applied to the debit memo.  .</param>
        /// <param name="refundAmount">The amount of the refund on the taxation item. .</param>
        /// <param name="sourceTaxItemId">The ID of the source taxation item. .</param>
        ...
        /// <param name="taxDate">The date that the tax is applied to the debit memo, in &#x60;yyyy-mm-dd&#x60; format. .</param>
        /// <param name="taxRate">The tax rate applied to the debit memo. .</param>
        /// <param name="taxRateDescription">The description of the tax rate. .</param>
        /// <param name="taxRateType">The type of the tax rate. .</param>
        /// <param name="unappliedAmount">The unapplied amount of the taxation item. .</param>
        public GETDMTaxItemTypeAllOf(double appliedAmount = default(double), double creditAmount = default(double), double exemptAmount = default(double), GETDMTaxItemTypeAllOfFinanceInformation financeInformation = default(GETDMTaxItemTypeAllOfFinanceInformation), string id = default(string), string jurisdiction = default(string), string locationCode = default(string), string name = default(string), double paymentAmount = default(double), double refundAmount = default(double), string sourceTaxItemId = default(string), double taxAmount = default(double), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), double taxRate = default(double), string taxRateDescription = default(string), TaxRateTypeEnum? taxRateType = default(TaxRateTypeEnum?), double unappliedAmount = default(double))
        {
        ...
        /// </summary>
        /// <value>The applied amount of the taxation item. </value>
        ...
        /// </summary>
        /// <value>The amount of credit memos applied to the debit memo.  </value>
        ...
        public GETDMTaxItemTypeAllOfFinanceInformation FinanceInformation { get; set; }
        ...
        /// </summary>
        /// <value>The amount of payments applied to the debit memo.  </value>
        ...
        /// </summary>
        /// <value>The amount of the refund on the taxation item. </value>
        ...
        /// </summary>
        /// <value>The ID of the source taxation item. </value>
        ...
        /// </summary>
        /// <value>The date that the tax is applied to the debit memo, in &#x60;yyyy-mm-dd&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The unapplied amount of the taxation item. </value>
        ...
        {
            return this.Equals(input as GETDMTaxItemTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETDMTaxItemTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETDMTaxItemTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETDMTaxItemTypeAllOf input)
        {
            if (input == null)
            {
                return false;
