...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyCreateInvoiceItemAdjustment")]
    public partial class ProxyCreateInvoiceItemAdjustment : IEquatable<ProxyCreateInvoiceItemAdjustment>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateInvoiceItemAdjustment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateInvoiceItemAdjustment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateInvoiceItemAdjustment" /> class.
        /// </summary>
        ...
        /// <param name="adjustmentDate"> The date when the invoice item adjustment is applied, in &#x60;yyyy-mm-dd&#x60; format. This date must be the same as the invoice&#39;s date or later. **Character limit**: 29  (required).</param>
        ...
        /// <param name="amount"> The amount of the invoice item adjustment. The value of Amount must be positive. Use the required parameter Type to either credit or charge (debit) this amount on the invoice. **Character limit**: 16 **Values**: a valid currency amount  (required).</param>
        ...
        /// <param name="invoiceId"> The ID of the invoice associated with the adjustment. The adjustment invoice item is in this invoice. This field is optional if you specify a value for the &#x60;InvoiceNumber&#x60; field. **Character limit**: 3 **Values**: a valid invoice ID  (required).</param>
        /// <param name="invoiceNumber"> The unique identification number for the invoice that contains the invoice item. This field is optional if you specify a value for the &#x60;InvoiceId&#x60; field. **Character limit**: 32 **Values**: a valid invoice number  (required).</param>
        ...
        /// <param name="sourceId"> The ID of the item specified in the SourceType field. **Character limit**: 32 **Values**: a valid invoice item ID or taxation item ID  (required).</param>
        /// <param name="sourceType"> The type of adjustment. **Character limit**: 13 **Values**: InvoiceDetail, Tax  (required).</param>
        /// <param name="type">Indicates whether the adjustment credits or debits the invoice item amount. (required).</param>
        ...
        public ProxyCreateInvoiceItemAdjustment(string accountingCode = default(string), DateTime adjustmentDate = default(DateTime), string adjustmentNumber = default(string), double amount = default(double), string comment = default(string), string createdById = default(string), string deferredRevenueAccount = default(string), bool excludeItemBillingFromRevenueAccounting = false, string invoiceId = default(string), string invoiceNumber = default(string), string reasonCode = default(string), string recognizedRevenueAccount = default(string), string referenceId = default(string), string sourceId = default(string), string sourceType = default(string), TypeEnum type = default(TypeEnum), string invoiceItemAdjustmentIntegrationIdNS = default(string), string invoiceItemAdjustmentIntegrationStatusNS = default(string), string invoiceItemAdjustmentSyncDateNS = default(string))
        {
            ...
            if (invoiceId == null)
            {
                throw new ArgumentNullException("invoiceId is a required property for ProxyCreateInvoiceItemAdjustment and cannot be null");
            }
            this.InvoiceId = invoiceId;
            // to ensure "invoiceNumber" is required (not null)
            if (invoiceNumber == null)
            {
                throw new ArgumentNullException("invoiceNumber is a required property for ProxyCreateInvoiceItemAdjustment and cannot be null");
            }
            this.InvoiceNumber = invoiceNumber;
            // to ensure "sourceId" is required (not null)
            if (sourceId == null)
            {
                throw new ArgumentNullException("sourceId is a required property for ProxyCreateInvoiceItemAdjustment and cannot be null");
            }
            this.SourceId = sourceId;
            // to ensure "sourceType" is required (not null)
            if (sourceType == null)
            {
                throw new ArgumentNullException("sourceType is a required property for ProxyCreateInvoiceItemAdjustment and cannot be null");
            }
        ...
        [DataMember(Name = "AdjustmentDate", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "InvoiceId", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyCreateInvoiceItemAdjustment {\n");
        ...
        {
            return this.Equals(input as ProxyCreateInvoiceItemAdjustment);
        }

        /// <summary>
        /// Returns true if ProxyCreateInvoiceItemAdjustment instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreateInvoiceItemAdjustment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateInvoiceItemAdjustment input)
        {
            if (input == null)
            {
                return false;
