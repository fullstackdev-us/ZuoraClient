# ZuoraClient.Api.RefundInvoicePaymentsApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**ObjectGETRefundInvoicePayment**](RefundInvoicePaymentsApi.md#objectgetrefundinvoicepayment) | **GET** /v1/object/refund-invoice-payment/{id} | CRUD: Retrieve a refund invoice payment |

<a name="objectgetrefundinvoicepayment"></a>
# **ObjectGETRefundInvoicePayment**
> ProxyGetRefundInvoicePayment ObjectGETRefundInvoicePayment (string id, string authorization = null, string zuoraEntityIds = null, string zuoraTrackId = null, string fields = null)
...
namespace Example
{
    public class ObjectGETRefundInvoicePaymentExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            config.BasePath = "https://rest.zuora.com";
            var apiInstance = new RefundInvoicePaymentsApi(config);
            ...
            {
                // CRUD: Retrieve a refund invoice payment
                ProxyGetRefundInvoicePayment result = apiInstance.ObjectGETRefundInvoicePayment(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling RefundInvoicePaymentsApi.ObjectGETRefundInvoicePayment: " + e.Message);
...
#### Using the ObjectGETRefundInvoicePaymentWithHttpInfo variant
...
{
    // CRUD: Retrieve a refund invoice payment
    ApiResponse<ProxyGetRefundInvoicePayment> response = apiInstance.ObjectGETRefundInvoicePaymentWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
...
{
    Debug.Print("Exception when calling RefundInvoicePaymentsApi.ObjectGETRefundInvoicePaymentWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
