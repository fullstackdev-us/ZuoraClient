...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscribeRequestSoldToContact")]
    public partial class SubscribeRequestSoldToContact : IEquatable<SubscribeRequestSoldToContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeRequestSoldToContact" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubscribeRequestSoldToContact {\n");
        ...
        {
            return this.Equals(input as SubscribeRequestSoldToContact);
        }

        /// <summary>
        /// Returns true if SubscribeRequestSoldToContact instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribeRequestSoldToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribeRequestSoldToContact input)
        {
            if (input == null)
            {
                return false;
