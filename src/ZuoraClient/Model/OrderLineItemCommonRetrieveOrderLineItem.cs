...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderLineItemCommonRetrieveOrderLineItem")]
    public partial class OrderLineItemCommonRetrieveOrderLineItem : IEquatable<OrderLineItemCommonRetrieveOrderLineItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderLineItemCommonRetrieveOrderLineItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OrderLineItemCommonRetrieveOrderLineItem);
        }

        /// <summary>
        /// Returns true if OrderLineItemCommonRetrieveOrderLineItem instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderLineItemCommonRetrieveOrderLineItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderLineItemCommonRetrieveOrderLineItem input)
        {
            if (input == null)
            {
                return false;
