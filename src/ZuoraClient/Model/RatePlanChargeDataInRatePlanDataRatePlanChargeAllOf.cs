...
{
    /// <summary>
    /// RatePlanChargeDataInRatePlanDataRatePlanChargeAllOf
    /// </summary>
    [DataContract(Name = "RatePlanChargeDataInRatePlanData_RatePlanCharge_allOf")]
    public partial class RatePlanChargeDataInRatePlanDataRatePlanChargeAllOf : IEquatable<RatePlanChargeDataInRatePlanDataRatePlanChargeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RatePlanChargeDataInRatePlanDataRatePlanChargeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RatePlanChargeDataInRatePlanDataRatePlanChargeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RatePlanChargeDataInRatePlanDataRatePlanChargeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="listPriceBase">The list price base for the product rate plan charge.  You can only change the value of this field if the amendment type is NewProduct.  **Values**: one of the following:  - &#x60;Per Month&#x60; - &#x60;Per Billing Period&#x60; - &#x60;Per Week&#x60; .</param>
        ...
        /// </summary>
        /// <value>The list price base for the product rate plan charge.  You can only change the value of this field if the amendment type is NewProduct.  **Values**: one of the following:  - &#x60;Per Month&#x60; - &#x60;Per Billing Period&#x60; - &#x60;Per Week&#x60; </value>
        ...
        /// <summary>
        ///  The default quantity of units, such as the number of authors in a hosted wiki service. Valid for all charge models except for Flat Fee pricing. This field is only rquired if the charge model is per unit, tiered pricing, or volume pricing.    **Character limit**: 16   **Values**: a valid quantity value 
        /// </summary>
        /// <value> The default quantity of units, such as the number of authors in a hosted wiki service. Valid for all charge models except for Flat Fee pricing. This field is only rquired if the charge model is per unit, tiered pricing, or volume pricing.    **Character limit**: 16   **Values**: a valid quantity value </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RatePlanChargeDataInRatePlanDataRatePlanChargeAllOf {\n");
        ...
        {
            return this.Equals(input as RatePlanChargeDataInRatePlanDataRatePlanChargeAllOf);
        }

        /// <summary>
        /// Returns true if RatePlanChargeDataInRatePlanDataRatePlanChargeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of RatePlanChargeDataInRatePlanDataRatePlanChargeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RatePlanChargeDataInRatePlanDataRatePlanChargeAllOf input)
        {
            if (input == null)
            {
                return false;
