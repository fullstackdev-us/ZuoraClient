...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETDebitMemoItemType")]
    public partial class GETDebitMemoItemType : IEquatable<GETDebitMemoItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETDebitMemoItemType" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETDebitMemoItemType);
        }

        /// <summary>
        /// Returns true if GETDebitMemoItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETDebitMemoItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETDebitMemoItemType input)
        {
            if (input == null)
            {
                return false;
