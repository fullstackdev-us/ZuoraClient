...
namespace ZuoraClient.Model
{
    ...
    /// ProxyCreateContact
    /// </summary>
    [DataContract(Name = "ProxyCreateContact")]
    public partial class ProxyCreateContact : IEquatable<ProxyCreateContact>, IValidatableObject
    {
        ...
        public ProxyCreateContact(string accountId = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string description = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickName = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string postalCode = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string))
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for ProxyCreateContact and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for ProxyCreateContact and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for ProxyCreateContact and cannot be null");
            }
        ...
        {
            return this.Equals(input as ProxyCreateContact);
        }

        /// <summary>
        /// Returns true if ProxyCreateContact instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreateContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateContact input)
        {
            if (input == null)
            {
                return false;
