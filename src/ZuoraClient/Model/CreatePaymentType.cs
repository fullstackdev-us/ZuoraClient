...
namespace ZuoraClient.Model
{
    ...
    /// CreatePaymentType
    /// </summary>
    [DataContract(Name = "CreatePaymentType")]
    public partial class CreatePaymentType : IEquatable<CreatePaymentType>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Payment transaction source used to differentiate the transaction source in Stored Credential Transaction framework.   - &#x60;C_Unscheduled&#x60;: Cardholder-initiated transaction (CIT) that does not occur on scheduled or regularly occurring dates.   - &#x60;M_Recurring&#x60;: Merchant-initiated transaction (MIT) that occurs at regular intervals.   - &#x60;M_Unscheduled&#x60;: Merchant-initiated transaction (MIT) that does not occur on scheduled or regularly occurring dates. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum MitTransactionSourceEnum
        {
            /// <summary>
            /// Enum CUnscheduled for value: C_Unscheduled
            /// </summary>
            [EnumMember(Value = "C_Unscheduled")]
            CUnscheduled = 1,

            /// <summary>
            /// Enum MRecurring for value: M_Recurring
            /// </summary>
            [EnumMember(Value = "M_Recurring")]
            MRecurring = 2,

            /// <summary>
            /// Enum MUnscheduled for value: M_Unscheduled
            /// </summary>
            [EnumMember(Value = "M_Unscheduled")]
            MUnscheduled = 3
        ...
        /// </summary>
        /// <value>Payment transaction source used to differentiate the transaction source in Stored Credential Transaction framework.   - &#x60;C_Unscheduled&#x60;: Cardholder-initiated transaction (CIT) that does not occur on scheduled or regularly occurring dates.   - &#x60;M_Recurring&#x60;: Merchant-initiated transaction (MIT) that occurs at regular intervals.   - &#x60;M_Unscheduled&#x60;: Merchant-initiated transaction (MIT) that does not occur on scheduled or regularly occurring dates. </value>
        [DataMember(Name = "mitTransactionSource", EmitDefaultValue = false)]
        public MitTransactionSourceEnum? MitTransactionSource { get; set; }
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePaymentType" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="CreatePaymentType" /> class.
        /// </summary>
        /// <param name="accountId">The ID of the customer account that the payment is created for. .</param>
        /// <param name="accountNumber">The number of the customer account that the payment is created for, such as &#x60;A00000001&#x60;.  You can specify either &#x60;accountNumber&#x60; or &#x60;accountId&#x60; for a customer account. If both of them are specified, they must refer to the same customer account. .</param>
        /// <param name="amount">The total amount of the payment.  (required).</param>
        /// <param name="authTransactionId">The authorization transaction ID from the payment gateway. Use this field for electronic payments, such as credit cards.  When you create a payment for capturing the authorized funds, it is highly recommended to pass in the gatewayOrderId that you used when authorizing the funds by using the [Create authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CreateAuthorization) operation, together with the &#x60;authTransactionId&#x60; field.  The following payment gateways support this field:   - Adyen Integration v2.0   - CyberSource 1.28   - CyberSource 1.97   - CyberSource 2.0   - Chase Paymentech Orbital   - Ingenico ePayments   - SlimPay   - Verifi Global Payment Gateway   - WePay Payment Gateway Integration .</param>
        /// <param name="comment">Additional information related to the payment. .</param>
        /// <param name="currency">When Standalone Payment is not enabled, the &#x60;currency&#x60; of the payment must be the same as the payment currency defined in the customer account settings through Zuora UI.  When Standalone Payment is enabled and &#x60;standalone&#x60; is &#x60;true&#x60;, the &#x60;currency&#x60; of the standalone payment can be different from the payment currency defined in the customer account settings. The amount will not be summed up to the account balance or key metrics regardless of currency.  (required).</param>
        /// <param name="debitMemos">Container for debit memos. The maximum number of debit memos is 1,000. .</param>
        /// <param name="effectiveDate">The date when the payment takes effect, in &#x60;yyyy-mm-dd&#x60; format.  **Note:** This is an optional field that only applies to electronic payments. When specified, it must be set to the date of today. .</param>
        /// <param name="financeInformation">financeInformation.</param>
        /// <param name="gatewayId">The ID of the gateway instance that processes the payment. The ID must be a valid gateway instance ID and this gateway must support the specific payment method.   - When creating electronic payments, this field is required.  - When creating external payments, this field is optional. .</param>
        /// <param name="gatewayOptions">gatewayOptions.</param>
        /// <param name="gatewayOrderId">A merchant-specified natural key value that can be passed to the electronic payment gateway when a payment is created. If not specified, the payment number will be passed in instead.  Gateways check duplicates on the gateway order ID to ensure that the merchant do not accidentally enter the same transaction twice. This ID can also be used to do reconciliation and tie the payment to a natural key in external systems. The source of this ID varies by merchant. Some merchants use their shopping cart order IDs, and others use something different. Merchants use this ID to track transactions in their eCommerce systems.  When you create a payment for capturing the authorized funds, it is highly recommended to pass in the gatewayOrderId that you used when authorizing the funds by using the [Create authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CreateAuthorization) operation, together with the &#x60;authTransactionId&#x60; field. .</param>
        /// <param name="invoices">Container for invoices. The maximum number of invoices is 1,000. .</param>
        /// <param name="mitTransactionSource">Payment transaction source used to differentiate the transaction source in Stored Credential Transaction framework.   - &#x60;C_Unscheduled&#x60;: Cardholder-initiated transaction (CIT) that does not occur on scheduled or regularly occurring dates.   - &#x60;M_Recurring&#x60;: Merchant-initiated transaction (MIT) that occurs at regular intervals.   - &#x60;M_Unscheduled&#x60;: Merchant-initiated transaction (MIT) that does not occur on scheduled or regularly occurring dates. .</param>
        /// <param name="paymentMethodId">The unique ID of the payment method that the customer used to make the payment.   For a specified credit card payment method, it is recommended that [the support for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions) for this payment method is already enabled.  If no payment method ID is specified in the request body, the default payment method for the customer account is used automatically. If the default payment method is different from the type of payments that you want to create, an error occurs. .</param>
        /// <param name="paymentScheduleNumber">The number of the payment schedule to be linked with the payment. See [Link payments to payment schedules](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Payment_Schedules/Link_payments_with_payment_schedules) for more information..</param>
        ...
        public CreatePaymentType(string accountId = default(string), string accountNumber = default(string), double amount = default(double), string authTransactionId = default(string), string comment = default(string), string currency = default(string), List<PaymentDebitMemoApplicationCreateRequestType> debitMemos = default(List<PaymentDebitMemoApplicationCreateRequestType>), DateTime effectiveDate = default(DateTime), CreatePaymentTypeAllOfFinanceInformation financeInformation = default(CreatePaymentTypeAllOfFinanceInformation), string gatewayId = default(string), CreatePaymentTypeAllOfGatewayOptions gatewayOptions = default(CreatePaymentTypeAllOfGatewayOptions), string gatewayOrderId = default(string), List<PaymentInvoiceApplicationCreateRequestType> invoices = default(List<PaymentInvoiceApplicationCreateRequestType>), MitTransactionSourceEnum? mitTransactionSource = default(MitTransactionSourceEnum?), string paymentMethodId = default(string), string paymentScheduleNumber = default(string), string referenceId = default(string), string softDescriptor = default(string), string softDescriptorPhone = default(string), bool standalone = false, TypeEnum type = default(TypeEnum), string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string transactionNS = default(string))
        {
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for CreatePaymentType and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The ID of the customer account that the payment is created for. </value>
        ...
        /// </summary>
        /// <value>The number of the customer account that the payment is created for, such as &#x60;A00000001&#x60;.  You can specify either &#x60;accountNumber&#x60; or &#x60;accountId&#x60; for a customer account. If both of them are specified, they must refer to the same customer account. </value>
        ...
        /// </summary>
        /// <value>The authorization transaction ID from the payment gateway. Use this field for electronic payments, such as credit cards.  When you create a payment for capturing the authorized funds, it is highly recommended to pass in the gatewayOrderId that you used when authorizing the funds by using the [Create authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CreateAuthorization) operation, together with the &#x60;authTransactionId&#x60; field.  The following payment gateways support this field:   - Adyen Integration v2.0   - CyberSource 1.28   - CyberSource 1.97   - CyberSource 2.0   - Chase Paymentech Orbital   - Ingenico ePayments   - SlimPay   - Verifi Global Payment Gateway   - WePay Payment Gateway Integration </value>
        ...
        /// </summary>
        /// <value>Container for debit memos. The maximum number of debit memos is 1,000. </value>
        [DataMember(Name = "debitMemos", EmitDefaultValue = false)]
        public List<PaymentDebitMemoApplicationCreateRequestType> DebitMemos { get; set; }

        /// <summary>
        /// The date when the payment takes effect, in &#x60;yyyy-mm-dd&#x60; format.  **Note:** This is an optional field that only applies to electronic payments. When specified, it must be set to the date of today. 
        /// </summary>
        /// <value>The date when the payment takes effect, in &#x60;yyyy-mm-dd&#x60; format.  **Note:** This is an optional field that only applies to electronic payments. When specified, it must be set to the date of today. </value>
        ...
        public CreatePaymentTypeAllOfFinanceInformation FinanceInformation { get; set; }
        ...
        /// </summary>
        /// <value>The ID of the gateway instance that processes the payment. The ID must be a valid gateway instance ID and this gateway must support the specific payment method.   - When creating electronic payments, this field is required.  - When creating external payments, this field is optional. </value>
        ...
        public CreatePaymentTypeAllOfGatewayOptions GatewayOptions { get; set; }

        /// <summary>
        /// A merchant-specified natural key value that can be passed to the electronic payment gateway when a payment is created. If not specified, the payment number will be passed in instead.  Gateways check duplicates on the gateway order ID to ensure that the merchant do not accidentally enter the same transaction twice. This ID can also be used to do reconciliation and tie the payment to a natural key in external systems. The source of this ID varies by merchant. Some merchants use their shopping cart order IDs, and others use something different. Merchants use this ID to track transactions in their eCommerce systems.  When you create a payment for capturing the authorized funds, it is highly recommended to pass in the gatewayOrderId that you used when authorizing the funds by using the [Create authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CreateAuthorization) operation, together with the &#x60;authTransactionId&#x60; field. 
        /// </summary>
        /// <value>A merchant-specified natural key value that can be passed to the electronic payment gateway when a payment is created. If not specified, the payment number will be passed in instead.  Gateways check duplicates on the gateway order ID to ensure that the merchant do not accidentally enter the same transaction twice. This ID can also be used to do reconciliation and tie the payment to a natural key in external systems. The source of this ID varies by merchant. Some merchants use their shopping cart order IDs, and others use something different. Merchants use this ID to track transactions in their eCommerce systems.  When you create a payment for capturing the authorized funds, it is highly recommended to pass in the gatewayOrderId that you used when authorizing the funds by using the [Create authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CreateAuthorization) operation, together with the &#x60;authTransactionId&#x60; field. </value>
        ...
        /// </summary>
        /// <value>Container for invoices. The maximum number of invoices is 1,000. </value>
        [DataMember(Name = "invoices", EmitDefaultValue = false)]
        public List<PaymentInvoiceApplicationCreateRequestType> Invoices { get; set; }
        ...
        /// </summary>
        /// <value>The unique ID of the payment method that the customer used to make the payment.   For a specified credit card payment method, it is recommended that [the support for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions) for this payment method is already enabled.  If no payment method ID is specified in the request body, the default payment method for the customer account is used automatically. If the default payment method is different from the type of payments that you want to create, an error occurs. </value>
        [DataMember(Name = "paymentMethodId", EmitDefaultValue = false)]
        public string PaymentMethodId { get; set; }

        /// <summary>
        /// The number of the payment schedule to be linked with the payment. See [Link payments to payment schedules](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Payment_Schedules/Link_payments_with_payment_schedules) for more information.
        /// </summary>
        /// <value>The number of the payment schedule to be linked with the payment. See [Link payments to payment schedules](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Payment_Schedules/Link_payments_with_payment_schedules) for more information.</value>
        ...
        /// </summary>
        /// <value>This field is only available if support for standalone payments is enabled.  Specify &#x60;true&#x60; to create a standalone payment that will be processed in Zuora through Zuora gateway integration but will be settled outside of Zuora.  When &#x60;standalone&#x60; is set to &#x60;true&#x60;:   - &#x60;accountId&#x60;, &#x60;amount&#x60;, &#x60;currency&#x60;, and &#x60;type&#x60; are required.    - &#x60;type&#x60; must be &#x60;Electronic&#x60;.   - &#x60;currency&#x60; of the payment can be different from the payment currency in the customer account settings.   - The amount will not be summed up into the account balance and key metrics regardless of the payment currency.   - No settlement data will be created.   - Either the applied amount or the unapplied amount of the payment is zero.   - The standalone payment cannot be applied, unapplied, or transferred.  Specify &#x60;false&#x60; to create an ordinary payment that will be created, processed, and settled in Zuora. The &#x60;currency&#x60; of an ordinary payment must be the same as the currency in the customer account settings. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MitTransactionSource: ").Append(MitTransactionSource).Append("\n");
        ...
        {
            return this.Equals(input as CreatePaymentType);
        }

        /// <summary>
        /// Returns true if CreatePaymentType instances are equal
        /// </summary>
        /// <param name="input">Instance of CreatePaymentType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreatePaymentType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DebitMemos == input.DebitMemos ||
                    this.DebitMemos != null &&
                    input.DebitMemos != null &&
                    this.DebitMemos.SequenceEqual(input.DebitMemos)
                ) && 
                (
                ...
                (
                    this.MitTransactionSource == input.MitTransactionSource ||
                    this.MitTransactionSource.Equals(input.MitTransactionSource)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.DebitMemos.GetHashCode();
                }
                ...
                hashCode = (hashCode * 59) + this.MitTransactionSource.GetHashCode();
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.GatewayOrderId != null && this.GatewayOrderId.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GatewayOrderId, length must be less than 50.", new [] { "GatewayOrderId" });
            }
