...
namespace ZuoraClient.Model
{
    ...
    /// InvoiceDataInvoice
    /// </summary>
    [DataContract(Name = "InvoiceDataInvoice")]
    public partial class InvoiceDataInvoice : IEquatable<InvoiceDataInvoice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceDataInvoice" /> class.
        /// </summary>
        ...
        /// <param name="dueDate"> The date by which the payment for this invoice is due.   **Character limit**: 29 .</param>
        ...
        /// <param name="invoiceDate"> Specifies the date on which to generate the invoice.   **Character limit**: 29 .</param>
        ...
        /// <param name="targetDate"> This date is used to determine which charges are to be billed. All charges that are to be billed on this date or prior will be included in this bill run.   **Character limit**: 29 .</param>
        ...
        /// <param name="taxExemptAmount"> The calculated tax amount excluded due to the exemption.   **Character limit**: 16   **Values**: automatically generated .</param>
        ...
        public InvoiceDataInvoice(string accountId = default(string), double adjustmentAmount = default(double), double amount = default(double), double amountWithoutTax = default(double), double balance = default(double), string billRunId = default(string), string body = default(string), string comments = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), double creditBalanceAdjustmentAmount = default(double), DateTime dueDate = default(DateTime), bool includesOneTime = default(bool), bool includesRecurring = default(bool), bool includesUsage = default(bool), DateTime invoiceDate = default(DateTime), string invoiceNumber = default(string), DateTime lastEmailSentDate = default(DateTime), double paymentAmount = default(double), string postedBy = default(string), DateTime postedDate = default(DateTime), double refundAmount = default(double), bool regenerateInvoicePDF = default(bool), string status = default(string), DateTime targetDate = default(DateTime), double taxAmount = default(double), double taxExemptAmount = default(double), string transferredToAccounting = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value> The date by which the payment for this invoice is due.   **Character limit**: 29 </value>
        ...
        /// </summary>
        /// <value> Specifies the date on which to generate the invoice.   **Character limit**: 29 </value>
        ...
        [DataMember(Name = "RegenerateInvoicePDF", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value> This date is used to determine which charges are to be billed. All charges that are to be billed on this date or prior will be included in this bill run.   **Character limit**: 29 </value>
        ...
        /// <summary>
        ///  The calculated tax amount excluded due to the exemption.   **Character limit**: 16   **Values**: automatically generated 
        /// </summary>
        /// <value> The calculated tax amount excluded due to the exemption.   **Character limit**: 16   **Values**: automatically generated </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvoiceDataInvoice {\n");
        ...
        {
            return this.Equals(input as InvoiceDataInvoice);
        }

        /// <summary>
        /// Returns true if InvoiceDataInvoice instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceDataInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceDataInvoice input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.BillRunId == input.BillRunId ||
                    (this.BillRunId != null &&
                    this.BillRunId.Equals(input.BillRunId))
                ) && 
                (
                ...
                (
                    this.RegenerateInvoicePDF == input.RegenerateInvoicePDF ||
                    this.RegenerateInvoicePDF.Equals(input.RegenerateInvoicePDF)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.BillRunId.GetHashCode();
                }
                if (this.Body != null)
                {
                ...
                hashCode = (hashCode * 59) + this.RegenerateInvoicePDF.GetHashCode();
                if (this.Status != null)
                {
