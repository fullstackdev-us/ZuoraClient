...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRevenueEventDetailType_allOf")]
    public partial class GETRevenueEventDetailTypeAllOf : IEquatable<GETRevenueEventDetailTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Label of the revenue event type. Revenue event type labels can be duplicated. You can configure your revenue event type labels by navigating to **Settings &gt; Finance &gt; Configure Revenue Event Types** in the Zuora UI.  Note that &#x60;Credit Memo Posted&#x60; and &#x60;Debit Memo Posted&#x60; are only available if you enable the Invoice Settlement feature. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum EventTypeEnum
        {
            /// <summary>
            /// Enum InvoicePosted for value: Invoice Posted
            /// </summary>
            [EnumMember(Value = "Invoice Posted")]
            InvoicePosted = 1,

            /// <summary>
            /// Enum InvoiceItemAdjustmentCreated for value: Invoice Item Adjustment Created
            /// </summary>
            [EnumMember(Value = "Invoice Item Adjustment Created")]
            InvoiceItemAdjustmentCreated = 2,

            /// <summary>
            /// Enum InvoiceCanceled for value: Invoice Canceled
            /// </summary>
            [EnumMember(Value = "Invoice Canceled")]
            InvoiceCanceled = 3,

            /// <summary>
            /// Enum InvoiceItemAdjustmentCanceled for value: Invoice Item Adjustment Canceled
            /// </summary>
            [EnumMember(Value = "Invoice Item Adjustment Canceled")]
            InvoiceItemAdjustmentCanceled = 4,

            /// <summary>
            /// Enum RevenueDistributed for value: Revenue Distributed
            /// </summary>
            [EnumMember(Value = "Revenue Distributed")]
            RevenueDistributed = 5,

            /// <summary>
            /// Enum CreditMemoPosted for value: Credit Memo Posted
            /// </summary>
            [EnumMember(Value = "Credit Memo Posted")]
            CreditMemoPosted = 6,

            /// <summary>
            /// Enum DebitMemoPosted for value: Debit Memo Posted
            /// </summary>
            [EnumMember(Value = "Debit Memo Posted")]
            DebitMemoPosted = 7
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRevenueEventDetailTypeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="eventType">Label of the revenue event type. Revenue event type labels can be duplicated. You can configure your revenue event type labels by navigating to **Settings &gt; Finance &gt; Configure Revenue Event Types** in the Zuora UI.  Note that &#x60;Credit Memo Posted&#x60; and &#x60;Debit Memo Posted&#x60; are only available if you enable the Invoice Settlement feature. .</param>
        ...
        public GETRevenueEventDetailTypeAllOf(string accountId = default(string), DateTime createdOn = default(DateTime), string currency = default(string), EventTypeEnum? eventType = default(EventTypeEnum?), string notes = default(string), string number = default(string), DateTime recognitionEnd = default(DateTime), DateTime recognitionStart = default(DateTime), List<GETRevenueItemType> revenueItems = default(List<GETRevenueItemType>), string subscriptionChargeId = default(string), string subscriptionId = default(string), bool success = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETRevenueEventDetailTypeAllOf {\n");
        ...
        {
            return this.Equals(input as GETRevenueEventDetailTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETRevenueEventDetailTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRevenueEventDetailTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRevenueEventDetailTypeAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RecognitionEnd == input.RecognitionEnd ||
                    (this.RecognitionEnd != null &&
                    this.RecognitionEnd.Equals(input.RecognitionEnd))
                ) && 
                (
                    this.RecognitionStart == input.RecognitionStart ||
                    (this.RecognitionStart != null &&
                    this.RecognitionStart.Equals(input.RecognitionStart))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.RecognitionEnd.GetHashCode();
                }
                if (this.RecognitionStart != null)
                {
                    hashCode = (hashCode * 59) + this.RecognitionStart.GetHashCode();
                }
