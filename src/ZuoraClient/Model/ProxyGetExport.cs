...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetExport
    /// </summary>
    [DataContract(Name = "ProxyGetExport")]
    public partial class ProxyGetExport : IEquatable<ProxyGetExport>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value> The format that you want the export file to use. **Character limit**: 5 </value>
        ...
        /// </summary>
        /// <param name="convertToCurrencies"> The currencies that you want to convert transaction amounts into. You can specify any number of currencies. Specify the currencies using their Foreign Currency Conversion enabled to use this field. **Character limit**: **Values**: a list of valid currency codes .</param>
        ...
        /// <param name="fileId"> The ID of the file generated by an export query. This file is automatically generated when an Export object is created. Use this file ID with [Get files](https://www.zuora.com/developer/api-reference/#operation/GET_Files) to download the export file. **Character limit**: 32 **Values**: automatically generated .</param>
        /// <param name="format"> The format that you want the export file to use. **Character limit**: 5 .</param>
        /// <param name="id">Object identifier..</param>
        /// <param name="name"> The name of the export. **Character limit**: 255 **Values**: a string of 255 characters or fewer .</param>
        /// <param name="query">[Export ZOQL](https://knowledgecenter.zuora.com/DC_Developers/M_Export_ZOQL) query. .</param>
        ...
        public ProxyGetExport(string convertToCurrencies = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), bool encrypted = default(bool), string fileId = default(string), FormatEnum? format = default(FormatEnum?), string id = default(string), string name = default(string), string query = default(string), int size = default(int), string status = default(string), string statusReason = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime), bool zip = default(bool))
        {
        ...
        /// </summary>
        /// <value> The currencies that you want to convert transaction amounts into. You can specify any number of currencies. Specify the currencies using their Foreign Currency Conversion enabled to use this field. **Character limit**: **Values**: a list of valid currency codes </value>
        ...
        /// </summary>
        /// <value> The ID of the file generated by an export query. This file is automatically generated when an Export object is created. Use this file ID with [Get files](https://www.zuora.com/developer/api-reference/#operation/GET_Files) to download the export file. **Character limit**: 32 **Values**: automatically generated </value>
        ...
        /// </summary>
        /// <value>[Export ZOQL](https://knowledgecenter.zuora.com/DC_Developers/M_Export_ZOQL) query. </value>
        ...
        {
            return this.Equals(input as ProxyGetExport);
        }

        /// <summary>
        /// Returns true if ProxyGetExport instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetExport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetExport input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.ConvertToCurrencies == input.ConvertToCurrencies ||
                    (this.ConvertToCurrencies != null &&
                    this.ConvertToCurrencies.Equals(input.ConvertToCurrencies))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ConvertToCurrencies.GetHashCode();
                }
