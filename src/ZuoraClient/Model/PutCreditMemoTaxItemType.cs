...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PutCreditMemoTaxItemType")]
    public partial class PutCreditMemoTaxItemType : IEquatable<PutCreditMemoTaxItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutCreditMemoTaxItemType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutCreditMemoTaxItemType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutCreditMemoTaxItemType" /> class.
        /// </summary>
        ...
        public PutCreditMemoTaxItemType(double amount = default(double), PutCreditMemoTaxItemTypeAllOfFinanceInformation financeInformation = default(PutCreditMemoTaxItemTypeAllOfFinanceInformation), string id = default(string), string jurisdiction = default(string), string locationCode = default(string), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), double taxExemptAmount = default(double), string taxName = default(string), double taxRate = default(double), string taxRateDescription = default(string), TaxRateTypeEnum? taxRateType = default(TaxRateTypeEnum?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PutCreditMemoTaxItemType and cannot be null");
            }
            this.Id = id;
            this.Amount = amount;
        ...
        {
            return this.Equals(input as PutCreditMemoTaxItemType);
        }

        /// <summary>
        /// Returns true if PutCreditMemoTaxItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of PutCreditMemoTaxItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutCreditMemoTaxItemType input)
        {
            if (input == null)
            {
                return false;
