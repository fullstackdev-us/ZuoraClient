...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTPaymentScheduleResponse_allOf")]
    public partial class POSTPaymentScheduleResponseAllOf : IEquatable<POSTPaymentScheduleResponseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The status of the payment schedule.  - &#x60;Active&#x60;: There are still pament schedule items to process. - &#x60;Canceled&#x60;: After a payment schedule is canceled by the user, the schedule is marked as &#x60;Canceled&#x60;. - &#x60;Completed&#x60;: After all payment schedule items are processed, the schedule is marked as &#x60;Completed&#x60;. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTPaymentScheduleResponseAllOf" /> class.
        /// </summary>
        /// <param name="accountId">ID of the account that owns the payment schedule. .</param>
        /// <param name="accountNumber">Number of the account that owns the payment schedule. .</param>
        /// <param name="billingDocument">billingDocument.</param>
        /// <param name="createdById">ID of the user who created this payment schedule. .</param>
        /// <param name="createdDate">The date and time the payment schedule is created. .</param>
        /// <param name="description">The description of the payment schedule. .</param>
        /// <param name="id">ID of the payment schedule. .</param>
        /// <param name="isCustom">Indicates if the payment schedule is a custom payment schedule. .</param>
        /// <param name="items">Container for payment schedule items. .</param>
        /// <param name="nextPaymentDate">The date the next payment will be processed. .</param>
        /// <param name="occurrences">The number of payment schedule items that are created by this payment schedule. .</param>
        /// <param name="paymentScheduleNumber">Number of the payment schedule. .</param>
        /// <param name="period">For recurring payment schedule only. The period of payment generation. Available values include: &#x60;Monthly&#x60;, &#x60;Weekly&#x60;, &#x60;BiWeekly&#x60;. Return &#x60;null&#x60; for custom payment schedules. .</param>
        /// <param name="recentPaymentDate">The date the last payment was processed. .</param>
        /// <param name="runHour">[0,1,2,~,22,23]  At which hour in the day in the tenant’s timezone this payment will be collected. Return &#x60;0&#x60; for custom payment schedules. .</param>
        /// <param name="standalone">Indicates if the payments that the payment schedule created are standalone payments or not. .</param>
        /// <param name="startDate">The date when the first payment of this payment schedule is proccessed. .</param>
        /// <param name="status">The status of the payment schedule.  - &#x60;Active&#x60;: There are still pament schedule items to process. - &#x60;Canceled&#x60;: After a payment schedule is canceled by the user, the schedule is marked as &#x60;Canceled&#x60;. - &#x60;Completed&#x60;: After all payment schedule items are processed, the schedule is marked as &#x60;Completed&#x60;. .</param>
        /// <param name="success">Returns &#x60;true&#x60; if the request was processed successfully.         .</param>
        /// <param name="totalPaymentsErrored">The number of errored payments. .</param>
        /// <param name="totalPaymentsProcessed">The number of processed payments. .</param>
        /// <param name="updatedById">ID of the user who last updated this payment schedule. .</param>
        /// <param name="updatedDate">The date and time the payment schedule is last updated. .</param>
        public POSTPaymentScheduleResponseAllOf(string accountId = default(string), string accountNumber = default(string), POSTPaymentScheduleResponseAllOfBillingDocument billingDocument = default(POSTPaymentScheduleResponseAllOfBillingDocument), string createdById = default(string), DateTime createdDate = default(DateTime), string description = default(string), string id = default(string), bool isCustom = default(bool), List<PaymentScheduleItemCommonResponse> items = default(List<PaymentScheduleItemCommonResponse>), DateTime nextPaymentDate = default(DateTime), int occurrences = default(int), string paymentScheduleNumber = default(string), string period = default(string), DateTime recentPaymentDate = default(DateTime), int runHour = default(int), bool standalone = default(bool), DateTime startDate = default(DateTime), StatusEnum? status = default(StatusEnum?), bool success = default(bool), int totalPaymentsErrored = default(int), int totalPaymentsProcessed = default(int), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>ID of the account that owns the payment schedule. </value>
        ...
        /// </summary>
        /// <value>Number of the account that owns the payment schedule. </value>
        [DataMember(Name = "accountNumber", EmitDefaultValue = false)]
        public string AccountNumber { get; set; }

        /// <summary>
        /// Gets or Sets BillingDocument
        /// </summary>
        [DataMember(Name = "billingDocument", EmitDefaultValue = false)]
        public POSTPaymentScheduleResponseAllOfBillingDocument BillingDocument { get; set; }

        /// <summary>
        /// ID of the user who created this payment schedule. 
        /// </summary>
        /// <value>ID of the user who created this payment schedule. </value>
        ...
        /// </summary>
        /// <value>The date and time the payment schedule is created. </value>
        ...
        /// </summary>
        /// <value>The description of the payment schedule. </value>
        ...
        /// </summary>
        /// <value>Indicates if the payment schedule is a custom payment schedule. </value>
        ...
        public List<PaymentScheduleItemCommonResponse> Items { get; set; }

        /// <summary>
        /// The date the next payment will be processed. 
        /// </summary>
        /// <value>The date the next payment will be processed. </value>
        ...
        /// </summary>
        /// <value>The number of payment schedule items that are created by this payment schedule. </value>
        ...
        /// </summary>
        /// <value>For recurring payment schedule only. The period of payment generation. Available values include: &#x60;Monthly&#x60;, &#x60;Weekly&#x60;, &#x60;BiWeekly&#x60;. Return &#x60;null&#x60; for custom payment schedules. </value>
        ...
        /// </summary>
        /// <value>The date the last payment was processed. </value>
        [DataMember(Name = "recentPaymentDate", EmitDefaultValue = false)]
        [JsonConverter(typeof(OpenAPIDateConverter))]
        ...
        /// </summary>
        /// <value>[0,1,2,~,22,23]  At which hour in the day in the tenant’s timezone this payment will be collected. Return &#x60;0&#x60; for custom payment schedules. </value>
        [DataMember(Name = "runHour", EmitDefaultValue = false)]
        public int RunHour { get; set; }

        /// <summary>
        /// Indicates if the payments that the payment schedule created are standalone payments or not. 
        /// </summary>
        /// <value>Indicates if the payments that the payment schedule created are standalone payments or not. </value>
        ...
        /// </summary>
        /// <value>The date when the first payment of this payment schedule is proccessed. </value>
        ...
        /// </summary>
        /// <value>The number of errored payments. </value>
        [DataMember(Name = "totalPaymentsErrored", EmitDefaultValue = false)]
        public int TotalPaymentsErrored { get; set; }

        /// <summary>
        /// The number of processed payments. 
        /// </summary>
        /// <value>The number of processed payments. </value>
        [DataMember(Name = "totalPaymentsProcessed", EmitDefaultValue = false)]
        public int TotalPaymentsProcessed { get; set; }

        /// <summary>
        /// ID of the user who last updated this payment schedule. 
        /// </summary>
        /// <value>ID of the user who last updated this payment schedule. </value>
        ...
        /// </summary>
        /// <value>The date and time the payment schedule is last updated. </value>
        ...
        {
            return this.Equals(input as POSTPaymentScheduleResponseAllOf);
        }

        /// <summary>
        /// Returns true if POSTPaymentScheduleResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTPaymentScheduleResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTPaymentScheduleResponseAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.BillingDocument == input.BillingDocument ||
                    (this.BillingDocument != null &&
                    this.BillingDocument.Equals(input.BillingDocument))
                ) && 
                (
                ...
                (
                    this.RecentPaymentDate == input.RecentPaymentDate ||
                    (this.RecentPaymentDate != null &&
                    this.RecentPaymentDate.Equals(input.RecentPaymentDate))
                ) && 
                (
                    this.RunHour == input.RunHour ||
                    this.RunHour.Equals(input.RunHour)
                ) && 
                (
                ...
                (
                    this.TotalPaymentsErrored == input.TotalPaymentsErrored ||
                    this.TotalPaymentsErrored.Equals(input.TotalPaymentsErrored)
                ) && 
                (
                    this.TotalPaymentsProcessed == input.TotalPaymentsProcessed ||
                    this.TotalPaymentsProcessed.Equals(input.TotalPaymentsProcessed)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BillingDocument != null)
                {
                    hashCode = (hashCode * 59) + this.BillingDocument.GetHashCode();
                }
                ...
                if (this.RecentPaymentDate != null)
                {
                    hashCode = (hashCode * 59) + this.RecentPaymentDate.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.RunHour.GetHashCode();
                ...
                hashCode = (hashCode * 59) + this.TotalPaymentsErrored.GetHashCode();
                hashCode = (hashCode * 59) + this.TotalPaymentsProcessed.GetHashCode();
