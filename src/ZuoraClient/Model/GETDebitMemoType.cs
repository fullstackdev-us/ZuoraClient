...
namespace ZuoraClient.Model
{
    ...
    /// GETDebitMemoType
    /// </summary>
    [DataContract(Name = "GETDebitMemoType")]
    public partial class GETDebitMemoType : IEquatable<GETDebitMemoType>, IValidatableObject
    {
        /// <summary>
        /// The type of the debit memo source. 
        /// </summary>
        /// <value>The type of the debit memo source. </value>
        ...
        public enum SourceTypeEnum
        {
            ...
            /// <summary>
            /// Enum CreditMemo for value: CreditMemo
            /// </summary>
        ...
        /// </summary>
        /// <value>The status of tax calculation related to the debit memo.  **Note**: This field is only applicable to tax calculation by third-party tax engines. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Whether the debit memo was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETDebitMemoType" /> class.
        /// </summary>
        /// <param name="accountId">The ID of the customer account associated with the debit memo. .</param>
        /// <param name="amount">The total amount of the debit memo. .</param>
        /// <param name="autoPay">Whether debit memos are automatically picked up for processing in the corresponding payment run.  By default, debit memos are automatically picked up for processing in the corresponding payment run. .</param>
        /// <param name="balance">The balance of the debit memo. .</param>
        /// <param name="beAppliedAmount">The amount that is applied to the debit memo. .</param>
        /// <param name="billToContactId">The ID of the bill-to contact associated with the debit memo.  The value of this field is &#x60;null&#x60; if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature disabled. .</param>
        /// <param name="cancelledById">The ID of the Zuora user who cancelled the debit memo. .</param>
        /// <param name="cancelledOn">The date and time when the debit memo was cancelled, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        /// <param name="comment">Comments about the debit memo. .</param>
        /// <param name="createdById">The ID of the Zuora user who created the debit memo. .</param>
        /// <param name="createdDate">The date and time when the debit memo was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10. .</param>
        /// <param name="debitMemoDate">The date when the debit memo takes effect, in &#x60;yyyy-mm-dd&#x60; format. For example, 2017-05-20. .</param>
        /// <param name="dueDate">The date by which the payment for the debit memo is due, in &#x60;yyyy-mm-dd&#x60; format. .</param>
        /// <param name="excludeItemBillingFromRevenueAccounting">The flag to exclude the debit memo item from revenue accounting.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.  .</param>
        /// <param name="id">The unique ID of the debit memo. .</param>
        /// <param name="latestPDFFileId">The ID of the latest PDF file generated for the debit memo. .</param>
        /// <param name="number">The unique identification number of the debit memo. .</param>
        /// <param name="paymentTerm">The name of the payment term assoicated with the debit memo.  The value of this field is &#x60;null&#x60; if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature disabled.               .</param>
        /// <param name="postedById">The ID of the Zuora user who posted the debit memo. .</param>
        /// <param name="postedOn">The date and time when the debit memo was posted, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        ...
        /// <param name="referredCreditMemoId">The ID of the credit memo from which the debit memo was created. .</param>
        /// <param name="referredInvoiceId">The ID of a referred invoice. .</param>
        /// <param name="sourceType">The type of the debit memo source. .</param>
        /// <param name="status">The status of the debit memo. .</param>
        /// <param name="success">Returns &#x60;true&#x60; if the request was processed successfully..</param>
        /// <param name="targetDate">The target date for the debit memo, in &#x60;yyyy-mm-dd&#x60; format. For example, 2017-07-20. .</param>
        /// <param name="taxAmount">The amount of taxation. .</param>
        /// <param name="taxMessage">The message about the status of tax calculation related to the debit memo. If tax calculation fails in one debit memo, this field displays the reason for the failure. .</param>
        /// <param name="taxStatus">The status of tax calculation related to the debit memo.  **Note**: This field is only applicable to tax calculation by third-party tax engines. .</param>
        /// <param name="totalTaxExemptAmount">The calculated tax amount excluded due to the exemption. .</param>
        /// <param name="transferredToAccounting">Whether the debit memo was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite. .</param>
        /// <param name="updatedById">The ID of the Zuora user who last updated the debit memo. .</param>
        /// <param name="updatedDate">The date and time when the debit memo was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. .</param>
        ...
        /// <param name="integrationStatusNS">Status of the debit memo&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        /// <param name="syncDateNS">Date when the debit memo was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        public GETDebitMemoType(string accountId = default(string), double amount = default(double), bool autoPay = default(bool), double balance = default(double), double beAppliedAmount = default(double), string billToContactId = default(string), string cancelledById = default(string), DateTime cancelledOn = default(DateTime), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), DateTime debitMemoDate = default(DateTime), DateTime dueDate = default(DateTime), bool excludeItemBillingFromRevenueAccounting = default(bool), string id = default(string), string latestPDFFileId = default(string), string number = default(string), string paymentTerm = default(string), string postedById = default(string), DateTime postedOn = default(DateTime), string reasonCode = default(string), string referredCreditMemoId = default(string), string referredInvoiceId = default(string), SourceTypeEnum? sourceType = default(SourceTypeEnum?), StatusEnum? status = default(StatusEnum?), bool success = default(bool), DateTime targetDate = default(DateTime), double taxAmount = default(double), string taxMessage = default(string), TaxStatusEnum? taxStatus = default(TaxStatusEnum?), double totalTaxExemptAmount = default(double), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value>The ID of the customer account associated with the debit memo. </value>
        ...
        /// </summary>
        /// <value>The total amount of the debit memo. </value>
        ...
        /// </summary>
        /// <value>Whether debit memos are automatically picked up for processing in the corresponding payment run.  By default, debit memos are automatically picked up for processing in the corresponding payment run. </value>
        ...
        /// </summary>
        /// <value>The balance of the debit memo. </value>
        ...
        /// </summary>
        /// <value>The amount that is applied to the debit memo. </value>
        [DataMember(Name = "beAppliedAmount", EmitDefaultValue = false)]
        public double BeAppliedAmount { get; set; }

        /// <summary>
        /// The ID of the bill-to contact associated with the debit memo.  The value of this field is &#x60;null&#x60; if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature disabled. 
        /// </summary>
        /// <value>The ID of the bill-to contact associated with the debit memo.  The value of this field is &#x60;null&#x60; if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature disabled. </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who cancelled the debit memo. </value>
        ...
        /// </summary>
        /// <value>The date and time when the debit memo was cancelled, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>Comments about the debit memo. </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who created the debit memo. </value>
        ...
        /// </summary>
        /// <value>The date and time when the debit memo was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10. </value>
        ...
        /// </summary>
        /// <value>The date when the debit memo takes effect, in &#x60;yyyy-mm-dd&#x60; format. For example, 2017-05-20. </value>
        [DataMember(Name = "debitMemoDate", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The date by which the payment for the debit memo is due, in &#x60;yyyy-mm-dd&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The flag to exclude the debit memo item from revenue accounting.  **Note**: This field is only available if you have the Billing - Revenue Integration feature enabled.  </value>
        ...
        /// </summary>
        /// <value>The unique ID of the debit memo. </value>
        ...
        /// </summary>
        /// <value>The ID of the latest PDF file generated for the debit memo. </value>
        ...
        /// </summary>
        /// <value>The unique identification number of the debit memo. </value>
        [DataMember(Name = "number", EmitDefaultValue = false)]
        public string Number { get; set; }

        /// <summary>
        /// The name of the payment term assoicated with the debit memo.  The value of this field is &#x60;null&#x60; if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature disabled.               
        /// </summary>
        /// <value>The name of the payment term assoicated with the debit memo.  The value of this field is &#x60;null&#x60; if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature disabled.               </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who posted the debit memo. </value>
        ...
        /// </summary>
        /// <value>The date and time when the debit memo was posted, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The ID of the credit memo from which the debit memo was created. </value>
        [DataMember(Name = "referredCreditMemoId", EmitDefaultValue = false)]
        public string ReferredCreditMemoId { get; set; }
        ...
        /// </summary>
        /// <value>The target date for the debit memo, in &#x60;yyyy-mm-dd&#x60; format. For example, 2017-07-20. </value>
        ...
        /// </summary>
        /// <value>The message about the status of tax calculation related to the debit memo. If tax calculation fails in one debit memo, this field displays the reason for the failure. </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who last updated the debit memo. </value>
        ...
        /// </summary>
        /// <value>The date and time when the debit memo was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. </value>
        ...
        /// </summary>
        /// <value>Status of the debit memo&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        /// </summary>
        /// <value>Date when the debit memo was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BeAppliedAmount: ").Append(BeAppliedAmount).Append("\n");
            ...
            sb.Append("  DebitMemoDate: ").Append(DebitMemoDate).Append("\n");
            ...
            sb.Append("  ReferredCreditMemoId: ").Append(ReferredCreditMemoId).Append("\n");
        ...
        {
            return this.Equals(input as GETDebitMemoType);
        }

        /// <summary>
        /// Returns true if GETDebitMemoType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETDebitMemoType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETDebitMemoType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.BeAppliedAmount == input.BeAppliedAmount ||
                    this.BeAppliedAmount.Equals(input.BeAppliedAmount)
                ) && 
                (
                ...
                (
                    this.DebitMemoDate == input.DebitMemoDate ||
                    (this.DebitMemoDate != null &&
                    this.DebitMemoDate.Equals(input.DebitMemoDate))
                ) && 
                (
                ...
                (
                    this.ReferredCreditMemoId == input.ReferredCreditMemoId ||
                    (this.ReferredCreditMemoId != null &&
                    this.ReferredCreditMemoId.Equals(input.ReferredCreditMemoId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.BeAppliedAmount.GetHashCode();
                ...
                if (this.DebitMemoDate != null)
                {
                    hashCode = (hashCode * 59) + this.DebitMemoDate.GetHashCode();
                }
                ...
                if (this.ReferredCreditMemoId != null)
                {
                    hashCode = (hashCode * 59) + this.ReferredCreditMemoId.GetHashCode();
                }
