...
namespace ZuoraClient.Model
{
    ...
    /// GETCMTaxItemType
    /// </summary>
    [DataContract(Name = "GETCMTaxItemType")]
    public partial class GETCMTaxItemType : IEquatable<GETCMTaxItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETCMTaxItemType" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETCMTaxItemType);
        }

        /// <summary>
        /// Returns true if GETCMTaxItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETCMTaxItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETCMTaxItemType input)
        {
            if (input == null)
            {
                return false;
