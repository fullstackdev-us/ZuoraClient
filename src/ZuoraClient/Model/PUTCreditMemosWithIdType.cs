...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PUTCreditMemosWithIdType")]
    public partial class PUTCreditMemosWithIdType : IEquatable<PUTCreditMemosWithIdType>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Whether the credit memo is transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite.  </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTCreditMemosWithIdType" /> class.
        /// </summary>
        /// <param name="id">The ID of the credit memo. .</param>
        ...
        /// <param name="excludeFromAutoApplyRules">Whether the credit memo is excluded from the rule of automatically applying unapplied credit memos to invoices and debit memos during payment runs. If you set this field to &#x60;true&#x60;, a payment run does not pick up this credit memo or apply it to other invoices or debit memos. .</param>
        /// <param name="items">Container for credit memo items. .</param>
        ...
        /// <param name="transferredToAccounting">Whether the credit memo is transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite.  .</param>
        ...
        public PUTCreditMemosWithIdType(string id = default(string), bool autoApplyUponPosting = default(bool), string comment = default(string), DateTime effectiveDate = default(DateTime), bool excludeFromAutoApplyRules = default(bool), List<PUTCreditMemoItemType> items = default(List<PUTCreditMemoItemType>), string reasonCode = default(string), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string transactionNS = default(string))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>The ID of the credit memo. </value>
        ...
        /// </summary>
        /// <value>Whether the credit memo is excluded from the rule of automatically applying unapplied credit memos to invoices and debit memos during payment runs. If you set this field to &#x60;true&#x60;, a payment run does not pick up this credit memo or apply it to other invoices or debit memos. </value>
        ...
        /// </summary>
        /// <value>Container for credit memo items. </value>
        [DataMember(Name = "items", EmitDefaultValue = false)]
        public List<PUTCreditMemoItemType> Items { get; set; }
        ...
        {
            return this.Equals(input as PUTCreditMemosWithIdType);
        }

        /// <summary>
        /// Returns true if PUTCreditMemosWithIdType instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTCreditMemosWithIdType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTCreditMemosWithIdType input)
        {
            if (input == null)
            {
                return false;
