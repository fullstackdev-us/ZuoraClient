...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PUTPaymentMethodType")]
    public partial class PUTPaymentMethodType : IEquatable<PUTPaymentMethodType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PUTPaymentMethodType);
        }

        /// <summary>
        /// Returns true if PUTPaymentMethodType instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTPaymentMethodType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTPaymentMethodType input)
        {
            if (input == null)
            {
                return false;
