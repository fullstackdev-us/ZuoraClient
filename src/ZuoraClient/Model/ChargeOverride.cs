...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChargeOverride")]
    public partial class ChargeOverride : IEquatable<ChargeOverride>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeOverride" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChargeOverride() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeOverride" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ChargeOverride);
        }

        /// <summary>
        /// Returns true if ChargeOverride instances are equal
        /// </summary>
        /// <param name="input">Instance of ChargeOverride to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargeOverride input)
        {
            if (input == null)
            {
                return false;
