...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRSDetailWithoutSuccessType")]
    public partial class GETRSDetailWithoutSuccessType : IEquatable<GETRSDetailWithoutSuccessType>, IValidatableObject
    {
        ...
        public GETRSDetailWithoutSuccessType(string accountId = default(string), decimal amount = default(decimal), DateTime createdOn = default(DateTime), string currency = default(string), string linkedTransactionId = default(string), string linkedTransactionNumber = default(string), string linkedTransactionType = default(string), string notes = default(string), string number = default(string), string recognitionRuleName = default(string), decimal recognizedRevenue = default(decimal), string referenceId = default(string), List<GETRsRevenueItemType> revenueItems = default(List<GETRsRevenueItemType>), DateTime revenueScheduleDate = default(DateTime), string subscriptionChargeId = default(string), string subscriptionId = default(string), decimal undistributedUnrecognizedRevenue = default(decimal), decimal unrecognizedRevenue = default(decimal), DateTime updatedOn = default(DateTime))
        {
        ...
        {
            return this.Equals(input as GETRSDetailWithoutSuccessType);
        }

        /// <summary>
        /// Returns true if GETRSDetailWithoutSuccessType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRSDetailWithoutSuccessType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRSDetailWithoutSuccessType input)
        {
            if (input == null)
            {
                return false;
