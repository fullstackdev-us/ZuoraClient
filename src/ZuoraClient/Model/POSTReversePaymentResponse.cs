...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTReversePaymentResponse")]
    public partial class POSTReversePaymentResponse : IEquatable<POSTReversePaymentResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTReversePaymentResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as POSTReversePaymentResponse);
        }

        /// <summary>
        /// Returns true if POSTReversePaymentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTReversePaymentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTReversePaymentResponse input)
        {
            if (input == null)
            {
                return false;
