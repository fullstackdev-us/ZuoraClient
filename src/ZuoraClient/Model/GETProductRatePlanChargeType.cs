...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETProductRatePlanChargeType")]
    public partial class GETProductRatePlanChargeType : IEquatable<GETProductRatePlanChargeType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETProductRatePlanChargeType);
        }

        /// <summary>
        /// Returns true if GETProductRatePlanChargeType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETProductRatePlanChargeType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETProductRatePlanChargeType input)
        {
            if (input == null)
            {
                return false;
