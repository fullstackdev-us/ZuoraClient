...
namespace ZuoraClient.Model
{
    ...
    public partial class JobResult : IEquatable<JobResult>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Status of the order. &#x60;Pending&#x60; is only applicable for an order that contains a &#x60;CreateSubscription&#x60; order action.</value>
        ...
        /// </summary>
        /// <param name="processId">The Id of the process that handle the operation. .</param>
        /// <param name="reasons">reasons.</param>
        /// <param name="success">Indicates whether the call succeeded. .</param>
        /// <param name="accountId">The account ID for the order. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;..</param>
        /// <param name="accountNumber">The account number for the order..</param>
        /// <param name="creditMemoIds">An array of the credit memo IDs that are generated in the \&quot;Create an order asynchronously\&quot; operation. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;..</param>
        /// <param name="creditMemoNumbers">An array of the credit memo numbers generated in this order request. The credit memo is only available if you have the Invoice Settlement feature enabled..</param>
        /// <param name="invoiceId">An array of the invoice IDs that are generated in the \&quot;Create an order asynchronously\&quot; operation. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;..</param>
        /// <param name="invoiceNumbers">An array of the invoice numbers generated in this order request. Normally it includes one invoice number only, but can include multiple items when a subscription was tagged as invoice separately..</param>
        /// <param name="orderId">The ID of the order created. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;..</param>
        /// <param name="orderLineItems">orderLineItems.</param>
        /// <param name="orderNumber">The order number of the order created..</param>
        /// <param name="paidAmount">The total amount collected in this order request..</param>
        /// <param name="paymentId">The ID of the payment that is collected in the \&quot;Create an order asynchronously\&quot; operation. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;..</param>
        /// <param name="paymentNumber">The payment number that collected in this order request..</param>
        /// <param name="ramps">**Note**: This field is only available if you have the Ramps feature enabled. The [Orders](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/AA_Overview_of_Orders) feature must be enabled before you can access the [Ramps](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Ramps_and_Ramp_Metrics/A_Overview_of_Ramps_and_Ramp_Metrics) feature. The Ramps feature is available for customers with Enterprise and Nine editions by default. If you are a Growth customer, see [Zuora Editions](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/C_Zuora_Editions) for pricing information coming October 2020.  The ramp definitions created by this order request. .</param>
        /// <param name="status">Status of the order. &#x60;Pending&#x60; is only applicable for an order that contains a &#x60;CreateSubscription&#x60; order action..</param>
        /// <param name="subscriptionIds">Container for the IDs of the subscriptions in the order. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;..</param>
        /// <param name="subscriptionNumbers">**Note:** This field is in Zuora REST API version control. Supported minor versions are 222.4 or earlier. To use this field in the method, you must set the &#x60;zuora-version&#x60; parameter to the minor version number in the request header.  Container for the subscription numbers of the subscriptions in an order. .</param>
        /// <param name="subscriptions">**Note:** This field is in Zuora REST API version control. Supported minor versions are 223.0 or later. To use this field in the method, you must set the &#x60;zuora-version&#x60; parameter to the minor version number in the request header.  Container for the subscription numbers and statuses in an order. .</param>
        public JobResult(string processId = default(string), List<CommonResponseTypeReasonsInner> reasons = default(List<CommonResponseTypeReasonsInner>), bool success = default(bool), string accountId = default(string), string accountNumber = default(string), List<string> creditMemoIds = default(List<string>), List<string> creditMemoNumbers = default(List<string>), string invoiceId = default(string), List<string> invoiceNumbers = default(List<string>), string orderId = default(string), List<JobResultAllOfOrderLineItems> orderLineItems = default(List<JobResultAllOfOrderLineItems>), string orderNumber = default(string), string paidAmount = default(string), string paymentId = default(string), string paymentNumber = default(string), List<JobResultAllOfRamps> ramps = default(List<JobResultAllOfRamps>), StatusEnum? status = default(StatusEnum?), List<string> subscriptionIds = default(List<string>), List<string> subscriptionNumbers = default(List<string>), List<JobResultAllOfSubscriptions> subscriptions = default(List<JobResultAllOfSubscriptions>))
        {
        ...
        /// </summary>
        /// <value>The Id of the process that handle the operation. </value>
        ...
        public List<CommonResponseTypeReasonsInner> Reasons { get; set; }

        /// <summary>
        /// Indicates whether the call succeeded. 
        /// </summary>
        /// <value>Indicates whether the call succeeded. </value>
        ...
        /// </summary>
        /// <value>The account ID for the order. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>The account number for the order.</value>
        ...
        /// </summary>
        /// <value>An array of the credit memo IDs that are generated in the \&quot;Create an order asynchronously\&quot; operation. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;.</value>
        [DataMember(Name = "creditMemoIds", EmitDefaultValue = false)]
        public List<string> CreditMemoIds { get; set; }
        ...
        /// </summary>
        /// <value>An array of the credit memo numbers generated in this order request. The credit memo is only available if you have the Invoice Settlement feature enabled.</value>
        [DataMember(Name = "creditMemoNumbers", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>An array of the invoice IDs that are generated in the \&quot;Create an order asynchronously\&quot; operation. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>An array of the invoice numbers generated in this order request. Normally it includes one invoice number only, but can include multiple items when a subscription was tagged as invoice separately.</value>
        [DataMember(Name = "invoiceNumbers", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The ID of the order created. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;.</value>
        [DataMember(Name = "orderId", EmitDefaultValue = false)]
        public string OrderId { get; set; }

        /// <summary>
        /// Gets or Sets OrderLineItems
        /// </summary>
        [DataMember(Name = "orderLineItems", EmitDefaultValue = false)]
        public List<JobResultAllOfOrderLineItems> OrderLineItems { get; set; }

        /// <summary>
        /// The order number of the order created.
        /// </summary>
        /// <value>The order number of the order created.</value>
        ...
        /// </summary>
        /// <value>The total amount collected in this order request.</value>
        ...
        /// </summary>
        /// <value>The ID of the payment that is collected in the \&quot;Create an order asynchronously\&quot; operation. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>The payment number that collected in this order request.</value>
        ...
        /// </summary>
        /// <value>**Note**: This field is only available if you have the Ramps feature enabled. The [Orders](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/AA_Overview_of_Orders) feature must be enabled before you can access the [Ramps](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Ramps_and_Ramp_Metrics/A_Overview_of_Ramps_and_Ramp_Metrics) feature. The Ramps feature is available for customers with Enterprise and Nine editions by default. If you are a Growth customer, see [Zuora Editions](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/C_Zuora_Editions) for pricing information coming October 2020.  The ramp definitions created by this order request. </value>
        [DataMember(Name = "ramps", EmitDefaultValue = false)]
        public List<JobResultAllOfRamps> Ramps { get; set; }
        ...
        /// </summary>
        /// <value>Container for the IDs of the subscriptions in the order. This field is returned only when the &#x60;returnIds&#x60; query parameter in the \&quot;Create an order asynchronously\&quot; operation is set to &#x60;true&#x60;.</value>
        [DataMember(Name = "subscriptionIds", EmitDefaultValue = false)]
        public List<string> SubscriptionIds { get; set; }

        /// <summary>
        /// **Note:** This field is in Zuora REST API version control. Supported minor versions are 222.4 or earlier. To use this field in the method, you must set the &#x60;zuora-version&#x60; parameter to the minor version number in the request header.  Container for the subscription numbers of the subscriptions in an order. 
        /// </summary>
        /// <value>**Note:** This field is in Zuora REST API version control. Supported minor versions are 222.4 or earlier. To use this field in the method, you must set the &#x60;zuora-version&#x60; parameter to the minor version number in the request header.  Container for the subscription numbers of the subscriptions in an order. </value>
        [DataMember(Name = "subscriptionNumbers", EmitDefaultValue = false)]
        public List<string> SubscriptionNumbers { get; set; }
        ...
        /// </summary>
        /// <value>**Note:** This field is in Zuora REST API version control. Supported minor versions are 223.0 or later. To use this field in the method, you must set the &#x60;zuora-version&#x60; parameter to the minor version number in the request header.  Container for the subscription numbers and statuses in an order. </value>
        [DataMember(Name = "subscriptions", EmitDefaultValue = false)]
        public List<JobResultAllOfSubscriptions> Subscriptions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CreditMemoIds: ").Append(CreditMemoIds).Append("\n");
            ...
            sb.Append("  Ramps: ").Append(Ramps).Append("\n");
            sb.Append("  Status: ").Append(Status).Append("\n");
            sb.Append("  SubscriptionIds: ").Append(SubscriptionIds).Append("\n");
            sb.Append("  SubscriptionNumbers: ").Append(SubscriptionNumbers).Append("\n");
        ...
        public bool Equals(JobResult input)
        {
            ...
            return 
                ...
                (
                    this.CreditMemoIds == input.CreditMemoIds ||
                    this.CreditMemoIds != null &&
                    input.CreditMemoIds != null &&
                    this.CreditMemoIds.SequenceEqual(input.CreditMemoIds)
                ) && 
                (
                    this.CreditMemoNumbers == input.CreditMemoNumbers ||
                    this.CreditMemoNumbers != null &&
                    input.CreditMemoNumbers != null &&
                    this.CreditMemoNumbers.SequenceEqual(input.CreditMemoNumbers)
                ) && 
                (
                ...
                (
                    this.InvoiceNumbers == input.InvoiceNumbers ||
                    this.InvoiceNumbers != null &&
                    input.InvoiceNumbers != null &&
                    this.InvoiceNumbers.SequenceEqual(input.InvoiceNumbers)
                ) && 
                (
                ...
                (
                    this.OrderLineItems == input.OrderLineItems ||
                    this.OrderLineItems != null &&
                    input.OrderLineItems != null &&
                    this.OrderLineItems.SequenceEqual(input.OrderLineItems)
                ) && 
                (
                ...
                (
                    this.Ramps == input.Ramps ||
                    this.Ramps != null &&
                    input.Ramps != null &&
                    this.Ramps.SequenceEqual(input.Ramps)
                ) && 
                (
                ...
                (
                    this.SubscriptionNumbers == input.SubscriptionNumbers ||
                    this.SubscriptionNumbers != null &&
                    input.SubscriptionNumbers != null &&
                    this.SubscriptionNumbers.SequenceEqual(input.SubscriptionNumbers)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.CreditMemoIds.GetHashCode();
                }
                if (this.CreditMemoNumbers != null)
                {
                    hashCode = (hashCode * 59) + this.CreditMemoNumbers.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.InvoiceNumbers.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.OrderLineItems.GetHashCode();
                }
                ...
                if (this.Ramps != null)
                {
                    hashCode = (hashCode * 59) + this.Ramps.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.SubscriptionNumbers.GetHashCode();
                }
