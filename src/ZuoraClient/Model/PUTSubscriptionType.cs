...
namespace ZuoraClient.Model
{
    ...
    /// PUTSubscriptionType
    /// </summary>
    [DataContract(Name = "PUTSubscriptionType")]
    public partial class PUTSubscriptionType : IEquatable<PUTSubscriptionType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PUTSubscriptionType);
        }

        /// <summary>
        /// Returns true if PUTSubscriptionType instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTSubscriptionType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSubscriptionType input)
        {
            if (input == null)
            {
                return false;
