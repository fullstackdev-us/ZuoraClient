...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountingCodeItemType_allOf")]
    public partial class GETAccountingCodeItemTypeAllOf : IEquatable<GETAccountingCodeItemTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountingCodeItemTypeAllOf" /> class.
        /// </summary>
        ...
        public GETAccountingCodeItemTypeAllOf(CategoryEnum? category = default(CategoryEnum?), string createdBy = default(string), DateTime createdOn = default(DateTime), string glAccountName = default(string), string glAccountNumber = default(string), string id = default(string), string name = default(string), string notes = default(string), StatusEnum? status = default(StatusEnum?), bool success = default(bool), TypeEnum? type = default(TypeEnum?), string updatedBy = default(string), DateTime updatedOn = default(DateTime))
        {
        ...
        {
            return this.Equals(input as GETAccountingCodeItemTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETAccountingCodeItemTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountingCodeItemTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountingCodeItemTypeAllOf input)
        {
            if (input == null)
            {
                return false;
