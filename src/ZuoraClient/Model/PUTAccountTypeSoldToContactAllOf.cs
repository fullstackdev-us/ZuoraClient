...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PUTAccountTypeSoldToContact_allOf")]
    public partial class PUTAccountTypeSoldToContactAllOf : IEquatable<PUTAccountTypeSoldToContactAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTAccountTypeSoldToContactAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PUTAccountTypeSoldToContactAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTAccountTypeSoldToContactAllOf" /> class.
        /// </summary>
        ...
        public PUTAccountTypeSoldToContactAllOf(string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickname = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string), string zipCode = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for PUTAccountTypeSoldToContactAllOf and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for PUTAccountTypeSoldToContactAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as PUTAccountTypeSoldToContactAllOf);
        }

        /// <summary>
        /// Returns true if PUTAccountTypeSoldToContactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTAccountTypeSoldToContactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTAccountTypeSoldToContactAllOf input)
        {
            if (input == null)
            {
                return false;
