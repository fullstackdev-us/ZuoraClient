...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PUTSubscriptionResponseType")]
    public partial class PUTSubscriptionResponseType : IEquatable<PUTSubscriptionResponseType>, IValidatableObject
    {
        ...
        /// <param name="targetDate">Date through which to calculate charges if an invoice is generated, as yyyy-mm-dd. Default is current date.  **Note:** This field is only available if you set the Zuora REST API minor version to 207.0 or later in the request header. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information. .</param>
        ...
        public PUTSubscriptionResponseType(decimal amount = default(decimal), decimal amountWithoutTax = default(decimal), PUTSubscriptionResponseTypeChargeMetrics chargeMetrics = default(PUTSubscriptionResponseTypeChargeMetrics), PUTSubscriptionResponseTypeCreditMemo creditMemo = default(PUTSubscriptionResponseTypeCreditMemo), string creditMemoId = default(string), PUTSubscriptionResponseTypeInvoice invoice = default(PUTSubscriptionResponseTypeInvoice), string invoiceId = default(string), List<PUTSubscriptionPreviewInvoiceItemsType> invoiceItems = default(List<PUTSubscriptionPreviewInvoiceItemsType>), DateTime invoiceTargetDate = default(DateTime), decimal paidAmount = default(decimal), string paymentId = default(string), string subscriptionId = default(string), bool success = default(bool), DateTime targetDate = default(DateTime), decimal taxAmount = default(decimal), decimal totalDeltaMrr = default(decimal), decimal totalDeltaTcv = default(decimal))
        {
            this.Amount = amount;
        ...
        /// <summary>
        /// Gets or Sets CreditMemo
        /// </summary>
        [DataMember(Name = "creditMemo", EmitDefaultValue = false)]
        public PUTSubscriptionResponseTypeCreditMemo CreditMemo { get; set; }
        ...
        public PUTSubscriptionResponseTypeInvoice Invoice { get; set; }
        ...
        /// </summary>
        /// <value>Date through which charges are calculated on the invoice, as yyyy-mm-dd. Preview mode only.  **Note:** This field is only available if you do not specify the Zuora REST API minor version or specify the minor version to 186.0, 187.0, 188.0, 189.0, and 196.0. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information. </value>
        ...
        public decimal TotalDeltaTcv { get; set; }
        ...
        {
            return this.Equals(input as PUTSubscriptionResponseType);
        }

        /// <summary>
        /// Returns true if PUTSubscriptionResponseType instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTSubscriptionResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSubscriptionResponseType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ChargeMetrics == input.ChargeMetrics ||
                    (this.ChargeMetrics != null &&
                    this.ChargeMetrics.Equals(input.ChargeMetrics))
                ) && 
                (
                    this.CreditMemo == input.CreditMemo ||
                    (this.CreditMemo != null &&
                    this.CreditMemo.Equals(input.CreditMemo))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ChargeMetrics.GetHashCode();
                }
                if (this.CreditMemo != null)
                {
                    hashCode = (hashCode * 59) + this.CreditMemo.GetHashCode();
                }
