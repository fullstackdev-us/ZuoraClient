...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetBillRun
    /// </summary>
    [DataContract(Name = "ProxyGetBillRun")]
    public partial class ProxyGetBillRun : IEquatable<ProxyGetBillRun>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetBillRun" /> class.
        /// </summary>
        /// <param name="accountId">ID of the account used for single account bill run.  **Character limit:** 32 .</param>
        /// <param name="autoEmail">Determines whether to auto send email or not once the bill run completes.  **Note:** You must enable the [Support Bill Run Auto-Post Billing](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Billing_Rules) rule to pass this field. .</param>
        /// <param name="autoPost">Determines whether to auto post bill run or not once the bill run completes.  **Note:** You must enable the [Support Bill Run Auto-Post Billing](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Billing_Rules) rule to pass this field. .</param>
        /// <param name="autoRenewal">Determines whether to auto renew subscription or not by this bill run once the bill run completes. .</param>
        /// <param name="batch">Batch of accounts for this bill run.   **Character limit:** 20  **Values:** AllBatches or Batchn where n is a number between 1 and 50. .</param>
        /// <param name="batches">The specific batches of customer accounts to be included in the bill run.   **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;102&#x60; or later. Otherwise, an error occurs.  **Character limit:** 20  **Values:** &#x60;AllBatches&#x60;, &#x60;Batch&#x60;*n* or an array of &#x60;Batch&#x60;*n* where *n* is a number between 1 and 50 .</param>
        /// <param name="billCycleDay">The day of the bill cycle.  **Character limit:** 32  **Values:** &#x60;AllBillCycleDays&#x60; or 01 - 31. .</param>
        /// <param name="billRunNumber">Number of the bill run.  **Character limit:** 50  **Values:** automatically generated .</param>
        /// <param name="createdById">The user ID of the person who created the bill run.  **Character limit:** 32  **Values:** automatically generated          .</param>
        /// <param name="createdDate">The date and time when the bill run was created.  **Character limit:** 29  **Values:** automatically generated            .</param>
        /// <param name="executedDate">The date and time when the bill run was executed. .</param>
        /// <param name="id">ID of the object.  **Character limit:** 32  **Values:** automatically generated .</param>
        /// <param name="invoiceDate">Invoice date for this bill run.  **Character limit:** 29 .</param>
        /// <param name="invoicesEmailed">Indicates whether the invoice has been sent or not.   **Values:** automatically generated            .</param>
        /// <param name="lastEmailSentTime">The last time emails were sent for this bill run.  **Character limit:** 29  **Values:** automatically generated .</param>
        /// <param name="noEmailForZeroAmountInvoice">Determines whether to suppress email for invoices with zero total or not for this bill run once the bill run completes. (Do not email invoices with 0 Invoice Total). .</param>
        /// <param name="numberOfAccounts">The number of accounts processed by this bill run.  **Values:** automatically generated .</param>
        /// <param name="numberOfInvoices">The number of invoices generated by this  run.  **Values:** automatically generated .</param>
        /// <param name="status">The status  for this bill run. See [Status Types](https://knowledgecenter.zuora.com/CB_Billing/J_Billing_Operations/G_Bill_Runs#Status_Types) for more information.  **Character limit:** 20  **Values:**     * &#x60;Pending&#x60;   * &#x60;Processing&#x60;   * &#x60;Completed&#x60;   * &#x60;Error&#x60;   * &#x60;Canceled&#x60;   * &#x60;Posted&#x60; .</param>
        /// <param name="targetDate">Target date for this bill run. See [Create Bill Run](https://knowledgecenter.zuora.com/CB_Billing/J_Billing_Operations/G_Bill_Runs/Creating_Bill_Runs) for more information.  **Character limit:** 29 .</param>
        /// <param name="updatedById">The user ID of the person who last updated the bill run.  **Character limit:** 32  **Values:** automatically generated          .</param>
        /// <param name="updatedDate">The date and time when the bill run was last updated.  **Character limit:** 29  **Values:** automatically generated  .</param>
        public ProxyGetBillRun(string accountId = default(string), bool autoEmail = default(bool), bool autoPost = default(bool), bool autoRenewal = default(bool), string batch = default(string), string batches = default(string), string billCycleDay = default(string), string billRunNumber = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), DateTime executedDate = default(DateTime), string id = default(string), DateTime invoiceDate = default(DateTime), bool invoicesEmailed = default(bool), DateTime lastEmailSentTime = default(DateTime), bool noEmailForZeroAmountInvoice = default(bool), long numberOfAccounts = default(long), long numberOfInvoices = default(long), string status = default(string), DateTime targetDate = default(DateTime), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>ID of the account used for single account bill run.  **Character limit:** 32 </value>
        ...
        /// </summary>
        /// <value>Determines whether to auto send email or not once the bill run completes.  **Note:** You must enable the [Support Bill Run Auto-Post Billing](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Billing_Rules) rule to pass this field. </value>
        [DataMember(Name = "AutoEmail", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Determines whether to auto post bill run or not once the bill run completes.  **Note:** You must enable the [Support Bill Run Auto-Post Billing](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Billing_Rules) rule to pass this field. </value>
        [DataMember(Name = "AutoPost", EmitDefaultValue = true)]
        public bool AutoPost { get; set; }

        /// <summary>
        /// Determines whether to auto renew subscription or not by this bill run once the bill run completes. 
        /// </summary>
        /// <value>Determines whether to auto renew subscription or not by this bill run once the bill run completes. </value>
        ...
        /// </summary>
        /// <value>Batch of accounts for this bill run.   **Character limit:** 20  **Values:** AllBatches or Batchn where n is a number between 1 and 50. </value>
        [DataMember(Name = "Batch", EmitDefaultValue = false)]
        public string Batch { get; set; }

        /// <summary>
        /// The specific batches of customer accounts to be included in the bill run.   **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;102&#x60; or later. Otherwise, an error occurs.  **Character limit:** 20  **Values:** &#x60;AllBatches&#x60;, &#x60;Batch&#x60;*n* or an array of &#x60;Batch&#x60;*n* where *n* is a number between 1 and 50 
        /// </summary>
        /// <value>The specific batches of customer accounts to be included in the bill run.   **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;102&#x60; or later. Otherwise, an error occurs.  **Character limit:** 20  **Values:** &#x60;AllBatches&#x60;, &#x60;Batch&#x60;*n* or an array of &#x60;Batch&#x60;*n* where *n* is a number between 1 and 50 </value>
        ...
        /// </summary>
        /// <value>The day of the bill cycle.  **Character limit:** 32  **Values:** &#x60;AllBillCycleDays&#x60; or 01 - 31. </value>
        ...
        /// </summary>
        /// <value>Number of the bill run.  **Character limit:** 50  **Values:** automatically generated </value>
        [DataMember(Name = "BillRunNumber", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The user ID of the person who created the bill run.  **Character limit:** 32  **Values:** automatically generated          </value>
        ...
        /// </summary>
        /// <value>The date and time when the bill run was created.  **Character limit:** 29  **Values:** automatically generated            </value>
        ...
        /// </summary>
        /// <value>The date and time when the bill run was executed. </value>
        [DataMember(Name = "ExecutedDate", EmitDefaultValue = false)]
        public DateTime ExecutedDate { get; set; }

        /// <summary>
        /// ID of the object.  **Character limit:** 32  **Values:** automatically generated 
        /// </summary>
        /// <value>ID of the object.  **Character limit:** 32  **Values:** automatically generated </value>
        ...
        /// </summary>
        /// <value>Invoice date for this bill run.  **Character limit:** 29 </value>
        ...
        /// </summary>
        /// <value>Indicates whether the invoice has been sent or not.   **Values:** automatically generated            </value>
        [DataMember(Name = "InvoicesEmailed", EmitDefaultValue = true)]
        public bool InvoicesEmailed { get; set; }

        /// <summary>
        /// The last time emails were sent for this bill run.  **Character limit:** 29  **Values:** automatically generated 
        /// </summary>
        /// <value>The last time emails were sent for this bill run.  **Character limit:** 29  **Values:** automatically generated </value>
        [DataMember(Name = "LastEmailSentTime", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Determines whether to suppress email for invoices with zero total or not for this bill run once the bill run completes. (Do not email invoices with 0 Invoice Total). </value>
        [DataMember(Name = "NoEmailForZeroAmountInvoice", EmitDefaultValue = true)]
        public bool NoEmailForZeroAmountInvoice { get; set; }

        /// <summary>
        /// The number of accounts processed by this bill run.  **Values:** automatically generated 
        /// </summary>
        /// <value>The number of accounts processed by this bill run.  **Values:** automatically generated </value>
        ...
        /// </summary>
        /// <value>The number of invoices generated by this  run.  **Values:** automatically generated </value>
        [DataMember(Name = "NumberOfInvoices", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The status  for this bill run. See [Status Types](https://knowledgecenter.zuora.com/CB_Billing/J_Billing_Operations/G_Bill_Runs#Status_Types) for more information.  **Character limit:** 20  **Values:**     * &#x60;Pending&#x60;   * &#x60;Processing&#x60;   * &#x60;Completed&#x60;   * &#x60;Error&#x60;   * &#x60;Canceled&#x60;   * &#x60;Posted&#x60; </value>
        ...
        /// </summary>
        /// <value>Target date for this bill run. See [Create Bill Run](https://knowledgecenter.zuora.com/CB_Billing/J_Billing_Operations/G_Bill_Runs/Creating_Bill_Runs) for more information.  **Character limit:** 29 </value>
        ...
        /// </summary>
        /// <value>The user ID of the person who last updated the bill run.  **Character limit:** 32  **Values:** automatically generated          </value>
        ...
        /// </summary>
        /// <value>The date and time when the bill run was last updated.  **Character limit:** 29  **Values:** automatically generated  </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetBillRun {\n");
            sb.Append("  AccountId: ").Append(AccountId).Append("\n");
            sb.Append("  AutoEmail: ").Append(AutoEmail).Append("\n");
            sb.Append("  AutoPost: ").Append(AutoPost).Append("\n");
            ...
            sb.Append("  ExecutedDate: ").Append(ExecutedDate).Append("\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  InvoiceDate: ").Append(InvoiceDate).Append("\n");
            sb.Append("  InvoicesEmailed: ").Append(InvoicesEmailed).Append("\n");
            sb.Append("  LastEmailSentTime: ").Append(LastEmailSentTime).Append("\n");
            sb.Append("  NoEmailForZeroAmountInvoice: ").Append(NoEmailForZeroAmountInvoice).Append("\n");
        ...
        {
            return this.Equals(input as ProxyGetBillRun);
        }

        /// <summary>
        /// Returns true if ProxyGetBillRun instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetBillRun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetBillRun input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AutoEmail == input.AutoEmail ||
                    this.AutoEmail.Equals(input.AutoEmail)
                ) && 
                (
                    this.AutoPost == input.AutoPost ||
                    this.AutoPost.Equals(input.AutoPost)
                ) && 
                (
                ...
                (
                    this.BillRunNumber == input.BillRunNumber ||
                    (this.BillRunNumber != null &&
                    this.BillRunNumber.Equals(input.BillRunNumber))
                ) && 
                (
                ...
                (
                    this.ExecutedDate == input.ExecutedDate ||
                    (this.ExecutedDate != null &&
                    this.ExecutedDate.Equals(input.ExecutedDate))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
                ...
                (
                    this.InvoicesEmailed == input.InvoicesEmailed ||
                    this.InvoicesEmailed.Equals(input.InvoicesEmailed)
                ) && 
                (
                    this.LastEmailSentTime == input.LastEmailSentTime ||
                    (this.LastEmailSentTime != null &&
                    this.LastEmailSentTime.Equals(input.LastEmailSentTime))
                ) && 
                (
                    this.NoEmailForZeroAmountInvoice == input.NoEmailForZeroAmountInvoice ||
                    this.NoEmailForZeroAmountInvoice.Equals(input.NoEmailForZeroAmountInvoice)
                ) && 
                (
                    this.NumberOfAccounts == input.NumberOfAccounts ||
                    this.NumberOfAccounts.Equals(input.NumberOfAccounts)
                ) && 
                (
                    this.NumberOfInvoices == input.NumberOfInvoices ||
                    this.NumberOfInvoices.Equals(input.NumberOfInvoices)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AutoEmail.GetHashCode();
                hashCode = (hashCode * 59) + this.AutoPost.GetHashCode();
                ...
                if (this.BillRunNumber != null)
                {
                    hashCode = (hashCode * 59) + this.BillRunNumber.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.ExecutedDate.GetHashCode();
                }
                if (this.Id != null)
                {
                ...
                hashCode = (hashCode * 59) + this.InvoicesEmailed.GetHashCode();
                if (this.LastEmailSentTime != null)
                {
                    hashCode = (hashCode * 59) + this.LastEmailSentTime.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.NoEmailForZeroAmountInvoice.GetHashCode();
                hashCode = (hashCode * 59) + this.NumberOfAccounts.GetHashCode();
                hashCode = (hashCode * 59) + this.NumberOfInvoices.GetHashCode();
                if (this.Status != null)
                {
