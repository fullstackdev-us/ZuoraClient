...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTTaxationItemForDMType_allOf")]
    public partial class POSTTaxationItemForDMTypeAllOf : IEquatable<POSTTaxationItemForDMTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// The type of the tax rate applied to the debit memo. 
        /// </summary>
        /// <value>The type of the tax rate applied to the debit memo. </value>
        ...
        /// </summary>
        /// <value>The type of the tax rate applied to the debit memo. </value>
        [DataMember(Name = "taxRateType", IsRequired = true, EmitDefaultValue = false)]
        public TaxRateTypeEnum TaxRateType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTTaxationItemForDMTypeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTTaxationItemForDMTypeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTTaxationItemForDMTypeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="jurisdiction">The jurisdiction that applies the tax or VAT. This value is typically a state, province, county, or city.  (required).</param>
        /// <param name="locationCode">The identifier for the location based on the value of the &#x60;taxCode&#x60; field. .</param>
        /// <param name="memoItemId">The ID of the debit memo that the taxation item is created for. .</param>
        /// <param name="name">The name of the taxation item.  (required).</param>
        /// <param name="sourceTaxItemId">The ID of the taxation item of the invoice, which the debit memo is created from.   If you want to use this REST API to create taxation items for a debit memo created from an invoice, the taxation items of the invoice must be created or imported through the SOAP API call.  **Note:**    - This field is only used if the debit memo is created from an invoice.    - If you do not contain this field in the request body, Zuora will automatically set a value for the &#x60;sourceTaxItemId&#x60; field based on the tax location code, tax jurisdiction, and tax rate. .</param>
        /// <param name="taxAmount">The amount of the tax applied to the debit memo.  (required).</param>
        /// <param name="taxCode">The tax code identifies which tax rules and tax rates to apply to a specific debit memo. .</param>
        /// <param name="taxCodeDescription">The description of the tax code. .</param>
        /// <param name="taxDate">The date when the tax is applied to the debit memo. .</param>
        /// <param name="taxRate">The tax rate applied to the debit memo.  (required).</param>
        /// <param name="taxRateDescription">The description of the tax rate. .</param>
        /// <param name="taxRateType">The type of the tax rate applied to the debit memo.  (required).</param>
        public POSTTaxationItemForDMTypeAllOf(double exemptAmount = default(double), POSTTaxationItemForDMTypeAllOfFinanceInformation financeInformation = default(POSTTaxationItemForDMTypeAllOfFinanceInformation), string jurisdiction = default(string), string locationCode = default(string), string memoItemId = default(string), string name = default(string), string sourceTaxItemId = default(string), double taxAmount = default(double), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), double taxRate = default(double), string taxRateDescription = default(string), TaxRateTypeEnum taxRateType = default(TaxRateTypeEnum))
        {
            // to ensure "jurisdiction" is required (not null)
            if (jurisdiction == null)
            {
                throw new ArgumentNullException("jurisdiction is a required property for POSTTaxationItemForDMTypeAllOf and cannot be null");
            }
            this.Jurisdiction = jurisdiction;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for POSTTaxationItemForDMTypeAllOf and cannot be null");
            }
            this.Name = name;
        ...
        public POSTTaxationItemForDMTypeAllOfFinanceInformation FinanceInformation { get; set; }
        ...
        /// </summary>
        /// <value>The ID of the debit memo that the taxation item is created for. </value>
        ...
        /// </summary>
        /// <value>The ID of the taxation item of the invoice, which the debit memo is created from.   If you want to use this REST API to create taxation items for a debit memo created from an invoice, the taxation items of the invoice must be created or imported through the SOAP API call.  **Note:**    - This field is only used if the debit memo is created from an invoice.    - If you do not contain this field in the request body, Zuora will automatically set a value for the &#x60;sourceTaxItemId&#x60; field based on the tax location code, tax jurisdiction, and tax rate. </value>
        ...
        /// </summary>
        /// <value>The amount of the tax applied to the debit memo. </value>
        [DataMember(Name = "taxAmount", IsRequired = true, EmitDefaultValue = false)]
        public double TaxAmount { get; set; }

        /// <summary>
        /// The tax code identifies which tax rules and tax rates to apply to a specific debit memo. 
        /// </summary>
        /// <value>The tax code identifies which tax rules and tax rates to apply to a specific debit memo. </value>
        ...
        /// </summary>
        /// <value>The date when the tax is applied to the debit memo. </value>
        ...
        /// </summary>
        /// <value>The tax rate applied to the debit memo. </value>
        ...
        {
            return this.Equals(input as POSTTaxationItemForDMTypeAllOf);
        }

        /// <summary>
        /// Returns true if POSTTaxationItemForDMTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTTaxationItemForDMTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTTaxationItemForDMTypeAllOf input)
        {
            if (input == null)
            {
                return false;
