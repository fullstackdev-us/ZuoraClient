...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentScheduleItemCommonResponse_allOf")]
    public partial class PaymentScheduleItemCommonResponseAllOf : IEquatable<PaymentScheduleItemCommonResponseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>ID of the payment method of the payment schedule item.  - &#x60;Pending&#x60;: Payment schedule item is waiting for processing. - &#x60;Processed&#x60;: The payment has been collected. - &#x60;Error&#x60;: Failed to collect the payment. - &#x60;Canceled&#x60;: After a pending payment schedule item is canceled by the user, the item is marked as &#x60;Canceled&#x60;. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentScheduleItemCommonResponseAllOf" /> class.
        /// </summary>
        /// <param name="accountId">ID of the customer account that owns the payment schedule item, for example &#x60;402880e741112b310149b7343ef81234&#x60;. .</param>
        /// <param name="amount">The amount of the payment. .</param>
        /// <param name="billingDocument">billingDocument.</param>
        /// <param name="createdById">The ID of the user who created the payment schedule item. .</param>
        /// <param name="createdDate">The date and time when the payment schedule item was created. .</param>
        /// <param name="currency">The currency of the payment. .</param>
        /// <param name="description">The description of the payment schedule item. .</param>
        /// <param name="errorMessage">The error message indicating if the error is related to configuration or payment collection. .</param>
        /// <param name="id">ID of the payment schedule item. For example, &#x60;412880e749b72b310149b7343ef81346&#x60;. .</param>
        /// <param name="number">Number of the payment schedule item. .</param>
        /// <param name="paymentGatewayId">ID of the payment gateway of the payment schedule item. .</param>
        /// <param name="paymentId">ID of the payment that is created by the payment schedule item， or linked to the payment schedule item.  .</param>
        /// <param name="paymentMethodId">ID of the payment method of the payment schedule item. .</param>
        /// <param name="paymentScheduleId">ID of the payment schedule that contains the payment schedule item, for example, &#x60;ID402880e749b72b310149b7343ef80005&#x60;. .</param>
        /// <param name="paymentScheduleNumber">Number of the payment schedule that contains the payment schedule item, for example, &#x60;ID402880e749b72b310149b7343ef80005&#x60;. .</param>
        /// <param name="runHour">At which hour in the day in the tenant’s timezone this payment will be collected. .</param>
        /// <param name="scheduledDate">The scheduled date when the payment is processed. .</param>
        /// <param name="standalone">Indicates if the payment created by the payment schedule item is a standalone payment or not. .</param>
        /// <param name="status">ID of the payment method of the payment schedule item.  - &#x60;Pending&#x60;: Payment schedule item is waiting for processing. - &#x60;Processed&#x60;: The payment has been collected. - &#x60;Error&#x60;: Failed to collect the payment. - &#x60;Canceled&#x60;: After a pending payment schedule item is canceled by the user, the item is marked as &#x60;Canceled&#x60;. .</param>
        /// <param name="updatedById">The ID of the user who updated the payment schedule item. .</param>
        /// <param name="updatedDate">The date and time when the payment schedule item was last updated. .</param>
        public PaymentScheduleItemCommonResponseAllOf(string accountId = default(string), decimal amount = default(decimal), POSTPaymentScheduleResponseAllOfBillingDocument billingDocument = default(POSTPaymentScheduleResponseAllOfBillingDocument), string createdById = default(string), DateTime createdDate = default(DateTime), string currency = default(string), string description = default(string), string errorMessage = default(string), string id = default(string), string number = default(string), string paymentGatewayId = default(string), string paymentId = default(string), string paymentMethodId = default(string), string paymentScheduleId = default(string), string paymentScheduleNumber = default(string), int runHour = default(int), DateTime scheduledDate = default(DateTime), bool standalone = default(bool), StatusEnum? status = default(StatusEnum?), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>ID of the customer account that owns the payment schedule item, for example &#x60;402880e741112b310149b7343ef81234&#x60;. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment schedule item was created. </value>
        ...
        /// </summary>
        /// <value>The description of the payment schedule item. </value>
        ...
        /// </summary>
        /// <value>The error message indicating if the error is related to configuration or payment collection. </value>
        ...
        /// </summary>
        /// <value>ID of the payment schedule item. For example, &#x60;412880e749b72b310149b7343ef81346&#x60;. </value>
        ...
        /// </summary>
        /// <value>ID of the payment gateway of the payment schedule item. </value>
        ...
        /// </summary>
        /// <value>ID of the payment that is created by the payment schedule item， or linked to the payment schedule item.  </value>
        ...
        /// </summary>
        /// <value>ID of the payment method of the payment schedule item. </value>
        ...
        /// </summary>
        /// <value>ID of the payment schedule that contains the payment schedule item, for example, &#x60;ID402880e749b72b310149b7343ef80005&#x60;. </value>
        [DataMember(Name = "paymentScheduleId", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Number of the payment schedule that contains the payment schedule item, for example, &#x60;ID402880e749b72b310149b7343ef80005&#x60;. </value>
        ...
        /// </summary>
        /// <value>At which hour in the day in the tenant’s timezone this payment will be collected. </value>
        ...
        /// </summary>
        /// <value>The scheduled date when the payment is processed. </value>
        ...
        /// </summary>
        /// <value>Indicates if the payment created by the payment schedule item is a standalone payment or not. </value>
        ...
        /// </summary>
        /// <value>The ID of the user who updated the payment schedule item. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment schedule item was last updated. </value>
        ...
        {
            return this.Equals(input as PaymentScheduleItemCommonResponseAllOf);
        }

        /// <summary>
        /// Returns true if PaymentScheduleItemCommonResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentScheduleItemCommonResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentScheduleItemCommonResponseAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PaymentScheduleId == input.PaymentScheduleId ||
                    (this.PaymentScheduleId != null &&
                    this.PaymentScheduleId.Equals(input.PaymentScheduleId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.PaymentScheduleId.GetHashCode();
                }
