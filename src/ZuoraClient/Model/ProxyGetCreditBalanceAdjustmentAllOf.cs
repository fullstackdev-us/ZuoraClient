...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetCreditBalanceAdjustment_allOf")]
    public partial class ProxyGetCreditBalanceAdjustmentAllOf : IEquatable<ProxyGetCreditBalanceAdjustmentAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetCreditBalanceAdjustmentAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetCreditBalanceAdjustmentAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetCreditBalanceAdjustmentAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetCreditBalanceAdjustmentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetCreditBalanceAdjustmentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetCreditBalanceAdjustmentAllOf input)
        {
            if (input == null)
            {
                return false;
