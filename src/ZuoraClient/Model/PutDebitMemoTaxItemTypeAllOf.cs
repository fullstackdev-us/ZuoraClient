...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PutDebitMemoTaxItemType_allOf")]
    public partial class PutDebitMemoTaxItemTypeAllOf : IEquatable<PutDebitMemoTaxItemTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutDebitMemoTaxItemTypeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutDebitMemoTaxItemTypeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutDebitMemoTaxItemTypeAllOf" /> class.
        /// </summary>
        /// <param name="amount">The amount of the taxation item in the debit memo item. .</param>
        /// <param name="financeInformation">financeInformation.</param>
        /// <param name="id">The ID of the taxation item in the debit memo item.  (required).</param>
        ...
        /// <param name="taxRateType">The type of the tax rate applied to the debit memo. .</param>
        public PutDebitMemoTaxItemTypeAllOf(double amount = default(double), PutDebitMemoTaxItemTypeAllOfFinanceInformation financeInformation = default(PutDebitMemoTaxItemTypeAllOfFinanceInformation), string id = default(string), string jurisdiction = default(string), string locationCode = default(string), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), double taxExemptAmount = default(double), string taxName = default(string), double taxRate = default(double), string taxRateDescription = default(string), TaxRateTypeEnum? taxRateType = default(TaxRateTypeEnum?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PutDebitMemoTaxItemTypeAllOf and cannot be null");
            }
            this.Id = id;
            this.Amount = amount;
        ...
        /// </summary>
        /// <value>The amount of the taxation item in the debit memo item. </value>
        ...
        public PutDebitMemoTaxItemTypeAllOfFinanceInformation FinanceInformation { get; set; }

        /// <summary>
        /// The ID of the taxation item in the debit memo item. 
        /// </summary>
        /// <value>The ID of the taxation item in the debit memo item. </value>
        ...
        {
            return this.Equals(input as PutDebitMemoTaxItemTypeAllOf);
        }

        /// <summary>
        /// Returns true if PutDebitMemoTaxItemTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutDebitMemoTaxItemTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutDebitMemoTaxItemTypeAllOf input)
        {
            if (input == null)
            {
                return false;
