...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountTypeSoldToContact_allOf")]
    public partial class GETAccountTypeSoldToContactAllOf : IEquatable<GETAccountTypeSoldToContactAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountTypeSoldToContactAllOf" /> class.
        /// </summary>
        ...
        /// <param name="country">Full country name. This field does not contain the ISO-standard abbreviation of the country name. .</param>
        /// <param name="county">County; 32 characters or less. Zuora tax uses this information to calculate county taxation.          .</param>
        ...
        /// <param name="id">ID of the person who bought the subscription associated with the account, 32 characters or less..</param>
        ...
        /// <param name="state">Full state name. This field does not contain the ISO-standard abbreviation of the state name. .</param>
        /// <param name="taxRegion">A region string, defined in your Zuora tax rules. .</param>
        ...
        public GETAccountTypeSoldToContactAllOf(string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string id = default(string), string lastName = default(string), string mobilePhone = default(string), string nickname = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string), string zipCode = default(string))
        {
        ...
        /// </summary>
        /// <value>Full country name. This field does not contain the ISO-standard abbreviation of the country name. </value>
        ...
        /// </summary>
        /// <value>County; 32 characters or less. Zuora tax uses this information to calculate county taxation.          </value>
        ...
        /// </summary>
        /// <value>ID of the person who bought the subscription associated with the account, 32 characters or less.</value>
        ...
        /// </summary>
        /// <value>Full state name. This field does not contain the ISO-standard abbreviation of the state name. </value>
        ...
        /// </summary>
        /// <value>A region string, defined in your Zuora tax rules. </value>
        ...
        {
            return this.Equals(input as GETAccountTypeSoldToContactAllOf);
        }

        /// <summary>
        /// Returns true if GETAccountTypeSoldToContactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountTypeSoldToContactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountTypeSoldToContactAllOf input)
        {
            if (input == null)
            {
                return false;
