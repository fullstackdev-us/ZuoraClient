...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscribeRequestSoldToContact_allOf")]
    public partial class SubscribeRequestSoldToContactAllOf : IEquatable<SubscribeRequestSoldToContactAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeRequestSoldToContactAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubscribeRequestSoldToContactAllOf {\n");
        ...
        {
            return this.Equals(input as SubscribeRequestSoldToContactAllOf);
        }

        /// <summary>
        /// Returns true if SubscribeRequestSoldToContactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribeRequestSoldToContactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribeRequestSoldToContactAllOf input)
        {
            if (input == null)
            {
                return false;
