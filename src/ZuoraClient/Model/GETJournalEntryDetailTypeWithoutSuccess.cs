...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETJournalEntryDetailTypeWithoutSuccess")]
    public partial class GETJournalEntryDetailTypeWithoutSuccess : IEquatable<GETJournalEntryDetailTypeWithoutSuccess>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETJournalEntryDetailTypeWithoutSuccess);
        }

        /// <summary>
        /// Returns true if GETJournalEntryDetailTypeWithoutSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of GETJournalEntryDetailTypeWithoutSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETJournalEntryDetailTypeWithoutSuccess input)
        {
            if (input == null)
            {
                return false;
