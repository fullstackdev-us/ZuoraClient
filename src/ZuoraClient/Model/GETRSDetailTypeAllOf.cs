...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRSDetailType_allOf")]
    public partial class GETRSDetailTypeAllOf : IEquatable<GETRSDetailTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRSDetailTypeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="linkedTransactionNumber">The number for the linked invoice item or invoice item adjustment transaction. This field is used for all rules except for the custom unlimited or manual recognition rule models. If using the custom unlimited or manual recognition rule models, then the field value is null. .</param>
        /// <param name="linkedTransactionType">The type of linked transaction for billing transactions, which can be invoice item or invoice item adjustment. This field is used for all rules except for the custom unlimited or manual recognition rule models. .</param>
        ...
        /// <param name="updatedOn">The date and time when the revenue automation start date was set, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; formst. .</param>
        public GETRSDetailTypeAllOf(string accountId = default(string), decimal amount = default(decimal), DateTime createdOn = default(DateTime), string currency = default(string), string linkedTransactionId = default(string), string linkedTransactionNumber = default(string), string linkedTransactionType = default(string), string notes = default(string), string number = default(string), string recognitionRuleName = default(string), decimal recognizedRevenue = default(decimal), string referenceId = default(string), List<GETRsRevenueItemType> revenueItems = default(List<GETRsRevenueItemType>), DateTime revenueScheduleDate = default(DateTime), string subscriptionChargeId = default(string), string subscriptionId = default(string), bool success = default(bool), decimal undistributedUnrecognizedRevenue = default(decimal), decimal unrecognizedRevenue = default(decimal), DateTime updatedOn = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The number for the linked invoice item or invoice item adjustment transaction. This field is used for all rules except for the custom unlimited or manual recognition rule models. If using the custom unlimited or manual recognition rule models, then the field value is null. </value>
        ...
        /// </summary>
        /// <value>The type of linked transaction for billing transactions, which can be invoice item or invoice item adjustment. This field is used for all rules except for the custom unlimited or manual recognition rule models. </value>
        ...
        public decimal UndistributedUnrecognizedRevenue { get; set; }
        ...
        /// </summary>
        /// <value>The date and time when the revenue automation start date was set, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; formst. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETRSDetailTypeAllOf {\n");
        ...
        {
            return this.Equals(input as GETRSDetailTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETRSDetailTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRSDetailTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRSDetailTypeAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SubscriptionChargeId == input.SubscriptionChargeId ||
                    (this.SubscriptionChargeId != null &&
                    this.SubscriptionChargeId.Equals(input.SubscriptionChargeId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SubscriptionChargeId.GetHashCode();
                }
