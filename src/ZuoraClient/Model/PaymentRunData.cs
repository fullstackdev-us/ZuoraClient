...
namespace ZuoraClient.Model
{
    ...
    /// PaymentRunData
    /// </summary>
    [DataContract(Name = "payment_run_data")]
    public partial class PaymentRunData : IEquatable<PaymentRunData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRunData" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PaymentRunData);
        }

        /// <summary>
        /// Returns true if PaymentRunData instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRunData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRunData input)
        {
            if (input == null)
            {
                return false;
