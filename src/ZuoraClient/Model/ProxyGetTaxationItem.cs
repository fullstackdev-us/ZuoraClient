...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetTaxationItem")]
    public partial class ProxyGetTaxationItem : IEquatable<ProxyGetTaxationItem>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyGetTaxationItem);
        }

        /// <summary>
        /// Returns true if ProxyGetTaxationItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetTaxationItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetTaxationItem input)
        {
            if (input == null)
            {
                return false;
