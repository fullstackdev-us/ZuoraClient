...
namespace ZuoraClient.Model
{
    ...
    /// GETPaymentType
    /// </summary>
    [DataContract(Name = "GETPaymentType")]
    public partial class GETPaymentType : IEquatable<GETPaymentType>, IValidatableObject
    {
        ...
        public GETPaymentType(string accountID = default(string), string accountName = default(string), string accountNumber = default(string), decimal amount = default(decimal), DateTime effectiveDate = default(DateTime), string gatewayTransactionNumber = default(string), string id = default(string), List<GETPaidInvoicesType> paidInvoices = default(List<GETPaidInvoicesType>), string paymentMethodID = default(string), string paymentNumber = default(string), string status = default(string), string type = default(string), string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string transactionNS = default(string))
        {
        ...
        {
            return this.Equals(input as GETPaymentType);
        }

        /// <summary>
        /// Returns true if GETPaymentType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETPaymentType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPaymentType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GatewayTransactionNumber == input.GatewayTransactionNumber ||
                    (this.GatewayTransactionNumber != null &&
                    this.GatewayTransactionNumber.Equals(input.GatewayTransactionNumber))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
                ...
                (
                    ...
                    input.PaidInvoices != null &&
                    this.PaidInvoices.SequenceEqual(input.PaidInvoices)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.GatewayTransactionNumber.GetHashCode();
                }
                if (this.Id != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + this.PaidInvoices.GetHashCode();
                }
