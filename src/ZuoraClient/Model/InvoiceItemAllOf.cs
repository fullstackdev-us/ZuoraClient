...
namespace ZuoraClient.Model
{
    ...
    /// InvoiceItemAllOf
    /// </summary>
    [DataContract(Name = "InvoiceItem_allOf")]
    public partial class InvoiceItemAllOf : IEquatable<InvoiceItemAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceItemAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InvoiceItemAllOf);
        }

        /// <summary>
        /// Returns true if InvoiceItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceItemAllOf input)
        {
            if (input == null)
            {
                return false;
