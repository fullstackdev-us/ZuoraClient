...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscribeRequestBillToContact")]
    public partial class SubscribeRequestBillToContact : IEquatable<SubscribeRequestBillToContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeRequestBillToContact" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubscribeRequestBillToContact() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeRequestBillToContact" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubscribeRequestBillToContact {\n");
        ...
        {
            return this.Equals(input as SubscribeRequestBillToContact);
        }

        /// <summary>
        /// Returns true if SubscribeRequestBillToContact instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribeRequestBillToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribeRequestBillToContact input)
        {
            if (input == null)
            {
                return false;
