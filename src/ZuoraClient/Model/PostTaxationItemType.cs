...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostTaxationItemType")]
    public partial class PostTaxationItemType : IEquatable<PostTaxationItemType>, IValidatableObject
    {
        /// <summary>
        /// The tax mode of the invoice item, indicating whether the amount of the invoice item includes tax. 
        /// </summary>
        /// <value>The tax mode of the invoice item, indicating whether the amount of the invoice item includes tax. </value>
        ...
        /// </summary>
        /// <value>The tax mode of the invoice item, indicating whether the amount of the invoice item includes tax. </value>
        [DataMember(Name = "taxMode", IsRequired = true, EmitDefaultValue = false)]
        public TaxModeEnum TaxMode { get; set; }
        /// <summary>
        /// The type of the tax rate applied to the invoice item. 
        /// </summary>
        /// <value>The type of the tax rate applied to the invoice item. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostTaxationItemType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostTaxationItemType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostTaxationItemType" /> class.
        /// </summary>
        ...
        /// <param name="name">The name of taxation.  (required).</param>
        /// <param name="taxAmount">The amount of the taxation item in the invoice item.  (required).</param>
        /// <param name="taxCode">The tax code identifies which tax rules and tax rates to apply to a specific invoice item.  (required).</param>
        /// <param name="taxCodeDescription">The description of the tax code. .</param>
        /// <param name="taxDate">The date that the tax is applied to the invoice item, in &#x60;yyyy-mm-dd&#x60; format.  (required).</param>
        /// <param name="taxMode">The tax mode of the invoice item, indicating whether the amount of the invoice item includes tax.  (required).</param>
        /// <param name="taxRate">The tax rate applied to the invoice item.  (required).</param>
        /// <param name="taxRateDescription">The description of the tax rate. .</param>
        /// <param name="taxRateType">The type of the tax rate applied to the invoice item.  (required).</param>
        public PostTaxationItemType(decimal exemptAmount = default(decimal), string jurisdiction = default(string), string locationCode = default(string), string name = default(string), decimal taxAmount = default(decimal), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), TaxModeEnum taxMode = default(TaxModeEnum), decimal taxRate = default(decimal), string taxRateDescription = default(string), TaxRateTypeEnum taxRateType = default(TaxRateTypeEnum))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PostTaxationItemType and cannot be null");
            }
            this.Name = name;
            ...
            if (taxCode == null)
            {
                throw new ArgumentNullException("taxCode is a required property for PostTaxationItemType and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The name of taxation. </value>
        ...
        /// </summary>
        /// <value>The amount of the taxation item in the invoice item. </value>
        ...
        /// </summary>
        /// <value>The tax code identifies which tax rules and tax rates to apply to a specific invoice item. </value>
        [DataMember(Name = "taxCode", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The date that the tax is applied to the invoice item, in &#x60;yyyy-mm-dd&#x60; format. </value>
        [DataMember(Name = "taxDate", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The tax rate applied to the invoice item. </value>
        ...
        {
            return this.Equals(input as PostTaxationItemType);
        }

        /// <summary>
        /// Returns true if PostTaxationItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of PostTaxationItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostTaxationItemType input)
        {
            if (input == null)
            {
                return false;
