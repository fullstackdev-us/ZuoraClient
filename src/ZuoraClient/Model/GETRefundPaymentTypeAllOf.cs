...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRefundPaymentType_allOf")]
    public partial class GETRefundPaymentTypeAllOf : IEquatable<GETRefundPaymentTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRefundPaymentTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETRefundPaymentTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETRefundPaymentTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRefundPaymentTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRefundPaymentTypeAllOf input)
        {
            if (input == null)
            {
                return false;
