...
namespace ZuoraClient.Model
{
    ...
    /// GETPaymentRunType
    /// </summary>
    [DataContract(Name = "GETPaymentRunType")]
    public partial class GETPaymentRunType : IEquatable<GETPaymentRunType>, IValidatableObject
    {
        /// <summary>
        /// The status of the created payment run. 
        /// </summary>
        /// <value>The status of the created payment run. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETPaymentRunType" /> class.
        /// </summary>
        /// <param name="accountId">The ID of the customer account associated with the payment run. .</param>
        /// <param name="applyCreditBalance">**Note:** This field is only available if you have the Credit Balance feature enabled and the Invoice Settlement feature disabled.  Whether to apply credit balances in the payment run. This field is only available when you have Invoice Settlement feature disabled. .</param>
        /// <param name="autoApplyCreditMemo">**Note:** This field is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Whether to automatically apply a posted credit memo to one or more receivables in the payment run. .</param>
        /// <param name="autoApplyUnappliedPayment">**Note:** This field is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Whether to automatically apply unapplied payments to  one or more receivables in the payment run. .</param>
        /// <param name="batch">The alias name given to a batch. .</param>
        /// <param name="billCycleDay">The billing cycle day (BCD), the day of the month when a bill run generates invoices for the account.  .</param>
        /// <param name="billingRunId">The ID of the bill run. .</param>
        /// <param name="collectPayment">Whether to process electronic payments during the execution of payment runs.  .</param>
        /// <param name="completedOn">The date and time when the payment run is completed, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 11:39:58. .</param>
        /// <param name="consolidatedPayment">**Note:** The **Process Electronic Payment** permission also needs to be allowed for a Manage Payment Runs role to work. See [Payments Roles](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/A_Administrator_Settings/User_Roles/e_Payments_Roles) for more information.   Whether to process a single payment for all receivables that are due on an account. .</param>
        /// <param name="createdById">The ID of the Zuora user who created the payment run. .</param>
        /// <param name="createdDate">The date and time when the payment run was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10. .</param>
        /// <param name="currency">A currency defined in the web-based UI administrative settings. .</param>
        /// <param name="executedOn">The date and time when the payment run is executed, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 11:30:37. .</param>
        /// <param name="id">The ID of the payment run. .</param>
        /// <param name="number">The identification number of the payment run. .</param>
        /// <param name="paymentGatewayId">The ID of the gateway instance that processes the payment. .</param>
        /// <param name="processPaymentWithClosedPM">**Note:** The **Process Electronic Payment** permission also needs to be allowed for a Manage Payment Runs role to work. See [Payments Roles](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/A_Administrator_Settings/User_Roles/e_Payments_Roles) for more information.   Whether to process payments even if the default payment method is closed. .</param>
        /// <param name="runDate">The date and time when the scheduled payment run is to be executed for collecting payments. .</param>
        /// <param name="status">The status of the created payment run. .</param>
        /// <param name="success">Returns &#x60;true&#x60; if the request was processed successfully. .</param>
        /// <param name="targetDate">The target date used to determine which receivables to be collected in the payment run.  .</param>
        /// <param name="updatedById">The ID of the Zuora user who last updated the payment run. .</param>
        /// <param name="updatedDate">The date and time when the payment run was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. .</param>
        public GETPaymentRunType(string accountId = default(string), bool applyCreditBalance = default(bool), bool autoApplyCreditMemo = default(bool), bool autoApplyUnappliedPayment = default(bool), string batch = default(string), string billCycleDay = default(string), Guid billingRunId = default(Guid), bool collectPayment = default(bool), DateTime completedOn = default(DateTime), bool consolidatedPayment = default(bool), string createdById = default(string), DateTime createdDate = default(DateTime), string currency = default(string), DateTime executedOn = default(DateTime), string id = default(string), string number = default(string), Guid paymentGatewayId = default(Guid), bool processPaymentWithClosedPM = default(bool), DateTime runDate = default(DateTime), StatusEnum? status = default(StatusEnum?), bool success = default(bool), DateTime targetDate = default(DateTime), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The ID of the customer account associated with the payment run. </value>
        ...
        /// </summary>
        /// <value>**Note:** This field is only available if you have the Credit Balance feature enabled and the Invoice Settlement feature disabled.  Whether to apply credit balances in the payment run. This field is only available when you have Invoice Settlement feature disabled. </value>
        ...
        /// </summary>
        /// <value>**Note:** This field is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Whether to automatically apply a posted credit memo to one or more receivables in the payment run. </value>
        [DataMember(Name = "autoApplyCreditMemo", EmitDefaultValue = true)]
        public bool AutoApplyCreditMemo { get; set; }

        /// <summary>
        /// **Note:** This field is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Whether to automatically apply unapplied payments to  one or more receivables in the payment run. 
        /// </summary>
        /// <value>**Note:** This field is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Whether to automatically apply unapplied payments to  one or more receivables in the payment run. </value>
        [DataMember(Name = "autoApplyUnappliedPayment", EmitDefaultValue = true)]
        public bool AutoApplyUnappliedPayment { get; set; }

        /// <summary>
        /// The alias name given to a batch. 
        /// </summary>
        /// <value>The alias name given to a batch. </value>
        ...
        /// </summary>
        /// <value>The billing cycle day (BCD), the day of the month when a bill run generates invoices for the account.  </value>
        ...
        /// </summary>
        /// <value>The ID of the bill run. </value>
        [DataMember(Name = "billingRunId", EmitDefaultValue = false)]
        public Guid BillingRunId { get; set; }

        /// <summary>
        /// Whether to process electronic payments during the execution of payment runs.  
        /// </summary>
        /// <value>Whether to process electronic payments during the execution of payment runs.  </value>
        [DataMember(Name = "collectPayment", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>The date and time when the payment run is completed, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 11:39:58. </value>
        ...
        /// </summary>
        /// <value>**Note:** The **Process Electronic Payment** permission also needs to be allowed for a Manage Payment Runs role to work. See [Payments Roles](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/A_Administrator_Settings/User_Roles/e_Payments_Roles) for more information.   Whether to process a single payment for all receivables that are due on an account. </value>
        [DataMember(Name = "consolidatedPayment", EmitDefaultValue = true)]
        public bool ConsolidatedPayment { get; set; }

        /// <summary>
        /// The ID of the Zuora user who created the payment run. 
        /// </summary>
        /// <value>The ID of the Zuora user who created the payment run. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment run was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment run is executed, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 11:30:37. </value>
        ...
        /// </summary>
        /// <value>The ID of the payment run. </value>
        ...
        /// </summary>
        /// <value>The identification number of the payment run. </value>
        ...
        [DataMember(Name = "paymentGatewayId", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>**Note:** The **Process Electronic Payment** permission also needs to be allowed for a Manage Payment Runs role to work. See [Payments Roles](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/A_Administrator_Settings/User_Roles/e_Payments_Roles) for more information.   Whether to process payments even if the default payment method is closed. </value>
        [DataMember(Name = "processPaymentWithClosedPM", EmitDefaultValue = true)]
        public bool ProcessPaymentWithClosedPM { get; set; }

        /// <summary>
        /// The date and time when the scheduled payment run is to be executed for collecting payments. 
        /// </summary>
        /// <value>The date and time when the scheduled payment run is to be executed for collecting payments. </value>
        ...
        /// </summary>
        /// <value>The target date used to determine which receivables to be collected in the payment run.  </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who last updated the payment run. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment run was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AutoApplyCreditMemo: ").Append(AutoApplyCreditMemo).Append("\n");
            sb.Append("  AutoApplyUnappliedPayment: ").Append(AutoApplyUnappliedPayment).Append("\n");
            sb.Append("  Batch: ").Append(Batch).Append("\n");
            sb.Append("  BillCycleDay: ").Append(BillCycleDay).Append("\n");
            sb.Append("  BillingRunId: ").Append(BillingRunId).Append("\n");
            ...
            sb.Append("  ProcessPaymentWithClosedPM: ").Append(ProcessPaymentWithClosedPM).Append("\n");
        ...
        {
            return this.Equals(input as GETPaymentRunType);
        }

        /// <summary>
        /// Returns true if GETPaymentRunType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETPaymentRunType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPaymentRunType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AutoApplyCreditMemo == input.AutoApplyCreditMemo ||
                    this.AutoApplyCreditMemo.Equals(input.AutoApplyCreditMemo)
                ) && 
                (
                    this.AutoApplyUnappliedPayment == input.AutoApplyUnappliedPayment ||
                    this.AutoApplyUnappliedPayment.Equals(input.AutoApplyUnappliedPayment)
                ) && 
                (
                ...
                (
                    this.BillingRunId == input.BillingRunId ||
                    (this.BillingRunId != null &&
                    this.BillingRunId.Equals(input.BillingRunId))
                ) && 
                (
                    this.CollectPayment == input.CollectPayment ||
                    this.CollectPayment.Equals(input.CollectPayment)
                ) && 
                (
                ...
                (
                    this.ConsolidatedPayment == input.ConsolidatedPayment ||
                    this.ConsolidatedPayment.Equals(input.ConsolidatedPayment)
                ) && 
                (
                ...
                (
                    this.ExecutedOn == input.ExecutedOn ||
                    (this.ExecutedOn != null &&
                    this.ExecutedOn.Equals(input.ExecutedOn))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
                ...
                (
                    this.ProcessPaymentWithClosedPM == input.ProcessPaymentWithClosedPM ||
                    this.ProcessPaymentWithClosedPM.Equals(input.ProcessPaymentWithClosedPM)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AutoApplyCreditMemo.GetHashCode();
                hashCode = (hashCode * 59) + this.AutoApplyUnappliedPayment.GetHashCode();
                if (this.Batch != null)
                {
                ...
                if (this.BillingRunId != null)
                {
                    hashCode = (hashCode * 59) + this.BillingRunId.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.CollectPayment.GetHashCode();
                if (this.CompletedOn != null)
                {
                    hashCode = (hashCode * 59) + this.CompletedOn.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.ConsolidatedPayment.GetHashCode();
                ...
                {
                    hashCode = (hashCode * 59) + this.ExecutedOn.GetHashCode();
                }
                if (this.Id != null)
                {
                ...
                hashCode = (hashCode * 59) + this.ProcessPaymentWithClosedPM.GetHashCode();
