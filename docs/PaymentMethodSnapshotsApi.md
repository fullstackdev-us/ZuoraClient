# ZuoraClient.Api.PaymentMethodSnapshotsApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**ObjectGETPaymentMethodSnapshot**](PaymentMethodSnapshotsApi.md#objectgetpaymentmethodsnapshot) | **GET** /v1/object/payment-method-snapshot/{id} | CRUD: Retrieve a payment method snapshot |

<a name="objectgetpaymentmethodsnapshot"></a>
# **ObjectGETPaymentMethodSnapshot**
> ProxyGetPaymentMethodSnapshot ObjectGETPaymentMethodSnapshot (string id, string authorization = null, string zuoraEntityIds = null, string zuoraTrackId = null, string fields = null)
...
namespace Example
{
    public class ObjectGETPaymentMethodSnapshotExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            config.BasePath = "https://rest.zuora.com";
            var apiInstance = new PaymentMethodSnapshotsApi(config);
            ...
            {
                // CRUD: Retrieve a payment method snapshot
                ProxyGetPaymentMethodSnapshot result = apiInstance.ObjectGETPaymentMethodSnapshot(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling PaymentMethodSnapshotsApi.ObjectGETPaymentMethodSnapshot: " + e.Message);
...
#### Using the ObjectGETPaymentMethodSnapshotWithHttpInfo variant
...
{
    // CRUD: Retrieve a payment method snapshot
    ApiResponse<ProxyGetPaymentMethodSnapshot> response = apiInstance.ObjectGETPaymentMethodSnapshotWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
...
{
    Debug.Print("Exception when calling PaymentMethodSnapshotsApi.ObjectGETPaymentMethodSnapshotWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
