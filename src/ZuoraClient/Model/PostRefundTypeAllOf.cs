...
namespace ZuoraClient.Model
{
    ...
    /// PostRefundTypeAllOf
    /// </summary>
    [DataContract(Name = "PostRefundType_allOf")]
    public partial class PostRefundTypeAllOf : IEquatable<PostRefundTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostRefundTypeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostRefundTypeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostRefundTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PostRefundTypeAllOf);
        }

        /// <summary>
        /// Returns true if PostRefundTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostRefundTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostRefundTypeAllOf input)
        {
            if (input == null)
            {
                return false;
