...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PUTPublicEmailTemplateRequest")]
    public partial class PUTPublicEmailTemplateRequest : IEquatable<PUTPublicEmailTemplateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The type of fromEmail.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>The type of the reply email.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTPublicEmailTemplateRequest" /> class.
        /// </summary>
        ...
        /// <param name="fromEmailType">The type of fromEmail..</param>
        ...
        /// <param name="replyToEmailType">The type of the reply email..</param>
        /// <param name="toEmailAddress">If toEmailType is SpecificEmail, this field is required..</param>
        /// <param name="toEmailType">Email receive type. * When the base object for the event is associated with &#x60;Account&#x60;, &#x60;toEmailType&#x60; can be any values in the enum list.  * When the base object for the event is not associated with &#x60;Account&#x60;, &#x60;toEmailType&#x60; must be &#x60;TenantAdmin&#x60;, &#x60;RunOwner&#x60;, or &#x60;SpecificEmail&#x60;. .</param>
        public PUTPublicEmailTemplateRequest(bool active = default(bool), string bccEmailAddress = default(string), string ccEmailAddress = default(string), CcEmailTypeEnum? ccEmailType = CcEmailTypeEnum.SpecificEmails, string description = default(string), string emailBody = default(string), string emailSubject = default(string), EncodingTypeEnum? encodingType = default(EncodingTypeEnum?), string fromEmailAddress = default(string), FromEmailTypeEnum? fromEmailType = default(FromEmailTypeEnum?), string fromName = default(string), bool isHtml = default(bool), string name = default(string), string replyToEmailAddress = default(string), ReplyToEmailTypeEnum? replyToEmailType = default(ReplyToEmailTypeEnum?), string toEmailAddress = default(string), ToEmailTypeEnum? toEmailType = default(ToEmailTypeEnum?))
        {
            this.Active = active;
        ...
        {
            return this.Equals(input as PUTPublicEmailTemplateRequest);
        }

        /// <summary>
        /// Returns true if PUTPublicEmailTemplateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTPublicEmailTemplateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTPublicEmailTemplateRequest input)
        {
            if (input == null)
            {
                return false;
