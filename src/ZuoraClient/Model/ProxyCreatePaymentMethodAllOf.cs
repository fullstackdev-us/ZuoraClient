...
{
    /// <summary>
    /// ProxyCreatePaymentMethodAllOf
    /// </summary>
    [DataContract(Name = "ProxyCreatePaymentMethod_allOf")]
    public partial class ProxyCreatePaymentMethodAllOf : IEquatable<ProxyCreatePaymentMethodAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The type of payment method.   If you want to create an Amazon Pay payment method, specify &#x60;CreditCardReferenceTransaction&#x60; for this field.   If you want create a custom payment method, specify the name of the custom payment method type. This type is only available if the Universal Payment Connector and Open Payment Method services are enabled. See [Set up custom payment gateways and payment methods](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/MB_Set_up_custom_payment_gateways_and_payment_methods) for details. </value>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum CreditCardReferenceTransaction for value: CreditCardReferenceTransaction
            /// </summary>
            [EnumMember(Value = "CreditCardReferenceTransaction")]
            CreditCardReferenceTransaction = 4,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreatePaymentMethodAllOf" /> class.
        /// </summary>
        /// <param name="accountId">The ID of the customer account associated with this payment method. To create an orphan payment method that is not associated with any customer account, you do not need to specify this field during creation. However, you must associate the orphan payment method with a customer account within 10 days. Otherwise, this orphan payment method will be deleted..</param>
        /// <param name="achAbaCode"> The nine-digit routing number or ABA number used by banks. This field is only required if the &#x60;Type&#x60; field is set to &#x60;ACH&#x60;.  **Character limit**: 9 **Values**: a string of 9 characters or fewer .</param>
        /// <param name="achAccountName"> The name of the account holder, which can be either a person or a company. This field is only required if the &#x60;Type&#x60; field is set to &#x60;ACH&#x60;.  **Character limit**: 70 **Values**: a string of 70 characters or fewer .</param>
        /// <param name="achAccountNumber">The bank account number associated with the ACH payment. This field is only required if the &#x60;Type&#x60; field is set to &#x60;ACH&#x60;. **Character limit**: 30 **Values**: a string of 30 numeric characters or fewer .</param>
        ...
        /// <param name="achAddress1"> Line 1 for the ACH address. This field is required for creating a payment method for the Vantiv payment gateway. **Character limit**: 255 **Values**: an address .</param>
        /// <param name="achAddress2"> Line 2 for the ACH address. This field is required for creating a payment method for the Vantiv payment gateway. **Character limit**: 255 **Values**: an address .</param>
        ...
        /// <param name="bankBranchCode">The branch code of the bank used for direct debit. This field is required for the following bank transfer payment methods:   - Sweden Direct Debit (&#x60;Autogiro&#x60;)   - Direct Debit NZ (&#x60;DirectDebitNZ&#x60;)   - Pre-Authorized Debit (&#x60;PAD&#x60;)  **Character limit**: 10 .</param>
        /// <param name="bankCheckDigit">The check digit in the international bank account number, which confirms the validity of the account. Use this field for direct debit payment methods. **Character limit**: 4 **Values**: a string of 4 characters or fewer .</param>
        /// <param name="bankCode">The sort code or number that identifies the bank. This is also known as the sort code. This field is required for the following bank transfer payment methods:   - Direct Debit UK (&#x60;Bacs&#x60;)   - Denmark Direct Debit (&#x60;Betalingsservice&#x60;)   - Direct Debit NZ (&#x60;DirectDebitNZ&#x60;)   - Pre-Authorized Debit (&#x60;PAD&#x60;) .</param>
        /// <param name="bankTransferAccountName">The name on the customer&#39;s bank account. This field is required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;.  **Character limit**: 60  **Values**: a string of 60 characters or fewer .</param>
        /// <param name="bankTransferAccountNumber">The number of the customer&#39;s bank account. This field is required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;.  **Character limit**: 30  **Values**: a string of 30 characters or fewer .</param>
        ...
        /// <param name="businessIdentificationCode"> The business identification code for Swiss direct payment methods that use the Global Collect payment gateway. Use this field only for direct debit payments in Switzerland with Global Collect. **Character limit**: 11 **Values**: a string of 11 characters or fewer .</param>
        /// <param name="city"> The city of the customer&#39;s address. Use this field for direct debit payment methods. It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing. **Character limit**:80 **Values**: a string of 80 characters or fewer .</param>
        /// <param name="companyName">The name of the company.  Zuora does not recommend that you use this field. .</param>
        /// <param name="country">The two-letter country code of the customer&#39;s address. This field is required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;, and the &#x60;BankTransferType&#x60; field is set to any of the following values:   - &#x60;Autogiro&#x60;   - &#x60;Betalingsservice&#x60;   - &#x60;DirectDebitUK&#x60;   - &#x60;DirectEntryAU&#x60;   - &#x60;DirectDebitNZ&#x60;   - &#x60;PAD&#x60;  It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing. .</param>
        ...
        /// <param name="creditCardCity"> The city of the card holder&#39;s address. Use this field for credit card and direct debit payment methods. It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing. **Character limit**: 40 **Values**: a string of 40 characters or fewer .</param>
        /// <param name="creditCardCountry"> The country of the card holder&#39;s address. It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing. .</param>
        /// <param name="creditCardExpirationMonth"> The expiration month of the credit card or debit card. This field is required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;. **Character limit**: 2 **Values**: a two-digit number, 01 - 12 .</param>
        /// <param name="creditCardExpirationYear"> The expiration month of the credit card or debit card. This field is required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;. **Character limit**: 4 **Values**: a four-digit number .</param>
        /// <param name="creditCardHolderName"> The full name of the card holder. This field is only required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;.  **Character limit**: 50 **Values**: a string of 50 characters or fewer .</param>
        /// <param name="creditCardNumber">Credit card number, a string of up to 16 characters. This field is required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;. This field can only be set when creating a new payment method; it cannot be queried or updated. .</param>
        /// <param name="creditCardPostalCode"> The billing address&#39;s zip code. **Character limit**: 20 **Values**: a string of 20 characters or fewer .</param>
        ...
        /// <param name="creditCardState"> The billing address&#39;s state. Use this field if the &#x60;CreditCardCountry&#x60; value is either Canada or the US. State names must be spelled in full. .</param>
        ...
        /// <param name="gatewayOptionData">gatewayOptionData.</param>
        ...
        /// <param name="identityNumber">The unique identity number of the customer account. This field is required for the following bank transfer payment methods:   - Denmark Direct Debit (Betalingsservice)   - Sweden Direct Debit (Autogiro)  It is a string of 12 characters for a Swedish identity number, and a string of 10 characters for a Denish identity number. .</param>
        ...
        /// <param name="maxConsecutivePaymentFailures"> Specifies the number of allowable consecutive failures Zuora attempts with the payment method before stopping. When the &#x60;UseDefaultRetryRule&#x60; field is set to &#x60;false&#x60;, this field is only required if the &#x60;PaymentRetryWindow&#x60; field is not defined. **Values**: a valid number .</param>
        ...
        /// <param name="paymentRetryWindow"> The retry interval setting, which prevents making a payment attempt if the last failed attempt was within the last specified number of hours. When the &#x60;UseDefaultRetryRule&#x60; field is set to &#x60;false&#x60;, this field is only required if the &#x60;MaxConsecutivePaymentFailures&#x60; field is not defined. **Character limit**: 4 **Values**: a whole number between 1 and 1000, exclusive .</param>
        /// <param name="paypalBaid"> The PayPal billing agreement ID, which is a contract between two PayPal accounts. Typically, the selling party initiates a request to create a BAID, and sends it to buying party for acceptance. The seller can keep track of the BAID and use it for future charges against the buyer. This field is only required if the &#x60;Type&#x60; field is set to &#x60;PayPal&#x60;. **Character limit**: 64 **Values**: a string of 64 characters or fewer .</param>
        /// <param name="paypalEmail"> The email address associated with the account holder&#39;s PayPal account or of the PayPal account of the person paying for the service. This field is only required if the &#x60;Type&#x60; field is set to &#x60;PayPal&#x60;. **Character limit**: 80 **Values**: a string of 80 characters or fewer .</param>
        ...
        /// <param name="paypalType"> Specifies the PayPal gateway: PayFlow Pro (Express Checkout) or Adaptive Payments. This field is only required if you use PayPal Adaptive Payments or Payflow Pro (Express Checkout) gateways. **Character limit**: 32 **Values**: &#x60;ExpressCheckout&#x60;, &#x60;AdaptivePayments&#x60; .</param>
        ...
        /// <param name="skipValidation">If you set this field to &#x60;false&#x60;, Zuora will send an authorization request to the payment gateway. If the authorization fails, the Create Payment Method request will fail as well. If the user knows that the card number or token is valid, we recommend disabling this feature because authorization requests to the card network incur additional processing fees. Currently, Zuora sends all authorizations as keyed entries. If you set this field to &#x60;true&#x60;, the authorization request is not sent. **Character limit**: 5 **Values**: &#x60;true&#x60; or &#x60;false&#x60; .</param>
        ...
        /// <param name="tokenId">A gateway unique identifier that replaces sensitive payment method data or represents a gateway&#39;s unique customer profile. When &#x60;TokenId&#x60; is used to represent a customer profile, &#x60;SecondTokenId&#x60; is conditionally required for representing the underlying tokenized payment method. &#x60;TokenId&#x60; is required for the CC Reference Transaction payment method. **Character limit**: 255 **Values**: a string of 255 characters or fewer .</param>
        /// <param name="type">The type of payment method.   If you want to create an Amazon Pay payment method, specify &#x60;CreditCardReferenceTransaction&#x60; for this field.   If you want create a custom payment method, specify the name of the custom payment method type. This type is only available if the Universal Payment Connector and Open Payment Method services are enabled. See [Set up custom payment gateways and payment methods](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/MB_Set_up_custom_payment_gateways_and_payment_methods) for details. .</param>
        ...
        public ProxyCreatePaymentMethodAllOf(string accountId = default(string), string achAbaCode = default(string), string achAccountName = default(string), string achAccountNumber = default(string), string achAccountType = default(string), string achAddress1 = default(string), string achAddress2 = default(string), string achBankName = default(string), string achCity = default(string), string achCountry = default(string), string achPostalCode = default(string), string achState = default(string), string bankBranchCode = default(string), string bankCheckDigit = default(string), string bankCode = default(string), string bankTransferAccountName = default(string), string bankTransferAccountNumber = default(string), string bankTransferAccountNumberMask = default(string), string bankTransferType = default(string), string businessIdentificationCode = default(string), string city = default(string), string companyName = default(string), string country = default(string), string creditCardAddress1 = default(string), string creditCardAddress2 = default(string), string creditCardCity = default(string), string creditCardCountry = default(string), int creditCardExpirationMonth = default(int), int creditCardExpirationYear = default(int), string creditCardHolderName = default(string), string creditCardNumber = default(string), string creditCardPostalCode = default(string), string creditCardSecurityCode = default(string), string creditCardState = default(string), string creditCardType = default(string), string deviceSessionId = default(string), string email = default(string), string existingMandate = default(string), string firstName = default(string), ProxyCreatePaymentAllOfGatewayOptionData gatewayOptionData = default(ProxyCreatePaymentAllOfGatewayOptionData), string iBAN = default(string), string iPAddress = default(string), string identityNumber = default(string), bool isCompany = false, string lastName = default(string), DateTime lastTransactionDateTime = default(DateTime), DateTime mandateCreationDate = default(DateTime), string mandateID = default(string), string mandateReceived = default(string), DateTime mandateUpdateDate = default(DateTime), int maxConsecutivePaymentFailures = default(int), int numConsecutiveFailures = default(int), int paymentRetryWindow = default(int), string paypalBaid = default(string), string paypalEmail = default(string), string paypalPreapprovalKey = default(string), string paypalType = default(string), string phone = default(string), string postalCode = default(string), string secondTokenId = default(string), bool skipValidation = default(bool), string state = default(string), string streetName = default(string), string streetNumber = default(string), string tokenId = default(string), TypeEnum? type = default(TypeEnum?), bool useDefaultRetryRule = default(bool), string currencyCode = default(string))
        {
        ...
        /// </summary>
        /// <value>The ID of the customer account associated with this payment method. To create an orphan payment method that is not associated with any customer account, you do not need to specify this field during creation. However, you must associate the orphan payment method with a customer account within 10 days. Otherwise, this orphan payment method will be deleted.</value>
        ...
        /// </summary>
        /// <value> The nine-digit routing number or ABA number used by banks. This field is only required if the &#x60;Type&#x60; field is set to &#x60;ACH&#x60;.  **Character limit**: 9 **Values**: a string of 9 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The name of the account holder, which can be either a person or a company. This field is only required if the &#x60;Type&#x60; field is set to &#x60;ACH&#x60;.  **Character limit**: 70 **Values**: a string of 70 characters or fewer </value>
        ...
        /// </summary>
        /// <value>The bank account number associated with the ACH payment. This field is only required if the &#x60;Type&#x60; field is set to &#x60;ACH&#x60;. **Character limit**: 30 **Values**: a string of 30 numeric characters or fewer </value>
        ...
        /// </summary>
        /// <value> Line 1 for the ACH address. This field is required for creating a payment method for the Vantiv payment gateway. **Character limit**: 255 **Values**: an address </value>
        ...
        /// </summary>
        /// <value> Line 2 for the ACH address. This field is required for creating a payment method for the Vantiv payment gateway. **Character limit**: 255 **Values**: an address </value>
        ...
        /// </summary>
        /// <value>The city of the ACH address. Use this field for ACH payment methods. **Note**: This field is only specific to the NMI payment gateway. It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing. **Character limit**: 40 **Values**: a string of 40 characters or fewer </value>
        ...
        /// </summary>
        /// <value>The billing address&#39;s zip code. This field is required only when you define an ACH payment method. **Note**: This field is only specific to the NMI payment gateway. **Character limit**: 20 **Values**: a string of 20 characters or fewer </value>
        ...
        /// <summary>
        /// The branch code of the bank used for direct debit. This field is required for the following bank transfer payment methods:   - Sweden Direct Debit (&#x60;Autogiro&#x60;)   - Direct Debit NZ (&#x60;DirectDebitNZ&#x60;)   - Pre-Authorized Debit (&#x60;PAD&#x60;)  **Character limit**: 10 
        /// </summary>
        /// <value>The branch code of the bank used for direct debit. This field is required for the following bank transfer payment methods:   - Sweden Direct Debit (&#x60;Autogiro&#x60;)   - Direct Debit NZ (&#x60;DirectDebitNZ&#x60;)   - Pre-Authorized Debit (&#x60;PAD&#x60;)  **Character limit**: 10 </value>
        ...
        /// </summary>
        /// <value>The check digit in the international bank account number, which confirms the validity of the account. Use this field for direct debit payment methods. **Character limit**: 4 **Values**: a string of 4 characters or fewer </value>
        [DataMember(Name = "BankCheckDigit", EmitDefaultValue = false)]
        public string BankCheckDigit { get; set; }

        /// <summary>
        /// The sort code or number that identifies the bank. This is also known as the sort code. This field is required for the following bank transfer payment methods:   - Direct Debit UK (&#x60;Bacs&#x60;)   - Denmark Direct Debit (&#x60;Betalingsservice&#x60;)   - Direct Debit NZ (&#x60;DirectDebitNZ&#x60;)   - Pre-Authorized Debit (&#x60;PAD&#x60;) 
        /// </summary>
        /// <value>The sort code or number that identifies the bank. This is also known as the sort code. This field is required for the following bank transfer payment methods:   - Direct Debit UK (&#x60;Bacs&#x60;)   - Denmark Direct Debit (&#x60;Betalingsservice&#x60;)   - Direct Debit NZ (&#x60;DirectDebitNZ&#x60;)   - Pre-Authorized Debit (&#x60;PAD&#x60;) </value>
        [DataMember(Name = "BankCode", EmitDefaultValue = false)]
        public string BankCode { get; set; }

        /// <summary>
        /// The name on the customer&#39;s bank account. This field is required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;.  **Character limit**: 60  **Values**: a string of 60 characters or fewer 
        /// </summary>
        /// <value>The name on the customer&#39;s bank account. This field is required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;.  **Character limit**: 60  **Values**: a string of 60 characters or fewer </value>
        [DataMember(Name = "BankTransferAccountName", EmitDefaultValue = false)]
        public string BankTransferAccountName { get; set; }

        /// <summary>
        /// The number of the customer&#39;s bank account. This field is required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;.  **Character limit**: 30  **Values**: a string of 30 characters or fewer 
        /// </summary>
        /// <value>The number of the customer&#39;s bank account. This field is required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;.  **Character limit**: 30  **Values**: a string of 30 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The business identification code for Swiss direct payment methods that use the Global Collect payment gateway. Use this field only for direct debit payments in Switzerland with Global Collect. **Character limit**: 11 **Values**: a string of 11 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The city of the customer&#39;s address. Use this field for direct debit payment methods. It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing. **Character limit**:80 **Values**: a string of 80 characters or fewer </value>
        ...
        /// </summary>
        /// <value>The two-letter country code of the customer&#39;s address. This field is required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;, and the &#x60;BankTransferType&#x60; field is set to any of the following values:   - &#x60;Autogiro&#x60;   - &#x60;Betalingsservice&#x60;   - &#x60;DirectDebitUK&#x60;   - &#x60;DirectEntryAU&#x60;   - &#x60;DirectDebitNZ&#x60;   - &#x60;PAD&#x60;  It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing. </value>
        ...
        /// </summary>
        /// <value> The city of the card holder&#39;s address. Use this field for credit card and direct debit payment methods. It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing. **Character limit**: 40 **Values**: a string of 40 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The country of the card holder&#39;s address. It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing. </value>
        ...
        /// </summary>
        /// <value> The expiration month of the credit card or debit card. This field is required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;. **Character limit**: 2 **Values**: a two-digit number, 01 - 12 </value>
        ...
        /// </summary>
        /// <value> The expiration month of the credit card or debit card. This field is required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;. **Character limit**: 4 **Values**: a four-digit number </value>
        ...
        /// </summary>
        /// <value> The full name of the card holder. This field is only required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;.  **Character limit**: 50 **Values**: a string of 50 characters or fewer </value>
        ...
        /// </summary>
        /// <value>Credit card number, a string of up to 16 characters. This field is required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;. This field can only be set when creating a new payment method; it cannot be queried or updated. </value>
        ...
        /// </summary>
        /// <value> The billing address&#39;s zip code. **Character limit**: 20 **Values**: a string of 20 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The billing address&#39;s state. Use this field if the &#x60;CreditCardCountry&#x60; value is either Canada or the US. State names must be spelled in full. </value>
        ...
        /// <summary>
        /// Gets or Sets GatewayOptionData
        /// </summary>
        [DataMember(Name = "GatewayOptionData", EmitDefaultValue = false)]
        public ProxyCreatePaymentAllOfGatewayOptionData GatewayOptionData { get; set; }
        ...
        /// <summary>
        /// The unique identity number of the customer account. This field is required for the following bank transfer payment methods:   - Denmark Direct Debit (Betalingsservice)   - Sweden Direct Debit (Autogiro)  It is a string of 12 characters for a Swedish identity number, and a string of 10 characters for a Denish identity number. 
        /// </summary>
        /// <value>The unique identity number of the customer account. This field is required for the following bank transfer payment methods:   - Denmark Direct Debit (Betalingsservice)   - Sweden Direct Debit (Autogiro)  It is a string of 12 characters for a Swedish identity number, and a string of 10 characters for a Denish identity number. </value>
        ...
        /// </summary>
        /// <value> Specifies the number of allowable consecutive failures Zuora attempts with the payment method before stopping. When the &#x60;UseDefaultRetryRule&#x60; field is set to &#x60;false&#x60;, this field is only required if the &#x60;PaymentRetryWindow&#x60; field is not defined. **Values**: a valid number </value>
        ...
        /// </summary>
        /// <value> The retry interval setting, which prevents making a payment attempt if the last failed attempt was within the last specified number of hours. When the &#x60;UseDefaultRetryRule&#x60; field is set to &#x60;false&#x60;, this field is only required if the &#x60;MaxConsecutivePaymentFailures&#x60; field is not defined. **Character limit**: 4 **Values**: a whole number between 1 and 1000, exclusive </value>
        ...
        /// </summary>
        /// <value> The PayPal billing agreement ID, which is a contract between two PayPal accounts. Typically, the selling party initiates a request to create a BAID, and sends it to buying party for acceptance. The seller can keep track of the BAID and use it for future charges against the buyer. This field is only required if the &#x60;Type&#x60; field is set to &#x60;PayPal&#x60;. **Character limit**: 64 **Values**: a string of 64 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The email address associated with the account holder&#39;s PayPal account or of the PayPal account of the person paying for the service. This field is only required if the &#x60;Type&#x60; field is set to &#x60;PayPal&#x60;. **Character limit**: 80 **Values**: a string of 80 characters or fewer </value>
        ...
        /// </summary>
        /// <value> Specifies the PayPal gateway: PayFlow Pro (Express Checkout) or Adaptive Payments. This field is only required if you use PayPal Adaptive Payments or Payflow Pro (Express Checkout) gateways. **Character limit**: 32 **Values**: &#x60;ExpressCheckout&#x60;, &#x60;AdaptivePayments&#x60; </value>
        ...
        /// </summary>
        /// <value>If you set this field to &#x60;false&#x60;, Zuora will send an authorization request to the payment gateway. If the authorization fails, the Create Payment Method request will fail as well. If the user knows that the card number or token is valid, we recommend disabling this feature because authorization requests to the card network incur additional processing fees. Currently, Zuora sends all authorizations as keyed entries. If you set this field to &#x60;true&#x60;, the authorization request is not sent. **Character limit**: 5 **Values**: &#x60;true&#x60; or &#x60;false&#x60; </value>
        ...
        /// </summary>
        /// <value>A gateway unique identifier that replaces sensitive payment method data or represents a gateway&#39;s unique customer profile. When &#x60;TokenId&#x60; is used to represent a customer profile, &#x60;SecondTokenId&#x60; is conditionally required for representing the underlying tokenized payment method. &#x60;TokenId&#x60; is required for the CC Reference Transaction payment method. **Character limit**: 255 **Values**: a string of 255 characters or fewer </value>
        ...
        /// </summary>
        /// <value>Determines whether to use the default retry rules configured in the Z-Payments settings. Set this to &#x60;true&#x60; to use the default retry rules. Set this to &#x60;false&#x60; to set the specific rules for this payment method. If you set this value to &#x60;false&#x60;, then the fields, &#x60;PaymentRetryWindow&#x60; and &#x60;MaxConsecutivePaymentFailures&#x60;, are required. **Character limit**: 5 **Values**: &#x60;true&#x60; or &#x60;false&#x60; </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyCreatePaymentMethodAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyCreatePaymentMethodAllOf);
        }

        /// <summary>
        /// Returns true if ProxyCreatePaymentMethodAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreatePaymentMethodAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreatePaymentMethodAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AchAccountNumber == input.AchAccountNumber ||
                    (this.AchAccountNumber != null &&
                    this.AchAccountNumber.Equals(input.AchAccountNumber))
                ) && 
                (
                ...
                (
                    this.BankTransferAccountName == input.BankTransferAccountName ||
                    (this.BankTransferAccountName != null &&
                    this.BankTransferAccountName.Equals(input.BankTransferAccountName))
                ) && 
                (
                    this.BankTransferAccountNumber == input.BankTransferAccountNumber ||
                    (this.BankTransferAccountNumber != null &&
                    this.BankTransferAccountNumber.Equals(input.BankTransferAccountNumber))
                ) && 
                (
                    this.BankTransferAccountNumberMask == input.BankTransferAccountNumberMask ||
                    (this.BankTransferAccountNumberMask != null &&
                    this.BankTransferAccountNumberMask.Equals(input.BankTransferAccountNumberMask))
                ) && 
                (
                ...
                (
                    this.GatewayOptionData == input.GatewayOptionData ||
                    (this.GatewayOptionData != null &&
                    this.GatewayOptionData.Equals(input.GatewayOptionData))
                ) && 
                (
                ...
                (
                    this.PaypalBaid == input.PaypalBaid ||
                    (this.PaypalBaid != null &&
                    this.PaypalBaid.Equals(input.PaypalBaid))
                ) && 
                (
                ...
                (
                    this.PaypalPreapprovalKey == input.PaypalPreapprovalKey ||
                    (this.PaypalPreapprovalKey != null &&
                    this.PaypalPreapprovalKey.Equals(input.PaypalPreapprovalKey))
                ) && 
                (
                    this.PaypalType == input.PaypalType ||
                    (this.PaypalType != null &&
                    this.PaypalType.Equals(input.PaypalType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AchAccountNumber.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.BankTransferAccountName.GetHashCode();
                }
                if (this.BankTransferAccountNumber != null)
                {
                    hashCode = (hashCode * 59) + this.BankTransferAccountNumber.GetHashCode();
                }
                if (this.BankTransferAccountNumberMask != null)
                {
                    hashCode = (hashCode * 59) + this.BankTransferAccountNumberMask.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.GatewayOptionData.GetHashCode();
                }
                if (this.IBAN != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + this.PaypalBaid.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.PaypalPreapprovalKey.GetHashCode();
                }
                if (this.PaypalType != null)
                {
                    hashCode = (hashCode * 59) + this.PaypalType.GetHashCode();
                }
                if (this.Phone != null)
                {
