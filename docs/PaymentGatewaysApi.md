# ZuoraClient.Api.PaymentGatewaysApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**GETPaymentgateways**](PaymentGatewaysApi.md#getpaymentgateways) | **GET** /v1/paymentgateways | List all payment gateways |

<a name="getpaymentgateways"></a>
# **GETPaymentgateways**
> GETPaymentGatwaysResponse GETPaymentgateways (string authorization = null, string zuoraTrackId = null, string zuoraEntityIds = null)
...
namespace Example
{
    public class GETPaymentgatewaysExample
    {
        public static void Main()
        {
            ...
            {
                // List all payment gateways
                GETPaymentGatwaysResponse result = apiInstance.GETPaymentgateways(authorization, zuoraTrackId, zuoraEntityIds);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling PaymentGatewaysApi.GETPaymentgateways: " + e.Message);
...
#### Using the GETPaymentgatewaysWithHttpInfo variant
...
{
    // List all payment gateways
    ApiResponse<GETPaymentGatwaysResponse> response = apiInstance.GETPaymentgatewaysWithHttpInfo(authorization, zuoraTrackId, zuoraEntityIds);
...
{
    Debug.Print("Exception when calling PaymentGatewaysApi.GETPaymentgatewaysWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
