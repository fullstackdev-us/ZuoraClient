# ZuoraClient.Api.InvoiceSplitItemsApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**ObjectGETInvoiceSplitItem**](InvoiceSplitItemsApi.md#objectgetinvoicesplititem) | **GET** /v1/object/invoice-split-item/{id} | CRUD: Retrieve an invoice split item |

<a name="objectgetinvoicesplititem"></a>
# **ObjectGETInvoiceSplitItem**
> ProxyGetInvoiceSplitItem ObjectGETInvoiceSplitItem (string id, string authorization = null, string zuoraEntityIds = null, string zuoraTrackId = null, string fields = null)
...
namespace Example
{
    public class ObjectGETInvoiceSplitItemExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            config.BasePath = "https://rest.zuora.com";
            var apiInstance = new InvoiceSplitItemsApi(config);
            ...
            {
                // CRUD: Retrieve an invoice split item
                ProxyGetInvoiceSplitItem result = apiInstance.ObjectGETInvoiceSplitItem(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling InvoiceSplitItemsApi.ObjectGETInvoiceSplitItem: " + e.Message);
...
#### Using the ObjectGETInvoiceSplitItemWithHttpInfo variant
...
{
    // CRUD: Retrieve an invoice split item
    ApiResponse<ProxyGetInvoiceSplitItem> response = apiInstance.ObjectGETInvoiceSplitItemWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
...
{
    Debug.Print("Exception when calling InvoiceSplitItemsApi.ObjectGETInvoiceSplitItemWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
