...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreviewOrderCreateSubscription_newSubscriptionOwnerAccount")]
    public partial class PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount : IEquatable<PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount" /> class.
        /// </summary>
        ...
        public PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount(string accountNumber = default(string), string additionalEmailAddresses = default(string), bool allowInvoiceEdit = default(bool), bool autoPay = default(bool), string batch = default(string), int billCycleDay = default(int), BillToContactPostOrder billToContact = default(BillToContactPostOrder), string communicationProfileId = default(string), CreditCard creditCard = default(CreditCard), string creditMemoTemplateId = default(string), string crmId = default(string), string currency = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string customerServiceRepName = default(string), string debitMemoTemplateId = default(string), string hpmCreditCardPaymentMethodId = default(string), bool invoiceDeliveryPrefsEmail = default(bool), bool invoiceDeliveryPrefsPrint = default(bool), string invoiceTemplateId = default(string), string name = default(string), string notes = default(string), string parentId = default(string), string paymentGateway = default(string), PaymentMethod paymentMethod = default(PaymentMethod), string paymentTerm = default(string), string purchaseOrderNumber = default(string), string salesRep = default(string), SoldToContactPostOrder soldToContact = default(SoldToContactPostOrder), TaxInfo taxInfo = default(TaxInfo))
        {
            ...
            {
                throw new ArgumentNullException("billToContact is a required property for PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount and cannot be null");
            }
            this.BillToContact = billToContact;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount and cannot be null");
            }
            this.Currency = currency;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>The ID of the payment method associated with this account. The payment method specified for this field will be set as the default payment method of the account.  If the &#x60;autoPay&#x60; field is set to &#x60;true&#x60;, you must provide the credit card payment method ID for either this field or the &#x60;creditCard&#x60; field, but not both.  For a specified credit card payment method, it is recommended that [the support for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions) for this payment method is already enabled. </value>
        ...
        {
            return this.Equals(input as PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount);
        }

        /// <summary>
        /// Returns true if PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount input)
        {
            if (input == null)
            {
                return false;
