...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountingPeriodWithoutSuccessType")]
    public partial class GETAccountingPeriodWithoutSuccessType : IEquatable<GETAccountingPeriodWithoutSuccessType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETAccountingPeriodWithoutSuccessType);
        }

        /// <summary>
        /// Returns true if GETAccountingPeriodWithoutSuccessType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountingPeriodWithoutSuccessType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountingPeriodWithoutSuccessType input)
        {
            if (input == null)
            {
                return false;
