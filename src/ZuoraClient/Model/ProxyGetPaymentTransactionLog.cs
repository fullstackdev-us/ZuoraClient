...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetPaymentTransactionLog")]
    public partial class ProxyGetPaymentTransactionLog : IEquatable<ProxyGetPaymentTransactionLog>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The state of the transaction at the payment gateway. </value>
        ...
        /// </summary>
        /// <value>The type of the transaction, either making a payment, or canceling a payment.  </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        public GatewayTransactionTypeEnum? GatewayTransactionType { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetPaymentTransactionLog" /> class.
        /// </summary>
        /// <param name="aVSResponseCode">The response code returned by the payment gateway referring to the AVS international response of the payment transaction. .</param>
        /// <param name="batchId">The ID of the batch used to send the transaction if the request was sent in a batch. .</param>
        /// <param name="cVVResponseCode">The response code returned by the payment gateway referring to the CVV international response of the payment transaction. .</param>
        /// <param name="gateway">The name of the payment gateway used to transact the current payment transaction log. .</param>
        /// <param name="gatewayReasonCode">The code returned by the payment gateway for the payment. This code is gateway-dependent. .</param>
        /// <param name="gatewayReasonCodeDescription">The message returned by the payment gateway for the payment. This message is gateway-dependent.  .</param>
        /// <param name="gatewayState">The state of the transaction at the payment gateway. .</param>
        /// <param name="gatewayTransactionType">The type of the transaction, either making a payment, or canceling a payment.  .</param>
        /// <param name="id">The ID of the payment transaction log. .</param>
        /// <param name="paymentId">The ID of the payment wherein the payment transaction log was recorded.  .</param>
        /// <param name="requestString">The payment transaction request string sent to the payment gateway.  .</param>
        /// <param name="responseString">The payment transaction response string returned by the payment gateway.  .</param>
        /// <param name="transactionDate">The transaction date when the payment was performed.  .</param>
        /// <param name="transactionId">The transaction ID returned by the payment gateway. This field is used to reconcile payment transactions between the payment gateway and records in Zuora. .</param>
        public ProxyGetPaymentTransactionLog(string aVSResponseCode = default(string), string batchId = default(string), string cVVResponseCode = default(string), string gateway = default(string), string gatewayReasonCode = default(string), string gatewayReasonCodeDescription = default(string), GatewayStateEnum? gatewayState = default(GatewayStateEnum?), GatewayTransactionTypeEnum? gatewayTransactionType = default(GatewayTransactionTypeEnum?), string id = default(string), string paymentId = default(string), string requestString = default(string), string responseString = default(string), DateTime transactionDate = default(DateTime), string transactionId = default(string))
        {
        ...
        /// </summary>
        /// <value>The response code returned by the payment gateway referring to the AVS international response of the payment transaction. </value>
        ...
        /// </summary>
        /// <value>The ID of the batch used to send the transaction if the request was sent in a batch. </value>
        ...
        /// </summary>
        /// <value>The response code returned by the payment gateway referring to the CVV international response of the payment transaction. </value>
        ...
        /// </summary>
        /// <value>The name of the payment gateway used to transact the current payment transaction log. </value>
        ...
        /// </summary>
        /// <value>The code returned by the payment gateway for the payment. This code is gateway-dependent. </value>
        ...
        /// </summary>
        /// <value>The message returned by the payment gateway for the payment. This message is gateway-dependent.  </value>
        ...
        /// </summary>
        /// <value>The ID of the payment transaction log. </value>
        ...
        /// </summary>
        /// <value>The ID of the payment wherein the payment transaction log was recorded.  </value>
        ...
        /// </summary>
        /// <value>The payment transaction request string sent to the payment gateway.  </value>
        ...
        /// </summary>
        /// <value>The payment transaction response string returned by the payment gateway.  </value>
        ...
        /// </summary>
        /// <value>The transaction date when the payment was performed.  </value>
        ...
        /// </summary>
        /// <value>The transaction ID returned by the payment gateway. This field is used to reconcile payment transactions between the payment gateway and records in Zuora. </value>
        ...
        {
            return this.Equals(input as ProxyGetPaymentTransactionLog);
        }

        /// <summary>
        /// Returns true if ProxyGetPaymentTransactionLog instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetPaymentTransactionLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetPaymentTransactionLog input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GatewayReasonCode == input.GatewayReasonCode ||
                    (this.GatewayReasonCode != null &&
                    this.GatewayReasonCode.Equals(input.GatewayReasonCode))
                ) && 
                (
                    this.GatewayReasonCodeDescription == input.GatewayReasonCodeDescription ||
                    (this.GatewayReasonCodeDescription != null &&
                    this.GatewayReasonCodeDescription.Equals(input.GatewayReasonCodeDescription))
                ) && 
                (
                ...
                (
                    this.GatewayTransactionType == input.GatewayTransactionType ||
                    this.GatewayTransactionType.Equals(input.GatewayTransactionType)
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
                ...
                (
                    this.RequestString == input.RequestString ||
                    (this.RequestString != null &&
                    this.RequestString.Equals(input.RequestString))
                ) && 
                (
                    this.ResponseString == input.ResponseString ||
                    (this.ResponseString != null &&
                    this.ResponseString.Equals(input.ResponseString))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.GatewayReasonCode.GetHashCode();
                }
                if (this.GatewayReasonCodeDescription != null)
                {
                    hashCode = (hashCode * 59) + this.GatewayReasonCodeDescription.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.GatewayState.GetHashCode();
                hashCode = (hashCode * 59) + this.GatewayTransactionType.GetHashCode();
                if (this.Id != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + this.RequestString.GetHashCode();
                }
                if (this.ResponseString != null)
                {
                    hashCode = (hashCode * 59) + this.ResponseString.GetHashCode();
                }
