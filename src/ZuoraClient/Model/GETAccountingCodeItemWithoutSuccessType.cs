...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountingCodeItemWithoutSuccessType")]
    public partial class GETAccountingCodeItemWithoutSuccessType : IEquatable<GETAccountingCodeItemWithoutSuccessType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETAccountingCodeItemWithoutSuccessType);
        }

        /// <summary>
        /// Returns true if GETAccountingCodeItemWithoutSuccessType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountingCodeItemWithoutSuccessType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountingCodeItemWithoutSuccessType input)
        {
            if (input == null)
            {
                return false;
