...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyModifyProductRatePlan")]
    public partial class ProxyModifyProductRatePlan : IEquatable<ProxyModifyProductRatePlan>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyModifyProductRatePlan);
        }

        /// <summary>
        /// Returns true if ProxyModifyProductRatePlan instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyModifyProductRatePlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyProductRatePlan input)
        {
            if (input == null)
            {
                return false;
