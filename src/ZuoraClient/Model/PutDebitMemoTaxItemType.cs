...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PutDebitMemoTaxItemType")]
    public partial class PutDebitMemoTaxItemType : IEquatable<PutDebitMemoTaxItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutDebitMemoTaxItemType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutDebitMemoTaxItemType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutDebitMemoTaxItemType" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PutDebitMemoTaxItemType);
        }

        /// <summary>
        /// Returns true if PutDebitMemoTaxItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of PutDebitMemoTaxItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutDebitMemoTaxItemType input)
        {
            if (input == null)
            {
                return false;
