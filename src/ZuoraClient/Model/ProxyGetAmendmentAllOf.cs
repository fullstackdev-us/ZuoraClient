...
{
    /// <summary>
    /// ProxyGetAmendmentAllOf
    /// </summary>
    [DataContract(Name = "ProxyGetAmendment_allOf")]
    public partial class ProxyGetAmendmentAllOf : IEquatable<ProxyGetAmendmentAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetAmendmentAllOf" /> class.
        /// </summary>
        ...
        /// <param name="serviceActivationDate">The date when service is activated.  This field is only required if [Zuora is configured to require service activation in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Activation status (the value of the &#x60;Status&#x60; field is currently &#x60;PendingActivation&#x60;). .</param>
        /// <param name="specificUpdateDate"> The date when the UpdateProduct amendment takes effect. This field is only applicable if there is already a future-dated UpdateProduct amendment on the subscription. **Required**: Only for the UpdateProduct amendments if there is already a future-dated UpdateProduct amendment on the subscription. **Version notes**: - - .</param>
        ...
        /// <param name="subscriptionId"> The ID of the subscription that the amendment changes. **Character limit**: 32 **Values**: a valid subscription ID .</param>
        /// <param name="termStartDate"> The date when the new terms and conditions take effect.   **Version notes**: - - .</param>
        ...
        /// <param name="type"> The type of amendment. **Character limit**: 18 **Values**: one of the following:  - Cancellation - NewProduct - OwnerTransfer - RemoveProduct - Renewal - UpdateProduct - TermsAndConditions - SuspendSubscription - ResumeSubscription .</param>
        ...
        /// </summary>
        /// <value>The date when the customer accepts the amendment&#39;s changes to the subscription.  This field is only required if [Zuora is configured to require customer acceptance in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Acceptance status (the value of the &#x60;Status&#x60; field is currently &#x60;PendingAcceptance&#x60;). </value>
        ...
        /// </summary>
        /// <value> The date when the UpdateProduct amendment takes effect. This field is only applicable if there is already a future-dated UpdateProduct amendment on the subscription. **Required**: Only for the UpdateProduct amendments if there is already a future-dated UpdateProduct amendment on the subscription. **Version notes**: - - </value>
        ...
        /// </summary>
        /// <value> The ID of the subscription that the amendment changes. **Character limit**: 32 **Values**: a valid subscription ID </value>
        ...
        /// </summary>
        /// <value> The date when the new terms and conditions take effect.   **Version notes**: - - </value>
        ...
        /// <summary>
        ///  The type of amendment. **Character limit**: 18 **Values**: one of the following:  - Cancellation - NewProduct - OwnerTransfer - RemoveProduct - Renewal - UpdateProduct - TermsAndConditions - SuspendSubscription - ResumeSubscription 
        /// </summary>
        /// <value> The type of amendment. **Character limit**: 18 **Values**: one of the following:  - Cancellation - NewProduct - OwnerTransfer - RemoveProduct - Renewal - UpdateProduct - TermsAndConditions - SuspendSubscription - ResumeSubscription </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetAmendmentAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetAmendmentAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetAmendmentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetAmendmentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetAmendmentAllOf input)
        {
            if (input == null)
            {
                return false;
