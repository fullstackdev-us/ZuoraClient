...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETARPaymentType_allOf")]
    public partial class GETARPaymentTypeAllOf : IEquatable<GETARPaymentTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETARPaymentTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETARPaymentTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETARPaymentTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETARPaymentTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETARPaymentTypeAllOf input)
        {
            if (input == null)
            {
                return false;
