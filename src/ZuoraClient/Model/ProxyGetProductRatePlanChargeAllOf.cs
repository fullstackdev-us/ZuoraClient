...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetProductRatePlanCharge_allOf")]
    public partial class ProxyGetProductRatePlanChargeAllOf : IEquatable<ProxyGetProductRatePlanChargeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetProductRatePlanChargeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProxyGetProductRatePlanChargeAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetProductRatePlanChargeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetProductRatePlanChargeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetProductRatePlanChargeAllOf input)
        {
            if (input == null)
            {
                return false;
