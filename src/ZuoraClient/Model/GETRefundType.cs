...
namespace ZuoraClient.Model
{
    ...
    /// GETRefundType
    /// </summary>
    [DataContract(Name = "GETRefundType")]
    public partial class GETRefundType : IEquatable<GETRefundType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRefundType" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETRefundType);
        }

        /// <summary>
        /// Returns true if GETRefundType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRefundType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRefundType input)
        {
            if (input == null)
            {
                return false;
