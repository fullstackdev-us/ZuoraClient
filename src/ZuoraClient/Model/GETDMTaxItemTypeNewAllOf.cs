...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETDMTaxItemTypeNew_allOf")]
    public partial class GETDMTaxItemTypeNewAllOf : IEquatable<GETDMTaxItemTypeNewAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETDMTaxItemTypeNewAllOf" /> class.
        /// </summary>
        /// <param name="balance">The balance of the taxation item. .</param>
        ...
        public GETDMTaxItemTypeNewAllOf(double balance = default(double), double creditAmount = default(double), double exemptAmount = default(double), GETDMTaxItemTypeAllOfFinanceInformation financeInformation = default(GETDMTaxItemTypeAllOfFinanceInformation), string id = default(string), string jurisdiction = default(string), string locationCode = default(string), string name = default(string), double paymentAmount = default(double), string sourceTaxItemId = default(string), double taxAmount = default(double), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), double taxRate = default(double), string taxRateDescription = default(string), TaxRateTypeEnum? taxRateType = default(TaxRateTypeEnum?))
        {
        ...
        /// </summary>
        /// <value>The balance of the taxation item. </value>
        ...
        {
            return this.Equals(input as GETDMTaxItemTypeNewAllOf);
        }

        /// <summary>
        /// Returns true if GETDMTaxItemTypeNewAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETDMTaxItemTypeNewAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETDMTaxItemTypeNewAllOf input)
        {
            if (input == null)
            {
                return false;
