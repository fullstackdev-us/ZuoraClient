...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRSDetailWithoutSuccessType_allOf")]
    public partial class GETRSDetailWithoutSuccessTypeAllOf : IEquatable<GETRSDetailWithoutSuccessTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRSDetailWithoutSuccessTypeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="updatedOn">The date when the revenue automation start date was set, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        public GETRSDetailWithoutSuccessTypeAllOf(string accountId = default(string), decimal amount = default(decimal), DateTime createdOn = default(DateTime), string currency = default(string), string linkedTransactionId = default(string), string linkedTransactionNumber = default(string), string linkedTransactionType = default(string), string notes = default(string), string number = default(string), string recognitionRuleName = default(string), decimal recognizedRevenue = default(decimal), string referenceId = default(string), List<GETRsRevenueItemType> revenueItems = default(List<GETRsRevenueItemType>), DateTime revenueScheduleDate = default(DateTime), string subscriptionChargeId = default(string), string subscriptionId = default(string), decimal undistributedUnrecognizedRevenue = default(decimal), decimal unrecognizedRevenue = default(decimal), DateTime updatedOn = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The date when the revenue automation start date was set, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GETRSDetailWithoutSuccessTypeAllOf {\n");
        ...
        {
            return this.Equals(input as GETRSDetailWithoutSuccessTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETRSDetailWithoutSuccessTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRSDetailWithoutSuccessTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRSDetailWithoutSuccessTypeAllOf input)
        {
            if (input == null)
            {
                return false;
