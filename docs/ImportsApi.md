# ZuoraClient.Api.ImportsApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**ObjectGETImport**](ImportsApi.md#objectgetimport) | **GET** /v1/object/import/{id} | CRUD: Retrieve an import |
| [**ObjectPOSTImport**](ImportsApi.md#objectpostimport) | **POST** /v1/object/import | CRUD: Create an import |

<a name="objectgetimport"></a>
# **ObjectGETImport**
> ProxyGetImport ObjectGETImport (string id, string authorization = null, string zuoraEntityIds = null, string zuoraTrackId = null, string fields = null)
...
namespace Example
{
    public class ObjectGETImportExample
    {
        public static void Main()
        {
            ...
            {
                // CRUD: Retrieve an import
                ProxyGetImport result = apiInstance.ObjectGETImport(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling ImportsApi.ObjectGETImport: " + e.Message);
...
#### Using the ObjectGETImportWithHttpInfo variant
...
{
    // CRUD: Retrieve an import
    ApiResponse<ProxyGetImport> response = apiInstance.ObjectGETImportWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
...
{
    Debug.Print("Exception when calling ImportsApi.ObjectGETImportWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
# **ObjectPOSTImport**
> ProxyPostImport ObjectPOSTImport (string importType, string name, System.IO.Stream file, string authorization = null, bool? rejectUnknownFields = null, string zuoraEntityIds = null, string zuoraTrackId = null)
...
namespace Example
{
    public class ObjectPOSTImportExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            config.BasePath = "https://rest.zuora.com";
            var apiInstance = new ImportsApi(config);
            var importType = "Usage";  // string | The type of data to import. 
            var name = "name_example";  // string | A descriptive name for the import. 
            var file = new System.IO.MemoryStream(System.IO.File.ReadAllBytes("/path/to/file.txt"));  // System.IO.Stream | The data to import. 
            var authorization = "authorization_example";  // string | The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional) 
            ...
            {
                // CRUD: Create an import
                ProxyPostImport result = apiInstance.ObjectPOSTImport(importType, name, file, authorization, rejectUnknownFields, zuoraEntityIds, zuoraTrackId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling ImportsApi.ObjectPOSTImport: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the ObjectPOSTImportWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // CRUD: Create an import
    ApiResponse<ProxyPostImport> response = apiInstance.ObjectPOSTImportWithHttpInfo(importType, name, file, authorization, rejectUnknownFields, zuoraEntityIds, zuoraTrackId);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ImportsApi.ObjectPOSTImportWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **importType** | **string** | The type of data to import.  |  |
| **name** | **string** | A descriptive name for the import.  |  |
| **file** | **System.IO.Stream****System.IO.Stream** | The data to import.  |  |
| **authorization** | **string** | The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  | [optional]  |
