...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETCreditMemoType_allOf")]
    public partial class GETCreditMemoTypeAllOf : IEquatable<GETCreditMemoTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETCreditMemoTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETCreditMemoTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETCreditMemoTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETCreditMemoTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETCreditMemoTypeAllOf input)
        {
            if (input == null)
            {
                return false;
