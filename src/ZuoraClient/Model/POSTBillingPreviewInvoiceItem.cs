...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTBillingPreviewInvoiceItem")]
    public partial class POSTBillingPreviewInvoiceItem : IEquatable<POSTBillingPreviewInvoiceItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTBillingPreviewInvoiceItem" /> class.
        /// </summary>
        ...
        /// <param name="chargeDate">The date when the invoice item was created. .</param>
        ...
        /// <param name="subscriptionName">Name of the subscription associated with this item. .</param>
        /// <param name="subscriptionNumber">Number of the subscription associated with this item. .</param>
        /// <param name="taxAmount">If you use [Zuora Tax](https://knowledgecenter.zuora.com/Billing/Taxes/A_Zuora_Tax) and the product rate plan charge associated with the invoice item is of [tax inclusive mode](https://knowledgecenter.zuora.com/Billing/Taxes/A_Zuora_Tax/D_Associate_tax_codes_with_product_charges_and_set_the_tax_mode), the value of this field is the amount of tax applied to the charge. Otherwise, the value of this field is &#x60;0&#x60;.  .</param>
        /// <param name="unitOfMeasure">Unit used to measure consumption. .</param>
        public POSTBillingPreviewInvoiceItem(string appliedToItemId = default(string), decimal chargeAmount = default(decimal), DateTime chargeDate = default(DateTime), string chargeDescription = default(string), string chargeId = default(string), string chargeName = default(string), string chargeNumber = default(string), string chargeType = default(string), string id = default(string), string processingType = default(string), string productName = default(string), decimal quantity = default(decimal), DateTime serviceEndDate = default(DateTime), DateTime serviceStartDate = default(DateTime), string subscriptionId = default(string), string subscriptionName = default(string), string subscriptionNumber = default(string), decimal taxAmount = default(decimal), string unitOfMeasure = default(string))
        {
        ...
        /// </summary>
        /// <value>The date when the invoice item was created. </value>
        ...
        /// </summary>
        /// <value>Number of the subscription associated with this item. </value>
        ...
        /// </summary>
        /// <value>If you use [Zuora Tax](https://knowledgecenter.zuora.com/Billing/Taxes/A_Zuora_Tax) and the product rate plan charge associated with the invoice item is of [tax inclusive mode](https://knowledgecenter.zuora.com/Billing/Taxes/A_Zuora_Tax/D_Associate_tax_codes_with_product_charges_and_set_the_tax_mode), the value of this field is the amount of tax applied to the charge. Otherwise, the value of this field is &#x60;0&#x60;.  </value>
        ...
        {
            return this.Equals(input as POSTBillingPreviewInvoiceItem);
        }

        /// <summary>
        /// Returns true if POSTBillingPreviewInvoiceItem instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTBillingPreviewInvoiceItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTBillingPreviewInvoiceItem input)
        {
            if (input == null)
            {
                return false;
