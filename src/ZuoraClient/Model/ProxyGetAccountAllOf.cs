...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetAccount_allOf")]
    public partial class ProxyGetAccountAllOf : IEquatable<ProxyGetAccountAllOf>, IValidatableObject
    {
        /// <summary>
        /// Status of the account in the system. 
        /// </summary>
        /// <value>Status of the account in the system. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetAccountAllOf" /> class.
        /// </summary>
        ...
        /// <param name="currency"> Currency that the customer is billed in. .</param>
        ...
        /// <param name="defaultPaymentMethodId">ID of the default payment method for the account. This field is required if the AutoPay field is set to &#x60;true&#x60;. **Character limit**: 32 **Values**: a valid ID for an existing payment method .</param>
        ...
        /// <param name="paymentGateway">Gateway used for processing electronic payments and refunds. **Character limit**: 40 **Values**: one of the following:  - a valid configured gateway name - Null to inherit the default value set in Payment Settings .</param>
        ...
        /// <param name="status">Status of the account in the system. .</param>
        ...
        public ProxyGetAccountAllOf(string accountNumber = default(string), string additionalEmailAddresses = default(string), bool allowInvoiceEdit = default(bool), bool autoPay = default(bool), double balance = default(double), string batch = default(string), string bcdSettingOption = default(string), int billCycleDay = default(int), string billToId = default(string), string communicationProfileId = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), double creditBalance = default(double), string crmId = default(string), string currency = default(string), string customerServiceRepName = default(string), string defaultPaymentMethodId = default(string), string id = default(string), bool invoiceDeliveryPrefsEmail = default(bool), bool invoiceDeliveryPrefsPrint = default(bool), string invoiceTemplateId = default(string), DateTime lastInvoiceDate = default(DateTime), string name = default(string), string notes = default(string), string parentId = default(string), string paymentGateway = default(string), string paymentTerm = default(string), string purchaseOrderNumber = default(string), string salesRepName = default(string), string soldToId = default(string), StatusEnum? status = default(StatusEnum?), string taxCompanyCode = default(string), string taxExemptCertificateID = default(string), string taxExemptCertificateType = default(string), string taxExemptDescription = default(string), DateTime taxExemptEffectiveDate = default(DateTime), DateTime taxExemptExpirationDate = default(DateTime), string taxExemptIssuingJurisdiction = default(string), string taxExemptStatus = default(string), double totalInvoiceBalance = default(double), string updatedById = default(string), DateTime updatedDate = default(DateTime), string vATId = default(string))
        {
        ...
        /// </summary>
        /// <value> Currency that the customer is billed in. </value>
        ...
        /// </summary>
        /// <value>ID of the default payment method for the account. This field is required if the AutoPay field is set to &#x60;true&#x60;. **Character limit**: 32 **Values**: a valid ID for an existing payment method </value>
        ...
        /// </summary>
        /// <value>Gateway used for processing electronic payments and refunds. **Character limit**: 40 **Values**: one of the following:  - a valid configured gateway name - Null to inherit the default value set in Payment Settings </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetAccountAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetAccountAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetAccountAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetAccountAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetAccountAllOf input)
        {
            if (input == null)
            {
                return false;
