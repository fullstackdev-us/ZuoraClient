...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountTypeBasicInfo")]
    public partial class GETAccountTypeBasicInfo : IEquatable<GETAccountTypeBasicInfo>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETAccountTypeBasicInfo);
        }

        /// <summary>
        /// Returns true if GETAccountTypeBasicInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountTypeBasicInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountTypeBasicInfo input)
        {
            if (input == null)
            {
                return false;
