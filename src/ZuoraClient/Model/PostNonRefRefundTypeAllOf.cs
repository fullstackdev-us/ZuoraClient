...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNonRefRefundType_allOf")]
    public partial class PostNonRefRefundTypeAllOf : IEquatable<PostNonRefRefundTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNonRefRefundTypeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostNonRefRefundTypeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNonRefRefundTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PostNonRefRefundTypeAllOf);
        }

        /// <summary>
        /// Returns true if PostNonRefRefundTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNonRefRefundTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNonRefRefundTypeAllOf input)
        {
            if (input == null)
            {
                return false;
