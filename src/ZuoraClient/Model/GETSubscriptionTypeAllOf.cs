...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETSubscriptionType_allOf")]
    public partial class GETSubscriptionTypeAllOf : IEquatable<GETSubscriptionTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETSubscriptionTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETSubscriptionTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETSubscriptionTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETSubscriptionTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETSubscriptionTypeAllOf input)
        {
            if (input == null)
            {
                return false;
