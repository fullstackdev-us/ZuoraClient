...
namespace ZuoraClient.Model
{
    ...
    /// PUTCreditMemoType
    /// </summary>
    [DataContract(Name = "PUTCreditMemoType")]
    public partial class PUTCreditMemoType : IEquatable<PUTCreditMemoType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTCreditMemoType" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PUTCreditMemoType);
        }

        /// <summary>
        /// Returns true if PUTCreditMemoType instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTCreditMemoType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTCreditMemoType input)
        {
            if (input == null)
            {
                return false;
