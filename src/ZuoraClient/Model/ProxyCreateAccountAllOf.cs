...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyCreateAccount_allOf")]
    public partial class ProxyCreateAccountAllOf : IEquatable<ProxyCreateAccountAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateAccountAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateAccountAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateAccountAllOf" /> class.
        /// </summary>
        ...
        /// <param name="batch"> Organizes your customer accounts into groups to optimize your billing and payment operations. Required if use the Subscribe call. **Character limit**: 20 **Values**:any system-defined batch (&#x60;Batch1&#x60; - &#x60;Batch50 &#x60;or by name). .</param>
        ...
        /// <param name="billToId">ID of the person to bill for the account. This field is only required if the &#x60;Status&#x60; field is set to &#x60;Active&#x60;. **Character limit**: 32 **Values**: a valid contact ID for the account .</param>
        ...
        /// <param name="currency"> Currency that the customer is billed in.  (required).</param>
        ...
        /// <param name="soldToId">ID of the person who bought the subscription associated with the account. This field is only required if the &#x60;Status&#x60; field is set to &#x60;Active&#x60;. **Character limit**: 32 **Values**: a valid contact ID for the account .</param>
        /// <param name="status">Status of the account in the system.  (required).</param>
        ...
        /// </summary>
        /// <value> Organizes your customer accounts into groups to optimize your billing and payment operations. Required if use the Subscribe call. **Character limit**: 20 **Values**:any system-defined batch (&#x60;Batch1&#x60; - &#x60;Batch50 &#x60;or by name). </value>
        ...
        /// </summary>
        /// <value>ID of the person to bill for the account. This field is only required if the &#x60;Status&#x60; field is set to &#x60;Active&#x60;. **Character limit**: 32 **Values**: a valid contact ID for the account </value>
        ...
        /// </summary>
        /// <value>Gateway used for processing electronic payments and refunds. This field is only required if there is no default payment gateway is defined in the tenant. **Character limit**: 40 **Values**: one of the following:  - a valid configured gateway name - Null to inherit the default value set in Zuora Payment Settings </value>
        ...
        /// </summary>
        /// <value>ID of the person who bought the subscription associated with the account. This field is only required if the &#x60;Status&#x60; field is set to &#x60;Active&#x60;. **Character limit**: 32 **Values**: a valid contact ID for the account </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyCreateAccountAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyCreateAccountAllOf);
        }

        /// <summary>
        /// Returns true if ProxyCreateAccountAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreateAccountAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateAccountAllOf input)
        {
            if (input == null)
            {
                return false;
