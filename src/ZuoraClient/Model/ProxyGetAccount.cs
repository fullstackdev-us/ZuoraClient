...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetAccount
    /// </summary>
    [DataContract(Name = "ProxyGetAccount")]
    public partial class ProxyGetAccount : IEquatable<ProxyGetAccount>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyGetAccount);
        }

        /// <summary>
        /// Returns true if ProxyGetAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetAccount input)
        {
            if (input == null)
            {
                return false;
