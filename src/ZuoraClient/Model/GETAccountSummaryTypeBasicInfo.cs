...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountSummaryTypeBasicInfo")]
    public partial class GETAccountSummaryTypeBasicInfo : IEquatable<GETAccountSummaryTypeBasicInfo>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETAccountSummaryTypeBasicInfo);
        }

        /// <summary>
        /// Returns true if GETAccountSummaryTypeBasicInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountSummaryTypeBasicInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummaryTypeBasicInfo input)
        {
            if (input == null)
            {
                return false;
