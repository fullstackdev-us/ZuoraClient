...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountingPeriodType_allOf")]
    public partial class GETAccountingPeriodTypeAllOf : IEquatable<GETAccountingPeriodTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountingPeriodTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETAccountingPeriodTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETAccountingPeriodTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountingPeriodTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountingPeriodTypeAllOf input)
        {
            if (input == null)
            {
                return false;
