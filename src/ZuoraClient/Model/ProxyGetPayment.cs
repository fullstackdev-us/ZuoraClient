...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetPayment
    /// </summary>
    [DataContract(Name = "ProxyGetPayment")]
    public partial class ProxyGetPayment : IEquatable<ProxyGetPayment>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>How the payment was created, whether through the API, manually, import, or payment run. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum SourceEnum
        {
            /// <summary>
            /// Enum PaymentRun for value: PaymentRun
            /// </summary>
            [EnumMember(Value = "PaymentRun")]
            PaymentRun = 1,
        ...
        /// </summary>
        /// <value>Indicates if the payment was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <param name="accountId">The unique account ID for the customer that the payment is for. .</param>
        ...
        /// <param name="appliedAmount">The applied amount of the payment.  **Note**: This field is only available if you have the Invoice Settlement feature enabled. .</param>
        /// <param name="appliedCreditBalanceAmount">If you have the Invoice Settlement feature disabled, the value of this field is the amount of the payment to apply to a credit balance.  If you have the Invoice Settlement feature enabled, the value of this field returned in the response is &#x60;0&#x60; for the payments that are created after the enablement. .</param>
        ...
        /// <param name="cancelledOn">The date and time when the payment was canceled. .</param>
        ...
        /// <param name="createdDate">The date and time when the payment was created. .</param>
        /// <param name="effectiveDate">The date when the payment takes effect. .</param>
        /// <param name="gateway">The name of the gateway instance that processes the payment.  .</param>
        ...
        /// <param name="markedForSubmissionOn">The date and time when a payment was marked and waiting for batch submission to the payment process.  .</param>
        /// <param name="paymentMethodId">The ID of the payment method used for the payment.  .</param>
        ...
        /// <param name="paymentNumber">The unique identification number of the payment. For example, P-00000028. .</param>
        ...
        /// <param name="refundAmount">The amount of the payment that is refunded. The value of this field is &#x60;0&#x60; if no refund is made against the payment. .</param>
        ...
        /// <param name="settledOn">The date and time when the payment was settled in the payment processor. This field is used by the Spectrum gateway only and not applicable to other gateways. .</param>
        ...
        /// <param name="source">How the payment was created, whether through the API, manually, import, or payment run. .</param>
        /// <param name="sourceName">The name of the source. The value is a Payment Run number or a file name. .</param>
        /// <param name="status">The status of the payment in Zuora. The value depends on the type of payments.  - If you have the Invoice Settlement feature disabled, for electronic payments, the status can be &#x60;Processed&#x60;, &#x60;Processing&#x60;, &#x60;Error&#x60;, or &#x60;Voided&#x60;. For external payments, the status can be &#x60;Processed&#x60; or &#x60;Canceled&#x60;. - If you have the Invoice Settlement feature enabled, for electronic payments, the status can be &#x60;Processed&#x60;, &#x60;Processing&#x60;, &#x60;Error&#x60;, or &#x60;Canceled&#x60;. For external payments, the status can be &#x60;Processed&#x60; or &#x60;Canceled&#x60;. .</param>
        /// <param name="submittedOn">The date and time when the payment was submitted. .</param>
        /// <param name="transferredToAccounting">Indicates if the payment was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite. .</param>
        /// <param name="type">The type of the payment, whether the payment is external or electronic. .</param>
        /// <param name="unappliedAmount">The unapplied amount of the payment.  **Note**: This field is only available if you have the Invoice Settlement feature enabled. .</param>
        /// <param name="updatedById">The ID of the Zuora user who last updated the payment. .</param>
        /// <param name="updatedDate">The date and time when the payment was last updated. .</param>
        ...
        public ProxyGetPayment(string accountId = default(string), string accountingCode = default(string), double amount = default(double), double appliedAmount = default(double), double appliedCreditBalanceAmount = default(double), string authTransactionId = default(string), string bankIdentificationNumber = default(string), DateTime cancelledOn = default(DateTime), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), DateTime effectiveDate = default(DateTime), string gateway = default(string), string gatewayOrderId = default(string), string gatewayResponse = default(string), string gatewayResponseCode = default(string), GatewayStateEnum? gatewayState = default(GatewayStateEnum?), string id = default(string), DateTime markedForSubmissionOn = default(DateTime), string paymentMethodId = default(string), string paymentMethodSnapshotId = default(string), string paymentNumber = default(string), string referenceId = default(string), double refundAmount = default(double), string secondPaymentReferenceId = default(string), DateTime settledOn = default(DateTime), string softDescriptor = default(string), string softDescriptorPhone = default(string), SourceEnum? source = default(SourceEnum?), string sourceName = default(string), StatusEnum? status = default(StatusEnum?), DateTime submittedOn = default(DateTime), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), TypeEnum? type = default(TypeEnum?), double unappliedAmount = default(double), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string transactionNS = default(string))
        {
        ...
        /// <summary>
        /// The applied amount of the payment.  **Note**: This field is only available if you have the Invoice Settlement feature enabled. 
        /// </summary>
        /// <value>The applied amount of the payment.  **Note**: This field is only available if you have the Invoice Settlement feature enabled. </value>
        [DataMember(Name = "AppliedAmount", EmitDefaultValue = false)]
        public double AppliedAmount { get; set; }

        /// <summary>
        /// If you have the Invoice Settlement feature disabled, the value of this field is the amount of the payment to apply to a credit balance.  If you have the Invoice Settlement feature enabled, the value of this field returned in the response is &#x60;0&#x60; for the payments that are created after the enablement. 
        /// </summary>
        /// <value>If you have the Invoice Settlement feature disabled, the value of this field is the amount of the payment to apply to a credit balance.  If you have the Invoice Settlement feature enabled, the value of this field returned in the response is &#x60;0&#x60; for the payments that are created after the enablement. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment was canceled. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment was created. </value>
        ...
        /// </summary>
        /// <value>The date when the payment takes effect. </value>
        ...
        /// </summary>
        /// <value>The name of the gateway instance that processes the payment.  </value>
        ...
        /// </summary>
        /// <value>The unique ID of a payment. For example, 2c92c095592623ea01596621ada84352. </value>
        ...
        /// </summary>
        /// <value>The date and time when a payment was marked and waiting for batch submission to the payment process.  </value>
        ...
        /// </summary>
        /// <value>The ID of the payment method used for the payment.  </value>
        ...
        /// </summary>
        /// <value>The unique identification number of the payment. For example, P-00000028. </value>
        ...
        /// </summary>
        /// <value>The amount of the payment that is refunded. The value of this field is &#x60;0&#x60; if no refund is made against the payment. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment was settled in the payment processor. This field is used by the Spectrum gateway only and not applicable to other gateways. </value>
        ...
        /// </summary>
        /// <value>The name of the source. The value is a Payment Run number or a file name. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment was submitted. </value>
        [DataMember(Name = "SubmittedOn", EmitDefaultValue = false)]
        public DateTime SubmittedOn { get; set; }

        /// <summary>
        /// The unapplied amount of the payment.  **Note**: This field is only available if you have the Invoice Settlement feature enabled. 
        /// </summary>
        /// <value>The unapplied amount of the payment.  **Note**: This field is only available if you have the Invoice Settlement feature enabled. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment was last updated. </value>
        ...
        {
            return this.Equals(input as ProxyGetPayment);
        }

        /// <summary>
        /// Returns true if ProxyGetPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetPayment input)
        {
            if (input == null)
            {
                return false;
