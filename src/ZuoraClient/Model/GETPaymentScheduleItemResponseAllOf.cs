...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETPaymentScheduleItemResponse_allOf")]
    public partial class GETPaymentScheduleItemResponseAllOf : IEquatable<GETPaymentScheduleItemResponseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>ID of the payment method of the payment schedule item.  - &#x60;Pending&#x60;: Waiting for processing. - &#x60;Processed&#x60;: The payment has been collected. - &#x60;Error&#x60;: Failed to collect the payment. - &#x60;Canceled&#x60;: After a pending payment schedule item is canceled by the user, the item is marked as &#x60;Canceled&#x60;. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETPaymentScheduleItemResponseAllOf" /> class.
        /// </summary>
        ...
        /// <param name="errorMessage">The error message indicating if the error is related to the configuration or the payment collection. .</param>
        ...
        /// <param name="standalone">Indicates if the payment created by the payment schedule item is a standalone payment. .</param>
        /// <param name="status">ID of the payment method of the payment schedule item.  - &#x60;Pending&#x60;: Waiting for processing. - &#x60;Processed&#x60;: The payment has been collected. - &#x60;Error&#x60;: Failed to collect the payment. - &#x60;Canceled&#x60;: After a pending payment schedule item is canceled by the user, the item is marked as &#x60;Canceled&#x60;. .</param>
        ...
        public GETPaymentScheduleItemResponseAllOf(string accountId = default(string), decimal amount = default(decimal), GETPaymentScheduleItemResponseAllOfBillingDocument billingDocument = default(GETPaymentScheduleItemResponseAllOfBillingDocument), string createdById = default(string), DateTime createdDate = default(DateTime), string currency = default(string), string description = default(string), string errorMessage = default(string), string id = default(string), string number = default(string), string paymentGatewayId = default(string), string paymentId = default(string), string paymentMethodId = default(string), string paymentScheduleId = default(string), string paymentScheduleNumber = default(string), int runHour = default(int), DateTime scheduledDate = default(DateTime), bool standalone = default(bool), StatusEnum? status = default(StatusEnum?), bool success = default(bool), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The error message indicating if the error is related to the configuration or the payment collection. </value>
        ...
        /// </summary>
        /// <value>Indicates if the payment created by the payment schedule item is a standalone payment. </value>
        ...
        {
            return this.Equals(input as GETPaymentScheduleItemResponseAllOf);
        }

        /// <summary>
        /// Returns true if GETPaymentScheduleItemResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETPaymentScheduleItemResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPaymentScheduleItemResponseAllOf input)
        {
            if (input == null)
            {
                return false;
