...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountingCodeItemType")]
    public partial class GETAccountingCodeItemType : IEquatable<GETAccountingCodeItemType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETAccountingCodeItemType);
        }

        /// <summary>
        /// Returns true if GETAccountingCodeItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountingCodeItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountingCodeItemType input)
        {
            if (input == null)
            {
                return false;
