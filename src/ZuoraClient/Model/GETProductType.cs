...
namespace ZuoraClient.Model
{
    ...
    /// GETProductType
    /// </summary>
    [DataContract(Name = "GETProductType")]
    public partial class GETProductType : IEquatable<GETProductType>, IValidatableObject
    {
        ...
        public GETProductType(string category = default(string), string description = default(string), DateTime effectiveEndDate = default(DateTime), DateTime effectiveStartDate = default(DateTime), string id = default(string), string name = default(string), List<GetProductFeatureType> productFeatures = default(List<GetProductFeatureType>), string productRatePlans = default(string), string sku = default(string), string tags = default(string), string integrationIdNS = default(string), string integrationStatusNS = default(string), ItemTypeNSEnum? itemTypeNS = default(ItemTypeNSEnum?), string syncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value>Container for one or more product features. Only available when the following settings are enabled: - The Entitlements feature in your tenant - The Enable Feature Specification in Product and Subscriptions setting in Settings &gt; Billing </value>
        ...
        /// </summary>
        /// <value>URL to retrieve information about all product rate plans of a specific product. For example, &#x60;/v1/rateplan/40289f466463d683016463ef8b7301a0/productRatePlan&#x60;. If you want to view the product rate plan details, call [List all product rate plans of a product](https://www.zuora.com/developer/api-reference/#operation/GET_ProductRatePlans) with the returned URL.  This field is in Zuora REST API version control. If you set the &#x60;zuora-version&#x60; request header to &#x60;230.0&#x60; or later, the value of this field is a URL. Zuora recommends that you use the latest behavior to retrieve product information.  If you do not set the &#x60;zuora-version&#x60; request header or you set this header to &#x60;229.0&#x60; or earlier, the value of this field is an array of product rate plan details. For more information about the array, see the response body of [List all product rate plans of a product](https://www.zuora.com/developer/api-reference/#operation/GET_ProductRatePlans). **Note**: The array contains a maximum of 300 product rate plans. Additionally, across all product rate plans, at most 300 product rate plan charges are returned. </value>
        [DataMember(Name = "productRatePlans", EmitDefaultValue = false)]
        public string ProductRatePlans { get; set; }
        ...
        {
            return this.Equals(input as GETProductType);
        }

        /// <summary>
        /// Returns true if GETProductType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETProductType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETProductType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProductRatePlans == input.ProductRatePlans ||
                    (this.ProductRatePlans != null &&
                    this.ProductRatePlans.Equals(input.ProductRatePlans))
                ) && 
                (
                    this.Sku == input.Sku ||
                    (this.Sku != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ProductRatePlans.GetHashCode();
                }
                if (this.Sku != null)
                {
