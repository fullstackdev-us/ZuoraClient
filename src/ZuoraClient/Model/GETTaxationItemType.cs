...
namespace ZuoraClient.Model
{
    ...
    /// GETTaxationItemType
    /// </summary>
    [DataContract(Name = "GETTaxationItemType")]
    public partial class GETTaxationItemType : IEquatable<GETTaxationItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETTaxationItemType" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETTaxationItemType);
        }

        /// <summary>
        /// Returns true if GETTaxationItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETTaxationItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETTaxationItemType input)
        {
            if (input == null)
            {
                return false;
