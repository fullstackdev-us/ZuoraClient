...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetInvoice
    /// </summary>
    [DataContract(Name = "ProxyGetInvoice")]
    public partial class ProxyGetInvoice : IEquatable<ProxyGetInvoice>, IValidatableObject
    {
        ...
        /// <param name="includesOneTime">Whether the bill run picks up all one-time charges for processing. You can use this field only with the Generate call for the Invoice object.  (default to true).</param>
        /// <param name="includesRecurring">Whether the bill run picks up all recurring charges for processing. You can use this field only with the Generate call for the Invoice object.  (default to true).</param>
        /// <param name="includesUsage">Whether the bill run picks up all usage charges for processing. You can use this field only with the Generate call for the Invoice object.  (default to true).</param>
        ...
        /// <param name="paymentTerm">The name of payment term associated with the invoice.  **Note**: This field is available only if you set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;118&#x60; or later. The value of this field is &#x60;null&#x60; if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature disabled. .</param>
        ...
        /// <param name="sourceType"> The type of the invoice source. **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;118&#x60; or later. Otherwise, an error occurs. **Character limit**: 16 **Values**: one of the following enum values:  -  Subscription  -  Standalone  -  Order  -  Consolidation .</param>
        ...
        public ProxyGetInvoice(string accountId = default(string), double adjustmentAmount = default(double), double amount = default(double), double amountWithoutTax = default(double), double balance = default(double), string billToContactId = default(string), string body = default(string), string comments = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), double creditBalanceAdjustmentAmount = default(double), DateTime dueDate = default(DateTime), string id = default(string), bool includesOneTime = true, bool includesRecurring = true, bool includesUsage = true, DateTime invoiceDate = default(DateTime), string invoiceNumber = default(string), DateTime lastEmailSentDate = default(DateTime), double paymentAmount = default(double), string paymentTerm = default(string), string postedBy = default(string), DateTime postedDate = default(DateTime), double refundAmount = default(double), string sourceType = default(string), string status = default(string), DateTime targetDate = default(DateTime), double taxAmount = default(double), double taxExemptAmount = default(double), string transferredToAccounting = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// <summary>
        /// The ID of bill-to contact associated with the invoice.   **Note**: This field is available only if you set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;118&#x60; or later. The value of this field is &#x60;null&#x60; if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature disabled. 
        /// </summary>
        /// <value>The ID of bill-to contact associated with the invoice.   **Note**: This field is available only if you set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;118&#x60; or later. The value of this field is &#x60;null&#x60; if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature disabled. </value>
        ...
        /// </summary>
        /// <value>Whether the bill run picks up all one-time charges for processing. You can use this field only with the Generate call for the Invoice object. </value>
        [DataMember(Name = "IncludesOneTime", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Whether the bill run picks up all recurring charges for processing. You can use this field only with the Generate call for the Invoice object. </value>
        [DataMember(Name = "IncludesRecurring", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Whether the bill run picks up all usage charges for processing. You can use this field only with the Generate call for the Invoice object. </value>
        [DataMember(Name = "IncludesUsage", EmitDefaultValue = true)]
        ...
        /// <summary>
        /// The name of payment term associated with the invoice.  **Note**: This field is available only if you set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;118&#x60; or later. The value of this field is &#x60;null&#x60; if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature disabled. 
        /// </summary>
        /// <value>The name of payment term associated with the invoice.  **Note**: This field is available only if you set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;118&#x60; or later. The value of this field is &#x60;null&#x60; if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature disabled. </value>
        ...
        /// <summary>
        ///  The type of the invoice source. **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;118&#x60; or later. Otherwise, an error occurs. **Character limit**: 16 **Values**: one of the following enum values:  -  Subscription  -  Standalone  -  Order  -  Consolidation 
        /// </summary>
        /// <value> The type of the invoice source. **Note**: To use this field, you must set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;118&#x60; or later. Otherwise, an error occurs. **Character limit**: 16 **Values**: one of the following enum values:  -  Subscription  -  Standalone  -  Order  -  Consolidation </value>
        ...
        {
            return this.Equals(input as ProxyGetInvoice);
        }

        /// <summary>
        /// Returns true if ProxyGetInvoice instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetInvoice input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.IncludesOneTime == input.IncludesOneTime ||
                    this.IncludesOneTime.Equals(input.IncludesOneTime)
                ) && 
                (
                    this.IncludesRecurring == input.IncludesRecurring ||
                    this.IncludesRecurring.Equals(input.IncludesRecurring)
                ) && 
                (
                    this.IncludesUsage == input.IncludesUsage ||
                    this.IncludesUsage.Equals(input.IncludesUsage)
                ) && 
                (
                ...
                (
                    this.LastEmailSentDate == input.LastEmailSentDate ||
                    (this.LastEmailSentDate != null &&
                    this.LastEmailSentDate.Equals(input.LastEmailSentDate))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.IncludesOneTime.GetHashCode();
                hashCode = (hashCode * 59) + this.IncludesRecurring.GetHashCode();
                hashCode = (hashCode * 59) + this.IncludesUsage.GetHashCode();
                ...
                {
                    hashCode = (hashCode * 59) + this.LastEmailSentDate.GetHashCode();
                }
