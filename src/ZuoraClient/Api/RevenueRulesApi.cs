...
namespace ZuoraClient.Api
{
    ...
    /// </summary>
    public interface IRevenueRulesApiSync : IApiAccessor
    {
        ...
        GETRevenueStartDateSettingType GETRevenueAutomationStartDate(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        ...
        ApiResponse<GETRevenueStartDateSettingType> GETRevenueAutomationStartDateWithHttpInfo(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        /// <summary>
        ...
        GETRevenueRecognitionRuleAssociationType GETRevenueRecRulebyProductRatePlanCharge(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        ...
        ApiResponse<GETRevenueRecognitionRuleAssociationType> GETRevenueRecRulebyProductRatePlanChargeWithHttpInfo(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="chargeKey">The unique ID of the subscription rate plan charge. For example, 402892793e173340013e173b81000012. </param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETRevenueRecognitionRuleAssociationType</returns>
        GETRevenueRecognitionRuleAssociationType GETRevenueRecRules(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETRevenueRecognitionRuleAssociationType</returns>
        ApiResponse<GETRevenueRecognitionRuleAssociationType> GETRevenueRecRulesWithHttpInfo(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRevenueRulesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<GETRevenueStartDateSettingType>> GETRevenueAutomationStartDateWithHttpInfoAsync(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a revenue recognition rule by product rate plan charge ID
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GETRevenueRecognitionRuleAssociationType> GETRevenueRecRulebyProductRatePlanChargeAsync(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GETRevenueRecognitionRuleAssociationType>> GETRevenueRecRulebyProductRatePlanChargeWithHttpInfoAsync(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a revenue recognition rule by subscription charge ID
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETRevenueRecognitionRuleAssociationType</returns>
        System.Threading.Tasks.Task<GETRevenueRecognitionRuleAssociationType> GETRevenueRecRulesAsync(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETRevenueRecognitionRuleAssociationType)</returns>
        System.Threading.Tasks.Task<ApiResponse<GETRevenueRecognitionRuleAssociationType>> GETRevenueRecRulesWithHttpInfoAsync(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRevenueRulesApi : IRevenueRulesApiSync, IRevenueRulesApiAsync
    {
    ...
    public partial class RevenueRulesApi : IRevenueRulesApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public RevenueRulesApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public RevenueRulesApi(ZuoraClient.Client.Configuration configuration)
        {
        ...
        public RevenueRulesApi(ZuoraClient.Client.ISynchronousClient client, ZuoraClient.Client.IAsynchronousClient asyncClient, ZuoraClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve a revenue automation start date Describes how to get the revenue automation start date. Request and response field descriptions and sample code are provided. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETRevenueStartDateSettingType</returns>
        public GETRevenueStartDateSettingType GETRevenueAutomationStartDate(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GETRevenueStartDateSettingType> localVarResponse = GETRevenueAutomationStartDateWithHttpInfo(authorization, zuoraTrackId, zuoraEntityIds);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETRevenueStartDateSettingType</returns>
        public ZuoraClient.Client.ApiResponse<GETRevenueStartDateSettingType> GETRevenueAutomationStartDateWithHttpInfo(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "RevenueRulesApi.GETRevenueAutomationStartDate";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<GETRevenueStartDateSettingType>("/v1/settings/finance/revenue-automation-start-date", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETRevenueAutomationStartDate", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETRevenueStartDateSettingType</returns>
        public async System.Threading.Tasks.Task<GETRevenueStartDateSettingType> GETRevenueAutomationStartDateAsync(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GETRevenueStartDateSettingType> localVarResponse = await GETRevenueAutomationStartDateWithHttpInfoAsync(authorization, zuoraTrackId, zuoraEntityIds, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETRevenueStartDateSettingType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GETRevenueStartDateSettingType>> GETRevenueAutomationStartDateWithHttpInfoAsync(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GETRevenueStartDateSettingType>("/v1/settings/finance/revenue-automation-start-date", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a revenue recognition rule by product rate plan charge ID **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.   Retrieves the revenue recognition rule associated with a production rate plan charge by specifying the charge ID. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="chargeKey">The unique ID of a product rate plan charge. For example, 8a8082e65ba86084015bb323d3c61d82. </param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETRevenueRecognitionRuleAssociationType</returns>
        public GETRevenueRecognitionRuleAssociationType GETRevenueRecRulebyProductRatePlanCharge(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GETRevenueRecognitionRuleAssociationType> localVarResponse = GETRevenueRecRulebyProductRatePlanChargeWithHttpInfo(chargeKey, authorization, zuoraTrackId, zuoraEntityIds);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETRevenueRecognitionRuleAssociationType</returns>
        public ZuoraClient.Client.ApiResponse<GETRevenueRecognitionRuleAssociationType> GETRevenueRecRulebyProductRatePlanChargeWithHttpInfo(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'chargeKey' is set
            if (chargeKey == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'chargeKey' when calling RevenueRulesApi->GETRevenueRecRulebyProductRatePlanCharge");
            }
            ...
            localVarRequestOptions.Operation = "RevenueRulesApi.GETRevenueRecRulebyProductRatePlanCharge";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<GETRevenueRecognitionRuleAssociationType>("/v1/revenue-recognition-rules/product-charges/{charge-key}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETRevenueRecRulebyProductRatePlanCharge", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETRevenueRecognitionRuleAssociationType</returns>
        public async System.Threading.Tasks.Task<GETRevenueRecognitionRuleAssociationType> GETRevenueRecRulebyProductRatePlanChargeAsync(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GETRevenueRecognitionRuleAssociationType> localVarResponse = await GETRevenueRecRulebyProductRatePlanChargeWithHttpInfoAsync(chargeKey, authorization, zuoraTrackId, zuoraEntityIds, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETRevenueRecognitionRuleAssociationType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GETRevenueRecognitionRuleAssociationType>> GETRevenueRecRulebyProductRatePlanChargeWithHttpInfoAsync(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'chargeKey' is set
            if (chargeKey == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GETRevenueRecognitionRuleAssociationType>("/v1/revenue-recognition-rules/product-charges/{charge-key}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a revenue recognition rule by subscription charge ID Retrieves the revenue recognition rule associated with a subscription charge by specifying the charge ID. Request and response field descriptions and sample code are provided. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="chargeKey">The unique ID of the subscription rate plan charge. For example, 402892793e173340013e173b81000012. </param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETRevenueRecognitionRuleAssociationType</returns>
        public GETRevenueRecognitionRuleAssociationType GETRevenueRecRules(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GETRevenueRecognitionRuleAssociationType> localVarResponse = GETRevenueRecRulesWithHttpInfo(chargeKey, authorization, zuoraTrackId, zuoraEntityIds);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETRevenueRecognitionRuleAssociationType</returns>
        public ZuoraClient.Client.ApiResponse<GETRevenueRecognitionRuleAssociationType> GETRevenueRecRulesWithHttpInfo(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'chargeKey' is set
            if (chargeKey == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'chargeKey' when calling RevenueRulesApi->GETRevenueRecRules");
            }
            ...
            localVarRequestOptions.Operation = "RevenueRulesApi.GETRevenueRecRules";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<GETRevenueRecognitionRuleAssociationType>("/v1/revenue-recognition-rules/subscription-charges/{charge-key}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETRevenueRecRules", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETRevenueRecognitionRuleAssociationType</returns>
        public async System.Threading.Tasks.Task<GETRevenueRecognitionRuleAssociationType> GETRevenueRecRulesAsync(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GETRevenueRecognitionRuleAssociationType> localVarResponse = await GETRevenueRecRulesWithHttpInfoAsync(chargeKey, authorization, zuoraTrackId, zuoraEntityIds, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETRevenueRecognitionRuleAssociationType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GETRevenueRecognitionRuleAssociationType>> GETRevenueRecRulesWithHttpInfoAsync(string chargeKey, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'chargeKey' is set
            if (chargeKey == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GETRevenueRecognitionRuleAssociationType>("/v1/revenue-recognition-rules/subscription-charges/{charge-key}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
