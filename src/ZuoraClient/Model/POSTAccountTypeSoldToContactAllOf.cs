...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTAccountTypeSoldToContact_allOf")]
    public partial class POSTAccountTypeSoldToContactAllOf : IEquatable<POSTAccountTypeSoldToContactAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountTypeSoldToContactAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTAccountTypeSoldToContactAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountTypeSoldToContactAllOf" /> class.
        /// </summary>
        ...
        /// <param name="county">County; 32 characters or less. May optionally be used by Zuora Tax to calculate county tax. .</param>
        ...
        /// <param name="taxRegion">If using Zuora Tax, a region string as optionally defined in your tax rules. Not required. .</param>
        ...
        public POSTAccountTypeSoldToContactAllOf(string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickname = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string), string zipCode = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for POSTAccountTypeSoldToContactAllOf and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for POSTAccountTypeSoldToContactAllOf and cannot be null");
            }
        ...
        /// </summary>
        /// <value>County; 32 characters or less. May optionally be used by Zuora Tax to calculate county tax. </value>
        ...
        /// </summary>
        /// <value>If using Zuora Tax, a region string as optionally defined in your tax rules. Not required. </value>
        ...
        {
            return this.Equals(input as POSTAccountTypeSoldToContactAllOf);
        }

        /// <summary>
        /// Returns true if POSTAccountTypeSoldToContactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTAccountTypeSoldToContactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTAccountTypeSoldToContactAllOf input)
        {
            if (input == null)
            {
                return false;
