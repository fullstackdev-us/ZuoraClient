...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTSubscriptionPreviewTypePreviewAccountInfo")]
    public partial class POSTSubscriptionPreviewTypePreviewAccountInfo : IEquatable<POSTSubscriptionPreviewTypePreviewAccountInfo>, IValidatableObject
    {
        ...
        /// <param name="currency">A currency as defined in Billing Settings.  (required).</param>
        ...
        public POSTSubscriptionPreviewTypePreviewAccountInfo(long billCycleDay = default(long), POSTSubscriptionPreviewTypePreviewAccountInfoAllOfBillToContact billToContact = default(POSTSubscriptionPreviewTypePreviewAccountInfoAllOfBillToContact), string currency = default(string), string classNS = default(string), CustomerTypeNSEnum? customerTypeNS = default(CustomerTypeNSEnum?), string departmentNS = default(string), string integrationIdNS = default(string), string integrationStatusNS = default(string), string locationNS = default(string), string subsidiaryNS = default(string), string syncDateNS = default(string), SynctoNetSuiteNSEnum? synctoNetSuiteNS = default(SynctoNetSuiteNSEnum?))
        {
            this.BillCycleDay = billCycleDay;
            // to ensure "billToContact" is required (not null)
            if (billToContact == null)
            {
                throw new ArgumentNullException("billToContact is a required property for POSTSubscriptionPreviewTypePreviewAccountInfo and cannot be null");
            }
            this.BillToContact = billToContact;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for POSTSubscriptionPreviewTypePreviewAccountInfo and cannot be null");
            }
        ...
        public POSTSubscriptionPreviewTypePreviewAccountInfoAllOfBillToContact BillToContact { get; set; }

        /// <summary>
        /// A currency as defined in Billing Settings. 
        /// </summary>
        /// <value>A currency as defined in Billing Settings. </value>
        ...
        {
            return this.Equals(input as POSTSubscriptionPreviewTypePreviewAccountInfo);
        }

        /// <summary>
        /// Returns true if POSTSubscriptionPreviewTypePreviewAccountInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTSubscriptionPreviewTypePreviewAccountInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTSubscriptionPreviewTypePreviewAccountInfo input)
        {
            if (input == null)
            {
                return false;
