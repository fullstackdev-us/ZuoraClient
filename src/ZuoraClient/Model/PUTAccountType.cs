...
namespace ZuoraClient.Model
{
    ...
    /// PUTAccountType
    /// </summary>
    [DataContract(Name = "PUTAccountType")]
    public partial class PUTAccountType : IEquatable<PUTAccountType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PUTAccountType);
        }

        /// <summary>
        /// Returns true if PUTAccountType instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTAccountType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTAccountType input)
        {
            if (input == null)
            {
                return false;
