...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountTypeBillToContact")]
    public partial class GETAccountTypeBillToContact : IEquatable<GETAccountTypeBillToContact>, IValidatableObject
    {
        ...
        public GETAccountTypeBillToContact(string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string id = default(string), string lastName = default(string), string mobilePhone = default(string), string nickname = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string), string zipCode = default(string))
        {
        ...
        {
            return this.Equals(input as GETAccountTypeBillToContact);
        }

        /// <summary>
        /// Returns true if GETAccountTypeBillToContact instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountTypeBillToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountTypeBillToContact input)
        {
            if (input == null)
            {
                return false;
