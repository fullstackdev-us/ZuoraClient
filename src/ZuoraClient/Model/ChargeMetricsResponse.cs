...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChargeMetricsResponse")]
    public partial class ChargeMetricsResponse : IEquatable<ChargeMetricsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeMetricsResponse" /> class.
        /// </summary>
        /// <param name="amendmentId">The ID of the corresponding amendment that results in the charge metrics record. .</param>
        /// <param name="amendmentType">The type of the corresponding amendment that results in the charge metrics record. .</param>
        /// <param name="chargeNumber">The corresponding charge number of the charge metrics record. .</param>
        /// <param name="createdOn">The date and time when the charge metrics record was created, in &#x60;yyyy-mm-ddThh:mm:ssZ&#x60; format. .</param>
        /// <param name="currency">The currency of the charge metrics record. .</param>
        /// <param name="deleted">Whether the charge metrics record is deleted. .</param>
        /// <param name="endDate">The end date of the charge metrics record. .</param>
        /// <param name="id">The ID of the charge metrics record. .</param>
        /// <param name="invoiceOwnerAccountNumber">The account number of the corresponding invoice owner. .</param>
        /// <param name="mrrDiscountAmount">The discount amount for the MRR.  See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. .</param>
        /// <param name="mrrGrossAmount">The Gross MRR amount before discounts charges are applied.   See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. .</param>
        /// <param name="mrrNetAmount">The NET MRR amount after discounts charges are applied.  See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. .</param>
        /// <param name="productId">The corresponding product ID of the charge metrics record. .</param>
        /// <param name="productRatePlanChargeId">The corresponding product rate plan charge ID of the charge metrics record. .</param>
        /// <param name="productRatePlanId">The corresponding product rate plan ID of the charge metrics record. .</param>
        /// <param name="ratePlanChargeId">The corresponding rate plan charge ID of the charge metrics record. .</param>
        /// <param name="startDate">The start date of the charge metrics record. .</param>
        /// <param name="subscriptionName">The name of the corresponding subscription. .</param>
        /// <param name="subscriptionOwnerAccountNumber">The account number of the corresponding subscription owner. .</param>
        /// <param name="tcvDiscountAmount">The discount amount for the TCV. .</param>
        /// <param name="tcvGrossAmount">The Gross TCV amount before discount charges are applied. .</param>
        /// <param name="tcvNetAmount">The Net TCV amount after discount charges are applied. .</param>
        /// <param name="updatedOn">The date and time when the charge metrics record was last updated, in &#x60;yyyy-mm-ddThh:mm:ssZ&#x60; format. .</param>
        public ChargeMetricsResponse(string amendmentId = default(string), string amendmentType = default(string), string chargeNumber = default(string), DateTime createdOn = default(DateTime), string currency = default(string), bool deleted = default(bool), DateTime endDate = default(DateTime), string id = default(string), string invoiceOwnerAccountNumber = default(string), decimal mrrDiscountAmount = default(decimal), decimal mrrGrossAmount = default(decimal), decimal mrrNetAmount = default(decimal), string productId = default(string), string productRatePlanChargeId = default(string), string productRatePlanId = default(string), string ratePlanChargeId = default(string), DateTime startDate = default(DateTime), string subscriptionName = default(string), string subscriptionOwnerAccountNumber = default(string), decimal tcvDiscountAmount = default(decimal), decimal tcvGrossAmount = default(decimal), decimal tcvNetAmount = default(decimal), DateTime updatedOn = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The ID of the corresponding amendment that results in the charge metrics record. </value>
        ...
        /// </summary>
        /// <value>The type of the corresponding amendment that results in the charge metrics record. </value>
        ...
        /// </summary>
        /// <value>The corresponding charge number of the charge metrics record. </value>
        ...
        /// </summary>
        /// <value>The date and time when the charge metrics record was created, in &#x60;yyyy-mm-ddThh:mm:ssZ&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The currency of the charge metrics record. </value>
        ...
        /// </summary>
        /// <value>Whether the charge metrics record is deleted. </value>
        ...
        /// </summary>
        /// <value>The end date of the charge metrics record. </value>
        ...
        /// </summary>
        /// <value>The ID of the charge metrics record. </value>
        ...
        /// </summary>
        /// <value>The account number of the corresponding invoice owner. </value>
        [DataMember(Name = "invoiceOwnerAccountNumber", EmitDefaultValue = false)]
        public string InvoiceOwnerAccountNumber { get; set; }

        /// <summary>
        /// The discount amount for the MRR.  See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. 
        /// </summary>
        /// <value>The discount amount for the MRR.  See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. </value>
        [DataMember(Name = "mrrDiscountAmount", EmitDefaultValue = false)]
        public decimal MrrDiscountAmount { get; set; }

        /// <summary>
        /// The Gross MRR amount before discounts charges are applied.   See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. 
        /// </summary>
        /// <value>The Gross MRR amount before discounts charges are applied.   See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. </value>
        [DataMember(Name = "mrrGrossAmount", EmitDefaultValue = false)]
        public decimal MrrGrossAmount { get; set; }

        /// <summary>
        /// The NET MRR amount after discounts charges are applied.  See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. 
        /// </summary>
        /// <value>The NET MRR amount after discounts charges are applied.  See [Monthly Recurring Revenue](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue) for more MRR information. </value>
        [DataMember(Name = "mrrNetAmount", EmitDefaultValue = false)]
        public decimal MrrNetAmount { get; set; }

        /// <summary>
        /// The corresponding product ID of the charge metrics record. 
        /// </summary>
        /// <value>The corresponding product ID of the charge metrics record. </value>
        ...
        /// </summary>
        /// <value>The corresponding product rate plan charge ID of the charge metrics record. </value>
        ...
        /// </summary>
        /// <value>The corresponding product rate plan ID of the charge metrics record. </value>
        ...
        /// </summary>
        /// <value>The corresponding rate plan charge ID of the charge metrics record. </value>
        ...
        /// </summary>
        /// <value>The start date of the charge metrics record. </value>
        ...
        /// </summary>
        /// <value>The name of the corresponding subscription. </value>
        ...
        /// </summary>
        /// <value>The account number of the corresponding subscription owner. </value>
        [DataMember(Name = "subscriptionOwnerAccountNumber", EmitDefaultValue = false)]
        public string SubscriptionOwnerAccountNumber { get; set; }

        /// <summary>
        /// The discount amount for the TCV. 
        /// </summary>
        /// <value>The discount amount for the TCV. </value>
        [DataMember(Name = "tcvDiscountAmount", EmitDefaultValue = false)]
        public decimal TcvDiscountAmount { get; set; }

        /// <summary>
        /// The Gross TCV amount before discount charges are applied. 
        /// </summary>
        /// <value>The Gross TCV amount before discount charges are applied. </value>
        [DataMember(Name = "tcvGrossAmount", EmitDefaultValue = false)]
        public decimal TcvGrossAmount { get; set; }

        /// <summary>
        /// The Net TCV amount after discount charges are applied. 
        /// </summary>
        /// <value>The Net TCV amount after discount charges are applied. </value>
        [DataMember(Name = "tcvNetAmount", EmitDefaultValue = false)]
        public decimal TcvNetAmount { get; set; }

        /// <summary>
        /// The date and time when the charge metrics record was last updated, in &#x60;yyyy-mm-ddThh:mm:ssZ&#x60; format. 
        /// </summary>
        /// <value>The date and time when the charge metrics record was last updated, in &#x60;yyyy-mm-ddThh:mm:ssZ&#x60; format. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChargeMetricsResponse {\n");
            ...
            sb.Append("  MrrDiscountAmount: ").Append(MrrDiscountAmount).Append("\n");
            sb.Append("  MrrGrossAmount: ").Append(MrrGrossAmount).Append("\n");
            sb.Append("  MrrNetAmount: ").Append(MrrNetAmount).Append("\n");
            ...
            sb.Append("  SubscriptionOwnerAccountNumber: ").Append(SubscriptionOwnerAccountNumber).Append("\n");
            sb.Append("  TcvDiscountAmount: ").Append(TcvDiscountAmount).Append("\n");
            sb.Append("  TcvGrossAmount: ").Append(TcvGrossAmount).Append("\n");
            sb.Append("  TcvNetAmount: ").Append(TcvNetAmount).Append("\n");
        ...
        {
            return this.Equals(input as ChargeMetricsResponse);
        }

        /// <summary>
        /// Returns true if ChargeMetricsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ChargeMetricsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargeMetricsResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.AmendmentId == input.AmendmentId ||
                    (this.AmendmentId != null &&
                    this.AmendmentId.Equals(input.AmendmentId))
                ) && 
                (
                    this.AmendmentType == input.AmendmentType ||
                    (this.AmendmentType != null &&
                    this.AmendmentType.Equals(input.AmendmentType))
                ) && 
                (
                ...
                (
                    this.MrrDiscountAmount == input.MrrDiscountAmount ||
                    this.MrrDiscountAmount.Equals(input.MrrDiscountAmount)
                ) && 
                (
                    this.MrrGrossAmount == input.MrrGrossAmount ||
                    this.MrrGrossAmount.Equals(input.MrrGrossAmount)
                ) && 
                (
                    this.MrrNetAmount == input.MrrNetAmount ||
                    this.MrrNetAmount.Equals(input.MrrNetAmount)
                ) && 
                (
                ...
                (
                    this.RatePlanChargeId == input.RatePlanChargeId ||
                    (this.RatePlanChargeId != null &&
                    this.RatePlanChargeId.Equals(input.RatePlanChargeId))
                ) && 
                (
                ...
                (
                    this.SubscriptionOwnerAccountNumber == input.SubscriptionOwnerAccountNumber ||
                    (this.SubscriptionOwnerAccountNumber != null &&
                    this.SubscriptionOwnerAccountNumber.Equals(input.SubscriptionOwnerAccountNumber))
                ) && 
                (
                    this.TcvDiscountAmount == input.TcvDiscountAmount ||
                    this.TcvDiscountAmount.Equals(input.TcvDiscountAmount)
                ) && 
                (
                    this.TcvGrossAmount == input.TcvGrossAmount ||
                    this.TcvGrossAmount.Equals(input.TcvGrossAmount)
                ) && 
                (
                    this.TcvNetAmount == input.TcvNetAmount ||
                    this.TcvNetAmount.Equals(input.TcvNetAmount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AmendmentId.GetHashCode();
                }
                if (this.AmendmentType != null)
                {
                    hashCode = (hashCode * 59) + this.AmendmentType.GetHashCode();
                }
                ...
                hashCode = (hashCode * 59) + this.MrrDiscountAmount.GetHashCode();
                hashCode = (hashCode * 59) + this.MrrGrossAmount.GetHashCode();
                hashCode = (hashCode * 59) + this.MrrNetAmount.GetHashCode();
                ...
                {
                    hashCode = (hashCode * 59) + this.RatePlanChargeId.GetHashCode();
                }
                ...
                if (this.SubscriptionOwnerAccountNumber != null)
                {
                    hashCode = (hashCode * 59) + this.SubscriptionOwnerAccountNumber.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.TcvDiscountAmount.GetHashCode();
                hashCode = (hashCode * 59) + this.TcvGrossAmount.GetHashCode();
                hashCode = (hashCode * 59) + this.TcvNetAmount.GetHashCode();
