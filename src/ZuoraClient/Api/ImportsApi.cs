...
namespace ZuoraClient.Api
{
    ...
    public interface IImportsApiSync : IApiAccessor
    {
        ...
        ProxyGetImport ObjectGETImport(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0);
        ...
        ApiResponse<ProxyGetImport> ObjectGETImportWithHttpInfo(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="importType">The type of data to import. </param>
        /// <param name="name">A descriptive name for the import. </param>
        /// <param name="file">The data to import. </param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProxyPostImport</returns>
        ProxyPostImport ObjectPOSTImport(string importType, string name, System.IO.Stream file, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProxyPostImport</returns>
        ApiResponse<ProxyPostImport> ObjectPOSTImportWithHttpInfo(string importType, string name, System.IO.Stream file, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
    ...
    public interface IImportsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<ProxyGetImport>> ObjectGETImportWithHttpInfoAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// CRUD: Create an import
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProxyPostImport</returns>
        System.Threading.Tasks.Task<ProxyPostImport> ObjectPOSTImportAsync(string importType, string name, System.IO.Stream file, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProxyPostImport)</returns>
        System.Threading.Tasks.Task<ApiResponse<ProxyPostImport>> ObjectPOSTImportWithHttpInfoAsync(string importType, string name, System.IO.Stream file, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ImportsApi : IImportsApi
    {
        ...
        /// <returns></returns>
        public ImportsApi(ZuoraClient.Client.Configuration configuration)
        {
        ...
        public ImportsApi(ZuoraClient.Client.ISynchronousClient client, ZuoraClient.Client.IAsynchronousClient asyncClient, ZuoraClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProxyGetImport</returns>
        public ProxyGetImport ObjectGETImport(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<ProxyGetImport> localVarResponse = ObjectGETImportWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProxyGetImport</returns>
        public ZuoraClient.Client.ApiResponse<ProxyGetImport> ObjectGETImportWithHttpInfo(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'id' when calling ImportsApi->ObjectGETImport");
            }
            ...
            localVarRequestOptions.Operation = "ImportsApi.ObjectGETImport";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<ProxyGetImport>("/v1/object/import/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ObjectGETImport", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProxyGetImport</returns>
        public async System.Threading.Tasks.Task<ProxyGetImport> ObjectGETImportAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<ProxyGetImport> localVarResponse = await ObjectGETImportWithHttpInfoAsync(id, authorization, zuoraEntityIds, zuoraTrackId, fields, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProxyGetImport)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<ProxyGetImport>> ObjectGETImportWithHttpInfoAsync(string id, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), string fields = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ProxyGetImport>("/v1/object/import/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// CRUD: Create an import Creates a data import. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="importType">The type of data to import. </param>
        /// <param name="name">A descriptive name for the import. </param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ProxyPostImport</returns>
        public ProxyPostImport ObjectPOSTImport(string importType, string name, System.IO.Stream file, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<ProxyPostImport> localVarResponse = ObjectPOSTImportWithHttpInfo(importType, name, file, authorization, rejectUnknownFields, zuoraEntityIds, zuoraTrackId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ProxyPostImport</returns>
        public ZuoraClient.Client.ApiResponse<ProxyPostImport> ObjectPOSTImportWithHttpInfo(string importType, string name, System.IO.Stream file, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'importType' is set
            if (importType == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'importType' when calling ImportsApi->ObjectPOSTImport");
            }

            // verify the required parameter 'name' is set
            if (name == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'name' when calling ImportsApi->ObjectPOSTImport");
            }

            // verify the required parameter 'file' is set
            if (file == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'file' when calling ImportsApi->ObjectPOSTImport");
            }
            ...
            localVarRequestOptions.FormParameters.Add("ImportType", ZuoraClient.Client.ClientUtils.ParameterToString(importType)); // form parameter
            localVarRequestOptions.FormParameters.Add("Name", ZuoraClient.Client.ClientUtils.ParameterToString(name)); // form parameter
            localVarRequestOptions.FileParameters.Add("File", file);

            localVarRequestOptions.Operation = "ImportsApi.ObjectPOSTImport";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<ProxyPostImport>("/v1/object/import", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ObjectPOSTImport", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ProxyPostImport</returns>
        public async System.Threading.Tasks.Task<ProxyPostImport> ObjectPOSTImportAsync(string importType, string name, System.IO.Stream file, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<ProxyPostImport> localVarResponse = await ObjectPOSTImportWithHttpInfoAsync(importType, name, file, authorization, rejectUnknownFields, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProxyPostImport)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<ProxyPostImport>> ObjectPOSTImportWithHttpInfoAsync(string importType, string name, System.IO.Stream file, string authorization = default(string), bool? rejectUnknownFields = default(bool?), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'importType' is set
            if (importType == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ProxyPostImport>("/v1/object/import", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
