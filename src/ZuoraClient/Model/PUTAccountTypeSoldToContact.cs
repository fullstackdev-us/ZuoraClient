...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PUTAccountTypeSoldToContact")]
    public partial class PUTAccountTypeSoldToContact : IEquatable<PUTAccountTypeSoldToContact>, IValidatableObject
    {
        ...
        public PUTAccountTypeSoldToContact(string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickname = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string), string zipCode = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for PUTAccountTypeSoldToContact and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for PUTAccountTypeSoldToContact and cannot be null");
            }
        ...
        {
            return this.Equals(input as PUTAccountTypeSoldToContact);
        }

        /// <summary>
        /// Returns true if PUTAccountTypeSoldToContact instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTAccountTypeSoldToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTAccountTypeSoldToContact input)
        {
            if (input == null)
            {
                return false;
