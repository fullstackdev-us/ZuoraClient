...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreditMemoFromInvoiceType")]
    public partial class CreditMemoFromInvoiceType : IEquatable<CreditMemoFromInvoiceType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditMemoFromInvoiceType" /> class.
        /// </summary>
        ...
        public CreditMemoFromInvoiceType(bool autoApplyToInvoiceUponPosting = default(bool), bool autoPost = false, string comment = default(string), DateTime effectiveDate = default(DateTime), bool excludeFromAutoApplyRules = default(bool), string invoiceId = default(string), List<CreditMemoItemFromInvoiceItemType> items = default(List<CreditMemoItemFromInvoiceItemType>), string reasonCode = default(string), bool taxAutoCalculation = true, string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string transactionNS = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreditMemoFromInvoiceType {\n");
        ...
        {
            return this.Equals(input as CreditMemoFromInvoiceType);
        }

        /// <summary>
        /// Returns true if CreditMemoFromInvoiceType instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditMemoFromInvoiceType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditMemoFromInvoiceType input)
        {
            if (input == null)
            {
                return false;
