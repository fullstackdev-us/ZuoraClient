...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyCreateCreditBalanceAdjustment")]
    public partial class ProxyCreateCreditBalanceAdjustment : IEquatable<ProxyCreateCreditBalanceAdjustment>, IValidatableObject
    {
        /// <summary>
        /// Whether the credit balance adjustment increases or decrease the amount of the credit balance. 
        /// </summary>
        /// <value>Whether the credit balance adjustment increases or decrease the amount of the credit balance. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateCreditBalanceAdjustment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateCreditBalanceAdjustment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateCreditBalanceAdjustment" /> class.
        /// </summary>
        /// <param name="accountingCode">An active accounting code in your Zuora [Chart of Accounts](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/V_Configure_Accounting_Codes/D_Set_Up_Chart_of_Accounts).  The [accounting code](https://knowledgecenter.zuora.com/BC_Subscription_Management/Product_Catalog/A_Product_Catalog_Concepts/Accounting_Codes) for the credit balance adjustment. Typically, an accounting code for a credit balance adjustment maps to a bank account in your accounting system. .</param>
        /// <param name="adjustmentDate">The date when the credit balance adjustment is applied.  With the Future Dated Credit Balance Adjustment feature enabled, you can use this field to specify when the credit balance adjustment is applied. If not specified, the value defaults to the latter date of the date when the API operation is called and the invoice date.  With the Future Dated Credit Balance Adjustment feature disabled, if no value is specified for this field, the value defaults to the date when the API operation is called. If you specify a value for this field, the value must be the date when the API operation is called. .</param>
        /// <param name="amount">The amount of the adjustment.  (required).</param>
        /// <param name="comment">Your comments about the credit balance adjustment. .</param>
        /// <param name="reasonCode">A code identifying the reason for the transaction. Must be an existing [reason code](https://knowledgecenter.zuora.com/CB_Billing/K_Payment_Operations/Reason_Codes_for_Payment_Operations) or empty. If you do not specify a value, Zuora uses the default reason code. .</param>
        /// <param name="referenceId">The ID of the payment that the credit balance adjustment is for. .</param>
        /// <param name="sourceTransactionId">The ID of the object that the credit balance adjustment is applied to. You must specify a value for either the &#x60;SourceTransactionId&#x60; field or the &#x60;SourceTransactionNumber&#x60; field.  The value of this field must be an invoice ID. .</param>
        /// <param name="sourceTransactionNumber">The number of the object that the credit balance adjustment is applied to. You must specify a value for either the &#x60;SourceTransactionId&#x60; field or the &#x60;SourceTransactionNumber&#x60; field.  The value of this field must be an invoice number. .</param>
        /// <param name="type">Whether the credit balance adjustment increases or decrease the amount of the credit balance.  (required).</param>
        ...
        /// <param name="integrationStatusNS">Status of the credit balance adjustment&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        /// <param name="syncDateNS">Date when the credit balance adjustment was sychronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        public ProxyCreateCreditBalanceAdjustment(string accountingCode = default(string), DateTime adjustmentDate = default(DateTime), double amount = default(double), string comment = default(string), string reasonCode = default(string), string referenceId = default(string), string sourceTransactionId = default(string), string sourceTransactionNumber = default(string), TypeEnum type = default(TypeEnum), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
            this.Amount = amount;
            this.Type = type;
        ...
        /// <summary>
        /// An active accounting code in your Zuora [Chart of Accounts](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/V_Configure_Accounting_Codes/D_Set_Up_Chart_of_Accounts).  The [accounting code](https://knowledgecenter.zuora.com/BC_Subscription_Management/Product_Catalog/A_Product_Catalog_Concepts/Accounting_Codes) for the credit balance adjustment. Typically, an accounting code for a credit balance adjustment maps to a bank account in your accounting system. 
        /// </summary>
        /// <value>An active accounting code in your Zuora [Chart of Accounts](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/V_Configure_Accounting_Codes/D_Set_Up_Chart_of_Accounts).  The [accounting code](https://knowledgecenter.zuora.com/BC_Subscription_Management/Product_Catalog/A_Product_Catalog_Concepts/Accounting_Codes) for the credit balance adjustment. Typically, an accounting code for a credit balance adjustment maps to a bank account in your accounting system. </value>
        ...
        /// </summary>
        /// <value>The date when the credit balance adjustment is applied.  With the Future Dated Credit Balance Adjustment feature enabled, you can use this field to specify when the credit balance adjustment is applied. If not specified, the value defaults to the latter date of the date when the API operation is called and the invoice date.  With the Future Dated Credit Balance Adjustment feature disabled, if no value is specified for this field, the value defaults to the date when the API operation is called. If you specify a value for this field, the value must be the date when the API operation is called. </value>
        ...
        /// </summary>
        /// <value>Your comments about the credit balance adjustment. </value>
        ...
        /// </summary>
        /// <value>A code identifying the reason for the transaction. Must be an existing [reason code](https://knowledgecenter.zuora.com/CB_Billing/K_Payment_Operations/Reason_Codes_for_Payment_Operations) or empty. If you do not specify a value, Zuora uses the default reason code. </value>
        ...
        /// </summary>
        /// <value>The ID of the payment that the credit balance adjustment is for. </value>
        [DataMember(Name = "ReferenceId", EmitDefaultValue = false)]
        public string ReferenceId { get; set; }

        /// <summary>
        /// The ID of the object that the credit balance adjustment is applied to. You must specify a value for either the &#x60;SourceTransactionId&#x60; field or the &#x60;SourceTransactionNumber&#x60; field.  The value of this field must be an invoice ID. 
        /// </summary>
        /// <value>The ID of the object that the credit balance adjustment is applied to. You must specify a value for either the &#x60;SourceTransactionId&#x60; field or the &#x60;SourceTransactionNumber&#x60; field.  The value of this field must be an invoice ID. </value>
        [DataMember(Name = "SourceTransactionId", EmitDefaultValue = false)]
        public string SourceTransactionId { get; set; }

        /// <summary>
        /// The number of the object that the credit balance adjustment is applied to. You must specify a value for either the &#x60;SourceTransactionId&#x60; field or the &#x60;SourceTransactionNumber&#x60; field.  The value of this field must be an invoice number. 
        /// </summary>
        /// <value>The number of the object that the credit balance adjustment is applied to. You must specify a value for either the &#x60;SourceTransactionId&#x60; field or the &#x60;SourceTransactionNumber&#x60; field.  The value of this field must be an invoice number. </value>
        ...
        /// </summary>
        /// <value>Status of the credit balance adjustment&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        /// </summary>
        /// <value>Date when the credit balance adjustment was sychronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyCreateCreditBalanceAdjustment {\n");
        ...
        {
            return this.Equals(input as ProxyCreateCreditBalanceAdjustment);
        }

        /// <summary>
        /// Returns true if ProxyCreateCreditBalanceAdjustment instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreateCreditBalanceAdjustment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateCreditBalanceAdjustment input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SourceTransactionNumber == input.SourceTransactionNumber ||
                    (this.SourceTransactionNumber != null &&
                    this.SourceTransactionNumber.Equals(input.SourceTransactionNumber))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SourceTransactionNumber.GetHashCode();
                }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ReasonCode, length must be less than 32.", new [] { "ReasonCode" });
            }
            ...
            // SourceTransactionId (string) maxLength
            if (this.SourceTransactionId != null && this.SourceTransactionId.Length > 32)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SourceTransactionId, length must be less than 32.", new [] { "SourceTransactionId" });
            }

            // SourceTransactionNumber (string) maxLength
            if (this.SourceTransactionNumber != null && this.SourceTransactionNumber.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SourceTransactionNumber, length must be less than 50.", new [] { "SourceTransactionNumber" });
            }
