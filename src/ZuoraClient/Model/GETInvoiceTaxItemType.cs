...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETInvoiceTaxItemType")]
    public partial class GETInvoiceTaxItemType : IEquatable<GETInvoiceTaxItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETInvoiceTaxItemType" /> class.
        /// </summary>
        /// <param name="availableToCreditAmount">The amount of the invoice taxation item that is available to credit. .</param>
        /// <param name="balance">The balance of the taxation item. .</param>
        /// <param name="creditAmount">The amount of credit memos applied to the taxation item.  .</param>
        ...
        /// <param name="paymentAmount">The amount of payments applied to the taxation item.  .</param>
        /// <param name="taxAmount">The amount of taxation. .</param>
        /// <param name="taxCode">The tax code identifies which tax rules and tax rates to apply to a specific invoice. .</param>
        /// <param name="taxCodeDescription">The description of the tax code. .</param>
        /// <param name="taxDate">The date that the tax is applied to the invoice, in &#x60;yyyy-mm-dd&#x60; format. .</param>
        /// <param name="taxRate">The tax rate applied to the invoice. .</param>
        /// <param name="taxRateDescription">The description of the tax rate. .</param>
        /// <param name="taxRateType">The type of the tax rate. .</param>
        public GETInvoiceTaxItemType(decimal availableToCreditAmount = default(decimal), double balance = default(double), double creditAmount = default(double), double exemptAmount = default(double), string id = default(string), string jurisdiction = default(string), string locationCode = default(string), string name = default(string), double paymentAmount = default(double), double taxAmount = default(double), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), double taxRate = default(double), string taxRateDescription = default(string), TaxRateTypeEnum? taxRateType = default(TaxRateTypeEnum?))
        {
        ...
        /// </summary>
        /// <value>The amount of the invoice taxation item that is available to credit. </value>
        ...
        /// </summary>
        /// <value>The amount of credit memos applied to the taxation item.  </value>
        ...
        /// </summary>
        /// <value>The amount of payments applied to the taxation item.  </value>
        ...
        /// </summary>
        /// <value>The tax code identifies which tax rules and tax rates to apply to a specific invoice. </value>
        ...
        /// </summary>
        /// <value>The date that the tax is applied to the invoice, in &#x60;yyyy-mm-dd&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The tax rate applied to the invoice. </value>
        ...
        {
            return this.Equals(input as GETInvoiceTaxItemType);
        }

        /// <summary>
        /// Returns true if GETInvoiceTaxItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETInvoiceTaxItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETInvoiceTaxItemType input)
        {
            if (input == null)
            {
                return false;
