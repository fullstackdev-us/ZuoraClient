...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyCreateContact_allOf")]
    public partial class ProxyCreateContactAllOf : IEquatable<ProxyCreateContactAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateContactAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreateContactAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreateContactAllOf" /> class.
        /// </summary>
        /// <param name="accountId"> The Zuora account ID associated with this contact. This field is not required when you use the Subscribe call. This field is required for all other calls. **Character limit: **32 **Values: **a valid account ID  (required).</param>
        ...
        /// <param name="country"> The country of the contact&#39;s address. .</param>
        /// <param name="county"> The county. May optionally be used by Zuora Tax to calculate county tax. **Character limit**: 32 **Values**: a string of 32 characters or fewer .</param>
        ...
        /// <param name="state"> The state or province of the contact&#39;s address. .</param>
        /// <param name="taxRegion">If using Zuora Tax rules .</param>
        ...
        public ProxyCreateContactAllOf(string accountId = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string description = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickName = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string postalCode = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string))
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for ProxyCreateContactAllOf and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for ProxyCreateContactAllOf and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for ProxyCreateContactAllOf and cannot be null");
            }
        ...
        /// </summary>
        /// <value> The Zuora account ID associated with this contact. This field is not required when you use the Subscribe call. This field is required for all other calls. **Character limit: **32 **Values: **a valid account ID </value>
        ...
        /// </summary>
        /// <value> The county. May optionally be used by Zuora Tax to calculate county tax. **Character limit**: 32 **Values**: a string of 32 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The state or province of the contact&#39;s address. </value>
        ...
        /// </summary>
        /// <value>If using Zuora Tax rules </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyCreateContactAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyCreateContactAllOf);
        }

        /// <summary>
        /// Returns true if ProxyCreateContactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreateContactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateContactAllOf input)
        {
            if (input == null)
            {
                return false;
