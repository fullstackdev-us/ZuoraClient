...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyCreatePaymentMethod")]
    public partial class ProxyCreatePaymentMethod : IEquatable<ProxyCreatePaymentMethod>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyCreatePaymentMethod);
        }

        /// <summary>
        /// Returns true if ProxyCreatePaymentMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreatePaymentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreatePaymentMethod input)
        {
            if (input == null)
            {
                return false;
