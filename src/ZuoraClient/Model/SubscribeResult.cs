...
namespace ZuoraClient.Model
{
    ...
    public partial class SubscribeResult : IEquatable<SubscribeResult>, IValidatableObject
    {
        ...
        /// <param name="chargeMetricsData">chargeMetricsData.</param>
        /// <param name="creditMemoData">Container for credit memo data.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;107&#x60; or later. .</param>
        /// <param name="creditMemoId">The ID of the credit memo.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;107&#x60; or later. .</param>
        /// <param name="creditMemoNumber">The number of the credit memo.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;107&#x60; or later. .</param>
        /// <param name="creditMemoResult">creditMemoResult.</param>
        /// <param name="errors">errors.</param>
        /// <param name="gatewayResponse">gatewayResponse.</param>
        /// <param name="gatewayResponseCode">gatewayResponseCode.</param>
        /// <param name="invoiceData">invoiceData.</param>
        /// <param name="invoiceId">invoiceId.</param>
        /// <param name="invoiceNumber">invoiceNumber.</param>
        /// <param name="invoiceResult">invoiceResult.</param>
        ...
        /// <param name="totalMrr">totalMrr.</param>
        /// <param name="totalTcv">totalTcv.</param>
        public SubscribeResult(string accountId = default(string), string accountNumber = default(string), SubscribeResultChargeMetricsData chargeMetricsData = default(SubscribeResultChargeMetricsData), List<ActionSubscribeCreditMemoData> creditMemoData = default(List<ActionSubscribeCreditMemoData>), string creditMemoId = default(string), string creditMemoNumber = default(string), CreditMemoResult creditMemoResult = default(CreditMemoResult), List<ActionsErrorResponse> errors = default(List<ActionsErrorResponse>), string gatewayResponse = default(string), string gatewayResponseCode = default(string), List<ActionSubscribeInvoiceData> invoiceData = default(List<ActionSubscribeInvoiceData>), string invoiceId = default(string), string invoiceNumber = default(string), SubscribeResultInvoiceResult invoiceResult = default(SubscribeResultInvoiceResult), string paymentId = default(string), string paymentTransactionNumber = default(string), string subscriptionId = default(string), string subscriptionNumber = default(string), bool success = default(bool), double totalMrr = default(double), double totalTcv = default(double))
        {
        ...
        /// <summary>
        /// Gets or Sets ChargeMetricsData
        /// </summary>
        [DataMember(Name = "ChargeMetricsData", EmitDefaultValue = false)]
        public SubscribeResultChargeMetricsData ChargeMetricsData { get; set; }

        /// <summary>
        /// Container for credit memo data.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;107&#x60; or later. 
        /// </summary>
        /// <value>Container for credit memo data.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;107&#x60; or later. </value>
        [DataMember(Name = "CreditMemoData", EmitDefaultValue = false)]
        public List<ActionSubscribeCreditMemoData> CreditMemoData { get; set; }

        /// <summary>
        /// The ID of the credit memo.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;107&#x60; or later. 
        /// </summary>
        /// <value>The ID of the credit memo.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;107&#x60; or later. </value>
        [DataMember(Name = "CreditMemoId", EmitDefaultValue = false)]
        public string CreditMemoId { get; set; }

        /// <summary>
        /// The number of the credit memo.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;107&#x60; or later. 
        /// </summary>
        /// <value>The number of the credit memo.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the &#x60;X-Zuora-WSDL-Version&#x60; request header to &#x60;107&#x60; or later. </value>
        [DataMember(Name = "CreditMemoNumber", EmitDefaultValue = false)]
        public string CreditMemoNumber { get; set; }

        /// <summary>
        /// Gets or Sets CreditMemoResult
        /// </summary>
        [DataMember(Name = "CreditMemoResult", EmitDefaultValue = false)]
        public CreditMemoResult CreditMemoResult { get; set; }
        ...
        public List<ActionSubscribeInvoiceData> InvoiceData { get; set; }
        ...
        /// <summary>
        /// Gets or Sets InvoiceResult
        /// </summary>
        [DataMember(Name = "InvoiceResult", EmitDefaultValue = false)]
        public SubscribeResultInvoiceResult InvoiceResult { get; set; }
        ...
        /// <summary>
        /// Gets or Sets SubscriptionNumber
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CreditMemoData: ").Append(CreditMemoData).Append("\n");
            sb.Append("  CreditMemoId: ").Append(CreditMemoId).Append("\n");
            sb.Append("  CreditMemoNumber: ").Append(CreditMemoNumber).Append("\n");
            sb.Append("  CreditMemoResult: ").Append(CreditMemoResult).Append("\n");
        ...
        {
            return this.Equals(input as SubscribeResult);
        }

        /// <summary>
        /// Returns true if SubscribeResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribeResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribeResult input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ChargeMetricsData == input.ChargeMetricsData ||
                    (this.ChargeMetricsData != null &&
                    this.ChargeMetricsData.Equals(input.ChargeMetricsData))
                ) && 
                (
                    this.CreditMemoData == input.CreditMemoData ||
                    this.CreditMemoData != null &&
                    input.CreditMemoData != null &&
                    this.CreditMemoData.SequenceEqual(input.CreditMemoData)
                ) && 
                (
                ...
                (
                    this.CreditMemoResult == input.CreditMemoResult ||
                    (this.CreditMemoResult != null &&
                    this.CreditMemoResult.Equals(input.CreditMemoResult))
                ) && 
                (
                ...
                (
                    this.InvoiceResult == input.InvoiceResult ||
                    (this.InvoiceResult != null &&
                    this.InvoiceResult.Equals(input.InvoiceResult))
                ) && 
                (
                ...
                (
                    this.PaymentTransactionNumber == input.PaymentTransactionNumber ||
                    (this.PaymentTransactionNumber != null &&
                    this.PaymentTransactionNumber.Equals(input.PaymentTransactionNumber))
                ) && 
                (
                ...
                (
                    this.TotalMrr == input.TotalMrr ||
                    this.TotalMrr.Equals(input.TotalMrr)
                ) && 
                (
                    this.TotalTcv == input.TotalTcv ||
                    this.TotalTcv.Equals(input.TotalTcv)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ChargeMetricsData.GetHashCode();
                }
                if (this.CreditMemoData != null)
                {
                    hashCode = (hashCode * 59) + this.CreditMemoData.GetHashCode();
                }
                ...
                if (this.CreditMemoResult != null)
                {
                    hashCode = (hashCode * 59) + this.CreditMemoResult.GetHashCode();
                }
                if (this.Errors != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + this.InvoiceResult.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.PaymentTransactionNumber.GetHashCode();
                }
                ...
                hashCode = (hashCode * 59) + this.TotalMrr.GetHashCode();
                hashCode = (hashCode * 59) + this.TotalTcv.GetHashCode();
                return hashCode;
            }
        }
