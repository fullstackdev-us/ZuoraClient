...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetInvoiceItem
    /// </summary>
    [DataContract(Name = "ProxyGetInvoiceItem")]
    public partial class ProxyGetInvoiceItem : IEquatable<ProxyGetInvoiceItem>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyGetInvoiceItem);
        }

        /// <summary>
        /// Returns true if ProxyGetInvoiceItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetInvoiceItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetInvoiceItem input)
        {
            if (input == null)
            {
                return false;
