...
namespace ZuoraClient.Model
{
    ...
    /// PostInvoiceType
    /// </summary>
    [DataContract(Name = "PostInvoiceType")]
    public partial class PostInvoiceType : IEquatable<PostInvoiceType>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The status of invoice. By default, the invoice status is Draft.  When creating an invoice, if you set this field to &#x60;Posted&#x60;, the invoice is created and posted directly. </value>
        ...
        /// <summary>
        /// Defines TransferredToAccounting
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInvoiceType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostInvoiceType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInvoiceType" /> class.
        /// </summary>
        /// <param name="accountId">The ID of the account associated with the invoice.   You must specify either &#x60;accountNumber&#x60; or &#x60;accountId&#x60; for a customer account. If both of them are specified, they must refer to the same customer account. .</param>
        /// <param name="accountNumber">The Number of the account associated with the invoice. You must specify either &#x60;accountNumber&#x60; or &#x60;accountId&#x60; for a customer account. If both of them are specified, they must refer to the same customer account. .</param>
        /// <param name="autoPay">Whether invoices are automatically picked up for processing in the corresponding payment run.  (default to false).</param>
        /// <param name="comments">Comments about the invoice. .</param>
        /// <param name="dueDate">The date by which the payment for this invoice is due, in &#x60;yyyy-mm-dd&#x60; format. .</param>
        /// <param name="invoiceDate">The date that appears on the invoice being created, in &#x60;yyyy-mm-dd&#x60; format. The value cannot fall in a closed accounting period.  (required).</param>
        /// <param name="invoiceItems">Container for invoice items. The maximum number of invoice items is 1,000. .</param>
        /// <param name="invoiceNumber">A customized invoice number with the following format requirements: - Max length: 16 characters - Acceptable characters: a-z,A-Z,0-9,-,_,  The value must be unique in the system, otherwise it may cause issues with bill runs and subscribe/amend. Check out [things to note and troubleshooting steps](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/IA_Invoices/Unified_Invoicing/Import_external_invoices_as_standalone_invoices?#Customizing_invoice_number).  .</param>
        /// <param name="status">The status of invoice. By default, the invoice status is Draft.  When creating an invoice, if you set this field to &#x60;Posted&#x60;, the invoice is created and posted directly.  (default to StatusEnum.Draft).</param>
        /// <param name="transferredToAccounting">transferredToAccounting.</param>
        ...
        public PostInvoiceType(string accountId = default(string), string accountNumber = default(string), bool autoPay = false, string comments = default(string), DateTime dueDate = default(DateTime), DateTime invoiceDate = default(DateTime), List<PostInvoiceItemType> invoiceItems = default(List<PostInvoiceItemType>), string invoiceNumber = default(string), StatusEnum? status = StatusEnum.Draft, TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value>The ID of the account associated with the invoice.   You must specify either &#x60;accountNumber&#x60; or &#x60;accountId&#x60; for a customer account. If both of them are specified, they must refer to the same customer account. </value>
        ...
        /// </summary>
        /// <value>The Number of the account associated with the invoice. You must specify either &#x60;accountNumber&#x60; or &#x60;accountId&#x60; for a customer account. If both of them are specified, they must refer to the same customer account. </value>
        ...
        /// </summary>
        /// <value>The date by which the payment for this invoice is due, in &#x60;yyyy-mm-dd&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The date that appears on the invoice being created, in &#x60;yyyy-mm-dd&#x60; format. The value cannot fall in a closed accounting period. </value>
        ...
        /// </summary>
        /// <value>Container for invoice items. The maximum number of invoice items is 1,000. </value>
        [DataMember(Name = "invoiceItems", EmitDefaultValue = false)]
        public List<PostInvoiceItemType> InvoiceItems { get; set; }
        ...
        /// </summary>
        /// <value>A customized invoice number with the following format requirements: - Max length: 16 characters - Acceptable characters: a-z,A-Z,0-9,-,_,  The value must be unique in the system, otherwise it may cause issues with bill runs and subscribe/amend. Check out [things to note and troubleshooting steps](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/IA_Invoices/Unified_Invoicing/Import_external_invoices_as_standalone_invoices?#Customizing_invoice_number).  </value>
        ...
        {
            return this.Equals(input as PostInvoiceType);
        }

        /// <summary>
        /// Returns true if PostInvoiceType instances are equal
        /// </summary>
        /// <param name="input">Instance of PostInvoiceType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostInvoiceType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.InvoiceItems.SequenceEqual(input.InvoiceItems)
                ) && 
                (
