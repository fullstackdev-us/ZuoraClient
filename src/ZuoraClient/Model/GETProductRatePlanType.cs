...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETProductRatePlanType")]
    public partial class GETProductRatePlanType : IEquatable<GETProductRatePlanType>, IValidatableObject
    {
        ...
        public GETProductRatePlanType(string description = default(string), DateTime effectiveEndDate = default(DateTime), DateTime effectiveStartDate = default(DateTime), decimal grade = default(decimal), string id = default(string), string name = default(string), List<GETProductRatePlanChargeType> productRatePlanCharges = default(List<GETProductRatePlanChargeType>), string status = default(string), BillingPeriodNSEnum? billingPeriodNS = default(BillingPeriodNSEnum?), string classNS = default(string), string departmentNS = default(string), IncludeChildrenNSEnum? includeChildrenNS = default(IncludeChildrenNSEnum?), string integrationIdNS = default(string), string integrationStatusNS = default(string), ItemTypeNSEnum? itemTypeNS = default(ItemTypeNSEnum?), string locationNS = default(string), string multiCurrencyPriceNS = default(string), string priceNS = default(string), string subsidiaryNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value>Unique product rate-plan ID. </value>
        ...
        {
            return this.Equals(input as GETProductRatePlanType);
        }

        /// <summary>
        /// Returns true if GETProductRatePlanType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETProductRatePlanType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETProductRatePlanType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ProductRatePlanCharges == input.ProductRatePlanCharges ||
                    this.ProductRatePlanCharges != null &&
                    input.ProductRatePlanCharges != null &&
                    this.ProductRatePlanCharges.SequenceEqual(input.ProductRatePlanCharges)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ProductRatePlanCharges.GetHashCode();
                }
                if (this.Status != null)
                {
