...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActionSubscribeInvoiceItem")]
    public partial class ActionSubscribeInvoiceItem : IEquatable<ActionSubscribeInvoiceItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionSubscribeInvoiceItem" /> class.
        /// </summary>
        ...
        /// <param name="appliedToChargeNumber"> The charge number that the discount charge is applied to. This field is only for the invoice items that are discount charges. This field is only returned in subscription previews. This field will be returned in the response if you specify the charge number in the rate plan charges in the request.  **Character limit**: 32  **Values**: inherited from &#x60;RatePlanCharge.ChargeNumber&#x60; for the charge associated with the invoice item that the discount charge is applied to .</param>
        ...
        /// <param name="revRecTriggerCondition"> Specifies when revenue recognition begins based on a triggering event.   **Character limit**:   **Values**: inherited from &#x60;ProductRatePlanCharge&#x60;.&#x60;RevRecTriggerCondition&#x60; .</param>
        ...
        public ActionSubscribeInvoiceItem(string accountingCode = default(string), string appliedToChargeNumber = default(string), string appliedToInvoiceItemId = default(string), double chargeAmount = default(double), DateTime chargeDate = default(DateTime), string chargeDescription = default(string), string chargeId = default(string), string chargeName = default(string), string chargeNumber = default(string), string chargeType = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), string invoiceId = default(string), double processingType = default(double), string productDescription = default(string), string productId = default(string), string productName = default(string), string productRatePlanChargeId = default(string), double quantity = default(double), string ratePlanChargeId = default(string), string revRecCode = default(string), DateTime revRecStartDate = default(DateTime), string revRecTriggerCondition = default(string), string sKU = default(string), DateTime serviceEndDate = default(DateTime), DateTime serviceStartDate = default(DateTime), string subscriptionId = default(string), string subscriptionNumber = default(string), double taxAmount = default(double), string taxCode = default(string), double taxExemptAmount = default(double), string taxMode = default(string), string uOM = default(string), double unitPrice = default(double), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value> The charge number that the discount charge is applied to. This field is only for the invoice items that are discount charges. This field is only returned in subscription previews. This field will be returned in the response if you specify the charge number in the rate plan charges in the request.  **Character limit**: 32  **Values**: inherited from &#x60;RatePlanCharge.ChargeNumber&#x60; for the charge associated with the invoice item that the discount charge is applied to </value>
        [DataMember(Name = "AppliedToChargeNumber", EmitDefaultValue = false)]
        public string AppliedToChargeNumber { get; set; }
        ...
        /// </summary>
        /// <value> Specifies when revenue recognition begins based on a triggering event.   **Character limit**:   **Values**: inherited from &#x60;ProductRatePlanCharge&#x60;.&#x60;RevRecTriggerCondition&#x60; </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionSubscribeInvoiceItem {\n");
            sb.Append("  AccountingCode: ").Append(AccountingCode).Append("\n");
            sb.Append("  AppliedToChargeNumber: ").Append(AppliedToChargeNumber).Append("\n");
        ...
        {
            return this.Equals(input as ActionSubscribeInvoiceItem);
        }

        /// <summary>
        /// Returns true if ActionSubscribeInvoiceItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionSubscribeInvoiceItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionSubscribeInvoiceItem input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AppliedToChargeNumber == input.AppliedToChargeNumber ||
                    (this.AppliedToChargeNumber != null &&
                    this.AppliedToChargeNumber.Equals(input.AppliedToChargeNumber))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AppliedToChargeNumber != null)
                {
                    hashCode = (hashCode * 59) + this.AppliedToChargeNumber.GetHashCode();
                }
