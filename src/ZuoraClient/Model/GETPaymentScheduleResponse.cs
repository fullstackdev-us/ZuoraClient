...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETPaymentScheduleResponse")]
    public partial class GETPaymentScheduleResponse : IEquatable<GETPaymentScheduleResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETPaymentScheduleResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETPaymentScheduleResponse);
        }

        /// <summary>
        /// Returns true if GETPaymentScheduleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GETPaymentScheduleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPaymentScheduleResponse input)
        {
            if (input == null)
            {
                return false;
