...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyModifySubscription_allOf")]
    public partial class ProxyModifySubscriptionAllOf : IEquatable<ProxyModifySubscriptionAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyModifySubscriptionAllOf" /> class.
        /// </summary>
        ...
        /// <param name="initialTerm"> The length of the period for the first subscription term. This field can be updated when Status is &#x60;Draft&#x60;. **Required**: If TermType is Termed **Character limit**: 20 **Values**: any valid number. .</param>
        ...
        public ProxyModifySubscriptionAllOf(string accountId = default(string), bool autoRenew = default(bool), DateTime cancelledDate = default(DateTime), DateTime contractAcceptanceDate = default(DateTime), DateTime contractEffectiveDate = default(DateTime), string currentTermPeriodType = default(string), ExternallyManagedByEnum? externallyManagedBy = default(ExternallyManagedByEnum?), int initialTerm = default(int), string initialTermPeriodType = default(string), string invoiceOwnerId = default(string), bool isInvoiceSeparate = default(bool), string name = default(string), string notes = default(string), string renewalSetting = default(string), int renewalTerm = default(int), string renewalTermPeriodType = default(string), DateTime serviceActivationDate = default(DateTime), string status = default(string), DateTime termStartDate = default(DateTime), string termType = default(string), int version = default(int))
        {
        ...
        /// </summary>
        /// <value> The date of the Amendment object. **Values**: inherited from &#x60;Amendment.EffectiveDate&#x60; </value>
        ...
        /// </summary>
        /// <value>The date when the customer accepts the contract.  This field can be updated when **Status** is &#x60;Pending Acceptance&#x60;.  **Note** : This field is only required in the Subscribe call if the [Require Customer Acceptance of Orders?](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Settings/Define_Default_Subscription_and_Order_Settings#Require_Customer_Acceptance_of_Orders.3F) setting is set to &#x60;Yes&#x60;. If this setting is set to &#x60;Yes&#x60;:   * If the &#x60;ServiceActivationDate&#x60; field is required, you must set this field, &#x60;ServiceActivationDate&#x60;, and &#x60;ContractEffectiveDate&#x60; fields in the Subscribe call to activate a subscription.  * If the &#x60;ServiceActivationDate&#x60; field is not required, you must set both this field and the &#x60;ContractEffectiveDate&#x60; field in the Subscribe call to activate a subscription. If you only set a valid date in the &#x60;ContractEffectiveDate&#x60; field, the Subscribe call still returns success, but the subscription is in &#x60;Pending Acceptance&#x60; status.  This field can also be updated when the subscription is still on version one (has not been amended before) and the [Allow update Subscription trigger dates?](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Settings/Define_Default_Subscription_and_Order_Settings#Allow_update_Subscription_trigger_dates.3F) setting in Billing Settings is set to &#x60;Yes&#x60;.  </value>
        ...
        /// </summary>
        /// <value> The length of the period for the first subscription term. This field can be updated when Status is &#x60;Draft&#x60;. **Required**: If TermType is Termed **Character limit**: 20 **Values**: any valid number. </value>
        ...
        /// </summary>
        /// <value>The date when the subscription is activated.   **Character limit**: 29  This field can be updated when **Status** is &#x60;Pending Activation&#x60;.  **Note**: This field is only required in the Subscribe call if the [Require Service Activation of Orders?](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Settings/Define_Default_Subscription_and_Order_Settings#Require_Service_Activation_of_Orders.3F) setting is set to &#x60;Yes&#x60;. If this setting is set to &#x60;Yes&#x60;:   * If the &#x60;ContractAcceptanceDate&#x60; field is required, you must set this field, &#x60;ContractAcceptanceDate&#x60;, and &#x60;ContractEffectiveDate&#x60; fields in the Subscribe call to activate a subscription.  * If the &#x60;ContractAcceptanceDate&#x60; field is not required, you must set both this field and the &#x60;ContractEffectiveDate&#x60; field in the Subscribe call to activate a subscription. If you only set a valid date in the &#x60;ContractEffectiveDate&#x60; field, the Subscribe call still returns success, but the subscription is in &#x60;Pending Activation&#x60; status.  This field can also be updated when the subscription is still on version one (has not been amended before) and the [Allow update Subscription trigger dates?](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Settings/Define_Default_Subscription_and_Order_Settings#Allow_update_Subscription_trigger_dates.3F) setting in Billing Settings is set to \&quot;Yes\&quot;.  </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyModifySubscriptionAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyModifySubscriptionAllOf);
        }

        /// <summary>
        /// Returns true if ProxyModifySubscriptionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyModifySubscriptionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifySubscriptionAllOf input)
        {
            if (input == null)
            {
                return false;
