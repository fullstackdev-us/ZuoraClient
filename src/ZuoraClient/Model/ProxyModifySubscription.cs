...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyModifySubscription")]
    public partial class ProxyModifySubscription : IEquatable<ProxyModifySubscription>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyModifySubscription);
        }

        /// <summary>
        /// Returns true if ProxyModifySubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyModifySubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifySubscription input)
        {
            if (input == null)
            {
                return false;
