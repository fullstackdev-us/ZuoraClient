...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductRatePlanChargeObjectNSFields")]
    public partial class ProductRatePlanChargeObjectNSFields : IEquatable<ProductRatePlanChargeObjectNSFields>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductRatePlanChargeObjectNSFields" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProductRatePlanChargeObjectNSFields);
        }

        /// <summary>
        /// Returns true if ProductRatePlanChargeObjectNSFields instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductRatePlanChargeObjectNSFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductRatePlanChargeObjectNSFields input)
        {
            if (input == null)
            {
                return false;
