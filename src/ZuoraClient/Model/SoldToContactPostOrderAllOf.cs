...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SoldToContactPostOrder_allOf")]
    public partial class SoldToContactPostOrderAllOf : IEquatable<SoldToContactPostOrderAllOf>, IValidatableObject
    {
        /// <summary>
        /// Specifies the type of phone number in the &#x60;otherPhone&#x60; field. 
        /// </summary>
        /// <value>Specifies the type of phone number in the &#x60;otherPhone&#x60; field. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SoldToContactPostOrderAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SoldToContactPostOrderAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SoldToContactPostOrderAllOf" /> class.
        /// </summary>
        /// <param name="address1">First line of the contact&#39;s address. This is often a street address or a business name. .</param>
        /// <param name="address2">Second line of the contact&#39;s address. .</param>
        /// <param name="city">City of the contact&#39;s address. .</param>
        /// <param name="contactDescription">A description for the contact.           .</param>
        /// <param name="country">Country; must be a valid country name or abbreviation. If using Zuora Tax, you must specify a country in the sold-to contact to calculate tax. A bill-to contact may be used if no sold-to contact is provided. .</param>
        /// <param name="county">County of the contact&#39;s address. .</param>
        /// <param name="fax">Fax number of the contact. .</param>
        /// <param name="firstName">First name of the contact.  (required).</param>
        /// <param name="homePhone">Home phone number of the contact. .</param>
        /// <param name="lastName">Last name of the contact.  (required).</param>
        /// <param name="mobilePhone">Mobile phone number of the contact. .</param>
        /// <param name="nickname">Nickname of the contact. .</param>
        /// <param name="otherPhone">Additional phone number of the contact. Use the &#x60;otherPhoneType&#x60; field to specify the type of phone number. .</param>
        /// <param name="otherPhoneType">Specifies the type of phone number in the &#x60;otherPhone&#x60; field. .</param>
        /// <param name="personalEmail">Personal email address of the contact. .</param>
        /// <param name="postalCode">ZIP code or other postal code of the contact&#39;s address. .</param>
        /// <param name="state">State or province of the contact&#39;s address. .</param>
        /// <param name="taxRegion">Region defined in your taxation rules. Only applicable if you use Zuora Tax. .</param>
        /// <param name="workEmail">Business email address of the contact. .</param>
        /// <param name="workPhone">Business phone number of the contact. .</param>
        public SoldToContactPostOrderAllOf(string address1 = default(string), string address2 = default(string), string city = default(string), string contactDescription = default(string), string country = default(string), string county = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickname = default(string), string otherPhone = default(string), OtherPhoneTypeEnum? otherPhoneType = default(OtherPhoneTypeEnum?), string personalEmail = default(string), string postalCode = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for SoldToContactPostOrderAllOf and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for SoldToContactPostOrderAllOf and cannot be null");
            }
        ...
        /// </summary>
        /// <value>First line of the contact&#39;s address. This is often a street address or a business name. </value>
        ...
        /// </summary>
        /// <value>Second line of the contact&#39;s address. </value>
        ...
        /// </summary>
        /// <value>City of the contact&#39;s address. </value>
        ...
        [DataMember(Name = "contactDescription", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Country; must be a valid country name or abbreviation. If using Zuora Tax, you must specify a country in the sold-to contact to calculate tax. A bill-to contact may be used if no sold-to contact is provided. </value>
        ...
        /// </summary>
        /// <value>County of the contact&#39;s address. </value>
        ...
        /// </summary>
        /// <value>Home phone number of the contact. </value>
        ...
        /// </summary>
        /// <value>Mobile phone number of the contact. </value>
        ...
        /// </summary>
        /// <value>Nickname of the contact. </value>
        ...
        /// </summary>
        /// <value>Additional phone number of the contact. Use the &#x60;otherPhoneType&#x60; field to specify the type of phone number. </value>
        ...
        /// </summary>
        /// <value>Personal email address of the contact. </value>
        ...
        /// </summary>
        /// <value>ZIP code or other postal code of the contact&#39;s address. </value>
        ...
        /// </summary>
        /// <value>State or province of the contact&#39;s address. </value>
        ...
        /// </summary>
        /// <value>Region defined in your taxation rules. Only applicable if you use Zuora Tax. </value>
        ...
        /// </summary>
        /// <value>Business email address of the contact. </value>
        ...
        /// </summary>
        /// <value>Business phone number of the contact. </value>
        ...
        {
            return this.Equals(input as SoldToContactPostOrderAllOf);
        }

        /// <summary>
        /// Returns true if SoldToContactPostOrderAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SoldToContactPostOrderAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SoldToContactPostOrderAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ContactDescription == input.ContactDescription ||
                    (this.ContactDescription != null &&
                    this.ContactDescription.Equals(input.ContactDescription))
                ) && 
                (
                ...
                (
                    this.OtherPhoneType == input.OtherPhoneType ||
                    this.OtherPhoneType.Equals(input.OtherPhoneType)
                ) && 
                (
                ...
                (
                    this.TaxRegion == input.TaxRegion ||
                    (this.TaxRegion != null &&
                    this.TaxRegion.Equals(input.TaxRegion))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ContactDescription.GetHashCode();
                }
                ...
                hashCode = (hashCode * 59) + this.OtherPhoneType.GetHashCode();
                ...
                {
                    hashCode = (hashCode * 59) + this.TaxRegion.GetHashCode();
                }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Address1, length must be less than 255.", new [] { "Address1" });
            }

            // Address2 (string) maxLength
            if (this.Address2 != null && this.Address2.Length > 255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Address2, length must be less than 255.", new [] { "Address2" });
            }

            // City (string) maxLength
            if (this.City != null && this.City.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for City, length must be less than 40.", new [] { "City" });
            }

            // ContactDescription (string) maxLength
            if (this.ContactDescription != null && this.ContactDescription.Length > 100)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ContactDescription, length must be less than 100.", new [] { "ContactDescription" });
            }
            ...
            if (this.Fax != null && this.Fax.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Fax, length must be less than 40.", new [] { "Fax" });
            }
            ...
            if (this.HomePhone != null && this.HomePhone.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for HomePhone, length must be less than 40.", new [] { "HomePhone" });
            }
            ...
            if (this.MobilePhone != null && this.MobilePhone.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MobilePhone, length must be less than 40.", new [] { "MobilePhone" });
            }

            // Nickname (string) maxLength
            if (this.Nickname != null && this.Nickname.Length > 100)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Nickname, length must be less than 100.", new [] { "Nickname" });
            }

            // OtherPhone (string) maxLength
            if (this.OtherPhone != null && this.OtherPhone.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for OtherPhone, length must be less than 40.", new [] { "OtherPhone" });
            }

            // PersonalEmail (string) maxLength
            if (this.PersonalEmail != null && this.PersonalEmail.Length > 80)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PersonalEmail, length must be less than 80.", new [] { "PersonalEmail" });
            }
            ...
            if (this.State != null && this.State.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for State, length must be less than 40.", new [] { "State" });
            }

            // TaxRegion (string) maxLength
            if (this.TaxRegion != null && this.TaxRegion.Length > 32)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TaxRegion, length must be less than 32.", new [] { "TaxRegion" });
            }

            // WorkEmail (string) maxLength
            if (this.WorkEmail != null && this.WorkEmail.Length > 80)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for WorkEmail, length must be less than 80.", new [] { "WorkEmail" });
            }

            // WorkPhone (string) maxLength
            if (this.WorkPhone != null && this.WorkPhone.Length > 40)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for WorkPhone, length must be less than 40.", new [] { "WorkPhone" });
            }
