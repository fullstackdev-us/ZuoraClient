...
namespace ZuoraClient.Model
{
    ...
    /// BillToContact
    /// </summary>
    [DataContract(Name = "BillToContact")]
    public partial class BillToContact : IEquatable<BillToContact>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BillToContact" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BillToContact() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BillToContact" /> class.
        /// </summary>
        ...
        public BillToContact(string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickname = default(string), string otherPhone = default(string), OtherPhoneTypeEnum? otherPhoneType = default(OtherPhoneTypeEnum?), string personalEmail = default(string), string postalCode = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for BillToContact and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for BillToContact and cannot be null");
            }
        ...
        {
            return this.Equals(input as BillToContact);
        }

        /// <summary>
        /// Returns true if BillToContact instances are equal
        /// </summary>
        /// <param name="input">Instance of BillToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillToContact input)
        {
            if (input == null)
            {
                return false;
