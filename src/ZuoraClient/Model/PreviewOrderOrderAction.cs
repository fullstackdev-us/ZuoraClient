...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreviewOrderOrderAction")]
    public partial class PreviewOrderOrderAction : IEquatable<PreviewOrderOrderAction>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Type of order action.  Unless the type of order action is &#x60;RenewSubscription&#x60;, you must use the corresponding field to provide information about the order action. For example, if the type of order action is &#x60;AddProduct&#x60;, you must set the &#x60;addProduct&#x60; field.  Zuora returns an error if you set a field that corresponds to a different type of order action. For example, if the type of order action is &#x60;AddProduct&#x60;, Zuora returns an error if you set the &#x60;updateProduct&#x60; field.  **Note**: The change plan type of order action is in the **Early Adopter** phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/). </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum TypeEnum
        {
            /// <summary>
            /// Enum CreateSubscription for value: CreateSubscription
            /// </summary>
            ...
            /// <summary>
            /// Enum AddProduct for value: AddProduct
            /// </summary>
            ...
            /// <summary>
            /// Enum RenewSubscription for value: RenewSubscription
            /// </summary>
            ...
            /// <summary>
            /// Enum OwnerTransfer for value: OwnerTransfer
            /// </summary>
            [EnumMember(Value = "OwnerTransfer")]
            OwnerTransfer = 8,
            ...
            /// <summary>
            /// Enum ChangePlan for value: ChangePlan
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PreviewOrderOrderAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PreviewOrderOrderAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreviewOrderOrderAction" /> class.
        /// </summary>
        ...
        /// <param name="changeReason">The change reason set for an order action when an order is created. .</param>
        /// <param name="createSubscription">createSubscription.</param>
        /// <param name="customFields">Container for custom fields of an Order Action object. .</param>
        /// <param name="ownerTransfer">ownerTransfer.</param>
        /// <param name="removeProduct">removeProduct.</param>
        /// <param name="renewSubscription">renewSubscription.</param>
        /// <param name="resume">resume.</param>
        /// <param name="suspend">suspend.</param>
        /// <param name="termsAndConditions">termsAndConditions.</param>
        /// <param name="triggerDates">Container for the contract effective, service activation, and customer acceptance dates of the order action.   If the service activation date is set as a required field in Default Subscription Settings, skipping this field in a &#x60;CreateSubscription&#x60; order action of your JSON request will result in a &#x60;Pending&#x60; order and a &#x60;Pending Activation&#x60; subscription.  If the customer acceptance date is set as a required field in Default Subscription Settings, skipping this field in a &#x60;CreateSubscription&#x60; order action of your JSON request will result in a &#x60;Pending&#x60; order and a &#x60;Pending Acceptance&#x60; subscription. If the service activation date field is at the same time required and skipped (or set as null), it will be a &#x60;Pending Activation&#x60; subscription. .</param>
        /// <param name="type">Type of order action.  Unless the type of order action is &#x60;RenewSubscription&#x60;, you must use the corresponding field to provide information about the order action. For example, if the type of order action is &#x60;AddProduct&#x60;, you must set the &#x60;addProduct&#x60; field.  Zuora returns an error if you set a field that corresponds to a different type of order action. For example, if the type of order action is &#x60;AddProduct&#x60;, Zuora returns an error if you set the &#x60;updateProduct&#x60; field.  **Note**: The change plan type of order action is in the **Early Adopter** phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).  (required).</param>
        /// <param name="updateProduct">updateProduct.</param>
        public PreviewOrderOrderAction(PreviewOrderRatePlanOverride addProduct = default(PreviewOrderRatePlanOverride), CancelSubscription cancelSubscription = default(CancelSubscription), CreateChangePlan changePlan = default(CreateChangePlan), string changeReason = default(string), PreviewOrderCreateSubscription createSubscription = default(PreviewOrderCreateSubscription), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), OwnerTransfer ownerTransfer = default(OwnerTransfer), RemoveProduct removeProduct = default(RemoveProduct), RenewSubscription renewSubscription = default(RenewSubscription), CreateOrderResume resume = default(CreateOrderResume), CreateOrderSuspend suspend = default(CreateOrderSuspend), CreateOrderTermsAndConditions termsAndConditions = default(CreateOrderTermsAndConditions), List<TriggerDate> triggerDates = default(List<TriggerDate>), TypeEnum type = default(TypeEnum), PreviewOrderRatePlanUpdate updateProduct = default(PreviewOrderRatePlanUpdate))
        {
            this.Type = type;
        ...
        /// <summary>
        /// Gets or Sets AddProduct
        /// </summary>
        [DataMember(Name = "addProduct", EmitDefaultValue = false)]
        public PreviewOrderRatePlanOverride AddProduct { get; set; }

        /// <summary>
        /// Gets or Sets CancelSubscription
        /// </summary>
        [DataMember(Name = "cancelSubscription", EmitDefaultValue = false)]
        public CancelSubscription CancelSubscription { get; set; }

        /// <summary>
        /// Gets or Sets ChangePlan
        /// </summary>
        [DataMember(Name = "changePlan", EmitDefaultValue = false)]
        public CreateChangePlan ChangePlan { get; set; }

        /// <summary>
        /// The change reason set for an order action when an order is created. 
        /// </summary>
        /// <value>The change reason set for an order action when an order is created. </value>
        [DataMember(Name = "changeReason", EmitDefaultValue = false)]
        public string ChangeReason { get; set; }

        /// <summary>
        /// Gets or Sets CreateSubscription
        /// </summary>
        [DataMember(Name = "createSubscription", EmitDefaultValue = false)]
        public PreviewOrderCreateSubscription CreateSubscription { get; set; }

        /// <summary>
        /// Container for custom fields of an Order Action object. 
        /// </summary>
        /// <value>Container for custom fields of an Order Action object. </value>
        [DataMember(Name = "customFields", EmitDefaultValue = false)]
        public Dictionary<string, Object> CustomFields { get; set; }

        /// <summary>
        /// Gets or Sets OwnerTransfer
        /// </summary>
        [DataMember(Name = "ownerTransfer", EmitDefaultValue = false)]
        public OwnerTransfer OwnerTransfer { get; set; }

        /// <summary>
        /// Gets or Sets RemoveProduct
        /// </summary>
        [DataMember(Name = "removeProduct", EmitDefaultValue = false)]
        public RemoveProduct RemoveProduct { get; set; }

        /// <summary>
        /// Gets or Sets RenewSubscription
        /// </summary>
        [DataMember(Name = "renewSubscription", EmitDefaultValue = false)]
        public RenewSubscription RenewSubscription { get; set; }

        /// <summary>
        /// Gets or Sets Resume
        /// </summary>
        [DataMember(Name = "resume", EmitDefaultValue = false)]
        public CreateOrderResume Resume { get; set; }

        /// <summary>
        /// Gets or Sets Suspend
        /// </summary>
        [DataMember(Name = "suspend", EmitDefaultValue = false)]
        public CreateOrderSuspend Suspend { get; set; }

        /// <summary>
        /// Gets or Sets TermsAndConditions
        /// </summary>
        [DataMember(Name = "termsAndConditions", EmitDefaultValue = false)]
        public CreateOrderTermsAndConditions TermsAndConditions { get; set; }
        ...
        /// </summary>
        /// <value>Container for the contract effective, service activation, and customer acceptance dates of the order action.   If the service activation date is set as a required field in Default Subscription Settings, skipping this field in a &#x60;CreateSubscription&#x60; order action of your JSON request will result in a &#x60;Pending&#x60; order and a &#x60;Pending Activation&#x60; subscription.  If the customer acceptance date is set as a required field in Default Subscription Settings, skipping this field in a &#x60;CreateSubscription&#x60; order action of your JSON request will result in a &#x60;Pending&#x60; order and a &#x60;Pending Acceptance&#x60; subscription. If the service activation date field is at the same time required and skipped (or set as null), it will be a &#x60;Pending Activation&#x60; subscription. </value>
        [DataMember(Name = "triggerDates", EmitDefaultValue = false)]
        public List<TriggerDate> TriggerDates { get; set; }

        /// <summary>
        /// Gets or Sets UpdateProduct
        /// </summary>
        [DataMember(Name = "updateProduct", EmitDefaultValue = false)]
        public PreviewOrderRatePlanUpdate UpdateProduct { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AddProduct: ").Append(AddProduct).Append("\n");
            sb.Append("  CancelSubscription: ").Append(CancelSubscription).Append("\n");
            sb.Append("  ChangePlan: ").Append(ChangePlan).Append("\n");
            sb.Append("  ChangeReason: ").Append(ChangeReason).Append("\n");
            sb.Append("  CreateSubscription: ").Append(CreateSubscription).Append("\n");
            sb.Append("  CustomFields: ").Append(CustomFields).Append("\n");
            sb.Append("  OwnerTransfer: ").Append(OwnerTransfer).Append("\n");
            sb.Append("  RemoveProduct: ").Append(RemoveProduct).Append("\n");
            sb.Append("  RenewSubscription: ").Append(RenewSubscription).Append("\n");
            sb.Append("  Resume: ").Append(Resume).Append("\n");
            sb.Append("  Suspend: ").Append(Suspend).Append("\n");
            sb.Append("  TermsAndConditions: ").Append(TermsAndConditions).Append("\n");
            sb.Append("  TriggerDates: ").Append(TriggerDates).Append("\n");
            sb.Append("  Type: ").Append(Type).Append("\n");
            sb.Append("  UpdateProduct: ").Append(UpdateProduct).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PreviewOrderOrderAction);
        }

        /// <summary>
        /// Returns true if PreviewOrderOrderAction instances are equal
        /// </summary>
        /// <param name="input">Instance of PreviewOrderOrderAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreviewOrderOrderAction input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.AddProduct == input.AddProduct ||
                    (this.AddProduct != null &&
                    this.AddProduct.Equals(input.AddProduct))
                ) && 
                (
                ...
                (
                    this.ChangePlan == input.ChangePlan ||
                    (this.ChangePlan != null &&
                    this.ChangePlan.Equals(input.ChangePlan))
                ) && 
                (
                ...
                (
                    this.CreateSubscription == input.CreateSubscription ||
                    (this.CreateSubscription != null &&
                    this.CreateSubscription.Equals(input.CreateSubscription))
                ) && 
                (
                ...
                (
                    this.OwnerTransfer == input.OwnerTransfer ||
                    (this.OwnerTransfer != null &&
                    this.OwnerTransfer.Equals(input.OwnerTransfer))
                ) && 
                (
                    this.RemoveProduct == input.RemoveProduct ||
                    (this.RemoveProduct != null &&
                    this.RemoveProduct.Equals(input.RemoveProduct))
                ) && 
                (
                    this.RenewSubscription == input.RenewSubscription ||
                    (this.RenewSubscription != null &&
                    this.RenewSubscription.Equals(input.RenewSubscription))
                ) && 
                (
                ...
                (
                    this.TriggerDates == input.TriggerDates ||
                    this.TriggerDates != null &&
                    input.TriggerDates != null &&
                    this.TriggerDates.SequenceEqual(input.TriggerDates)
                ) && 
                (
                ...
                (
                    this.UpdateProduct == input.UpdateProduct ||
                    (this.UpdateProduct != null &&
                    this.UpdateProduct.Equals(input.UpdateProduct))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AddProduct.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.ChangePlan.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.CreateSubscription.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.OwnerTransfer.GetHashCode();
                }
                if (this.RemoveProduct != null)
                {
                    hashCode = (hashCode * 59) + this.RemoveProduct.GetHashCode();
                }
                if (this.RenewSubscription != null)
                {
                    hashCode = (hashCode * 59) + this.RenewSubscription.GetHashCode();
                }
                if (this.Resume != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + this.TriggerDates.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.Type.GetHashCode();
                if (this.UpdateProduct != null)
                {
                    hashCode = (hashCode * 59) + this.UpdateProduct.GetHashCode();
                }
                return hashCode;
            }
        }
