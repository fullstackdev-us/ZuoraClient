...
namespace ZuoraClient.Model
{
    ...
    /// GETARPaymentType
    /// </summary>
    [DataContract(Name = "GETARPaymentType")]
    public partial class GETARPaymentType : IEquatable<GETARPaymentType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETARPaymentType" /> class.
        /// </summary>
        /// <param name="accountId">The ID of the customer account that the payment is for. .</param>
        /// <param name="accountNumber">The number of the customer account that the payment is for. .</param>
        /// <param name="amount">The total amount of the payment. .</param>
        /// <param name="appliedAmount">The applied amount of the payment. .</param>
        /// <param name="authTransactionId">The authorization transaction ID from the payment gateway. .</param>
        /// <param name="bankIdentificationNumber">The first six or eight digits of the credit card or debit card used for the payment, when applicable. .</param>
        /// <param name="cancelledOn">The date and time when the payment was cancelled, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        /// <param name="comment">Comments about the payment. .</param>
        /// <param name="createdById">The ID of the Zuora user who created the payment. .</param>
        /// <param name="createdDate">The date and time when the payment was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10. .</param>
        /// <param name="creditBalanceAmount">The amount that the payment transfers to the credit balance. The value is not &#x60;0&#x60; only for those payments that come from legacy payment operations performed without the Invoice Settlement feature. .</param>
        /// <param name="currency">When Standalone Payment is not enabled, the &#x60;currency&#x60; of the payment must be the same as the payment currency defined in the customer account settings through Zuora UI.  When Standalone Payment is enabled and &#x60;standalone&#x60; is &#x60;true&#x60;, the &#x60;currency&#x60; of the standalone payment can be different from the payment currency defined in the customer account settings. The amount will not be summed up to the account balance or key metrics regardless of currency. .</param>
        /// <param name="effectiveDate">The date and time when the payment takes effect, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        /// <param name="financeInformation">financeInformation.</param>
        /// <param name="gatewayId">The ID of the gateway instance that processes the payment. .</param>
        /// <param name="gatewayOrderId">A merchant-specified natural key value that can be passed to the electronic payment gateway when a payment is created.  If not specified, the payment number will be passed in instead. .</param>
        /// <param name="gatewayReconciliationReason">The reason of gateway reconciliation. .</param>
        /// <param name="gatewayReconciliationStatus">The status of gateway reconciliation. .</param>
        ...
        /// <param name="id">The unique ID of the created payment. For example, 4028905f5a87c0ff015a87eb6b75007f. .</param>
        /// <param name="markedForSubmissionOn">The date and time when a payment was marked and waiting for batch submission to the payment process, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        /// <param name="number">The unique identification number of the payment. For example, P-00000001. .</param>
        /// <param name="paymentMethodId">The unique ID of the payment method that the customer used to make the payment. .</param>
        /// <param name="paymentMethodSnapshotId">The unique ID of the payment method snapshot which is a copy of the particular Payment Method used in a transaction. .</param>
        /// <param name="paymentScheduleNumber">The number of the payment schedule that is linked to the payment. See [Link payments to payment schedules](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Payment_Schedules/Link_payments_with_payment_schedules) for more information..</param>
        /// <param name="payoutId">The payout ID of the payment from the gateway side. .</param>
        ...
        /// <param name="refundAmount">The amount of the payment that is refunded. .</param>
        /// <param name="secondPaymentReferenceId">The transaction ID returned by the payment gateway if there is an additional transaction for the payment. Use this field to reconcile payments between your gateway and Zuora Payments. .</param>
        /// <param name="settledOn">The date and time when the payment was settled in the payment processor, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. This field is used by the Spectrum gateway only and not applicable to other gateways. .</param>
        /// <param name="softDescriptor">A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi. .</param>
        /// <param name="softDescriptorPhone">A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi. .</param>
        /// <param name="standalone">This field is only available if the support for standalone payment is enabled. This field is not available for transferring, applying, or unapplying a payment.  The value &#x60;true&#x60; indicates this is a standalone payment that is created and processed in Zuora through Zuora gateway integration but will be settled outside of Zuora. No settlement data will be created. The standalone payment cannot be applied, unapplied, or transferred.  The value &#x60;false&#x60; indicates this is an ordinary payment that is created, processed, and settled in Zuora.  (default to false).</param>
        /// <param name="status">The status of the payment. .</param>
        /// <param name="submittedOn">The date and time when the payment was submitted, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        ...
        /// <param name="unappliedAmount">The unapplied amount of the payment. .</param>
        /// <param name="updatedById">The ID of the Zuora user who last updated the payment. .</param>
        /// <param name="updatedDate">The date and time when the payment was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. .</param>
        ...
        public GETARPaymentType(string accountId = default(string), string accountNumber = default(string), double amount = default(double), double appliedAmount = default(double), string authTransactionId = default(string), string bankIdentificationNumber = default(string), DateTime cancelledOn = default(DateTime), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), double creditBalanceAmount = default(double), string currency = default(string), DateTime effectiveDate = default(DateTime), GETARPaymentTypeAllOfFinanceInformation financeInformation = default(GETARPaymentTypeAllOfFinanceInformation), string gatewayId = default(string), string gatewayOrderId = default(string), string gatewayReconciliationReason = default(string), string gatewayReconciliationStatus = default(string), string gatewayResponse = default(string), string gatewayResponseCode = default(string), GatewayStateEnum? gatewayState = default(GatewayStateEnum?), string id = default(string), DateTime markedForSubmissionOn = default(DateTime), string number = default(string), string paymentMethodId = default(string), string paymentMethodSnapshotId = default(string), string paymentScheduleNumber = default(string), string payoutId = default(string), string referenceId = default(string), double refundAmount = default(double), string secondPaymentReferenceId = default(string), DateTime settledOn = default(DateTime), string softDescriptor = default(string), string softDescriptorPhone = default(string), bool standalone = false, StatusEnum? status = default(StatusEnum?), DateTime submittedOn = default(DateTime), bool success = default(bool), TypeEnum? type = default(TypeEnum?), double unappliedAmount = default(double), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string transactionNS = default(string))
        {
        ...
        /// </summary>
        /// <value>The ID of the customer account that the payment is for. </value>
        ...
        /// </summary>
        /// <value>The number of the customer account that the payment is for. </value>
        ...
        /// </summary>
        /// <value>The applied amount of the payment. </value>
        ...
        /// </summary>
        /// <value>The authorization transaction ID from the payment gateway. </value>
        ...
        /// </summary>
        /// <value>The first six or eight digits of the credit card or debit card used for the payment, when applicable. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment was cancelled, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>Comments about the payment. </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who created the payment. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10. </value>
        ...
        /// </summary>
        /// <value>The amount that the payment transfers to the credit balance. The value is not &#x60;0&#x60; only for those payments that come from legacy payment operations performed without the Invoice Settlement feature. </value>
        [DataMember(Name = "creditBalanceAmount", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>When Standalone Payment is not enabled, the &#x60;currency&#x60; of the payment must be the same as the payment currency defined in the customer account settings through Zuora UI.  When Standalone Payment is enabled and &#x60;standalone&#x60; is &#x60;true&#x60;, the &#x60;currency&#x60; of the standalone payment can be different from the payment currency defined in the customer account settings. The amount will not be summed up to the account balance or key metrics regardless of currency. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment takes effect, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        public GETARPaymentTypeAllOfFinanceInformation FinanceInformation { get; set; }

        /// <summary>
        /// The ID of the gateway instance that processes the payment. 
        /// </summary>
        /// <value>The ID of the gateway instance that processes the payment. </value>
        ...
        /// </summary>
        /// <value>A merchant-specified natural key value that can be passed to the electronic payment gateway when a payment is created.  If not specified, the payment number will be passed in instead. </value>
        ...
        /// </summary>
        /// <value>The reason of gateway reconciliation. </value>
        [DataMember(Name = "gatewayReconciliationReason", EmitDefaultValue = false)]
        public string GatewayReconciliationReason { get; set; }

        /// <summary>
        /// The status of gateway reconciliation. 
        /// </summary>
        /// <value>The status of gateway reconciliation. </value>
        [DataMember(Name = "gatewayReconciliationStatus", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The unique ID of the created payment. For example, 4028905f5a87c0ff015a87eb6b75007f. </value>
        ...
        /// </summary>
        /// <value>The date and time when a payment was marked and waiting for batch submission to the payment process, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The unique identification number of the payment. For example, P-00000001. </value>
        ...
        /// </summary>
        /// <value>The unique ID of the payment method that the customer used to make the payment. </value>
        ...
        /// </summary>
        /// <value>The unique ID of the payment method snapshot which is a copy of the particular Payment Method used in a transaction. </value>
        [DataMember(Name = "paymentMethodSnapshotId", EmitDefaultValue = false)]
        public string PaymentMethodSnapshotId { get; set; }

        /// <summary>
        /// The number of the payment schedule that is linked to the payment. See [Link payments to payment schedules](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Payment_Schedules/Link_payments_with_payment_schedules) for more information.
        /// </summary>
        /// <value>The number of the payment schedule that is linked to the payment. See [Link payments to payment schedules](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Payment_Schedules/Link_payments_with_payment_schedules) for more information.</value>
        [DataMember(Name = "paymentScheduleNumber", EmitDefaultValue = false)]
        public string PaymentScheduleNumber { get; set; }

        /// <summary>
        /// The payout ID of the payment from the gateway side. 
        /// </summary>
        /// <value>The payout ID of the payment from the gateway side. </value>
        ...
        /// </summary>
        /// <value>The amount of the payment that is refunded. </value>
        ...
        /// </summary>
        /// <value>The transaction ID returned by the payment gateway if there is an additional transaction for the payment. Use this field to reconcile payments between your gateway and Zuora Payments. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment was settled in the payment processor, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. This field is used by the Spectrum gateway only and not applicable to other gateways. </value>
        ...
        /// </summary>
        /// <value>A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi. </value>
        ...
        /// </summary>
        /// <value>This field is only available if the support for standalone payment is enabled. This field is not available for transferring, applying, or unapplying a payment.  The value &#x60;true&#x60; indicates this is a standalone payment that is created and processed in Zuora through Zuora gateway integration but will be settled outside of Zuora. No settlement data will be created. The standalone payment cannot be applied, unapplied, or transferred.  The value &#x60;false&#x60; indicates this is an ordinary payment that is created, processed, and settled in Zuora. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment was submitted, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The unapplied amount of the payment. </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who last updated the payment. </value>
        ...
        /// </summary>
        /// <value>The date and time when the payment was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CreditBalanceAmount: ").Append(CreditBalanceAmount).Append("\n");
        ...
        {
            return this.Equals(input as GETARPaymentType);
        }

        /// <summary>
        /// Returns true if GETARPaymentType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETARPaymentType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETARPaymentType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CreditBalanceAmount == input.CreditBalanceAmount ||
                    this.CreditBalanceAmount.Equals(input.CreditBalanceAmount)
                ) && 
                (
                ...
                (
                    this.GatewayReconciliationReason == input.GatewayReconciliationReason ||
                    (this.GatewayReconciliationReason != null &&
                    this.GatewayReconciliationReason.Equals(input.GatewayReconciliationReason))
                ) && 
                (
                    this.GatewayReconciliationStatus == input.GatewayReconciliationStatus ||
                    (this.GatewayReconciliationStatus != null &&
                    this.GatewayReconciliationStatus.Equals(input.GatewayReconciliationStatus))
                ) && 
                (
                ...
                (
                    this.MarkedForSubmissionOn == input.MarkedForSubmissionOn ||
                    (this.MarkedForSubmissionOn != null &&
                    this.MarkedForSubmissionOn.Equals(input.MarkedForSubmissionOn))
                ) && 
                (
                ...
                (
                    this.PaymentMethodSnapshotId == input.PaymentMethodSnapshotId ||
                    (this.PaymentMethodSnapshotId != null &&
                    this.PaymentMethodSnapshotId.Equals(input.PaymentMethodSnapshotId))
                ) && 
                (
                    this.PaymentScheduleNumber == input.PaymentScheduleNumber ||
                    (this.PaymentScheduleNumber != null &&
                    this.PaymentScheduleNumber.Equals(input.PaymentScheduleNumber))
                ) && 
                (
                ...
                (
                    this.SecondPaymentReferenceId == input.SecondPaymentReferenceId ||
                    (this.SecondPaymentReferenceId != null &&
                    this.SecondPaymentReferenceId.Equals(input.SecondPaymentReferenceId))
                ) && 
                (
                    this.SettledOn == input.SettledOn ||
                    (this.SettledOn != null &&
                    this.SettledOn.Equals(input.SettledOn))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.CreditBalanceAmount.GetHashCode();
                ...
                if (this.GatewayReconciliationReason != null)
                {
                    hashCode = (hashCode * 59) + this.GatewayReconciliationReason.GetHashCode();
                }
                if (this.GatewayReconciliationStatus != null)
                {
                    hashCode = (hashCode * 59) + this.GatewayReconciliationStatus.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.MarkedForSubmissionOn.GetHashCode();
                }
                if (this.Number != null)
                {
                ...
                {
                    hashCode = (hashCode * 59) + this.PaymentMethodSnapshotId.GetHashCode();
                }
                if (this.PaymentScheduleNumber != null)
                {
                    hashCode = (hashCode * 59) + this.PaymentScheduleNumber.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.SecondPaymentReferenceId.GetHashCode();
                }
                if (this.SettledOn != null)
                {
                    hashCode = (hashCode * 59) + this.SettledOn.GetHashCode();
                }
