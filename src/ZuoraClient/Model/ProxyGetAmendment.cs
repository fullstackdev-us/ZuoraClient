...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetAmendment
    /// </summary>
    [DataContract(Name = "ProxyGetAmendment")]
    public partial class ProxyGetAmendment : IEquatable<ProxyGetAmendment>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyGetAmendment);
        }

        /// <summary>
        /// Returns true if ProxyGetAmendment instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetAmendment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetAmendment input)
        {
            if (input == null)
            {
                return false;
