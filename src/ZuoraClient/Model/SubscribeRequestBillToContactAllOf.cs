...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscribeRequestBillToContact_allOf")]
    public partial class SubscribeRequestBillToContactAllOf : IEquatable<SubscribeRequestBillToContactAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeRequestBillToContactAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubscribeRequestBillToContactAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeRequestBillToContactAllOf" /> class.
        /// </summary>
        /// <param name="accountId"> The Zuora account ID associated with this contact. This field is not required when you use the subscribe call. This field is required for all other calls. **Character limit: **32 **Values: **a valid account ID .</param>
        ...
        /// <param name="country"> The country of the contact&#39;s address. This field is only required if you enbale taxation. .</param>
        ...
        public SubscribeRequestBillToContactAllOf(string accountId = default(string), string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), string description = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickName = default(string), string otherPhone = default(string), string otherPhoneType = default(string), string personalEmail = default(string), string postalCode = default(string), string state = default(string), string taxRegion = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime), string workEmail = default(string), string workPhone = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for SubscribeRequestBillToContactAllOf and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for SubscribeRequestBillToContactAllOf and cannot be null");
            }
        ...
        /// </summary>
        /// <value> The country of the contact&#39;s address. This field is only required if you enbale taxation. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubscribeRequestBillToContactAllOf {\n");
        ...
        {
            return this.Equals(input as SubscribeRequestBillToContactAllOf);
        }

        /// <summary>
        /// Returns true if SubscribeRequestBillToContactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribeRequestBillToContactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribeRequestBillToContactAllOf input)
        {
            if (input == null)
            {
                return false;
