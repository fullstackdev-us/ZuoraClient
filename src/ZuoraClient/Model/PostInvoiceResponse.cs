...
namespace ZuoraClient.Model
{
    ...
    /// PostInvoiceResponse
    /// </summary>
    [DataContract(Name = "PostInvoiceResponse")]
    public partial class PostInvoiceResponse : IEquatable<PostInvoiceResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInvoiceResponse" /> class.
        /// </summary>
        ...
        /// <param name="amountWithoutTax">The invoice amount excluding tax. .</param>
        ...
        /// <param name="discount">the invoice discount amount. .</param>
        ...
        /// <param name="invoiceDate">The date that appears on the invoice being created. .</param>
        /// <param name="invoiceNumber">The unique identification number of the invoice. .</param>
        /// <param name="status">The status of the invoice. .</param>
        /// <param name="taxAmount">The amount of taxation. .</param>
        /// <param name="taxExemptAmount">The calculated tax amount excluded due to the exemption. .</param>
        ...
        public PostInvoiceResponse(string accountId = default(string), decimal amount = default(decimal), decimal amountWithoutTax = default(decimal), bool autoPay = default(bool), string comments = default(string), decimal discount = default(decimal), DateTime dueDate = default(DateTime), bool excludeItemBillingFromRevenueAccounting = default(bool), string id = default(string), DateTime invoiceDate = default(DateTime), string invoiceNumber = default(string), StatusEnum? status = default(StatusEnum?), decimal taxAmount = default(decimal), decimal taxExemptAmount = default(decimal), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// </summary>
        /// <value>The invoice amount excluding tax. </value>
        ...
        /// </summary>
        /// <value>the invoice discount amount. </value>
        ...
        /// </summary>
        /// <value>The date that appears on the invoice being created. </value>
        ...
        {
            return this.Equals(input as PostInvoiceResponse);
        }

        /// <summary>
        /// Returns true if PostInvoiceResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PostInvoiceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostInvoiceResponse input)
        {
            if (input == null)
            {
                return false;
