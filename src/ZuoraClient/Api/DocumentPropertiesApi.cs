...
namespace ZuoraClient.Api
{
    ...
    /// </summary>
    public interface IDocumentPropertiesApiSync : IApiAccessor
    {
        ...
        /// <param name="documentPropertiesId">The unique ID of document properties. For example, 402892c74c9193cd014c96bbe7c101f9. </param>
        ...
        CommonResponseType DELETEDocumentProperties(string documentPropertiesId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        ApiResponse<CommonResponseType> DELETEDocumentPropertiesWithHttpInfo(string documentPropertiesId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="documentType">The type of the billing document.  </param>
        /// <param name="documentId">The unique ID of document properties to be retrieved. For example, 402892c74c9193cd014c96bbe7c101f9. </param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETDocumentPropertiesResponseType</returns>
        GETDocumentPropertiesResponseType GETDocumentProperies(string documentType, string documentId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETDocumentPropertiesResponseType</returns>
        ApiResponse<GETDocumentPropertiesResponseType> GETDocumentProperiesWithHttpInfo(string documentType, string documentId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETDocumentPropertiesResponseType</returns>
        GETDocumentPropertiesResponseType POSTDocumentProperties(POSTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETDocumentPropertiesResponseType</returns>
        ApiResponse<GETDocumentPropertiesResponseType> POSTDocumentPropertiesWithHttpInfo(POSTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="documentPropertiesId">The unique ID of document properties to be updated. For example, 402892c74c9193cd014c96bbe7c101f9. </param>
        /// <param name="request"></param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETDocumentPropertiesResponseType</returns>
        GETDocumentPropertiesResponseType PUTDocumentProperties(string documentPropertiesId, PUTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETDocumentPropertiesResponseType</returns>
        ApiResponse<GETDocumentPropertiesResponseType> PUTDocumentPropertiesWithHttpInfo(string documentPropertiesId, PUTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDocumentPropertiesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<CommonResponseType>> DELETEDocumentPropertiesWithHttpInfoAsync(string documentPropertiesId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all properties of a billing document
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETDocumentPropertiesResponseType</returns>
        System.Threading.Tasks.Task<GETDocumentPropertiesResponseType> GETDocumentProperiesAsync(string documentType, string documentId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETDocumentPropertiesResponseType)</returns>
        System.Threading.Tasks.Task<ApiResponse<GETDocumentPropertiesResponseType>> GETDocumentProperiesWithHttpInfoAsync(string documentType, string documentId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create document properties
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETDocumentPropertiesResponseType</returns>
        System.Threading.Tasks.Task<GETDocumentPropertiesResponseType> POSTDocumentPropertiesAsync(POSTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETDocumentPropertiesResponseType)</returns>
        System.Threading.Tasks.Task<ApiResponse<GETDocumentPropertiesResponseType>> POSTDocumentPropertiesWithHttpInfoAsync(POSTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update document properties
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETDocumentPropertiesResponseType</returns>
        System.Threading.Tasks.Task<GETDocumentPropertiesResponseType> PUTDocumentPropertiesAsync(string documentPropertiesId, PUTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETDocumentPropertiesResponseType)</returns>
        System.Threading.Tasks.Task<ApiResponse<GETDocumentPropertiesResponseType>> PUTDocumentPropertiesWithHttpInfoAsync(string documentPropertiesId, PUTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDocumentPropertiesApi : IDocumentPropertiesApiSync, IDocumentPropertiesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DocumentPropertiesApi : IDocumentPropertiesApi
    {
        private ZuoraClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentPropertiesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DocumentPropertiesApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public DocumentPropertiesApi(string basePath)
        {
        ...
        /// <returns></returns>
        public DocumentPropertiesApi(ZuoraClient.Client.Configuration configuration)
        {
        ...
        public DocumentPropertiesApi(ZuoraClient.Client.ISynchronousClient client, ZuoraClient.Client.IAsynchronousClient asyncClient, ZuoraClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Delete document properties **Note:** This feature is available only if you have the Billing Document Properties Setup feature enabled. The Billing Document Properties Setup feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Deletes document properties with a specific ID for a billing document. Billing documents include invoices, credit memos, and debit memos.  **Note:** You can delete document properties for credit and debit memos only if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="documentPropertiesId">The unique ID of document properties. For example, 402892c74c9193cd014c96bbe7c101f9. </param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CommonResponseType</returns>
        public CommonResponseType DELETEDocumentProperties(string documentPropertiesId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<CommonResponseType> localVarResponse = DELETEDocumentPropertiesWithHttpInfo(documentPropertiesId, authorization, zuoraEntityIds, zuoraTrackId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CommonResponseType</returns>
        public ZuoraClient.Client.ApiResponse<CommonResponseType> DELETEDocumentPropertiesWithHttpInfo(string documentPropertiesId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'documentPropertiesId' is set
            if (documentPropertiesId == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'documentPropertiesId' when calling DocumentPropertiesApi->DELETEDocumentProperties");
            }
            ...
            localVarRequestOptions.PathParameters.Add("documentPropertiesId", ZuoraClient.Client.ClientUtils.ParameterToString(documentPropertiesId)); // path parameter
            ...
            localVarRequestOptions.Operation = "DocumentPropertiesApi.DELETEDocumentProperties";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Delete<CommonResponseType>("/v1/document-properties/{documentPropertiesId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DELETEDocumentProperties", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        {
            ZuoraClient.Client.ApiResponse<CommonResponseType> localVarResponse = await DELETEDocumentPropertiesWithHttpInfoAsync(documentPropertiesId, authorization, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CommonResponseType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<CommonResponseType>> DELETEDocumentPropertiesWithHttpInfoAsync(string documentPropertiesId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'documentPropertiesId' is set
            if (documentPropertiesId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<CommonResponseType>("/v1/document-properties/{documentPropertiesId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// List all properties of a billing document **Note:** This feature is available only if you have the Billing Document Properties Setup feature enabled. The Billing Document Properties Setup feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).   Retrieve information about document properties of a billing document. Billing documents include invoices, credit memos, and debit memos.    **Note:** You can retrieve information about document properties of credit and debit memos only if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="documentType">The type of the billing document.  </param>
        /// <param name="documentId">The unique ID of document properties to be retrieved. For example, 402892c74c9193cd014c96bbe7c101f9. </param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETDocumentPropertiesResponseType</returns>
        public GETDocumentPropertiesResponseType GETDocumentProperies(string documentType, string documentId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType> localVarResponse = GETDocumentProperiesWithHttpInfo(documentType, documentId, authorization, zuoraEntityIds, zuoraTrackId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETDocumentPropertiesResponseType</returns>
        public ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType> GETDocumentProperiesWithHttpInfo(string documentType, string documentId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'documentType' is set
            if (documentType == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'documentType' when calling DocumentPropertiesApi->GETDocumentProperies");
            }

            // verify the required parameter 'documentId' is set
            if (documentId == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'documentId' when calling DocumentPropertiesApi->GETDocumentProperies");
            }
            ...
            localVarRequestOptions.PathParameters.Add("documentType", ZuoraClient.Client.ClientUtils.ParameterToString(documentType)); // path parameter
            localVarRequestOptions.PathParameters.Add("documentId", ZuoraClient.Client.ClientUtils.ParameterToString(documentId)); // path parameter
            if (authorization != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Authorization", ZuoraClient.Client.ClientUtils.ParameterToString(authorization)); // header parameter
            }
            ...
            localVarRequestOptions.Operation = "DocumentPropertiesApi.GETDocumentProperies";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<GETDocumentPropertiesResponseType>("/v1/document-properties/{documentType}/{documentId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETDocumentProperies", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETDocumentPropertiesResponseType</returns>
        public async System.Threading.Tasks.Task<GETDocumentPropertiesResponseType> GETDocumentProperiesAsync(string documentType, string documentId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType> localVarResponse = await GETDocumentProperiesWithHttpInfoAsync(documentType, documentId, authorization, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETDocumentPropertiesResponseType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType>> GETDocumentProperiesWithHttpInfoAsync(string documentType, string documentId, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'documentType' is set
            if (documentType == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GETDocumentPropertiesResponseType>("/v1/document-properties/{documentType}/{documentId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create document properties **Note:** This feature is available only if you have the Billing Document Properties Setup feature enabled. The Billing Document Properties Setup feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Creates custom document properties for a billing document. For example, a document property can be a custom name used for files generated for billing documents. Billing documents include invoices, credit memos, and debit memos.  If you want to configure custom file names for billing documents created through API operations, you have to call this operation before posting the billing documents.   **Note:** You can create document properties for credit and debit memos only if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="request"></param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETDocumentPropertiesResponseType</returns>
        public GETDocumentPropertiesResponseType POSTDocumentProperties(POSTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType> localVarResponse = POSTDocumentPropertiesWithHttpInfo(request, authorization, zuoraEntityIds, zuoraTrackId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETDocumentPropertiesResponseType</returns>
        public ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType> POSTDocumentPropertiesWithHttpInfo(POSTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'request' is set
            if (request == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'request' when calling DocumentPropertiesApi->POSTDocumentProperties");
            }
            ...
            localVarRequestOptions.Operation = "DocumentPropertiesApi.POSTDocumentProperties";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<GETDocumentPropertiesResponseType>("/v1/document-properties", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("POSTDocumentProperties", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETDocumentPropertiesResponseType</returns>
        public async System.Threading.Tasks.Task<GETDocumentPropertiesResponseType> POSTDocumentPropertiesAsync(POSTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType> localVarResponse = await POSTDocumentPropertiesWithHttpInfoAsync(request, authorization, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType>> POSTDocumentPropertiesWithHttpInfoAsync(POSTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<GETDocumentPropertiesResponseType>("/v1/document-properties", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update document properties **Note:** This feature is available only if you have the Billing Document Properties Setup feature enabled. The Billing Document Properties Setup feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).  Updates document properties with a specific ID for a billing document. Billing documents include invoices, credit memos, and debit memos.  **Note:** You can update document properties for credit and debit memos only if you have the Invoice Settlement feature enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="documentPropertiesId">The unique ID of document properties to be updated. For example, 402892c74c9193cd014c96bbe7c101f9. </param>
        /// <param name="request"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETDocumentPropertiesResponseType</returns>
        public GETDocumentPropertiesResponseType PUTDocumentProperties(string documentPropertiesId, PUTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType> localVarResponse = PUTDocumentPropertiesWithHttpInfo(documentPropertiesId, request, authorization, zuoraEntityIds, zuoraTrackId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETDocumentPropertiesResponseType</returns>
        public ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType> PUTDocumentPropertiesWithHttpInfo(string documentPropertiesId, PUTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'documentPropertiesId' is set
            if (documentPropertiesId == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'documentPropertiesId' when calling DocumentPropertiesApi->PUTDocumentProperties");
            }

            // verify the required parameter 'request' is set
            if (request == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'request' when calling DocumentPropertiesApi->PUTDocumentProperties");
            }
            ...
            localVarRequestOptions.Operation = "DocumentPropertiesApi.PUTDocumentProperties";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Put<GETDocumentPropertiesResponseType>("/v1/document-properties/{documentPropertiesId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PUTDocumentProperties", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETDocumentPropertiesResponseType</returns>
        public async System.Threading.Tasks.Task<GETDocumentPropertiesResponseType> PUTDocumentPropertiesAsync(string documentPropertiesId, PUTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType> localVarResponse = await PUTDocumentPropertiesWithHttpInfoAsync(documentPropertiesId, request, authorization, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GETDocumentPropertiesResponseType>> PUTDocumentPropertiesWithHttpInfoAsync(string documentPropertiesId, PUTDocumentPropertiesType request, string authorization = default(string), string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<GETDocumentPropertiesResponseType>("/v1/document-properties/{documentPropertiesId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
