...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FilterRuleParameterDefinition")]
    public partial class FilterRuleParameterDefinition : IEquatable<FilterRuleParameterDefinition>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterRuleParameterDefinition" /> class.
        /// </summary>
        ...
        public FilterRuleParameterDefinition(string description = default(string), string displayName = default(string), List<string> options = default(List<string>), ValueTypeEnum? valueType = default(ValueTypeEnum?))
        {
        ...
        {
            return this.Equals(input as FilterRuleParameterDefinition);
        }

        /// <summary>
        /// Returns true if FilterRuleParameterDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of FilterRuleParameterDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FilterRuleParameterDefinition input)
        {
            if (input == null)
            {
                return false;
