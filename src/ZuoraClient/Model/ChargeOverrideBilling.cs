...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChargeOverride_billing")]
    public partial class ChargeOverrideBilling : IEquatable<ChargeOverrideBilling>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Specifies how Zuora determines the day that each billing period begins on.    * &#x60;DefaultFromCustomer&#x60; - Each billing period begins on the bill cycle day of the account that owns the subscription.   * &#x60;SpecificDayofMonth&#x60; - Use the &#x60;billCycleDay&#x60; field to specify the day of the month that each billing period begins on.   * &#x60;SubscriptionStartDay&#x60; - Each billing period begins on the same day of the month as the start date of the subscription.   * &#x60;ChargeTriggerDay&#x60; - Each billing period begins on the same day of the month as the date when the charge becomes active.   * &#x60;SpecificDayofWeek&#x60; - Use the &#x60;weeklyBillCycleDay&#x60; field to specify the day of the week that each billing period begins on. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum BillCycleTypeEnum
        {
            /// <summary>
            /// Enum DefaultFromCustomer for value: DefaultFromCustomer
            /// </summary>
            [EnumMember(Value = "DefaultFromCustomer")]
            DefaultFromCustomer = 1,

            /// <summary>
            /// Enum SpecificDayofMonth for value: SpecificDayofMonth
            /// </summary>
            [EnumMember(Value = "SpecificDayofMonth")]
            SpecificDayofMonth = 2,

            /// <summary>
            /// Enum SubscriptionStartDay for value: SubscriptionStartDay
            /// </summary>
            [EnumMember(Value = "SubscriptionStartDay")]
            SubscriptionStartDay = 3,

            /// <summary>
            /// Enum ChargeTriggerDay for value: ChargeTriggerDay
            /// </summary>
            [EnumMember(Value = "ChargeTriggerDay")]
            ChargeTriggerDay = 4,

            /// <summary>
            /// Enum SpecificDayofWeek for value: SpecificDayofWeek
            /// </summary>
            [EnumMember(Value = "SpecificDayofWeek")]
            SpecificDayofWeek = 5
        ...
        public BillCycleTypeEnum? BillCycleType { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>Billing frequency of the charge. The value of this field controls the duration of each billing period.  If the value of this field is &#x60;Specific_Months&#x60; or &#x60;Specific_Weeks&#x60;, use the &#x60;specificBillingPeriod&#x60; field to specify the duration of each billing period. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum BillingPeriodEnum
        {
            ...
            /// <summary>
            /// Enum EighteenMonths for value: Eighteen_Months
            /// </summary>
            [EnumMember(Value = "Eighteen_Months")]
            EighteenMonths = 5,

            /// <summary>
            /// Enum TwoYears for value: Two_Years
            /// </summary>
            [EnumMember(Value = "Two_Years")]
            TwoYears = 6,

            /// <summary>
            /// Enum ThreeYears for value: Three_Years
            /// </summary>
            [EnumMember(Value = "Three_Years")]
            ThreeYears = 7,

            /// <summary>
            /// Enum FiveYears for value: Five_Years
            /// </summary>
            [EnumMember(Value = "Five_Years")]
            FiveYears = 8,

            /// <summary>
            /// Enum SpecificMonths for value: Specific_Months
            /// </summary>
            [EnumMember(Value = "Specific_Months")]
            SpecificMonths = 9,
            ...
            /// <summary>
            /// Enum SpecificWeeks for value: Specific_Weeks
            /// </summary>
            [EnumMember(Value = "Specific_Weeks")]
            SpecificWeeks = 12
        ...
        /// </summary>
        /// <value>Specifies how Zuora determines when to start new billing periods. You can use this field to align the billing periods of different charges.  * &#x60;AlignToCharge&#x60; - Zuora starts a new billing period on the first billing day that falls on or after the date when the charge becomes active. * &#x60;AlignToSubscriptionStart&#x60; - Zuora starts a new billing period on the first billing day that falls on or after the start date of the subscription. * &#x60;AlignToTermStart&#x60; - For each term of the subscription, Zuora starts a new billing period on the first billing day that falls on or after the start date of the term.  See the &#x60;billCycleType&#x60; field for information about how Zuora determines the billing day. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum BillingPeriodAlignmentEnum
        {
            /// <summary>
            /// Enum AlignToCharge for value: AlignToCharge
            /// </summary>
            [EnumMember(Value = "AlignToCharge")]
            AlignToCharge = 1,

            /// <summary>
            /// Enum AlignToSubscriptionStart for value: AlignToSubscriptionStart
            /// </summary>
            [EnumMember(Value = "AlignToSubscriptionStart")]
            AlignToSubscriptionStart = 2,

            /// <summary>
            /// Enum AlignToTermStart for value: AlignToTermStart
            /// </summary>
            [EnumMember(Value = "AlignToTermStart")]
            AlignToTermStart = 3
        ...
        public BillingPeriodAlignmentEnum? BillingPeriodAlignment { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>Specifies whether to invoice for a billing period on the first day of the billing period (billing in advance) or the first day of the next billing period (billing in arrears). </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        public BillingTimingEnum? BillingTiming { get; set; }
        /// <summary>
        ...
        /// </summary>
        /// <value>Day of the week that each billing period begins on. Only applicable if the value of the &#x60;billCycleType&#x60; field is &#x60;SpecificDayofWeek&#x60;. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        public WeeklyBillCycleDayEnum? WeeklyBillCycleDay { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeOverrideBilling" /> class.
        /// </summary>
        /// <param name="billCycleDay">Day of the month that each billing period begins on. Only applicable if the value of the &#x60;billCycleType&#x60; field is &#x60;SpecificDayofMonth&#x60;. .</param>
        /// <param name="billCycleType">Specifies how Zuora determines the day that each billing period begins on.    * &#x60;DefaultFromCustomer&#x60; - Each billing period begins on the bill cycle day of the account that owns the subscription.   * &#x60;SpecificDayofMonth&#x60; - Use the &#x60;billCycleDay&#x60; field to specify the day of the month that each billing period begins on.   * &#x60;SubscriptionStartDay&#x60; - Each billing period begins on the same day of the month as the start date of the subscription.   * &#x60;ChargeTriggerDay&#x60; - Each billing period begins on the same day of the month as the date when the charge becomes active.   * &#x60;SpecificDayofWeek&#x60; - Use the &#x60;weeklyBillCycleDay&#x60; field to specify the day of the week that each billing period begins on. .</param>
        /// <param name="billingPeriod">Billing frequency of the charge. The value of this field controls the duration of each billing period.  If the value of this field is &#x60;Specific_Months&#x60; or &#x60;Specific_Weeks&#x60;, use the &#x60;specificBillingPeriod&#x60; field to specify the duration of each billing period. .</param>
        /// <param name="billingPeriodAlignment">Specifies how Zuora determines when to start new billing periods. You can use this field to align the billing periods of different charges.  * &#x60;AlignToCharge&#x60; - Zuora starts a new billing period on the first billing day that falls on or after the date when the charge becomes active. * &#x60;AlignToSubscriptionStart&#x60; - Zuora starts a new billing period on the first billing day that falls on or after the start date of the subscription. * &#x60;AlignToTermStart&#x60; - For each term of the subscription, Zuora starts a new billing period on the first billing day that falls on or after the start date of the term.  See the &#x60;billCycleType&#x60; field for information about how Zuora determines the billing day. .</param>
        /// <param name="billingTiming">Specifies whether to invoice for a billing period on the first day of the billing period (billing in advance) or the first day of the next billing period (billing in arrears). .</param>
        /// <param name="specificBillingPeriod">Duration of each billing period in months or weeks, depending on the value of the &#x60;billingPeriod&#x60; field. Only applicable if the value of the &#x60;billingPeriod&#x60; field is &#x60;Specific_Months&#x60; or &#x60;Specific_Weeks&#x60;. .</param>
        /// <param name="weeklyBillCycleDay">Day of the week that each billing period begins on. Only applicable if the value of the &#x60;billCycleType&#x60; field is &#x60;SpecificDayofWeek&#x60;. .</param>
        public ChargeOverrideBilling(int billCycleDay = default(int), BillCycleTypeEnum? billCycleType = default(BillCycleTypeEnum?), BillingPeriodEnum? billingPeriod = default(BillingPeriodEnum?), BillingPeriodAlignmentEnum? billingPeriodAlignment = default(BillingPeriodAlignmentEnum?), BillingTimingEnum? billingTiming = default(BillingTimingEnum?), int specificBillingPeriod = default(int), WeeklyBillCycleDayEnum? weeklyBillCycleDay = default(WeeklyBillCycleDayEnum?))
        {
        ...
        /// </summary>
        /// <value>Day of the month that each billing period begins on. Only applicable if the value of the &#x60;billCycleType&#x60; field is &#x60;SpecificDayofMonth&#x60;. </value>
        ...
        /// </summary>
        /// <value>Duration of each billing period in months or weeks, depending on the value of the &#x60;billingPeriod&#x60; field. Only applicable if the value of the &#x60;billingPeriod&#x60; field is &#x60;Specific_Months&#x60; or &#x60;Specific_Weeks&#x60;. </value>
        [DataMember(Name = "specificBillingPeriod", EmitDefaultValue = false)]
        public int SpecificBillingPeriod { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChargeOverrideBilling {\n");
        ...
        {
            return this.Equals(input as ChargeOverrideBilling);
        }

        /// <summary>
        /// Returns true if ChargeOverrideBilling instances are equal
        /// </summary>
        /// <param name="input">Instance of ChargeOverrideBilling to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargeOverrideBilling input)
        {
            if (input == null)
            {
                return false;
