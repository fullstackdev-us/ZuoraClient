...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountSummaryTypeBillToContact_allOf")]
    public partial class GETAccountSummaryTypeBillToContactAllOf : IEquatable<GETAccountSummaryTypeBillToContactAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountSummaryTypeBillToContactAllOf" /> class.
        /// </summary>
        ...
        public GETAccountSummaryTypeBillToContactAllOf(string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string fax = default(string), string firstName = default(string), string id = default(string), string lastName = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string), string zipCode = default(string))
        {
        ...
        {
            return this.Equals(input as GETAccountSummaryTypeBillToContactAllOf);
        }

        /// <summary>
        /// Returns true if GETAccountSummaryTypeBillToContactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountSummaryTypeBillToContactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummaryTypeBillToContactAllOf input)
        {
            if (input == null)
            {
                return false;
