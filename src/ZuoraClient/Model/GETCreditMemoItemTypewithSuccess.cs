...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETCreditMemoItemTypewithSuccess")]
    public partial class GETCreditMemoItemTypewithSuccess : IEquatable<GETCreditMemoItemTypewithSuccess>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETCreditMemoItemTypewithSuccess" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETCreditMemoItemTypewithSuccess);
        }

        /// <summary>
        /// Returns true if GETCreditMemoItemTypewithSuccess instances are equal
        /// </summary>
        /// <param name="input">Instance of GETCreditMemoItemTypewithSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETCreditMemoItemTypewithSuccess input)
        {
            if (input == null)
            {
                return false;
