...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETCreditMemoTypewithSuccess_allOf")]
    public partial class GETCreditMemoTypewithSuccessAllOf : IEquatable<GETCreditMemoTypewithSuccessAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETCreditMemoTypewithSuccessAllOf" /> class.
        /// </summary>
        ...
        /// <param name="excludeFromAutoApplyRules">Whether the credit memo is excluded from the rule of automatically applying unapplied credit memos to invoices and debit memos during payment runs. .</param>
        ...
        /// <param name="updatedDate">The date and time when the credit memo was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. .</param>
        public GETCreditMemoTypewithSuccessAllOf(string accountId = default(string), double amount = default(double), double appliedAmount = default(double), bool autoApplyUponPosting = default(bool), string billToContactId = default(string), string cancelledById = default(string), DateTime cancelledOn = default(DateTime), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), DateTime creditMemoDate = default(DateTime), string currency = default(string), bool excludeFromAutoApplyRules = default(bool), string id = default(string), string latestPDFFileId = default(string), string number = default(string), string postedById = default(string), DateTime postedOn = default(DateTime), string reasonCode = default(string), string referredInvoiceId = default(string), double refundAmount = default(double), bool reversed = default(bool), string source = default(string), string sourceId = default(string), SourceTypeEnum? sourceType = default(SourceTypeEnum?), StatusEnum? status = default(StatusEnum?), DateTime targetDate = default(DateTime), double taxAmount = default(double), string taxMessage = default(string), TaxStatusEnum? taxStatus = default(TaxStatusEnum?), double totalTaxExemptAmount = default(double), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), double unappliedAmount = default(double), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>Whether the credit memo is excluded from the rule of automatically applying unapplied credit memos to invoices and debit memos during payment runs. </value>
        ...
        /// </summary>
        /// <value>The date and time when the credit memo was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. </value>
        ...
        {
            return this.Equals(input as GETCreditMemoTypewithSuccessAllOf);
        }

        /// <summary>
        /// Returns true if GETCreditMemoTypewithSuccessAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETCreditMemoTypewithSuccessAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETCreditMemoTypewithSuccessAllOf input)
        {
            if (input == null)
            {
                return false;
