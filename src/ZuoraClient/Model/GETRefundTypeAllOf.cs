...
namespace ZuoraClient.Model
{
    ...
    /// GETRefundTypeAllOf
    /// </summary>
    [DataContract(Name = "GETRefundType_allOf")]
    public partial class GETRefundTypeAllOf : IEquatable<GETRefundTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRefundTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETRefundTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETRefundTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRefundTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRefundTypeAllOf input)
        {
            if (input == null)
            {
                return false;
