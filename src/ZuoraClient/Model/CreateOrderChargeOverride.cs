...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateOrderChargeOverride")]
    public partial class CreateOrderChargeOverride : IEquatable<CreateOrderChargeOverride>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrderChargeOverride" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateOrderChargeOverride() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrderChargeOverride" /> class.
        /// </summary>
        ...
        public CreateOrderChargeOverride(ChargeOverrideBilling billing = default(ChargeOverrideBilling), string chargeNumber = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string description = default(string), decimal drawdownRate = default(decimal), EndConditions endDate = default(EndConditions), bool excludeItemBillingFromRevenueAccounting = false, bool excludeItemBookingFromRevenueAccounting = false, decimal prepaidQuantity = default(decimal), ChargeOverridePricing pricing = default(ChargeOverridePricing), string productRatePlanChargeId = default(string), string revRecCode = default(string), RevRecTriggerConditionEnum? revRecTriggerCondition = default(RevRecTriggerConditionEnum?), RevenueRecognitionRuleNameEnum? revenueRecognitionRuleName = default(RevenueRecognitionRuleNameEnum?), CreateOrderTriggerParams startDate = default(CreateOrderTriggerParams), string uniqueToken = default(string), ValidityPeriodTypeEnum? validityPeriodType = default(ValidityPeriodTypeEnum?))
        {
            // to ensure "productRatePlanChargeId" is required (not null)
            if (productRatePlanChargeId == null)
            {
                throw new ArgumentNullException("productRatePlanChargeId is a required property for CreateOrderChargeOverride and cannot be null");
            }
        ...
        public CreateOrderTriggerParams StartDate { get; set; }
        ...
        {
            return this.Equals(input as CreateOrderChargeOverride);
        }

        /// <summary>
        /// Returns true if CreateOrderChargeOverride instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateOrderChargeOverride to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateOrderChargeOverride input)
        {
            if (input == null)
            {
                return false;
