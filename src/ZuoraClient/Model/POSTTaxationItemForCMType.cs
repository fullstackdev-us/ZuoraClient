...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTTaxationItemForCMType")]
    public partial class POSTTaxationItemForCMType : IEquatable<POSTTaxationItemForCMType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTTaxationItemForCMType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTTaxationItemForCMType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTTaxationItemForCMType" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as POSTTaxationItemForCMType);
        }

        /// <summary>
        /// Returns true if POSTTaxationItemForCMType instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTTaxationItemForCMType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTTaxationItemForCMType input)
        {
            if (input == null)
            {
                return false;
