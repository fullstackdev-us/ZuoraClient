...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetInvoiceAdjustment")]
    public partial class ProxyGetInvoiceAdjustment : IEquatable<ProxyGetInvoiceAdjustment>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyGetInvoiceAdjustment);
        }

        /// <summary>
        /// Returns true if ProxyGetInvoiceAdjustment instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetInvoiceAdjustment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetInvoiceAdjustment input)
        {
            if (input == null)
            {
                return false;
