...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETTaxationItemTypewithSuccess_allOf")]
    public partial class GETTaxationItemTypewithSuccessAllOf : IEquatable<GETTaxationItemTypewithSuccessAllOf>, IValidatableObject
    {
        /// <summary>
        /// The type of the tax rate applied to the credit or debit memo. 
        /// </summary>
        /// <value>The type of the tax rate applied to the credit or debit memo. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETTaxationItemTypewithSuccessAllOf" /> class.
        /// </summary>
        /// <param name="createdById">The ID of the Zuora user who created the taxation item. .</param>
        /// <param name="createdDate">The date and time when the taxation item was created in the Zuora system, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        /// <param name="exemptAmount">The calculated tax amount excluded due to the exemption. .</param>
        /// <param name="financeInformation">financeInformation.</param>
        /// <param name="id">The ID of the taxation item. .</param>
        ...
        /// <param name="locationCode">The identifier for the location based on the value of the &#x60;taxCode&#x60; field. .</param>
        /// <param name="memoItemId">The ID of the credit or debit memo associated with the taxation item. .</param>
        /// <param name="name">The name of the taxation item. .</param>
        /// <param name="sourceTaxItemId">The ID of the taxation item of the invoice, which the credit or debit memo is created from. .</param>
        /// <param name="taxAmount">The amount of the tax applied to the credit or debit memo. .</param>
        /// <param name="taxCode">The tax code identifies which tax rules and tax rates to apply to a specific credit or debit memo. .</param>
        /// <param name="taxCodeDescription">The description of the tax code. .</param>
        /// <param name="taxDate">The date when the tax is applied to the credit or debit memo. .</param>
        /// <param name="taxRate">The tax rate applied to the credit or debit memo. .</param>
        /// <param name="taxRateDescription">The description of the tax rate. .</param>
        /// <param name="taxRateType">The type of the tax rate applied to the credit or debit memo. .</param>
        /// <param name="updatedById">The ID of the Zuora user who last updated the taxation item. .</param>
        /// <param name="updatedDate">The date and time when the taxation item was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        public GETTaxationItemTypewithSuccessAllOf(string createdById = default(string), DateTime createdDate = default(DateTime), double exemptAmount = default(double), GETCMTaxItemTypeAllOfFinanceInformation financeInformation = default(GETCMTaxItemTypeAllOfFinanceInformation), string id = default(string), string jurisdiction = default(string), string locationCode = default(string), string memoItemId = default(string), string name = default(string), string sourceTaxItemId = default(string), double taxAmount = default(double), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), double taxRate = default(double), string taxRateDescription = default(string), TaxRateTypeEnum? taxRateType = default(TaxRateTypeEnum?), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who created the taxation item. </value>
        ...
        /// </summary>
        /// <value>The date and time when the taxation item was created in the Zuora system, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        public GETCMTaxItemTypeAllOfFinanceInformation FinanceInformation { get; set; }

        /// <summary>
        /// The ID of the taxation item. 
        /// </summary>
        /// <value>The ID of the taxation item. </value>
        ...
        /// </summary>
        /// <value>The identifier for the location based on the value of the &#x60;taxCode&#x60; field. </value>
        ...
        /// </summary>
        /// <value>The ID of the credit or debit memo associated with the taxation item. </value>
        [DataMember(Name = "memoItemId", EmitDefaultValue = false)]
        public string MemoItemId { get; set; }
        ...
        /// </summary>
        /// <value>The ID of the taxation item of the invoice, which the credit or debit memo is created from. </value>
        [DataMember(Name = "sourceTaxItemId", EmitDefaultValue = false)]
        public string SourceTaxItemId { get; set; }

        /// <summary>
        /// The amount of the tax applied to the credit or debit memo. 
        /// </summary>
        /// <value>The amount of the tax applied to the credit or debit memo. </value>
        ...
        /// </summary>
        /// <value>The tax code identifies which tax rules and tax rates to apply to a specific credit or debit memo. </value>
        ...
        /// </summary>
        /// <value>The description of the tax code. </value>
        ...
        /// </summary>
        /// <value>The date when the tax is applied to the credit or debit memo. </value>
        ...
        /// </summary>
        /// <value>The tax rate applied to the credit or debit memo. </value>
        ...
        /// </summary>
        /// <value>The description of the tax rate. </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who last updated the taxation item. </value>
        ...
        /// </summary>
        /// <value>The date and time when the taxation item was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MemoItemId: ").Append(MemoItemId).Append("\n");
        ...
        {
            return this.Equals(input as GETTaxationItemTypewithSuccessAllOf);
        }

        /// <summary>
        /// Returns true if GETTaxationItemTypewithSuccessAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETTaxationItemTypewithSuccessAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETTaxationItemTypewithSuccessAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MemoItemId == input.MemoItemId ||
                    (this.MemoItemId != null &&
                    this.MemoItemId.Equals(input.MemoItemId))
                ) && 
                (
                ...
                (
                    this.SourceTaxItemId == input.SourceTaxItemId ||
                    (this.SourceTaxItemId != null &&
                    this.SourceTaxItemId.Equals(input.SourceTaxItemId))
                ) && 
                (
                ...
                (
                    this.TaxDate == input.TaxDate ||
                    (this.TaxDate != null &&
                    this.TaxDate.Equals(input.TaxDate))
                ) && 
                (
                ...
                (
                    this.TaxRateDescription == input.TaxRateDescription ||
                    (this.TaxRateDescription != null &&
                    this.TaxRateDescription.Equals(input.TaxRateDescription))
                ) && 
                (
                    this.TaxRateType == input.TaxRateType ||
                    this.TaxRateType.Equals(input.TaxRateType)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MemoItemId != null)
                {
                    hashCode = (hashCode * 59) + this.MemoItemId.GetHashCode();
                }
                if (this.Name != null)
                {
                    hashCode = (hashCode * 59) + this.Name.GetHashCode();
                }
                if (this.SourceTaxItemId != null)
                {
                    hashCode = (hashCode * 59) + this.SourceTaxItemId.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.TaxDate.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.TaxRate.GetHashCode();
                if (this.TaxRateDescription != null)
                {
                    hashCode = (hashCode * 59) + this.TaxRateDescription.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.TaxRateType.GetHashCode();
