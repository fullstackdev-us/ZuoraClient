...
namespace ZuoraClient.Model
{
    ...
    /// ProxyModifyAccount
    /// </summary>
    [DataContract(Name = "ProxyModifyAccount")]
    public partial class ProxyModifyAccount : IEquatable<ProxyModifyAccount>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyModifyAccount);
        }

        /// <summary>
        /// Returns true if ProxyModifyAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyModifyAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyModifyAccount input)
        {
            if (input == null)
            {
                return false;
