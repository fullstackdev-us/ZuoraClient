...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetUsageAllOf
    /// </summary>
    [DataContract(Name = "ProxyGetUsage_allOf")]
    public partial class ProxyGetUsageAllOf : IEquatable<ProxyGetUsageAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetUsageAllOf" /> class.
        /// </summary>
        /// <param name="accountId"> The ID of the account associated with the usage data. This field is required if no value is specified for the &#x60;AccountNumber&#x60; field. **Character limit**: 32 **Values**: a valid account ID .</param>
        /// <param name="accountNumber"> The number of the account associated with the usage data. This field is required if no value is specified for the &#x60;AccountId&#x60; field. **Character limit**: 50 **Values**: a valid account number .</param>
        /// <param name="chargeId"> The OrginalId of the rate plan charge related to the usage record, e.g., &#x60;2c9081a03c63c94c013c6873357a0117&#x60; **Character limit**: 32 **Values**: a valid rate plan charge OriginalID .</param>
        ...
        /// <param name="createdDate"> The date when the usage was generated. **Character limit**: 29 **Values**: automatically generated .</param>
        /// <param name="description">A description of the usage record. .</param>
        /// <param name="endDateTime"> The end date and time of a range of time when usage is tracked. Use this field for reporting; this field doesn&#39;t affect usage calculation. **Character limit**: 29 **Values**: a valid date and time value .</param>
        ...
        /// <param name="startDateTime"> The start date and time of a range of time when usage is tracked. Zuora uses this field value to determine the usage date. Unlike the &#x60;EndDateTime&#x60;, the &#x60;StartDateTime&#x60; field does affect usage calculation. **Character limit**: 29 **Values**: a valid date and time value .</param>
        /// <param name="submissionDateTime"> The date when usage was submitted. **Character limit**: 29 **Values**: automatically generated .</param>
        /// <param name="subscriptionId"> The original ID of the subscription that contains the fees related to the usage data. **Character limit**: 32 **Values**: a valid subscription ID .</param>
        /// <param name="subscriptionNumber">The unique identifier number of the subscription that contains the fees related to the usage data. .</param>
        /// <param name="uOM"> Specifies the units to measure usage. Units of measure are configured in the web-based UI. Your values depend on your configuration in **Billing Settings**. **Character limit**: **Values**: a valid unit of measure .</param>
        ...
        public ProxyGetUsageAllOf(string accountId = default(string), string accountNumber = default(string), string chargeId = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), string description = default(string), DateTime endDateTime = default(DateTime), string id = default(string), double quantity = default(double), string rbeStatus = default(string), string sourceType = default(string), DateTime startDateTime = default(DateTime), DateTime submissionDateTime = default(DateTime), string subscriptionId = default(string), string subscriptionNumber = default(string), string uOM = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value> The ID of the account associated with the usage data. This field is required if no value is specified for the &#x60;AccountNumber&#x60; field. **Character limit**: 32 **Values**: a valid account ID </value>
        ...
        /// </summary>
        /// <value> The number of the account associated with the usage data. This field is required if no value is specified for the &#x60;AccountId&#x60; field. **Character limit**: 50 **Values**: a valid account number </value>
        ...
        /// </summary>
        /// <value> The OrginalId of the rate plan charge related to the usage record, e.g., &#x60;2c9081a03c63c94c013c6873357a0117&#x60; **Character limit**: 32 **Values**: a valid rate plan charge OriginalID </value>
        ...
        /// </summary>
        /// <value> The date when the usage was generated. **Character limit**: 29 **Values**: automatically generated </value>
        ...
        /// </summary>
        /// <value>A description of the usage record. </value>
        ...
        /// </summary>
        /// <value> The end date and time of a range of time when usage is tracked. Use this field for reporting; this field doesn&#39;t affect usage calculation. **Character limit**: 29 **Values**: a valid date and time value </value>
        ...
        /// </summary>
        /// <value> The start date and time of a range of time when usage is tracked. Zuora uses this field value to determine the usage date. Unlike the &#x60;EndDateTime&#x60;, the &#x60;StartDateTime&#x60; field does affect usage calculation. **Character limit**: 29 **Values**: a valid date and time value </value>
        ...
        /// </summary>
        /// <value> The original ID of the subscription that contains the fees related to the usage data. **Character limit**: 32 **Values**: a valid subscription ID </value>
        ...
        /// </summary>
        /// <value>The unique identifier number of the subscription that contains the fees related to the usage data. </value>
        ...
        /// </summary>
        /// <value> Specifies the units to measure usage. Units of measure are configured in the web-based UI. Your values depend on your configuration in **Billing Settings**. **Character limit**: **Values**: a valid unit of measure </value>
        ...
        {
            return this.Equals(input as ProxyGetUsageAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetUsageAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetUsageAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetUsageAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RbeStatus == input.RbeStatus ||
                    (this.RbeStatus != null &&
                    this.RbeStatus.Equals(input.RbeStatus))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.RbeStatus.GetHashCode();
                }
