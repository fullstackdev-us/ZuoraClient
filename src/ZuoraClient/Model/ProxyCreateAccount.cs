...
namespace ZuoraClient.Model
{
    ...
    /// ProxyCreateAccount
    /// </summary>
    [DataContract(Name = "ProxyCreateAccount")]
    public partial class ProxyCreateAccount : IEquatable<ProxyCreateAccount>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyCreateAccount);
        }

        /// <summary>
        /// Returns true if ProxyCreateAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreateAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreateAccount input)
        {
            if (input == null)
            {
                return false;
