...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentScheduleItemCommonResponse")]
    public partial class PaymentScheduleItemCommonResponse : IEquatable<PaymentScheduleItemCommonResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentScheduleItemCommonResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PaymentScheduleItemCommonResponse);
        }

        /// <summary>
        /// Returns true if PaymentScheduleItemCommonResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentScheduleItemCommonResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentScheduleItemCommonResponse input)
        {
            if (input == null)
            {
                return false;
