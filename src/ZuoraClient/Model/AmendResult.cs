...
namespace ZuoraClient.Model
{
    ...
    public partial class AmendResult : IEquatable<AmendResult>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="amendmentIds">A list of the IDs of the associated amendments. There can be as many as three amendment IDs. Use a comma to separate each amendment ID. .</param>
        /// <param name="chargeMetricsData">chargeMetricsData.</param>
        /// <param name="creditMemoDatas">creditMemoDatas.</param>
        ...
        /// <param name="invoiceDatas">This array of invoices contains one invoice only as one invoice is generated for one subscription. .</param>
        /// <param name="invoiceId">invoiceId.</param>
        /// <param name="paymentId">paymentId.</param>
        /// <param name="paymentTransactionNumber">paymentTransactionNumber.</param>
        /// <param name="subscriptionId">subscriptionId.</param>
        /// <param name="success">success.</param>
        /// <param name="totalDeltaMrr">&#x60;TotalDeltaMrr&#x60; is calculated by the following formula:   TotalDeltaMrr &#x3D; newSubscription.CMRR - originalSubscription.CMRR   See [here](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue#Contracted_MRR) for the definition of CMRR. The new subscriptin represents the later version of an subscription after an amendment. The original subscription represents the original version of the subscription before the amendment.  .</param>
        /// <param name="totalDeltaTcv">totalDeltaTcv.</param>
        public AmendResult(List<string> amendmentIds = default(List<string>), ChargeMetricsData chargeMetricsData = default(ChargeMetricsData), List<ActionAmendCreditMemoData> creditMemoDatas = default(List<ActionAmendCreditMemoData>), string creditMemoId = default(string), List<ActionsErrorResponse> errors = default(List<ActionsErrorResponse>), string gatewayResponse = default(string), string gatewayResponseCode = default(string), List<ActionAmendInvoiceData> invoiceDatas = default(List<ActionAmendInvoiceData>), string invoiceId = default(string), string paymentId = default(string), string paymentTransactionNumber = default(string), string subscriptionId = default(string), bool success = default(bool), double totalDeltaMrr = default(double), double totalDeltaTcv = default(double))
        {
        ...
        /// </summary>
        /// <value>A list of the IDs of the associated amendments. There can be as many as three amendment IDs. Use a comma to separate each amendment ID. </value>
        ...
        /// <summary>
        /// Gets or Sets CreditMemoDatas
        /// </summary>
        [DataMember(Name = "CreditMemoDatas", EmitDefaultValue = false)]
        public List<ActionAmendCreditMemoData> CreditMemoDatas { get; set; }

        /// <summary>
        /// Gets or Sets CreditMemoId
        /// </summary>
        ...
        /// </summary>
        /// <value>This array of invoices contains one invoice only as one invoice is generated for one subscription. </value>
        [DataMember(Name = "InvoiceDatas", EmitDefaultValue = false)]
        public List<ActionAmendInvoiceData> InvoiceDatas { get; set; }
        ...
        /// <summary>
        /// &#x60;TotalDeltaMrr&#x60; is calculated by the following formula:   TotalDeltaMrr &#x3D; newSubscription.CMRR - originalSubscription.CMRR   See [here](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue#Contracted_MRR) for the definition of CMRR. The new subscriptin represents the later version of an subscription after an amendment. The original subscription represents the original version of the subscription before the amendment.  
        /// </summary>
        /// <value>&#x60;TotalDeltaMrr&#x60; is calculated by the following formula:   TotalDeltaMrr &#x3D; newSubscription.CMRR - originalSubscription.CMRR   See [here](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue#Contracted_MRR) for the definition of CMRR. The new subscriptin represents the later version of an subscription after an amendment. The original subscription represents the original version of the subscription before the amendment.  </value>
        [DataMember(Name = "TotalDeltaMrr", EmitDefaultValue = false)]
        public double TotalDeltaMrr { get; set; }

        /// <summary>
        /// Gets or Sets TotalDeltaTcv
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CreditMemoDatas: ").Append(CreditMemoDatas).Append("\n");
        ...
        {
            return this.Equals(input as AmendResult);
        }

        /// <summary>
        /// Returns true if AmendResult instances are equal
        /// </summary>
        /// <param name="input">Instance of AmendResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AmendResult input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.AmendmentIds == input.AmendmentIds ||
                    this.AmendmentIds != null &&
                    input.AmendmentIds != null &&
                    this.AmendmentIds.SequenceEqual(input.AmendmentIds)
                ) && 
                (
                ...
                (
                    this.CreditMemoDatas == input.CreditMemoDatas ||
                    this.CreditMemoDatas != null &&
                    input.CreditMemoDatas != null &&
                    this.CreditMemoDatas.SequenceEqual(input.CreditMemoDatas)
                ) && 
                (
                ...
                (
                    this.InvoiceDatas == input.InvoiceDatas ||
                    this.InvoiceDatas != null &&
                    input.InvoiceDatas != null &&
                    this.InvoiceDatas.SequenceEqual(input.InvoiceDatas)
                ) && 
                (
                ...
                (
                    this.TotalDeltaMrr == input.TotalDeltaMrr ||
                    this.TotalDeltaMrr.Equals(input.TotalDeltaMrr)
                ) && 
                (
                    this.TotalDeltaTcv == input.TotalDeltaTcv ||
                    this.TotalDeltaTcv.Equals(input.TotalDeltaTcv)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AmendmentIds.GetHashCode();
                }
                if (this.ChargeMetricsData != null)
                {
                    hashCode = (hashCode * 59) + this.ChargeMetricsData.GetHashCode();
                }
                if (this.CreditMemoDatas != null)
                {
                    hashCode = (hashCode * 59) + this.CreditMemoDatas.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.InvoiceDatas.GetHashCode();
                }
                ...
                hashCode = (hashCode * 59) + this.TotalDeltaMrr.GetHashCode();
                hashCode = (hashCode * 59) + this.TotalDeltaTcv.GetHashCode();
                return hashCode;
            }
        }
