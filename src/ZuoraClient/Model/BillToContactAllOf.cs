...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BillToContact_allOf")]
    public partial class BillToContactAllOf : IEquatable<BillToContactAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BillToContactAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BillToContactAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BillToContactAllOf" /> class.
        /// </summary>
        ...
        public BillToContactAllOf(string address1 = default(string), string address2 = default(string), string city = default(string), string country = default(string), string county = default(string), string fax = default(string), string firstName = default(string), string homePhone = default(string), string lastName = default(string), string mobilePhone = default(string), string nickname = default(string), string otherPhone = default(string), OtherPhoneTypeEnum? otherPhoneType = default(OtherPhoneTypeEnum?), string personalEmail = default(string), string postalCode = default(string), string state = default(string), string taxRegion = default(string), string workEmail = default(string), string workPhone = default(string))
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for BillToContactAllOf and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for BillToContactAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as BillToContactAllOf);
        }

        /// <summary>
        /// Returns true if BillToContactAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of BillToContactAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillToContactAllOf input)
        {
            if (input == null)
            {
                return false;
