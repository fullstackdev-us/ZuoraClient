...
namespace ZuoraClient.Model
{
    ...
    public partial class SubscribeRequestPaymentMethod : IEquatable<SubscribeRequestPaymentMethod>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The type of payment method. If you want to create an Amazon Pay payment method, specify &#x60;CreditCardReferenceTransaction&#x60; for this field.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeRequestPaymentMethod" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubscribeRequestPaymentMethod() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeRequestPaymentMethod" /> class.
        /// </summary>
        ...
        /// <param name="bankIdentificationNumber"> The first six or eight digits of the payment method&#39;s number, such as the credit card number or account number. Banks use this number to identify a payment method.   **Character limit**: 8   **Values**:  string of 8 characters or fewer .</param>
        ...
        /// <param name="bankTransferAccountNumber"> The number of the customer&#39;s bank account. This field is only required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;.   **Character limit**:30   **Values**:  string of 30 characters or fewer .</param>
        ...
        /// <param name="bankTransferType"> Specifies the type of direct debit transfer. The value of this field is dependent on the country of the user. This field is only required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;.   **Character limit**: 20   **Values**:  - &#x60;AutomatischIncasso&#x60; (NL) - &#x60;LastschriftDE&#x60; (Germany) - &#x60;LastschriftAT&#x60; (Austria) - &#x60;DemandeDePrelevement&#x60; (FR) - &#x60;DirectDebitUK&#x60; (UK) - &#x60;Domicil&#x60; (Belgium) - &#x60;LastschriftCH&#x60; (CH) - &#x60;RID&#x60; (Italy) - &#x60;OrdenDeDomiciliacion&#x60; (Spain) .</param>
        ...
        /// <param name="city"> The city of the customer&#39;s address. Use this field for direct debit payment methods. It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing.   **Character limit**:80   **Values**:  string of 80 characters or fewer .</param>
        /// <param name="country"> The two-letter country code of the customer&#39;s address. This field is only required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;, and the &#x60;BankTransferType&#x60; field is set to either &#x60;DirectDebitUK&#x60;, &#x60;DirectEntryAU&#x60;, or &#x60;DirectDebitNZ&#x60;. It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing.   **Character limit**: 2   **Values**: a valid country code .</param>
        ...
        /// <param name="creditCardExpirationMonth"> The expiration month of the credit card or debit card. This field is only required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;.  **Character limit**: 2   **Values**: a two-digit number, 01 - 12 .</param>
        /// <param name="creditCardExpirationYear"> The expiration month of the credit card or debit card. This field is only required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;.   **Character limit**: 4   **Values**: a four-digit number .</param>
        ...
        /// <param name="creditCardNumber"> The credit card or debit card number. This is an insert-only field; it cannot be updated nor queried for security purposes. This field is only required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;.   **Character limit**: 16   **Values**: a string of 16 characters or fewer .</param>
        ...
        /// <param name="paymentMethodStatus"> Specifies the status of the payment method. It is set to Active on creation.   **Character limit**: 6   **Values**: &#x60;Active&#x60; or &#x60;Closed&#x60; PaymentMethodStatus should not be used in the &#x60;create &#x60; call. You can only set this field to **Closed** via the &#x60;update &#x60; call. .</param>
        ...
        /// <param name="paypalType"> Specifies the PayPal gateway: PayFlow Pro, Express Checkout, or Adaptive Payments. This field is only required if you use the PayPal Adaptive Payments, Payflow Pro, or Express Checkout gateway.   **Character limit**: 32   **Values**: &#x60;ExpressCheckout&#x60;, &#x60;NativeExpressCheckout&#x60;, &#x60;AdaptivePayments&#x60; .</param>
        ...
        /// <param name="tokenId">A gateway unique identifier that replaces sensitive payment method data or represents a gateway&#39;s unique customer profile. If you want to create an Amazon Pay payment method, specify &#x60;AmazonBillingAgreementId&#x60; for this field.   While &#x60;TokenId&#x60; is used to represent a customer profile, &#x60;SecondTokenId&#x60; is conditionally required for representing the underlying tokenized payment method. When the &#x60;Type&#x60; field is set to &#x60;CreditCardReferenceTransaction&#x60;, this field is required if the &#x60;CreditCardNumber&#x60; field is not specified.   **Character limit**: 255 **Values**: a string of 255 characters or fewer .</param>
        ...
        /// <param name="type">The type of payment method. If you want to create an Amazon Pay payment method, specify &#x60;CreditCardReferenceTransaction&#x60; for this field. (required).</param>
        ...
        public SubscribeRequestPaymentMethod(string accountId = default(string), string achAbaCode = default(string), string achAccountName = default(string), string achAccountNumber = default(string), string achAccountNumberMask = default(string), string achAccountType = default(string), string achAddress1 = default(string), string achAddress2 = default(string), string achBankName = default(string), bool active = default(bool), string bankBranchCode = default(string), string bankCheckDigit = default(string), string bankCity = default(string), string bankCode = default(string), string bankIdentificationNumber = default(string), string bankName = default(string), string bankPostalCode = default(string), string bankStreetName = default(string), string bankStreetNumber = default(string), string bankTransferAccountName = default(string), string bankTransferAccountNumber = default(string), string bankTransferAccountNumberMask = default(string), string bankTransferAccountType = default(string), string bankTransferType = default(string), string businessIdentificationCode = default(string), string city = default(string), string country = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), string creditCardAddress1 = default(string), string creditCardAddress2 = default(string), string creditCardCity = default(string), string creditCardCountry = default(string), int creditCardExpirationMonth = default(int), int creditCardExpirationYear = default(int), string creditCardHolderName = default(string), string creditCardMaskNumber = default(string), string creditCardNumber = default(string), string creditCardPostalCode = default(string), string creditCardSecurityCode = default(string), string creditCardState = default(string), string creditCardType = default(string), string deviceSessionId = default(string), string email = default(string), string existingMandate = default(string), string firstName = default(string), SubscribeRequestPaymentMethodGatewayOptionData gatewayOptionData = default(SubscribeRequestPaymentMethodGatewayOptionData), string iBAN = default(string), string iPAddress = default(string), string id = default(string), DateTime lastFailedSaleTransactionDate = default(DateTime), string lastName = default(string), DateTime lastTransactionDateTime = default(DateTime), string lastTransactionStatus = default(string), DateTime mandateCreationDate = default(DateTime), string mandateID = default(string), string mandateReceived = default(string), DateTime mandateUpdateDate = default(DateTime), int maxConsecutivePaymentFailures = default(int), string name = default(string), int numConsecutiveFailures = default(int), string paymentMethodStatus = default(string), int paymentRetryWindow = default(int), string paypalBaid = default(string), string paypalEmail = default(string), string paypalPreapprovalKey = default(string), string paypalType = default(string), string phone = default(string), string postalCode = default(string), string secondTokenId = default(string), bool skipValidation = default(bool), string state = default(string), string streetName = default(string), string streetNumber = default(string), string tokenId = default(string), int totalNumberOfErrorPayments = default(int), int totalNumberOfProcessedPayments = default(int), TypeEnum type = default(TypeEnum), string updatedById = default(string), DateTime updatedDate = default(DateTime), bool useDefaultRetryRule = default(bool))
        {
            this.Type = type;
        ...
        /// </summary>
        /// <value> The first six or eight digits of the payment method&#39;s number, such as the credit card number or account number. Banks use this number to identify a payment method.   **Character limit**: 8   **Values**:  string of 8 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The number of the customer&#39;s bank account. This field is only required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;.   **Character limit**:30   **Values**:  string of 30 characters or fewer </value>
        ...
        /// </summary>
        /// <value> Specifies the type of direct debit transfer. The value of this field is dependent on the country of the user. This field is only required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;.   **Character limit**: 20   **Values**:  - &#x60;AutomatischIncasso&#x60; (NL) - &#x60;LastschriftDE&#x60; (Germany) - &#x60;LastschriftAT&#x60; (Austria) - &#x60;DemandeDePrelevement&#x60; (FR) - &#x60;DirectDebitUK&#x60; (UK) - &#x60;Domicil&#x60; (Belgium) - &#x60;LastschriftCH&#x60; (CH) - &#x60;RID&#x60; (Italy) - &#x60;OrdenDeDomiciliacion&#x60; (Spain) </value>
        ...
        /// </summary>
        /// <value> The two-letter country code of the customer&#39;s address. This field is only required if the &#x60;Type&#x60; field is set to &#x60;BankTransfer&#x60;, and the &#x60;BankTransferType&#x60; field is set to either &#x60;DirectDebitUK&#x60;, &#x60;DirectEntryAU&#x60;, or &#x60;DirectDebitNZ&#x60;. It is recommended to provide the city and country information when creating a payment method. The information will be used to process payments. If the information is not provided during payment method creation, the city and country data will be missing during payment processing.   **Character limit**: 2   **Values**: a valid country code </value>
        ...
        /// </summary>
        /// <value> The expiration month of the credit card or debit card. This field is only required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;.  **Character limit**: 2   **Values**: a two-digit number, 01 - 12 </value>
        ...
        /// </summary>
        /// <value> The expiration month of the credit card or debit card. This field is only required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;.   **Character limit**: 4   **Values**: a four-digit number </value>
        ...
        /// </summary>
        /// <value> The credit card or debit card number. This is an insert-only field; it cannot be updated nor queried for security purposes. This field is only required if the &#x60;Type&#x60; field is set to &#x60;CreditCard&#x60; or &#x60;DebitCard&#x60;.   **Character limit**: 16   **Values**: a string of 16 characters or fewer </value>
        ...
        public SubscribeRequestPaymentMethodGatewayOptionData GatewayOptionData { get; set; }
        ...
        /// </summary>
        /// <value> Specifies the status of the payment method. It is set to Active on creation.   **Character limit**: 6   **Values**: &#x60;Active&#x60; or &#x60;Closed&#x60; PaymentMethodStatus should not be used in the &#x60;create &#x60; call. You can only set this field to **Closed** via the &#x60;update &#x60; call. </value>
        ...
        /// <summary>
        ///  Specifies the PayPal gateway: PayFlow Pro, Express Checkout, or Adaptive Payments. This field is only required if you use the PayPal Adaptive Payments, Payflow Pro, or Express Checkout gateway.   **Character limit**: 32   **Values**: &#x60;ExpressCheckout&#x60;, &#x60;NativeExpressCheckout&#x60;, &#x60;AdaptivePayments&#x60; 
        /// </summary>
        /// <value> Specifies the PayPal gateway: PayFlow Pro, Express Checkout, or Adaptive Payments. This field is only required if you use the PayPal Adaptive Payments, Payflow Pro, or Express Checkout gateway.   **Character limit**: 32   **Values**: &#x60;ExpressCheckout&#x60;, &#x60;NativeExpressCheckout&#x60;, &#x60;AdaptivePayments&#x60; </value>
        ...
        /// </summary>
        /// <value>A gateway unique identifier that replaces sensitive payment method data or represents a gateway&#39;s unique customer profile. If you want to create an Amazon Pay payment method, specify &#x60;AmazonBillingAgreementId&#x60; for this field.   While &#x60;TokenId&#x60; is used to represent a customer profile, &#x60;SecondTokenId&#x60; is conditionally required for representing the underlying tokenized payment method. When the &#x60;Type&#x60; field is set to &#x60;CreditCardReferenceTransaction&#x60;, this field is required if the &#x60;CreditCardNumber&#x60; field is not specified.   **Character limit**: 255 **Values**: a string of 255 characters or fewer </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubscribeRequestPaymentMethod {\n");
        ...
        {
            return this.Equals(input as SubscribeRequestPaymentMethod);
        }

        /// <summary>
        /// Returns true if SubscribeRequestPaymentMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribeRequestPaymentMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribeRequestPaymentMethod input)
        {
            if (input == null)
            {
                return false;
