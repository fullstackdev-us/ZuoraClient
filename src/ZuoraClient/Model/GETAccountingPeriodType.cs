...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountingPeriodType")]
    public partial class GETAccountingPeriodType : IEquatable<GETAccountingPeriodType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETAccountingPeriodType);
        }

        /// <summary>
        /// Returns true if GETAccountingPeriodType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountingPeriodType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountingPeriodType input)
        {
            if (input == null)
            {
                return false;
