...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaymentScheduleCommonResponse")]
    public partial class PaymentScheduleCommonResponse : IEquatable<PaymentScheduleCommonResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentScheduleCommonResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PaymentScheduleCommonResponse);
        }

        /// <summary>
        /// Returns true if PaymentScheduleCommonResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentScheduleCommonResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentScheduleCommonResponse input)
        {
            if (input == null)
            {
                return false;
