...
namespace ZuoraClient.Model
{
    ...
    /// GETCMTaxItemTypeNew
    /// </summary>
    [DataContract(Name = "GETCMTaxItemTypeNew")]
    public partial class GETCMTaxItemTypeNew : IEquatable<GETCMTaxItemTypeNew>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETCMTaxItemTypeNew" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETCMTaxItemTypeNew);
        }

        /// <summary>
        /// Returns true if GETCMTaxItemTypeNew instances are equal
        /// </summary>
        /// <param name="input">Instance of GETCMTaxItemTypeNew to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETCMTaxItemTypeNew input)
        {
            if (input == null)
            {
                return false;
