...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PUTSubscriptionType_allOf")]
    public partial class PUTSubscriptionTypeAllOf : IEquatable<PUTSubscriptionTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTSubscriptionTypeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="change">Use this field to change one or more rate plans - to replace the existing rate plans in a subscription with other rate plans.  **Note**: This feature is in the **Early Adopter** phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/). .</param>
        /// <param name="clearingExistingBillToContactId">Whether to clear the existing bill-to contact ID at the subscription level. This field is mutually exclusive with the &#x60;paymentTerm&#x60; field.  **Note**: This field is only available if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature enabled.  (default to false).</param>
        /// <param name="clearingExistingPaymentTerm">Whether to clear the existing payment term at the subscription level. This field is mutually exclusive with the &#x60;billToContactId&#x60; field.  **Note**: This field is only available if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature enabled.  (default to false).</param>
        /// <param name="collect">Collects an automatic payment for a subscription. The collection generated in this operation is only for this subscription, not for the entire customer account.  If the value is &#x60;true&#x60;, the automatic payment is collected. If the value is &#x60;false&#x60;, no action is taken.  Prerequisite: The &#x60;invoice&#x60; or &#x60;runBilling&#x60; field must be &#x60;true&#x60;.   **Note**: This field is only available if you set the &#x60;zuora-version&#x60; request header to &#x60;196.0&#x60; or later.  (default to false).</param>
        ...
        /// <param name="currentTerm">The length of the period for the current subscription term. If &#x60;termType&#x60; is &#x60;TERMED&#x60;, this field is required and must be greater than &#x60;0&#x60;. If &#x60;termType&#x60; is &#x60;EVERGREEN&#x60;, this value is ignored. .</param>
        ...
        public PUTSubscriptionTypeAllOf(List<PUTSrpAddType> add = default(List<PUTSrpAddType>), List<string> applicationOrder = default(List<string>), bool applyCredit = default(bool), bool applyCreditBalance = default(bool), bool autoRenew = default(bool), List<PUTSrpChangeType> change = default(List<PUTSrpChangeType>), bool clearingExistingBillToContactId = false, bool clearingExistingPaymentTerm = false, bool collect = false, string creditMemoReasonCode = default(string), long currentTerm = default(long), string currentTermPeriodType = default(string), DateTime documentDate = default(DateTime), ExternallyManagedByEnum? externallyManagedBy = default(ExternallyManagedByEnum?), bool includeExistingDraftDocItems = default(bool), bool includeExistingDraftInvoiceItems = default(bool), bool invoice = default(bool), bool invoiceCollect = false, bool invoiceSeparately = default(bool), DateTime invoiceTargetDate = default(DateTime), string notes = default(string), bool preview = default(bool), string previewType = default(string), List<PUTSrpRemoveType> remove = default(List<PUTSrpRemoveType>), string renewalSetting = default(string), long renewalTerm = default(long), string renewalTermPeriodType = default(string), bool runBilling = false, DateTime targetDate = default(DateTime), DateTime termStartDate = default(DateTime), string termType = default(string), List<PUTSrpUpdateType> update = default(List<PUTSrpUpdateType>))
        {
            this.Add = add;
            ...
            this.Change = change;
            this.ClearingExistingBillToContactId = clearingExistingBillToContactId;
        ...
        /// <summary>
        /// Use this field to change one or more rate plans - to replace the existing rate plans in a subscription with other rate plans.  **Note**: This feature is in the **Early Adopter** phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/). 
        /// </summary>
        /// <value>Use this field to change one or more rate plans - to replace the existing rate plans in a subscription with other rate plans.  **Note**: This feature is in the **Early Adopter** phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/). </value>
        [DataMember(Name = "change", EmitDefaultValue = false)]
        public List<PUTSrpChangeType> Change { get; set; }

        /// <summary>
        /// Whether to clear the existing bill-to contact ID at the subscription level. This field is mutually exclusive with the &#x60;paymentTerm&#x60; field.  **Note**: This field is only available if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature enabled. 
        /// </summary>
        /// <value>Whether to clear the existing bill-to contact ID at the subscription level. This field is mutually exclusive with the &#x60;paymentTerm&#x60; field.  **Note**: This field is only available if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature enabled. </value>
        [DataMember(Name = "clearingExistingBillToContactId", EmitDefaultValue = true)]
        public bool ClearingExistingBillToContactId { get; set; }

        /// <summary>
        /// Whether to clear the existing payment term at the subscription level. This field is mutually exclusive with the &#x60;billToContactId&#x60; field.  **Note**: This field is only available if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature enabled. 
        /// </summary>
        /// <value>Whether to clear the existing payment term at the subscription level. This field is mutually exclusive with the &#x60;billToContactId&#x60; field.  **Note**: This field is only available if you have the [Flexible Billing](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing) feature enabled. </value>
        [DataMember(Name = "clearingExistingPaymentTerm", EmitDefaultValue = true)]
        public bool ClearingExistingPaymentTerm { get; set; }
        ...
        /// </summary>
        /// <value>The length of the period for the current subscription term. If &#x60;termType&#x60; is &#x60;TERMED&#x60;, this field is required and must be greater than &#x60;0&#x60;. If &#x60;termType&#x60; is &#x60;EVERGREEN&#x60;, this value is ignored. </value>
        ...
        /// </summary>
        /// <value>Specifies whether to include draft invoice items in subscription previews. Values are:  * &#x60;true&#x60; (default). Includes draft invoice items in the preview result. * &#x60;false&#x60;. Excludes draft invoice items in the preview result.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 207.0 or later. To use this field in the method, you must set the **zuora-version** parameter to the minor version number in the request header. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information. </value>
        [DataMember(Name = "includeExistingDraftDocItems", EmitDefaultValue = true)]
        public bool IncludeExistingDraftDocItems { get; set; }

        /// <summary>
        /// Specifies whether to include draft invoice items in subscription previews. Values are:  * &#x60;true&#x60; (default). Includes draft invoice items in the preview result. * &#x60;false&#x60;. Excludes draft invoice items in the preview result.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 186.0, 187.0, 188.0, 189.0, and 196.0. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information. 
        /// </summary>
        /// <value>Specifies whether to include draft invoice items in subscription previews. Values are:  * &#x60;true&#x60; (default). Includes draft invoice items in the preview result. * &#x60;false&#x60;. Excludes draft invoice items in the preview result.  **Note:** This field is in Zuora REST API version control. Supported minor versions are 186.0, 187.0, 188.0, 189.0, and 196.0. See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information. </value>
        [DataMember(Name = "includeExistingDraftInvoiceItems", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>The type of preview you will receive.   This field is in Zuora REST API version control. The supported values of this field depend on the REST API minor version you specified in the request header.   * If you do not specify the REST API minor version or specify the minor version number to one of following values in the request header:    * 186.0   * 187.0   * 188.0   * 189.0   * 196.0     The following values are supported in the **previewType** field:    * InvoiceItem   * ChargeMetrics   * InvoiceItemChargeMetrics    The default value is InvoiceItem.  * If you specify the REST API minor version to 207.0 or later in the request header, the following values are supported in the **previewType** field:    - LegalDoc   - ChargeMetrics   - LegalDocChargeMetrics    The default value is LegalDoc.  See [Zuora REST API Versions](https://www.zuora.com/developer/api-reference/#section/API-Versions) for more information. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ClearingExistingBillToContactId: ").Append(ClearingExistingBillToContactId).Append("\n");
            sb.Append("  ClearingExistingPaymentTerm: ").Append(ClearingExistingPaymentTerm).Append("\n");
            ...
            sb.Append("  IncludeExistingDraftDocItems: ").Append(IncludeExistingDraftDocItems).Append("\n");
        ...
        {
            return this.Equals(input as PUTSubscriptionTypeAllOf);
        }

        /// <summary>
        /// Returns true if PUTSubscriptionTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTSubscriptionTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTSubscriptionTypeAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ClearingExistingBillToContactId == input.ClearingExistingBillToContactId ||
                    this.ClearingExistingBillToContactId.Equals(input.ClearingExistingBillToContactId)
                ) && 
                (
                    this.ClearingExistingPaymentTerm == input.ClearingExistingPaymentTerm ||
                    this.ClearingExistingPaymentTerm.Equals(input.ClearingExistingPaymentTerm)
                ) && 
                (
                ...
                (
                    this.IncludeExistingDraftDocItems == input.IncludeExistingDraftDocItems ||
                    this.IncludeExistingDraftDocItems.Equals(input.IncludeExistingDraftDocItems)
                ) && 
                (
                    this.IncludeExistingDraftInvoiceItems == input.IncludeExistingDraftInvoiceItems ||
                    this.IncludeExistingDraftInvoiceItems.Equals(input.IncludeExistingDraftInvoiceItems)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ClearingExistingBillToContactId.GetHashCode();
                hashCode = (hashCode * 59) + this.ClearingExistingPaymentTerm.GetHashCode();
                ...
                hashCode = (hashCode * 59) + this.IncludeExistingDraftDocItems.GetHashCode();
                hashCode = (hashCode * 59) + this.IncludeExistingDraftInvoiceItems.GetHashCode();
