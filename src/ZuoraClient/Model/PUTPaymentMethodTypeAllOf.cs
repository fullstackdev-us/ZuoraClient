...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PUTPaymentMethodType_allOf")]
    public partial class PUTPaymentMethodTypeAllOf : IEquatable<PUTPaymentMethodTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTPaymentMethodTypeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="country">Country; must be a valid country name or abbreviation. .</param>
        ...
        /// <param name="expirationMonth">One or two digit(s) expiration month (1-12). .</param>
        ...
        /// <param name="state">State; must be a valid state name or 2-character abbreviation. .</param>
        /// <param name="zipCode">Zip code, 20 characters or less. .</param>
        public PUTPaymentMethodTypeAllOf(string addressLine1 = default(string), string addressLine2 = default(string), string cardHolderName = default(string), string city = default(string), string country = default(string), bool defaultPaymentMethod = default(bool), string email = default(string), int expirationMonth = default(int), int expirationYear = default(int), CreatePaymentMethodCommonGatewayOptions gatewayOptions = default(CreatePaymentMethodCommonGatewayOptions), int numConsecutiveFailures = default(int), string phone = default(string), string securityCode = default(string), string state = default(string), string zipCode = default(string))
        {
        ...
        /// </summary>
        /// <value>Country; must be a valid country name or abbreviation. </value>
        ...
        /// </summary>
        /// <value>One or two digit(s) expiration month (1-12). </value>
        ...
        /// </summary>
        /// <value>State; must be a valid state name or 2-character abbreviation. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PUTPaymentMethodTypeAllOf {\n");
        ...
        {
            return this.Equals(input as PUTPaymentMethodTypeAllOf);
        }

        /// <summary>
        /// Returns true if PUTPaymentMethodTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTPaymentMethodTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTPaymentMethodTypeAllOf input)
        {
            if (input == null)
            {
                return false;
