...
namespace ZuoraClient.Model
{
    ...
    public partial class GETJournalRunType : IEquatable<GETJournalRunType>, IValidatableObject
    {
        ...
        public enum StatusEnum
        {
            ...
            /// <summary>
            /// Enum DeleteInprogress for value: DeleteInprogress
            /// </summary>
        ...
        /// </summary>
        /// <param name="aggregateCurrency">aggregateCurrency.</param>
        ...
        /// <param name="status">Status of the journal run.  .</param>
        ...
        public GETJournalRunType(bool aggregateCurrency = default(bool), DateTime executedOn = default(DateTime), DateTime journalEntryDate = default(DateTime), string number = default(string), string segmentationRuleName = default(string), StatusEnum? status = default(StatusEnum?), bool success = default(bool), DateTime targetEndDate = default(DateTime), DateTime targetStartDate = default(DateTime), long totalJournalEntryCount = default(long), List<GETJournalRunTransactionType> transactionTypes = default(List<GETJournalRunTransactionType>))
        {
        ...
        /// <summary>
        /// Gets or Sets AggregateCurrency
        /// </summary>
        ...
        {
            return this.Equals(input as GETJournalRunType);
        }

        /// <summary>
        /// Returns true if GETJournalRunType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETJournalRunType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETJournalRunType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SegmentationRuleName == input.SegmentationRuleName ||
                    (this.SegmentationRuleName != null &&
                    this.SegmentationRuleName.Equals(input.SegmentationRuleName))
                ) && 
                (
                ...
                (
                    this.TargetEndDate == input.TargetEndDate ||
                    (this.TargetEndDate != null &&
                    this.TargetEndDate.Equals(input.TargetEndDate))
                ) && 
                (
                    this.TargetStartDate == input.TargetStartDate ||
                    (this.TargetStartDate != null &&
                    this.TargetStartDate.Equals(input.TargetStartDate))
                ) && 
                (
                    this.TotalJournalEntryCount == input.TotalJournalEntryCount ||
                    this.TotalJournalEntryCount.Equals(input.TotalJournalEntryCount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SegmentationRuleName.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.Status.GetHashCode();
                hashCode = (hashCode * 59) + this.Success.GetHashCode();
                if (this.TargetEndDate != null)
                {
                    hashCode = (hashCode * 59) + this.TargetEndDate.GetHashCode();
                }
                if (this.TargetStartDate != null)
                {
                    hashCode = (hashCode * 59) + this.TargetStartDate.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.TotalJournalEntryCount.GetHashCode();
