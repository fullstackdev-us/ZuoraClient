...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostOrderResponseType")]
    public partial class PostOrderResponseType : IEquatable<PostOrderResponseType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOrderResponseType" /> class.
        /// </summary>
        ...
        /// <param name="accountId">The account ID for the order. This field is returned instead of the &#x60;accountNumber&#x60; field if the &#x60;returnIds&#x60; query parameter is set to &#x60;true&#x60;..</param>
        /// <param name="accountNumber">The account number for the order..</param>
        /// <param name="creditMemoIds">An array of the credit memo IDs generated in this order request. The credit memo is only available if you have the Invoice Settlement feature enabled. This field is returned instead of the &#x60;creditMemoNumbers&#x60; field if the &#x60;returnIds&#x60; query parameter is set to &#x60;true&#x60;..</param>
        ...
        /// <param name="orderId">The ID of the order created. This field is returned instead of the &#x60;orderNumber&#x60; field if the &#x60;returnIds&#x60; query parameter is set to &#x60;true&#x60;..</param>
        ...
        /// <param name="paymentId">The payment Id that is collected in this order request. This field is returned instead of the &#x60;paymentNumber&#x60; field if the &#x60;returnIds&#x60; query parameter is set to &#x60;true&#x60;..</param>
        /// <param name="paymentNumber">The payment number that is collected in this order request..</param>
        ...
        /// <param name="subscriptionIds">Container for the subscription IDs of the subscriptions in an order. This field is returned if the &#x60;returnIds&#x60; query parameter is set to &#x60;true&#x60;..</param>
        /// <param name="subscriptionNumbers">Container for the subscription numbers of the subscriptions in an order..</param>
        ...
        public PostOrderResponseType(string processId = default(string), List<CommonResponseTypeReasonsInner> reasons = default(List<CommonResponseTypeReasonsInner>), bool success = default(bool), string accountId = default(string), string accountNumber = default(string), List<string> creditMemoIds = default(List<string>), List<string> creditMemoNumbers = default(List<string>), List<string> invoiceIds = default(List<string>), List<string> invoiceNumbers = default(List<string>), string orderId = default(string), List<JobResultAllOfOrderLineItems> orderLineItems = default(List<JobResultAllOfOrderLineItems>), string orderNumber = default(string), string paidAmount = default(string), string paymentId = default(string), string paymentNumber = default(string), List<JobResultAllOfRamps> ramps = default(List<JobResultAllOfRamps>), StatusEnum? status = default(StatusEnum?), List<string> subscriptionIds = default(List<string>), List<string> subscriptionNumbers = default(List<string>), List<PostOrderResponseTypeAllOfSubscriptions> subscriptions = default(List<PostOrderResponseTypeAllOfSubscriptions>))
        {
        ...
        /// </summary>
        /// <value>The account ID for the order. This field is returned instead of the &#x60;accountNumber&#x60; field if the &#x60;returnIds&#x60; query parameter is set to &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>An array of the credit memo IDs generated in this order request. The credit memo is only available if you have the Invoice Settlement feature enabled. This field is returned instead of the &#x60;creditMemoNumbers&#x60; field if the &#x60;returnIds&#x60; query parameter is set to &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>An array of the invoice IDs generated in this order request. Normally it includes one invoice ID only, but can include multiple items when a subscription was tagged as invoice separately. This field is returned instead of the &#x60;invoiceNumbers&#x60; field if the &#x60;returnIds&#x60; query parameter is set to &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>The ID of the order created. This field is returned instead of the &#x60;orderNumber&#x60; field if the &#x60;returnIds&#x60; query parameter is set to &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>The payment Id that is collected in this order request. This field is returned instead of the &#x60;paymentNumber&#x60; field if the &#x60;returnIds&#x60; query parameter is set to &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>The payment number that is collected in this order request.</value>
        ...
        /// </summary>
        /// <value>Container for the subscription IDs of the subscriptions in an order. This field is returned if the &#x60;returnIds&#x60; query parameter is set to &#x60;true&#x60;.</value>
        ...
        /// </summary>
        /// <value>Container for the subscription numbers of the subscriptions in an order.</value>
        ...
        public List<PostOrderResponseTypeAllOfSubscriptions> Subscriptions { get; set; }
        ...
        {
            return this.Equals(input as PostOrderResponseType);
        }

        /// <summary>
        /// Returns true if PostOrderResponseType instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOrderResponseType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOrderResponseType input)
        {
            if (input == null)
            {
                return false;
