...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetTaxationItem_allOf")]
    public partial class ProxyGetTaxationItemAllOf : IEquatable<ProxyGetTaxationItemAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyGetTaxationItemAllOf" /> class.
        /// </summary>
        ...
        /// <param name="exemptAmount"> The calculated tax amount excluded due to the exemption. **Character limit**: 16 **Values**: a decimal value .</param>
        /// <param name="id">Object identifier..</param>
        /// <param name="invoiceItemId"> The ID of the specific invoice item that the taxation information applies to. **Character limit**: 32 **Values**: a valid invoice item ID .</param>
        ...
        /// <param name="taxDate"> The date that the tax is applied to the charge, in &#x60;yyyy-mm-dd&#x60; format. **Character limit**: 29 .</param>
        ...
        public ProxyGetTaxationItemAllOf(string accountingCode = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), double exemptAmount = default(double), string id = default(string), string invoiceItemId = default(string), string jurisdiction = default(string), string locationCode = default(string), string name = default(string), double taxAmount = default(double), string taxCode = default(string), string taxCodeDescription = default(string), DateTime taxDate = default(DateTime), double taxRate = default(double), string taxRateDescription = default(string), string taxRateType = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
        ...
        /// </summary>
        /// <value> The calculated tax amount excluded due to the exemption. **Character limit**: 16 **Values**: a decimal value </value>
        ...
        /// </summary>
        /// <value> The ID of the specific invoice item that the taxation information applies to. **Character limit**: 32 **Values**: a valid invoice item ID </value>
        ...
        /// </summary>
        /// <value> The date that the tax is applied to the charge, in &#x60;yyyy-mm-dd&#x60; format. **Character limit**: 29 </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyGetTaxationItemAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyGetTaxationItemAllOf);
        }

        /// <summary>
        /// Returns true if ProxyGetTaxationItemAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetTaxationItemAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetTaxationItemAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.InvoiceItemId == input.InvoiceItemId ||
                    (this.InvoiceItemId != null &&
                    this.InvoiceItemId.Equals(input.InvoiceItemId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.InvoiceItemId.GetHashCode();
                }
