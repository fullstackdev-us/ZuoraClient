...
namespace ZuoraClient.Api
{
    ...
    /// </summary>
    public interface ICustomScheduledEventsApiSync : IApiAccessor
    {
        ...
        /// <param name="id">The ID of the scheduled event.</param>
        ...
        /// <returns></returns>
        void DELETEScheduledEventByID(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        ApiResponse<Object> DELETEScheduledEventByIDWithHttpInfo(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetScheduledEventResponse</returns>
        GetScheduledEventResponse GETScheduledEventByID(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetScheduledEventResponse</returns>
        ApiResponse<GetScheduledEventResponse> GETScheduledEventByIDWithHttpInfo(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETScheduledEvents200Response</returns>
        GETScheduledEvents200Response GETScheduledEvents(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0);
        ...
        /// <param name="limit">The maximum number of data records to be returned. Default to 10 if absent. (optional, default to 10)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETScheduledEvents200Response</returns>
        ApiResponse<GETScheduledEvents200Response> GETScheduledEventsWithHttpInfo(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0);
        /// <summary>
        ...
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken). </param>
        /// <param name="postScheduledEventRequest"></param>
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetScheduledEventResponse</returns>
        GetScheduledEventResponse POSTScheduledEvent(string authorization, PostScheduledEventRequest postScheduledEventRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetScheduledEventResponse</returns>
        ApiResponse<GetScheduledEventResponse> POSTScheduledEventWithHttpInfo(string authorization, PostScheduledEventRequest postScheduledEventRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICustomScheduledEventsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DELETEScheduledEventByIDAsync(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetScheduledEventResponse</returns>
        System.Threading.Tasks.Task<GetScheduledEventResponse> GETScheduledEventByIDAsync(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetScheduledEventResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<GetScheduledEventResponse>> GETScheduledEventByIDWithHttpInfoAsync(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all scheduled events
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETScheduledEvents200Response</returns>
        System.Threading.Tasks.Task<GETScheduledEvents200Response> GETScheduledEventsAsync(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETScheduledEvents200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<GETScheduledEvents200Response>> GETScheduledEventsWithHttpInfoAsync(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a scheduled event
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetScheduledEventResponse</returns>
        System.Threading.Tasks.Task<GetScheduledEventResponse> POSTScheduledEventAsync(string authorization, PostScheduledEventRequest postScheduledEventRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetScheduledEventResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<GetScheduledEventResponse>> POSTScheduledEventWithHttpInfoAsync(string authorization, PostScheduledEventRequest postScheduledEventRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ICustomScheduledEventsApi : ICustomScheduledEventsApiSync, ICustomScheduledEventsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CustomScheduledEventsApi : ICustomScheduledEventsApi
    {
        private ZuoraClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomScheduledEventsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CustomScheduledEventsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public CustomScheduledEventsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public CustomScheduledEventsApi(ZuoraClient.Client.Configuration configuration)
        {
        ...
        public CustomScheduledEventsApi(ZuoraClient.Client.ISynchronousClient client, ZuoraClient.Client.IAsynchronousClient asyncClient, ZuoraClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DELETEScheduledEventByID(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            DELETEScheduledEventByIDWithHttpInfo(authorization, id, zuoraEntityIds, zuoraTrackId);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ZuoraClient.Client.ApiResponse<Object> DELETEScheduledEventByIDWithHttpInfo(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'authorization' when calling CustomScheduledEventsApi->DELETEScheduledEventByID");
            }

            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'id' when calling CustomScheduledEventsApi->DELETEScheduledEventByID");
            }
            ...
            localVarRequestOptions.Operation = "CustomScheduledEventsApi.DELETEScheduledEventByID";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/events/scheduled-events/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DELETEScheduledEventByID", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DELETEScheduledEventByIDAsync(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DELETEScheduledEventByIDWithHttpInfoAsync(authorization, id, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<Object>> DELETEScheduledEventByIDWithHttpInfoAsync(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/events/scheduled-events/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetScheduledEventResponse</returns>
        public GetScheduledEventResponse GETScheduledEventByID(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GetScheduledEventResponse> localVarResponse = GETScheduledEventByIDWithHttpInfo(authorization, id, zuoraEntityIds, zuoraTrackId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetScheduledEventResponse</returns>
        public ZuoraClient.Client.ApiResponse<GetScheduledEventResponse> GETScheduledEventByIDWithHttpInfo(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'authorization' when calling CustomScheduledEventsApi->GETScheduledEventByID");
            }

            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'id' when calling CustomScheduledEventsApi->GETScheduledEventByID");
            }
            ...
            localVarRequestOptions.Operation = "CustomScheduledEventsApi.GETScheduledEventByID";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<GetScheduledEventResponse>("/events/scheduled-events/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETScheduledEventByID", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetScheduledEventResponse</returns>
        public async System.Threading.Tasks.Task<GetScheduledEventResponse> GETScheduledEventByIDAsync(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GetScheduledEventResponse> localVarResponse = await GETScheduledEventByIDWithHttpInfoAsync(authorization, id, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetScheduledEventResponse)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GetScheduledEventResponse>> GETScheduledEventByIDWithHttpInfoAsync(string authorization, string id, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetScheduledEventResponse>("/events/scheduled-events/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETScheduledEvents200Response</returns>
        public GETScheduledEvents200Response GETScheduledEvents(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GETScheduledEvents200Response> localVarResponse = GETScheduledEventsWithHttpInfo(authorization, zuoraEntityIds, zuoraTrackId, start, limit);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETScheduledEvents200Response</returns>
        public ZuoraClient.Client.ApiResponse<GETScheduledEvents200Response> GETScheduledEventsWithHttpInfo(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'authorization' when calling CustomScheduledEventsApi->GETScheduledEvents");
            }
            ...
            localVarRequestOptions.Operation = "CustomScheduledEventsApi.GETScheduledEvents";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<GETScheduledEvents200Response>("/events/scheduled-events", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETScheduledEvents", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETScheduledEvents200Response</returns>
        public async System.Threading.Tasks.Task<GETScheduledEvents200Response> GETScheduledEventsAsync(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GETScheduledEvents200Response> localVarResponse = await GETScheduledEventsWithHttpInfoAsync(authorization, zuoraEntityIds, zuoraTrackId, start, limit, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETScheduledEvents200Response)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GETScheduledEvents200Response>> GETScheduledEventsWithHttpInfoAsync(string authorization, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int? start = default(int?), int? limit = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GETScheduledEvents200Response>("/events/scheduled-events", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a scheduled event To create a custom scheduled event, you must specify the base object, the base field and the scheduled time. 
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken). </param>
        /// <param name="postScheduledEventRequest"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetScheduledEventResponse</returns>
        public GetScheduledEventResponse POSTScheduledEvent(string authorization, PostScheduledEventRequest postScheduledEventRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GetScheduledEventResponse> localVarResponse = POSTScheduledEventWithHttpInfo(authorization, postScheduledEventRequest, zuoraEntityIds, zuoraTrackId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetScheduledEventResponse</returns>
        public ZuoraClient.Client.ApiResponse<GetScheduledEventResponse> POSTScheduledEventWithHttpInfo(string authorization, PostScheduledEventRequest postScheduledEventRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'authorization' when calling CustomScheduledEventsApi->POSTScheduledEvent");
            }

            // verify the required parameter 'postScheduledEventRequest' is set
            if (postScheduledEventRequest == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'postScheduledEventRequest' when calling CustomScheduledEventsApi->POSTScheduledEvent");
            }
            ...
            localVarRequestOptions.Data = postScheduledEventRequest;

            localVarRequestOptions.Operation = "CustomScheduledEventsApi.POSTScheduledEvent";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<GetScheduledEventResponse>("/events/scheduled-events", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("POSTScheduledEvent", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetScheduledEventResponse</returns>
        public async System.Threading.Tasks.Task<GetScheduledEventResponse> POSTScheduledEventAsync(string authorization, PostScheduledEventRequest postScheduledEventRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GetScheduledEventResponse> localVarResponse = await POSTScheduledEventWithHttpInfoAsync(authorization, postScheduledEventRequest, zuoraEntityIds, zuoraTrackId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetScheduledEventResponse)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GetScheduledEventResponse>> POSTScheduledEventWithHttpInfoAsync(string authorization, PostScheduledEventRequest postScheduledEventRequest, string zuoraEntityIds = default(string), string zuoraTrackId = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<GetScheduledEventResponse>("/events/scheduled-events", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
