...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyGetCreditBalanceAdjustment")]
    public partial class ProxyGetCreditBalanceAdjustment : IEquatable<ProxyGetCreditBalanceAdjustment>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Status of the credit balance adjustment&#39;s transfer to an external accounting system, such as NetSuite. </value>
        ...
        /// </summary>
        /// <param name="accountId"> The account ID of the credit balance&#39;s account. Zuora generates this value from the source transaction. **Character limit**: 32 **Values**: automatically generated from:  - CreditBalanceAdjustment.SourceTransactionId or - CreditBalanceAdjustment.SourceTransactionNumber .</param>
        /// <param name="accountingCode"> The Chart of Accounts .</param>
        ...
        /// <param name="referenceId"> The ID of the payment that the credit balance adjustment is for. **Character limit**: 100 **Values**: a string of 100 characters or fewer .</param>
        ...
        /// <param name="transferredToAccounting">Status of the credit balance adjustment&#39;s transfer to an external accounting system, such as NetSuite. .</param>
        ...
        public ProxyGetCreditBalanceAdjustment(string accountId = default(string), string accountingCode = default(string), DateTime adjustmentDate = default(DateTime), double amount = default(double), DateTime cancelledOn = default(DateTime), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), string id = default(string), string number = default(string), string reasonCode = default(string), string referenceId = default(string), string sourceTransactionId = default(string), string sourceTransactionNumber = default(string), string sourceTransactionType = default(string), string status = default(string), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?), string type = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), string syncDateNS = default(string))
        {
        ...
        /// <summary>
        ///  The account ID of the credit balance&#39;s account. Zuora generates this value from the source transaction. **Character limit**: 32 **Values**: automatically generated from:  - CreditBalanceAdjustment.SourceTransactionId or - CreditBalanceAdjustment.SourceTransactionNumber 
        /// </summary>
        /// <value> The account ID of the credit balance&#39;s account. Zuora generates this value from the source transaction. **Character limit**: 32 **Values**: automatically generated from:  - CreditBalanceAdjustment.SourceTransactionId or - CreditBalanceAdjustment.SourceTransactionNumber </value>
        ...
        /// </summary>
        /// <value> The Chart of Accounts </value>
        ...
        /// <summary>
        ///  The ID of the payment that the credit balance adjustment is for. **Character limit**: 100 **Values**: a string of 100 characters or fewer 
        /// </summary>
        /// <value> The ID of the payment that the credit balance adjustment is for. **Character limit**: 100 **Values**: a string of 100 characters or fewer </value>
        ...
        {
            return this.Equals(input as ProxyGetCreditBalanceAdjustment);
        }

        /// <summary>
        /// Returns true if ProxyGetCreditBalanceAdjustment instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetCreditBalanceAdjustment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetCreditBalanceAdjustment input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SourceTransactionType == input.SourceTransactionType ||
                    (this.SourceTransactionType != null &&
                    this.SourceTransactionType.Equals(input.SourceTransactionType))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SourceTransactionType.GetHashCode();
                }
                if (this.Status != null)
                {
