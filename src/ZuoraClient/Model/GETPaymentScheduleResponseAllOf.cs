...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETPaymentScheduleResponse_allOf")]
    public partial class GETPaymentScheduleResponseAllOf : IEquatable<GETPaymentScheduleResponseAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The status of the payment schedule.  - Active: There is still payment schedule item to process. - Canceled: After a payment schedule is canceled by the user, the schedule is marked as &#x60;Canceled&#x60;. - Completed: After all payment schedule items are processed, the schedule is marked as &#x60;Completed&#x60;. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETPaymentScheduleResponseAllOf" /> class.
        /// </summary>
        ...
        /// <param name="createdById">The ID of the user who created this payment schedule. .</param>
        ...
        /// <param name="standalone">Indicates if the payments that the payment schedule created are standalone payments. .</param>
        /// <param name="startDate">The date when the first payment of this payment schedule is proccessed. .</param>
        /// <param name="status">The status of the payment schedule.  - Active: There is still payment schedule item to process. - Canceled: After a payment schedule is canceled by the user, the schedule is marked as &#x60;Canceled&#x60;. - Completed: After all payment schedule items are processed, the schedule is marked as &#x60;Completed&#x60;. .</param>
        ...
        public GETPaymentScheduleItemResponseAllOfBillingDocument BillingDocument { get; set; }

        /// <summary>
        /// The ID of the user who created this payment schedule. 
        /// </summary>
        /// <value>The ID of the user who created this payment schedule. </value>
        ...
        /// </summary>
        /// <value>Indicates if the payments that the payment schedule created are standalone payments. </value>
        ...
        /// </summary>
        /// <value>The ID of the user who last updated this payment schedule. </value>
        ...
        {
            return this.Equals(input as GETPaymentScheduleResponseAllOf);
        }

        /// <summary>
        /// Returns true if GETPaymentScheduleResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETPaymentScheduleResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPaymentScheduleResponseAllOf input)
        {
            if (input == null)
            {
                return false;
