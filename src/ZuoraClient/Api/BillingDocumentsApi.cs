...
namespace ZuoraClient.Api
{
    ...
    /// </summary>
    public interface IBillingDocumentsApiSync : IApiAccessor
    {
        ...
        /// <param name="jobId">The unique ID of a billing document file deletion job. For example, 2c92c8f83dc4f752013dc72c24ee016c.</param>
        ...
        /// <returns>GETBillingDocumentFilesDeletionJobResponse</returns>
        GETBillingDocumentFilesDeletionJobResponse GETBillingDocumentFilesDeletionJob(string jobId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        ...
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETBillingDocumentFilesDeletionJobResponse</returns>
        ApiResponse<GETBillingDocumentFilesDeletionJobResponse> GETBillingDocumentFilesDeletionJobWithHttpInfo(string jobId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="accountId">The ID of the customer account that the billing documents are associated with.  **Note**: When retrieving information about all billing documents associated with an account, you must specify either &#x60;accountId&#x60; or &#x60;accountNumber&#x60; in the query parameters.  (optional)</param>
        /// <param name="accountNumber">The number of the customer account that the billing documents are associated with.  **Note**: When retrieving information about all billing documents associated with an account, you must specify either &#x60;accountId&#x60; or &#x60;accountNumber&#x60; in the query parameters.  (optional)</param>
        /// <param name="documentDate">The date of the billing document. It represents the invoice date for invoices, credit memo date for credit memos, and debit memo date for debit memos.  (optional)</param>
        /// <param name="status">The status of the billing document.  (optional)</param>
        /// <param name="sort">This parameter restricts the order of the data returned in the response. You can use this parameter to supply a dimension you want to sort on.  If you do not specify any sortable field, the response data is sorted by the &#x60;documentDate&#x60; field in descending order.  A sortable field uses the following form:   *operator* *field_name*  You can use at most two sortable fields in one URL path. Use a comma to separate sortable fields. For example:  *operator* *field_name*, *operator* *field_name*    *operator* is used to mark the order of sequencing. The operator is optional. If you only specify the sortable field without any operator, the response data is sorted in descending order by this field.      - The &#x60;-&#x60; operator indicates an ascending order.   - The &#x60;+&#x60; operator indicates a descending order.  *field_name* indicates the name of a sortable field. The supported sortable fields of this operation are as below:    - documentDate   - documentType    Examples: - /billing-documents?accountId&#x3D;4028905f5e4feb38015e50af9aa002d1   &amp;sort&#x3D;+documentDate,-documentType - /billing-documents?accountId&#x3D;4028905f5e4feb38015e50af9aa002d1   &amp;status&#x3D;Posted&amp;sort&#x3D;+documentDate&amp;page&#x3D;2&amp;pageSize&#x3D;15  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BillingDocumentQueryResponseElementType</returns>
        BillingDocumentQueryResponseElementType GETBillingDocuments(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), Guid? accountId = default(Guid?), Guid? accountNumber = default(Guid?), DateTime? documentDate = default(DateTime?), string status = default(string), string sort = default(string), int operationIndex = 0);
        ...
        /// <param name="sort">This parameter restricts the order of the data returned in the response. You can use this parameter to supply a dimension you want to sort on.  If you do not specify any sortable field, the response data is sorted by the &#x60;documentDate&#x60; field in descending order.  A sortable field uses the following form:   *operator* *field_name*  You can use at most two sortable fields in one URL path. Use a comma to separate sortable fields. For example:  *operator* *field_name*, *operator* *field_name*    *operator* is used to mark the order of sequencing. The operator is optional. If you only specify the sortable field without any operator, the response data is sorted in descending order by this field.      - The &#x60;-&#x60; operator indicates an ascending order.   - The &#x60;+&#x60; operator indicates a descending order.  *field_name* indicates the name of a sortable field. The supported sortable fields of this operation are as below:    - documentDate   - documentType    Examples: - /billing-documents?accountId&#x3D;4028905f5e4feb38015e50af9aa002d1   &amp;sort&#x3D;+documentDate,-documentType - /billing-documents?accountId&#x3D;4028905f5e4feb38015e50af9aa002d1   &amp;status&#x3D;Posted&amp;sort&#x3D;+documentDate&amp;page&#x3D;2&amp;pageSize&#x3D;15  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BillingDocumentQueryResponseElementType</returns>
        ApiResponse<BillingDocumentQueryResponseElementType> GETBillingDocumentsWithHttpInfo(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), Guid? accountId = default(Guid?), Guid? accountNumber = default(Guid?), DateTime? documentDate = default(DateTime?), string status = default(string), string sort = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>POSTBillingDocumentFilesDeletionJobResponse</returns>
        POSTBillingDocumentFilesDeletionJobResponse POSTBillingDocumentFilesDeletionJob(POSTBillingDocumentFilesDeletionJobRequest body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        ...
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of POSTBillingDocumentFilesDeletionJobResponse</returns>
        ApiResponse<POSTBillingDocumentFilesDeletionJobResponse> POSTBillingDocumentFilesDeletionJobWithHttpInfo(POSTBillingDocumentFilesDeletionJobRequest body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="key">The ID or number of the customer account that billing documents are generated for. For example, 8a8082e65b27f6c3015ba3e326b26419 or AC0000001. </param>
        /// <param name="body"></param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        /// <param name="zuoraTrackId">A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  (optional)</param>
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GenerateBillingDocumentResponseType</returns>
        GenerateBillingDocumentResponseType POSTGenerateBillingDocuments(string key, PostGenerateBillingDocumentType body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
        ...
        /// <param name="zuoraEntityIds">An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header.  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GenerateBillingDocumentResponseType</returns>
        ApiResponse<GenerateBillingDocumentResponseType> POSTGenerateBillingDocumentsWithHttpInfo(string key, PostGenerateBillingDocumentType body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBillingDocumentsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of GETBillingDocumentFilesDeletionJobResponse</returns>
        System.Threading.Tasks.Task<GETBillingDocumentFilesDeletionJobResponse> GETBillingDocumentFilesDeletionJobAsync(string jobId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETBillingDocumentFilesDeletionJobResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<GETBillingDocumentFilesDeletionJobResponse>> GETBillingDocumentFilesDeletionJobWithHttpInfoAsync(string jobId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List billing documents for an account
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BillingDocumentQueryResponseElementType</returns>
        System.Threading.Tasks.Task<BillingDocumentQueryResponseElementType> GETBillingDocumentsAsync(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), Guid? accountId = default(Guid?), Guid? accountNumber = default(Guid?), DateTime? documentDate = default(DateTime?), string status = default(string), string sort = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BillingDocumentQueryResponseElementType)</returns>
        System.Threading.Tasks.Task<ApiResponse<BillingDocumentQueryResponseElementType>> GETBillingDocumentsWithHttpInfoAsync(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), Guid? accountId = default(Guid?), Guid? accountNumber = default(Guid?), DateTime? documentDate = default(DateTime?), string status = default(string), string sort = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a job to hard delete billing document files
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of POSTBillingDocumentFilesDeletionJobResponse</returns>
        System.Threading.Tasks.Task<POSTBillingDocumentFilesDeletionJobResponse> POSTBillingDocumentFilesDeletionJobAsync(POSTBillingDocumentFilesDeletionJobRequest body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (POSTBillingDocumentFilesDeletionJobResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<POSTBillingDocumentFilesDeletionJobResponse>> POSTBillingDocumentFilesDeletionJobWithHttpInfoAsync(POSTBillingDocumentFilesDeletionJobRequest body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Generate billing documents by account ID
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GenerateBillingDocumentResponseType</returns>
        System.Threading.Tasks.Task<GenerateBillingDocumentResponseType> POSTGenerateBillingDocumentsAsync(string key, PostGenerateBillingDocumentType body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GenerateBillingDocumentResponseType)</returns>
        System.Threading.Tasks.Task<ApiResponse<GenerateBillingDocumentResponseType>> POSTGenerateBillingDocumentsWithHttpInfoAsync(string key, PostGenerateBillingDocumentType body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBillingDocumentsApi : IBillingDocumentsApiSync, IBillingDocumentsApiAsync
    {
    ...
    public partial class BillingDocumentsApi : IBillingDocumentsApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public BillingDocumentsApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public BillingDocumentsApi(ZuoraClient.Client.Configuration configuration)
        {
        ...
        public BillingDocumentsApi(ZuoraClient.Client.ISynchronousClient client, ZuoraClient.Client.IAsynchronousClient asyncClient, ZuoraClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve a job of hard deleting billing document files Retrieves information about an asynchronous job of permanently deleting all billing document PDF files for specific accounts.  **Note**: This operation can be used only if you have the Billing user permission \&quot;Hard Delete Billing Document Files\&quot; enabled.  
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="jobId">The unique ID of a billing document file deletion job. For example, 2c92c8f83dc4f752013dc72c24ee016c.</param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GETBillingDocumentFilesDeletionJobResponse</returns>
        public GETBillingDocumentFilesDeletionJobResponse GETBillingDocumentFilesDeletionJob(string jobId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GETBillingDocumentFilesDeletionJobResponse> localVarResponse = GETBillingDocumentFilesDeletionJobWithHttpInfo(jobId, authorization, zuoraTrackId, zuoraEntityIds);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GETBillingDocumentFilesDeletionJobResponse</returns>
        public ZuoraClient.Client.ApiResponse<GETBillingDocumentFilesDeletionJobResponse> GETBillingDocumentFilesDeletionJobWithHttpInfo(string jobId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'jobId' is set
            if (jobId == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'jobId' when calling BillingDocumentsApi->GETBillingDocumentFilesDeletionJob");
            }
            ...
            localVarRequestOptions.Operation = "BillingDocumentsApi.GETBillingDocumentFilesDeletionJob";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<GETBillingDocumentFilesDeletionJobResponse>("/v1/accounts/billing-documents/files/deletion-jobs/{jobId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETBillingDocumentFilesDeletionJob", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GETBillingDocumentFilesDeletionJobResponse</returns>
        public async System.Threading.Tasks.Task<GETBillingDocumentFilesDeletionJobResponse> GETBillingDocumentFilesDeletionJobAsync(string jobId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GETBillingDocumentFilesDeletionJobResponse> localVarResponse = await GETBillingDocumentFilesDeletionJobWithHttpInfoAsync(jobId, authorization, zuoraTrackId, zuoraEntityIds, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GETBillingDocumentFilesDeletionJobResponse)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GETBillingDocumentFilesDeletionJobResponse>> GETBillingDocumentFilesDeletionJobWithHttpInfoAsync(string jobId, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'jobId' is set
            if (jobId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GETBillingDocumentFilesDeletionJobResponse>("/v1/accounts/billing-documents/files/deletion-jobs/{jobId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BillingDocumentQueryResponseElementType</returns>
        public BillingDocumentQueryResponseElementType GETBillingDocuments(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), Guid? accountId = default(Guid?), Guid? accountNumber = default(Guid?), DateTime? documentDate = default(DateTime?), string status = default(string), string sort = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<BillingDocumentQueryResponseElementType> localVarResponse = GETBillingDocumentsWithHttpInfo(authorization, zuoraTrackId, zuoraEntityIds, page, pageSize, accountId, accountNumber, documentDate, status, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BillingDocumentQueryResponseElementType</returns>
        public ZuoraClient.Client.ApiResponse<BillingDocumentQueryResponseElementType> GETBillingDocumentsWithHttpInfo(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), Guid? accountId = default(Guid?), Guid? accountNumber = default(Guid?), DateTime? documentDate = default(DateTime?), string status = default(string), string sort = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.RequestOptions localVarRequestOptions = new ZuoraClient.Client.RequestOptions();
            ...
            {
                localVarRequestOptions.QueryParameters.Add(ZuoraClient.Client.ClientUtils.ParameterToMultiMap("", "documentDate", documentDate));
            }
            if (status != null)
            {
            ...
            localVarRequestOptions.Operation = "BillingDocumentsApi.GETBillingDocuments";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<BillingDocumentQueryResponseElementType>("/v1/billing-documents", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GETBillingDocuments", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BillingDocumentQueryResponseElementType</returns>
        public async System.Threading.Tasks.Task<BillingDocumentQueryResponseElementType> GETBillingDocumentsAsync(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), Guid? accountId = default(Guid?), Guid? accountNumber = default(Guid?), DateTime? documentDate = default(DateTime?), string status = default(string), string sort = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<BillingDocumentQueryResponseElementType> localVarResponse = await GETBillingDocumentsWithHttpInfoAsync(authorization, zuoraTrackId, zuoraEntityIds, page, pageSize, accountId, accountNumber, documentDate, status, sort, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BillingDocumentQueryResponseElementType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<BillingDocumentQueryResponseElementType>> GETBillingDocumentsWithHttpInfoAsync(string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int? page = default(int?), int? pageSize = default(int?), Guid? accountId = default(Guid?), Guid? accountNumber = default(Guid?), DateTime? documentDate = default(DateTime?), string status = default(string), string sort = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<BillingDocumentQueryResponseElementType>("/v1/billing-documents", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a job to hard delete billing document files Creates an asynchronous job to permanently delete all billing document PDF files for specific accounts.   After the deletion job is completed, all billing document PDF files are permanently deleted. To retrieve the status of a deletion job, call [Retrieve a job of hard deleting billing document files](https://www.zuora.com/developer/api-reference/#operation/GET_BillingDocumentFilesDeletionJob).  **Note**: This operation can be used only if you have the Billing user permission \&quot;Hard Delete Billing Document Files\&quot; enabled.  
        /// </summary>
        /// <exception cref="ZuoraClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body"></param>
        /// <param name="authorization">The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-reference/#operation/createToken).  (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>POSTBillingDocumentFilesDeletionJobResponse</returns>
        public POSTBillingDocumentFilesDeletionJobResponse POSTBillingDocumentFilesDeletionJob(POSTBillingDocumentFilesDeletionJobRequest body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<POSTBillingDocumentFilesDeletionJobResponse> localVarResponse = POSTBillingDocumentFilesDeletionJobWithHttpInfo(body, authorization, zuoraTrackId, zuoraEntityIds);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of POSTBillingDocumentFilesDeletionJobResponse</returns>
        public ZuoraClient.Client.ApiResponse<POSTBillingDocumentFilesDeletionJobResponse> POSTBillingDocumentFilesDeletionJobWithHttpInfo(POSTBillingDocumentFilesDeletionJobRequest body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'body' is set
            if (body == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'body' when calling BillingDocumentsApi->POSTBillingDocumentFilesDeletionJob");
            }
            ...
            localVarRequestOptions.Operation = "BillingDocumentsApi.POSTBillingDocumentFilesDeletionJob";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<POSTBillingDocumentFilesDeletionJobResponse>("/v1/accounts/billing-documents/files/deletion-jobs", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("POSTBillingDocumentFilesDeletionJob", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of POSTBillingDocumentFilesDeletionJobResponse</returns>
        public async System.Threading.Tasks.Task<POSTBillingDocumentFilesDeletionJobResponse> POSTBillingDocumentFilesDeletionJobAsync(POSTBillingDocumentFilesDeletionJobRequest body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<POSTBillingDocumentFilesDeletionJobResponse> localVarResponse = await POSTBillingDocumentFilesDeletionJobWithHttpInfoAsync(body, authorization, zuoraTrackId, zuoraEntityIds, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (POSTBillingDocumentFilesDeletionJobResponse)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<POSTBillingDocumentFilesDeletionJobResponse>> POSTBillingDocumentFilesDeletionJobWithHttpInfoAsync(POSTBillingDocumentFilesDeletionJobRequest body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<POSTBillingDocumentFilesDeletionJobResponse>("/v1/accounts/billing-documents/files/deletion-jobs", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GenerateBillingDocumentResponseType</returns>
        public GenerateBillingDocumentResponseType POSTGenerateBillingDocuments(string key, PostGenerateBillingDocumentType body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            ZuoraClient.Client.ApiResponse<GenerateBillingDocumentResponseType> localVarResponse = POSTGenerateBillingDocumentsWithHttpInfo(key, body, authorization, zuoraTrackId, zuoraEntityIds);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GenerateBillingDocumentResponseType</returns>
        public ZuoraClient.Client.ApiResponse<GenerateBillingDocumentResponseType> POSTGenerateBillingDocumentsWithHttpInfo(string key, PostGenerateBillingDocumentType body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'key' is set
            if (key == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'key' when calling BillingDocumentsApi->POSTGenerateBillingDocuments");
            }

            // verify the required parameter 'body' is set
            if (body == null)
            {
                throw new ZuoraClient.Client.ApiException(400, "Missing required parameter 'body' when calling BillingDocumentsApi->POSTGenerateBillingDocuments");
            }
            ...
            localVarRequestOptions.PathParameters.Add("key", ZuoraClient.Client.ClientUtils.ParameterToString(key)); // path parameter
            if (authorization != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Authorization", ZuoraClient.Client.ClientUtils.ParameterToString(authorization)); // header parameter
            }
            ...
            localVarRequestOptions.Operation = "BillingDocumentsApi.POSTGenerateBillingDocuments";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Post<GenerateBillingDocumentResponseType>("/v1/accounts/{key}/billing-documents/generate", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("POSTGenerateBillingDocuments", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GenerateBillingDocumentResponseType</returns>
        public async System.Threading.Tasks.Task<GenerateBillingDocumentResponseType> POSTGenerateBillingDocumentsAsync(string key, PostGenerateBillingDocumentType body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ZuoraClient.Client.ApiResponse<GenerateBillingDocumentResponseType> localVarResponse = await POSTGenerateBillingDocumentsWithHttpInfoAsync(key, body, authorization, zuoraTrackId, zuoraEntityIds, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GenerateBillingDocumentResponseType)</returns>
        public async System.Threading.Tasks.Task<ZuoraClient.Client.ApiResponse<GenerateBillingDocumentResponseType>> POSTGenerateBillingDocumentsWithHttpInfoAsync(string key, PostGenerateBillingDocumentType body, string authorization = default(string), string zuoraTrackId = default(string), string zuoraEntityIds = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'key' is set
            if (key == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<GenerateBillingDocumentResponseType>("/v1/accounts/{key}/billing-documents/generate", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
