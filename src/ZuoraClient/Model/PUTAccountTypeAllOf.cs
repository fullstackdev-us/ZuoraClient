...
namespace ZuoraClient.Model
{
    ...
    /// PUTAccountTypeAllOf
    /// </summary>
    [DataContract(Name = "PUTAccountType_allOf")]
    public partial class PUTAccountTypeAllOf : IEquatable<PUTAccountTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PUTAccountTypeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="autoPay">Whether future payments are to be automatically billed when they are due.  .</param>
        /// <param name="batch">The alias name given to a batch. A string of 50 characters or less. .</param>
        /// <param name="billCycleDay">Sets the bill cycle day (BCD) for the charge. The BCD determines which day of the month the customer is billed. Values: Any activated system-defined bill cycle day （&#x60;1&#x60;-&#x60;31&#x60;） .</param>
        ...
        /// <param name="defaultPaymentMethodId">ID of the default payment method for the account.  Values: a valid ID for an existing payment method.  For a specified credit card payment method, it is recommended that [the support for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions) for this payment method is already enabled. .</param>
        /// <param name="invoiceDeliveryPrefsEmail">Whether the customer wants to receive invoices through email.   The default value is &#x60;false&#x60;. .</param>
        /// <param name="invoiceDeliveryPrefsPrint">Whether the customer wants to receive printed invoices, such as through postal mail.  The default value is &#x60;false&#x60;. .</param>
        ...
        public PUTAccountTypeAllOf(List<string> additionalEmailAddresses = default(List<string>), bool autoPay = default(bool), string batch = default(string), int billCycleDay = default(int), PUTAccountTypeBillToContact billToContact = default(PUTAccountTypeBillToContact), string communicationProfileId = default(string), string creditMemoTemplateId = default(string), string crmId = default(string), string debitMemoTemplateId = default(string), string defaultPaymentMethodId = default(string), bool invoiceDeliveryPrefsEmail = default(bool), bool invoiceDeliveryPrefsPrint = default(bool), string invoiceTemplateId = default(string), string name = default(string), string notes = default(string), string parentId = default(string), string paymentGateway = default(string), string paymentTerm = default(string), string salesRep = default(string), string sequenceSetId = default(string), PUTAccountTypeSoldToContact soldToContact = default(PUTAccountTypeSoldToContact), string tagging = default(string), POSTAccountTypeAllOfTaxInfo taxInfo = default(POSTAccountTypeAllOfTaxInfo))
        {
        ...
        /// </summary>
        /// <value>Whether future payments are to be automatically billed when they are due.  </value>
        ...
        /// </summary>
        /// <value>Sets the bill cycle day (BCD) for the charge. The BCD determines which day of the month the customer is billed. Values: Any activated system-defined bill cycle day （&#x60;1&#x60;-&#x60;31&#x60;） </value>
        ...
        /// <summary>
        /// ID of the default payment method for the account.  Values: a valid ID for an existing payment method.  For a specified credit card payment method, it is recommended that [the support for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions) for this payment method is already enabled. 
        /// </summary>
        /// <value>ID of the default payment method for the account.  Values: a valid ID for an existing payment method.  For a specified credit card payment method, it is recommended that [the support for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions) for this payment method is already enabled. </value>
        ...
        /// </summary>
        /// <value>Whether the customer wants to receive invoices through email.   The default value is &#x60;false&#x60;. </value>
        ...
        /// </summary>
        /// <value>Whether the customer wants to receive printed invoices, such as through postal mail.  The default value is &#x60;false&#x60;. </value>
        ...
        {
            return this.Equals(input as PUTAccountTypeAllOf);
        }

        /// <summary>
        /// Returns true if PUTAccountTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTAccountTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTAccountTypeAllOf input)
        {
            if (input == null)
            {
                return false;
        ...
        {
            // DefaultPaymentMethodId (string) maxLength
            if (this.DefaultPaymentMethodId != null && this.DefaultPaymentMethodId.Length > 64)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DefaultPaymentMethodId, length must be less than 64.", new [] { "DefaultPaymentMethodId" });
            }
