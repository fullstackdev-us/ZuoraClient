...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTBulkCreditMemoFromInvoiceType")]
    public partial class POSTBulkCreditMemoFromInvoiceType : IEquatable<POSTBulkCreditMemoFromInvoiceType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTBulkCreditMemoFromInvoiceType" /> class.
        /// </summary>
        /// <param name="invoiceId">The ID of the invoice that the credit memo is created from. * If this field is specified, its value must be the same as the value of the &#x60;invoiceId&#x60; path parameter. Otherwise, its value overrides the value of the &#x60;invoiceId&#x60; path parameter.  * If this field is not specified, the value of the &#x60;invoiceId&#x60; path parameter is used. .</param>
        /// <param name="autoApplyToInvoiceUponPosting">Whether the credit memo automatically applies to the invoice upon posting. .</param>
        /// <param name="autoPost">Whether to automatically post the credit memo after it is created.  Setting this field to &#x60;true&#x60;, you do not need to separately call the [Post credit memo](https://www.zuora.com/developer/api-reference/#operation/PUT_PostCreditMemo) operation to post the credit memo.  (default to false).</param>
        /// <param name="comment">Comments about the credit memo. .</param>
        /// <param name="effectiveDate">The date when the credit memo takes effect. .</param>
        ...
        /// <param name="items">Container for items. The maximum number of items is 1,000. .</param>
        ...
        /// <param name="taxAutoCalculation">Whether to automatically calculate taxes in the credit memo.  (default to true).</param>
        ...
        public POSTBulkCreditMemoFromInvoiceType(string invoiceId = default(string), bool autoApplyToInvoiceUponPosting = default(bool), bool autoPost = false, string comment = default(string), DateTime effectiveDate = default(DateTime), bool excludeFromAutoApplyRules = default(bool), List<CreditMemoItemFromInvoiceItemType> items = default(List<CreditMemoItemFromInvoiceItemType>), string reasonCode = default(string), bool taxAutoCalculation = true, string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string transactionNS = default(string))
        {
        ...
        /// </summary>
        /// <value>The ID of the invoice that the credit memo is created from. * If this field is specified, its value must be the same as the value of the &#x60;invoiceId&#x60; path parameter. Otherwise, its value overrides the value of the &#x60;invoiceId&#x60; path parameter.  * If this field is not specified, the value of the &#x60;invoiceId&#x60; path parameter is used. </value>
        ...
        [DataMember(Name = "autoApplyToInvoiceUponPosting", EmitDefaultValue = true)]
        public bool AutoApplyToInvoiceUponPosting { get; set; }

        /// <summary>
        /// Whether to automatically post the credit memo after it is created.  Setting this field to &#x60;true&#x60;, you do not need to separately call the [Post credit memo](https://www.zuora.com/developer/api-reference/#operation/PUT_PostCreditMemo) operation to post the credit memo. 
        /// </summary>
        /// <value>Whether to automatically post the credit memo after it is created.  Setting this field to &#x60;true&#x60;, you do not need to separately call the [Post credit memo](https://www.zuora.com/developer/api-reference/#operation/PUT_PostCreditMemo) operation to post the credit memo. </value>
        ...
        /// </summary>
        /// <value>Container for items. The maximum number of items is 1,000. </value>
        [DataMember(Name = "items", EmitDefaultValue = false)]
        public List<CreditMemoItemFromInvoiceItemType> Items { get; set; }
        ...
        /// </summary>
        /// <value>Whether to automatically calculate taxes in the credit memo. </value>
        [DataMember(Name = "taxAutoCalculation", EmitDefaultValue = true)]
        public bool TaxAutoCalculation { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class POSTBulkCreditMemoFromInvoiceType {\n");
            sb.Append("  InvoiceId: ").Append(InvoiceId).Append("\n");
            sb.Append("  AutoApplyToInvoiceUponPosting: ").Append(AutoApplyToInvoiceUponPosting).Append("\n");
            ...
            sb.Append("  TaxAutoCalculation: ").Append(TaxAutoCalculation).Append("\n");
        ...
        {
            return this.Equals(input as POSTBulkCreditMemoFromInvoiceType);
        }

        /// <summary>
        /// Returns true if POSTBulkCreditMemoFromInvoiceType instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTBulkCreditMemoFromInvoiceType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTBulkCreditMemoFromInvoiceType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AutoApplyToInvoiceUponPosting == input.AutoApplyToInvoiceUponPosting ||
                    this.AutoApplyToInvoiceUponPosting.Equals(input.AutoApplyToInvoiceUponPosting)
                ) && 
                (
                ...
                (
                    this.TaxAutoCalculation == input.TaxAutoCalculation ||
                    this.TaxAutoCalculation.Equals(input.TaxAutoCalculation)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AutoApplyToInvoiceUponPosting.GetHashCode();
                ...
                hashCode = (hashCode * 59) + this.TaxAutoCalculation.GetHashCode();
