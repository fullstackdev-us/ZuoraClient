...
namespace ZuoraClient.Model
{
    ...
    /// GETSubscriptionType
    /// </summary>
    [DataContract(Name = "GETSubscriptionType")]
    public partial class GETSubscriptionType : IEquatable<GETSubscriptionType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETSubscriptionType);
        }

        /// <summary>
        /// Returns true if GETSubscriptionType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETSubscriptionType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETSubscriptionType input)
        {
            if (input == null)
            {
                return false;
