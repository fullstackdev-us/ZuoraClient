...
namespace ZuoraClient.Model
{
    ...
    /// ProxyCreatePayment
    /// </summary>
    [DataContract(Name = "ProxyCreatePayment")]
    public partial class ProxyCreatePayment : IEquatable<ProxyCreatePayment>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The status of the payment in the gateway; use for reconciliation. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum GatewayStateEnum
        {
            /// <summary>
            /// Enum MarkedForSubmission for value: MarkedForSubmission
            /// </summary>
            [EnumMember(Value = "MarkedForSubmission")]
            ...
            /// <summary>
            /// Enum FailedToSettle for value: FailedToSettle
            /// </summary>
            [EnumMember(Value = "FailedToSettle")]
            FailedToSettle = 5
        ...
        /// <summary>
        /// The status of the payment in Zuora. The only available value is &#x60;Processed&#x60;. 
        /// </summary>
        /// <value>The status of the payment in Zuora. The only available value is &#x60;Processed&#x60;. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>The type of the payment, whether the payment is external or electronic. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum Electronic for value: Electronic
            /// </summary>
        ...
        /// Initializes a new instance of the <see cref="ProxyCreatePayment" /> class.
        /// </summary>
        /// <param name="accountId">The unique account ID for the customer that the payment is for.  (required).</param>
        /// <param name="accountingCode">The accounting code for the payment. Accounting codes group transactions that contain similar accounting attributes. .</param>
        /// <param name="amount">The amount of the payment.  If Invoice Settlement is enabled, this field is required. .</param>
        /// <param name="appliedCreditBalanceAmount">If you have the Invoice Settlement feature disabled, the value of this field is the amount of the payment to apply to a credit balance. This field is only required if the &#x60;AppliedInvoiceAmount&#x60; field value is null.  If you have the Invoice Settlement feature enabled, the value of this field is created as the unapplied amount. .</param>
        /// <param name="appliedInvoiceAmount">The amount of the payment to apply to an invoice. This field is only required if either the &#x60;InvoiceId&#x60; or &#x60;InvoiceNumber&#x60; field is not null. .</param>
        /// <param name="authTransactionId">The authorization transaction ID from the payment gateway. Use this field for electronic payments, such as credit cards.  The following payment gateways support this field:   - Adyen Integration v2.0   - CyberSource 1.28   - CyberSource 1.97   - CyberSource 2.0   - Chase Paymentech Orbital   - Ingenico ePayments   - SlimPay   - Verifi Global Payment Gateway   - WePay Payment Gateway Integration .</param>
        /// <param name="comment">Additional information related to the payment. .</param>
        /// <param name="effectiveDate">The date when the payment takes effect.  **Note:** This is an optional field that only applies to electronic payments. When specified, it must be set to the date of today.  (required).</param>
        /// <param name="gateway">The name of the gateway instance that processes the payment. When creating a payment, the value of this field must be a valid gateway instance name, and this gateway must support the specific payment method. If no value is specified, the default gateway on the Account will be used. .</param>
        /// <param name="gatewayOptionData">gatewayOptionData.</param>
        /// <param name="gatewayOrderId">A merchant-specified natural key value that can be passed to the electronic payment gateway when a payment is created. If not specified, the payment number will be passed in instead.  Gateways check duplicates on the gateway order ID to ensure that the merchant do not accidentally enter the same transaction twice. This ID can also be used to do reconciliation and tie the payment to a natural key in external systems. The source of this ID varies by merchant. Some merchants use their shopping cart order IDs, and others use something different. Merchants use this ID to track transactions in their eCommerce systems. .</param>
        /// <param name="gatewayResponse">The message returned from the payment gateway for the payment. This message is gateway-dependent. .</param>
        /// <param name="gatewayResponseCode">The code returned from the payment gateway for the payment. This code is gateway-dependent. .</param>
        /// <param name="gatewayState">The status of the payment in the gateway; use for reconciliation. .</param>
        /// <param name="invoiceId">The ID of the invoice that the payment is applied to. When applying a payment to a single invoice, this field is only required if the &#x60;InvoiceNumber&#x60; field is null. .</param>
        /// <param name="invoiceNumber">The unique identification number for the invoice that the payment is applied to. When applying a payment to a single invoice, this field is only required if the &#x60;InvoiceId&#x60; field is null. .</param>
        /// <param name="invoicePaymentData">invoicePaymentData.</param>
        /// <param name="paymentMethodId">The ID of the payment method used for the payment.   For a specified credit card payment method, it is recommended that [the support for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions) for this payment method is already enabled.  (required).</param>
        /// <param name="referenceId">The transaction ID returned by the payment gateway. Use this field to reconcile payments between your gateway and Zuora Payments. .</param>
        /// <param name="softDescriptor">A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi.   Zuora passes this field to Verifi directly without verification. In general, this field will be defaulted by the gateway. For Orbital, this field contains two fields separated by an asterisk, &#x60;SDMerchantName&#x60; and &#x60;SDProductionInfo&#x60;. For more information, contact your payment gateway. .</param>
        /// <param name="softDescriptorPhone">A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi.  Verifi and Orbital determine how to format this string. For more information, contact your payment gateway. .</param>
        /// <param name="status">The status of the payment in Zuora. The only available value is &#x60;Processed&#x60;.  (required).</param>
        /// <param name="type">The type of the payment, whether the payment is external or electronic.  (required).</param>
        ...
        /// <param name="integrationStatusNS">Status of the payment&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        ...
        /// <param name="syncDateNS">Date when the payment was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        ...
        public ProxyCreatePayment(string accountId = default(string), string accountingCode = default(string), double amount = default(double), double appliedCreditBalanceAmount = default(double), decimal appliedInvoiceAmount = default(decimal), string authTransactionId = default(string), string comment = default(string), DateTime effectiveDate = default(DateTime), string gateway = default(string), ProxyCreatePaymentAllOfGatewayOptionData gatewayOptionData = default(ProxyCreatePaymentAllOfGatewayOptionData), string gatewayOrderId = default(string), string gatewayResponse = default(string), string gatewayResponseCode = default(string), GatewayStateEnum? gatewayState = default(GatewayStateEnum?), string invoiceId = default(string), string invoiceNumber = default(string), InvoicePaymentData invoicePaymentData = default(InvoicePaymentData), string paymentMethodId = default(string), string referenceId = default(string), string softDescriptor = default(string), string softDescriptorPhone = default(string), StatusEnum status = default(StatusEnum), TypeEnum type = default(TypeEnum), string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string transactionNS = default(string))
        {
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for ProxyCreatePayment and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("paymentMethodId is a required property for ProxyCreatePayment and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The unique account ID for the customer that the payment is for. </value>
        ...
        /// </summary>
        /// <value>The accounting code for the payment. Accounting codes group transactions that contain similar accounting attributes. </value>
        [DataMember(Name = "AccountingCode", EmitDefaultValue = false)]
        public string AccountingCode { get; set; }

        /// <summary>
        /// The amount of the payment.  If Invoice Settlement is enabled, this field is required. 
        /// </summary>
        /// <value>The amount of the payment.  If Invoice Settlement is enabled, this field is required. </value>
        ...
        /// </summary>
        /// <value>If you have the Invoice Settlement feature disabled, the value of this field is the amount of the payment to apply to a credit balance. This field is only required if the &#x60;AppliedInvoiceAmount&#x60; field value is null.  If you have the Invoice Settlement feature enabled, the value of this field is created as the unapplied amount. </value>
        ...
        /// </summary>
        /// <value>The amount of the payment to apply to an invoice. This field is only required if either the &#x60;InvoiceId&#x60; or &#x60;InvoiceNumber&#x60; field is not null. </value>
        [DataMember(Name = "AppliedInvoiceAmount", EmitDefaultValue = false)]
        public decimal AppliedInvoiceAmount { get; set; }

        /// <summary>
        /// The authorization transaction ID from the payment gateway. Use this field for electronic payments, such as credit cards.  The following payment gateways support this field:   - Adyen Integration v2.0   - CyberSource 1.28   - CyberSource 1.97   - CyberSource 2.0   - Chase Paymentech Orbital   - Ingenico ePayments   - SlimPay   - Verifi Global Payment Gateway   - WePay Payment Gateway Integration 
        /// </summary>
        /// <value>The authorization transaction ID from the payment gateway. Use this field for electronic payments, such as credit cards.  The following payment gateways support this field:   - Adyen Integration v2.0   - CyberSource 1.28   - CyberSource 1.97   - CyberSource 2.0   - Chase Paymentech Orbital   - Ingenico ePayments   - SlimPay   - Verifi Global Payment Gateway   - WePay Payment Gateway Integration </value>
        ...
        /// </summary>
        /// <value>Additional information related to the payment. </value>
        [DataMember(Name = "Comment", EmitDefaultValue = false)]
        public string Comment { get; set; }

        /// <summary>
        /// The date when the payment takes effect.  **Note:** This is an optional field that only applies to electronic payments. When specified, it must be set to the date of today. 
        /// </summary>
        /// <value>The date when the payment takes effect.  **Note:** This is an optional field that only applies to electronic payments. When specified, it must be set to the date of today. </value>
        ...
        /// </summary>
        /// <value>The name of the gateway instance that processes the payment. When creating a payment, the value of this field must be a valid gateway instance name, and this gateway must support the specific payment method. If no value is specified, the default gateway on the Account will be used. </value>
        ...
        /// </summary>
        /// <value>The message returned from the payment gateway for the payment. This message is gateway-dependent. </value>
        ...
        /// </summary>
        /// <value>The code returned from the payment gateway for the payment. This code is gateway-dependent. </value>
        ...
        /// </summary>
        /// <value>The ID of the invoice that the payment is applied to. When applying a payment to a single invoice, this field is only required if the &#x60;InvoiceNumber&#x60; field is null. </value>
        ...
        /// </summary>
        /// <value>The unique identification number for the invoice that the payment is applied to. When applying a payment to a single invoice, this field is only required if the &#x60;InvoiceId&#x60; field is null. </value>
        [DataMember(Name = "InvoiceNumber", EmitDefaultValue = false)]
        public string InvoiceNumber { get; set; }

        /// <summary>
        /// Gets or Sets InvoicePaymentData
        /// </summary>
        [DataMember(Name = "InvoicePaymentData", EmitDefaultValue = false)]
        public InvoicePaymentData InvoicePaymentData { get; set; }
        ...
        /// </summary>
        /// <value>The transaction ID returned by the payment gateway. Use this field to reconcile payments between your gateway and Zuora Payments. </value>
        ...
        /// </summary>
        /// <value>A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi.   Zuora passes this field to Verifi directly without verification. In general, this field will be defaulted by the gateway. For Orbital, this field contains two fields separated by an asterisk, &#x60;SDMerchantName&#x60; and &#x60;SDProductionInfo&#x60;. For more information, contact your payment gateway. </value>
        ...
        /// </summary>
        /// <value>A payment gateway-specific field that maps to Zuora for the gateways, Orbital, Vantiv and Verifi.  Verifi and Orbital determine how to format this string. For more information, contact your payment gateway. </value>
        ...
        /// </summary>
        /// <value>Status of the payment&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        /// </summary>
        /// <value>Date when the payment was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AppliedInvoiceAmount: ").Append(AppliedInvoiceAmount).Append("\n");
            ...
            sb.Append("  InvoicePaymentData: ").Append(InvoicePaymentData).Append("\n");
        ...
        {
            return this.Equals(input as ProxyCreatePayment);
        }

        /// <summary>
        /// Returns true if ProxyCreatePayment instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreatePayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreatePayment input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AppliedCreditBalanceAmount == input.AppliedCreditBalanceAmount ||
                    this.AppliedCreditBalanceAmount.Equals(input.AppliedCreditBalanceAmount)
                ) && 
                (
                    this.AppliedInvoiceAmount == input.AppliedInvoiceAmount ||
                    this.AppliedInvoiceAmount.Equals(input.AppliedInvoiceAmount)
                ) && 
                (
                    this.AuthTransactionId == input.AuthTransactionId ||
                    (this.AuthTransactionId != null &&
                    this.AuthTransactionId.Equals(input.AuthTransactionId))
                ) && 
                (
                ...
                (
                    this.GatewayOrderId == input.GatewayOrderId ||
                    (this.GatewayOrderId != null &&
                    this.GatewayOrderId.Equals(input.GatewayOrderId))
                ) && 
                (
                    this.GatewayResponse == input.GatewayResponse ||
                    (this.GatewayResponse != null &&
                    this.GatewayResponse.Equals(input.GatewayResponse))
                ) && 
                (
                    this.GatewayResponseCode == input.GatewayResponseCode ||
                    (this.GatewayResponseCode != null &&
                    this.GatewayResponseCode.Equals(input.GatewayResponseCode))
                ) && 
                (
                    this.GatewayState == input.GatewayState ||
                    this.GatewayState.Equals(input.GatewayState)
                ) && 
                (
                ...
                (
                    this.InvoicePaymentData == input.InvoicePaymentData ||
                    (this.InvoicePaymentData != null &&
                    this.InvoicePaymentData.Equals(input.InvoicePaymentData))
                ) && 
                (
                ...
                (
                    this.SoftDescriptorPhone == input.SoftDescriptorPhone ||
                    (this.SoftDescriptorPhone != null &&
                    this.SoftDescriptorPhone.Equals(input.SoftDescriptorPhone))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AppliedCreditBalanceAmount.GetHashCode();
                hashCode = (hashCode * 59) + this.AppliedInvoiceAmount.GetHashCode();
                if (this.AuthTransactionId != null)
                {
                    hashCode = (hashCode * 59) + this.AuthTransactionId.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.GatewayOrderId.GetHashCode();
                }
                if (this.GatewayResponse != null)
                {
                    hashCode = (hashCode * 59) + this.GatewayResponse.GetHashCode();
                }
                if (this.GatewayResponseCode != null)
                {
                    hashCode = (hashCode * 59) + this.GatewayResponseCode.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.GatewayState.GetHashCode();
                ...
                if (this.InvoicePaymentData != null)
                {
                    hashCode = (hashCode * 59) + this.InvoicePaymentData.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.SoftDescriptorPhone.GetHashCode();
                }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (this.AccountId != null && this.AccountId.Length > 32)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AccountId, length must be less than 32.", new [] { "AccountId" });
            }
            ...
            if (this.AccountingCode != null && this.AccountingCode.Length > 100)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AccountingCode, length must be less than 100.", new [] { "AccountingCode" });
            }

            // AccountingCode (string) minLength
            if (this.AccountingCode != null && this.AccountingCode.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AccountingCode, length must be greater than 0.", new [] { "AccountingCode" });
            }

            // AuthTransactionId (string) maxLength
            if (this.AuthTransactionId != null && this.AuthTransactionId.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AuthTransactionId, length must be less than 50.", new [] { "AuthTransactionId" });
            }

            // AuthTransactionId (string) minLength
            if (this.AuthTransactionId != null && this.AuthTransactionId.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AuthTransactionId, length must be greater than 0.", new [] { "AuthTransactionId" });
            }
            ...
            // GatewayOrderId (string) maxLength
            if (this.GatewayOrderId != null && this.GatewayOrderId.Length > 70)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GatewayOrderId, length must be less than 70.", new [] { "GatewayOrderId" });
            }

            // GatewayOrderId (string) minLength
            if (this.GatewayOrderId != null && this.GatewayOrderId.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GatewayOrderId, length must be greater than 0.", new [] { "GatewayOrderId" });
            }

            // GatewayResponse (string) maxLength
            if (this.GatewayResponse != null && this.GatewayResponse.Length > 500)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GatewayResponse, length must be less than 500.", new [] { "GatewayResponse" });
            }

            // GatewayResponse (string) minLength
            if (this.GatewayResponse != null && this.GatewayResponse.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GatewayResponse, length must be greater than 0.", new [] { "GatewayResponse" });
            }

            // GatewayResponseCode (string) maxLength
            if (this.GatewayResponseCode != null && this.GatewayResponseCode.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GatewayResponseCode, length must be less than 20.", new [] { "GatewayResponseCode" });
            }

            // GatewayResponseCode (string) minLength
            if (this.GatewayResponseCode != null && this.GatewayResponseCode.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GatewayResponseCode, length must be greater than 0.", new [] { "GatewayResponseCode" });
            }

            // InvoiceId (string) maxLength
            if (this.InvoiceId != null && this.InvoiceId.Length > 32)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InvoiceId, length must be less than 32.", new [] { "InvoiceId" });
            }

            // InvoiceId (string) minLength
            if (this.InvoiceId != null && this.InvoiceId.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InvoiceId, length must be greater than 0.", new [] { "InvoiceId" });
            }

            // InvoiceNumber (string) maxLength
            if (this.InvoiceNumber != null && this.InvoiceNumber.Length > 32)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InvoiceNumber, length must be less than 32.", new [] { "InvoiceNumber" });
            }

            // InvoiceNumber (string) minLength
            if (this.InvoiceNumber != null && this.InvoiceNumber.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for InvoiceNumber, length must be greater than 0.", new [] { "InvoiceNumber" });
            }

            // PaymentMethodId (string) maxLength
            if (this.PaymentMethodId != null && this.PaymentMethodId.Length > 32)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PaymentMethodId, length must be less than 32.", new [] { "PaymentMethodId" });
            }

            // PaymentMethodId (string) minLength
            if (this.PaymentMethodId != null && this.PaymentMethodId.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PaymentMethodId, length must be greater than 0.", new [] { "PaymentMethodId" });
            }

            // ReferenceId (string) maxLength
            if (this.ReferenceId != null && this.ReferenceId.Length > 100)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ReferenceId, length must be less than 100.", new [] { "ReferenceId" });
            }

            // ReferenceId (string) minLength
            if (this.ReferenceId != null && this.ReferenceId.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ReferenceId, length must be greater than 0.", new [] { "ReferenceId" });
            }

            // SoftDescriptor (string) maxLength
            if (this.SoftDescriptor != null && this.SoftDescriptor.Length > 35)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SoftDescriptor, length must be less than 35.", new [] { "SoftDescriptor" });
            }

            // SoftDescriptor (string) minLength
            if (this.SoftDescriptor != null && this.SoftDescriptor.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SoftDescriptor, length must be greater than 0.", new [] { "SoftDescriptor" });
            }

            // SoftDescriptorPhone (string) maxLength
            if (this.SoftDescriptorPhone != null && this.SoftDescriptorPhone.Length > 20)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SoftDescriptorPhone, length must be less than 20.", new [] { "SoftDescriptorPhone" });
            }

            // SoftDescriptorPhone (string) minLength
            if (this.SoftDescriptorPhone != null && this.SoftDescriptorPhone.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SoftDescriptorPhone, length must be greater than 0.", new [] { "SoftDescriptorPhone" });
            }
