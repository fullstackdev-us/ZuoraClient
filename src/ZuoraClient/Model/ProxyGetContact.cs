...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetContact
    /// </summary>
    [DataContract(Name = "ProxyGetContact")]
    public partial class ProxyGetContact : IEquatable<ProxyGetContact>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ProxyGetContact);
        }

        /// <summary>
        /// Returns true if ProxyGetContact instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetContact input)
        {
            if (input == null)
            {
                return false;
