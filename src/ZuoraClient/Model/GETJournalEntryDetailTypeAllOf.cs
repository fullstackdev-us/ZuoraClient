...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETJournalEntryDetailType_allOf")]
    public partial class GETJournalEntryDetailTypeAllOf : IEquatable<GETJournalEntryDetailTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETJournalEntryDetailTypeAllOf" /> class.
        /// </summary>
        /// <param name="accountingPeriodName">Name of the accounting period that the journal entry belongs to. .</param>
        /// <param name="aggregateCurrency">Returns true if the journal entry is aggregating currencies. That is, if the journal entry was created when the &#x60;Aggregate transactions with different currencies during a Journal Run&#x60; setting was configured to &#x60;Yes&#x60;. Otherwise, returns &#x60;false&#x60;. .</param>
        ...
        public GETJournalEntryDetailTypeAllOf(string accountingPeriodName = default(string), bool aggregateCurrency = default(bool), string currency = default(string), string homeCurrency = default(string), DateTime journalEntryDate = default(DateTime), List<GETJournalEntryItemType> journalEntryItems = default(List<GETJournalEntryItemType>), string notes = default(string), string number = default(string), List<GETJournalEntrySegmentType> segments = default(List<GETJournalEntrySegmentType>), StatusEnum? status = default(StatusEnum?), bool success = default(bool), DateTime timePeriodEnd = default(DateTime), DateTime timePeriodStart = default(DateTime), string transactionType = default(string), DateTime transferDateTime = default(DateTime), string transferredBy = default(string), TransferredToAccountingEnum? transferredToAccounting = default(TransferredToAccountingEnum?))
        {
        ...
        /// </summary>
        /// <value>Returns true if the journal entry is aggregating currencies. That is, if the journal entry was created when the &#x60;Aggregate transactions with different currencies during a Journal Run&#x60; setting was configured to &#x60;Yes&#x60;. Otherwise, returns &#x60;false&#x60;. </value>
        ...
        {
            return this.Equals(input as GETJournalEntryDetailTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETJournalEntryDetailTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETJournalEntryDetailTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETJournalEntryDetailTypeAllOf input)
        {
            if (input == null)
            {
                return false;
