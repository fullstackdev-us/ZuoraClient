...
namespace ZuoraClient.Model
{
    ...
    /// InvoiceItems1
    /// </summary>
    [DataContract(Name = "invoiceItems_1")]
    public partial class InvoiceItems1 : IEquatable<InvoiceItems1>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceItems1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvoiceItems1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceItems1" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InvoiceItems1);
        }

        /// <summary>
        /// Returns true if InvoiceItems1 instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceItems1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceItems1 input)
        {
            if (input == null)
            {
                return false;
