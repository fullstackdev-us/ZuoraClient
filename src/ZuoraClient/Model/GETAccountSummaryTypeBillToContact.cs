...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountSummaryTypeBillToContact")]
    public partial class GETAccountSummaryTypeBillToContact : IEquatable<GETAccountSummaryTypeBillToContact>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GETAccountSummaryTypeBillToContact);
        }

        /// <summary>
        /// Returns true if GETAccountSummaryTypeBillToContact instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountSummaryTypeBillToContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountSummaryTypeBillToContact input)
        {
            if (input == null)
            {
                return false;
