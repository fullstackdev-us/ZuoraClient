# ZuoraClient.Api.PaymentTransactionLogsApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**ObjectGETPaymentTransactionLog**](PaymentTransactionLogsApi.md#objectgetpaymenttransactionlog) | **GET** /v1/object/payment-transaction-log/{id} | CRUD: Retrieve a payment transaction log |

<a name="objectgetpaymenttransactionlog"></a>
# **ObjectGETPaymentTransactionLog**
> ProxyGetPaymentTransactionLog ObjectGETPaymentTransactionLog (string id, string authorization = null, string zuoraEntityIds = null, string zuoraTrackId = null)
...
namespace Example
{
    public class ObjectGETPaymentTransactionLogExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            config.BasePath = "https://rest.zuora.com";
            var apiInstance = new PaymentTransactionLogsApi(config);
            var id = "id_example";  // string | The ID of a payment transaction log. 
            ...
            {
                // CRUD: Retrieve a payment transaction log
                ProxyGetPaymentTransactionLog result = apiInstance.ObjectGETPaymentTransactionLog(id, authorization, zuoraEntityIds, zuoraTrackId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling PaymentTransactionLogsApi.ObjectGETPaymentTransactionLog: " + e.Message);
...
#### Using the ObjectGETPaymentTransactionLogWithHttpInfo variant
...
{
    // CRUD: Retrieve a payment transaction log
    ApiResponse<ProxyGetPaymentTransactionLog> response = apiInstance.ObjectGETPaymentTransactionLogWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId);
...
{
    Debug.Print("Exception when calling PaymentTransactionLogsApi.ObjectGETPaymentTransactionLogWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
