...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountTypeBasicInfo_allOf")]
    public partial class GETAccountTypeBasicInfoAllOf : IEquatable<GETAccountTypeBasicInfoAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountTypeBasicInfoAllOf" /> class.
        /// </summary>
        /// <param name="accountNumber">Account number. .</param>
        /// <param name="batch">The alias name given to a batch. A string of 50 characters or less. .</param>
        /// <param name="communicationProfileId">ID of a communication profile. .</param>
        ...
        /// <param name="sequenceSetId">The ID of the billing document sequence set that is assigned to the customer account.  .</param>
        /// <param name="status">Account status; possible values are: &#x60;Active&#x60;, &#x60;Draft&#x60;, &#x60;Canceled&#x60;. .</param>
        /// <param name="tags">tags.</param>
        public GETAccountTypeBasicInfoAllOf(string accountNumber = default(string), string batch = default(string), string communicationProfileId = default(string), string creditMemoTemplateId = default(string), string crmId = default(string), string debitMemoTemplateId = default(string), string id = default(string), string invoiceTemplateId = default(string), string name = default(string), string notes = default(string), string parentId = default(string), string salesRep = default(string), string sequenceSetId = default(string), string status = default(string), string tags = default(string))
        {
        ...
        /// </summary>
        /// <value>ID of a communication profile. </value>
        ...
        /// </summary>
        /// <value>The ID of the billing document sequence set that is assigned to the customer account.  </value>
        ...
        {
            return this.Equals(input as GETAccountTypeBasicInfoAllOf);
        }

        /// <summary>
        /// Returns true if GETAccountTypeBasicInfoAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountTypeBasicInfoAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountTypeBasicInfoAllOf input)
        {
            if (input == null)
            {
                return false;
