...
namespace ZuoraClient.Model
{
    ...
    /// GETDMTaxItemType
    /// </summary>
    [DataContract(Name = "GETDMTaxItemType")]
    public partial class GETDMTaxItemType : IEquatable<GETDMTaxItemType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETDMTaxItemType" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETDMTaxItemType);
        }

        /// <summary>
        /// Returns true if GETDMTaxItemType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETDMTaxItemType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETDMTaxItemType input)
        {
            if (input == null)
            {
                return false;
