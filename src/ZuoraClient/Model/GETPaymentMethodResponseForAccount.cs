...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETPaymentMethodResponseForAccount")]
    public partial class GETPaymentMethodResponseForAccount : IEquatable<GETPaymentMethodResponseForAccount>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETPaymentMethodResponseForAccount" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETPaymentMethodResponseForAccount);
        }

        /// <summary>
        /// Returns true if GETPaymentMethodResponseForAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of GETPaymentMethodResponseForAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPaymentMethodResponseForAccount input)
        {
            if (input == null)
            {
                return false;
