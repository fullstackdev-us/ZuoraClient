...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTAccountType_allOf")]
    public partial class POSTAccountTypeAllOf : IEquatable<POSTAccountTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountTypeAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTAccountTypeAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTAccountTypeAllOf" /> class.
        /// </summary>
        ...
        /// <param name="additionalEmailAddresses">A list of additional email addresses to receive email notifications. Use commas to separate email addresses. .</param>
        ...
        /// <param name="autoPay">Whether future payments are to be automatically billed when they are due.   - If this field is set to &#x60;true&#x60;, you must specify either the &#x60;creditCard&#x60; field or the &#x60;hpmCreditCardPaymentMethodId&#x60; field, but not both. - If this field is set to &#x60;false&#x60;, you can specify neither the &#x60;creditCard&#x60; field nor the &#x60;hpmCreditCardPaymentMethodId&#x60; field. .</param>
        ...
        /// <param name="communicationProfileId">The ID of a communication profile.          .</param>
        ...
        /// <param name="invoiceDeliveryPrefsEmail">Whether the customer wants to receive invoices through email.   (default to false).</param>
        /// <param name="invoiceDeliveryPrefsPrint">Whether the customer wants to receive printed invoices, such as through postal mail.  (default to false).</param>
        /// <param name="invoiceTargetDate">**Note:** This field has been replaced by the &#x60;targetDate&#x60; field. The &#x60;invoiceTargetDate&#x60; field is only available for backward compatibility.     Date through which to calculate charges if an invoice is generated, as yyyy-mm-dd. Default is current date.   This field is in REST API minor version control. To use this field in the method, you can set the &#x60;zuora-version&#x60; parameter to the minor version number in the request header. Supported minor versions are &#x60;207.0&#x60; and earlier.  .</param>
        /// <param name="invoiceTemplateId">Invoice template ID, configured in Billing Settings in the Zuora UI. .</param>
        ...
        /// <param name="parentId">Identifier of the parent customer account for this Account object. The length is 32 characters. Use this field if you have customer hierarchy enabled..</param>
        ...
        /// <param name="salesRep">The name of the sales representative associated with this account, if applicable. Maximum of 50 characters..</param>
        /// <param name="sequenceSetId">The ID of the billing document sequence set to assign to the customer account.   The billing documents to generate for this account will adopt the prefix and starting document number configured in the sequence set.  If a customer account has no assigned billing document sequence set, billing documents generated for this account adopt the prefix and starting document number from the default sequence set. .</param>
        /// <param name="soldToContact">soldToContact.</param>
        /// <param name="soldToSameAsBillTo">Whether the sold-to contact and bill-to contact are the same entity.   The created account has the same bill-to contact and sold-to contact entity only when all the following conditions are met in the request body:  - This field is set to &#x60;true&#x60;.  - A bill-to contact is specified. - No sold-to contact is specified. .</param>
        ...
        public POSTAccountTypeAllOf(string accountNumber = default(string), List<string> additionalEmailAddresses = default(List<string>), List<string> applicationOrder = default(List<string>), bool applyCredit = default(bool), bool applyCreditBalance = default(bool), bool autoPay = default(bool), string batch = default(string), long billCycleDay = default(long), POSTAccountTypeBillToContact billToContact = default(POSTAccountTypeBillToContact), bool collect = true, string communicationProfileId = default(string), POSTAccountTypeCreditCard creditCard = default(POSTAccountTypeCreditCard), string creditMemoReasonCode = default(string), string creditMemoTemplateId = default(string), string crmId = default(string), string currency = default(string), string debitMemoTemplateId = default(string), DateTime documentDate = default(DateTime), string hpmCreditCardPaymentMethodId = default(string), bool invoice = true, bool invoiceCollect = true, bool invoiceDeliveryPrefsEmail = false, bool invoiceDeliveryPrefsPrint = false, DateTime invoiceTargetDate = default(DateTime), string invoiceTemplateId = default(string), string name = default(string), string notes = default(string), string parentId = default(string), string paymentGateway = default(string), POSTAccountTypePaymentMethod paymentMethod = default(POSTAccountTypePaymentMethod), string paymentTerm = default(string), bool runBilling = true, string salesRep = default(string), string sequenceSetId = default(string), POSTAccountTypeSoldToContact soldToContact = default(POSTAccountTypeSoldToContact), bool soldToSameAsBillTo = default(bool), POSTAccountTypeSubscription subscription = default(POSTAccountTypeSubscription), string tagging = default(string), DateTime targetDate = default(DateTime), POSTAccountTypeAllOfTaxInfo taxInfo = default(POSTAccountTypeAllOfTaxInfo))
        {
            // to ensure "billToContact" is required (not null)
            if (billToContact == null)
            {
                throw new ArgumentNullException("billToContact is a required property for POSTAccountTypeAllOf and cannot be null");
            }
            this.BillToContact = billToContact;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for POSTAccountTypeAllOf and cannot be null");
            }
            this.Currency = currency;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for POSTAccountTypeAllOf and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>A list of additional email addresses to receive email notifications. Use commas to separate email addresses. </value>
        ...
        /// </summary>
        /// <value>Whether future payments are to be automatically billed when they are due.   - If this field is set to &#x60;true&#x60;, you must specify either the &#x60;creditCard&#x60; field or the &#x60;hpmCreditCardPaymentMethodId&#x60; field, but not both. - If this field is set to &#x60;false&#x60;, you can specify neither the &#x60;creditCard&#x60; field nor the &#x60;hpmCreditCardPaymentMethodId&#x60; field. </value>
        ...
        /// </summary>
        /// <value>The ID of a communication profile.          </value>
        ...
        /// </summary>
        /// <value>A currency as defined in Billing Settings in the Zuora UI.  For payment method authorization, if the &#x60;paymentMethod&#x60; &gt; &#x60;currencyCode&#x60; field is specified, &#x60;currencyCode&#x60; is used. Otherwise, this &#x60;currency&#x60; field is used for payment method authorization. If no currency is specified for the account, the default currency of the account is then used. </value>
        ...
        /// </summary>
        /// <value>**Note:** This field has been replaced by the &#x60;runBilling&#x60; field. The &#x60;invoice&#x60; field is only available for backward compatibility.   Creates an invoice for a subscription. The invoice generated in this operation is only for this subscription, not for the entire customer account.  If the value is &#x60;true&#x60;, an invoice is created. If the value is &#x60;false&#x60;, no action is taken.  **Note**: This field is only available if you set the &#x60;zuora-version&#x60; request header to &#x60;196.0&#x60; or &#x60;207.0&#x60;. </value>
        ...
        /// </summary>
        /// <value>Whether the customer wants to receive invoices through email.  </value>
        ...
        /// </summary>
        /// <value>Whether the customer wants to receive printed invoices, such as through postal mail. </value>
        ...
        /// </summary>
        /// <value>**Note:** This field has been replaced by the &#x60;targetDate&#x60; field. The &#x60;invoiceTargetDate&#x60; field is only available for backward compatibility.     Date through which to calculate charges if an invoice is generated, as yyyy-mm-dd. Default is current date.   This field is in REST API minor version control. To use this field in the method, you can set the &#x60;zuora-version&#x60; parameter to the minor version number in the request header. Supported minor versions are &#x60;207.0&#x60; and earlier.  </value>
        ...
        /// </summary>
        /// <value>Invoice template ID, configured in Billing Settings in the Zuora UI. </value>
        ...
        /// </summary>
        /// <value>Identifier of the parent customer account for this Account object. The length is 32 characters. Use this field if you have customer hierarchy enabled.</value>
        ...
        public POSTAccountTypePaymentMethod PaymentMethod { get; set; }
        ...
        /// </summary>
        /// <value>The name of the sales representative associated with this account, if applicable. Maximum of 50 characters.</value>
        ...
        /// </summary>
        /// <value>The ID of the billing document sequence set to assign to the customer account.   The billing documents to generate for this account will adopt the prefix and starting document number configured in the sequence set.  If a customer account has no assigned billing document sequence set, billing documents generated for this account adopt the prefix and starting document number from the default sequence set. </value>
        [DataMember(Name = "sequenceSetId", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Whether the sold-to contact and bill-to contact are the same entity.   The created account has the same bill-to contact and sold-to contact entity only when all the following conditions are met in the request body:  - This field is set to &#x60;true&#x60;.  - A bill-to contact is specified. - No sold-to contact is specified. </value>
        [DataMember(Name = "soldToSameAsBillTo", EmitDefaultValue = true)]
        public bool SoldToSameAsBillTo { get; set; }
        ...
        public POSTAccountTypeAllOfTaxInfo TaxInfo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SoldToSameAsBillTo: ").Append(SoldToSameAsBillTo).Append("\n");
        ...
        {
            return this.Equals(input as POSTAccountTypeAllOf);
        }

        /// <summary>
        /// Returns true if POSTAccountTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTAccountTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTAccountTypeAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    input.AdditionalEmailAddresses != null &&
                ...
                (
                    this.SequenceSetId == input.SequenceSetId ||
                    (this.SequenceSetId != null &&
                    this.SequenceSetId.Equals(input.SequenceSetId))
                ) && 
                (
                ...
                (
                    this.SoldToSameAsBillTo == input.SoldToSameAsBillTo ||
                    this.SoldToSameAsBillTo.Equals(input.SoldToSameAsBillTo)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SequenceSetId.GetHashCode();
                }
                if (this.SoldToContact != null)
                {
                    hashCode = (hashCode * 59) + this.SoldToContact.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.SoldToSameAsBillTo.GetHashCode();
