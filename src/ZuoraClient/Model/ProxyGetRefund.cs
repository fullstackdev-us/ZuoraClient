...
namespace ZuoraClient.Model
{
    ...
    /// ProxyGetRefund
    /// </summary>
    [DataContract(Name = "ProxyGetRefund")]
    public partial class ProxyGetRefund : IEquatable<ProxyGetRefund>, IValidatableObject
    {
        ...
        /// <param name="paymentId"> The unique ID of the payment associated with this refund. Don&#39;t specify a value for this field if you&#39;re creating an electronic non-referenced refund. **Character limit**: 32 **Values**: a valid payment ID .</param>
        ...
        /// <param name="referenceID"> The transaction ID returned by the payment gateway for an electronic refund. Use this field to reconcile refunds between your gateway and Zuora Payments. **Character limit**: 60 **Values**: a string of 60 characters or fewer .</param>
        /// <param name="refundDate"> The date of the refund, in &#x60;yyyy-mm-dd&#x60; format. The date of the refund cannot be before the payment date. Specify this field only for external refunds. Zuora automatically generates this field for electronic refunds. **Character limit**: 29 .</param>
        ...
        /// <param name="secondRefundReferenceId"> The transaction ID returned by the payment gateway if there is an additional transaction for the payment. Use this field to reconcile payments between your gateway and Zuora Payments. **Character limit**: 60 **Values**: a string of 60 characters or fewer .</param>
        ...
        public ProxyGetRefund(string accountId = default(string), string accountingCode = default(string), double amount = default(double), DateTime cancelledOn = default(DateTime), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), string gateway = default(string), string gatewayResponse = default(string), string gatewayResponseCode = default(string), string gatewayState = default(string), string id = default(string), DateTime markedForSubmissionOn = default(DateTime), string methodType = default(string), Object paymentId = default(Object), string paymentMethodId = default(string), string paymentMethodSnapshotId = default(string), string reasonCode = default(string), string referenceID = default(string), DateTime refundDate = default(DateTime), string refundNumber = default(string), DateTime refundTransactionTime = default(DateTime), string secondRefundReferenceId = default(string), DateTime settledOn = default(DateTime), string softDescriptor = default(string), string softDescriptorPhone = default(string), string sourceType = default(string), string status = default(string), DateTime submittedOn = default(DateTime), string transferredToAccounting = default(string), string type = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string synctoNetSuiteNS = default(string))
        {
        ...
        /// </summary>
        /// <value> The ID of the account associated with this refund. Specify a value for this field only if you&#39;re creating an electronic non-referenced refund. Don&#39;t specify a value for any other type of refund; Zuora associates the refund automatically with the account from the associated payment. **Character limit**: 32 **Values**: a valid account ID </value>
        ...
        /// </summary>
        /// <value> The amount of the refund. The amount can&#39;t exceed the amount of the associated payment. If the original payment was applied to a single invoice, you can create a partial refund by specifying an amount in this field or through the UI. If the payment was applied to multiple invoices, you can create a partial refund by using the &#x60;RefundInvoicePaymentData&#x60; field of this operation or through the UI. **Character limit**: 16 **Values**: a valid currency amount </value>
        ...
        /// <summary>
        ///  The unique ID of the payment associated with this refund. Don&#39;t specify a value for this field if you&#39;re creating an electronic non-referenced refund. **Character limit**: 32 **Values**: a valid payment ID 
        /// </summary>
        /// <value> The unique ID of the payment associated with this refund. Don&#39;t specify a value for this field if you&#39;re creating an electronic non-referenced refund. **Character limit**: 32 **Values**: a valid payment ID </value>
        ...
        /// </summary>
        /// <value> The transaction ID returned by the payment gateway for an electronic refund. Use this field to reconcile refunds between your gateway and Zuora Payments. **Character limit**: 60 **Values**: a string of 60 characters or fewer </value>
        ...
        /// </summary>
        /// <value> The date of the refund, in &#x60;yyyy-mm-dd&#x60; format. The date of the refund cannot be before the payment date. Specify this field only for external refunds. Zuora automatically generates this field for electronic refunds. **Character limit**: 29 </value>
        ...
        /// </summary>
        /// <value> The transaction ID returned by the payment gateway if there is an additional transaction for the payment. Use this field to reconcile payments between your gateway and Zuora Payments. **Character limit**: 60 **Values**: a string of 60 characters or fewer </value>
        ...
        {
            return this.Equals(input as ProxyGetRefund);
        }

        /// <summary>
        /// Returns true if ProxyGetRefund instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyGetRefund to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyGetRefund input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RefundNumber == input.RefundNumber ||
                    (this.RefundNumber != null &&
                    this.RefundNumber.Equals(input.RefundNumber))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.RefundNumber.GetHashCode();
                }
