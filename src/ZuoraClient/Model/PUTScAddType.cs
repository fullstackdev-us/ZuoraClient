...
namespace ZuoraClient.Model
{
    ...
    /// PUTScAddType
    /// </summary>
    [DataContract(Name = "PUTScAddType")]
    public partial class PUTScAddType : IEquatable<PUTScAddType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PUTScAddType);
        }

        /// <summary>
        /// Returns true if PUTScAddType instances are equal
        /// </summary>
        /// <param name="input">Instance of PUTScAddType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PUTScAddType input)
        {
            if (input == null)
            {
                return false;
