# ZuoraClient.Api.CommunicationProfilesApi

All URIs are relative to *https://rest.zuora.com*

| Method | HTTP request | Description |
|--------|--------------|-------------|
| [**ObjectGETCommunicationProfile**](CommunicationProfilesApi.md#objectgetcommunicationprofile) | **GET** /v1/object/communication-profile/{id} | CRUD: Retrieve a communication profile |

<a name="objectgetcommunicationprofile"></a>
# **ObjectGETCommunicationProfile**
> ProxyGetCommunicationProfile ObjectGETCommunicationProfile (string id, string authorization = null, string zuoraEntityIds = null, string zuoraTrackId = null, string fields = null)
...
namespace Example
{
    public class ObjectGETCommunicationProfileExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            config.BasePath = "https://rest.zuora.com";
            var apiInstance = new CommunicationProfilesApi(config);
            ...
            {
                // CRUD: Retrieve a communication profile
                ProxyGetCommunicationProfile result = apiInstance.ObjectGETCommunicationProfile(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling CommunicationProfilesApi.ObjectGETCommunicationProfile: " + e.Message);
...
#### Using the ObjectGETCommunicationProfileWithHttpInfo variant
...
{
    // CRUD: Retrieve a communication profile
    ApiResponse<ProxyGetCommunicationProfile> response = apiInstance.ObjectGETCommunicationProfileWithHttpInfo(id, authorization, zuoraEntityIds, zuoraTrackId, fields);
...
{
    Debug.Print("Exception when calling CommunicationProfilesApi.ObjectGETCommunicationProfileWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
