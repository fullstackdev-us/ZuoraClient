...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostNonRefRefundType")]
    public partial class PostNonRefRefundType : IEquatable<PostNonRefRefundType>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>How an external refund was issued to a customer. This field is required for an external refund and must be left empty for an electronic refund. You can issue an external refund on a credit memo. </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNonRefRefundType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostNonRefRefundType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNonRefRefundType" /> class.
        /// </summary>
        /// <param name="comment">Comments about the refund. .</param>
        /// <param name="financeInformation">financeInformation.</param>
        /// <param name="gatewayId">The ID of the gateway instance that processes the refund. This field can be specified only for electronic refunds. The ID must be a valid gateway instance ID, and this gateway must support the specific payment method.   If no gateway ID is specified, the default gateway in the billing account configuration will be used. If no gateway is specified in the billing account, the default gateway of the corresponding tenant will be used. .</param>
        /// <param name="gatewayOptions">gatewayOptions.</param>
        /// <param name="items">Container for credit memo items. The maximum number of items is 1,000.  **Note:** This field is only available if you have the [Invoice Item Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/C_Invoice_Item_Settlement) feature enabled. Invoice Item Settlement must be used together with other Invoice Settlement features (Unapplied Payments, and Credit and Debit memos).  If you wish to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. .</param>
        /// <param name="methodType">How an external refund was issued to a customer. This field is required for an external refund and must be left empty for an electronic refund. You can issue an external refund on a credit memo. .</param>
        /// <param name="paymentMethodId">The ID of the payment method used for the refund. This field is required for an electronic refund, and the value must be an electronic payment method ID. This field must be left empty for an external refund.  .</param>
        /// <param name="reasonCode">A code identifying the reason for the transaction. The value must be an existing reason code or empty. If you do not specify a value, Zuora uses the default reason code. .</param>
        ...
        /// <param name="refundDate">The date when the refund takes effect, in &#x60;yyyy-mm-dd&#x60; format. The date of the refund cannot be before the credit memo date. Specify this field only for external refunds. Zuora automatically generates this field for electronic refunds. .</param>
        ...
        /// <param name="totalAmount">The total amount of the refund. The amount cannot exceed the unapplied amount of the associated credit memo. If the original credit memo was applied to one or more invoices or debit memos, you have to unapply a full or partial credit memo from the invoices or debit memos, and then refund the full or partial unapplied credit memo to your customers.  (required).</param>
        /// <param name="type">The type of the refund.  (required).</param>
        ...
        public PostNonRefRefundType(string comment = default(string), PostNonRefRefundTypeAllOfFinanceInformation financeInformation = default(PostNonRefRefundTypeAllOfFinanceInformation), string gatewayId = default(string), PostNonRefRefundTypeAllOfGatewayOptions gatewayOptions = default(PostNonRefRefundTypeAllOfGatewayOptions), List<RefundCreditMemoItemType> items = default(List<RefundCreditMemoItemType>), MethodTypeEnum? methodType = default(MethodTypeEnum?), string paymentMethodId = default(string), string reasonCode = default(string), string referenceId = default(string), DateTime refundDate = default(DateTime), string secondRefundReferenceId = default(string), string softDescriptor = default(string), string softDescriptorPhone = default(string), double totalAmount = default(double), TypeEnum type = default(TypeEnum), string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string synctoNetSuiteNS = default(string))
        {
        ...
        public PostNonRefRefundTypeAllOfFinanceInformation FinanceInformation { get; set; }
        ...
        /// </summary>
        /// <value>The ID of the gateway instance that processes the refund. This field can be specified only for electronic refunds. The ID must be a valid gateway instance ID, and this gateway must support the specific payment method.   If no gateway ID is specified, the default gateway in the billing account configuration will be used. If no gateway is specified in the billing account, the default gateway of the corresponding tenant will be used. </value>
        ...
        public PostNonRefRefundTypeAllOfGatewayOptions GatewayOptions { get; set; }
        ...
        /// </summary>
        /// <value>Container for credit memo items. The maximum number of items is 1,000.  **Note:** This field is only available if you have the [Invoice Item Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/C_Invoice_Item_Settlement) feature enabled. Invoice Item Settlement must be used together with other Invoice Settlement features (Unapplied Payments, and Credit and Debit memos).  If you wish to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. </value>
        [DataMember(Name = "items", EmitDefaultValue = false)]
        public List<RefundCreditMemoItemType> Items { get; set; }
        ...
        /// </summary>
        /// <value>The ID of the payment method used for the refund. This field is required for an electronic refund, and the value must be an electronic payment method ID. This field must be left empty for an external refund.  </value>
        ...
        /// </summary>
        /// <value>A code identifying the reason for the transaction. The value must be an existing reason code or empty. If you do not specify a value, Zuora uses the default reason code. </value>
        ...
        /// </summary>
        /// <value>The date when the refund takes effect, in &#x60;yyyy-mm-dd&#x60; format. The date of the refund cannot be before the credit memo date. Specify this field only for external refunds. Zuora automatically generates this field for electronic refunds. </value>
        ...
        /// </summary>
        /// <value>The total amount of the refund. The amount cannot exceed the unapplied amount of the associated credit memo. If the original credit memo was applied to one or more invoices or debit memos, you have to unapply a full or partial credit memo from the invoices or debit memos, and then refund the full or partial unapplied credit memo to your customers. </value>
        [DataMember(Name = "totalAmount", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as PostNonRefRefundType);
        }

        /// <summary>
        /// Returns true if PostNonRefRefundType instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNonRefRefundType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNonRefRefundType input)
        {
            if (input == null)
            {
                return false;
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            // SecondRefundReferenceId (string) maxLength
            if (this.SecondRefundReferenceId != null && this.SecondRefundReferenceId.Length > 100)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SecondRefundReferenceId, length must be less than 100.", new [] { "SecondRefundReferenceId" });
            }

            // SecondRefundReferenceId (string) minLength
            if (this.SecondRefundReferenceId != null && this.SecondRefundReferenceId.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SecondRefundReferenceId, length must be greater than 0.", new [] { "SecondRefundReferenceId" });
            }
