...
namespace ZuoraClient.Model
{
    ...
    /// GETRSDetailType
    /// </summary>
    [DataContract(Name = "GETRSDetailType")]
    public partial class GETRSDetailType : IEquatable<GETRSDetailType>, IValidatableObject
    {
        ...
        public GETRSDetailType(string accountId = default(string), decimal amount = default(decimal), DateTime createdOn = default(DateTime), string currency = default(string), string linkedTransactionId = default(string), string linkedTransactionNumber = default(string), string linkedTransactionType = default(string), string notes = default(string), string number = default(string), string recognitionRuleName = default(string), decimal recognizedRevenue = default(decimal), string referenceId = default(string), List<GETRsRevenueItemType> revenueItems = default(List<GETRsRevenueItemType>), DateTime revenueScheduleDate = default(DateTime), string subscriptionChargeId = default(string), string subscriptionId = default(string), bool success = default(bool), decimal undistributedUnrecognizedRevenue = default(decimal), decimal unrecognizedRevenue = default(decimal), DateTime updatedOn = default(DateTime))
        {
        ...
        {
            return this.Equals(input as GETRSDetailType);
        }

        /// <summary>
        /// Returns true if GETRSDetailType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRSDetailType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRSDetailType input)
        {
            if (input == null)
            {
                return false;
