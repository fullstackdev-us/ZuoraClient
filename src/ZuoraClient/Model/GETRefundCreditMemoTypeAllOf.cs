...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRefundCreditMemoType_allOf")]
    public partial class GETRefundCreditMemoTypeAllOf : IEquatable<GETRefundCreditMemoTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRefundCreditMemoTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETRefundCreditMemoTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETRefundCreditMemoTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRefundCreditMemoTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRefundCreditMemoTypeAllOf input)
        {
            if (input == null)
            {
                return false;
