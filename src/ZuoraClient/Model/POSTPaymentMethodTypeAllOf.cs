...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTPaymentMethodType_allOf")]
    public partial class POSTPaymentMethodTypeAllOf : IEquatable<POSTPaymentMethodTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="expirationMonth">One or two digits expiration month (1-12).  (required).</param>
        ...
        public POSTPaymentMethodTypeAllOf(string accountKey = default(string), CreatePaymentMethodCardholderInfo cardHolderInfo = default(CreatePaymentMethodCardholderInfo), string creditCardNumber = default(string), string creditCardType = default(string), bool defaultPaymentMethod = default(bool), int expirationMonth = default(int), int expirationYear = default(int), CreatePaymentMethodCommonGatewayOptions gatewayOptions = default(CreatePaymentMethodCommonGatewayOptions), string mitConsentAgreementRef = default(string), MitConsentAgreementSrcEnum? mitConsentAgreementSrc = default(MitConsentAgreementSrcEnum?), string mitNetworkTransactionId = default(string), MitProfileActionEnum? mitProfileAction = default(MitProfileActionEnum?), DateTime mitProfileAgreedOn = default(DateTime), MitProfileTypeEnum? mitProfileType = default(MitProfileTypeEnum?), int numConsecutiveFailures = default(int), string securityCode = default(string))
        {
            // to ensure "creditCardNumber" is required (not null)
            if (creditCardNumber == null)
            {
                throw new ArgumentNullException("creditCardNumber is a required property for POSTPaymentMethodTypeAllOf and cannot be null");
            }
            this.CreditCardNumber = creditCardNumber;
            // to ensure "creditCardType" is required (not null)
            if (creditCardType == null)
            {
                throw new ArgumentNullException("creditCardType is a required property for POSTPaymentMethodTypeAllOf and cannot be null");
            }
        ...
        /// </summary>
        /// <value>ID of the customer account. To create an orphan payment method that is not associated with any customer account, you do not need to specify this field during creation. However, you must associate the orphan payment method with a customer account within 10 days. Otherwise, this orphan payment method will be deleted.</value>
        ...
        [DataMember(Name = "creditCardNumber", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "creditCardType", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "defaultPaymentMethod", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "expirationMonth", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "expirationYear", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class POSTPaymentMethodTypeAllOf {\n");
        ...
        {
            return this.Equals(input as POSTPaymentMethodTypeAllOf);
        }

        /// <summary>
        /// Returns true if POSTPaymentMethodTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTPaymentMethodTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTPaymentMethodTypeAllOf input)
        {
            if (input == null)
            {
                return false;
