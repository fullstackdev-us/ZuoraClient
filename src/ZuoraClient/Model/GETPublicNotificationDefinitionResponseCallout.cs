...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETPublicNotificationDefinitionResponse_callout")]
    public partial class GETPublicNotificationDefinitionResponseCallout : IEquatable<GETPublicNotificationDefinitionResponseCallout>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETPublicNotificationDefinitionResponseCallout" /> class.
        /// </summary>
        /// <param name="active">The status of the callout. The default value is &#x60;true&#x60;. (default to true).</param>
        /// <param name="calloutAuth">calloutAuth.</param>
        /// <param name="calloutBaseurl">The callout URL. It must start with &#39;https://&#39;.</param>
        ...
        /// <param name="eventTypeName">The name of the custom event type..</param>
        /// <param name="httpMethod">The HTTP method of the callout..</param>
        /// <param name="id">The ID of the callout. If &#x60;calloutActive&#x60; is &#x60;true&#x60;, a callout is required. The eventTypeName of the callout MUST be the same as the eventTypeName..</param>
        /// <param name="name">The name of the created callout..</param>
        /// <param name="requiredAuth">Specifies whether the callout requires auth..</param>
        public GETPublicNotificationDefinitionResponseCallout(bool active = true, CalloutAuth calloutAuth = default(CalloutAuth), string calloutBaseurl = default(string), Dictionary<string, string> calloutParams = default(Dictionary<string, string>), bool calloutRetry = true, string description = default(string), string eventTypeName = default(string), HttpMethodEnum? httpMethod = default(HttpMethodEnum?), Guid id = default(Guid), string name = default(string), bool requiredAuth = default(bool))
        {
            this.Active = active;
        ...
        /// </summary>
        /// <value>The status of the callout. The default value is &#x60;true&#x60;.</value>
        ...
        [DataMember(Name = "calloutBaseurl", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The name of the custom event type.</value>
        ...
        /// </summary>
        /// <value>The ID of the callout. If &#x60;calloutActive&#x60; is &#x60;true&#x60;, a callout is required. The eventTypeName of the callout MUST be the same as the eventTypeName.</value>
        ...
        [DataMember(Name = "requiredAuth", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as GETPublicNotificationDefinitionResponseCallout);
        }

        /// <summary>
        /// Returns true if GETPublicNotificationDefinitionResponseCallout instances are equal
        /// </summary>
        /// <param name="input">Instance of GETPublicNotificationDefinitionResponseCallout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETPublicNotificationDefinitionResponseCallout input)
        {
            if (input == null)
            {
                return false;
