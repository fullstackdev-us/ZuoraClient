...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETRefundPaymentType")]
    public partial class GETRefundPaymentType : IEquatable<GETRefundPaymentType>, IValidatableObject
    {
        /// <summary>
        /// The status of the refund in the gateway. 
        /// </summary>
        /// <value>The status of the refund in the gateway. </value>
        ...
        /// </summary>
        /// <value>How an external refund was issued to a customer. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum MethodTypeEnum
        {
            ...
            CreditCardReferenceTransaction = 8,
        ...
        /// </summary>
        /// <value>The status of the refund. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETRefundPaymentType" /> class.
        /// </summary>
        /// <param name="accountId">The ID of the account associated with this refund. Zuora associates the refund automatically with the account from the associated payment. .</param>
        /// <param name="amount">The total amount of the refund. .</param>
        /// <param name="cancelledOn">The date and time when the refund was cancelled, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format.  .</param>
        /// <param name="comment">Comments about the refund. .</param>
        /// <param name="createdById">The ID of the Zuora user who created the refund. .</param>
        /// <param name="createdDate">The date and time when the refund was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10.  .</param>
        /// <param name="creditMemoId">The ID of the credit memo associated with the refund. .</param>
        /// <param name="financeInformation">financeInformation.</param>
        /// <param name="gatewayId">The ID of the gateway instance that processes the refund. .</param>
        ...
        /// <param name="gatewayResponse">The message returned from the payment gateway for the refund. This message is gateway-dependent. .</param>
        /// <param name="gatewayResponseCode">The code returned from the payment gateway for the refund. This code is gateway-dependent. .</param>
        /// <param name="gatewayState">The status of the refund in the gateway. .</param>
        /// <param name="id">The ID of the created refund. .</param>
        /// <param name="markedForSubmissionOn">The date and time when a refund was marked and waiting for batch submission to the payment process, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        /// <param name="methodType">How an external refund was issued to a customer. .</param>
        /// <param name="number">The unique identification number of the refund. .</param>
        /// <param name="paymentId">The ID of the payment that is refunded. .</param>
        /// <param name="paymentMethodId">The unique ID of the payment method that the customer used to make the refund.  .</param>
        ...
        /// <param name="payoutId">The payout ID of the refund from the gateway side. .</param>
        /// <param name="reasonCode">A code identifying the reason for the transaction.  .</param>
        /// <param name="referenceId">The transaction ID returned by the payment gateway for an electronic refund. Use this field to reconcile refunds between your gateway and Zuora Payments. .</param>
        /// <param name="refundDate">The date when the refund takes effect, in &#x60;yyyy-mm-dd&#x60; format. .</param>
        /// <param name="refundTransactionTime">The date and time when the refund was issued, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        /// <param name="secondRefundReferenceId">The transaction ID returned by the payment gateway if there is an additional transaction for the refund. Use this field to reconcile payments between your gateway and Zuora Payments. .</param>
        /// <param name="settledOn">The date and time when the refund was settled in the payment processor, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. This field is used by the Spectrum gateway only and not applicable to other gateways. .</param>
        ...
        /// <param name="submittedOn">The date and time when the refund was submitted, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. .</param>
        /// <param name="success">Returns &#x60;true&#x60; if the request was processed successfully..</param>
        /// <param name="type">The type of the refund. .</param>
        /// <param name="updatedById">The ID of the the Zuora user who last updated the refund. .</param>
        /// <param name="updatedDate">The date and time when the refund was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. .</param>
        ...
        /// <param name="integrationStatusNS">Status of the refund&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        ...
        /// <param name="syncDateNS">Date when the refund was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        /// <param name="synctoNetSuiteNS">Specifies whether the refund should be synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). .</param>
        public GETRefundPaymentType(string accountId = default(string), double amount = default(double), DateTime cancelledOn = default(DateTime), string comment = default(string), string createdById = default(string), DateTime createdDate = default(DateTime), string creditMemoId = default(string), GETRefundCreditMemoTypeAllOfFinanceInformation financeInformation = default(GETRefundCreditMemoTypeAllOfFinanceInformation), string gatewayId = default(string), string gatewayReconciliationReason = default(string), string gatewayReconciliationStatus = default(string), string gatewayResponse = default(string), string gatewayResponseCode = default(string), GatewayStateEnum? gatewayState = default(GatewayStateEnum?), string id = default(string), DateTime markedForSubmissionOn = default(DateTime), MethodTypeEnum? methodType = default(MethodTypeEnum?), string number = default(string), string paymentId = default(string), string paymentMethodId = default(string), string paymentMethodSnapshotId = default(string), string payoutId = default(string), string reasonCode = default(string), string referenceId = default(string), DateTime refundDate = default(DateTime), DateTime refundTransactionTime = default(DateTime), string secondRefundReferenceId = default(string), DateTime settledOn = default(DateTime), string softDescriptor = default(string), string softDescriptorPhone = default(string), StatusEnum? status = default(StatusEnum?), DateTime submittedOn = default(DateTime), bool success = default(bool), TypeEnum? type = default(TypeEnum?), string updatedById = default(string), DateTime updatedDate = default(DateTime), string integrationIdNS = default(string), string integrationStatusNS = default(string), string originNS = default(string), string syncDateNS = default(string), string synctoNetSuiteNS = default(string))
        {
        ...
        /// </summary>
        /// <value>The ID of the account associated with this refund. Zuora associates the refund automatically with the account from the associated payment. </value>
        ...
        /// </summary>
        /// <value>The total amount of the refund. </value>
        ...
        /// </summary>
        /// <value>The date and time when the refund was cancelled, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format.  </value>
        ...
        /// </summary>
        /// <value>The ID of the Zuora user who created the refund. </value>
        ...
        /// </summary>
        /// <value>The date and time when the refund was created, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-01 15:31:10.  </value>
        ...
        /// </summary>
        /// <value>The ID of the credit memo associated with the refund. </value>
        [DataMember(Name = "creditMemoId", EmitDefaultValue = false)]
        ...
        public GETRefundCreditMemoTypeAllOfFinanceInformation FinanceInformation { get; set; }

        /// <summary>
        /// The ID of the gateway instance that processes the refund. 
        /// </summary>
        /// <value>The ID of the gateway instance that processes the refund. </value>
        ...
        /// </summary>
        /// <value>The message returned from the payment gateway for the refund. This message is gateway-dependent. </value>
        ...
        /// </summary>
        /// <value>The code returned from the payment gateway for the refund. This code is gateway-dependent. </value>
        ...
        /// </summary>
        /// <value>The ID of the created refund. </value>
        ...
        /// </summary>
        /// <value>The date and time when a refund was marked and waiting for batch submission to the payment process, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The unique identification number of the refund. </value>
        ...
        /// </summary>
        /// <value>The ID of the payment that is refunded. </value>
        ...
        /// </summary>
        /// <value>The unique ID of the payment method that the customer used to make the refund.  </value>
        ...
        /// </summary>
        /// <value>The payout ID of the refund from the gateway side. </value>
        ...
        /// </summary>
        /// <value>A code identifying the reason for the transaction.  </value>
        ...
        /// </summary>
        /// <value>The transaction ID returned by the payment gateway for an electronic refund. Use this field to reconcile refunds between your gateway and Zuora Payments. </value>
        ...
        /// </summary>
        /// <value>The date when the refund takes effect, in &#x60;yyyy-mm-dd&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The date and time when the refund was issued, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The transaction ID returned by the payment gateway if there is an additional transaction for the refund. Use this field to reconcile payments between your gateway and Zuora Payments. </value>
        ...
        /// </summary>
        /// <value>The date and time when the refund was settled in the payment processor, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. This field is used by the Spectrum gateway only and not applicable to other gateways. </value>
        ...
        /// </summary>
        /// <value>The date and time when the refund was submitted, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. </value>
        ...
        /// </summary>
        /// <value>The ID of the the Zuora user who last updated the refund. </value>
        ...
        /// </summary>
        /// <value>The date and time when the refund was last updated, in &#x60;yyyy-mm-dd hh:mm:ss&#x60; format. For example, 2017-03-02 15:36:10. </value>
        ...
        /// </summary>
        /// <value>Status of the refund&#39;s synchronization with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        /// </summary>
        /// <value>Date when the refund was synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        /// </summary>
        /// <value>Specifies whether the refund should be synchronized with NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId&#x3D;265). </value>
        ...
        {
            return this.Equals(input as GETRefundPaymentType);
        }

        /// <summary>
        /// Returns true if GETRefundPaymentType instances are equal
        /// </summary>
        /// <param name="input">Instance of GETRefundPaymentType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETRefundPaymentType input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CreditMemoId == input.CreditMemoId ||
                    (this.CreditMemoId != null &&
                    this.CreditMemoId.Equals(input.CreditMemoId))
                ) && 
                (
                ...
                (
                    this.RefundTransactionTime == input.RefundTransactionTime ||
                    (this.RefundTransactionTime != null &&
                    this.RefundTransactionTime.Equals(input.RefundTransactionTime))
                ) && 
                (
                    this.SecondRefundReferenceId == input.SecondRefundReferenceId ||
                    (this.SecondRefundReferenceId != null &&
                    this.SecondRefundReferenceId.Equals(input.SecondRefundReferenceId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CreditMemoId != null)
                {
                    hashCode = (hashCode * 59) + this.CreditMemoId.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.RefundTransactionTime.GetHashCode();
                }
                if (this.SecondRefundReferenceId != null)
                {
                    hashCode = (hashCode * 59) + this.SecondRefundReferenceId.GetHashCode();
                }
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            // SynctoNetSuiteNS (string) maxLength
            if (this.SynctoNetSuiteNS != null && this.SynctoNetSuiteNS.Length > 255)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SynctoNetSuiteNS, length must be less than 255.", new [] { "SynctoNetSuiteNS" });
            }
