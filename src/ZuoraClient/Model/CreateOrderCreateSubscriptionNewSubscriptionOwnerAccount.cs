...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount")]
    public partial class CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount : IEquatable<CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount);
        }

        /// <summary>
        /// Returns true if CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateOrderCreateSubscriptionNewSubscriptionOwnerAccount input)
        {
            if (input == null)
            {
                return false;
