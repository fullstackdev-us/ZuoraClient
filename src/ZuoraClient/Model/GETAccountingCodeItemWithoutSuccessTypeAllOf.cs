...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETAccountingCodeItemWithoutSuccessType_allOf")]
    public partial class GETAccountingCodeItemWithoutSuccessTypeAllOf : IEquatable<GETAccountingCodeItemWithoutSuccessTypeAllOf>, IValidatableObject
    {
        /// <summary>
        /// The category associated with the accounting code. 
        /// </summary>
        /// <value>The category associated with the accounting code. </value>
        ...
        /// </summary>
        /// <value>The accounting code status. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// </summary>
        /// <value>Accounting code type.   Note that &#x60;On-Account Receivable&#x60; is only available if you enable the Invoice Settlement feature.  </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum OnAccountReceivable for value: On-Account Receivable
            /// </summary>
            [EnumMember(Value = "On-Account Receivable")]
            OnAccountReceivable = 2,
            ...
            /// <summary>
            /// Enum CustomerCashOnAccount for value: CustomerCashOnAccount
            /// </summary>
            [EnumMember(Value = "CustomerCashOnAccount")]
            CustomerCashOnAccount = 5,

            /// <summary>
            /// Enum DeferredRevenue for value: DeferredRevenue
            /// </summary>
            [EnumMember(Value = "DeferredRevenue")]
            DeferredRevenue = 6,

            /// <summary>
            /// Enum SalesTaxPayable for value: SalesTaxPayable
            /// </summary>
            [EnumMember(Value = "SalesTaxPayable")]
            SalesTaxPayable = 7,
            ...
            /// <summary>
            /// Enum SalesDiscounts for value: SalesDiscounts
            /// </summary>
            [EnumMember(Value = "SalesDiscounts")]
            SalesDiscounts = 10,

            /// <summary>
            /// Enum OtherRevenue for value: OtherRevenue
            /// </summary>
            [EnumMember(Value = "OtherRevenue")]
            OtherRevenue = 11,

            /// <summary>
            /// Enum OtherEquity for value: OtherEquity
            /// </summary>
            ...
            /// <summary>
            /// Enum OtherExpenses for value: OtherExpenses
            /// </summary>
            [EnumMember(Value = "OtherExpenses")]
            OtherExpenses = 14
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETAccountingCodeItemWithoutSuccessTypeAllOf" /> class.
        /// </summary>
        /// <param name="category">The category associated with the accounting code. .</param>
        ...
        /// <param name="glAccountName">Name of the account in your general ledger.  Field only available if you have Zuora Finance enabled. .</param>
        /// <param name="glAccountNumber">Account number in your general ledger.  Field only available if you have Zuora Finance enabled. .</param>
        ...
        /// <param name="status">The accounting code status. .</param>
        /// <param name="type">Accounting code type.   Note that &#x60;On-Account Receivable&#x60; is only available if you enable the Invoice Settlement feature.  .</param>
        ...
        public GETAccountingCodeItemWithoutSuccessTypeAllOf(CategoryEnum? category = default(CategoryEnum?), string createdBy = default(string), DateTime createdOn = default(DateTime), string glAccountName = default(string), string glAccountNumber = default(string), string id = default(string), string name = default(string), string notes = default(string), StatusEnum? status = default(StatusEnum?), TypeEnum? type = default(TypeEnum?), string updatedBy = default(string), DateTime updatedOn = default(DateTime))
        {
        ...
        /// </summary>
        /// <value>Name of the account in your general ledger.  Field only available if you have Zuora Finance enabled. </value>
        ...
        /// </summary>
        /// <value>Account number in your general ledger.  Field only available if you have Zuora Finance enabled. </value>
        ...
        {
            return this.Equals(input as GETAccountingCodeItemWithoutSuccessTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETAccountingCodeItemWithoutSuccessTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETAccountingCodeItemWithoutSuccessTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETAccountingCodeItemWithoutSuccessTypeAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GlAccountName == input.GlAccountName ||
                    (this.GlAccountName != null &&
                    this.GlAccountName.Equals(input.GlAccountName))
                ) && 
                (
                    this.GlAccountNumber == input.GlAccountNumber ||
                    (this.GlAccountNumber != null &&
                    this.GlAccountNumber.Equals(input.GlAccountNumber))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.GlAccountName.GetHashCode();
                }
                if (this.GlAccountNumber != null)
                {
                    hashCode = (hashCode * 59) + this.GlAccountNumber.GetHashCode();
                }
                if (this.Id != null)
                {
