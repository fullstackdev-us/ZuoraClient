...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InvoiceDataInvoice_allOf")]
    public partial class InvoiceDataInvoiceAllOf : IEquatable<InvoiceDataInvoiceAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceDataInvoiceAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvoiceDataInvoiceAllOf {\n");
        ...
        {
            return this.Equals(input as InvoiceDataInvoiceAllOf);
        }

        /// <summary>
        /// Returns true if InvoiceDataInvoiceAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceDataInvoiceAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceDataInvoiceAllOf input)
        {
            if (input == null)
            {
                return false;
