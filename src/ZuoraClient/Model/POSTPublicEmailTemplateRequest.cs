...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTPublicEmailTemplateRequest")]
    public partial class POSTPublicEmailTemplateRequest : IEquatable<POSTPublicEmailTemplateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTPublicEmailTemplateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTPublicEmailTemplateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTPublicEmailTemplateRequest" /> class.
        /// </summary>
        ...
        public POSTPublicEmailTemplateRequest(bool active = true, string bccEmailAddress = default(string), string ccEmailAddress = default(string), CcEmailTypeEnum? ccEmailType = CcEmailTypeEnum.SpecificEmails, string description = default(string), string emailBody = default(string), string emailSubject = default(string), EncodingTypeEnum? encodingType = EncodingTypeEnum.UTF8, decimal eventCategory = default(decimal), string eventTypeName = default(string), string eventTypeNamespace = default(string), string fromEmailAddress = default(string), FromEmailTypeEnum fromEmailType = default(FromEmailTypeEnum), string fromName = default(string), bool isHtml = false, string name = default(string), string replyToEmailAddress = default(string), ReplyToEmailTypeEnum? replyToEmailType = default(ReplyToEmailTypeEnum?), string toEmailAddress = default(string), ToEmailTypeEnum toEmailType = default(ToEmailTypeEnum))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for POSTPublicEmailTemplateRequest and cannot be null");
            }
            this.Name = name;
        ...
        {
            return this.Equals(input as POSTPublicEmailTemplateRequest);
        }

        /// <summary>
        /// Returns true if POSTPublicEmailTemplateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTPublicEmailTemplateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTPublicEmailTemplateRequest input)
        {
            if (input == null)
            {
                return false;
