...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "POSTTaxationItemForDMType")]
    public partial class POSTTaxationItemForDMType : IEquatable<POSTTaxationItemForDMType>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTTaxationItemForDMType" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected POSTTaxationItemForDMType() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="POSTTaxationItemForDMType" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as POSTTaxationItemForDMType);
        }

        /// <summary>
        /// Returns true if POSTTaxationItemForDMType instances are equal
        /// </summary>
        /// <param name="input">Instance of POSTTaxationItemForDMType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(POSTTaxationItemForDMType input)
        {
            if (input == null)
            {
                return false;
