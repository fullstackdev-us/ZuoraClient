...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProxyCreatePayment_allOf")]
    public partial class ProxyCreatePaymentAllOf : IEquatable<ProxyCreatePaymentAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreatePaymentAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProxyCreatePaymentAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProxyCreatePaymentAllOf" /> class.
        /// </summary>
        ...
        public ProxyCreatePaymentAllOf(string accountId = default(string), string accountingCode = default(string), double amount = default(double), double appliedCreditBalanceAmount = default(double), decimal appliedInvoiceAmount = default(decimal), string authTransactionId = default(string), string comment = default(string), DateTime effectiveDate = default(DateTime), string gateway = default(string), ProxyCreatePaymentAllOfGatewayOptionData gatewayOptionData = default(ProxyCreatePaymentAllOfGatewayOptionData), string gatewayOrderId = default(string), string gatewayResponse = default(string), string gatewayResponseCode = default(string), GatewayStateEnum? gatewayState = default(GatewayStateEnum?), string invoiceId = default(string), string invoiceNumber = default(string), InvoicePaymentData invoicePaymentData = default(InvoicePaymentData), string paymentMethodId = default(string), string referenceId = default(string), string softDescriptor = default(string), string softDescriptorPhone = default(string), StatusEnum status = default(StatusEnum), TypeEnum type = default(TypeEnum))
        {
            ...
            {
                throw new ArgumentNullException("paymentMethodId is a required property for ProxyCreatePaymentAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProxyCreatePaymentAllOf {\n");
        ...
        {
            return this.Equals(input as ProxyCreatePaymentAllOf);
        }

        /// <summary>
        /// Returns true if ProxyCreatePaymentAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProxyCreatePaymentAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProxyCreatePaymentAllOf input)
        {
            if (input == null)
            {
                return false;
