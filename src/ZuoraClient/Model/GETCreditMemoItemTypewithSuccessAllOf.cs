...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETCreditMemoItemTypewithSuccess_allOf")]
    public partial class GETCreditMemoItemTypewithSuccessAllOf : IEquatable<GETCreditMemoItemTypewithSuccessAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETCreditMemoItemTypewithSuccessAllOf" /> class.
        /// </summary>
        ...
        /// <param name="serviceStartDate">The service start date of the credit memo item. .</param>
        ...
        public GETCreditMemoItemTypewithSuccessAllOfFinanceInformation FinanceInformation { get; set; }
        ...
        /// </summary>
        /// <value>The service start date of the credit memo item. </value>
        ...
        {
            return this.Equals(input as GETCreditMemoItemTypewithSuccessAllOf);
        }

        /// <summary>
        /// Returns true if GETCreditMemoItemTypewithSuccessAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETCreditMemoItemTypewithSuccessAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETCreditMemoItemTypewithSuccessAllOf input)
        {
            if (input == null)
            {
                return false;
