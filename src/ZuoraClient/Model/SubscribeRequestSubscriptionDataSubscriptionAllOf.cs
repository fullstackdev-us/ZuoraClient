...
{
    /// <summary>
    /// SubscribeRequestSubscriptionDataSubscriptionAllOf
    /// </summary>
    [DataContract(Name = "SubscribeRequestSubscriptionDataSubscription_allOf")]
    public partial class SubscribeRequestSubscriptionDataSubscriptionAllOf : IEquatable<SubscribeRequestSubscriptionDataSubscriptionAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeRequestSubscriptionDataSubscriptionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubscribeRequestSubscriptionDataSubscriptionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeRequestSubscriptionDataSubscriptionAllOf" /> class.
        /// </summary>
        /// <param name="accountId"> This field can be updated when &#x60;Status&#x60; is &#x60;Draft&#x60;. .</param>
        /// <param name="ancestorAccountId"> A filter option for querying all subscriptions under the same account hierarchy.   **Character limit**: 32   **Values**: a valid account ID .</param>
        /// <param name="autoRenew"> This field can be updated when &#x60;Status&#x60; is &#x60;Draft&#x60;. Indicates if the subscription automatically renews at the end of the term. This field is only required if the &#x60;TermType&#x60; field is set to &#x60;TERMED&#x60;.    **Values**: &#x60;true&#x60;, &#x60;false&#x60; .</param>
        /// <param name="cancelledDate"> The date of the amendment that canceled the subscription.    **Values**: inherited from &#x60;Amendment&#x60;.&#x60;EffectiveDate&#x60; .</param>
        /// <param name="contractAcceptanceDate"> The date when the customer accepts the contract. This field can be updated when **Status** is &#x60;Draft&#x60;.   This field is only required if the [Require Service Activation of Orders?](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Default_Subscription_Settings#Require_Service_Activation_of_Orders.3F) Setting is set to &#x60;Yes&#x60;. If this setting is set to &#x60;Yes&#x60;:  - If ContractAcceptanceDate field is required, you must set this field, ContractAcceptanceDate, and ContractEffectiveDate fields in the subscribe call to activate a subscription. - If ContractAcceptanceDate field is not required, you must set both this field and the ContractEffectiveDate field in the subscribe call to activate a subscription. If you only set a valid date in the ContractEffectiveDate field, the subscribe call still returns success, but the subscription is in &#x60;DRAT&#x60; status. .</param>
        /// <param name="contractEffectiveDate"> The date when the contract takes effect. This field can be updated when **Status** is &#x60;Draft&#x60;.   **Note**: This field is required in the subscribe call. If you set the value of this field to null and both the ServiceActivationDate and ContractAcceptanceDate fields are not required, the subscribe call still returns success, but the new subscription is in &#x60;DRAFT&#x60; status. To activate the subscription, you must set a valid date to this field.  (required).</param>
        ...
        /// <param name="currentTerm"> The length of the period for the current subscription term. This field is only required If the &#x60;TermType&#x60; field is set to &#x60;TERMED&#x60; and its value must be greater than &#x60;0&#x60;. If TermType is set to &#x60;EVERGREEN&#x60;, this value is ignored. Default is &#x60;0&#x60;.   **Character limit**: 20   **Values**: automatically generated .</param>
        ...
        /// <param name="invoiceOwnerId"> This field can be updated when &#x60;Status&#x60; is &#x60;Draft&#x60;. .</param>
        ...
        /// <param name="renewalSetting"> This field can be updated when **Status** is &#x60;Draft&#x60;. Specifies whether a termed subscription will remain termed or change to evergreen when it is renewed.   This field is only required if the &#x60;TermType&#x60; field is set to &#x60;TERMED&#x60;.   **Values**: &#x60;RENEW_WITH_SPECIFIC_TERM &#x60;(default), &#x60;RENEW_TO_EVERGREEN&#x60; .</param>
        ...
        /// <param name="serviceActivationDate"> The date when the subscription is activated. This field can be updated when **Status** is &#x60;Draft&#x60;. This field is only required if the [Require Service Activation of Orders?](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Default_Subscription_Settings#Require_Service_Activation_of_Orders.3F) Setting is set to &#x60;Yes&#x60;. If this setting is set to &#x60;Yes&#x60;:  - If ContractAcceptanceDate field is required, you must set this field, ContractAcceptanceDate, and ContractEffectiveDate fields in the subscribe call to activate a subscription. - If ContractAcceptanceDate field is not required, you must set both this field and the ContractEffectiveDate field in the subscribe call to activate a subscription. If you only set a valid date in the ContractEffectiveDate field, the subscribe call still returns success, but the subscription is in &#x60;DRAT&#x60; status.   **Character limit**: 29  .</param>
        /// <param name="status"> The status of the subscription.   **Character limit**: 17   **Values**: automatically generated  **Possible values**: one of the following:  - &#x60;Draft&#x60; - &#x60;PendingActivation&#x60; - &#x60;PendingAcceptance&#x60; - &#x60;Active&#x60; - &#x60;Cancelled&#x60; - &#x60;Expired&#x60; - &#x60;Suspended&#x60; .</param>
        ...
        public SubscribeRequestSubscriptionDataSubscriptionAllOf(string accountId = default(string), string ancestorAccountId = default(string), bool autoRenew = default(bool), DateTime cancelledDate = default(DateTime), DateTime contractAcceptanceDate = default(DateTime), DateTime contractEffectiveDate = default(DateTime), string createdById = default(string), DateTime createdDate = default(DateTime), string creatorAccountId = default(string), string creatorInvoiceOwnerId = default(string), int currentTerm = default(int), string currentTermPeriodType = default(string), ExternallyManagedByEnum? externallyManagedBy = default(ExternallyManagedByEnum?), int initialTerm = default(int), string initialTermPeriodType = default(string), string invoiceOwnerId = default(string), bool isInvoiceSeparate = default(bool), DateTime lastBookingDate = default(DateTime), string name = default(string), string notes = default(string), DateTime originalCreatedDate = default(DateTime), string originalId = default(string), string previousSubscriptionId = default(string), string renewalSetting = default(string), int renewalTerm = default(int), string renewalTermPeriodType = default(string), DateTime serviceActivationDate = default(DateTime), string status = default(string), DateTime subscriptionEndDate = default(DateTime), DateTime subscriptionStartDate = default(DateTime), DateTime termEndDate = default(DateTime), DateTime termStartDate = default(DateTime), string termType = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime), int version = default(int))
        {
            this.ContractEffectiveDate = contractEffectiveDate;
            // to ensure "termType" is required (not null)
            if (termType == null)
            {
                throw new ArgumentNullException("termType is a required property for SubscribeRequestSubscriptionDataSubscriptionAllOf and cannot be null");
            }
        ...
        /// </summary>
        /// <value> This field can be updated when &#x60;Status&#x60; is &#x60;Draft&#x60;. </value>
        ...
        /// </summary>
        /// <value> A filter option for querying all subscriptions under the same account hierarchy.   **Character limit**: 32   **Values**: a valid account ID </value>
        ...
        /// </summary>
        /// <value> This field can be updated when &#x60;Status&#x60; is &#x60;Draft&#x60;. Indicates if the subscription automatically renews at the end of the term. This field is only required if the &#x60;TermType&#x60; field is set to &#x60;TERMED&#x60;.    **Values**: &#x60;true&#x60;, &#x60;false&#x60; </value>
        ...
        /// </summary>
        /// <value> The date of the amendment that canceled the subscription.    **Values**: inherited from &#x60;Amendment&#x60;.&#x60;EffectiveDate&#x60; </value>
        ...
        /// </summary>
        /// <value> The date when the customer accepts the contract. This field can be updated when **Status** is &#x60;Draft&#x60;.   This field is only required if the [Require Service Activation of Orders?](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Default_Subscription_Settings#Require_Service_Activation_of_Orders.3F) Setting is set to &#x60;Yes&#x60;. If this setting is set to &#x60;Yes&#x60;:  - If ContractAcceptanceDate field is required, you must set this field, ContractAcceptanceDate, and ContractEffectiveDate fields in the subscribe call to activate a subscription. - If ContractAcceptanceDate field is not required, you must set both this field and the ContractEffectiveDate field in the subscribe call to activate a subscription. If you only set a valid date in the ContractEffectiveDate field, the subscribe call still returns success, but the subscription is in &#x60;DRAT&#x60; status. </value>
        ...
        /// </summary>
        /// <value> The length of the period for the current subscription term. This field is only required If the &#x60;TermType&#x60; field is set to &#x60;TERMED&#x60; and its value must be greater than &#x60;0&#x60;. If TermType is set to &#x60;EVERGREEN&#x60;, this value is ignored. Default is &#x60;0&#x60;.   **Character limit**: 20   **Values**: automatically generated </value>
        ...
        /// </summary>
        /// <value> The length of the period for the first subscription term. This field can be updated when Status is &#x60;Draft&#x60;. If you use the subscribe call, this field is required.   This field is only required if the &#x60;TermType&#x60; field is set to &#x60;TERMED&#x60;.  **Character limit**: 20   **Values**: any valid number. The default value is 0. </value>
        ...
        /// </summary>
        /// <value> This field can be updated when **Status** is &#x60;Draft&#x60;. Specifies whether a termed subscription will remain termed or change to evergreen when it is renewed.   This field is only required if the &#x60;TermType&#x60; field is set to &#x60;TERMED&#x60;.   **Values**: &#x60;RENEW_WITH_SPECIFIC_TERM &#x60;(default), &#x60;RENEW_TO_EVERGREEN&#x60; </value>
        ...
        /// </summary>
        /// <value> The length of the period for the subscription renewal term. This field can be updated when **Status** is &#x60;Draft&#x60;. If you use the subscribe call, this field is required.   This field is only required if the &#x60;TermType&#x60; field is set to &#x60;TERMED&#x60;.   **Character limit**: 20   **Values**: one of the following:  - leave null to default to &#x60;0&#x60; - any number </value>
        ...
        /// </summary>
        /// <value> The date when the subscription is activated. This field can be updated when **Status** is &#x60;Draft&#x60;. This field is only required if the [Require Service Activation of Orders?](https://knowledgecenter.zuora.com/CB_Billing/Billing_Settings/Define_Default_Subscription_Settings#Require_Service_Activation_of_Orders.3F) Setting is set to &#x60;Yes&#x60;. If this setting is set to &#x60;Yes&#x60;:  - If ContractAcceptanceDate field is required, you must set this field, ContractAcceptanceDate, and ContractEffectiveDate fields in the subscribe call to activate a subscription. - If ContractAcceptanceDate field is not required, you must set both this field and the ContractEffectiveDate field in the subscribe call to activate a subscription. If you only set a valid date in the ContractEffectiveDate field, the subscribe call still returns success, but the subscription is in &#x60;DRAT&#x60; status.   **Character limit**: 29  </value>
        [DataMember(Name = "ServiceActivationDate", EmitDefaultValue = false)]
        [JsonConverter(typeof(OpenAPIDateConverter))]
        public DateTime ServiceActivationDate { get; set; }

        /// <summary>
        ///  The status of the subscription.   **Character limit**: 17   **Values**: automatically generated  **Possible values**: one of the following:  - &#x60;Draft&#x60; - &#x60;PendingActivation&#x60; - &#x60;PendingAcceptance&#x60; - &#x60;Active&#x60; - &#x60;Cancelled&#x60; - &#x60;Expired&#x60; - &#x60;Suspended&#x60; 
        /// </summary>
        /// <value> The status of the subscription.   **Character limit**: 17   **Values**: automatically generated  **Possible values**: one of the following:  - &#x60;Draft&#x60; - &#x60;PendingActivation&#x60; - &#x60;PendingAcceptance&#x60; - &#x60;Active&#x60; - &#x60;Cancelled&#x60; - &#x60;Expired&#x60; - &#x60;Suspended&#x60; </value>
        ...
        /// </summary>
        /// <value> This field can be updated when **Status** is &#x60;Draft&#x60;. The date when the subscription term begins. If this is a renewal subscription, then this date is different from the subscription start date. If you don&#39;t specify a value, then Zuora uses ContractEffectiveDate automatically.   **Character limit**: 29 </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubscribeRequestSubscriptionDataSubscriptionAllOf {\n");
        ...
        {
            return this.Equals(input as SubscribeRequestSubscriptionDataSubscriptionAllOf);
        }

        /// <summary>
        /// Returns true if SubscribeRequestSubscriptionDataSubscriptionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribeRequestSubscriptionDataSubscriptionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribeRequestSubscriptionDataSubscriptionAllOf input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AncestorAccountId == input.AncestorAccountId ||
                    (this.AncestorAccountId != null &&
                    this.AncestorAccountId.Equals(input.AncestorAccountId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AncestorAccountId.GetHashCode();
                }
