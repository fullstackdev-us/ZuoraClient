...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GETDebitMemoType_allOf")]
    public partial class GETDebitMemoTypeAllOf : IEquatable<GETDebitMemoTypeAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GETDebitMemoTypeAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GETDebitMemoTypeAllOf);
        }

        /// <summary>
        /// Returns true if GETDebitMemoTypeAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GETDebitMemoTypeAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GETDebitMemoTypeAllOf input)
        {
            if (input == null)
            {
                return false;
