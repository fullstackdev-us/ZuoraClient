...
namespace ZuoraClient.Model
{
    ...
    public partial class Amendment : IEquatable<Amendment>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Amendment" /> class.
        /// </summary>
        /// <param name="autoRenew"> Determines whether the subscription is automatically renewed, or whether it expires at the end of the term and needs to be manually renewed. For amendment of type &#x60;TermsAndConditions&#x60;, this field is only required if you change the automatic renewal status of a subscription.   **Values**: true, false .</param>
        /// <param name="code"> A unique alphanumeric string that identifies the amendment.   **Character limit**: 50  **Values**: automatically generated .</param>
        /// <param name="contractEffectiveDate"> The date when the amendment&#39;s changes become effective for billing purposes.  (required).</param>
        ...
        /// <param name="currentTermPeriodType"> The period type for the current subscription term. This field is only required if the &#x60;Type&#x60; field is set to &#x60;TermsAndConditions&#x60; and &#x60;TermType&#x60; is set to &#x60;TERMED&#x60;. This field is not required if &#x60;TermType&#x60; is set to &#x60;EVERGREEN&#x60;.  **Values**:  - &#x60;Month&#x60; (default) - &#x60;Year&#x60; - &#x60;Day&#x60; - &#x60;Week&#x60;   **Note**:  - This field can be updated when Status is &#x60;Draft&#x60;. - This field is used with the CurrentTerm field to specify the current subscription term. .</param>
        /// <param name="customerAcceptanceDate">The date when the customer accepts the amendment&#39;s changes to the subscription.  This field is only required if [Zuora is configured to require customer acceptance in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Acceptance status (the value of the &#x60;Status&#x60; field is currently &#x60;PendingAcceptance&#x60;).  Use this field together with the &#x60;Status&#x60; field. When you set a date in this field as a customer acceptance date, you should also set the &#x60;Status&#x60; field as &#x60;Completed&#x60;. .</param>
        /// <param name="description"> A description of the amendment.   **Character limit**: 500  **Values**: maximum 500 characters .</param>
        /// <param name="destinationAccountId"> The ID of the subscription owner that the subscription is being transferred to.   **Character limit**: 32  **Values**: a valid account ID .</param>
        /// <param name="destinationInvoiceOwnerId"> The ID of the invoice owner that the subscription is being transferred to.   **Character limit**: 32  **Values**: a valid invoice ID .</param>
        /// <param name="effectiveDate"> The date when the amendment&#39;s changes take effective. This field validates that the amendment&#39;s changes are within valid ranges of products and product rate plans. This field is only required if the &#x60;Type&#x60; field is set to &#x60;Cancellation&#x60;.  .</param>
        ...
        /// <param name="name"> The name of the amendment.   **Character limit**: 100  **Values**: a string of 100 characters or fewer  (required).</param>
        /// <param name="ratePlanData">ratePlanData.</param>
        /// <param name="renewalSetting"> Specifies whether a termed subscription will remain termed or change to evergreen when it is renewed.  This field is only required if the &#x60;TermType&#x60; field is set to &#x60;Termed&#x60;.   **Values**: RENEW_WITH_SPECIFIC_TERM (default), RENEW_TO_EVERGREEN .</param>
        /// <param name="renewalTerm"> The term of renewal for the amended subscription. This field can be updated when Status is &#x60;Draft&#x60;. This field is only required if the &#x60;Type&#x60; field is set to &#x60;TermsAndConditions&#x60;.   **Values:** a valid number .</param>
        ...
        /// <param name="resumeDate">The date when the subscription resumption takes effect. See [Resume Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Resume_a_Subscription#Resume_Date) for more information.  This field is only required if you resume a suspended subscription. .</param>
        /// <param name="serviceActivationDate">The date when service is activated.  This field is only required if [Zuora is configured to require service activation in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Activation status (the value of the &#x60;Status&#x60; field is currently &#x60;PendingActivation&#x60;).  Use this field together with the &#x60;Status&#x60; field. When you set a date in this field as a service activation date, you should also set the &#x60;Status&#x60; field as the expected next phase status: &#x60;Completed&#x60; or &#x60;PendingAcceptance&#x60;. .</param>
        /// <param name="specificUpdateDate">The date when the UpdateProduct amendment takes effect. This field is only applicable if there is already a future-dated UpdateProduct amendment on the subscription.   For the UpdateProduct amendments, this field is only required if there is already a future-dated UpdateProduct amendment on the subscription. .</param>
        /// <param name="status"> The status of the amendment. Type: string (enum)    **Values**: one of the following:  - Draft (default, if left null) - Pending Activation - Pending Acceptance - Completed .</param>
        /// <param name="subscriptionId"> The ID of the subscription that the amendment changes. The ID can be the latest version or any history version of ID.   **Character limit**: 32  **Values**: a valid subscription ID  (required).</param>
        /// <param name="suspendDate">The date when the subscription suspension takes effect. See [Suspend Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Suspend_a_Subscription#Suspend_Date) for more information.  This field is only required if you suspend an active subscription. .</param>
        /// <param name="termStartDate"> The date when the new terms and conditions take effect. This field is only required if the &#x60;Type&#x60; field is set to &#x60;TermsAndConditions&#x60;. .</param>
        /// <param name="termType"> Indicates if the subscription isTERMED or EVERGREEN.  - A TERMED subscription has an expiration date, and must be manually renewed. - An EVERGREEN subscription doesn&#39;t have an expiration date, and must be manually ended.  When as part of an amendment of type &#x60;TermsAndConditions&#x60;, this field is required to change the term type of a subscription.   **Character limit**: 9  **Values**: TERMED, EVERGREEN .</param>
        /// <param name="type"> The type of amendment.   **Character limit**: 20    **Values**: one of the following:  - Cancellation - NewProduct - OwnerTransfer (If this value is chosen, the &#x60;ContractEffectiveDate&#x60;, &#x60;ServiceActivationDate&#x60;, and &#x60;CustomerAcceptanceDate&#x60; fields will all be automatically set to today&#39;s date, and any values passed from the API are ignored.) - RemoveProduct - Renewal - UpdateProduct - TermsAndConditions - SuspendSubscription - ResumeSubscription  (required).</param>
        ...
        public Amendment(bool autoRenew = default(bool), string code = default(string), DateTime contractEffectiveDate = default(DateTime), string createdById = default(string), DateTime createdDate = default(DateTime), long currentTerm = default(long), string currentTermPeriodType = default(string), DateTime customerAcceptanceDate = default(DateTime), string description = default(string), string destinationAccountId = default(string), string destinationInvoiceOwnerId = default(string), DateTime effectiveDate = default(DateTime), ExternallyManagedByEnum? externallyManagedBy = default(ExternallyManagedByEnum?), string name = default(string), AmendmentRatePlanData ratePlanData = default(AmendmentRatePlanData), string renewalSetting = default(string), long renewalTerm = default(long), string renewalTermPeriodType = default(string), DateTime resumeDate = default(DateTime), DateTime serviceActivationDate = default(DateTime), DateTime specificUpdateDate = default(DateTime), string status = default(string), string subscriptionId = default(string), DateTime suspendDate = default(DateTime), DateTime termStartDate = default(DateTime), string termType = default(string), string type = default(string), string updatedById = default(string), DateTime updatedDate = default(DateTime))
        {
            this.ContractEffectiveDate = contractEffectiveDate;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for Amendment and cannot be null");
            }
            this.Name = name;
            // to ensure "subscriptionId" is required (not null)
            if (subscriptionId == null)
            {
                throw new ArgumentNullException("subscriptionId is a required property for Amendment and cannot be null");
            }
            this.SubscriptionId = subscriptionId;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for Amendment and cannot be null");
            }
            this.Type = type;
        ...
        /// </summary>
        /// <value> Determines whether the subscription is automatically renewed, or whether it expires at the end of the term and needs to be manually renewed. For amendment of type &#x60;TermsAndConditions&#x60;, this field is only required if you change the automatic renewal status of a subscription.   **Values**: true, false </value>
        [DataMember(Name = "AutoRenew", EmitDefaultValue = true)]
        public bool AutoRenew { get; set; }

        /// <summary>
        ///  A unique alphanumeric string that identifies the amendment.   **Character limit**: 50  **Values**: automatically generated 
        /// </summary>
        /// <value> A unique alphanumeric string that identifies the amendment.   **Character limit**: 50  **Values**: automatically generated </value>
        ...
        /// </summary>
        /// <value> The date when the amendment&#39;s changes become effective for billing purposes. </value>
        ...
        /// </summary>
        /// <value> The period type for the current subscription term. This field is only required if the &#x60;Type&#x60; field is set to &#x60;TermsAndConditions&#x60; and &#x60;TermType&#x60; is set to &#x60;TERMED&#x60;. This field is not required if &#x60;TermType&#x60; is set to &#x60;EVERGREEN&#x60;.  **Values**:  - &#x60;Month&#x60; (default) - &#x60;Year&#x60; - &#x60;Day&#x60; - &#x60;Week&#x60;   **Note**:  - This field can be updated when Status is &#x60;Draft&#x60;. - This field is used with the CurrentTerm field to specify the current subscription term. </value>
        [DataMember(Name = "CurrentTermPeriodType", EmitDefaultValue = false)]
        public string CurrentTermPeriodType { get; set; }

        /// <summary>
        /// The date when the customer accepts the amendment&#39;s changes to the subscription.  This field is only required if [Zuora is configured to require customer acceptance in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Acceptance status (the value of the &#x60;Status&#x60; field is currently &#x60;PendingAcceptance&#x60;).  Use this field together with the &#x60;Status&#x60; field. When you set a date in this field as a customer acceptance date, you should also set the &#x60;Status&#x60; field as &#x60;Completed&#x60;. 
        /// </summary>
        /// <value>The date when the customer accepts the amendment&#39;s changes to the subscription.  This field is only required if [Zuora is configured to require customer acceptance in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Acceptance status (the value of the &#x60;Status&#x60; field is currently &#x60;PendingAcceptance&#x60;).  Use this field together with the &#x60;Status&#x60; field. When you set a date in this field as a customer acceptance date, you should also set the &#x60;Status&#x60; field as &#x60;Completed&#x60;. </value>
        ...
        /// <summary>
        ///  The ID of the subscription owner that the subscription is being transferred to.   **Character limit**: 32  **Values**: a valid account ID 
        /// </summary>
        /// <value> The ID of the subscription owner that the subscription is being transferred to.   **Character limit**: 32  **Values**: a valid account ID </value>
        [DataMember(Name = "DestinationAccountId", EmitDefaultValue = false)]
        public string DestinationAccountId { get; set; }

        /// <summary>
        ///  The ID of the invoice owner that the subscription is being transferred to.   **Character limit**: 32  **Values**: a valid invoice ID 
        /// </summary>
        /// <value> The ID of the invoice owner that the subscription is being transferred to.   **Character limit**: 32  **Values**: a valid invoice ID </value>
        ...
        /// </summary>
        /// <value> The date when the amendment&#39;s changes take effective. This field validates that the amendment&#39;s changes are within valid ranges of products and product rate plans. This field is only required if the &#x60;Type&#x60; field is set to &#x60;Cancellation&#x60;.  </value>
        ...
        /// </summary>
        /// <value> Specifies whether a termed subscription will remain termed or change to evergreen when it is renewed.  This field is only required if the &#x60;TermType&#x60; field is set to &#x60;Termed&#x60;.   **Values**: RENEW_WITH_SPECIFIC_TERM (default), RENEW_TO_EVERGREEN </value>
        ...
        /// </summary>
        /// <value> The term of renewal for the amended subscription. This field can be updated when Status is &#x60;Draft&#x60;. This field is only required if the &#x60;Type&#x60; field is set to &#x60;TermsAndConditions&#x60;.   **Values:** a valid number </value>
        ...
        /// <summary>
        /// The date when the subscription resumption takes effect. See [Resume Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Resume_a_Subscription#Resume_Date) for more information.  This field is only required if you resume a suspended subscription. 
        /// </summary>
        /// <value>The date when the subscription resumption takes effect. See [Resume Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Resume_a_Subscription#Resume_Date) for more information.  This field is only required if you resume a suspended subscription. </value>
        [DataMember(Name = "ResumeDate", EmitDefaultValue = false)]
        [JsonConverter(typeof(OpenAPIDateConverter))]
        public DateTime ResumeDate { get; set; }

        /// <summary>
        /// The date when service is activated.  This field is only required if [Zuora is configured to require service activation in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Activation status (the value of the &#x60;Status&#x60; field is currently &#x60;PendingActivation&#x60;).  Use this field together with the &#x60;Status&#x60; field. When you set a date in this field as a service activation date, you should also set the &#x60;Status&#x60; field as the expected next phase status: &#x60;Completed&#x60; or &#x60;PendingAcceptance&#x60;. 
        /// </summary>
        /// <value>The date when service is activated.  This field is only required if [Zuora is configured to require service activation in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Activation status (the value of the &#x60;Status&#x60; field is currently &#x60;PendingActivation&#x60;).  Use this field together with the &#x60;Status&#x60; field. When you set a date in this field as a service activation date, you should also set the &#x60;Status&#x60; field as the expected next phase status: &#x60;Completed&#x60; or &#x60;PendingAcceptance&#x60;. </value>
        ...
        /// </summary>
        /// <value>The date when the UpdateProduct amendment takes effect. This field is only applicable if there is already a future-dated UpdateProduct amendment on the subscription.   For the UpdateProduct amendments, this field is only required if there is already a future-dated UpdateProduct amendment on the subscription. </value>
        ...
        /// </summary>
        /// <value> The status of the amendment. Type: string (enum)    **Values**: one of the following:  - Draft (default, if left null) - Pending Activation - Pending Acceptance - Completed </value>
        [DataMember(Name = "Status", EmitDefaultValue = false)]
        public string Status { get; set; }

        /// <summary>
        ///  The ID of the subscription that the amendment changes. The ID can be the latest version or any history version of ID.   **Character limit**: 32  **Values**: a valid subscription ID 
        /// </summary>
        /// <value> The ID of the subscription that the amendment changes. The ID can be the latest version or any history version of ID.   **Character limit**: 32  **Values**: a valid subscription ID </value>
        [DataMember(Name = "SubscriptionId", IsRequired = true, EmitDefaultValue = false)]
        public string SubscriptionId { get; set; }

        /// <summary>
        /// The date when the subscription suspension takes effect. See [Suspend Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Suspend_a_Subscription#Suspend_Date) for more information.  This field is only required if you suspend an active subscription. 
        /// </summary>
        /// <value>The date when the subscription suspension takes effect. See [Suspend Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Suspend_a_Subscription#Suspend_Date) for more information.  This field is only required if you suspend an active subscription. </value>
        ...
        /// </summary>
        /// <value> The date when the new terms and conditions take effect. This field is only required if the &#x60;Type&#x60; field is set to &#x60;TermsAndConditions&#x60;. </value>
        ...
        /// </summary>
        /// <value> Indicates if the subscription isTERMED or EVERGREEN.  - A TERMED subscription has an expiration date, and must be manually renewed. - An EVERGREEN subscription doesn&#39;t have an expiration date, and must be manually ended.  When as part of an amendment of type &#x60;TermsAndConditions&#x60;, this field is required to change the term type of a subscription.   **Character limit**: 9  **Values**: TERMED, EVERGREEN </value>
        ...
        /// </summary>
        /// <value> The type of amendment.   **Character limit**: 20    **Values**: one of the following:  - Cancellation - NewProduct - OwnerTransfer (If this value is chosen, the &#x60;ContractEffectiveDate&#x60;, &#x60;ServiceActivationDate&#x60;, and &#x60;CustomerAcceptanceDate&#x60; fields will all be automatically set to today&#39;s date, and any values passed from the API are ignored.) - RemoveProduct - Renewal - UpdateProduct - TermsAndConditions - SuspendSubscription - ResumeSubscription </value>
        ...
        {
            return this.Equals(input as Amendment);
        }

        /// <summary>
        /// Returns true if Amendment instances are equal
        /// </summary>
        /// <param name="input">Instance of Amendment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Amendment input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RatePlanData == input.RatePlanData ||
                    (this.RatePlanData != null &&
                    this.RatePlanData.Equals(input.RatePlanData))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.RatePlanData.GetHashCode();
                }
