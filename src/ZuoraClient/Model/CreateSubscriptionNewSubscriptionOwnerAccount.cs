...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateSubscription_newSubscriptionOwnerAccount")]
    public partial class CreateSubscriptionNewSubscriptionOwnerAccount : IEquatable<CreateSubscriptionNewSubscriptionOwnerAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionNewSubscriptionOwnerAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateSubscriptionNewSubscriptionOwnerAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionNewSubscriptionOwnerAccount" /> class.
        /// </summary>
        ...
        public CreateSubscriptionNewSubscriptionOwnerAccount(string accountNumber = default(string), bool autoPay = default(bool), string batch = default(string), int billCycleDay = default(int), BillToContact billToContact = default(BillToContact), string communicationProfileId = default(string), CreditCard creditCard = default(CreditCard), string crmId = default(string), string currency = default(string), Dictionary<string, Object> customFields = default(Dictionary<string, Object>), string hpmCreditCardPaymentMethodId = default(string), bool invoiceDeliveryPrefsEmail = default(bool), bool invoiceDeliveryPrefsPrint = default(bool), string invoiceTemplateId = default(string), string name = default(string), string notes = default(string), string parentId = default(string), string paymentGateway = default(string), PaymentMethod paymentMethod = default(PaymentMethod), string paymentTerm = default(string), SoldToContact soldToContact = default(SoldToContact), TaxInfo taxInfo = default(TaxInfo))
        {
            this.BillCycleDay = billCycleDay;
            // to ensure "billToContact" is required (not null)
            if (billToContact == null)
            {
                throw new ArgumentNullException("billToContact is a required property for CreateSubscriptionNewSubscriptionOwnerAccount and cannot be null");
            }
            this.BillToContact = billToContact;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for CreateSubscriptionNewSubscriptionOwnerAccount and cannot be null");
            }
            this.Currency = currency;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateSubscriptionNewSubscriptionOwnerAccount and cannot be null");
            }
            this.Name = name;
        ...
        public SoldToContact SoldToContact { get; set; }
        ...
        {
            return this.Equals(input as CreateSubscriptionNewSubscriptionOwnerAccount);
        }

        /// <summary>
        /// Returns true if CreateSubscriptionNewSubscriptionOwnerAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSubscriptionNewSubscriptionOwnerAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSubscriptionNewSubscriptionOwnerAccount input)
        {
            if (input == null)
            {
                return false;
