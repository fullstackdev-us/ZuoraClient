...
namespace ZuoraClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductRatePlanObjectNSFields")]
    public partial class ProductRatePlanObjectNSFields : IEquatable<ProductRatePlanObjectNSFields>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductRatePlanObjectNSFields" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProductRatePlanObjectNSFields);
        }

        /// <summary>
        /// Returns true if ProductRatePlanObjectNSFields instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductRatePlanObjectNSFields to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductRatePlanObjectNSFields input)
        {
            if (input == null)
            {
                return false;
