...
namespace ZuoraClient.Model
{
    ...
    public partial class OrderLineItem : IEquatable<OrderLineItem>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The state of the Order Line Item. See [Order Line Item states, Order states, and state transitions](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AB_Order_Line_Item_States_and_Order_States) for more information. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="accountingCode">The accountingCode for the Order Line Item. .</param>
        ...
        /// <param name="itemState">The state of the Order Line Item. See [Order Line Item states, Order states, and state transitions](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AB_Order_Line_Item_States_and_Order_States) for more information. .</param>
        ...
        /// </summary>
        /// <value>The accountingCode for the Order Line Item. </value>
        ...
        public DateTime AmendedByOrderOn { get; set; }
