...
namespace ZuoraClient.Model
{
    ...
    /// JobResultAllOf
    /// </summary>
    [DataContract(Name = "JobResult_allOf")]
    public partial class JobResultAllOf : IEquatable<JobResultAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JobResultAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as JobResultAllOf);
        }

        /// <summary>
        /// Returns true if JobResultAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of JobResultAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobResultAllOf input)
        {
            if (input == null)
            {
                return false;
